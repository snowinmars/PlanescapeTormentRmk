...
Бинарные файлы - картинки, музыка и т.д. - лежат отдельно на https://disk.yandex.ru/d/1vqwCTMVOBEbgA . Скачай required 7z архив и распакуй в каталог game.
...
- Открой `src\htmlcov\index.html` в браузере. Убедись, что покрытие составляет хотя бы 90%. Питон - сплошной косяк рантайма.
