...
from _build.parse_clean.parse_clean import (parse_clean)
from _build.parse_clean_tests_cases import (
    test_case1,
    test_tree1,
    test_case2,
    test_tree2,
...
class ParseCleanTest(unittest.TestCase):
    def test_case_1(self):
        lhs = parse_clean(test_case1)[0]
        rhs = test_tree1
        self.assert_equal_states(lhs, rhs)
    def test_case_2(self):
        lhs = parse_clean(test_case2)[0]
        rhs = test_tree2
        self.assert_equal_states(lhs, rhs)
    def test_case_3(self):
        lhs = parse_clean(test_case3)[0]
        rhs = test_tree3
        self.assert_equal_states(lhs, rhs)
    def test_case_4(self):
        lhs = parse_clean(test_case4)[0]
        rhs = test_tree4
        self.assert_equal_states(lhs, rhs)
    def test_case_5(self):
        lhs = parse_clean(test_case5)[0]
        rhs = test_tree5
        self.assert_equal_states(lhs, rhs)
    def test_case_6(self):
        lhs = parse_clean(test_case6)[0]
        rhs = test_tree6
        self.assert_equal_states(lhs, rhs)
    def test_case_7(self):
        lhs = parse_clean(test_case7)[0]
        rhs = test_tree7
        self.assert_equal_states(lhs, rhs)
    def test_case_8(self):
        lhs = parse_clean(test_case8)[0]
        rhs = test_tree8
        self.assert_equal_states(lhs, rhs)
    def test_case_9(self):
        lhs = parse_clean(test_case9)[0]
        rhs = test_tree9
        self.assert_equal_states(lhs, rhs)
    def test_case_10(self):
        lhs = parse_clean(test_case10)[0]
        rhs = test_tree10
        self.assert_equal_states(lhs, rhs)
    def test_case_11(self):
        lhs = parse_clean(test_case11)[0]
        rhs = test_tree11
        self.assert_equal_states(lhs, rhs)
    def test_case_12(self):
        lhs = parse_clean(test_case12)[0]
        rhs = test_tree12
        self.assert_equal_states(lhs, rhs)
