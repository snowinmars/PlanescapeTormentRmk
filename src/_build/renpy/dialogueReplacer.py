...
class DialogueReplacer:
    ...
    def build_replacements(self):
        ...
        self.inventory_item('Bandage' , 'bandage')
        self.inventory_item('BoneChrm', 'bonechrm')
        ...
        self.inventory_item('CopEarC' , 'copearc')
        self.inventory_item('CopEarO' , 'copearo')
        self.inventory_item('Cube'    , 'cube')
        self.inventory_item('Decant'  , 'decant')
        self.inventory_item('doornote', 'doornote')
        self.inventory_item('dremind' , 'dremind')
        self.inventory_item('DRemind' , 'dremind')
        self.inventory_item('drequest', 'drequest')
        self.inventory_item('DsupRing', 'dsupring')
        self.inventory_item('dustrobe', 'dustrobe')
        self.inventory_item('Dwedring', 'dwedring')
        self.inventory_item('DwedRing', 'dwedring')
        self.inventory_item('Embalm'  , 'embalm')
        self.inventory_item('fingbone', 'fingbone')
        self.inventory_item('GSKnife' , 'gsknife')
        self.inventory_item('KeyEm'   , 'keyem')
        self.inventory_item('KeyMo'   , 'keymo')
        self.inventory_item('keymo2'  , 'keymo2')
        self.inventory_item('KeyPR'   , 'keypr')
        self.inventory_item('KeyPr'   , 'keypr') #  ?
        self.inventory_item('Logpage' , 'logpage')
        self.inventory_item('N1201'   , 'n1201')
        ...
        self.inventory_item('tasklist', 'tasklist')
        self.inventory_item('TEarring', 'tearring')
        self.inventory_item('TomeBA'  , 'tomeba')
        self.inventory_item('XacHeart', 'xacheart')
        self.inventory_item('XacLiver', 'xacliver')
        ...
        self.add_replacement('TransformPartyItem("CopEarC","CopEarO",1,0,0)', 'self.state_manager.inventory_items_manager.drop_all_items(\'copearc\') self.state_manager.inventory_items_manager.pick_item(\'copearo\')')
        self.add_replacement('TransformPartyItem("Dwedring","DsupRing",1,0,0)', 'self.state_manager.inventory_items_manager.drop_all_items(\'dwedring\') self.state_manager.inventory_items_manager.pick_item(\'dsupring\')')

        self.add_replacement('!HasItem("KeyEm","EiVene")', 'return self.state_manager.inventory_items_manager.is_own_item(\'keyem\')')
        self.add_replacement('HasItem("KeyEm","EiVene")' , 'return not self.state_manager.inventory_items_manager.is_own_item(\'keyem\')')
        self.add_replacement('HasItem("Bandage","ZM396")', 'return not self.state_manager.world_manager.get_has_bandages_zm396()')
        self.add_replacement('GiveItem("KeyEm","Vaxis")' , 'self.state_manager.inventory_items_manager.drop_all_items(\'keyem\') self.state_manager.world_manager.set_vaxis_has_keyem(True)')
    ...
    def inventory_item(self, from_var, to_var):
        ...
        for i in range(0, 6):  # manually add new values
            self.add_replacement(f'GiveItemCreate("{from_var}",Protagonist,{i},0,0)', f'self.state_manager.inventory_items_manager.pick_item(\'{to_var}\')')
            self.add_replacement(f'GiveItemCreate("{from_var}",Protagonist,{i},1,0)', f'self.state_manager.inventory_items_manager.pick_item(\'{to_var}\')')
        ...
        self.add_replacement(f'!HasItem("{from_var}",Myself)'       , f'return not self.state_manager.inventory_items_manager.is_own_item(\'{to_var}\')')
        self.add_replacement(f'!PartyHasItem("{from_var}")'         , f'return not self.state_manager.inventory_items_manager.is_own_item(\'{to_var}\')')
        self.add_replacement(f'DestroyPartyItem("{from_var}",TRUE)' , f'self.state_manager.inventory_items_manager.drop_item(\'{to_var}\')')
        self.add_replacement(f'DestroyPartyItem("{from_var}",FALSE)', f'self.state_manager.inventory_items_manager.drop_item(\'{to_var}\')')
        self.add_replacement(f'GiveItem("{from_var}",Protagonist)'  , f'self.state_manager.inventory_items_manager.pick_item(\'{to_var}\')')
        self.add_replacement(f'HasItem("{from_var}",Myself)'        , f'return not self.state_manager.inventory_items_manager.is_own_item(\'{to_var}\')')
        self.add_replacement(f'PartyHasItem("{from_var}")'          , f'return self.state_manager.inventory_items_manager.is_own_item(\'{to_var}\')')
        self.add_replacement(f'TakeItem("{from_var}",Protagonist)'  , f'self.state_manager.inventory_items_manager.drop_item(\'{to_var}\')')
        self.add_replacement(f'TakePartyItemNum("{from_var}",1)'    , f'self.state_manager.inventory_items_manager.drop_item(\'{to_var}\')')
