...
inventory_pick_item_condition_pattern = re.compile(r"^inventory_items_manager.pick_item\(\'(.*)\'\)$")
inventory_drop_item_condition_pattern = re.compile(r"^inventory_items_manager.drop_item\(\'(.*)\'\)$")
inventory_is_own_item_condition_pattern = re.compile(r"^inventory_items_manager.is_own_item\(\'(.*)\'\)$")
inventory_not_is_own_item_condition_pattern = re.compile(r"^not inventory_items_manager.is_own_item\(\'(.*)\'\)$")
...
inventory_pick_item_action_pattern = re.compile(r'^inventory_items_manager.pick_item\(\'(.*)\'\)$')
inventory_drop_item_action_pattern = re.compile(r'^inventory_items_manager.drop_item\(\'(.*)\'\)$')
inventory_drop_all_items_action_pattern = re.compile(r'^inventory_items_manager.drop_all_items\(\'(.*)\'\)$')
...
update_journal_action_pattern = re.compile(r'^journal_notes_manager\.update_journal\(\'(\d+)\'\)$')
