...
self.assert{v}(self.settings_manager.get_{s}())
""".strip()
...
self.assertEqual(self.settings_manager.get_{s}(), {s}_after)
""".strip()
set_integer_action_pattern_after_once = """
self.assertEqual(self.settings_manager.get_{s}(), {s}_after_once)
""".strip()
...
{p}_before = self.settings_manager.character_manager.get_property(who_{p}, prop_{p})
""".strip()
modify_property_once_action_pattern_after = """
{p}_after = self.settings_manager.character_manager.get_property(who_{p}, prop_{p})
self.assertEqual({p}_before + delta_{p}, {p}_after)
""".strip()
modify_property_once_action_pattern_after_once = """
{p}_after_once = self.settings_manager.character_manager.get_property(who_{p}, prop_{p})
...
self.settings_manager.set_{s}(False)
""".strip()
...
self.settings_manager.set_{s}({v})
""".strip()
...
self.settings_manager.character_manager.set_property(who_{s}, prop_{s}, delta_{s})
""".strip()
