class EiveneLogic:
    ...
    def r3424_action(self):
        ...
        self.settings_manager.update_journal('37701')
    ...
    def r3425_action(self):
        self.settings_manager.update_journal('37702')
    ...
    def r3449_action(self):
        ...
        self.settings_manager.update_journal('38199')
    ...
    def r3459_action(self):
        # ?.play_sound('SPTR_01') self.settings_manager.update_journal('61612')
    ...
    def r3469_action(self):
        ...
        self.settings_manager.set_eivene_delivery(True)
        self.settings_manager.gain_experience('party', 250)
        self.settings_manager.update_journal('38202')
    ...
    def r3494_action(self):
        self.settings_manager.update_journal('38203')
