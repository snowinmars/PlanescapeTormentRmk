...
# s105 # say6071
label morte_s105: # externs deions_s8 deions_s48 deions_s26 deions_s19 deions_s0
...
# s413 # say39570
label morte_s413: # from 408.1 # ~SetGlobal("Yves_Shared","AR0605",1)
    SPEAKER '«Ладно, ладно…»'
...
label morte_s718: # from 717.0
    ...
    menu:
# s719 # say65818
label morte_s719: # from 718.0 # ~SetGlobal("Know_Morte_Pillar","GLOBAL",2)
