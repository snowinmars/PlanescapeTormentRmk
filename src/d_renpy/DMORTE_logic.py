class MorteLogic:
    ...
    def r3474_action(self):
        self.settings_manager.update_journal('38205')
    ...
    def r4676_action(self):
        self.settings_manager.update_journal('64512')
    ...
    def r20612_action(self):
        ...
        self.settings_manager.update_journal('20538')
    ...
    def r24932_action(self):
        self.settings_manager.set_in_party_morte(True)
        self.settings_manager.update_journal('24933')
    ...
    def r41837_action(self):
        self.settings_manager.update_journal('39516')
    ...
    def r41921_action(self):
        ...
        self.settings_manager.update_journal('67862')
    ...
    def r43910_action(self):
        ...
        self.settings_manager.update_journal('39490')
    ...
    def r45093_action(self):
        self.settings_manager.update_journal('39477')
    ...
    def r53629_action(self):
        ...
        self.settings_manager.update_journal('53633')
    ...
    def r53630_action(self):
        self.settings_manager.dec_morale_morte()
        self.settings_manager.set_morte_story(True)
        self.settings_manager.update_journal('53661')
    ...
    def r65569_action(self):
        ...
        self.settings_manager.update_journal('65573')
    ...
    def r65621_action(self):
        ...
        self.settings_manager.update_journal('65625')
    ...
    def r65631_action(self):
        self.settings_manager.update_journal('65637')
    ...
    def r65666_action(self):
        self.settings_manager.update_journal('65669')
    ...
    def r65674_action(self):
        self.settings_manager.update_journal('65678')
    ...
    def r65710_action(self):
        self.settings_manager.update_journal('65712')
    ...
    def r65821_action(self):
        ...
        self.settings_manager.character_manager.modify_property('morte",str,raise,4)
        permanentstatchange("morte",dex,raise,2) permanentstatchange("morte"', 'constitution', 2) self.settings_manager.set_bd_morte_story(True)
        self.settings_manager.update_journal('65825')
    ...
    def r40069_condition(self):
        return not self.settings_manager.get_in_party_morte() current = self.settings_manager.character_manager.get_property('protagonist', 'current_health')
        return max = self.settings_manager.character_manager.get_property('protagonist', 'max_health')
        return current == max
