class DmorteLogic:
    ...
    def r4029_action(self):
        self.gsm.gcm.modify_property_once('protagonist', 'good', 1, 'globalgood_giant_skel_mort_1')
    ...
    def r7485_action(self):
        self.gsm.inc_morte_taunt()


    def r11977_action(self):
        self.gsm.set_ingress_teeth_installed(True)
        self.gsm.gcm.modify_property_once('protagonist', 'law', -1, 'globalchaotic_ingress_teeth_2')
        self.gsm.gcm.modify_property_once('protagonist', 'good', -1, 'globalevil_ingress_teeth_1')
    ...
    def r13986_action(self):
        self.gsm.set_morte_wilder_quip_1(True)
        self.gsm.set_know_chaosmen(True)
    ...
    def r22850_action(self):
        self.gsm.gcm.modify_property_once('protagonist', 'law', -1, 'globalchaotic_cube_3')


    def r22853_action(self):
        self.gsm.gcm.modify_property_once('protagonist', 'law', -1, 'globalchaotic_cube_4')


    def r22856_action(self):
        self.gsm.gcm.modify_property_once('protagonist', 'law', -1, 'globalchaotic_cube_5')
    ...
    def r54244_action(self):
        self.gsm.set_morte_quip_regret_portal(2)
    ...
    def r54278_action(self):
        self.gsm.inc_bd_morte_morale()
        self.gsm.set_morte_morale_fortress_portal(1)
    ...
    def r55902_action(self):
        self.gsm.gcm.modify_property_once('protagonist', 'law', -1, 'globalchaotic_nordom_5')


    def r55925_action(self):
        self.gsm.set_know_mechanus(True)
    ...
    def r65750_action(self):
        self.gsm.gcm.modify_property_once('protagonist', 'law', 1, 'globallawful_morte_1')


    def r65751_action(self):
        self.gsm.gcm.modify_property_once('protagonist', 'law', -1, 'globalchaotic_morte_1')
        self.gsm.gcm.modify_property_once('protagonist', 'good', -1, 'globalevil_morte_1')
    ...
    def r65774_action(self):
        self.gsm.set_memory_morte_pillar(True)
        self.gsm.inc_exp_custom('protagonist', 12000)
        FadeToColor([20.0],0) Wait(3) FadeFromColor([20.0],0)
    ...
    def r68176_action(self):
        self.gsm.set_fortress_morte(4)
        JoinPartyEx(TRUE)


    def r68189_action(self):
        StartCutSceneMode() # ?.startCutScene("1204d0")


    def r68190_action(self):
        StartCutSceneMode() # ?.startCutScene("1204a0")


    def r68191_action(self):
        StartCutSceneMode() # ?.startCutScene("1204g0")


    def r68192_action(self):
        StartCutSceneMode() # ?.startCutScene("1204i0")


    def r68193_action(self):
        StartCutSceneMode() # ?.startCutScene("1204v0")


    def r68194_action(self):
        StartCutSceneMode() # ?.startCutScene("1204n0")


    def r68239_action(self):
        StartCutSceneMode() # ?.startCutScene("1204tr")
    ...
    def r1006_condition(self):
        return self.gsm.get_read_scars()
    ...
    def r9029_condition(self):
        return not self.gsm.get_know_gith()


    def r9030_condition(self):
        return self.gsm.get_know_gith()
    ...
    def r7057_condition(self):
        return not self.gsm.get_morte_quip()
    ...
    def r11985_condition(self):
        return self.gsm.get_evil_ingress_teeth_1()


    def r11986_condition(self):
        return self.gsm.get_good_ingress_teeth_1()
    ...
    def r12855_condition(self):
        return not self.gsm.get_know_mimir()
    ...
    def r13774_condition(self):
        return not self.gsm.get_know_chaosmen()


    def r13775_condition(self):
        return self.gsm.get_know_chaosmen()
    ...
    def r28744_condition(self):
        return self.gsm.gcm.get_character_property('protagonist', 'charisma') > 14


    def r28745_condition(self):
        return self.gsm.gcm.get_character_property('protagonist', 'charisma') < 15
    ...
    def r65541_condition(self):
        return not self.gsm.get_morte_talent()


    def r65542_condition(self):
        return self.gsm.get_morte_talent()


    def r65543_condition(self):
        return self.gsm.get_morte_tattoo_xp()


    def r65545_condition(self):
        return self.gsm.get_know_mimir() and \
               not self.gsm.get_morte_story()
    ...
    def r65547_condition(self):
        return self.gsm.get_know_morte_pillar()


    def r65548_condition(self):
        return self.gsm.get_know_blood_war()
    ...
    def r53627_condition(self):
        return not self.gsm.get_morte_story()
    ...
    def r53663_condition(self):
        return not self.gsm.get_in_party_annah()
    ...
    def r53832_condition(self):
        return self.gsm.get_specialist() == 4


    def r53833_condition(self):
        return self.gsm.get_specialist() == 5


    def r53834_condition(self):
        return self.gsm.get_specialist() == 6


    def r53835_condition(self):
        return self.gsm.get_specialist() != 4 and \
               self.gsm.get_specialist() != 5 and \
    ...
    def r54167_condition(self):
        return self.gsm.get_in_party_dakkon() and \
               self.gsm.gcm.get_character_property('protagonist', 'wisdom') < 14
    ...
    def r54179_condition(self):
        return self.gsm.get_morte_quip_regret_portal() > 1 and \
    ...
    def r54250_condition(self):
        return self.gsm.get_bd_morte_morale() > 5


    def r54252_condition(self):
        return self.gsm.get_bd_morte_morale() < 6
    ...
    def r54264_condition(self):
        return self.gsm.gcm.get_character_property('protagonist', 'wisdom') > 15
    ...
    def r54278_condition(self):
        return self.gsm.get_in_party_morte() and \
               self.gsm.get_morte_morale_fortress_portal() == 0
    ...
    def r54286_condition(self):
        return not self.gsm.get_ravel_morte()
    ...
    def r61412_condition(self):
        return PartyGoldLT(500)


    def r65554_condition(self):
        return self.gsm.get_morte_warning()
    ...
    def r65569_condition(self):
        return not self.gsm.get_morte_tattoo_xp()
    ...
    def r65613_condition(self):
        return self.gsm.get_morte_stolen() > 2
    ...
    def r65644_condition(self):
        return self.gsm.get_know_ravel() and \
               not self.gsm.get_know_ravel_key()
    ...
    def r65674_condition(self):
        return self.gsm.get_know_ravel_key()
    ...
    def r65700_condition(self):
        return self.gsm.get_grace_silver_mimir()


    def r65708_condition(self):
        return self.gsm.get_grace_smell_mimir()
    ...
    def r65750_condition(self):
        return not self.gsm.get_chaotic_morte_1()


    def r65751_condition(self):
        return not self.gsm.get_lawful_morte_1()
    ...
    def r65774_condition(self):
        return not self.gsm.get_memory_morte_pillar()


    def r65775_condition(self):
        return self.gsm.get_memory_morte_pillar()
    ...
    def r65801_condition(self):
        return not self.gsm.get_know_morte_pillar()
    ...
    def r68178_condition(self):
        return not self.gsm.get_trans_vanish() and \
               false  # GlobalGT("Fortress_Party_Roof","GLOBAL",1)


    def r68189_condition(self):
        return self.gsm.get_trans_vanish() and \
               self.gsm.get_fortress_dakkon()


    def r68190_condition(self):
        return self.gsm.get_trans_vanish() and \
               not self.gsm.get_fortress_dakkon() and \
               self.gsm.get_fortress_annah()


    def r68191_condition(self):
        return self.gsm.get_trans_vanish() and \
               not self.gsm.get_fortress_dakkon() and \
               not self.gsm.get_fortress_annah() and \
               self.gsm.get_fortress_grace()
    ...
    def r68192_condition(self):
        return self.gsm.get_trans_vanish() and \
               not self.gsm.get_fortress_dakkon() and \
               not self.gsm.get_fortress_annah() and \
               not self.gsm.get_fortress_grace() and \
               self.gsm.get_fortress_ignus() and \
               not self.gsm.get_fortress_ignus_battle()
    ...
    def r68193_condition(self):
        return self.gsm.get_trans_vanish() and \
               ...
               not self.gsm.get_fortress_annah() and \
               not self.gsm.get_fortress_grace() and \
               not self.gsm.get_fortress_ignus() and \
    ...
    def r68194_condition(self):
        return self.gsm.get_trans_vanish() and \
               ...
               not self.gsm.get_fortress_grace() and \
               not self.gsm.get_fortress_ignus() and \
               not self.gsm.get_fortress_vhailor() and \
               self.gsm.get_fortress_nordom()
    ...
    def r68239_condition(self):
        return self.gsm.get_trans_vanish() and \
               ...
               not self.gsm.get_fortress_ignus() and \
               not self.gsm.get_fortress_vhailor() and \
               not self.gsm.get_fortress_nordom()
    ...
    def r68438_condition(self):
        return self.gsm.get_trans_vanish() and \
               ...
               not self.gsm.get_fortress_ignus() and \
               self.gsm.get_fortress_vhailor() and \
               self.gsm.get_fortress_vhailor_battle() and \
               not self.gsm.get_fortress_nordom()
    ...
    def r68175_condition(self):
        return self.gsm.get_fortress_annah()


    def r68179_condition(self):
        return self.gsm.get_fortress_dakkon()


    def r68180_condition(self):
        return self.gsm.get_fortress_grace()


    def r68181_condition(self):
        return self.gsm.get_fortress_nordom()


    def r68182_condition(self):
        return self.gsm.get_fortress_ignus() and \
               not self.gsm.get_fortress_ignus_battle()


    def r68183_condition(self):
        return self.gsm.get_fortress_vhailor() and \
               not self.gsm.get_fortress_vhailor_battle()
    ...
    def r68320_condition(self):
        return self.gsm.get_fortress_dakkon() and \
               not self.gsm.get_fortress_annah()


    def r68321_condition(self):
        return self.gsm.get_fortress_grace() and \
               not self.gsm.get_fortress_dakkon() and \
               not self.gsm.get_fortress_annah()


    def r68322_condition(self):
        return self.gsm.get_fortress_nordom() and \
               not self.gsm.get_fortress_grace() and \
               not self.gsm.get_fortress_dakkon() and \
               not self.gsm.get_fortress_annah()
    ...
    def r68323_condition(self):
        return self.gsm.get_fortress_ignus() and \
               not self.gsm.get_fortress_ignus_battle() and \
               not self.gsm.get_fortress_nordom() and \
               not self.gsm.get_fortress_grace() and \
               not self.gsm.get_fortress_dakkon() and \
               not self.gsm.get_fortress_annah()
    ...
    def r68324_condition(self):
        return self.gsm.get_fortress_vhailor() and \
               not self.gsm.get_fortress_vhailor_battle() and \
               not self.gsm.get_fortress_ignus() and \
               not self.gsm.get_fortress_nordom() and \
               not self.gsm.get_fortress_grace() and \
               not self.gsm.get_fortress_dakkon() and \
    ...
    def r68325_condition(self):
        return not self.gsm.get_fortress_vhailor() and \
               not self.gsm.get_fortress_ignus() and \
               not self.gsm.get_fortress_nordom() and \
               not self.gsm.get_fortress_grace() and \
               not self.gsm.get_fortress_dakkon() and \
    ...
    def r68490_condition(self):
        return self.gsm.get_fortress_vhailor() and \
               ...
               not self.gsm.get_fortress_dakkon() and \
               not self.gsm.get_fortress_annah() and \
               self.gsm.get_fortress_ignus_battle()
