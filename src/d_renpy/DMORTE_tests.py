...
class MorteLogicTest(LogicTest):
    ...
    def test_r1088_action(self):
        self._false_then_true_action(
            self.state_manager.get_read_scars,
    ...
    def test_r1845_action(self):
        self._false_then_true_action(
            self.state_manager.get_morte_harlot_quip_1,
    ...
    def test_r2080_action(self):
        self.state_manager.set_know_mimir(False)
        morte_mimir_before = 0
        morte_mimir_after = 1
        morte_mimir_after_once = 1
        self.state_manager.set_morte_mimir(morte_mimir_before)

        self.assertFalse(self.state_manager.get_know_mimir())
        self.assertEqual(self.state_manager.get_morte_mimir(), morte_mimir_before)

        self.logic.r2080_action()

        self.assertTrue(self.state_manager.get_know_mimir())
        self.assertEqual(self.state_manager.get_morte_mimir(), morte_mimir_after)

        self.logic.r2080_action()

        self.assertTrue(self.state_manager.get_know_mimir())
        self.assertEqual(self.state_manager.get_morte_mimir(), morte_mimir_after_once)


    def test_r9029_action(self):
        self._false_then_true_action(
            self.state_manager.get_know_gith,
    ...
    def test_r2603_action(self):
        self._false_then_true_action(
            self.state_manager.get_morte_quip,
    ...
    def test_r6952_action(self):
        self._false_then_true_action(
            self.state_manager.get_know_lady,
    ...
    def test_r3871_action(self):
        ...
        self._integer_equals_action(
            self.state_manager.get_warning,
            1,
    ...
    def test_r3874_action(self):
        self.state_manager.set_warning(3)
        self._integer_equals_action(
            self.state_manager.get_warning,
            2,
    ...
    def test_r6075_action(self):
        self._false_then_true_action(
            self.state_manager.get_morte_deionarra_quip_1,
    ...
    def test_r6957_action(self):
        self.state_manager.set_translate_dabus(1)
        self._integer_equals_action(
            self.state_manager.get_translate_dabus,
            0,
    ...
    def test_r7056_action(self):
        self._false_then_true_action(
            self.state_manager.get_morte_zombie_female_bar_quip,
    ...
    def test_r7483_action(self):
        self._integer_inc_action(
            self.state_manager.get_bd_morte_morale,
            1,
    ...
    def test_r7485_action(self):
        self._integer_inc_action(
            self.state_manager.get_morte_taunt,
            1,
    ...
    def test_r11977_action(self):
        self.state_manager.set_ingress_teeth_installed(False)
        who_law = 'protagonist'
        prop_law = 'law'
        delta_law = -1
        who_good = 'protagonist'
        ...
        self.assertFalse(self.state_manager.get_ingress_teeth_installed())
        law_before = self.state_manager.characters_manager.get_property(who_law, prop_law)
        good_before = self.state_manager.characters_manager.get_property(who_good, prop_good)

        self.logic.r11977_action()

        self.assertTrue(self.state_manager.get_ingress_teeth_installed())
        law_after = self.state_manager.characters_manager.get_property(who_law, prop_law)
        self.assertEqual(law_before + delta_law, law_after)
        good_after = self.state_manager.characters_manager.get_property(who_good, prop_good)
        self.assertEqual(good_before + delta_good, good_after)
    ...
    def test_r11982_action(self):
        self._integer_dec_action(
            self.state_manager.get_morale_morte,
            1,
    ...
    def test_r11983_action(self):
        self._false_then_true_action(
            self.state_manager.get_ingress_teeth_installed,
    ...
    def test_r12556_action(self):
        self.state_manager.set_baria(3)
        self._integer_equals_action(
            self.state_manager.get_baria,
            2,
    ...
    def test_r12860_action(self):
        self.state_manager.set_morte_mimir(2)
        self._integer_equals_action(
    ...
    def test_r13774_action(self):
        self.state_manager.set_morte_sdthug_quip_1(False)
        self.state_manager.set_know_chaosmen(False)

        self.assertFalse(self.state_manager.get_morte_sdthug_quip_1())
        self.assertFalse(self.state_manager.get_know_chaosmen())

        self.logic.r13774_action()

        self.assertTrue(self.state_manager.get_morte_sdthug_quip_1())
        self.assertTrue(self.state_manager.get_know_chaosmen())
    ...
    def test_r13775_action(self):
        self._false_then_true_action(
            self.state_manager.get_morte_sdthug_quip_1,
    ...
    def test_r13986_action(self):
        self.state_manager.set_morte_wilder_quip_1(False)
        self.state_manager.set_know_chaosmen(False)

        self.assertFalse(self.state_manager.get_morte_wilder_quip_1())
        self.assertFalse(self.state_manager.get_know_chaosmen())

        self.logic.r13986_action()

        self.assertTrue(self.state_manager.get_morte_wilder_quip_1())
        self.assertTrue(self.state_manager.get_know_chaosmen())
    ...
    def test_r13987_action(self):
        self._false_then_true_action(
            self.state_manager.get_morte_wilder_quip_1,
    ...
    def test_r15495_action(self):
        self.state_manager.set_adyzoel(3)
        self._integer_equals_action(
            self.state_manager.get_adyzoel,
            2,
    ...
    def test_r16882_action(self):
        self._integer_inc_action(
            self.state_manager.get_tree_helpers,
            1,
    ...
    def test_r16888_action(self):
        ...
        self.state_manager.set_bd_dakkon_morale(bd_dakkon_morale_before)
        self.state_manager.set_tree_d(False)

        self.assertEqual(self.state_manager.get_bd_dakkon_morale(), bd_dakkon_morale_before)
        self.assertFalse(self.state_manager.get_tree_d())

        self.logic.r16888_action()

        self.assertEqual(self.state_manager.get_bd_dakkon_morale(), bd_dakkon_morale_after)
        self.assertTrue(self.state_manager.get_tree_d())

        self.logic.r16888_action()

        self.assertEqual(self.state_manager.get_bd_dakkon_morale(), bd_dakkon_morale_after_once)
        self.assertTrue(self.state_manager.get_tree_d())


    def test_r16889_action(self):
        self._false_then_true_action(
            self.state_manager.get_tree_n,
    ...
    def test_r18835_action(self):
        ...
        self.state_manager.set_gold(gold_before)
        who_good = 'protagonist'
        prop_good = 'good'
        delta_good = 1

        self.assertEqual(self.state_manager.get_gold(), gold_before)
        good_before = self.state_manager.characters_manager.get_property(who_good, prop_good)

        self.logic.r18835_action()

        self.assertEqual(self.state_manager.get_gold(), gold_after)
        good_after = self.state_manager.characters_manager.get_property(who_good, prop_good)
        self.assertEqual(good_before + delta_good, good_after)

        self.logic.r18835_action()

        self.assertEqual(self.state_manager.get_gold(), gold_after_once)
        good_after_once = self.state_manager.characters_manager.get_property(who_good, prop_good)
        self.assertEqual(good_after, good_after_once)
    ...
    def test_r20612_action(self):
        ...
        self.state_manager.set_know_marta_work(know_marta_work_before)
        note_id = '20538'

        self.assertEqual(self.state_manager.get_know_marta_work(), know_marta_work_before)
        self.assertFalse(self.state_manager.journal_manager.has_journal_note(note_id))

        self.logic.r20612_action()

        self.assertEqual(self.state_manager.get_know_marta_work(), know_marta_work_after)
        self.assertTrue(self.state_manager.journal_manager.has_journal_note(note_id))

        self.logic.r20612_action()

        self.assertEqual(self.state_manager.get_know_marta_work(), know_marta_work_after_once)
        self.assertTrue(self.state_manager.journal_manager.has_journal_note(note_id))
    ...
    def test_r28743_action(self):
        self.state_manager.set_morte_stolen(4)
        self._integer_equals_action(
            self.state_manager.get_morte_stolen,
            3,
    ...
    def test_r28744_action(self):
        ...
        self.state_manager.set_bd_morte_morale(bd_morte_morale_before)
        morte_stolen_before = 1
        morte_stolen_after = 3
        morte_stolen_after_once = 3
        self.state_manager.set_morte_stolen(morte_stolen_before)

        self.assertEqual(self.state_manager.get_bd_morte_morale(), bd_morte_morale_before)
        self.assertEqual(self.state_manager.get_morte_stolen(), morte_stolen_before)

        self.logic.r28744_action()

        self.assertEqual(self.state_manager.get_bd_morte_morale(), bd_morte_morale_after)
        self.assertEqual(self.state_manager.get_morte_stolen(), morte_stolen_after)

        self.logic.r28744_action()

        self.assertEqual(self.state_manager.get_bd_morte_morale(), bd_morte_morale_after_once)
        self.assertEqual(self.state_manager.get_morte_stolen(), morte_stolen_after_once)
    ...
    def test_r28968_action(self):
        self.state_manager.set_qui_sai(3)
        self._integer_equals_action(
            self.state_manager.get_qui_sai,
            2,
    ...
    def test_r32370_action(self):
        self.state_manager.set_lecture_death(3)
        self._integer_equals_action(
            self.state_manager.get_lecture_death,
            2,
    ...
    def test_r33076_action(self):
        self.state_manager.set_lecture_ghysis(3)
        self._integer_equals_action(
            self.state_manager.get_lecture_ghysis,
            2,
    ...
    def test_r39716_action(self):
        self._false_then_true_action(
            self.state_manager.get_yves_shared,
    ...
    def test_r40848_action(self):
        self._false_then_true_action(
            self.state_manager.get_met_modrons,
    ...
    def test_r41921_action(self):
        self.state_manager.set_jumble_reekwind(False)
        note_id = '67862'

        self.assertFalse(self.state_manager.get_jumble_reekwind())
        self.assertFalse(self.state_manager.journal_manager.has_journal_note(note_id))

        self.logic.r41921_action()

        self.assertTrue(self.state_manager.get_jumble_reekwind())
        self.assertTrue(self.state_manager.journal_manager.has_journal_note(note_id))
    ...
    def test_r43910_action(self):
        ...
        self.state_manager.set_nemelle(nemelle_before)
        aelwyn_value_before = 1
        aelwyn_value_after = 4
        aelwyn_value_after_once = 4
        self.state_manager.set_aelwyn_value(aelwyn_value_before)
        note_id = '39490'

        self.assertEqual(self.state_manager.get_nemelle(), nemelle_before)
        self.assertEqual(self.state_manager.get_aelwyn_value(), aelwyn_value_before)
        self.assertFalse(self.state_manager.journal_manager.has_journal_note(note_id))

        self.logic.r43910_action()

        self.assertEqual(self.state_manager.get_nemelle(), nemelle_after)
        self.assertEqual(self.state_manager.get_aelwyn_value(), aelwyn_value_after)
        self.assertTrue(self.state_manager.journal_manager.has_journal_note(note_id))

        self.logic.r43910_action()

        self.assertEqual(self.state_manager.get_nemelle(), nemelle_after_once)
        self.assertEqual(self.state_manager.get_aelwyn_value(), aelwyn_value_after_once)
        self.assertTrue(self.state_manager.journal_manager.has_journal_note(note_id))
    ...
    def test_r52577_action(self):
        self.state_manager.set_ravel_grace(3)
        self._integer_equals_action(
            self.state_manager.get_ravel_grace,
            2,
    ...
    def test_r52578_action(self):
        self.state_manager.set_ravel_annah(3)
        self._integer_equals_action(
            self.state_manager.get_ravel_annah,
            2,
    ...
    def test_r53629_action(self):
        self.state_manager.set_morte_story(False)
        note_id = '53633'

        self.assertFalse(self.state_manager.get_morte_story())
        self.assertFalse(self.state_manager.journal_manager.has_journal_note(note_id))

        self.logic.r53629_action()

        self.assertTrue(self.state_manager.get_morte_story())
        self.assertTrue(self.state_manager.journal_manager.has_journal_note(note_id))
    ...
    def test_r53630_action(self):
        ...
        self.state_manager.set_morale_morte(morale_morte_before)
        self.state_manager.set_morte_story(False)
        note_id = '53661'

        self.assertEqual(self.state_manager.get_morale_morte(), morale_morte_before)
        self.assertFalse(self.state_manager.get_morte_story())
        self.assertFalse(self.state_manager.journal_manager.has_journal_note(note_id))

        self.logic.r53630_action()

        self.assertEqual(self.state_manager.get_morale_morte(), morale_morte_after)
        self.assertTrue(self.state_manager.get_morte_story())
        self.assertTrue(self.state_manager.journal_manager.has_journal_note(note_id))

        self.logic.r53630_action()

        self.assertEqual(self.state_manager.get_morale_morte(), morale_morte_after_once)
        self.assertTrue(self.state_manager.get_morte_story())
        self.assertTrue(self.state_manager.journal_manager.has_journal_note(note_id))
    ...
    def test_r53825_action(self):
        self._false_then_true_action(
            self.state_manager.get_pillar_musk,
    ...
    def test_r53841_action(self):
        self.state_manager.set_pillar_question(1)
        self._integer_equals_action(
            self.state_manager.get_pillar_question,
            0,
    ...
    def test_r53843_action(self):
        ...
        pillar_after = 2
        pillar_after_once = 2
        self.state_manager.set_pillar(pillar_before)

        good_before = self.state_manager.characters_manager.get_property(who_good, prop_good)
        self.assertEqual(self.state_manager.get_pillar(), pillar_before)

        self.logic.r53843_action()

        good_after = self.state_manager.characters_manager.get_property(who_good, prop_good)
        self.assertEqual(good_before + delta_good, good_after)
        self.assertEqual(self.state_manager.get_pillar(), pillar_after)

        self.logic.r53843_action()

        good_after_once = self.state_manager.characters_manager.get_property(who_good, prop_good)
        self.assertEqual(good_after, good_after_once)
        self.assertEqual(self.state_manager.get_pillar(), pillar_after_once)
    ...
    def test_r54244_action(self):
        self.state_manager.set_morte_quip_regret_portal(3)
        self._integer_equals_action(
            self.state_manager.get_morte_quip_regret_portal,
            2,
    ...
    def test_r54278_action(self):
        ...
        bd_morte_morale_after_once = 2 * 1
        self.state_manager.set_bd_morte_morale(bd_morte_morale_before)
        self.state_manager.set_morte_morale_fortress_portal(False)

        self.assertEqual(self.state_manager.get_bd_morte_morale(), bd_morte_morale_before)
        self.assertFalse(self.state_manager.get_morte_morale_fortress_portal())

        self.logic.r54278_action()

        self.assertEqual(self.state_manager.get_bd_morte_morale(), bd_morte_morale_after)
        self.assertTrue(self.state_manager.get_morte_morale_fortress_portal())
    ...
    def test_s576_action(self):
        self._false_then_true_action(
            self.state_manager.get_know_source,
    ...
    def test_r55925_action(self):
        self._false_then_true_action(
            self.state_manager.get_know_mechanus,
    ...
    def test_s603_action(self):
        self._integer_inc_action(
            self.state_manager.get_grace_talked_morte,
            1,
    ...
    def test_s611_action(self):
        self.state_manager.set_grace_talked_morte(1)
        self._integer_equals_action(
            self.state_manager.get_grace_talked_morte,
            0,
    ...
    def test_s615_action(self):
        self.state_manager.set_annah_talked_morte(4)
        self._integer_equals_action(
            self.state_manager.get_annah_talked_morte,
            3,
    ...
    def test_s620_action(self):
        self.state_manager.set_annah_talked_morte(9)
        self._integer_equals_action(
            self.state_manager.get_annah_talked_morte,
            8,
    ...
    def test_s622_action(self):
        self.state_manager.set_annah_talked_morte(1)
        self._integer_equals_action(
            self.state_manager.get_annah_talked_morte,
            0,
    ...
    def test_s623_action(self):
        self.state_manager.set_nordom_talked_morte(2)
        self._integer_equals_action(
            self.state_manager.get_nordom_talked_morte,
            1,
    ...
    def test_s625_action(self):
        self.state_manager.set_nordom_talked_morte(4)
        self._integer_equals_action(
            self.state_manager.get_nordom_talked_morte,
            3,
    ...
    def test_s628_action(self):
        self.state_manager.set_nordom_talked_morte(6)
        self._integer_equals_action(
            self.state_manager.get_nordom_talked_morte,
            5,
    ...
    def test_s629_action(self):
        self.state_manager.set_nordom_talked_morte(7)
        self._integer_equals_action(
            self.state_manager.get_nordom_talked_morte,
            6,
    ...
    def test_s631_action(self):
        self.state_manager.set_nordom_talked_morte(8)
        self._integer_equals_action(
            self.state_manager.get_nordom_talked_morte,
            7,
    ...
    def test_s633_action(self):
        self.state_manager.set_nordom_talked_morte(9)
        self._integer_equals_action(
            self.state_manager.get_nordom_talked_morte,
            8,
    ...
    def test_s635_action(self):
        self.state_manager.set_nordom_talked_morte(10)
        self._integer_equals_action(
            self.state_manager.get_nordom_talked_morte,
            9,
    ...
    def test_s642_action(self):
        self.state_manager.set_nordom_talked_morte(1)
        self._integer_equals_action(
            self.state_manager.get_nordom_talked_morte,
            0,
    ...
    def test_s643_action(self):
        self.state_manager.set_nordom_talked_annah(1)
        self._integer_equals_action(
            self.state_manager.get_nordom_talked_annah,
            0,
    ...
    def test_s644_action(self):
        self.state_manager.set_nordom_talked_grace(3)
        self._integer_equals_action(
            self.state_manager.get_nordom_talked_grace,
            2,
    ...
    def test_s645_action(self):
        self.state_manager.set_nordom_talked_grace(4)
        self._integer_equals_action(
            self.state_manager.get_nordom_talked_grace,
            3,
    ...
    def test_r65569_action(self):
        self.state_manager.set_morte_tattoo_xp(False)
        who_experience = 'protagonist'
        prop_experience = 'experience'
        delta_experience = 1000

        self.assertFalse(self.state_manager.get_morte_tattoo_xp())
        experience_before = self.state_manager.characters_manager.get_property(who_experience, prop_experience)

        self.logic.r65569_action()

        self.assertTrue(self.state_manager.get_morte_tattoo_xp())
        experience_after = self.state_manager.characters_manager.get_property(who_experience, prop_experience)
        self.assertEqual(experience_before + delta_experience, experience_after)
    ...
    def test_r65621_action(self):
        self._false_then_true_action(
            self.state_manager.get_morte_talent,
    ...
    def test_r65731_action(self):
        self._false_then_true_action(
            self.state_manager.get_morte_story,
    ...
    def test_r65774_action(self):
        self.state_manager.set_memory_morte_pillar(False)
        who_experience = 'protagonist'
        prop_experience = 'experience'
        delta_experience = 12000

        self.assertFalse(self.state_manager.get_memory_morte_pillar())
        experience_before = self.state_manager.characters_manager.get_property(who_experience, prop_experience)

        self.logic.r65774_action()

        self.assertTrue(self.state_manager.get_memory_morte_pillar())
        experience_after = self.state_manager.characters_manager.get_property(who_experience, prop_experience)
        self.assertEqual(experience_before + delta_experience, experience_after)
    ...
    def test_s713_action(self):
        self.state_manager.set_know_morte_pillar(2)
        self._integer_equals_action(
            self.state_manager.get_know_morte_pillar,
            1,
    ...
    def test_s719_action(self):
        self.state_manager.set_know_morte_pillar(3)
        self._integer_equals_action(
            self.state_manager.get_know_morte_pillar,
            2,
    ...
    def test_r65821_action(self):
        ...
        self.state_manager.set_bd_morte_story(False)
        note_id = '65825'
        ...
        self.assertFalse(self.state_manager.get_bd_morte_story())
        self.assertFalse(self.state_manager.journal_manager.has_journal_note(note_id))
        ...
        self.assertTrue(self.state_manager.get_bd_morte_story())
        self.assertTrue(self.state_manager.journal_manager.has_journal_note(note_id))
    ...
    def test_r68176_action(self):
        ...
        self.state_manager.set_fortress_morte(fortress_morte_before)
        self.state_manager.set_in_party_morte(False)

        self.assertEqual(self.state_manager.get_fortress_morte(), fortress_morte_before)
        self.assertFalse(self.state_manager.get_in_party_morte())

        self.logic.r68176_action()

        self.assertEqual(self.state_manager.get_fortress_morte(), fortress_morte_after)
        self.assertTrue(self.state_manager.get_in_party_morte())

        self.logic.r68176_action()

        self.assertEqual(self.state_manager.get_fortress_morte(), fortress_morte_after_once)
        self.assertTrue(self.state_manager.get_in_party_morte())
    ...
    def test_r1006_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_read_scars(x),
    ...
    def test_r9029_condition(self):
        self._boolean_invert_condition(
            lambda x: self.state_manager.set_know_gith(x),
    ...
    def test_r6952_condition(self):
        self._boolean_invert_condition(
            lambda x: self.state_manager.set_know_lady(x),
    ...
    def test_r3971_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_has_prybar(x),
    ...
    def test_r64535_condition(self):
        self._boolean_invert_condition(
            lambda x: self.state_manager.set_vaxis_global_xp(x),
    ...
    def test_r6325_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_has_cobble(x),
    ...
    def test_r6664_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_42_secret(x),
    ...
    def test_r6665_condition(self):
        ...
        self.state_manager.characters_manager.set_property(who_wisdom, prop_wisdom, delta_wisdom + 1)
        self.state_manager.set_42_secret(False)
    ...
    def test_r11985_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_evil_ingress_teeth_1(x),
    ...
    def test_r11986_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_good_ingress_teeth_1(x),
    ...
    def test_r12855_condition(self):
        self._boolean_invert_condition(
            lambda x: self.state_manager.set_know_mimir(x),
    ...
    def test_r13774_condition(self):
        self._boolean_invert_condition(
            lambda x: self.state_manager.set_know_chaosmen(x),
    ...
    def test_r13989_condition(self):
        self._integer_equal_condition(
            lambda x: self.state_manager.set_join_chaosmen(x),
            0,
    ...
    def test_r14275_condition(self):
        self.state_manager.set_mortai_contract(False)
        self.state_manager.set_coppereyes_contract(-1)

        self.assertFalse(self.logic.r14275_condition())

        self.state_manager.set_mortai_contract(True)
        self.state_manager.set_coppereyes_contract(1)
    ...
    def test_r14276_condition(self):
        ...
        self.state_manager.set_mortai_contract(True)
        self.state_manager.set_coppereyes_contract(0)
    ...
    def test_r16887_condition(self):
        ...
        self.state_manager.set_tree_d(True)
    ...
    def test_r16888_condition(self):
        self.state_manager.set_in_party_dakkon(False)
        self.state_manager.set_tree_d(True)
        self.state_manager.set_dakkon_slave(False)

        self.assertFalse(self.logic.r16888_condition())

        self.state_manager.set_in_party_dakkon(True)
        self.state_manager.set_tree_d(False)
        self.state_manager.set_dakkon_slave(True)
    ...
    def test_r17583_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_in_party_annah(x),
    ...
    def test_r17584_condition(self):
        self._integer_gt_condition(
            lambda x: self.state_manager.set_gold(x),
            39,
    ...
    def test_r20612_condition(self):
        self._integer_lt_condition(
            lambda x: self.state_manager.set_know_marta_work(x),
            3,
    ...
    def test_r28038_condition(self):
        self.state_manager.set_malmaner(0)
        self.state_manager.set_chaotic_malmaner_1(1)

        self.assertFalse(self.logic.r28038_condition())

        self.state_manager.set_malmaner(3)
        self.state_manager.set_chaotic_malmaner_1(0)
    ...
    def test_r28045_condition(self):
        self.state_manager.set_malmaner(0)
        self.state_manager.set_chaotic_malmaner_1(3)

        self.assertFalse(self.logic.r28045_condition())

        self.state_manager.set_malmaner(5)
        self.state_manager.set_chaotic_malmaner_1(0)
    ...
    def test_r28968_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_cw_sal_hint(x),
    ...
    def test_r28980_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_know_ravel(x),
    ...
    def test_r30825_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_able(x),
    ...
    def test_r65541_condition(self):
        self._boolean_invert_condition(
            lambda x: self.state_manager.set_morte_talent(x),
    ...
    def test_r65543_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_morte_tattoo_xp(x),
    ...
    def test_r65545_condition(self):
        self.state_manager.set_know_mimir(False)
        self.state_manager.set_morte_story(True)
    ...
    def test_r65546_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_morte_story(x),
    ...
    def test_r65547_condition(self):
        self._integer_equal_condition(
            lambda x: self.state_manager.set_know_morte_pillar(x),
            1,
    ...
    def test_r65548_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_know_blood_war(x),
            self.logic.r65548_condition
        )


    def test_r65549_condition(self):
        self.state_manager.set_know_ravel(False)
        self.state_manager.set_ravel_value(1)

        self.assertFalse(self.logic.r65549_condition())

        self.state_manager.set_know_ravel(True)
        self.state_manager.set_ravel_value(0)
    ...
    def test_r40077_condition(self):
        self._integer_equal_condition(
            lambda x: self.state_manager.set_nenny(x),
            2,
    ...
    def test_r41921_condition(self):
        self.state_manager.set_story_reekwind_curse(False)
        self.state_manager.set_jumble_reekwind(True)

        self.assertFalse(self.logic.r41921_condition())

        self.state_manager.set_story_reekwind_curse(True)
        self.state_manager.set_jumble_reekwind(False)
    ...
    def test_r67864_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_jumble_reekwind(x),
            self.logic.r67864_condition
        )


    def test_r43909_condition(self):
        self.state_manager.set_has_decant(False)
        self.state_manager.set_seek_word(0)

        self.assertFalse(self.logic.r43909_condition())

        self.state_manager.set_has_decant(True)
        self.state_manager.set_seek_word(1)

        self.assertTrue(self.logic.r43909_condition())


    def test_r43910_condition(self):
        self.state_manager.set_aelwyn_value(0)
        self.state_manager.set_dead_aelwyn(True)

        self.assertFalse(self.logic.r43910_condition())

        self.state_manager.set_aelwyn_value(2)
        self.state_manager.set_dead_aelwyn(False)
    ...
    def test_r43911_condition(self):
        self._integer_lt_condition(
            lambda x: self.state_manager.set_aelwyn_value(x),
            2,
    ...
    def test_r52577_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_in_party_grace(x),
    ...
    def test_r53832_condition(self):
        self._integer_equal_condition(
            lambda x: self.state_manager.set_specialist(x),
            4,
    ...
    def test_r53835_condition(self):
        self.state_manager.set_specialist(4)
        self.state_manager.set_specialist(5)
        self.state_manager.set_specialist(6)

        self.assertFalse(self.logic.r53835_condition())

        self.state_manager.set_specialist(0)
        self.state_manager.set_specialist(0)
        self.state_manager.set_specialist(0)
    ...
    def test_r53836_condition(self):
        self._boolean_invert_condition(
            lambda x: self.state_manager.set_where_fhjull(x),
            self.logic.r53836_condition
        )


    def test_r53837_condition(self):
        self.state_manager.set_where_fhjull(False)
        self.state_manager.set_has_cube(False)

        self.assertFalse(self.logic.r53837_condition())

        self.state_manager.set_where_fhjull(True)
        self.state_manager.set_has_cube(True)
    ...
    def test_r54179_condition(self):
        self.state_manager.set_morte_quip_regret_portal(0)
        self.state_manager.set_in_party_morte(False)

        self.assertFalse(self.logic.r54179_condition())

        self.state_manager.set_morte_quip_regret_portal(2)
        self.state_manager.set_in_party_morte(True)
    ...
    def test_r54221_condition(self):
        ...
        self.state_manager.characters_manager.set_property(who_intelligence, prop_intelligence, delta_intelligence)
        self.state_manager.set_in_party_dakkon(True)
        self.state_manager.set_dakkon_value(-1)
    ...
    def test_r54223_condition(self):
        ...
        self.state_manager.characters_manager.set_property(who_intelligence, prop_intelligence, delta_intelligence + 1)
        self.state_manager.set_in_party_dakkon(False)
        self.state_manager.set_dakkon_value(0)
    ...
    def test_r54250_condition(self):
        self._integer_gt_condition(
            lambda x: self.state_manager.set_bd_morte_morale(x),
            5,
    ...
    def test_r54278_condition(self):
        self.state_manager.set_in_party_morte(False)
        self.state_manager.set_morte_morale_fortress_portal(True)
    ...
    def test_r54282_condition(self):
        self.state_manager.set_ravel_grace(-1)
        self.state_manager.set_ravel_morte(-1)
        self.state_manager.set_torment_fell(3)
        self.state_manager.set_in_party_grace(False)
        ...
        self.state_manager.set_ravel_grace(1)
        self.state_manager.set_ravel_morte(1)
        self.state_manager.set_torment_fell(1)
        self.state_manager.set_in_party_grace(True)
    ...
    def test_r54283_condition(self):
        self.state_manager.set_ravel_grace(-1)
        self.state_manager.set_ravel_morte(-1)
        self.state_manager.set_torment_fell(0)
        self.state_manager.set_in_party_grace(False)
        ...
        self.state_manager.set_ravel_grace(1)
        self.state_manager.set_ravel_morte(1)
        self.state_manager.set_torment_fell(2)
        self.state_manager.set_in_party_grace(True)
    ...
    def test_r54286_condition(self):
        self._integer_equal_condition(
            lambda x: self.state_manager.set_ravel_morte(x),
            0,
    ...
    def test_r65554_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_morte_warning(x),
    ...
    def test_r65613_condition(self):
        self._integer_gt_condition(
            lambda x: self.state_manager.set_morte_stolen(x),
            2,
    ...
    def test_r65640_condition(self):
        self.state_manager.set_pharod_value(0)
        self.state_manager.set_pharod_quest(0)

        self.assertFalse(self.logic.r65640_condition())

        self.state_manager.set_pharod_value(1)
        self.state_manager.set_pharod_quest(1)

        self.assertTrue(self.logic.r65640_condition())


    def test_r65641_condition(self):
        location_AR0401 = 'AR0401' # AR0401
    ...
    def test_r65674_condition(self):
        self._integer_equal_condition(
            lambda x: self.state_manager.set_know_ravel_key(x),
            1,
    ...
    def test_r65700_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_grace_silver_mimir(x),
    ...
    def test_r65708_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_grace_smell_mimir(x),
    ...
    def test_r65718_condition(self):
        location_AR1000 = 'AR1000' # AR1000

        self.state_manager.set_grace_smell_mimir(False)
    ...
    def test_r65750_condition(self):
        self._boolean_invert_condition(
            lambda x: self.state_manager.set_chaotic_morte_1(x),
    ...
    def test_r65751_condition(self):
        self._boolean_invert_condition(
            lambda x: self.state_manager.set_lawful_morte_1(x),
    ...
    def test_r65774_condition(self):
        self._boolean_invert_condition(
            lambda x: self.state_manager.set_memory_morte_pillar(x),
    ...
    def test_r68178_condition(self):
        self.state_manager.set_trans_vanish(True)
        self.state_manager.set_fortress_party_roof(0)

        self.assertFalse(self.logic.r68178_condition())

        self.state_manager.set_trans_vanish(False)
        self.state_manager.set_fortress_party_roof(2)
    ...
    def test_r68189_condition(self):
        self.state_manager.set_trans_vanish(False)
        self.state_manager.set_fortress_dakkon(-1)
    ...
    def test_r68190_condition(self):
        self.state_manager.set_trans_vanish(False)
        self.state_manager.set_fortress_dakkon(1)
        self.state_manager.set_fortress_annah(-1)

        self.assertFalse(self.logic.r68190_condition())

        self.state_manager.set_trans_vanish(True)
        self.state_manager.set_fortress_dakkon(0)
        self.state_manager.set_fortress_annah(1)
    ...
    def test_r68191_condition(self):
        ...
        self.state_manager.set_fortress_dakkon(1)
        self.state_manager.set_fortress_annah(1)
        self.state_manager.set_fortress_grace(-1)

        self.assertFalse(self.logic.r68191_condition())

        self.state_manager.set_trans_vanish(True)
        self.state_manager.set_fortress_dakkon(0)
        self.state_manager.set_fortress_annah(0)
        self.state_manager.set_fortress_grace(1)
    ...
    def test_r68192_condition(self):
        ...
        self.state_manager.set_fortress_annah(1)
        self.state_manager.set_fortress_grace(1)
        self.state_manager.set_fortress_ignus(-1)
        self.state_manager.set_fortress_ignus_battle(True)
        ...
        self.state_manager.set_fortress_dakkon(0)
        self.state_manager.set_fortress_annah(0)
        self.state_manager.set_fortress_grace(0)
        self.state_manager.set_fortress_ignus(1)
        self.state_manager.set_fortress_ignus_battle(False)
    ...
    def test_r68193_condition(self):
        ...
        self.state_manager.set_fortress_grace(1)
        self.state_manager.set_fortress_ignus(1)
        self.state_manager.set_fortress_vhailor(-1)
        self.state_manager.set_fortress_vhailor_battle(True)
        ...
        self.state_manager.set_fortress_annah(0)
        self.state_manager.set_fortress_grace(0)
        self.state_manager.set_fortress_ignus(0)
        self.state_manager.set_fortress_vhailor(1)
        self.state_manager.set_fortress_vhailor_battle(False)
    ...
    def test_r68194_condition(self):
        ...
        self.state_manager.set_fortress_ignus(1)
        self.state_manager.set_fortress_vhailor(1)
        self.state_manager.set_fortress_nordom(-1)
        ...
        self.state_manager.set_fortress_grace(0)
        self.state_manager.set_fortress_ignus(0)
        self.state_manager.set_fortress_vhailor(0)
        self.state_manager.set_fortress_nordom(1)
    ...
    def test_r68239_condition(self):
        ...
        self.state_manager.set_fortress_ignus(0)
        self.state_manager.set_fortress_vhailor(0)
        self.state_manager.set_fortress_nordom(0)
    ...
    def test_r68503_condition(self):
        ...
        self.state_manager.set_trans_vanish(False)
        self.state_manager.set_fortress_party_roof(1)
    ...
    def test_r68175_condition(self):
        self._integer_gt_condition(
            lambda x: self.state_manager.set_fortress_annah(x),
            0,
    ...
    def test_r68179_condition(self):
        self._integer_gt_condition(
            lambda x: self.state_manager.set_fortress_dakkon(x),
            0,
    ...
    def test_r68180_condition(self):
        self._integer_gt_condition(
            lambda x: self.state_manager.set_fortress_grace(x),
            0,
    ...
    def test_r68181_condition(self):
        self._integer_gt_condition(
            lambda x: self.state_manager.set_fortress_nordom(x),
            0,
