...
class N1201LogicTest(LogicTest):
    ...
    def test_r44994_action(self):
        ...
        self.state_manager.world_manager.set_1201_note_quest(1201_note_quest_before)

        self.assertFalse(self.state_manager.world_manager.get_ur_1201())
        self.assertEqual(self.state_manager.world_manager.get_1201_note_quest(), 1201_note_quest_before)

        self.logic.r44994_action()

        self.assertTrue(self.state_manager.world_manager.get_ur_1201())
        self.assertEqual(self.state_manager.world_manager.get_1201_note_quest(), 1201_note_quest_after)

        self.logic.r44994_action()

        self.assertTrue(self.state_manager.world_manager.get_ur_1201())
        self.assertEqual(self.state_manager.world_manager.get_1201_note_quest(), 1201_note_quest_after_once)
