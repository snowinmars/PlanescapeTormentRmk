init 10 python:
    from dlgs.s1221_logic import S1221Logic
...
# s0 # say35306
label s1221_s0:  # - # IF ~  True()  Check EXTERN ~DMORTE~ : 376 Check EXTERN ~DMORTE~ : 372 Check EXTERN ~DMORTE~ : 370
...
# s1 # say35308
label s1221_s1:  # from 0.0 0.1 0.2 0.3 # Check EXTERN ~DMORTE~ : 370
...
# s2 # say35334
label s1221_s2:  # from 0.4 # Check EXTERN ~DMORTE~ : 370
...
# s3 # say35339
label s1221_s3:  # from 0.5 # Check EXTERN ~DMORTE~ : 376 Check EXTERN ~DMORTE~ : 370
...
# s4 # say35345
label s1221_s4:  # from 0.7 0.10 3.1 3.4 # Check EXTERN ~DMORTE~ : 370
