...
class S1221LogicTest(LogicTest):
    ...
    def test_s1221_init(self):
        location = 'LOCATION'
        delta_talked_to_s1221_times = 1

        self.assertNotEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_s1221_times(), 0)

        self.logic.s1221_init()

        self.assertEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_s1221_times(), delta_talked_to_s1221_times)

        self.logic.s1221_init()

        self.assertEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_s1221_times(), 2 * delta_talked_to_s1221_times)
