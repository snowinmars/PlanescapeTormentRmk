...
label s996_s0: # - # IF ~  True()
    nr 'Этот скелет довольно стар: кожаные ремешки потрескались и истерлись от времени. На лбу с особым искусством вырезано слово'
    s996 '«ПОКАЙСЯ»'
    nr '; более грубая рука уже позднее высекла на обоих висках число'
    s996 '«996».'
