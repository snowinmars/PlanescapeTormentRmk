...
class S996LogicTest(LogicTest):
    ...
    def test_s996_init(self):
        location = 'LOCATION'
        delta_talked_to_s996_times = 1

        self.assertNotEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_s996_times(), 0)

        self.logic.s996_init()

        self.assertEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_s996_times(), delta_talked_to_s996_times)

        self.logic.s996_init()

        self.assertEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_s996_times(), 2 * delta_talked_to_s996_times)
