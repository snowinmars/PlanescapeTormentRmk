init 10 python:
    from dlgs.vaxis_logic import VaxisLogic
...
# s9 # say1363
label vaxis_s9:  # from 7.3 # Check EXTERN ~DMORTE~ : 85
    SPEAKER 'Он изучает тебя более пристально. Ты фпион? Ты иф яфейки?'
...
# s13 # say4377
label vaxis_s13:  # from 12.0 # Check EXTERN ~DMORTE~ : 87
...
# s23 # say4425
label vaxis_s23:  # from 21.0 22.0 # Check EXTERN ~DMORTE~ : 89
...
# s39 # say4512
label vaxis_s39:  # from 43.12 # Check EXTERN ~DMORTE~ : 93
...
# s46 # say4546
label vaxis_s46:  # from 44.1 45.0 # Check EXTERN ~DMORTE~ : 91
...
# s47 # say4551
label vaxis_s47:  # from 43.7 # Check EXTERN ~DMORTE~ : 92
...
# s65 # say4629
label vaxis_s65:  # from 63.0 # Check EXTERN ~DMORTE~ : 94
...
# s66 # say4633
label vaxis_s66:  # from 65.0 65.2 65.3 # Check EXTERN ~DMORTE~ : 95
