class VaxisLogic:
    ...
    def r464_action(self):
        self.settings_manager.update_journal('64513')
    ...
    def r472_action(self):
        self.settings_manager.character_manager.modify_property_once('protagonist', 'law', -1, 'globalchaotic_vaxis_1')
    ...
    def r476_action(self):
        self.settings_manager.character_manager.modify_property_once('protagonist', 'good', -1, 'globalevil_vaxis_2')


    def r477_action(self):
        self.settings_manager.character_manager.modify_property_once('protagonist', 'law', 1, 'globallawful_vaxis_1')
    ...
    def r493_action(self):
        self.settings_manager.character_manager.modify_property_once('protagonist', 'law', -1, 'globalchaotic_vaxis_2')
    ...
    def r4434_action(self):
        self.settings_manager.character_manager.modify_property_once('protagonist', 'law', -1, 'globalchaotic_vaxis_5')
    ...
    def r4469_action(self):
        ...
        GiveItemCreate("Knife",Protagonist,1,0,0) self.settings_manager.gain_experience('party', 500)
        self.settings_manager.update_journal('64517')
    ...
    def r4474_action(self):
        self.settings_manager.character_manager.modify_property_once('protagonist', 'good', 1, 'globalgood_vaxis_3')
    ...
    def r64520_action(self):
        self.settings_manager.update_journal('64519')
    ...
    def r4503_action(self):
        self.settings_manager.update_journal('64518')
    ...
    def r4521_action(self):
        self.settings_manager.set_embalm_key_quest(3)
        self.settings_manager.update_journal('64521')
    ...
    def r4539_action(self):
        self.settings_manager.update_journal('64522')
    ...
    def r64527_action(self):
        ...
        self.settings_manager.update_journal('64528')
    ...
    def r4568_action(self):
        self.settings_manager.gain_experience('party', 250)
        self.settings_manager.set_vaxis_help(True)
        self.settings_manager.update_journal('64529')
    ...
    def r4580_action(self):
        ...
        self.settings_manager.update_journal('64530')
    ...
    def r4630_action(self):
        FadeToColor([20.0],0) Wait(1) self.settings_manager.character_manager.set_property('protagonist', 'looks_like', 'zombie')
        Wait(2) FadeFromColor([20.0],0) self.settings_manager.gain_experience('party', 500)
    ...
    def r4638_action(self):
        self.settings_manager.update_journal('64531')
    ...
    def r468_condition(self):
        return not self.settings_manager.get_escape_mortuary()
    ...
    def r1306_condition(self):
        return self.settings_manager.character_manager.get_property('protagonist', 'strength') < 12


    def r1348_condition(self):
        return self.settings_manager.character_manager.get_property('protagonist', 'strength') > 11
    ...
    def r4446_condition(self):
        return self.settings_manager.character_manager.get_property('protagonist', 'charisma') < 12 and \
               self.settings_manager.character_manager.get_property('protagonist', 'intelligence') < 12
    ...
    def r4469_condition(self):
        return not self.settings_manager.get_vaxis_leave()
    ...
    def r4494_condition(self):
        return self.settings_manager.get_has_keyem()
    ...
    def r64520_condition(self):
        return self.settings_manager.get_eivene_value() == 1


    def r4503_condition(self):
        return self.settings_manager.get_eivene_value() == 0
    ...
    def r4508_condition(self):
        return self.settings_manager.get_embalm_key_quest() == 0
    ...
    def r4522_condition(self):
        return self.settings_manager.get_escape_mortuary()


    def r64508_condition(self):
        return not self.settings_manager.get_escape_mortuary() and \
               not self.settings_manager.get_vaxis_help() and \
               self.settings_manager.get_embalm_key_quest() == 0 and \
    ...
    def r4524_condition(self):
        return not self.settings_manager.get_escape_mortuary() and \
               not self.settings_manager.get_vaxis_help() and \
               self.settings_manager.get_embalm_key_quest() == 0 and \
               not self.settings_manager.get_strong_arm_vaxis()


    def r4525_condition(self):
        return self.settings_manager.get_vaxis_help()


    def r4526_condition(self):
        return self.settings_manager.get_vaxis_zombie_disguise() == 1 and \
               self.settings_manager.get_appearance() != 1


    def r4527_condition(self):
        return self.settings_manager.get_vaxis_zombie_disguise() == 2 and \
               self.settings_manager.get_appearance() != 1


    def r4528_condition(self):
        return self.settings_manager.get_vaxis_orders()
    ...
    def r4564_condition(self):
        return not self.settings_manager.get_strong_arm_vaxis() and \
               self.settings_manager.get_embalm_key_quest() == 0 and \
               not self.settings_manager.get_vaxis_orders()


    def r64509_condition(self):
        return not self.settings_manager.get_strong_arm_vaxis() and \
               self.settings_manager.get_embalm_key_quest() > 2 and \
               not self.settings_manager.get_vaxis_orders()


    def r64510_condition(self):
        return self.settings_manager.get_strong_arm_vaxis() and \
               not self.settings_manager.get_vaxis_orders()
    ...
    def r64527_condition(self):
        return not self.settings_manager.get_has_bone_chrm()


    def r4568_condition(self):
        return self.settings_manager.get_has_bone_chrm()
    ...
    def r4586_condition(self):
        return self.settings_manager.get_embalm_key_quest() == 1


    def r4587_condition(self):
        return self.settings_manager.get_embalm_key_quest() == 2
    ...
    def r4593_condition(self):
        return self.settings_manager.get_embalm_key_quest() == 2 and \
               self.settings_manager.get_has_keyem()
    ...
    def r4612_condition(self):
        return self.settings_manager.character_manager.get_property('protagonist', 'charisma') > 9
    ...
    def r4630_condition(self):
        return not self.settings_manager.get_in_party_morte() and \
               not self.settings_manager.get_vaxis_global_xp()


    def r4631_condition(self):
        return self.settings_manager.get_in_party_morte() and \
               not self.settings_manager.get_morte_vaxis_quip_1()
    ...
    def r64533_condition(self):
        return not self.settings_manager.get_in_party_morte() and \
               self.settings_manager.get_vaxis_global_xp()
    ...
    def r4635_condition(self):
        return self.settings_manager.get_in_party_morte() and \
               not self.settings_manager.get_morte_vaxis_quip_2()
    ...
    def r4656_condition(self):
        return not self.settings_manager.get_vaxis_help()
