class XachLogic:
    ...
    def r524_action(self):
        self.settings_manager.set_vaxis_exposed(True)


    def r645_action(self):
        self.settings_manager.set_xachariah_ring(1)


    def r663_action(self):
        self.settings_manager.set_has_xac_liver(True)


    def r666_action(self):
        self.settings_manager.set_xachariah_ring(2)
        self.settings_manager.set_has_xac_heart(True)


    def r672_action(self):
        self.settings_manager.set_xachariah_request(True)
    ...
    def r681_action(self):
        self.settings_manager.set_xachariah_gutted(False)
    ...
    def r508_condition(self):
        return self.settings_manager.character_manager.get_property('protagonist', 'intelligence') > 16 and \
               self.settings_manager.character_manager.get_property('protagonist', 'charisma') < 17


    def r63307_condition(self):
        return self.settings_manager.character_manager.get_property('protagonist', 'charisma') > 16


    def r506_condition(self):
        return self.settings_manager.get_know_xachariah_name()
    ...
    def r518_condition(self):
        return not self.settings_manager.get_xachariah_request()
    ...
    def r63484_condition(self):
        return self.settings_manager.get_xachariah_ring() == 1
    ...
    def r542_condition(self):
        return self.settings_manager.character_manager.get_property('protagonist', 'intelligence') > 17
    ...
    def r63234_condition(self):
        return self.settings_manager.get_xachariah_ring() < 2
    ...
    def r601_condition(self):
        return self.settings_manager.get_dakkon_slave()
    ...
    def r632_condition(self):
        return not self.settings_manager.get_know_xachariah_name()
