...
class XachLogicTest(LogicTest):
    ...
    def test_r524_action(self):
        self._false_then_true_action(
            self.state_manager.get_vaxis_exposed,
            self.logic.r524_action
        )


    def test_r645_action(self):
        self.state_manager.set_xachariah_ring(2)
        self._integer_equals_action(
            self.state_manager.get_xachariah_ring,
            1,
    ...
    def test_r663_action(self):
        self._false_then_true_action(
            self.state_manager.get_has_xac_liver,
    ...
    def test_r666_action(self):
        ...
        self.state_manager.set_xachariah_ring(xachariah_ring_before)
        self.state_manager.set_has_xac_heart(False)

        self.assertEqual(self.state_manager.get_xachariah_ring(), xachariah_ring_before)
        self.assertFalse(self.state_manager.get_has_xac_heart())

        self.logic.r666_action()

        self.assertEqual(self.state_manager.get_xachariah_ring(), xachariah_ring_after)
        self.assertTrue(self.state_manager.get_has_xac_heart())

        self.logic.r666_action()

        self.assertEqual(self.state_manager.get_xachariah_ring(), xachariah_ring_after_once)
        self.assertTrue(self.state_manager.get_has_xac_heart())


    def test_r672_action(self):
        self._false_then_true_action(
            self.state_manager.get_xachariah_request,
    ...
    def test_r679_action(self):
        self._false_then_true_action(
            self.state_manager.get_dead_xach,
            self.logic.r679_action
        )


    def test_r681_action(self):
        self.state_manager.set_xachariah_gutted(True)
        self._true_then_false_action(
            self.state_manager.get_xachariah_gutted,
    ...
    def test_r506_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_know_xachariah_name(x),
    ...
    def test_r518_condition(self):
        self._boolean_invert_condition(
            lambda x: self.state_manager.set_xachariah_request(x),
    ...
    def test_r63484_condition(self):
        self._integer_equal_condition(
            lambda x: self.state_manager.set_xachariah_ring(x),
            1,
    ...
    def test_r601_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_dakkon_slave(x),
