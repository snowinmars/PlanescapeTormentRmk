init 10 python:
    ...
    zf1096Logic = Zf1096Logic(renpy.store.global_state_manager)
...
label zf1096_s0: # - # IF ~  True()
    nr 'Этот труп женщины совершает круговой обход между плитами в комнате. Ее волосы заплетены в длинную косу, которая обернута вокруг шеи в виде петли. Кто-то под трафарет написал номер'
    zf1096 '«1096»'
    nr 'У нее на лбу; ее губы крепко зашиты.'
