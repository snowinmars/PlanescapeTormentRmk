init 10 python:
    ...
    zf1148Logic = Zf1148Logic(renpy.store.global_state_manager)
...
label zf1148_s0: # - # IF ~  True()
    nr 'Кожа этого женского трупа покрыто замысловатыми узорами татуировок. Кожа на лбу отвалилась, так что номер'
    zf1148 '«1148»'
    nr 'Вырезан прямо на черепе. Ее рот зашит крепкими грубыми стежками.'
