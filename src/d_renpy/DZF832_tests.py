...
class Zf832LogicTest(LogicTest):
    ...
    def test_zf832_init(self):
        location = 'LOCATION'
        delta_talked_to_zf832_times = 1

        self.assertNotEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_zf832_times(), 0)

        self.logic.zf832_init()

        self.assertEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_zf832_times(), delta_talked_to_zf832_times)

        self.logic.zf832_init()

        self.assertEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_zf832_times(), 2 * delta_talked_to_zf832_times)
