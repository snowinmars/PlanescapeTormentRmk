...
class Zm463LogicTest(LogicTest):
    ...
    def test_zm463_init(self):
        location = 'LOCATION'
        delta_talked_to_zm463_times = 1

        self.assertNotEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_zm463_times(), 0)

        self.logic.zm463_init()

        self.assertEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_zm463_times(), delta_talked_to_zm463_times)

        self.logic.zm463_init()

        self.assertEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_zm463_times(), 2 * delta_talked_to_zm463_times)
