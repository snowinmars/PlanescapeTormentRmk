...
class Zm613LogicTest(LogicTest):
    ...
    def test_zm613_init(self):
        location = 'LOCATION'
        delta_talked_to_zm613_times = 1

        self.assertNotEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_zm613_times(), 0)

        self.logic.zm613_init()

        self.assertEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_zm613_times(), delta_talked_to_zm613_times)

        self.logic.zm613_init()

        self.assertEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_zm613_times(), 2 * delta_talked_to_zm613_times)
