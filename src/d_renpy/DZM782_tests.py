...
class Zm782LogicTest(LogicTest):
    ...
    def test_zm782_init(self):
        location = 'LOCATION'
        talked_to_zm782_times_before = 0
        talked_to_zm782_times_after = 1
        talked_to_zm782_times_after_once = 2 * 1

        self.assertNotEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_zm782_times(), talked_to_zm782_times_before)

        self.logic.zm782_init()

        self.assertEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_zm782_times(), talked_to_zm782_times_after)

        self.logic.zm782_init()

        self.assertEqual(self.settings_manager.location_manager.get_location(), location)
        self.assertEqual(self.settings_manager.get_talked_to_zm782_times(), talked_to_zm782_times_after_once)
