init 10 python:
    ...
    zm825Logic = Zm825Logic(renpy.store.global_state_manager)
...
label zm825_s0: # - # IF ~  True()
    nr 'Голова этого трупа болтается на плечах… судя по вывернутой шее, этого человека повесили. На виске нарисован номер'
    zm825 '«825».'
