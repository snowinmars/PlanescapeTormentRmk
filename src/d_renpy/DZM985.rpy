init 10 python:
    from dlgs.zm985_logic import Zm985Logic
...
# s0 # say45515
label zm985_s0:  # - # IF ~  Global("Topple_985","GLOBAL",0)  Check EXTERN ~DMORTE~ : 482
...
# s4 # say45530
label zm985_s4:  # from 0.2 # Check EXTERN ~DMORTE~ : 482 # ~PlaySoundNotRanged("SPE_11") SetAnimState(Myself,ANIM_MIMEDIE) ~ EXTERN ~DMORTE~ 482
