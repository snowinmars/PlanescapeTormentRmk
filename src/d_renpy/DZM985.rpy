init 10 python:
    ...
    zm985Logic = Zm985Logic(renpy.store.global_state_manager)
...
label zm985_s0: # - # IF ~  Global("Topple_985","GLOBAL",0)
    nr 'Этот труп, номер'
    zm985 '«985»'
    nr ', встал как вкопанный; судя по состоянию его левой ноги, похоже, что его колено сгнило либо изъедено трупной плесенью. Труп неуверенно качается вперед и назад, пытаясь сохранить равновесие.'
