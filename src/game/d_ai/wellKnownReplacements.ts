...
export const wellKnownReplacements: string[][] = [
    ...
    ...booleanSetting('Skeleton_Chaotic', 'skeleton_chaotic'),
    ...booleanSetting('Skeleton_Examine', 'skeleton_examine'),
    ...booleanSetting('Morte_Skel_Mort_Quip2', 'morte_skel_mort_quip2'),
