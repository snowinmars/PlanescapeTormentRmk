...
def dlg_dzm1041():
    ...
    # from -
    DialogStateBuilder('DZM1041.D_s0') \
        .with_npc_lines() \
    ...
    # from 0.0 0.1 0.2
    DialogStateBuilder('DZM1041.D_s1') \
        .with_npc_lines() \
    ...
    # from 0.3
    DialogStateBuilder('DZM1041.D_s2') \
        .with_npc_lines() \
    ...
    # from 2.0
    DialogStateBuilder('DZM1041.D_s3') \
        .with_npc_lines() \
    ...
    # from 2.1
    DialogStateBuilder('DZM1041.D_s4') \
        .with_npc_lines() \
    ...
    # from 3.0 3.1 4.0 4.1
    DialogStateBuilder('DZM1041.D_s5') \
        .with_npc_lines() \
    ...
    # from 5.0 14.0
    DialogStateBuilder('DZM1041.D_s6') \
        .with_npc_lines() \
    ...
    # from 5.1 14.1
    DialogStateBuilder('DZM1041.D_s7') \
        .with_npc_lines() \
    ...
    # from 5.2 14.2
    DialogStateBuilder('DZM1041.D_s8') \
        .with_npc_lines() \
    ...
    # from 5.4 14.4
    DialogStateBuilder('DZM1041.D_s9') \
        .with_npc_lines() \
    ...
    # from 5.5 14.5
    DialogStateBuilder('DZM1041.D_s10') \
        .with_npc_lines() \
    ...
    # from 5.3 14.3
    DialogStateBuilder('DZM1041.D_s11') \
        .with_npc_lines() \
    ...
    # from 6.0 16.1
    DialogStateBuilder('DZM1041.D_s12') \
        .with_npc_lines() \
    ...
    # from 6.1
    DialogStateBuilder('DZM1041.D_s13') \
        .with_npc_lines() \
    ...
    # from 6.2 7.1 8.4 9.3 10.0 11.1 12.1 13.1 15.2 17.1 18.0 19.0 20.1 21.1 22.0 23.1 24.0 25.0 26.0 27.1 28.0 29.0 30.0 31.2 32.1 33.2 34.0 35.2 36.0 37.0 38.1
    DialogStateBuilder('DZM1041.D_s14') \
        .with_npc_lines() \
    ...
    # from 11.0
    DialogStateBuilder('DZM1041.D_s15') \
        .with_npc_lines() \
    ...
    # from 7.0 8.0 8.1 9.1 12.0 13.0
    DialogStateBuilder('DZM1041.D_s16') \
        .with_npc_lines() \
    ...
    # from 8.2 9.0
    DialogStateBuilder('DZM1041.D_s17') \
        .with_npc_lines() \
    ...
    # from 8.3 9.2
    DialogStateBuilder('DZM1041.D_s18') \
        .with_npc_lines() \
    ...
    # from 15.0 20.0
    DialogStateBuilder('DZM1041.D_s19') \
        .with_npc_lines() \
    ...
    # from 15.1
    DialogStateBuilder('DZM1041.D_s20') \
        .with_npc_lines() \
    ...
    # from 16.0
    DialogStateBuilder('DZM1041.D_s21') \
        .with_npc_lines() \
    ...
    # from 17.0
    DialogStateBuilder('DZM1041.D_s22') \
        .with_npc_lines() \
    ...
    # from 21.0
    DialogStateBuilder('DZM1041.D_s23') \
        .with_npc_lines() \
    ...
    # from 19.1
    DialogStateBuilder('DZM1041.D_s24') \
        .with_npc_lines() \
    ...
    # from 19.2 33.1 35.1
    DialogStateBuilder('DZM1041.D_s25') \
        .with_npc_lines() \
    ...
    # from 14.6
    DialogStateBuilder('DZM1041.D_s26') \
        .with_npc_lines() \
    ...
    # from 23.0
    DialogStateBuilder('DZM1041.D_s27') \
        .with_npc_lines() \
    ...
    # from 26.1
    DialogStateBuilder('DZM1041.D_s28') \
        .with_npc_lines() \
    ...
    # from 28.1
    DialogStateBuilder('DZM1041.D_s29') \
        .with_npc_lines() \
    ...
    # from 28.2
    DialogStateBuilder('DZM1041.D_s30') \
        .with_npc_lines() \
    ...
    # from 27.0
    DialogStateBuilder('DZM1041.D_s31') \
        .with_npc_lines() \
    ...
    # from 31.0 38.0
    DialogStateBuilder('DZM1041.D_s32') \
        .with_npc_lines() \
    ...
    # from 32.0
    DialogStateBuilder('DZM1041.D_s33') \
        .with_npc_lines() \
    ...
    # from 33.0
    DialogStateBuilder('DZM1041.D_s34') \
        .with_npc_lines() \
    ...
    # from -
    DialogStateBuilder('orphan DZM1041.D_s35') \
        .with_npc_lines() \
    ...
    # from 35.0
    DialogStateBuilder('DZM1041.D_s36') \
        .with_npc_lines() \
    ...
    # from 0.4
    DialogStateBuilder('DZM1041.D_s37') \
        .with_npc_lines() \
    ...
    # from 31.1
    DialogStateBuilder('DZM1041.D_s38') \
        .with_npc_lines() \
