...
def dlg_dzm1094():
    ...
    # from -
    DialogStateBuilder('DZM1094.D_s0') \
        .with_npc_lines() \
    ...
    # from 0.0 0.1 0.2
    DialogStateBuilder('DZM1094.D_s1') \
        .with_npc_lines() \
    ...
    # from 0.3
    DialogStateBuilder('DZM1094.D_s2') \
        .with_npc_lines() \
    ...
    # from 2.0
    DialogStateBuilder('DZM1094.D_s3') \
        .with_npc_lines() \
    ...
    # from 3.0
    DialogStateBuilder('DZM1094.D_s4') \
        .with_npc_lines() \
    ...
    # from 4.0 11.0
    DialogStateBuilder('DZM1094.D_s5') \
        .with_npc_lines() \
    ...
    # from 4.1 11.1
    DialogStateBuilder('DZM1094.D_s6') \
        .with_npc_lines() \
    ...
    # from 4.2 11.2
    DialogStateBuilder('DZM1094.D_s7') \
        .with_npc_lines() \
    ...
    # from 4.3 11.3
    DialogStateBuilder('DZM1094.D_s8') \
        .with_npc_lines() \
    ...
    # from 4.4 11.4
    DialogStateBuilder('DZM1094.D_s9') \
        .with_npc_lines() \
    ...
    # from 4.5 11.5
    DialogStateBuilder('DZM1094.D_s10') \
        .with_npc_lines() \
    ...
    # from 5.0 6.0 7.0 8.0 9.1 10.0 12.0 27.0
    DialogStateBuilder('DZM1094.D_s11') \
        .with_npc_lines() \
    ...
    # from 9.0
    DialogStateBuilder('DZM1094.D_s12') \
        .with_npc_lines() \
    ...
    # from 3.1
    DialogStateBuilder('DZM1094.D_s13') \
        .with_npc_lines() \
    ...
    # from 3.2 13.0
    DialogStateBuilder('DZM1094.D_s14') \
        .with_npc_lines() \
    ...
    # from 14.0 22.0
    DialogStateBuilder('DZM1094.D_s15') \
        .with_npc_lines() \
    ...
    # from 14.2 22.2
    DialogStateBuilder('DZM1094.D_s16') \
        .with_npc_lines() \
    ...
    # from 14.3 22.3
    DialogStateBuilder('DZM1094.D_s17') \
        .with_npc_lines() \
    ...
    # from 14.4 22.4
    DialogStateBuilder('DZM1094.D_s18') \
        .with_npc_lines() \
    ...
    # from 14.5 22.5
    DialogStateBuilder('DZM1094.D_s19') \
        .with_npc_lines() \
    ...
    # from 14.6 22.6
    DialogStateBuilder('DZM1094.D_s20') \
        .with_npc_lines() \
    ...
    # from 15.0
    DialogStateBuilder('DZM1094.D_s21') \
        .with_npc_lines() \
    ...
    # from 15.1 16.0 17.0 18.0 19.1 20.0 21.0 23.0 24.0 25.0 26.0
    DialogStateBuilder('DZM1094.D_s22') \
        .with_npc_lines() \
    ...
    # from 21.1
    DialogStateBuilder('DZM1094.D_s23') \
        .with_npc_lines() \
    ...
    # from 19.0
    DialogStateBuilder('DZM1094.D_s24') \
        .with_npc_lines() \
    ...
    # from 14.1 22.1
    DialogStateBuilder('DZM1094.D_s25') \
        .with_npc_lines() \
    ...
    # from -
    DialogStateBuilder('DZM1094.D_s26') \
        .with_npc_lines() \
    ...
    # from -
    DialogStateBuilder('DZM1094.D_s27') \
        .with_npc_lines() \
