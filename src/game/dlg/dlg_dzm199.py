...
def dlg_dzm199():
    ...
    # from -
    DialogStateBuilder('DZM199.D_s0') \
        .with_npc_lines() \
        ...
        .with_responses() \
            ...
            .response("Итак… что тут у нас интересного?", 'DZM199.D_s1', 'r1', 'reply34979').with_condition(lambda: _r34979_condition()) \
    ...
    # from 0.0 0.1 0.2
    DialogStateBuilder('DZM199.D_s1') \
        .with_npc_lines() \
    ...
    # from 0.3
    DialogStateBuilder('DZM199.D_s2') \
        .with_npc_lines() \
