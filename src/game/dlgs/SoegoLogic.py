class SoegoLogicGenerated:
    ...
    def j63982_s1_r1438_action(self):
        self.state_manager.journal_notes_manager.update_journal('63982')
    ...
    def j21805_s71_r21800_action(self):
        self.state_manager.journal_notes_manager.update_journal('21805')
    ...
    def r21852_action(self):
        ...
        self.state_manager.world_manager.set_soego_talk(2)
        #$% EndCutSceneMode() %$#
        self.state_manager.journal_notes_manager.update_journal('21856')
    ...
    def r21853_action(self):
        ...
        self.state_manager.world_manager.set_soego_talk(2)
        #$% EndCutSceneMode() %$#
        self.state_manager.journal_notes_manager.update_journal('21857')
    ...
    def r21915_action(self):
        self.state_manager.world_manager.set_soego_told(True)
        self.state_manager.journal_notes_manager.update_journal('21926')
    ...
    def j25254_s94_r25248_action(self):
        self.state_manager.journal_notes_manager.update_journal('25254')
    ...
    def j21996_s94_r21994_action(self):
        self.state_manager.journal_notes_manager.update_journal('21996')
    ...
    def r22051_action(self):
        ...
        self.state_manager.world_manager.set_soego_talk(2)
        #$% EndCutSceneMode() %$#
        self.state_manager.journal_notes_manager.update_journal('22052')
    ...
    def r1478_condition(self):
        return not self.state_manager.inventory_items_manager.is_own_item('has_mortuary_key')


    def r1479_condition(self):
        return self.state_manager.inventory_items_manager.is_own_item('has_mortuary_key')
...
class SoegoLogic(SoegoLogicGenerated):
    ...
    def talk(self):
        self.state_manager.world_manager.inc_talked_to_soego_times()
