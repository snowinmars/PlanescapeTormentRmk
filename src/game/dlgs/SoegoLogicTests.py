...
from game.dlgs.SoegoLogic import (SoegoLogicGenerated, SoegoLogic)


class SoegoLogicGeneratedTests(LogicTests):
    def setUp(self):
        super(SoegoLogicGeneratedTests, self).setUp()
    ...
    def test_r1478_condition(self):
        ...
        self._boolean_invert_condition(
            lambda x: self.state_manager.inventory_items_manager.pick_item('has_mortuary_key') if x else self.state_manager.inventory_items_manager.drop_item('has_mortuary_key'),
...
class SoegoLogicTests(LogicTests):
    def setUp(self):
        super(SoegoLogicTests, self).setUp()
