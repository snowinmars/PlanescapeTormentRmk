...
class DeionarraLogicGeneratedTest(LogicTest):
    ...
    def test_r786_action(self):
        self._false_then_true_action(
            self.state_manager.get_prophecy,
    ...
    def test_r6129_action(self):
        ...
        self.state_manager.set_deionarra_value(deionarra_value_before)
        who_law = 'protagonist'
        prop_law = 'law'
        delta_law = -1

        self.assertEqual(self.state_manager.get_deionarra_value(), deionarra_value_before)
        law_before = self.state_manager.characters_manager.get_property(who_law, prop_law)

        self.logic.r6129_action()

        self.assertEqual(self.state_manager.get_deionarra_value(), deionarra_value_after)
        law_after = self.state_manager.characters_manager.get_property(who_law, prop_law)
        self.assertEqual(law_before + delta_law, law_after)

        self.logic.r6129_action()

        self.assertEqual(self.state_manager.get_deionarra_value(), deionarra_value_after_once)
        law_after_once = self.state_manager.characters_manager.get_property(who_law, prop_law)
        self.assertEqual(law_after, law_after_once)
    ...
    def test_r6100_action(self):
        self._false_then_true_action(
            self.state_manager.get_deionarra_curse,
    ...
    def test_r6148_action(self):
        self.state_manager.set_deionarra_portal(False)
        who_experience = 'protagonist'
        prop_experience = 'experience'
        delta_experience = 500

        self.assertFalse(self.state_manager.get_deionarra_portal())
        ...
        self.assertTrue(self.state_manager.get_deionarra_portal())
    ...
    def test_r63384_action(self):
        self._false_then_true_action(
            self.state_manager.get_deionarra_forgives,
    ...
    def test_r63419_action(self):
        self.state_manager.set_has_wedding_ring(True)
        self.state_manager.set_has_sup_ring(False)

        self.assertTrue(self.state_manager.get_has_wedding_ring())
        self.assertFalse(self.state_manager.get_has_sup_ring())

        self.logic.r63419_action()

        self.assertFalse(self.state_manager.get_has_wedding_ring())
        self.assertTrue(self.state_manager.get_has_sup_ring())
    ...
    def test_r1308_condition(self):
        self._boolean_invert_condition(
            lambda x: self.state_manager.set_prophecy(x),
    ...
    def test_r1315_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_deionarra_curse(x),
    ...
    def test_r797_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_deionarra_raise_dead(x),
    ...
    def test_r6147_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_deionarra_portal(x),
    ...
    def test_r63367_condition(self):
        self.state_manager.set_fortress_party(0)
        ...
        self.state_manager.set_fortress_party(2)
    ...
    def test_r63369_condition(self):
        self._integer_gt_condition(
            lambda x: self.state_manager.set_deionarra_death_truth(x),
            0,
    ...
    def test_r63371_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_deionarra_forgives(x),
    ...
    def test_r63401_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_know_shadow_player_connection(x),
    ...
    def test_r63406_condition(self):
        self._integer_gt_condition(
            lambda x: self.state_manager.set_fortress_party(x),
            2,
    ...
    def test_r63408_condition(self):
        ...
        self.state_manager.set_fortress_party(1)
        self.state_manager.set_deionarra_value(1)
    ...
    def test_r63409_condition(self):
        ...
        self.state_manager.set_fortress_party(1)
        self.state_manager.set_deionarra_value(0)
