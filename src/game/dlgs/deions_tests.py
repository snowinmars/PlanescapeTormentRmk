...
class DeionsLogicTest(LogicTest):
    ...
    def test_r699_condition(self):
        ...
        self.assertFalse(logic.r699_condition())

        self.settings_manager.set_in_party_morte(True)
        self.settings_manager.set_morte_deionarra_quip_1(False)

        self.assertTrue(logic.r699_condition())
    ...
    def test_r9616_condition(self):
        ...
        self.assertFalse(logic.r9616_condition())

        self.settings_manager.set_in_party_morte(False)
        self.settings_manager.set_morte_deionarra_quip_1(False)

        self.assertTrue(logic.r9616_condition())
    ...
    def test_r708_condition(self):
        ...
        self.assertFalse(logic.r708_condition())
        ...
        self.settings_manager.character_manager.set_property(who, prop_int, delta_int + 1)
        self.settings_manager.character_manager.set_property(who, prop_cha, delta_cha - 1)
        self.assertTrue(logic.r708_condition())
    ...
    def test_r713_condition(self):
        ...
        self.settings_manager.character_manager.set_property(who, prop_int, delta_int - 1)
        self.settings_manager.character_manager.set_property(who, prop_cha, delta_cha + 1)
        self.assertFalse(logic.r713_condition())
        ...
        self.settings_manager.character_manager.set_property(who, prop_int, delta_int + 1)
        self.settings_manager.character_manager.set_property(who, prop_cha, delta_cha - 1)
        self.assertTrue(logic.r713_condition())
    ...
    def test_r718_condition(self):
        ...
        self.settings_manager.character_manager.set_property(who, prop_int, delta_int - 1)
        self.settings_manager.character_manager.set_property(who, prop_cha, delta_cha + 1)
        self.assertFalse(logic.r718_condition())
        ...
        self.settings_manager.character_manager.set_property(who, prop_int, delta_int + 1)
        self.settings_manager.character_manager.set_property(who, prop_cha, delta_cha - 1)
        self.assertTrue(logic.r718_condition())
    ...
    def test_r723_condition(self):
        ...
        self.settings_manager.character_manager.set_property(who, prop_int, delta_int - 1)
        self.settings_manager.character_manager.set_property(who, prop_cha, delta_cha + 1)
        self.assertFalse(logic.r723_condition())
        ...
        self.settings_manager.character_manager.set_property(who, prop_int, delta_int + 1)
        self.settings_manager.character_manager.set_property(who, prop_cha, delta_cha - 1)
        self.assertTrue(logic.r723_condition())
    ...
    def test_r1313_condition(self):
        ...
        self.assertFalse(logic.r1313_condition())

        self.settings_manager.set_in_party_morte(False)
        self.settings_manager.set_morte_deionarra_quip_1(False)

        self.assertTrue(logic.r1313_condition())
    ...
    def test_r13255_condition(self):
        ...
        self.assertFalse(logic.r13255_condition())

        self.settings_manager.set_in_party_morte(False)
        self.settings_manager.set_morte_deionarra_quip_1(False)

        self.assertTrue(logic.r13255_condition())
    ...
    def test_r731_condition(self):
        ...
        self.assertFalse(logic.r731_condition())
        ...
        self.settings_manager.character_manager.set_property(who, prop, delta - 1)
        self.assertTrue(logic.r731_condition())
    ...
    def test_r732_condition(self):
        ...
        self.settings_manager.set_escape_mortuary(False)
        self.settings_manager.character_manager.set_property(who, prop, delta + 1)
        self.assertTrue(logic.r732_condition())

        self.settings_manager.set_escape_mortuary(True)
        self.settings_manager.character_manager.set_property(who, prop, delta)
        self.assertFalse(logic.r732_condition())
    ...
    def test_r737_condition(self):
        ...
        self.settings_manager.set_escape_mortuary(True)
        self.settings_manager.character_manager.set_property(who, prop, delta + 1)
        self.assertFalse(logic.r737_condition())
        ...
        self.settings_manager.set_escape_mortuary(False)
        self.settings_manager.character_manager.set_property(who, prop, delta - 1)
        self.assertTrue(logic.r737_condition())
    ...
    def test_r738_condition(self):
        ...
        self.settings_manager.set_escape_mortuary(False)
        self.settings_manager.character_manager.set_property(who, prop, delta + 1)
        self.assertTrue(logic.r738_condition())

        self.settings_manager.set_escape_mortuary(True)
        self.settings_manager.character_manager.set_property(who, prop, delta)
        self.assertFalse(logic.r738_condition())
    ...
    def test_r6085_condition(self):
        ...
        self.assertFalse(logic.r6085_condition())

        self.settings_manager.set_in_party_morte(True)
        self.settings_manager.set_morte_deionarra_quip_1(False)

        self.assertTrue(logic.r6085_condition())
    ...
    def test_r13256_condition(self):
        ...
        self.assertFalse(logic.r13256_condition())

        self.settings_manager.set_in_party_morte(False)
        self.settings_manager.set_morte_deionarra_quip_1(False)

        self.assertTrue(logic.r13256_condition())
    ...
    def test_r6082_condition(self):
        ...
        self.assertFalse(logic.r6082_condition())

        self.settings_manager.set_in_party_morte(True)
        self.settings_manager.set_morte_deionarra_quip_1(False)

        self.assertTrue(logic.r6082_condition())
    ...
    def test_r13257_condition(self):
        ...
        self.assertFalse(logic.r13257_condition())

        self.settings_manager.set_in_party_morte(False)
        self.settings_manager.set_morte_deionarra_quip_1(False)

        self.assertTrue(logic.r13257_condition())
    ...
    def test_r6131_condition(self):
        ...
        self.settings_manager.character_manager.set_property(who, prop_int, delta_int - 1)
        self.settings_manager.character_manager.set_property(who, prop_cha, delta_cha + 1)
        self.assertFalse(logic.r6131_condition())
        ...
        self.settings_manager.character_manager.set_property(who, prop_int, delta_int + 1)
        self.settings_manager.character_manager.set_property(who, prop_cha, delta_cha - 1)
        self.assertTrue(logic.r6131_condition())
    ...
    def test_r6155_condition(self):
        ...
        self.assertFalse(logic.r6155_condition())

        self.settings_manager.set_in_party_morte(True)
        self.settings_manager.set_morte_deionarra_quip_1(False)

        self.assertTrue(logic.r6155_condition())
    ...
    def test_r13258_condition(self):
        ...
        self.assertFalse(logic.r13258_condition())

        self.settings_manager.set_in_party_morte(False)
        self.settings_manager.set_morte_deionarra_quip_1(False)

        self.assertTrue(logic.r13258_condition())
    ...
    def test_r63367_condition(self):
        ...
        self.assertFalse(logic.r63367_condition())
        ...
        self.assertTrue(logic.r63367_condition())
    ...
    def test_r63368_condition(self):
        ...
        self.assertFalse(logic.r63368_condition())

        self.settings_manager.set_fortress_party(2)
        self.settings_manager.set_fortress_ignus(0)
        self.settings_manager.set_fortress_vhailor(0)
        self.assertTrue(logic.r63368_condition())
    ...
    def test_r63409_condition(self):
        ...
        self.assertFalse(logic.r63409_condition())

        self.settings_manager.set_fortress_party(1)
        self.settings_manager.set_deionarra_value(0)

        self.assertTrue(logic.r63409_condition())
    ...
    def test_r63419_condition(self):
        ...
        self.assertFalse(logic.r63419_condition())

        self.settings_manager.set_deionarra_value(1)
        self.settings_manager.set_has_wedding_ring(True)

        self.assertTrue(logic.r63419_condition())
