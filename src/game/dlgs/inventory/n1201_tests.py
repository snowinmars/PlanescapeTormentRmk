...
class N1201LogicGeneratedTest(LogicTest):
    ...
    def test_r44994_action(self):
        self.state_manager.set_ur_1201(False)
        _1201_note_quest_before = 0
        _1201_note_quest_after = 1
        _1201_note_quest_after_once = 1
        self.state_manager.set_1201_note_quest(_1201_note_quest_before)

        self.assertFalse(self.state_manager.get_ur_1201())
        self.assertEqual(self.state_manager.get_1201_note_quest(), _1201_note_quest_before)

        self.logic.r44994_action()

        self.assertTrue(self.state_manager.get_ur_1201())
        self.assertEqual(self.state_manager.get_1201_note_quest(), _1201_note_quest_after)

        self.logic.r44994_action()

        self.assertTrue(self.state_manager.get_ur_1201())
        self.assertEqual(self.state_manager.get_1201_note_quest(), _1201_note_quest_after_once)


    def test_r44995_action(self):
        self._false_then_true_action(
            self.state_manager.get_lr_1201,
    ...
    def test_r44996_action(self):
        self._false_then_true_action(
            self.state_manager.get_ll_1201,
    ...
    def test_r44997_action(self):
        self._false_then_true_action(
            self.state_manager.get_ul_1201,
            self.logic.r44997_action
        )


    def test_r44998_action(self):
        self.state_manager.set_ur_1201(True)
        self.state_manager.set_lr_1201(True)
        self.state_manager.set_ll_1201(True)
        self.state_manager.set_ul_1201(True)
        ...
        self.assertTrue(self.state_manager.get_ur_1201())
        self.assertTrue(self.state_manager.get_lr_1201())
        self.assertTrue(self.state_manager.get_ll_1201())
        self.assertTrue(self.state_manager.get_ul_1201())
        self.assertEqual(self.state_manager.get_1201_note_quest(), _1201_note_quest_before)

        self.logic.r44998_action()

        self.assertFalse(self.state_manager.get_ur_1201())
        self.assertFalse(self.state_manager.get_lr_1201())
        self.assertFalse(self.state_manager.get_ll_1201())
        self.assertFalse(self.state_manager.get_ul_1201())
        self.assertEqual(self.state_manager.get_1201_note_quest(), _1201_note_quest_after)
    ...
    def test_r45000_action(self):
        self._false_then_true_action(
            self.state_manager.get_ur_1201,
    ...
    def test_r45001_action(self):
        ...
        self.state_manager.set_1201_note_quest(_1201_note_quest_before)
        self.state_manager.set_lr_1201(False)
    ...
    def test_r45003_action(self):
        self.state_manager.set_ll_1201(False)
        _1201_note_quest_before = 1
        _1201_note_quest_after = 0
        _1201_note_quest_after_once = 0
        self.state_manager.set_1201_note_quest(_1201_note_quest_before)
    ...
    def test_r45004_action(self):
        self.state_manager.set_ul_1201(False)
        _1201_note_quest_before = 1
        _1201_note_quest_after = 0
        _1201_note_quest_after_once = 0
        self.state_manager.set_1201_note_quest(_1201_note_quest_before)
    ...
    def test_r45025_action(self):
        self.state_manager.set_has_tearring(False)
        self.state_manager.set_has_1201_note(True)

        self.assertFalse(self.state_manager.get_has_tearring())
        self.assertTrue(self.state_manager.get_has_1201_note())

        self.logic.r45025_action()

        self.assertTrue(self.state_manager.get_has_tearring())
    ...
    def test_r45000_condition(self):
        self._boolean_invert_condition(
            lambda x: self.state_manager.set_ur_1201(x),
    ...
    def test_r45001_condition(self):
        self.state_manager.set_lr_1201(True)
        self.state_manager.set_1201_note_quest(0)

        self.assertFalse(self.logic.r45001_condition())

        self.state_manager.set_lr_1201(False)
        self.state_manager.set_1201_note_quest(1)
    ...
    def test_r45003_condition(self):
        self._boolean_invert_condition(
            lambda x: self.state_manager.set_ll_1201(x),
    ...
    def test_r45004_condition(self):
        self.state_manager.set_ul_1201(True)
        self.state_manager.set_1201_note_quest(2)
