...
class N1201LogicTest(LogicTest):
    ...
    def test_r44994_action(self):
        ...
        self.settings_manager.set_1201_note_quest(_1201_note_quest_before)

        self.assertFalse(self.settings_manager.get_ur_1201())
        self.assertEqual(self.settings_manager.get_1201_note_quest(), _1201_note_quest_before)

        self.logic.r44994_action()

        self.assertTrue(self.settings_manager.get_ur_1201())
        self.assertEqual(self.settings_manager.get_1201_note_quest(), _1201_note_quest_after)

        self.logic.r44994_action()

        self.assertTrue(self.settings_manager.get_ur_1201())
        self.assertEqual(self.settings_manager.get_1201_note_quest(), _1201_note_quest_after_once)
