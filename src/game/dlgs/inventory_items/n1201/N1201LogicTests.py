...
from game.dlgs.inventory_items.n1201.N1201Logic import (N1201LogicGenerated, N1201Logic)


class N1201LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(N1201LogicGeneratedTests, self).setUp()
...
class N1201LogicTests(LogicTests):
    def setUp(self):
        super(N1201LogicTests, self).setUp()
