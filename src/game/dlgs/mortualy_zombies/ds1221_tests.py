...
from dlgs.mortualy_zombies.ds1221_logic import Ds1221Logic

class Ds1221LogicTest(LogicTest):
    def test_initialization(self):
        logic = Ds1221Logic(self.settings_manager)
        self.assertIsNotNone(logic.gsm)


    def test_methods_are_bound(self):
        self.target_class = Ds1221Logic
    ...
    def test_r35354_action(self):
        ...
        self.assertFalse(self.settings_manager.get_dead_ds1221())
        self.assertFalse(self.settings_manager.get_has_spike())
        self.assertFalse(self.settings_manager.get_has_strap())

        logic.r35354_action()

        self.assertTrue(self.settings_manager.get_dead_ds1221())
