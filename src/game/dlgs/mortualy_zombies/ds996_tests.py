...
from dlgs.mortualy_zombies.ds996_logic import Ds996Logic

class Ds996LogicTest(LogicTest):
    def test_initialization(self):
        logic = Ds996Logic(self.settings_manager)
        self.assertIsNotNone(logic.gsm)


    def test_methods_are_bound(self):
        self.target_class = Ds996Logic
    ...
    def test_r35508_action(self):
        ...
        self.assertFalse(self.settings_manager.get_dead_ds996())
        self.assertFalse(self.settings_manager.get_has_spike())
        self.assertFalse(self.settings_manager.get_has_strap())

        logic.r35508_action()

        self.assertTrue(self.settings_manager.get_dead_ds996())
