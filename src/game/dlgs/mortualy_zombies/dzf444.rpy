...
# s0 # say35210
label dzf444_s0:  # from - # Manually checked EXTENDS ~DMORTE~ : 358 as dmorte_s330 (dmorte_s358 in the original Ps:T)
    jump 'dzf444_init'
...
# s1 # say35212
label dzf444_s1:  # from 0.0 0.1 0.2 # Check EXTENDS ~DMORTE~ : 358
...
# s2 # say35231
label dzf444_s2:  # from 0.3 # Check EXTENDS ~DMORTE~ : 358
