...
# ###
# Original:  DLG/DZF444.DLG # orphan dzf444_s3
# ###
...
# s0 # say35210
label dzf444_s0:  # - # IF ~  True()  Manually checked EXTERN ~DMORTE~ : 358 as dmorte_s330
...
# s1 # say35212
label dzf444_s1:  # from 0.0 0.1 0.2 # Manually checked EXTERN ~DMORTE~ : 358 as dmorte_s330
...
# s3 # say35241
label dzf444_s3:  # - # IF ~  False() # orphan
    teller 'Труп не реагирует. Кажется, он слишкомдалек от того, чтобы отвечать на твои вопросы.'
