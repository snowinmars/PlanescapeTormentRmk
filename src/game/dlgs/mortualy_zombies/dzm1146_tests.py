...
class Dzm1146LogicTest(LogicTest):
    def test_initialization(self):
        logic = Dzm1146Logic(self.settings_manager)
        self.assertIsNotNone(logic.gsm)


    def test_methods_are_bound(self):
        self.target_class = Dzm1146Logic
        self._methods_are_bound()


    def test_dzm1146_init(self):
        logic = Dzm1146Logic(self.settings_manager)
        id = 'mortuary_f2r1'

        self.assertNotEqual(self.settings_manager.glm.get_location(), id)
        self.assertFalse(self.settings_manager.get_meet_dzm1146())

        logic.dzm1146_init()

        self.assertEqual(self.settings_manager.glm.get_location(), id)
        self.assertTrue(self.settings_manager.get_meet_dzm1146(), True)
