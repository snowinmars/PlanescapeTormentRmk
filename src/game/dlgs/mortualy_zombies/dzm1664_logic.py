class Dzm1664Logic:
    ...
    def dzm1664_init(self):
        self.gsm.glm.set_location('mortuary_f2r4')
        self.gsm.set_meet_dzm1664(True)


    def kill_dzm1664(self):
        self.gsm.set_dead_dzm1664(True)
        self.gsm.inc_exp_custom('party', 65)


    def r47014_action(self):
        self.gsm.set_has_logpage(True)
        self.gsm.set_has_dzm1664_page(True)


    def r47003_condition(self):
        return not self.gsm.get_has_dzm1664_page()


    def r47004_condition(self):
        return self.gsm.get_has_dzm1664_page()
