...
# s0 # say45515
label dzm985_s0:  # - # IF ~  Global("Topple_985","GLOBAL",0) Manually checked EXTERN ~DMORTE~ : 482
...
label dzm985_s3:  # from 0.1 6.0
    ...
    $ dzm985Logic.s3_action()

    jump dzm985_s7

# s4 # say45530
label dzm985_s4:  # from 0.2 # Manually checked EXTERN ~DMORTE~ : 482
