...
from dlgs.mortualy_zombies.dzm985_logic import Dzm985Logic

class Dzm985LogicTest(LogicTest):
    def test_initialization(self):
        logic = Dzm985Logic(self.settings_manager)
        self.assertIsNotNone(logic.gsm)


    def test_methods_are_bound(self):
        self.target_class = Dzm985Logic
        self._methods_are_bound()


    def test_dzm985_init(self):
        logic = Dzm985Logic(self.settings_manager)
        id = 'mortuary_f2r5'

        self.assertNotEqual(self.settings_manager.glm.get_location(), id)
        self.assertFalse(self.settings_manager.get_meet_dzm985())

        logic.dzm985_init()

        self.assertEqual(self.settings_manager.glm.get_location(), id)
        self.assertTrue(self.settings_manager.get_meet_dzm985(), True)
    ...
    def test_s3_action(self):
        ...
        self.assertFalse(self.settings_manager.get_dead_dzm985())

        logic.s3_action()

        self.assertTrue(self.settings_manager.get_topple_985())
        self.assertTrue(self.settings_manager.get_dead_dzm985())
