...
# s0 # say35460
label s996_s0:  # - # IF ~  True()  Check EXTERN ~DMORTE~ : 392 Check EXTERN ~DMORTE~ : 388 Check EXTERN ~DMORTE~ : 386
    nr 'Этот скелет довольно стар: кожаные ремешки потрескались и истерлись от времени. На лбу с особым искусством вырезано слово ПОКАЙСЯ; более грубая рука уже позднее высекла на обоих висках число 996.'
...
# s1 # say35462
label s996_s1:  # from 0.0 0.1 0.2 0.3 # Check EXTERN ~DMORTE~ : 386
...
# s2 # say35488
label s996_s2:  # from 0.4 # Check EXTERN ~DMORTE~ : 386
...
# s3 # say35493
label s996_s3:  # from 0.5 # Check EXTERN ~DMORTE~ : 392 Check EXTERN ~DMORTE~ : 386
    nr 'Кто-то позаботился о том, чтобы связать кости скелета кожаными ремнями, обвивающими тело на манер, напоминающий мускулы и сухожилия. Ремни привязаны к железными скобам, вбитым в суставы скелета.'
...
# s4 # say35499
label s996_s4:  # from 0.7 0.10 3.1 3.4 # Check EXTERN ~DMORTE~ : 386
