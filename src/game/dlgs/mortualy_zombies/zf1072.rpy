...
# ###
# Original:  DLG/DZF1072.DLG # orphan zf1072_s3
# ###
...
# s0 # say35114
label zf1072_s0:  # - # IF ~  True() Manually checked EXTERN ~DMORTE~ : 346 as morte_s330
...
# s1 # say35116
label zf1072_s1:  # from 0.0 0.1 0.2 # Manually checked EXTERN ~DMORTE~ : 346 as morte_s330
...
# s2 # say35135
label zf1072_s2:  # from 0.3 # Manually checked EXTERN ~DMORTE~ : 346 as morte_s330
...
# s3 # say35145
label zf1072_s3:  # - # IF ~  False() # orphan
    teller 'Труп не шевелится. Кажется, он слишком далек от того, чтобы отвечать на твои вопросы.'
