init 10 python:
    from dlgs.mortualy_zombies.zf1096_logic import Zf1096Logic
    zf1096Logic = Zf1096Logic(renpy.store.global_settings_manager)


# ###
# Original:  DLG/DZF1096.DLG # orphan zf1096_s3
# ###
...
# s0 # say35082
label zf1096_s0:  # - # IF ~  True() Manually checked EXTERN ~DMORTE~ : 342 as morte_s330
...
# s1 # say35084
label zf1096_s1:  # from 0.0 0.1 0.2 # Manually checked EXTERN ~DMORTE~ : 342 as morte_s330
...
# s2 # say35103
label zf1096_s2:  # from 0.3 # Manually checked EXTERN ~DMORTE~ : 342 as morte_s330
...
# s3 # say35113
label zf1096_s3:  # - # IF ~  False() # orphan
    teller 'Труп не шевелится. Кажется, он слишком далек от того, чтобы отвечать на твои вопросы.'
