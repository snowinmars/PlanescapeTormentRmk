...
# ###
# Original:  DLG/DZF832.DLG # orphan zf832_s3
# ###
...
# s0 # say35146
label zf832_s0:  # - # IF ~  True() Manually checked EXTERN ~DMORTE~ : 350 as morte_s330
...
# s1 # say35148
label zf832_s1:  # from 0.0 0.1 0.2 # Manually checked EXTERN ~DMORTE~ : 350 as morte_s330
...
# s2 # say35167
label zf832_s2:  # from 0.3 # Manually checked EXTERN ~DMORTE~ : 350 as morte_s330
...
# s3 # say35177
label zf832_s3:  # - # IF ~  False() # orphan
    teller 'Труп не реагирует. Кажется, он слишком далек от того, чтобы отвечать на твои вопросы.'
