init 10 python:
    from dlgs.mortualy_zombies.zf916_logic import Zf916Logic
    zf916Logic = Zf916Logic(renpy.store.global_settings_manager)


# ###
# Original:  DLG/DZF916.DLG # orphan zf916_s3
# ###
...
# s0 # say24719
label zf916_s0:  # - # IF ~  True() Manually checked EXTERN ~DMORTE~ : 46 as morte_s330
...
# s1 # say24721
label zf916_s1:  # from 0.0 0.1 0.2 # Manually checked EXTERN ~DMORTE~ : 46 as morte_s330
...
# s2 # say24740
label zf916_s2:  # from 0.3 # Manually checked EXTERN ~DMORTE~ : 46 as morte_s330
...
# s3 # say24750
label zf916_s3:  # - # IF ~  False() # orphan
    teller 'Труп не реагирует. Кажется, он слишком далек от того, чтобы отвечать на твои вопросы.'
