...
label zm1041_killed:
    ...
    nr 'Его жёсткая кожа лопается от моих ударов. Я чувствую, что я безвозвратно разрушил тело этого духа. Стал ли он свободнее?'
    jump zm1041_dispose
...
label zm1041_killed_first:
    $ zm1041Logic.kill_zm1041()
    nr 'Его жёсткая кожа лопается от моих ударов. Я чувствую, что я безвозвратно что-то разрушил.'
    jump zm1041_dispose
