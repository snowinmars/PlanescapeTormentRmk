...
from game.dlgs.mortuary.dhall.DhallLogic import (DhallLogicGenerated, DhallLogic)


class DhallLogicGeneratedTests(LogicTests):
    def setUp(self):
        super(DhallLogicGeneratedTests, self).setUp()
...
class DhallLogicTests(LogicTests):
    def setUp(self):
        super(DhallLogicTests, self).setUp()
