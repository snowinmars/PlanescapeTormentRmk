...
from game.dlgs.mortuary.dust.DustLogic import (DustLogicGenerated, DustLogic)


class DustLogicGeneratedTests(LogicTests):
    def setUp(self):
        super(DustLogicGeneratedTests, self).setUp()
    ...
    def test_r1428_action(self):
        ...
        self.assertFalse(self.state_manager.world_manager.get_dead_dust())
        ...
        self.assertTrue(self.state_manager.world_manager.get_dead_dust())
    ...
    def test_r33189_condition(self):
        ...
        self.state_manager.world_manager.set_talked_to_dust_times(0)
    ...
    def test_r33190_condition(self):
        ...
        self.state_manager.characters_manager.set_property(who_intelligence, prop_intelligence, delta_intelligence + 1)
        self.state_manager.world_manager.set_talked_to_dust_times(2)
    ...
    def test_r371_condition(self):
        self._integer_equal_condition(
            lambda x: self.state_manager.world_manager.set_talked_to_dust_times(x),
            1,
...
class DustLogicTests(LogicTests):
    def setUp(self):
        super(DustLogicTests, self).setUp()
