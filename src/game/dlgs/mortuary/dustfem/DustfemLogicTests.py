...
from game.dlgs.mortuary.dustfem.DustfemLogic import (DustfemLogicGenerated, DustfemLogic)


class DustfemLogicGeneratedTests(LogicTests):
    def setUp(self):
        super(DustfemLogicGeneratedTests, self).setUp()
...
class DustfemLogicTests(LogicTests):
    def setUp(self):
        super(DustfemLogicTests, self).setUp()
