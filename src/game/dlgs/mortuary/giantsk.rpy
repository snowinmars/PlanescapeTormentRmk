...
# s0 # say292
label giantsk_s0:  # - # IF ~  True()  Check EXTERN ~DMORTE~ : 73
...
# s1 # say1166
label giantsk_s1:  # from 0.0 0.1 0.9 # IF ~  False()  Check EXTERN ~DMORTE~ : 73
...
# s4 # say4007
label giantsk_s4:  # from 0.2 1.0 3.1 7.1 15.1 16.3 # Check EXTERN ~DMORTE~ : 73
...
# s5 # say4008
label giantsk_s5:  # from 4.0 # Check EXTERN ~DMORTE~ : 73
...
# s6 # say4009
label giantsk_s6:  # from 5.0 5.1 # Check EXTERN ~DMORTE~ : 73
...
# s7 # say4010
label giantsk_s7:  # from 5.2 6.1 7.2 # Check EXTERN ~DMORTE~ : 73
...
# s8 # say4011
label giantsk_s8:  # from 6.0 # Check EXTERN ~DMORTE~ : 73
...
# s9 # say4012
label giantsk_s9:  # from 0.3 1.1 8.0 8.1 # Check EXTERN ~DMORTE~ : 73
...
label giantsk_s12:  # from 11.0
    ...
    # nr 'Ты чувствуешь, что эта вещь может пригодиться.' # TODO [snow]: её только продать можно. Прикрутить к сюжету?
...
label giantsk_s14:  # from 13.0
    ...
    # nr 'Эта вещь может пригодиться.' # TODO [snow]: её только продать можно. Прикрутить к сюжету?
...
label giantsk_killed_first:
    ...
    nr 'TODO [snowinmars]: Дописать сцену убийства.'
    jump giantsk_dispose
