init 10 python:
    ...
    morteLogic = MorteLogic(renpy.store.global_state_manager)
...
label morte_s130: # -
    ...
    morte '«И я тебя тоже люблю».' # [MRT387]
...
label morte_s226: # from 225.0
    morte '«Я разнесу этот мордонский куб на куски».' # [MRT251]
...
label morte_s227: # -
    morte '«Ооооох!»'
    nr 'Морт восхищенно щелкает зубами, выслушивая умопостроения Крэддока… кажется, ты даже слышишь, как внутри своего черепа он делает пометки.' # [MRT387]
...
label morte_s298: # -
    ...
    nr 'Внезапно все стихает. Остатки твоих чувств меркнут и покидают тебя.' # [MRT387]
...
# s439 # say41641
label morte_s439: # -
    morte '«Не буду, *тифлинг*. Хотя признаю, что узнал пару новых вещей… неплохо придумано, шеф!»' # [MRT387]
...
# s603 # say61481
label morte_s603: # -
    morte '«Моим? Я — голова Векны».' # [MRT562]
...
# s604 # say61482
label morte_s604: # -
    morte '«Боги услышали мои молитвы!»' # [MRT485]
...
# s605 # say61483
label morte_s605: # -
    morte '«История головы Векны очень долгая. Я не хочу об этом говорить».' # [MRT559A]
...
# s606 # say61484
label morte_s606: # -
    morte '«*Пожалуйста*, мы можем сменить тему?»' # [MRT559B]
...
# s608 # say61486
label morte_s608: # -
    morte '«Что сказать? Я — *Мементо Морте*».' # [MRT561]
...
# s609 # say61487
label morte_s609: # -
    morte '«Только если я отдохну на твоих буферах».' # [MRT486A]
...
# s610 # say61488
label morte_s610: # -
    morte '«Ничего! Ничего такого. Важного».' # [MRT486B]
...
# s613 # say63454
label morte_s613: # -
    morte '«Я не могу нигде стоять. Видишь ли, это можно делать только ногами».' # [MRT482]
...
# s614 # say63455
label morte_s614: # -
    morte '«Я думал, что ты хорошо выглядишь, но я ошибался».' # [MRT483]
...
# s615 # say63456
label morte_s615: # -
    morte '«Я перестал дышать с тех пор, как увидел тебя, бесовка».' # [MRT524]
...
# s616 # say63457
label morte_s616: # -
    morte '«Знаешь, у меня ведь есть ИМЯ».' # [MRT526]
...
# s617 # say63458
label morte_s617: # -
    morte '«Интересно, надо попробовать… на следующий день я у них спрошу, сколько они отвалят за тебя».' # [MRT531]
...
# s618 # say63459
label morte_s618: # -
    morte '«Знаешь, когда твой рот закрыт, ты выглядишь намного симпатичней».' # [MRT530]
...
# s619 # say63460
label morte_s619: # -
    morte '«О, но у тебя ведь уже есть мое сердце, бесовка».' # [MRT532]
...
# s620 # say63462
label morte_s620: # -
    morte '«Я могу придумать способы и похуже».' # [MRT525]
...
# s621 # say63463
label morte_s621: # -
    morte '«Знаешь, а ведь ты *тоже* отчасти нечисть».' # [MRT533A]
...
# s622 # say63464
label morte_s622: # -
    morte '«С той точки, где я парю, она выглядит хорошенькой».' # [MRT533B]
...
# s623 # say63666
label morte_s623: # -
    morte '«Я заметил. Почему бы тебе не поделиться своей проницательностью с шефом, а?»' # [MRT563]
...
# s624 # say63667
label morte_s624: # -
    morte '«Метеоризм, глупый полигон».' # [MRT468A]
...
# s625 # say63668
label morte_s625: # -
    morte '«Тогда почему бы тебе не стать чуточку „эффективнее“, пустомеля-полигон».' # [MRT469A]
...
# s626 # say63669
label morte_s626: # -
    morte '«Погоди, я-я-я н-ничего такого не говорил!»' # [MRT470B]
...
# s627 # say63670
label morte_s627: # -
    morte '«Анна все еще в одежде?»' # [MRT565A]
...
# s629 # say63672
label morte_s629: # -
    morte '«Я сейчас тебе приделаю девятнадцатую, если ты не заткнешь свою пасть».' # [MRT564]
...
# s630 # say63673
label morte_s630: # -
    morte '«Если свобода воли заключается в беспрекословном исполнении моих приказов, то — да».' # [MRT569A]
...
# s631 # say63674
label morte_s631: # -
    morte '«Добро пожаловать на планы, сынок».' # [MRT569B]
...
# s632 # say63675
label morte_s632: # -
    morte '«Падшая Грация голая?»' # [MRT568A]
...
# s633 # say63676
label morte_s633: # -
    morte '«Тогда ответ на твой вопрос — да».' # [MRT568B]
...
# s634 # say63677
label morte_s634: # -
    morte '«Купание Анны, Падшей Грации и тебя в киммерийской трясине».' # [MRT571A]
...
# s635 # say63678
label morte_s635: # -
    morte '«Эй. Некоторые читают словарь, а некоторые — его пишут».' # [MRT572B]
...
# s636 # say63679
label morte_s636: # -
    morte '«Анна, бутылка фуриондийского огненного янтарного и номер-люкс в Фестхолле».' # [MRT573]
...
# s638 # say63681
label morte_s638: # -
    morte '«Ох, иди беспокой кого-нибудь еще, дурацкая счетная машинка».' # [MRT576A]
...
# s639 # say63682
label morte_s639: # -
    morte '«Я не знаю, ясно? Оно просто… оно… ну понимаешь… просто исчезло».' # [MRT576B]
...
# s640 # say63683
label morte_s640: # -
    morte '«Если ты не заткнешь свою пасть, я тебе сейчас это покажу».' # [MRT576C]
...
# s641 # say63684
label morte_s641: # -
    morte '«Иди поцелуй медведя в задницу».' # [MRT575A]
...
# s642 # say63685
label morte_s642: # -
    morte '«Поверь мне. Анна заслуживает поцелуя».' # [MRT575B]
...
# s643 # say63686
label morte_s643: # -
    nr '…невинно посвистывает…' # [MRT472A]
...
# s644 # say63688
label morte_s644: # -
    morte '«Никто! Никто ему этого не говорил!»' # [MRT473D]
...
# s645 # say63689
label morte_s645: # -
    morte '«Это чисто добровольное действие с их стороны, идиот. Э… или я не все знаю».' # [MRT577]
...
# s646 # say63858
label morte_s646: # -
    morte '«Поверь мне, ты никогда не встречался с ним».' # [MRT475AA]
...
# s730 # say66816
label morte_s730: # -
    morte '«Эй, шеф, ты доверяешь этим двум? Они могли бы научить *меня* парочке вещей…»' # [MRT387]
...
label morte_s733: # - # IF WEIGHT #1 ~  Global("Fortress_Morte","GLOBAL",3) Global("Absorb","GLOBAL",0)
    ...
    morte '«Эй-эй-эй! Погоди, шеф. Э-э-э… мне тебе нужно кое-что тебе сказать».' # [MRT242]
...
label morte_s741: # from 740.0
    ...
    morte '«Не то чтобы я сильно растрогался, и все же мне, э-э, было приятно с тобой путешествовать, шеф».' # [MRT109]
