...
from game.dlgs.mortuary.morte2.Morte2Logic import (Morte2LogicGenerated, Morte2Logic)


class Morte2LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Morte2LogicGeneratedTests, self).setUp()
...
class Morte2LogicTests(LogicTests):
    def setUp(self):
        super(Morte2LogicTests, self).setUp()
