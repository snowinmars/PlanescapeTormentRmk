class MorteLogicGenerated:
    ...
    def r1845_action(self):
        self.state_manager.set_morte_harlot_quip_1(True)
    ...
    def r2080_action(self):
        ...
        self.state_manager.set_morte_mimir(1)


    def r9029_action(self):
        self.state_manager.set_know_gith(True)
    ...
    def r6952_action(self):
        self.state_manager.set_know_lady(True)
    ...
    def r6957_action(self):
        self.state_manager.set_translate_dabus(0)


    def r7056_action(self):
        self.state_manager.set_morte_zombie_female_bar_quip(True)
    ...
    def r7483_action(self):
        self.state_manager.inc_bd_morte_morale()


    def r7485_action(self):
        self.state_manager.inc_morte_taunt()


    def r11977_action(self):
        self.state_manager.set_ingress_teeth_installed(True)
    ...
    def r11982_action(self):
        self.state_manager.dec_morale_morte()
    ...
    def r12554_action(self):
        self.state_manager.dec_morale_morte(2)
        #$% Enemy() %$#
        #$% Attack(Protagonist) %$#
    ...
    def r12556_action(self):
        self.state_manager.set_baria(2)
    ...
    def r13774_action(self):
        self.state_manager.set_morte_sdthug_quip_1(True)
        self.state_manager.set_know_chaosmen(True)
    ...
    def r13986_action(self):
        self.state_manager.set_morte_wilder_quip_1(True)
        self.state_manager.set_know_chaosmen(True)
    ...
    def r15495_action(self):
        self.state_manager.set_adyzoel(2)


    def r16882_action(self):
        self.state_manager.inc_tree_helpers()
    ...
    def r16888_action(self):
        self.state_manager.inc_bd_dakkon_morale()
        self.state_manager.set_tree_d(True)
    ...
    def r17584_action(self):
        self.state_manager.dec_gold(40)
    ...
    def r18820_action(self):
        self.state_manager.dec_gold(5)


    def r18821_action(self):
        self.state_manager.dec_gold(50)


    def r18822_action(self):
        self.state_manager.dec_gold(100)


    def r18823_action(self):
        self.state_manager.dec_gold(500)
    ...
    def r18834_action(self):
        self.state_manager.dec_gold(10)
    ...
    def r20612_action(self):
        self.state_manager.set_know_marta_work(3)
    ...
    def r28038_action(self):
        self.state_manager.dec_gold(30)
    ...
    def r28047_action(self):
        self.state_manager.dec_gold(80)
    ...
    def r28743_action(self):
        self.state_manager.set_morte_stolen(3)
    ...
    def r28968_action(self):
        self.state_manager.set_qui_sai(2)
    ...
    def r30826_action(self):
        self.state_manager.set_able(True)
    ...
    def r32370_action(self):
        self.state_manager.set_lecture_death(2)
    ...
    def r33076_action(self):
        self.state_manager.set_lecture_ghysis(2)
    ...
    def r39716_action(self):
        self.state_manager.set_yves_shared(True)
    ...
    def r40848_action(self):
        self.state_manager.set_met_modrons(True)
    ...
    def r43910_action(self):
        self.state_manager.set_nemelle(3)
        self.state_manager.set_aelwyn_value(4)
    ...
    def r52577_action(self):
        self.state_manager.set_ravel_grace(2)


    def r52578_action(self):
        self.state_manager.set_ravel_annah(2)
    ...
    def r53825_action(self):
        self.state_manager.set_pillar_musk(True)
    ...
    def s576_action(self):
        self.state_manager.set_know_source(True)
    ...
    def r55925_action(self):
        self.state_manager.set_know_mechanus(True)
    ...
    def s603_action(self):
        self.state_manager.inc_grace_talked_morte()
    ...
    def s611_action(self):
        self.state_manager.set_grace_talked_morte(0)


    def s615_action(self):
        self.state_manager.set_annah_talked_morte(3)


    def s620_action(self):
        self.state_manager.set_annah_talked_morte(8)


    def s622_action(self):
        self.state_manager.set_annah_talked_morte(0)
    ...
    def s625_action(self):
        self.state_manager.set_nordom_talked_morte(3)


    def s628_action(self):
        self.state_manager.set_nordom_talked_morte(5)
    ...
    def s642_action(self):
        self.state_manager.set_nordom_talked_morte(0)


    def s643_action(self):
        self.state_manager.set_nordom_talked_annah(0)


    def s644_action(self):
        self.state_manager.set_nordom_talked_grace(2)
    ...
    def r65569_action(self):
        self.state_manager.set_morte_tattoo_xp(True)
    ...
    def r65621_action(self):
        self.state_manager.set_morte_talent(True)
    ...
    def r65774_action(self):
        self.state_manager.set_memory_morte_pillar(True)
    ...
    def s713_action(self):
        self.state_manager.set_know_morte_pillar(1)
    ...
    def r65821_action(self):
        self.state_manager.gain_experience('party', 12000)
        self.state_manager.inc_morale_morte(3)
        ...
        self.state_manager.set_bd_morte_story(True)
    ...
    def r68176_action(self):
        self.state_manager.set_fortress_morte(4)
        self.state_manager.set_in_party_morte(True)
    ...
    def r1006_condition(self):
        return self.state_manager.get_read_scars()
    ...
    def r9029_condition(self):
        return not self.state_manager.get_know_gith()


    def r9030_condition(self):
        return self.state_manager.get_know_gith()


    def r6952_condition(self):
        return not self.state_manager.get_know_lady()


    def r6953_condition(self):
        return self.state_manager.get_know_lady()
    ...
    def r3969_condition(self):
        return not self.state_manager.get_has_prybar() and \
    ...
    def r3971_condition(self):
        return self.state_manager.get_has_prybar()


    def r3972_condition(self):
        return not self.state_manager.get_morte_skel_mort_quip()


    def r3973_condition(self):
        return self.state_manager.get_morte_skel_mort_quip()
    ...
    def r64535_condition(self):
        return not self.state_manager.get_vaxis_global_xp()


    def r64534_condition(self):
        return self.state_manager.get_vaxis_global_xp()


    def r6325_condition(self):
        return self.state_manager.get_has_cobble() #$% Checks if "Cobble" is in Quick Item Slot 4 Other possible values include "Weapon1", "Weapon2", "Shield", "Armor", "Helmet", "RingLeft", "RingRight", "Cloak", "Amulet", "Belt", "Boots", "Gloves", "QuickItem1-3", or "Inventory" (general inventory).%$#


    def r6326_condition(self):
        return not self.state_manager.get_has_cobble() #$% Checks if "Cobble" is in Quick Item Slot 4 Other possible values include "Weapon1", "Weapon2", "Shield", "Armor", "Helmet", "RingLeft", "RingRight", "Cloak", "Amulet", "Belt", "Boots", "Gloves", "QuickItem1-3", or "Inventory" (general inventory).%$#
    ...
    def r6665_condition(self):
        return self.state_manager.characters_manager.get_property('protagonist', 'wisdom') > 12 and \
               not self.state_manager.get_42_secret()
    ...
    def r7057_condition(self):
        return not self.state_manager.get_morte_quip()
    ...
    def r11985_condition(self):
        return self.state_manager.get_evil_ingress_teeth_1()


    def r11986_condition(self):
        return self.state_manager.get_good_ingress_teeth_1()
    ...
    def r12855_condition(self):
        return not self.state_manager.get_know_mimir()
    ...
    def r13774_condition(self):
        return not self.state_manager.get_know_chaosmen()


    def r13775_condition(self):
        return self.state_manager.get_know_chaosmen()
    ...
    def r13989_condition(self):
        return self.state_manager.get_join_chaosmen() == 0


    def r14275_condition(self):
        return self.state_manager.get_mortai_contract() and \
               self.state_manager.get_coppereyes_contract() > 0
    ...
    def r14277_condition(self):
        return not self.state_manager.get_mortai_contract() and \
               self.state_manager.get_coppereyes_contract() > 0
    ...
    def r16884_condition(self):
        return self.state_manager.get_in_party_annah() and \
               not self.state_manager.get_tree_a()


    def r16885_condition(self):
        return self.state_manager.get_in_party_ignus() and \
               not self.state_manager.get_tree_i()


    def r16886_condition(self):
        return self.state_manager.get_in_party_grace() and \
               not self.state_manager.get_tree_g()


    def r16887_condition(self):
        return self.state_manager.get_in_party_dakkon() and \
               not self.state_manager.get_tree_d()


    def r16888_condition(self):
        return self.state_manager.get_in_party_dakkon() and \
               not self.state_manager.get_tree_d() and \
               self.state_manager.get_dakkon_slave()


    def r16889_condition(self):
        return self.state_manager.get_in_party_nordom() and \
               not self.state_manager.get_tree_n()


    def r16890_condition(self):
        return self.state_manager.get_in_party_vhail() and \
               not self.state_manager.get_tree_v()


    def r16893_condition(self):
        return self.state_manager.get_in_party_morte() and \
               not self.state_manager.get_tree_m()
    ...
    def r17583_condition(self):
        return self.state_manager.get_in_party_annah()


    def r17584_condition(self):
        return self.state_manager.get_gold() > 39
    ...
    def r17587_condition(self):
        return self.state_manager.get_gold() < 40
    ...
    def r18820_condition(self):
        return self.state_manager.get_gold() > 4


    def r18821_condition(self):
        return self.state_manager.get_gold() > 49


    def r18822_condition(self):
        return self.state_manager.get_gold() > 99


    def r18823_condition(self):
        return self.state_manager.get_gold() > 499


    def r18824_condition(self):
        return self.state_manager.get_gold() < 5
    ...
    def r18834_condition(self):
        return self.state_manager.get_gold() > 9
    ...
    def r19668_condition(self):
        return not self.state_manager.get_can_speak_with_dead()
    ...
    def r20612_condition(self):
        return self.state_manager.get_know_marta_work() < 3


    def r20613_condition(self):
        return self.state_manager.get_know_marta_work() > 2
    ...
    def r28038_condition(self):
        return self.state_manager.get_malmaner() == 3 and \
               self.state_manager.get_chaotic_malmaner_1() != 1
    ...
    def r28045_condition(self):
        return self.state_manager.get_malmaner() == 5 and \
               self.state_manager.get_chaotic_malmaner_1() != 3
    ...
    def r28968_condition(self):
        return self.state_manager.get_cw_sal_hint()
    ...
    def r28980_condition(self):
        return self.state_manager.get_know_ravel()
    ...
    def r30825_condition(self):
        return self.state_manager.get_able()


    def r30826_condition(self):
        return not self.state_manager.get_able()


    def r65541_condition(self):
        return not self.state_manager.get_morte_talent()


    def r65542_condition(self):
        return self.state_manager.get_morte_talent()


    def r65543_condition(self):
        return self.state_manager.get_morte_tattoo_xp()


    def r65545_condition(self):
        return self.state_manager.get_know_mimir() and \
               not self.state_manager.get_morte_story()


    def r65546_condition(self):
        return self.state_manager.get_morte_story()


    def r65547_condition(self):
        return self.state_manager.get_know_morte_pillar() == 1


    def r65548_condition(self):
        return self.state_manager.get_know_blood_war()


    def r65549_condition(self):
        return self.state_manager.get_know_ravel() and \
               self.state_manager.get_ravel_value() == 0
    ...
    def r40077_condition(self):
        return self.state_manager.get_nenny() == 2
    ...
    def r40079_condition(self):
        return self.state_manager.get_nenny() == 1
    ...
    def r41921_condition(self):
        return self.state_manager.get_story_reekwind_curse() and \
               not self.state_manager.get_jumble_reekwind()


    def r67864_condition(self):
        return self.state_manager.get_jumble_reekwind()


    def r43909_condition(self):
        return self.state_manager.get_has_decant() and \
               self.state_manager.get_seek_word() == 1


    def r43910_condition(self):
        return self.state_manager.get_aelwyn_value() == 2 and \
               not self.state_manager.get_dead_aelwyn()


    def r43911_condition(self):
        return self.state_manager.get_aelwyn_value() < 2
    ...
    def r52577_condition(self):
        return self.state_manager.get_in_party_grace()


    def r52578_condition(self):
        return not self.state_manager.get_in_party_grace() and \
               self.state_manager.get_in_party_annah()


    def r52579_condition(self):
        return not self.state_manager.get_in_party_grace() and \
               not self.state_manager.get_in_party_annah()
    ...
    def r53627_condition(self):
        return not self.state_manager.get_morte_story()
    ...
    def r53663_condition(self):
        return not self.state_manager.get_in_party_annah()
    ...
    def r53826_condition(self):
        return self.state_manager.get_in_party_annah() and \
               not self.state_manager.get_in_party_grace()
    ...
    def r53832_condition(self):
        return self.state_manager.get_specialist() == 4


    def r53833_condition(self):
        return self.state_manager.get_specialist() == 5


    def r53834_condition(self):
        return self.state_manager.get_specialist() == 6


    def r53835_condition(self):
        return self.state_manager.get_specialist() != 4 and \
               self.state_manager.get_specialist() != 5 and \
               self.state_manager.get_specialist() != 6


    def r53836_condition(self):
        return not self.state_manager.get_where_fhjull()


    def r53837_condition(self):
        return self.state_manager.get_where_fhjull() and \
               self.state_manager.get_has_cube()


    def r53838_condition(self):
        return self.state_manager.get_where_fhjull() and \
               not self.state_manager.get_has_cube() and \
               self.state_manager.get_in_party_grace()


    def r53839_condition(self):
        return self.state_manager.get_where_fhjull() and \
               not self.state_manager.get_has_cube() and \
               not self.state_manager.get_in_party_grace() and \
               self.state_manager.get_in_party_annah()
    ...
    def r54179_condition(self):
        return self.state_manager.get_morte_quip_regret_portal() > 1 and \
    ...
    def r54220_condition(self):
        return self.state_manager.characters_manager.get_property('protagonist', 'intelligence') > 15 and \
               self.state_manager.get_in_party_dakkon()


    def r54221_condition(self):
        return self.state_manager.characters_manager.get_property('protagonist', 'intelligence') > 15 and \
               not self.state_manager.get_in_party_dakkon() and \
               self.state_manager.get_dakkon_value() > 0
    ...
    def r54250_condition(self):
        return self.state_manager.get_bd_morte_morale() > 5


    def r54252_condition(self):
        return self.state_manager.get_bd_morte_morale() < 6
    ...
    def r54278_condition(self):
        return self.state_manager.get_in_party_morte() and \
               not self.state_manager.get_morte_morale_fortress_portal()
    ...
    def r54282_condition(self):
        return self.state_manager.get_ravel_grace() > 0 and \
               self.state_manager.get_ravel_morte() > 0 and \
               self.state_manager.get_torment_fell() < 2 and \
               self.state_manager.get_in_party_grace()
    ...
    def r54284_condition(self):
        return self.state_manager.get_ravel_morte() > 0 and \
               self.state_manager.get_torment_fell() < 2 and \
               not self.state_manager.get_in_party_grace()
    ...
    def r54286_condition(self):
        return self.state_manager.get_ravel_morte() == 0
    ...
    def r55849_condition(self):
        return not self.state_manager.get_in_party_grace()
    ...
    def r61412_condition(self):
        return self.state_manager.get_gold() < 500


    def r65554_condition(self):
        return self.state_manager.get_morte_warning()
    ...
    def r65569_condition(self):
        return not self.state_manager.get_morte_tattoo_xp()
    ...
    def r65613_condition(self):
        return self.state_manager.get_morte_stolen() > 2
    ...
    def r65640_condition(self):
        return self.state_manager.get_pharod_value() == 1 and \
               self.state_manager.get_pharod_quest() == 1


    def r65641_condition(self):
        return self.state_manager.get_pharod_quest() > 1 and \
    ...
    def r65643_condition(self):
        return self.state_manager.locations_manager.is_visited_internal('AR0500') and \
               not self.state_manager.get_know_ravel()


    def r65644_condition(self):
        return self.state_manager.get_know_ravel() and \
               self.state_manager.get_know_ravel_key() == 0


    def r65645_condition(self):
        return self.state_manager.get_know_ravel() and \
               self.state_manager.get_know_ravel_key() > 0 and \
    ...
    def r65674_condition(self):
        return self.state_manager.get_know_ravel_key() == 1
    ...
    def r65700_condition(self):
        return self.state_manager.get_grace_silver_mimir()


    def r65708_condition(self):
        return self.state_manager.get_grace_smell_mimir()
    ...
    def r65718_condition(self):
        return self.state_manager.get_grace_smell_mimir() and \
    ...
    def r65739_condition(self):
        return self.state_manager.get_know_morte_pillar() > 0
    ...
    def r65750_condition(self):
        return not self.state_manager.get_chaotic_morte_1()


    def r65751_condition(self):
        return not self.state_manager.get_lawful_morte_1()
    ...
    def r65774_condition(self):
        return not self.state_manager.get_memory_morte_pillar()


    def r65775_condition(self):
        return self.state_manager.get_memory_morte_pillar()
    ...
    def r68178_condition(self):
        return not self.state_manager.get_trans_vanish() and \
               self.state_manager.get_fortress_party_roof() > 1


    def r68189_condition(self):
        return self.state_manager.get_trans_vanish() and \
               self.state_manager.get_fortress_dakkon() > 0


    def r68190_condition(self):
        return self.state_manager.get_trans_vanish() and \
               self.state_manager.get_fortress_dakkon() == 0 and \
               self.state_manager.get_fortress_annah() > 0


    def r68191_condition(self):
        return self.state_manager.get_trans_vanish() and \
               self.state_manager.get_fortress_dakkon() == 0 and \
               self.state_manager.get_fortress_annah() == 0 and \
               self.state_manager.get_fortress_grace() > 0
    ...
    def r68192_condition(self):
        return self.state_manager.get_trans_vanish() and \
               self.state_manager.get_fortress_dakkon() == 0 and \
               self.state_manager.get_fortress_annah() == 0 and \
               self.state_manager.get_fortress_grace() == 0 and \
               self.state_manager.get_fortress_ignus() > 0 and \
               not self.state_manager.get_fortress_ignus_battle()
    ...
    def r68193_condition(self):
        return self.state_manager.get_trans_vanish() and \
               ...
               self.state_manager.get_fortress_grace() == 0 and \
               self.state_manager.get_fortress_ignus() == 0 and \
               self.state_manager.get_fortress_vhailor() > 0 and \
               not self.state_manager.get_fortress_vhailor_battle()
    ...
    def r68194_condition(self):
        return self.state_manager.get_trans_vanish() and \
               ...
               self.state_manager.get_fortress_ignus() == 0 and \
               self.state_manager.get_fortress_vhailor() == 0 and \
               self.state_manager.get_fortress_nordom() > 0
    ...
    def r68438_condition(self):
        return self.state_manager.get_trans_vanish() and \
               ...
               self.state_manager.get_fortress_ignus() == 0 and \
               self.state_manager.get_fortress_vhailor() > 0 and \
               self.state_manager.get_fortress_vhailor_battle() and \
               self.state_manager.get_fortress_nordom() == 0
    ...
    def r68439_condition(self):
        return self.state_manager.get_trans_vanish() and \
               ...
               self.state_manager.get_fortress_grace() == 0 and \
               self.state_manager.get_fortress_ignus() > 0 and \
               self.state_manager.get_fortress_ignus_battle() and \
               self.state_manager.get_fortress_vhailor() == 0 and \
               self.state_manager.get_fortress_nordom() == 0
    ...
    def r68175_condition(self):
        return self.state_manager.get_fortress_annah() > 0


    def r68179_condition(self):
        return self.state_manager.get_fortress_dakkon() > 0


    def r68180_condition(self):
        return self.state_manager.get_fortress_grace() > 0


    def r68181_condition(self):
        return self.state_manager.get_fortress_nordom() > 0


    def r68182_condition(self):
        return self.state_manager.get_fortress_ignus() > 0 and \
               not self.state_manager.get_fortress_ignus_battle()


    def r68183_condition(self):
        return self.state_manager.get_fortress_vhailor() > 0 and \
               not self.state_manager.get_fortress_vhailor_battle()
    ...
    def r68320_condition(self):
        return self.state_manager.get_fortress_dakkon() > 0 and \
               self.state_manager.get_fortress_annah() == 0


    def r68321_condition(self):
        return self.state_manager.get_fortress_grace() > 0 and \
               self.state_manager.get_fortress_dakkon() == 0 and \
               self.state_manager.get_fortress_annah() == 0


    def r68322_condition(self):
        return self.state_manager.get_fortress_nordom() > 0 and \
               self.state_manager.get_fortress_grace() == 0 and \
               self.state_manager.get_fortress_dakkon() == 0 and \
               self.state_manager.get_fortress_annah() == 0
    ...
    def r68323_condition(self):
        return self.state_manager.get_fortress_ignus() > 0 and \
               not self.state_manager.get_fortress_ignus_battle() and \
               self.state_manager.get_fortress_nordom() == 0 and \
               self.state_manager.get_fortress_grace() == 0 and \
               self.state_manager.get_fortress_dakkon() == 0 and \
               self.state_manager.get_fortress_annah() == 0
    ...
    def r68324_condition(self):
        return self.state_manager.get_fortress_vhailor() > 0 and \
               not self.state_manager.get_fortress_vhailor_battle() and \
               self.state_manager.get_fortress_ignus() == 0 and \
               self.state_manager.get_fortress_nordom() == 0 and \
               self.state_manager.get_fortress_grace() == 0 and \
               self.state_manager.get_fortress_dakkon() == 0 and \
    ...
    def r68490_condition(self):
        return self.state_manager.get_fortress_vhailor() > 0 and \
               ...
               self.state_manager.get_fortress_dakkon() == 0 and \
               self.state_manager.get_fortress_annah() == 0 and \
               self.state_manager.get_fortress_ignus_battle()
