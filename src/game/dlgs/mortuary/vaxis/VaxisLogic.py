class VaxisLogicGenerated:
    ...
    def j64513_s2_r464_action(self):
        self.state_manager.journal_notes_manager.update_journal('64513')
    ...
    def j64517_s30_r4469_action(self):
        self.state_manager.journal_notes_manager.update_journal('64517')
    ...
    def r4469_action(self):
        ...
        self.state_manager.inventory_items_manager.pick_item('bandage', 3)
    ...
    def j64519_s36_r64520_action(self):
        self.state_manager.journal_notes_manager.update_journal('64519')
    ...
    def j64518_s36_r4503_action(self):
        self.state_manager.journal_notes_manager.update_journal('64518')
    ...
    def j64521_s42_r4521_action(self):
        self.state_manager.journal_notes_manager.update_journal('64521')
    ...
    def j64522_s44_r4539_action(self):
        self.state_manager.journal_notes_manager.update_journal('64522')
    ...
    def j64528_s51_r64527_action(self):
        self.state_manager.journal_notes_manager.update_journal('64528')
    ...
    def j64529_s51_r4568_action(self):
        self.state_manager.journal_notes_manager.update_journal('64529')
    ...
    def r4580_action(self):
        ...
        self.state_manager.journal_notes_manager.update_journal('64530')
    ...
    def r4620_action(self):
        ...
        self.state_manager.inventory_items_manager.drop_item('embalm')
        self.state_manager.inventory_items_manager.drop_item('needle')
    ...
    def j64531_s67_r4638_action(self):
        self.state_manager.journal_notes_manager.update_journal('64531')
    ...
    def r4494_condition(self):
        return self.state_manager.inventory_items_manager.is_own_item('keyem')
    ...
    def r64527_condition(self):
        return not self.state_manager.inventory_items_manager.is_own_item('bonechrm')


    def r4568_condition(self):
        return self.state_manager.inventory_items_manager.is_own_item('bonechrm')
    ...
    def r4592_condition(self):
        return self.state_manager.world_manager.get_embalm_key_quest() == 1 and \
               self.state_manager.inventory_items_manager.is_own_item('keyem')
    ...
    def r4594_condition(self):
        return self.state_manager.world_manager.get_embalm_key_quest() == 1 and \
               not self.state_manager.inventory_items_manager.is_own_item('keyem')
    ...
    def r4620_condition(self):
        return self.state_manager.inventory_items_manager.is_own_item('embalm') and \
               self.state_manager.inventory_items_manager.is_own_item('needle')
