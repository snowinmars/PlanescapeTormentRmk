...
from game.dlgs.mortuary.vaxis.VaxisLogic import (VaxisLogicGenerated, VaxisLogic)


class VaxisLogicGeneratedTests(LogicTests):
    def setUp(self):
        super(VaxisLogicGeneratedTests, self).setUp()
...
class VaxisLogicTests(LogicTests):
    def setUp(self):
        super(VaxisLogicTests, self).setUp()
