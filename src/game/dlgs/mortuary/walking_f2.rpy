...
label walk_to_mortuaryf1r4_closed:
    nr "Эта дверь заперта. Тебе понадобится ключ."
    jump graphics_menu
...
label walk_mortuary_f2r1_pick_scalpel:
    $ walkingF2Logic.pick_scalpel()
    scene bg mortuary_f2r1
    nr "Ты подбираешь скальпель с одной из полок."
    jump graphics_menu


label walk_mortuary_f2r7_pick_embalm:
    $ walkingF2Logic.walk_mortuary_f2r7_pick_embalm()
    scene bg mortuary_f2r7
    nr "На столе стоят несколько бутылок с мутно-зелёной жидкостью. Ты берёшь парочку."
    jump graphics_menu


label walk_mortuary_f2r7_pick_copper_earring_closed:
    $ walkingF2Logic.walk_mortuary_f2r7_pick_copper_earring_closed()
    scene bg mortuary_f2r7
