...
label xach_s0:  # - # IF ~  True()
    nr 'Перед тобой труп мужчины с выбитым на черепе номером 331. Его веки и губы крепко зашиты, в горле зияет огромная дыра. От него *отвратительно* пахнет.'
...
label xach_s5:  # from 4.0
    ...
    xach '…снова сделал неправильный выбор? — из дыры в горле Захарии со свистом выходит воздух. — Ты ведь тоже мертв?'
...
label xach_s37:  # from 36.0
    xach 'Чуть левее… еще чуть-чуть… Твоя рука на нащупывает предмет.'
