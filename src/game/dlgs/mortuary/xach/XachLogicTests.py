...
from game.dlgs.mortuary.xach.XachLogic import (XachLogicGenerated, XachLogic)


class XachLogicGeneratedTests(LogicTests):
    def setUp(self):
        super(XachLogicGeneratedTests, self).setUp()
...
class XachLogicTests(LogicTests):
    def setUp(self):
        super(XachLogicTests, self).setUp()
