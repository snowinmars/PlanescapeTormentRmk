class XachLogicGenerated:
    ...
    def r524_action(self):
        self.state_manager.set_vaxis_exposed(True)


    def r645_action(self):
        self.state_manager.set_xachariah_ring(1)


    def r663_action(self):
        self.state_manager.set_has_xac_liver(True)


    def r666_action(self):
        self.state_manager.set_xachariah_ring(2)
        self.state_manager.set_has_xac_heart(True)


    def r672_action(self):
        self.state_manager.set_xachariah_request(True)
    ...
    def r679_action(self):
        self.state_manager.set_dead_xach(True)


    def r681_action(self):
        self.state_manager.set_xachariah_gutted(False)
    ...
    def r506_condition(self):
        return self.state_manager.get_know_xachariah_name()
    ...
    def r518_condition(self):
        return not self.state_manager.get_xachariah_request()


    def r1394_condition(self):
        return self.state_manager.get_xachariah_request()
    ...
    def r63484_condition(self):
        return self.state_manager.get_xachariah_ring() == 1
    ...
    def r63234_condition(self):
        return self.state_manager.get_xachariah_ring() < 2
    ...
    def r601_condition(self):
        return self.state_manager.get_dakkon_slave()
    ...
    def r632_condition(self):
        return not self.state_manager.get_know_xachariah_name()
