...
from game.dlgs.mortuary_zombies.s42.S42Logic import (S42LogicGenerated, S42Logic)


class S42LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(S42LogicGeneratedTests, self).setUp()
...
class S42LogicTests(LogicTests):
    def setUp(self):
        super(S42LogicTests, self).setUp()
