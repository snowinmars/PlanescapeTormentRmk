class S42LogicGenerated:
    ...
    def r6640_action(self):
        self.state_manager.set_dead_s42(True)
    ...
    def r58984_action(self):
        self.state_manager.set_has_gs_knife(True)
        self.state_manager.set_has_rags(True)
        self.state_manager.set_has_clotchrm(True)
        self.state_manager.set_has_clotchrm(True)
        self.state_manager.inc_gold(99)
