...
class S42LogicGeneratedTest(LogicTest):
    ...
    def test_r6642_action(self):
        ...
        self.assertTrue(self.state_manager.get_dead_s42())
    ...
    def test_r58984_action(self):
        self.state_manager.set_has_gs_knife(False)
        self.state_manager.set_has_rags(False)
        self.state_manager.set_has_clotchrm(False)
        self.state_manager.set_has_clotchrm(False)
        gold_before = 0
        gold_after = 99
        ...
        self.assertFalse(self.state_manager.get_has_gs_knife())
        self.assertFalse(self.state_manager.get_has_rags())
        self.assertFalse(self.state_manager.get_has_clotchrm())
        self.assertFalse(self.state_manager.get_has_clotchrm())
        self.assertEqual(self.state_manager.get_gold(), gold_before)

        self.logic.r58984_action()

        self.assertTrue(self.state_manager.get_has_gs_knife())
        self.assertTrue(self.state_manager.get_has_rags())
        self.assertTrue(self.state_manager.get_has_clotchrm())
        self.assertTrue(self.state_manager.get_has_clotchrm())
