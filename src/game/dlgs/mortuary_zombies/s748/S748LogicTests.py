...
from game.dlgs.mortuary_zombies.s748.S748Logic import (S748LogicGenerated, S748Logic)


class S748LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(S748LogicGeneratedTests, self).setUp()
    ...
    def test_r35431_action(self):
        self.state_manager.world_manager.set_dead_s748(False)
        ...
        self.assertFalse(self.state_manager.world_manager.get_dead_s748())
        ...
        self.assertTrue(self.state_manager.world_manager.get_dead_s748())
    ...
    def test_r35451_condition(self):
        ...
        self.state_manager.world_manager.set_in_party_morte(False)
        self.state_manager.world_manager.set_morte_skel_mort_quip2(False)
        self.state_manager.inventory_items_manager.drop_all_items('prybar')
...
class S748LogicTests(LogicTests):
    def setUp(self):
        super(S748LogicTests, self).setUp()
        self.logic = S748Logic(self.state_manager)


    def test_talk(self):
        self._integer_inc_action(
            self.state_manager.world_manager.get_talked_to_s748_times,
            1,
            self.logic.talk
        )
