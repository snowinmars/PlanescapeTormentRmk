...
from game.dlgs.mortuary_zombies.s863.S863Logic import (S863LogicGenerated, S863Logic)


class S863LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(S863LogicGeneratedTests, self).setUp()
    ...
    def test_r64266_action(self):
        self._false_then_true_action(
            lambda: self.state_manager.inventory_items_manager.is_own_item('dremind'),
...
class S863LogicTests(LogicTests):
    def setUp(self):
        super(S863LogicTests, self).setUp()
