class S863LogicGenerated:
    ...
    def r35538_action(self):
        ...
        self.state_manager.set_skeleton_chaotic(True)
    ...
    def r35585_action(self):
        self.state_manager.set_dead_s863(True)
        self.state_manager.set_has_spike(True)
        self.state_manager.set_has_strap(True)
    ...
    def r64266_action(self):
        self.state_manager.set_has_dremind(True)


    def r35538_condition(self):
        return not self.state_manager.get_skeleton_chaotic()


    def r35561_condition(self):
        return self.state_manager.get_skeleton_chaotic()
    ...
    def r35602_condition(self):
        return self.state_manager.get_skeleton_examine() and \
               self.state_manager.get_in_party_morte() and \
               not self.state_manager.get_morte_skel_mort_quip2()


    def r35603_condition(self):
        return self.state_manager.get_skeleton_examine() and \
               self.state_manager.get_in_party_morte() and \
               self.state_manager.get_morte_skel_mort_quip2() and \
               not self.state_manager.get_has_prybar() and \
    ...
    def r35610_condition(self):
        return self.state_manager.get_in_party_morte() and \
               not self.state_manager.get_morte_skel_mort_quip()
    ...
    def r35578_condition(self):
        return self.state_manager.characters_manager.get_property('protagonist', 'intelligence') > 12 and \
               not self.state_manager.get_in_party_morte() and \
               not self.state_manager.get_morte_skel_mort_quip()
