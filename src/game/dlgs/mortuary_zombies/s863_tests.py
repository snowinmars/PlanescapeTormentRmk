...
class S863LogicGeneratedTest(LogicTest):
    ...
    def test_r35585_action(self):
        self.state_manager.set_dead_s863(False)
        self.state_manager.set_has_spike(False)
        self.state_manager.set_has_strap(False)

        self.assertFalse(self.state_manager.get_dead_s863())
        ...
        self.assertTrue(self.state_manager.get_dead_s863())
    ...
    def test_r64266_action(self):
        self._false_then_true_action(
            self.state_manager.get_has_dremind,
