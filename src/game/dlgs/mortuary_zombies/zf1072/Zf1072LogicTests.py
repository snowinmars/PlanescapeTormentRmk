...
from game.dlgs.mortuary_zombies.zf1072.Zf1072Logic import (Zf1072LogicGenerated, Zf1072Logic)


class Zf1072LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zf1072LogicGeneratedTests, self).setUp()
...
class Zf1072LogicTests(LogicTests):
    def setUp(self):
        super(Zf1072LogicTests, self).setUp()
