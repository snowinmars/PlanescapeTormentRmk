...
from game.dlgs.mortuary_zombies.zf114.Zf114Logic import (Zf114LogicGenerated, Zf114Logic)


class Zf114LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zf114LogicGeneratedTests, self).setUp()
...
class Zf114LogicTests(LogicTests):
    def setUp(self):
        super(Zf114LogicTests, self).setUp()
        self.logic = Zf114Logic(self.state_manager)


    def test_talk(self):
        self._integer_inc_action(
            self.state_manager.world_manager.get_talked_to_zf114_times,
            1,
            self.logic.talk
        )
