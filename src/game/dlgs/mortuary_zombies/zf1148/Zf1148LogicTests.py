...
from game.dlgs.mortuary_zombies.zf1148.Zf1148Logic import (Zf1148LogicGenerated, Zf1148Logic)


class Zf1148LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zf1148LogicGeneratedTests, self).setUp()
        self.logic = Zf1148LogicGenerated(self.state_manager)
...
class Zf1148LogicTests(LogicTests):
    def setUp(self):
        super(Zf1148LogicTests, self).setUp()
        self.logic = Zf1148Logic(self.state_manager)


    def test_talk(self):
        self._integer_inc_action(
            self.state_manager.world_manager.get_talked_to_zf1148_times,
            1,
            self.logic.talk
        )
