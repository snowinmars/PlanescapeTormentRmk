...
from game.dlgs.mortuary_zombies.zf626.Zf626Logic import (Zf626LogicGenerated, Zf626Logic)


class Zf626LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zf626LogicGeneratedTests, self).setUp()
...
class Zf626LogicTests(LogicTests):
    def setUp(self):
        super(Zf626LogicTests, self).setUp()
