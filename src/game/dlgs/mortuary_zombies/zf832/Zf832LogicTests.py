...
from game.dlgs.mortuary_zombies.zf832.Zf832Logic import (Zf832LogicGenerated, Zf832Logic)


class Zf832LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zf832LogicGeneratedTests, self).setUp()
...
class Zf832LogicTests(LogicTests):
    def setUp(self):
        super(Zf832LogicTests, self).setUp()
        self.logic = Zf832Logic(self.state_manager)


    def test_talk(self):
        self._integer_inc_action(
            self.state_manager.world_manager.get_talked_to_zf832_times,
            1,
            self.logic.talk
        )
