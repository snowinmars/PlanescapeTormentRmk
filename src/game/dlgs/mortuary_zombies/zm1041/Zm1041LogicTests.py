...
from game.dlgs.mortuary_zombies.zm1041.Zm1041Logic import (Zm1041LogicGenerated, Zm1041Logic)


class Zm1041LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zm1041LogicGeneratedTests, self).setUp()
    ...
    def test_r9207_action(self):
        ...
        self.assertFalse(self.state_manager.world_manager.get_know_xixi())
        ...
        self.assertTrue(self.state_manager.world_manager.get_know_xixi())
    ...
    def test_r9209_action(self):
        self._false_then_true_action(
            self.state_manager.world_manager.get_know_xixi,
...
class Zm1041LogicTests(LogicTests):
    def setUp(self):
        super(Zm1041LogicTests, self).setUp()
