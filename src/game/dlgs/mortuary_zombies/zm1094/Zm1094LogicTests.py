...
from game.dlgs.mortuary_zombies.zm1094.Zm1094Logic import (Zm1094LogicGenerated, Zm1094Logic)


class Zm1094LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zm1094LogicGeneratedTests, self).setUp()
...
class Zm1094LogicTests(LogicTests):
    def setUp(self):
        super(Zm1094LogicTests, self).setUp()
