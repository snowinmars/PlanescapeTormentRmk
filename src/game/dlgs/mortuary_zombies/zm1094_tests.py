...
class Zm1094LogicTest(LogicTest):
    ...
    def test_set_know_asonje_name(self):
        self._false_then_true_action(
            self.state_manager.get_know_asonje_name,
    ...
    def test_get_know_asonje_name(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_know_asonje_name(x),
...
class Zm1094LogicGeneratedTest(LogicTest):
    ...
    def test_r6568_action(self):
        ...
        self._integer_equals_action(
            self.state_manager.get_asonje_value,
            1,
    ...
    def test_r9247_action(self):
        ...
        self.state_manager.set_asonje_value(asonje_value_before)

        good_before = self.state_manager.characters_manager.get_property(who_good, prop_good)
        self.assertEqual(self.state_manager.get_asonje_value(), asonje_value_before)
        ...
        self.assertEqual(self.state_manager.get_asonje_value(), asonje_value_after)
        ...
        self.assertEqual(self.state_manager.get_asonje_value(), asonje_value_after_once)
    ...
    def test_r9282_condition(self):
        self._integer_not_equal_condition(
            lambda x: self.state_manager.set_asonje_value(x),
            2,
