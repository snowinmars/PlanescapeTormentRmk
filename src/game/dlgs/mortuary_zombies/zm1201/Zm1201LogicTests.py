...
from game.dlgs.mortuary_zombies.zm1201.Zm1201Logic import (Zm1201LogicGenerated, Zm1201Logic)


class Zm1201LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zm1201LogicGeneratedTests, self).setUp()
...
class Zm1201LogicTests(LogicTests):
    def setUp(self):
        super(Zm1201LogicTests, self).setUp()
        self.logic = Zm1201Logic(self.state_manager)


    def test_talk(self):
        self._integer_inc_action(
            self.state_manager.world_manager.get_talked_to_zm1201_times,
            1,
            self.logic.talk
        )
