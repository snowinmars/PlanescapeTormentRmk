...
from game.dlgs.mortuary_zombies.zm1445.Zm1445Logic import (Zm1445LogicGenerated, Zm1445Logic)


class Zm1445LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zm1445LogicGeneratedTests, self).setUp()
...
class Zm1445LogicTests(LogicTests):
    def setUp(self):
        super(Zm1445LogicTests, self).setUp()
