...
from game.dlgs.mortuary_zombies.zm199.Zm199Logic import (Zm199LogicGenerated, Zm199Logic)


class Zm199LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zm199LogicGeneratedTests, self).setUp()
        self.logic = Zm199LogicGenerated(self.state_manager)
...
class Zm199LogicTests(LogicTests):
    def setUp(self):
        super(Zm199LogicTests, self).setUp()
        self.logic = Zm199Logic(self.state_manager)


    def test_talk(self):
        self._integer_inc_action(
            self.state_manager.world_manager.get_talked_to_zm199_times,
            1,
            self.logic.talk
        )
