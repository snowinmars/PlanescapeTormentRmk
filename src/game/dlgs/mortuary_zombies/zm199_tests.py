...
from game.dlgs.mortuary_zombies.zm199_logic import (Zm199LogicGenerated, Zm199Logic)


class Zm199LogicGeneratedTest(LogicTest):
    def setUp(self):
        super(Zm199LogicGeneratedTest, self).setUp()
