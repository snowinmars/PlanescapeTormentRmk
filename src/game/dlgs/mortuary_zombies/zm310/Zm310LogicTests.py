...
from game.dlgs.mortuary_zombies.zm310.Zm310Logic import (Zm310LogicGenerated, Zm310Logic)


class Zm310LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zm310LogicGeneratedTests, self).setUp()
...
class Zm310LogicTests(LogicTests):
    def setUp(self):
        super(Zm310LogicTests, self).setUp()
