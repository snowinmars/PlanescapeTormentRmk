...
class Zm310LogicTest(LogicTest):
    ...
    def test_set_know_oinosian_name(self):
        self._false_then_true_action(
            self.state_manager.get_know_oinosian_name,
    ...
    def test_get_know_oinosian_name(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.set_know_oinosian_name(x),
...
class Zm310LogicGeneratedTest(LogicTest):
    ...
    def test_r6502_action(self):
        self.state_manager.set_oinosian_value(2)
        self._integer_equals_action(
            self.state_manager.get_oinosian_value,
            1,
