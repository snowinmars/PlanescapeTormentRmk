...
from game.dlgs.mortuary_zombies.zm396.Zm396Logic import (Zm396LogicGenerated, Zm396Logic)


class Zm396LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zm396LogicGeneratedTests, self).setUp()
...
#     def test_r34932_condition(self): # wrong, overrided
...
#     def test_r34935_condition(self): # wrong, overrided
...
#     def test_r45112_condition(self): # wrong, overrided
#         self._boolean_invert_condition(
#             lambda x: self.state_manager.world_manager.set_zombie_chaotic(x),
...
#     def test_r45113_condition(self): # wrong, overrided
#         self._boolean_straight_condition(
#             lambda x: self.state_manager.world_manager.set_zombie_chaotic(x),
...
class Zm396LogicTests(LogicTests):
    def setUp(self):
        super(Zm396LogicTests, self).setUp()
    ...
    def test_r34934_action(self):
        self._false_then_true_action(
            lambda: self.state_manager.inventory_items_manager.is_own_item('has_bandages'),
