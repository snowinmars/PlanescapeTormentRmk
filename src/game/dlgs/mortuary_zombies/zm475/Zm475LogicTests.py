...
from game.dlgs.mortuary_zombies.zm475.Zm475Logic import (Zm475LogicGenerated, Zm475Logic)


class Zm475LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zm475LogicGeneratedTests, self).setUp()
...
class Zm475LogicTests(LogicTests):
    def setUp(self):
        super(Zm475LogicTests, self).setUp()
        self.logic = Zm475Logic(self.state_manager)


    def test_talk(self):
        self._integer_inc_action(
            self.state_manager.world_manager.get_talked_to_zm475_times,
            1,
            self.logic.talk
        )
