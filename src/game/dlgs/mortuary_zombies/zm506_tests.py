...
from game.dlgs.mortuary_zombies.zm506_logic import (Zm506LogicGenerated, Zm506Logic)
...
class Zm506LogicGeneratedTest(LogicTest):
    def setUp(self):
        super(Zm506LogicGeneratedTest, self).setUp()
        self.logic = Zm506LogicGenerated(self.state_manager)


    def test_r45480_action(self):
        self.state_manager.set_has_506_thread(False)
        self.state_manager.set_has_needle(False)
        who_experience = 'protagonist'
        prop_experience = 'experience'
        delta_experience = 100

        self.assertFalse(self.state_manager.get_has_506_thread())
        ...
        self.assertTrue(self.state_manager.get_has_506_thread())
    ...
    def test_r45420_condition(self):
        self._boolean_invert_condition(
            lambda x: self.state_manager.set_has_506_thread(x),
