...
from game.dlgs.mortuary_zombies.zm613.Zm613Logic import (Zm613LogicGenerated, Zm613Logic)


class Zm613LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zm613LogicGeneratedTests, self).setUp()
...
class Zm613LogicTests(LogicTests):
    def setUp(self):
        super(Zm613LogicTests, self).setUp()
        self.logic = Zm613Logic(self.state_manager)


    def test_talk(self):
        self._integer_inc_action(
            self.state_manager.world_manager.get_talked_to_zm613_times,
            1,
            self.logic.talk
        )
