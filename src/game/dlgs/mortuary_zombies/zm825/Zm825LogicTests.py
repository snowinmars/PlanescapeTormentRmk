...
from game.dlgs.mortuary_zombies.zm825.Zm825Logic import (Zm825LogicGenerated, Zm825Logic)


class Zm825LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zm825LogicGeneratedTests, self).setUp()
...
class Zm825LogicTests(LogicTests):
    def setUp(self):
        super(Zm825LogicTests, self).setUp()
