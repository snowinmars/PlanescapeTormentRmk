...
from game.dlgs.mortuary_zombies.zm965.Zm965Logic import (Zm965LogicGenerated, Zm965Logic)


class Zm965LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zm965LogicGeneratedTests, self).setUp()
...
class Zm965LogicTests(LogicTests):
    def setUp(self):
        super(Zm965LogicTests, self).setUp()
