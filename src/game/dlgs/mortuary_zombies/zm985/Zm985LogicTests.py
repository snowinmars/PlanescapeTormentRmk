...
from game.dlgs.mortuary_zombies.zm985.Zm985Logic import (Zm985LogicGenerated, Zm985Logic)


class Zm985LogicGeneratedTests(LogicTests):
    def setUp(self):
        super(Zm985LogicGeneratedTests, self).setUp()
...
class Zm985LogicTests(LogicTests):
    def setUp(self):
        super(Zm985LogicTests, self).setUp()
