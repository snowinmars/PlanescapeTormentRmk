...
class Zm985LogicGeneratedTest(LogicTest):
    ...
    def test_s3_action(self):
        self.state_manager.set_topple_985(False)
        self.state_manager.set_dead_zm985(False)

        self.assertFalse(self.state_manager.get_topple_985())
        self.assertFalse(self.state_manager.get_limb_985())
        self.assertFalse(self.state_manager.get_dead_zm985())

        self.logic.s3_action()

        self.assertTrue(self.state_manager.get_topple_985())
        self.assertTrue(self.state_manager.get_limb_985())
        self.assertTrue(self.state_manager.get_dead_zm985())
