...
label soego_s89: # from 83.1
    "soego_s89{#soego_s89}"
    # soego '«Акаста»{#soego_s89_1}'
    # nr 'Животное. Боюсь, что Безмолвный Король{#soego_s89_2}'
    # soego '«Единственный, кто держит ее под контролем. Если его устранят, упыри разорят катакомбы».{#soego_s89_3}'
