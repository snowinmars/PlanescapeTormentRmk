...
label soego_speak:
    ...
    if  gsm.location_manager.get_current_internal() == 'AR1500' and \
        gsm.get_soego_exposed():
        jump soego_s95_ctor
    ...
    if  gsm.location_manager.get_current_internal() == 'AR0201' and \
        gsm.get_gate_open() and \
        gsm.get_gate_cut_scene():
        jump soego_s12_ctor
    ...
    if  gsm.location_manager.get_current_internal() == 'AR0201' and \
        gsm.get_soego_value() == 1 and \
        not gsm.get_gate_open():
        jump soego_s59_ctor
    ...
    if  gsm.location_manager.get_current_internal() == 'AR0201' and \
        gsm.get_appearance() == 1 and \
        not gsm.get_gate_open() and \
        gsm.get_soego_value() == 0:
        jump soego_s0_ctor
