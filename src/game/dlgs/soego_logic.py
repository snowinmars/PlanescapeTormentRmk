class SoegoLogicGenerated:
    ...
    def r1478_action(self):
        ...
        self.state_manager.set_gate_cut_scene(1)
        #$% StartCutSceneMode() %$#
    ...
    def r1492_action(self):
        self.state_manager.set_gate_cut_scene(2)
    ...
    def r4810_action(self):
        self.state_manager.set_soego_exposed(True)
    ...
    def r21655_action(self):
        self.state_manager.set_met_soego2(True)
        self.state_manager.set_soego_value(3)
        self.state_manager.set_soego_talk(2)
        #$% EndCutSceneMode() %$#
    ...
    def r21916_action(self):
        self.state_manager.set_soego_fled(1)
        #$% Enemy() %$#
        self.state_manager.journal_manager.update_journal('21926')
        #$%.register('21926', 'Я рассказал Соэго про содержимое его дневника, а он превратился в крысооборотня и напал на меня. %$#')
    ...
    def r21917_action(self):
        self.state_manager.set_doubtful_skel(2)
    ...
    def r21979_action(self):
        self.state_manager.set_know_silent_king(True)


    def r21986_action(self):
        self.state_manager.set_know_hargrimm(True)
    ...
    def r22024_action(self):
        self.state_manager.set_soego_value(4)
        self.state_manager.set_soego_fled(2)
        #$% Enemy() %$#
        self.state_manager.journal_manager.update_journal('21856')
        #$%.register('21856', 'Я нашел Соэго. Он был заражен ликантропией, которая свела его в катакомбы. Его разум более не принадлежит ему, его вера в тленных утеряна. %$#')
    ...
    def r1478_condition(self):
        return not self.state_manager.get_has_keymo()


    def r1479_condition(self):
        return self.state_manager.get_has_keymo()
    ...
    def r1496_condition(self):
        return self.state_manager.get_appearance() == 2
    ...
    def r4805_condition(self):
        return self.state_manager.characters_manager.get_property('protagonist', 'charisma') > 10 and \
               not self.state_manager.get_gate_open()
    ...
    def r4810_condition(self):
        return self.state_manager.characters_manager.get_property('protagonist', 'wisdom') < 13 and \
               self.state_manager.get_vaxis_exposes_soego()
    ...
    def r4834_condition(self):
        return self.state_manager.get_gate_open()


    def r4835_condition(self):
        return not self.state_manager.get_gate_open()
    ...
    def r4931_condition(self):
        return self.state_manager.characters_manager.get_property('protagonist', 'intelligence') > 12 and \
               not self.state_manager.get_soego_adahn()


    def r4932_condition(self):
        return self.state_manager.characters_manager.get_property('protagonist', 'intelligence') > 12 and \
               self.state_manager.get_soego_adahn()
    ...
    def r4967_condition(self):
        return not self.state_manager.get_soego_adahn()


    def r4968_condition(self):
        return self.state_manager.get_soego_adahn()
    ...
    def r21663_condition(self):
        return self.state_manager.get_dustman_initiation() != 5


    def r21800_condition(self):
        return self.state_manager.count_in_party() == 0 and \
               not self.state_manager.get_visit_doubtful()
    ...
    def r64547_condition(self):
        return self.state_manager.get_soego_strangle() and \
               not self.state_manager.get_mortuary_soego_killed()


    def r21808_condition(self):
        return self.state_manager.get_mortuary_soego_killed()
    ...
    def r21815_condition(self):
        return self.state_manager.get_soego_strangle()
    ...
    def r66181_condition(self):
        return self.state_manager.get_dustman_initiation() == 5 and \
               self.state_manager.get_soego_value() > 0 and \
               self.state_manager.get_soego_value() < 3


    def r21852_condition(self):
        return self.state_manager.get_dustman_initiation() == 5 and \
               self.state_manager.get_soego_value() == 0


    def r64623_condition(self):
        return self.state_manager.get_dustman_initiation() != 5 and \
               self.state_manager.get_soego_strangle() and \
               not self.state_manager.get_mortuary_soego_killed()


    def r64624_condition(self):
        return self.state_manager.get_dustman_initiation() != 5 and \
               self.state_manager.get_mortuary_soego_killed()


    def r21853_condition(self):
        return not self.state_manager.get_soego_strangle() and \
               not self.state_manager.get_mortuary_soego_killed() and \
               self.state_manager.get_dustman_initiation() != 5
    ...
    def r24206_condition(self):
        return self.state_manager.get_silent_king() and \
               not self.state_manager.get_soego_told() and \
               self.state_manager.get_lawful_hargrimm_1()


    def r21915_condition(self):
        return self.state_manager.get_silent_king() and \
               not self.state_manager.get_soego_told() and \
               not self.state_manager.get_lawful_hargrimm_1()
    ...
    def r21916_condition(self):
        return self.state_manager.get_soego_journal()


    def r21917_condition(self):
        return self.state_manager.get_doubtful_skel() == 1
    ...
    def r21944_condition(self):
        return self.state_manager.get_know_hargrimm()


    def r21945_condition(self):
        return self.state_manager.get_know_acaste()


    def r21946_condition(self):
        return self.state_manager.get_know_stale_mary()


    def r21947_condition(self):
        return self.state_manager.get_know_silent_king()
    ...
    def r25248_condition(self):
        return self.state_manager.get_cr_vic() != 1 and \
               not self.state_manager.get_know_many()


    def r25252_condition(self):
        return self.state_manager.get_cr_vic() != 1 and \
               self.state_manager.get_know_many()
    ...
    def r21994_condition(self):
        return self.state_manager.get_cr_vic() == 1
    ...
    def r22015_condition(self):
        return not self.state_manager.get_lawful_soego_1()


    def r22016_condition(self):
        return self.state_manager.get_lawful_soego_1()
