...
from game.dlgs.world.morte.MorteLogic import (MorteLogicGenerated, MorteLogic)


class MorteLogicGeneratedTests(LogicTests):
    def setUp(self):
        super(MorteLogicGeneratedTests, self).setUp()
...
class MorteLogicTests(LogicTests):
    def setUp(self):
        super(MorteLogicTests, self).setUp()
