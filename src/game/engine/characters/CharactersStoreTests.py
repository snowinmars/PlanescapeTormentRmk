...
class CharactersStoreTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_reserialize_empty_pickle(self):
        ...
        expected = b'\x80\x05\x95c\x00\x00\x00\x00\x00\x00\x00\x8c&game.engine.characters.CharactersStore\x94\x8c\x0fCharactersStore\x94\x93\x94)\x81\x94}\x94(\x8c\ncharacters\x94}\x94\x8c\tonce_keys\x94}\x94ub.'
