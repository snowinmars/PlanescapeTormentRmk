...
class CharacterStoreTest(unittest.TestCase):
    ...
    def test_reserialize_empty_pickle(self):
        ...
        expected = b'\x80\x04\x95W\x00\x00\x00\x00\x00\x00\x00\x8c%game.engine.inventory.inventory_store\x94\x8c\x0eInventoryStore\x94\x93\x94)\x81\x94}\x94\x8c\x0finventory_items\x94}\x94sb.'
