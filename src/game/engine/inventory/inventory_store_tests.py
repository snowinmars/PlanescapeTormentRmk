...
class CharacterStoreTest(unittest.TestCase):
    ...
    def test_serialize_filled_json(self):
        ...
        dump = self.store.toJson()
        expected = '{"inventory_items": {"Ключ": {"settings_id": "intro_key", "orig_id": "keypr", "name": "Ключ", "description": "Ручка", "grid_image": "grid_key.png", "detail_image": "detail_key.png", "jump_on_use_to": null}, "Иголка и нитка": {"settings_id": "needle", "orig_id": "needle.itm", "name": "Иголка и нитка", "description": "катушка", "grid_image": "grid_needle.png", "detail_image": "detail_needle.png", "jump_on_use_to": null}}}'
        self.assertEqual(dump, expected)


    def test_deserialize_filled_json(self):
        dump = '{"inventory_items": {"Ключ": {"settings_id": "intro_key", "orig_id": "keypr", "name": "Ключ", "description": "Ручка", "grid_image": "grid_key.png", "detail_image": "detail_key.png", "jump_on_use_to": null}, "Иголка и нитка": {"settings_id": "needle", "orig_id": "needle.itm", "name": "Иголка и нитка", "description": "катушка", "grid_image": "grid_needle.png", "detail_image": "detail_needle.png", "jump_on_use_to": null}}}'
        store = InventoryStore.fromJson(dump)
