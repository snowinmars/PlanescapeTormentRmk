...
class LocationsStoreTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_reserialize_empty_pickle(self):
        ...
        expected = b'\x80\x05\x95\xe1\x00\x00\x00\x00\x00\x00\x00\x8c$game.engine.locations.LocationsStore\x94\x8c\x0eLocationsStore\x94\x93\x94)\x81\x94}\x94(\x8c\x0bi2e_mapping\x94}\x94\x8c\x0be2i_mapping\x94}\x94\x8c\x10current_external\x94N\x8c\x10current_internal\x94N\x8c\x11previous_external\x94N\x8c\x11previous_internal\x94N\x8c\x11visited_externals\x94]\x94\x8c\x11visited_internals\x94]\x94ub.'
    ...
    def test_reserialize_filled_pickle(self):
        ...
        dump = pickle.dumps(self.store)
        expected = b'\x80\x05\x95U\x01\x00\x00\x00\x00\x00\x00\x8c$game.engine.locations.LocationsStore\x94\x8c\x0eLocationsStore\x94\x93\x94)\x81\x94}\x94(\x8c\x0bi2e_mapping\x94}\x94(\x8c\x13internal_location_a\x94]\x94\x8c\x13external_location_a\x94a\x8c\x13internal_location_b\x94]\x94\x8c\x13external_location_b\x94au\x8c\x0be2i_mapping\x94}\x94(h\th\x07h\x0ch\nu\x8c\x10current_external\x94h\x0c\x8c\x10current_internal\x94h\n\x8c\x11previous_external\x94h\t\x8c\x11previous_internal\x94h\x07\x8c\x11visited_externals\x94]\x94h\x0ca\x8c\x11visited_internals\x94]\x94h\naub.'
        self.assertEqual(dump, expected)
