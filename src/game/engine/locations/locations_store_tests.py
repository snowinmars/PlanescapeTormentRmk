...
class LocationsStoreTest(unittest.TestCase):
    ...
    def test_deserialize_empty_json(self):
        dump = '{"i2e_mapping": {}, "e2i_mapping": {}, "current_external": null, "current_internal": null, "visited_externals": [], "visited_internals": []}'
    ...
    def test_serialize_filled_pickle(self):
        ...
        self.store.visited_internals = [self.internal_location_b]
        self.store.visited_externals = [self.external_location_b]
    ...
    def test_deserialize_filled_json(self):
        dump = '{"i2e_mapping": {"internal_location_a": ["external_location_a"], "internal_location_b": ["external_location_b"]}, "e2i_mapping": {"external_location_a": "internal_location_a", "external_location_b": "internal_location_b"}, "current_external": "external_location_b", "current_internal": "internal_location_b", "visited_externals": ["external_location_b"], "visited_internals": ["internal_location_b"]}'
        store = LocationsStore.fromJson(dump)
