...
class CharacterStoreTest(unittest.TestCase):
    ...
    def test_reserialize_empty_pickle(self):
        ...
        expected = b"\x80\x05\x95s\x00\x00\x00\x00\x00\x00\x00\x8c\x1fgame.engine.log_events.log_events_store\x94\x8c\x0bLogEventsStore\x94\x93\x94)\x81\x94}\x94(\x8c\x06log_events\x94\x8c\x0bcollections\x94\x8c\x05deque\x94\x93\x94)Kd\x86\x94R\x94\x8c\x0bmax_entries\x94Kdub."
    ...
    def test_reserialize_filled_pickle(self):
        ...
        dump = pickle.dumps(self.store)
        expected = b"\x80\x05\x95(\x01\x00\x00\x00\x00\x00\x00\x8c\x1fgame.engine.log_events.log_events_store\x94\x8c\x0bLogEventsStore\x94\x93\x94)\x81\x94}\x94(\x8c\x06log_events\x94\x8c\x0bcollections\x94\x8c\x05deque\x94\x93\x94)Kd\x86\x94R\x94(\x8c\x18game.engine.log_events.log_event\x94\x8c\x05LogEvent\x94\x93\x94)\x81\x94}\x94(\x8c\ttimestamp\x94\x8c\x07[15:50]\x94\x8c\x08category\x94\x8c\x10log_event_category_a\x94\x8c\x04text\x94\x8c\x0clog_event_text_a\x94ubh\r)\x81\x94}\x94(h\x10\x8c\x07[05:51]\x94h\x12\x8c\x10log_event_category_b\x94h\x14\x8c\x0clog_event_text_b\x94ube\x8c\x0bmax_entries\x94Kdub."
        self.assertEqual(dump, expected)
