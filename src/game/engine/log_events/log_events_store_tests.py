...
class CharacterStoreTest(unittest.TestCase):
    ...
    def test_reserialize_empty_pickle(self):
        ...
        expected = b"\x80\x04\x95\x82\x00\x00\x00\x00\x00\x00\x00\x8c'game.engine.log_events.log_events_store\x94\x8c\x0eLogEventsStore\x94\x93\x94)\x81\x94}\x94(\x8c\nlog_events\x94\x8c\x0bcollections\x94\x8c\x05deque\x94\x93\x94)Kd\x86\x94R\x94\x8c\x0bmax_entries\x94Kdub."
