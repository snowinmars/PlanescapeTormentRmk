...
class SettingsManagerTest(LogicTest):
    def test_ctor(self):
        ...
        self.assertIsNotNone(self.settings_manager._open_journal_note_ids)
    ...
    def test_update_journal_when_all_ok(self):
        ...
        self.settings_manager.update_journal(note_id)
    ...
    def test_has_journal_note_when_all_ok(self):
        ...
        self.assertEqual(len(self.settings_manager._open_journal_note_ids), 0)
        self.assertFalse(self.settings_manager.has_journal_note(note_id_1))
        self.assertFalse(self.settings_manager.has_journal_note(note_id_2))

        self.settings_manager.update_journal(note_id_1)
        self.assertEqual(len(self.settings_manager._open_journal_note_ids), 1)
        self.assertTrue(self.settings_manager.has_journal_note(note_id_1))
        self.assertFalse(self.settings_manager.has_journal_note(note_id_2))

        self.settings_manager.update_journal(note_id_2)
        self.assertEqual(len(self.settings_manager._open_journal_note_ids), 2)
        self.assertTrue(self.settings_manager.has_journal_note(note_id_1))
        self.assertTrue(self.settings_manager.has_journal_note(note_id_2))
