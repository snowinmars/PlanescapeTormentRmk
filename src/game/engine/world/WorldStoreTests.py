...
class WorldStoreTests(unittest.TestCase):
    ...
    def test_reserialize_empty_pickle(self):
        ...
        expected = b'\x80\x05\x95R\x00\x00\x00\x00\x00\x00\x00\x8c\x1cgame.engine.world.WorldStore\x94\x8c\nWorldStore\x94\x93\x94)\x81\x94}\x94(\x8c\tonce_keys\x94]\x94\x8c\x08registry\x94}\x94ub.'
