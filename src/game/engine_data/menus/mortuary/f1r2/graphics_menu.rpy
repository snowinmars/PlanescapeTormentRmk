...
screen mortuary_f1r2_graphics_menu_screen():
    ...
    use abstract_location_menu_screen(
        'bg mortuary_f1r2',
        [
            FromMortuaryF1R2ToMortuaryF1Rc(state_manager, 1200, 900),
            FromMortuaryF1R2ToMortuaryF1R3(state_manager, 1500, 150),
            FromMortuaryF1R2ToMortuaryF1R1(state_manager, 400, 1000),
        ],
        [
            *get_party(state_manager, 1360, 400),
            InMortuaryF1R2Deionarra(state_manager, 670, 670),
        ],
        audio.deionarra,
    )
