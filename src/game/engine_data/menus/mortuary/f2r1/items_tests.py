...
class F1R1ItemsTest(GraphicsMenuItemTest):
    def test_InMortuaryF2R1PickScalpel(self):
        self._test_graphics_menu_item(InMortuaryF2R1PickScalpel(self.gsm, self.x, self.y))
    def test_FromMortuaryF2R1ToMortuaryF2R2(self):
        self.gsm.set_has_intro_key(True)
        self._test_graphics_menu_item(FromMortuaryF2R1ToMortuaryF2R2(self.gsm, self.x, self.y))
    def test_FromMortuaryF2R1ToMortuaryF2R8(self):
        self.gsm.set_has_intro_key(True)
        self._test_graphics_menu_item(FromMortuaryF2R1ToMortuaryF2R8(self.gsm, self.x, self.y))
    def test_FromMortuaryF2R1ToMortuaryF3R1(self):
        self.gsm.set_has_intro_key(True)
        self._test_graphics_menu_item(FromMortuaryF2R1ToMortuaryF3R1(self.gsm, self.x, self.y))
    def test_FromMortuaryF2R1ToMortuaryF1R1(self):
        self.gsm.set_has_intro_key(True)
        self._test_graphics_menu_item(FromMortuaryF2R1ToMortuaryF1R1(self.gsm, self.x, self.y))
    def test_InMortuaryF2R1Zm569(self):
        self._test_graphics_menu_item(InMortuaryF2R1Zm569(self.gsm, self.x, self.y))
    def test_InMortuaryF2R1Zm825(self):
        self._test_graphics_menu_item(InMortuaryF2R1Zm825(self.gsm, self.x, self.y))
    def test_InMortuaryF2R1Zm782(self):
        self._test_graphics_menu_item(InMortuaryF2R1Zm782(self.gsm, self.x, self.y))
