...
class F1R1ItemsTest(GraphicsMenuItemTest):
    def test_FromMortuaryF2R2ToMortuaryF2R1(self):
        self._test_graphics_menu_item(FromMortuaryF2R2ToMortuaryF2R1(self.gsm, self.x, self.y))
    def test_FromMortuaryF2R2ToMortuaryF2R3(self):
        self._test_graphics_menu_item(FromMortuaryF2R2ToMortuaryF2R3(self.gsm, self.x, self.y))
    def test_InMortuaryF2R2Zm965(self):
        self._test_graphics_menu_item(InMortuaryF2R2Zm965(self.gsm, self.x, self.y))
    def test_InMortuaryF2R2Zf594(self):
        self._test_graphics_menu_item(InMortuaryF2R2Zf594(self.gsm, self.x, self.y))
    def test_InMortuaryF2R2Zf626(self):
        self._test_graphics_menu_item(InMortuaryF2R2Zf626(self.gsm, self.x, self.y))
