...
screen mortuary_f2r4_graphics_menu_screen():
    ...
    use abstract_location_menu_screen(
        'bg mortuary_f2r4',
        [
            FromMortuaryF2R4ToMortuaryF2R3(state_manager, 1980, 900),
            FromMortuaryF2R4ToMortuaryF2R5(state_manager, 3450, 777),
        ],
        [
            *get_party(state_manager, 2200, 850),
            InMortuaryF2R4Zm1664(state_manager, 2700, 1100),
        ],
        audio.mortuary
    )
