...
class F1R1ItemsTest(GraphicsMenuItemTest):
    def test_FromMortuaryF2R4ToMortuaryF2R5(self):
        self._test_graphics_menu_item(FromMortuaryF2R4ToMortuaryF2R5(self.gsm, self.x, self.y))
    def test_FromMortuaryF2R4ToMortuaryF2R3(self):
        self._test_graphics_menu_item(FromMortuaryF2R4ToMortuaryF2R3(self.gsm, self.x, self.y))
    def test_InMortuaryF2R4Zm1664(self):
        self._test_graphics_menu_item(InMortuaryF2R4Zm1664(self.gsm, self.x, self.y))
