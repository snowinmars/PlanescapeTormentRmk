...
class InMortuaryF3R4PickPrybar(ContainerMenuItem):
    def __init__(self, state_manager, x, y):
        super().__init__(state_manager, x, y)
    def when(self):
        return not self.state_manager.world_manager.get_has_prybar()
    def tooltip(self):
        return 'Взять ломик'
    def jump(self):
        return NavigationDirective(
...
class InMortuaryF3R4PickDustmanRequest(ContainerMenuItem):
    def __init__(self, state_manager, x, y):
        super().__init__(state_manager, x, y)
    def when(self):
        return not self.state_manager.world_manager.get_has_dustman_request()
    def tooltip(self):
        return 'Взять бумагу'
    def jump(self):
        return NavigationDirective(
...
class InMortuaryF3R4Dustfem(MenuItem):
    def __init__(self, state_manager, x, y):
        super().__init__(state_manager, x, y)
    def when(self):
        return not self.state_manager.world_manager.get_dead_dustfem()
    def texture(self):
...
class InMortuaryF3R4S42(SkeletMenuItem):
    def __init__(self, state_manager, x, y):
        super().__init__(state_manager, x, y)
    def when(self):
        return not self.state_manager.world_manager.get_dead_s42()
    def tooltip(self):
...
class InMortuaryF3R4Zf832(ZombieMenuItem):
    def __init__(self, state_manager, x, y):
        super().__init__(state_manager, x, y)
    def when(self):
        return not self.state_manager.world_manager.get_dead_zf832()
    def tooltip(self):
...
class InMortuaryF3R4Zm613(ZombieMenuItem):
    def __init__(self, state_manager, x, y):
        super().__init__(state_manager, x, y)
    def when(self):
        return not self.state_manager.world_manager.get_dead_zm613()
    def tooltip(self):
...
class InMortuaryF3R4Zm79(ZombieMenuItem):
    def __init__(self, state_manager, x, y):
        super().__init__(state_manager, x, y)
    def when(self):
        return not self.state_manager.world_manager.get_dead_zm79()
    def tooltip(self):
...
class InMortuaryF3R4Zf679(ZombieMenuItem):
    def __init__(self, state_manager, x, y):
        super().__init__(state_manager, x, y)
    def when(self):
        return not self.state_manager.world_manager.get_dead_zf679()
    def tooltip(self):
...
class InMortuaryF3R4S1221(SkeletMenuItem):
    def __init__(self, state_manager, x, y):
        super().__init__(state_manager, x, y)
    def when(self):
        return not self.state_manager.world_manager.get_dead_s1221()
    def tooltip(self):
