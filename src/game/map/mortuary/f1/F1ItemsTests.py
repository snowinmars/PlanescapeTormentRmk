...
class F1ItemsTests(GraphicsMenuItemTests):
    def test_FromMortuaryF1R1ToMortuaryF2R1(self):
        self._test_location_map_door(FromMortuaryF1R1ToMortuaryF2R1(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f2r1')
        self._test_location_map_door(FromMortuaryF1R1ToMortuaryF2R1(self.state_manager, self.x, self.y))
    def test_FromMortuaryF1R1ToMortuaryF1R2(self):
        self._test_location_map_door(FromMortuaryF1R1ToMortuaryF1R2(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1r2')
        self._test_location_map_door(FromMortuaryF1R1ToMortuaryF1R2(self.state_manager, self.x, self.y))
    def test_FromMortuaryF1R1ToMortuaryF1R4(self):
        self._test_location_map_door(FromMortuaryF1R1ToMortuaryF1R4(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1r4')
        self._test_location_map_door(FromMortuaryF1R1ToMortuaryF1R4(self.state_manager, self.x, self.y))
    def test_FromMortuaryF1R1ToMortuaryF1Rc(self):
        self._test_location_map_door(FromMortuaryF1R1ToMortuaryF1Rc(self.state_manager, self.x, self.y))
    ...
    def test_FromMortuaryF1R1ToGameEnd(self):
        ...
        self._test_location_map_door(FromMortuaryF1R1ToGameEnd(self.state_manager, self.x, self.y))
    def test_InMortuaryF1R1Soego(self):
        self._test_location_map_npc(InMortuaryF1R1Soego(self.state_manager, self.x, self.y))
        self.state_manager.world_manager.set_talked_to_soego_times(1)
        self._test_location_map_npc(InMortuaryF1R1Soego(self.state_manager, self.x, self.y))
    def test_MortuaryF1R1Shadow(self):
        self.state_manager.locations_manager.set_location('mortuary_f1r2')
        self._test_location_map_shadow(MortuaryF1R1Shadow(self.state_manager, self.x, self.y))
    ...
    def test_FromMortuaryF1R2ToMortuaryF1Rc(self):
        self._test_location_map_door(FromMortuaryF1R2ToMortuaryF1Rc(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1rc')
        self._test_location_map_door(FromMortuaryF1R2ToMortuaryF1Rc(self.state_manager, self.x, self.y))
    def test_FromMortuaryF1R2ToMortuaryF1R3(self):
        self._test_location_map_door(FromMortuaryF1R2ToMortuaryF1R3(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1r3')
        self._test_location_map_door(FromMortuaryF1R2ToMortuaryF1R3(self.state_manager, self.x, self.y))
    def test_FromMortuaryF1R2ToMortuaryF1R1(self):
        self._test_location_map_door(FromMortuaryF1R2ToMortuaryF1R1(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1r1')
        self._test_location_map_door(FromMortuaryF1R2ToMortuaryF1R1(self.state_manager, self.x, self.y))
    def test_InMortuaryF1R2Deionarra(self):
        self._test_location_map_npc(InMortuaryF1R2Deionarra(self.state_manager, self.x, self.y))
        self.state_manager.world_manager.set_talked_to_deionarra_times(1)
        self._test_location_map_npc(InMortuaryF1R2Deionarra(self.state_manager, self.x, self.y))
    def test_MortuaryF1R2Shadow(self):
        self.state_manager.locations_manager.set_location('mortuary_f1r3')
        self._test_location_map_shadow(MortuaryF1R2Shadow(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1r2')
        self.state_manager.locations_manager.set_location('mortuary_f1r3')
        self._test_location_map_shadow(MortuaryF1R2Shadow(self.state_manager, self.x, self.y))
    ...
    def test_FromMortuaryF1R3ToMortuaryF1R2(self):
        self._test_location_map_door(FromMortuaryF1R3ToMortuaryF1R2(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1r2')
        self._test_location_map_door(FromMortuaryF1R3ToMortuaryF1R2(self.state_manager, self.x, self.y))
    def test_FromMortuaryF1R3ToMortuaryF1R4(self):
        self._test_location_map_door(FromMortuaryF1R3ToMortuaryF1R4(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1r4')
        self._test_location_map_door(FromMortuaryF1R3ToMortuaryF1R4(self.state_manager, self.x, self.y))
    def test_FromMortuaryF1R3ToMortuaryF1Rc(self):
        self._test_location_map_door(FromMortuaryF1R3ToMortuaryF1Rc(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1rc')
        self._test_location_map_door(FromMortuaryF1R3ToMortuaryF1Rc(self.state_manager, self.x, self.y))
    def test_InMortuaryF1R3Zf114(self):
        self._test_location_map_npc(InMortuaryF1R3Zf114(self.state_manager, self.x, self.y))
        self.state_manager.world_manager.set_talked_to_zf114_times(1)
        self._test_location_map_npc(InMortuaryF1R3Zf114(self.state_manager, self.x, self.y))
    def test_InMortuaryF1R3Zm1041(self):
        self._test_location_map_npc(InMortuaryF1R3Zm1041(self.state_manager, self.x, self.y))
        self.state_manager.world_manager.set_talked_to_zm1041_times(1)
        self._test_location_map_npc(InMortuaryF1R3Zm1041(self.state_manager, self.x, self.y))
    def test_InMortuaryF1R3Xach(self):
        self._test_location_map_npc(InMortuaryF1R3Xach(self.state_manager, self.x, self.y))
    ...
    def test_MortuaryF1R3Shadow(self):
        self.state_manager.locations_manager.set_location('mortuary_f1r4')
        self._test_location_map_shadow(MortuaryF1R3Shadow(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1r3')
        self.state_manager.locations_manager.set_location('mortuary_f1r4')
        self._test_location_map_shadow(MortuaryF1R3Shadow(self.state_manager, self.x, self.y))
    ...
    def test_FromMortuaryF1R4ToMortuaryF1R3(self):
        self._test_location_map_door(FromMortuaryF1R4ToMortuaryF1R3(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1r3')
        self._test_location_map_door(FromMortuaryF1R4ToMortuaryF1R3(self.state_manager, self.x, self.y))
    def test_FromMortuaryF1R4ToMortuaryF1R1(self):
        self._test_location_map_door(FromMortuaryF1R4ToMortuaryF1R1(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1r1')
        self._test_location_map_door(FromMortuaryF1R4ToMortuaryF1R1(self.state_manager, self.x, self.y))
    def test_FromMortuaryF1R4ToMortuaryF1Rc(self):
        self._test_location_map_door(FromMortuaryF1R4ToMortuaryF1Rc(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1rc')
        self._test_location_map_door(FromMortuaryF1R4ToMortuaryF1Rc(self.state_manager, self.x, self.y))
    def test_FromMortuaryF1R4ToMortuaryF2R7(self):
        self._test_location_map_door(FromMortuaryF1R4ToMortuaryF2R7(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f2r7')
        self._test_location_map_door(FromMortuaryF1R4ToMortuaryF2R7(self.state_manager, self.x, self.y))
    def test_InMortuaryF1R4Zm732(self):
        self._test_location_map_npc(InMortuaryF1R4Zm732(self.state_manager, self.x, self.y))
        self.state_manager.world_manager.set_talked_to_zm732_times(1)
        self._test_location_map_npc(InMortuaryF1R4Zm732(self.state_manager, self.x, self.y))
    def test_MortuaryF1R4Shadow(self):
        self.state_manager.locations_manager.set_location('mortuary_f1rc')
        self._test_location_map_shadow(MortuaryF1R4Shadow(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1r4')
        self.state_manager.locations_manager.set_location('mortuary_f1rc')
        self._test_location_map_shadow(MortuaryF1R4Shadow(self.state_manager, self.x, self.y))
    ...
    def test_FromMortuaryF1RcToMortuaryF1R1(self):
        self._test_location_map_door(FromMortuaryF1RcToMortuaryF1R1(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1r1')
        self._test_location_map_door(FromMortuaryF1RcToMortuaryF1R1(self.state_manager, self.x, self.y))
    def test_FromMortuaryF1RcToMortuaryF1R2(self):
        self._test_location_map_door(FromMortuaryF1RcToMortuaryF1R2(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1r2')
        self._test_location_map_door(FromMortuaryF1RcToMortuaryF1R2(self.state_manager, self.x, self.y))
    def test_FromMortuaryF1RcToMortuaryF1R3(self):
        self._test_location_map_door(FromMortuaryF1RcToMortuaryF1R3(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1r3')
        self._test_location_map_door(FromMortuaryF1RcToMortuaryF1R3(self.state_manager, self.x, self.y))
    def test_FromMortuaryF1RcToMortuaryF1R4(self):
        self._test_location_map_door(FromMortuaryF1RcToMortuaryF1R4(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1r4')
        self._test_location_map_door(FromMortuaryF1RcToMortuaryF1R4(self.state_manager, self.x, self.y))
    def test_InMortuaryF1RcGiantsk(self):
        self._test_location_map_npc(InMortuaryF1RcGiantsk(self.state_manager, self.x, self.y))
    def test_MortuaryF1RcShadow(self):
        self.state_manager.locations_manager.set_location('mortuary_f1r1')
        self._test_location_map_shadow(MortuaryF1RcShadow(self.state_manager, self.x, self.y))
        self.state_manager.locations_manager.set_location('mortuary_f1rc')
        self.state_manager.locations_manager.set_location('mortuary_f1r1')
        self._test_location_map_shadow(MortuaryF1RcShadow(self.state_manager, self.x, self.y))
