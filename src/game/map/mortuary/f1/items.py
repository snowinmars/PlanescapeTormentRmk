...
class FromMortuaryF1R1ToMortuaryF2R1(MenuItem):
    ...
    def texture(self):
        return 'bg/mortuary/f1/door_f1r1_f2r1_opened.png'
    def jump(self):
...
class FromMortuaryF1R1ToMortuaryF1R2(MenuItem):
    ...
    def texture(self):
        return 'bg/mortuary/f1/door_f1r1_f1r2_opened.png'
    def jump(self):
        return NavigationDirective(
            'map_dispatcher',
...
class FromMortuaryF1R1ToMortuaryF1R4(MenuItem):
    ...
    def texture(self):
        return 'bg/mortuary/f1/door_f1r4_f1r1_opened.png'
    def jump(self):
        return NavigationDirective(
            'map_dispatcher',
...
class FromMortuaryF1R1ToMortuaryF1Rc(MenuItem):
    ...
    def texture(self):
        return 'bg/mortuary/f1/door_f1r1_f1rc_opened.png'
    def jump(self):
        return NavigationDirective(
            'map_dispatcher',
...
class FromMortuaryF1R1ToGameEnd(MenuItem):
    ...
    def texture(self):
        return 'bg/mortuary/f1/door_f1r1_sigil_opened.png'
    def jump(self):
        return NavigationDirective(
            'end'
        )
...
class MortuaryF1R1Shadow(ShadowItem):
    ...
    def texture(self):
        return 'bg/mortuary/f1/shadow_f1r1.png'
...
class FromMortuaryF1R2ToMortuaryF1Rc(MenuItem):
    ...
    def texture(self):
        return 'bg/mortuary/f1/door_f1r2_f1rc_opened.png'
    def jump(self):
        return NavigationDirective(
            'map_dispatcher',
            lambda: self.state_manager.locations_manager.set_location('mortuary_f1rc')
...
class FromMortuaryF1R2ToMortuaryF1R3(MenuItem):
    ...
    def texture(self):
        return 'bg/mortuary/f1/door_f1r2_f1r3_opened.png'
    def jump(self):
        return NavigationDirective(
            'map_dispatcher',
...
class MortuaryF1R2Shadow(ShadowItem):
    ...
    def texture(self):
        return 'bg/mortuary/f1/shadow_f1r2.png'
...
class FromMortuaryF1R3ToMortuaryF1R4(MenuItem):
    ...
    def texture(self):
        return 'bg/mortuary/f1/door_f1r3_f1r4_opened.png'
    def jump(self):
        return NavigationDirective(
            'map_dispatcher',
            lambda: self.state_manager.locations_manager.set_location('mortuary_f1r4')
...
class FromMortuaryF1R3ToMortuaryF1Rc(MenuItem):
    ...
    def texture(self):
        return 'bg/mortuary/f1/door_f1r3_f1rc_opened.png'
    def jump(self):
        return NavigationDirective(
            'map_dispatcher',
            lambda: self.state_manager.locations_manager.set_location('mortuary_f1rc')
...
class MortuaryF1R3Shadow(ShadowItem):
    ...
    def texture(self):
        return 'bg/mortuary/f1/shadow_f1r3.png'
...
class FromMortuaryF1R4ToMortuaryF1Rc(MenuItem):
    ...
    def texture(self):
        return 'bg/mortuary/f1/door_f1r4_f1rc_opened.png'
    def jump(self):
        return NavigationDirective(
            'map_dispatcher',
            lambda: self.state_manager.locations_manager.set_location('mortuary_f1rc')
...
class MortuaryF1R4Shadow(ShadowItem):
    ...
    def texture(self):
        return 'bg/mortuary/f1/shadow_f1r4.png'
...
class FromMortuaryF1R4ToMortuaryF2R7(MenuItem):
    ...
    def texture(self):
        return 'bg/mortuary/f1/door_f1r4_f2r7_opened.png'
    def jump(self):
        return NavigationDirective(
            'map_dispatcher',
...
class MortuaryF1RcShadow(ShadowItem):
    ...
    def texture(self):
        return 'bg/mortuary/f1/shadow_f1rc.png'
