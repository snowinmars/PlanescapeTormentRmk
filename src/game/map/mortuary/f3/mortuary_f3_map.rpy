...
label mortuary_f3_map:
    ...
    default screen_location_map_mortuary_f3_party = [] # get_party(runtime.global_state_manager, mortuaryF3LootLogic.get_where_party_stands())
    ...
    call screen screen_location_map(
        ...
        party=screen_location_map_mortuary_f3_party,
