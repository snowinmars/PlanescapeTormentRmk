def build_settings(manager):
    manager \
        ...
        .register('evil_dhall_1', False) \
        .register('evil_dhall_2', False) \
        .register('evil_dhall_3', False) \
        .register('good_dhall_1', False) \
        .register('good_dhall_2', False) \
