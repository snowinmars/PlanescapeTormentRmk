translate english strings:
    ...
    # game/engine_data/inventory/all_inventory.rpy:2
    old 'inventoryitem_has_intro_key_name'
    new 'Preparation room key'

    # game/engine_data/inventory/all_inventory.rpy:3
    ...
    # game/engine_data/inventory/all_inventory.rpy:5
    old 'inventoryitem_has_prybar_name'
    new 'Iron prybar'

    # game/engine_data/inventory/all_inventory.rpy:6
    ...
    # game/engine_data/inventory/all_inventory.rpy:8
    old 'inventoryitem_has_tome_ba_name'
    new 'Tome of bone and ash'

    # game/engine_data/inventory/all_inventory.rpy:9
    ...
    # game/engine_data/inventory/all_inventory.rpy:11
    old 'inventoryitem_has_copper_earring_closed_name'
    new 'Ancient copper earring'

    # game/engine_data/inventory/all_inventory.rpy:12
    ...
    # game/engine_data/inventory/all_inventory.rpy:14
    old 'inventoryitem_has_copper_earring_opened_name'
    new 'Ancient copper earring'

    # game/engine_data/inventory/all_inventory.rpy:15
    ...
    # game/engine_data/inventory/all_inventory.rpy:17
    old 'inventoryitem_has_scalpel_name'
    new 'Scalpel'

    # game/engine_data/inventory/all_inventory.rpy:18
    ...
    # game/engine_data/inventory/all_inventory.rpy:20
    old 'inventoryitem_has_needle_name'
    new 'Needle and thread'

    # game/engine_data/inventory/all_inventory.rpy:21
    ...
    # game/engine_data/inventory/all_inventory.rpy:23
    old 'inventoryitem_has_1201_note_name'
    new 'Note from corpse #1201'

    # game/engine_data/inventory/all_inventory.rpy:24
    ...
    # game/engine_data/inventory/all_inventory.rpy:26
    old 'inventoryitem_has_logpage_name'
    new 'Receiving log page'

    # game/engine_data/inventory/all_inventory.rpy:27
    ...
    # game/engine_data/inventory/all_inventory.rpy:29
    old 'inventoryitem_has_bandages_name'
    new 'Bandages'

    # game/engine_data/inventory/all_inventory.rpy:30
    ...
    # game/engine_data/inventory/all_inventory.rpy:32
    old 'inventoryitem_has_embalm_name'
    new 'Embalming fluid'

    # game/engine_data/inventory/all_inventory.rpy:33
    ...
    # game/engine_data/inventory/all_inventory.rpy:35
    old 'inventoryitem_has_keyem_name'
    new 'Embalming room key'

    # game/engine_data/inventory/all_inventory.rpy:36
    ...
    # game/engine_data/inventory/all_inventory.rpy:38
    old 'inventoryitem_has_tearring_name'
    new 'Rule-of-three earring'

    # game/engine_data/inventory/all_inventory.rpy:39
    ...
    # game/engine_data/inventory/all_inventory.rpy:41
    old 'inventoryitem_has_mortuary_key_name'
    new 'Mortuary sanctum key'

    # game/engine_data/inventory/all_inventory.rpy:42
    ...
    # game/engine_data/inventory/all_inventory.rpy:44
    old 'inventoryitem_has_dhall_feather_name'
    new 'Dhall\'s quill pen'

    # game/engine_data/inventory/all_inventory.rpy:45
    ...
    # game/engine_data/inventory/all_inventory.rpy:47
    old 'inventoryitem_has_finger_bone_name'
    new 'Crooked finger bone'

    # game/engine_data/inventory/all_inventory.rpy:48
    ...
    # game/engine_data/inventory/all_inventory.rpy:50
    old 'inventoryitem_has_dustrobe_name'
    new 'Dustman robes'

    # game/engine_data/inventory/all_inventory.rpy:51
    ...
    # game/engine_data/inventory/all_inventory.rpy:53
    old 'inventoryitem_has_dremind_name'
    new 'Mortuary reminder message'

    # game/engine_data/inventory/all_inventory.rpy:54
    ...
    # game/engine_data/inventory/all_inventory.rpy:56
    old 'inventoryitem_has_mortuary_doornote_name'
    new 'Scrawled note'

    # game/engine_data/inventory/all_inventory.rpy:57
    ...
    # game/engine_data/inventory/all_inventory.rpy:59
    old 'inventoryitem_has_dustman_request_name'
    new 'Dustman request'

    # game/engine_data/inventory/all_inventory.rpy:60
    ...
    # game/engine_data/inventory/all_inventory.rpy:62
    old 'inventoryitem_has_mortuary_task_list_name'
    new 'Mortuary task list'

    # game/engine_data/inventory/all_inventory.rpy:63
    ...
    # game/engine_data/inventory/all_inventory.rpy:65
    old 'inventoryitem_has_bone_chrm_name'
    new 'Bone charm'

    # game/engine_data/inventory/all_inventory.rpy:66
    ...
    # game/engine_data/inventory/all_inventory.rpy:68
    old 'inventoryitem_has_breast1_name'
    new 'Rune of lesser warding'

    # game/engine_data/inventory/all_inventory.rpy:69
    ...
    # game/engine_data/inventory/all_inventory.rpy:71
    old 'inventoryitem_has_breast2_name'
    new 'Rune of armor'

    # game/engine_data/inventory/all_inventory.rpy:72
    ...
    # game/engine_data/inventory/all_inventory.rpy:74
    old 'inventoryitem_has_breast3_name'
    new 'Rune of greater warding'

    # game/engine_data/inventory/all_inventory.rpy:75
    old 'inventoryitem_has_breast3_description'
    new 'Teaches user „Shield“\nUsable only by Mages\nUpon closer examination of the runes covering the surface of this breastplate, you think you might be able to unlock the rune\'s power and use it to invoke a primitive warding enchantment, similar to the one that protected the giant skeleton. Activating the rune will destroy the breastplate, however.'

    # game/engine_data/inventory/all_inventory.rpy:77
    old 'inventoryitem_has_breast4_name'
    new 'Rune of shielding'

    # game/engine_data/inventory/all_inventory.rpy:78
    old 'inventoryitem_has_breast4_description'
    new 'Teaches user „Shield“\nUsable only by Mages\nUpon closer examination of this breastplate, you realize you didn\'t mar the warding rune beyond recognition. In fact, unlike the other breastplates, the spell that maintained the integrity of the giant skeleton is mostly intact, so much so you could either cast the runes as a spell or copy them into a spell book and keep it as part of your arsenal. Either casting or copying the spell will destroy the breastplate, however.'

    # game/engine_data/inventory/all_inventory.rpy:80
    old 'inventoryitem_has_clotchrm_name'
    new 'Clot charm'

    # game/engine_data/inventory/all_inventory.rpy:81
    ...
    # game/engine_data/inventory/all_inventory.rpy:83
    old 'inventoryitem_has_cube_name'
    new 'Modron cube'

    # game/engine_data/inventory/all_inventory.rpy:84
    ...
    # game/engine_data/inventory/all_inventory.rpy:86
    old 'inventoryitem_has_decant_name'
    new 'Decanter of endless water'

    # game/engine_data/inventory/all_inventory.rpy:87
    ...
    # game/engine_data/inventory/all_inventory.rpy:89
    old 'inventoryitem_has_garbage_name'
    new 'Junk'

    # game/engine_data/inventory/all_inventory.rpy:90
    ...
    # game/engine_data/inventory/all_inventory.rpy:92
    old 'inventoryitem_has_gs_knife_name'
    new 'Green steel knife'

    # game/engine_data/inventory/all_inventory.rpy:93
    ...
    # game/engine_data/inventory/all_inventory.rpy:95
    old 'inventoryitem_has_rags_name'
    new 'Rags'

    # game/engine_data/inventory/all_inventory.rpy:96
    ...
    # game/engine_data/inventory/all_inventory.rpy:98
    old 'inventoryitem_has_spike_name'
    new 'Iron spike'

    # game/engine_data/inventory/all_inventory.rpy:99
    ...
    # game/engine_data/inventory/all_inventory.rpy:101
    old 'inventoryitem_has_strap_name'
    new 'Leather strap'

    # game/engine_data/inventory/all_inventory.rpy:102
    ...
    # game/engine_data/inventory/all_inventory.rpy:104
    old 'inventoryitem_has_sup_ring_name'
    new 'Deionarra\'s wedding ring'

    # game/engine_data/inventory/all_inventory.rpy:105
    ...
    # game/engine_data/inventory/all_inventory.rpy:107
    old 'inventoryitem_has_wedding_ring_name'
    new 'Deionarra\'s wedding ring'

    # game/engine_data/inventory/all_inventory.rpy:108
    ...
    # game/engine_data/inventory/all_inventory.rpy:110
    old 'inventoryitem_has_xac_heart_name'
    new 'Xachariah\'s heart'

    # game/engine_data/inventory/all_inventory.rpy:111
    ...
    # game/engine_data/inventory/all_inventory.rpy:113
    old 'inventoryitem_has_xac_liver_name'
    new 'Xachariah\'s liver'

    # game/engine_data/inventory/all_inventory.rpy:114
