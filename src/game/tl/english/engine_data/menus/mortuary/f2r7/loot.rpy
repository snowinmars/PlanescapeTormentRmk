...
translate english mortuary_f2r7_loot_embalm_7fc3e5ea:
    ...
    nr 'There are several bottles of cloudy green liquid on the table. You take a couple.'

# game/engine_data/menus/mortuary/f2r7/loot.rpy:25
translate english mortuary_f2r7_loot_copper_earring_closed_aa4c21e5:

    # nr 'Ты подбираешь серьгу.'
    nr 'You pick up an earring'
