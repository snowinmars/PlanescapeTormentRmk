translate english strings:
    ...
    # game/screens/narrat.rpy:2
    old "dexterity"
    new "dexterity"

    # game/screens/narrat.rpy:3
    old "intelligence"
    new "intelligence"

    # game/screens/narrat.rpy:4
    old "constitution"
    new "constitution"

    # game/screens/narrat.rpy:5
    old "wisdom"
    new "wisdom"

    # game/screens/narrat.rpy:6
    old "charisma"
    new "charisma"

    # game/screens/narrat.rpy:7
    old "good"
    new "good"

    # game/screens/narrat.rpy:8
    old "law"
    new "law"

    # game/screens/narrat.rpy:9
    old "lore"
    new "lore"

    # game/screens/narrat.rpy:10
    old "experience"
    new "experience"

    # game/screens/narrat.rpy:11
    old "ac"
    new "ac"

    # game/screens/narrat.rpy:130
    old "character_manager_modify_property"
    new "{name}: {prop} {amount:+}." # name prop amount actual_value

    # game/screens/narrat.rpy:137
    ...
    # game/screens/narrat.rpy:186
    old "world_manager_inc_once"
    new "{setting_id} {delta:+}" # setting_id before delta after

    # game/screens/narrat.rpy:193
