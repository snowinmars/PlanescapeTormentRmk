...
label morte1_s0: # - # IF WEIGHT #1 /* Triggers after states #: 26 even though they appear after this state */ ~  !InParty("Morte") Global("Morte","GLOBAL",0)
    nr '"Zdar šefíku. Seš v pořádku? Hraješ si tu na mrtváka nebo se snažíš zmást Spalovače? Myslel sem, že seš naprosto vytuhlej."~ [MRT001]{#morte1_s0_}'
...
label morte1_s1: # from 0.0
    nr '"Ehm… kdo jsem *JÁ?* Neměl bys začít spíš *TY*? Kdo seš ty?"{#morte1_s1_}'
...
label morte1_s2: # from 1.0 3.0 4.0
    nr '"Jó, tak pán si nemůže vzpomenout na méno? Ha. Tak příště, až budeš na flámu, tak to s tim chlastem zas tak nepřeháněj. Já jsem ňákej Morte. Taky jsem tu zavřenej."{#morte1_s2_}'
...
label morte1_s3: # from 1.1
    nr '"Jo a já se ptal *druhej*. Takže, jak se menuješ?"{#morte1_s3_}'
...
label morte1_s4: # from 3.1
    nr '"Ouuuu… s tebou je sranda jak s oprátkou kolem krku. Tak teda jo, klaďase si zahraju já. Jmenuju se Morte. Kdo seš ty?"{#morte1_s4_}'
...
label morte1_s5: # from 2.0
    nr '"Jo, přesně tak. Zatímco ty sis tady válel šunky, tak já už jsem makal jako včelka: Vodzkoušel jsem všecky dveře, jenže tahle místnost je zamčená víc než pás cudnosti."{#morte1_s5_}'
...
label morte1_s6: # from 5.0
    nr '"Říká se tomu Márnice… je to taková velká černá budova připomínající svou strukturou gravidního pavouka."{#morte1_s6_}'
...
label morte1_s7: # from 6.0
    nr '"Minimálně z mýho pohledu ne. Máš teda spoustu jizev a… vypadáš, jako by tě ňákej čipera pomaloval nožem. To je další důvod, proč zdrhnout z tohodle místa. Přece bys nechtěl, aby se ten umělec vrátil dokončit svou práci."{#morte1_s7_}'
...
label morte1_s8: # from 7.0
    nr '"Nooo… ty na hrudníku eště nejsou zas tak moc špatný… jenže ty na zádech…" Morte se odmlčel. "Dalo by se říct, že máš na zádech vyobrazenej katalog z tetovacího salónu, chápeš, šéfíku? Moh bych je přečíst…"{#morte1_s8_}'
...
label morte1_s11: # from 10.0
    nr '"Ne… přivlekli tě sem svlečenýho až na kůži. Ale stejně to vypadá, že velkej díl toho deníku máš napsanej na svým těle."{#morte1_s11_}'
...
label morte1_s12: # from 11.0
    nr '"Nikoho takovýho neznám… na druhou stranu, já neznám zrovna moc lidí. Tak ale pořád by tu moh bejt někdo, kdo o Pharodovi vědět bude… teda nejdřív se vocaď budem muset dostat."{#morte1_s12_}'
...
label morte1_s13: # from 12.0
    nr '"No, všecky dveře sou zavřený, takže by se nám šiknul klíč. Je možný, že ho bude mít jedna z těch chodících mrtvol."{#morte1_s13_}'
...
label morte1_s14: # from 13.0
    nr '"Jo, majitelé Márnice je vydržujou jako levnou pracovní sílu. Ty mrtvoly sou zamlklý jak kameny, ale taky sou neškodný a nenapadnou tě, pokud ty nezaútočíš první."{#morte1_s14_}'
...
label morte1_s15: # from 14.0
    nr '"Copak ty myslíš, že je to bude bolet? Sou MRTVÝ. A když to vezmeš z tý druhý stránky: zabiješ je a oni tak konečně dosáhnou odpočinku. Teda až do tý doby, než je znovu oživěj."{#morte1_s15_}'
...
label morte1_s16: # from 14.1 15.0
    nr '"No, ale než to uděláš, tak by ses moh eště ozbrojit. Myslím, že někde v těch poličkách kolem se válí skalpel."  POZNÁMKA: Prozkoumej police v místnosti a najdi zbraň pro napadení zombie. Až nějakou najdeš, přepni se do obrazovky inventáře (tlačítko batohu vpravo dole) a ozbroj se. Přeješ-li si prozkoumat předmět, který najdeš, klikni na něj pravým tlačítkem v obrazovce inventáře.{#morte1_s16_}'
...
label morte1_s18: # - # IF WEIGHT #2 /* Triggers after states #: 26 even though they appear after this state */ ~  Global("Mortuary_Walkthrough","GLOBAL",0) !PartyHasItem("Scalpel") Global("ZM782_Dead_KAPUTZ","GLOBAL",0)
    nr '"Někde v těch policích kolem by se měl poflakovat skalpel. Bejt tebou, tak ho najdu dřív, než si pudu poklábosit s některým zombíkem."  POZNÁMKA: Prozkoumej police v místnosti a najdi zbraň pro napadení zombie. Až nějakou najdeš, přepni se do obrazovky inventáře (tlačítko batohu vpravo dole) a ozbroj se. Přeješ-li si prozkoumat předmět, který najdeš, klikni na něj pravým tlačítkem v obrazovce inventáře.{#morte1_s18_}'
...
label morte1_s19: # - # IF WEIGHT #3 /* Triggers after states #: 26 even though they appear after this state */ ~  Global("Mortuary_Walkthrough","GLOBAL",0) PartyHasItem("Scalpel") Global("ZM782_Dead_KAPUTZ","GLOBAL",0)
    nr '"No hurá, našels ten skalpel! Teď si to skoč vyřídit s těma mrtvolama… a nemusíš se bát, já zůstanu vzadu a budu ti poskytovat cenné taktické informace a rady."{#morte1_s19_}'
...
label morte1_s20: # from 19.0
    nr '"No vždyť já ti budu pomáhat. Nejni přece nad dobrou radu."{#morte1_s20_}'
...
label morte1_s21: # from 20.0
    nr '"Cože, já? Já sem romantik a ne žádnej voják. Prostě se budu držet stranou."{#morte1_s21_}'
...
label morte1_s22: # from 21.0
    nr '"Ehmm… tak jo. Pomůžu ti."  POZNÁMKA: Pokud chceš, aby ti Morte pomohl v boji, ujisti se, že oba dva jste označeni, když napadáš soupeře. Morte se potom přidá k útoku.{#morte1_s22_}'
...
label morte1_s23: # from 19.1 20.1 21.1 22.0
    nr '"Je čas představit těm mrtvolám jejich druhou smrt…"  POZNÁMKA: Možnost útoku můžeš vybrat jak z rychlého menu, tak i pomocí tlačítka "A".{#morte1_s23_}'
...
label morte1_s24: # - # IF WEIGHT #4 /* Triggers after states #: 26 even though they appear after this state */ ~  Global("Mortuary_Walkthrough","GLOBAL",0) !PartyHasItem("KeyPr") Global("ZM782_Dead_KAPUTZ","GLOBAL",1)
    nr '"No sláva, zdá se, že todle byla ta správná mrtvolka. Teď už jenom najít ten klíč. Měl by bejt někde u toho těla. Až ho najdeš, konečně vocaď vypadnem."  POZNÁMKA: Nese-li nějaká bytost předmět a je-li zabita, pak tento předmět je položen na zem. Všechny předměty se zobrazí na hromádce vedle mrtvého těla. Přejeď kursorem přes dané místo pro ujištění, že ti nic neuniklo.{#morte1_s24_}'
...
label morte1_s25: # - # IF WEIGHT #5 /* Triggers after states #: 26 even though they appear after this state */ ~  Global("Mortuary_Walkthrough","GLOBAL",0) PartyHasItem("KeyPr")
    nr '"Hohó, to bude ten klíč. Určitě pasuje do jedněch z těch dveří."{#morte1_s25_}'
...
label morte1_s26: # - # IF WEIGHT #0 ~  !InParty("Morte") GlobalGT("Morte","GLOBAL",0)
    nr '"Já věděl, že se vrátíš, šéfíku! Konečně ti došlo, jak mě potřebuješ, co?"~ [MRT516]{#morte1_s26_}'
...
label morte1_s27: # from 26.1
    nr '"Hmmmph. Nevim, jak dlouho tu ještě vydržím stát, takže ti dávám POSLEDNÍ šanci. Určitě nepotřebuješ můj bystrej úsudek a moudrý rady?"{#morte1_s27_}'
...
label morte1_s28: # from 27.0 27.2
    nr '"Snažíš se ranit mý city? Copak sem něco špatnýho řek? Je to tím, že nemám ruce? Co?"{#morte1_s28_}'
...
label morte1_s29: # from 28.1
    nr '"No, ale já tu nehodlám čekat VĚČNĚ, takže se rači brzo vrať, než si to rozmyslím."{#morte1_s29_}'
...
label morte1_s30: # - # IF WEIGHT #6 ~  Global("Mortuary_Walkthrough","GLOBAL",1)
    nr '"Co tě žere, šéfíku?"~ [MRT515]{#morte1_s30_}'
...
label morte1_s31: # externs zm825_s3 zm825_s0 zm569_s3 zm569_s0
    nr '"Ehm, šéfe… voni tě neslyší, kapišto? Jsou mrtví."{#morte1_s31_}'
...
label morte1_s32: # from 31.0
    nr '"No jo, ale *Já* sem výjimka. Smrt ňák nemůže ukončit mou chuť k životu. Ty mrtváci támhle…" Morte pohlédne směrem k nim. "Ty nemaj tolik osobnosti, aby něco takovýho dokázali."{#morte1_s32_}'
...
label morte1_s33: # from 32.0
    nr '"Koukni šéfe… sledovat, jak se snažíš plkat s těmahle mrtvákama, mě moc nebere. Nenecháme radši tydle záhrobní bláboly na těch pitomcích, co?"{#morte1_s33_}'
...
label morte1_s34: # externs zm782_s0
    nr '"Zdá se, že naše přání byly vyslyšený šéfe. Koukni… má v ruce klíč."{#morte1_s34_}'
