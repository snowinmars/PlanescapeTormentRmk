class MorteLogic:
    ...
    def j64512_s85_r4676_action(self):
        ...
        #$% .register('64512', 'Muž, zdánlivě přestrojený za zombie, je členem Anarchistů, jakési frakce, která se vymyká autoritám a ničí vše, co jen vzdáleně zavání 'zákonem.'') %$#
    ...
    def r20612_action(self):
        ...
        #$%.register('20538', 'Švadlena Marta má zajímavou práci - nosí k ní mrtvoly, ona jim vyrazí zuby, odpárá stehy a podívá se po jakýchkoli cennostech, které jsou na nebo dokonce v těle, pak je zase sešije dohromady. %$#')
    ...
    def r24932_action(self):
        ...
        #$%.register('24933', 'Abych si udržel jasnou hlavu, začal jsem si zapisovat své zkušenosti a doufám, že se mi to bude někdy hodit. Probral jsem se v místě zvaném "Márnice"... a skutečně to jako Márnice vypadá. Nevím, kdo jsem, co tu dělám a jak jsem se sem dostal. První věc, kterou jsem potkal, je užvaněná lebka - Morte. Řekl mi, že jsme tu zamčeni, ale že některá z mrtvol motajících se kolem by mohla mít u sebe klíč. Navrhl mi, abych se poohlédl po skalpelu v jedné z polic kolem a pak se s ním vrhl na zombie a ubodal je k "smrti." %$#')
    ...
    def r41921_action(self):
        ...
        #$%.register('67862', 'V Hale jsem potkal muže, který proklel Smradodecha. Je to Jumble Vraždosmysl. %$#')
    ...
    def r43910_action(self):
        ...
        #$%.register('39490', 'Řekl jsem Nemelle, že jí hledá její přítelkyně Aelwyn. Odměnila mě magickým polibkem, který mi zvýšil maximální životy o tři. %$#')
    ...
    def j39477_s478_r45093_action(self):
        ...
        #$% .register('39477', 'Morte se zmínil o něčem zvaném 'Pravidlo Tří'. Někteří lidé zjevně věří, že se vše stává v trojicích a dávají tomuto číslu velký význam.') %$#
    ...
    def r53629_action(self):
        ...
        #$%.register('53633', 'Morte sdělil, že jsem ho kdysi dávno vytáhl z Pilíře, tak dávno, že už si nepamatuje, jak přesně. Taky mi vysvětlil, že ztratil všechnu shromážděnou znalost Pilíře, když jsem ho od něj odloučil... což by vysvětlovalo, proč nebyl tak *docela* užitečný, jak sliboval mé předchozí inkarnaci. %$#')
    ...
    def r53630_action(self):
        ...
        #$%.register('53661', 'Ukázalo se, že Morte pochází z něčeho, zvaného Pilíř lebek, hromady živých, useknutých hlav, na Avernu, první vrstvě Baatoru. Je vytvořený z hlav těch, kteří lhali a jejich lži zavedli jiné na konec jejich životů. %$#')
    ...
    def j65573_s652_r65569_action(self):
        ...
        #$% .register('65573', 'Řekl jsem Mortemu o novém řádku na mých zádech, který "zapomněl" přečíst. Tvrdil, že to není nic podstatného, tak mi to nepřečetl. Vím, že lže, ale ještě nevím proč.') %$#
    ...
    def r65621_action(self):
        ...
        #$%.register('65625', 'Morte mi řekl, že má speciální "moc" rozzuřit lidi, které říká Litanie Kleteb. Během života a smrti si zapamatoval tolik nadávek, že dokáže vyprovokovat skoro každého. Vynadá mu tak, že se ta osoba rozzuří a pustí se do něj. Do rozzuřené osoby se pak dá snáze trefit, jí samé trefování taky moc nejde a v podstatě bude jenom nahánět Morta kolem dokola a mlátit do něj pěstmi. Myslím, že se to bude hodit, až potkám nějakého kouzlomrska. Pokud bude chudák kouzelník hájit čest své maminky a fackovat Morta, nebude mít čas na ohnivé koule ani jiné žertíky. A to, že tenhle talent není magický, znamená, že může fungovat i na potvory, které kouzla lehce setřásnou nebo odrazí. řekl bych, že čím více nových nadávek Morte uslyší, tím lépe bude tahle schopnost fungovat. %$#')


    def j65637_s667_r65631_action(self):
        self.state_manager.journal_manager.update_journal('65637')
        #$% .register('65637', 'Morte mi řekl, že má novou schopnost, kterou získal, když seděl na polici u Lothara - říká tomu "Gang Lebek." Několikrát denně tak dokáže tak přivolat kamarády, které si našel u Lothara. Lebky se přivalí a zakousnou se do nepřítele, kterého Morte vybere. Po několika soustech se zase odvalí pryč. Poškození, které způsobí, závisí na Mortově úrovni.') %$#


    def j65669_s675_r65666_action(self):
        self.state_manager.journal_manager.update_journal('65669')
        #$% .register('65669', 'Morte mi navrhl, abych se podíval do Občanské Haly v Úřednické Čtvrti, kde bych mohl zjistit něco víc o noční čarodějnici Ravel."') %$#


    def j65678_s677_r65674_action(self):
        self.state_manager.journal_manager.update_journal('65678')
        #$% .register('65678', 'Morte mi navrhl návštěvu Občanské Haly. Někdo tam by mohl vědět, kde získat kousek Ravel. Pokud nikoho takového nenajdu, mám zkusit senzorické kameny. A pokud by i *tohle* selhalo, řekl bych, že opravdu můžeme zajít za nějakýma prostitutkama. Určitě to bude zábavnější, než to neustálé poletování mezi lidma a marná snaha něco zjistit.') %$#


    def j65712_s686_r65710_action(self):
        self.state_manager.journal_manager.update_journal('65712')
        #$% .register('65712', 'Zkonfrontoval jsem Morta s nesrovnalostí. Prohlašuje o sobě, že je mimir, ale já do něj nemusel nic zapisovat. Myslím, že ho budu muset chytit při nějaké lži, abych z něj dostal pravdu.') %$#
    ...
    def r65821_action(self):
        ...
        #$%.register('65825', 'Zjistil jsem, proč se mnou Morte zůstal celou tu dobu... protože se cítil vinný, že jsem kvůli němu kdysi zemřel, když byl ještě živý. Když jsem ho s touhle vinou zkonfrontoval, jakoby to z něj zvedlo tíži, kterou cítí. Stal se silnějším. %$#')
