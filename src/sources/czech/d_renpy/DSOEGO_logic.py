class SoegoLogic:
    ...
    def j63982_s1_r1438_action(self):
        ...
        #$% .register('63982', 'Před přední branou Márnice jsem se setkal se Spalovačem jménem Soego... vypadal unaveně, jako by týdny nespal. Podle barvy očí a bledosti jeho kůže usuzuji, že chytil nějaký druh nemoci.') %$#
    ...
    def j21805_s71_r21800_action(self):
        ...
        #$% .register('21805', 'Soego mi řekl, abych neútočil na žádné nemrtvé v Mrtvých národech, protože mi neublíží, dokud budu mírumilovný.') %$#
    ...
    def r21852_action(self):
        ...
        #$%.register('21856', 'Našel jsem Soega. Nakazil se lykantropií, která ho dovedla do katakomb. Jeho mysl už nebyla jeho a jeho víra Spalovače byla ztracena. %$#')
    ...
    def r21853_action(self):
        ...
        #$%.register('21857', 'Soego mi řekl, že neví, jak se dostat do trůnního sálu Tichého krále, což budu muset udělat, jestli chci Tichého krále zabít. %$#')
    ...
    def r21915_action(self):
        ...
        #$%.register('21926', 'Konfrontoval jsem Soega s obsahem jeho deníku, a on se proměnil v krysodlaka a zaútočil na mě. %$#')
    ...
    def j25254_s94_r25248_action(self):
        ...
        #$% .register('25254', 'Řekl jsem Soegovi, že Tichý Král nebyl ničím jiným než vyschlou mrtvolou. Řekl mi, že budu odměněn Mnohojedním, když mu to řeknu. Mnohojeden je vlastně společná mysl kraniových krys na Místě neustálého rozjímání, jižně od katakomb Truchlícího kamene.') %$#
    ...
    def j21996_s94_r21994_action(self):
        ...
        #$% .register('21996', 'Řekl jsem Soegovi, že Tichý král nebyl nic jiného, než vysušená mrtvola. Musím taky sám informovat Mnohojednoho hned, jak k tomu budu mít příležitost.') %$#
    ...
    def r22051_action(self):
        ...
        #$%.register('22052', 'Našel jsem Soega. Objevil skupinu nemrtvých strážců, kteří ochraňují katakomby. Snažil se je přesvědčit, aby se přidali k Pravé smrti. %$#')
