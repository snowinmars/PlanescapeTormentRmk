class VaxisLogic:
    ...
    def j64513_s2_r464_action(self):
        ...
        #$% .register('64513', 'Jedna ze zombie v druhém patře Márnice není ve skutečnosti zombie, ale muž v přestrojení. Proč se někdo dobrovolně přestrojuje za zombie je pro mě záhadou.') %$#
    ...
    def j64517_s30_r4469_action(self):
        ...
        #$% .register('64517', 'Zamaskovanému špiónovi jsem řekl, že jsem ho přišel vystřídat a on mi předal všechno, co dosud posbíral, hlavně hodně obvazů a léčivých itemů, které potřeboval pro udržování svého převleku.') %$#
    ...
    def j64519_s36_r64520_action(self):
        ...
        #$% .register('64519', 'Výměnou za "zombieho" pomoc jsem souhlasil, že od jedné ze Spalovaček s ostřím na rukách a žlutýma očima, se kterou jsem se setkal v jednom z pokojů, Ei-Vene myslím, že se jmenovala, přinesu balzamovací klíč. Jak může používat balzamovací klíč s těmi svými čepelemi na rukách, to fakt nechápu.') %$#


    def j64518_s36_r4503_action(self):
        self.state_manager.journal_manager.update_journal('64518')
        #$% .register('64518', 'Výměnou za "zombieho" pomoc jsem souhlasil, že od jedné ze Spalovaček s ostřím na rukách a žlutýma očima přinesu balzamovací klíč.') %$#
    ...
    def j64521_s42_r4521_action(self):
        ...
        #$% .register('64521', 'Obstarat Vaxisovi jeho drahocenný balzamovací klíč. Potřebuje jej, aby si mohl doplňovat zásoby pro své maskování - kdyby mu došla balzamovací tekutina, mohl by se prozradit.') %$#
    ...
    def j64522_s44_r4539_action(self):
        ...
        #$% .register('64522', 'Zní to, jako by Pharod a Spalovači nebyli zrovna přátelé... Vaxis mi řekl, že Pharod do Márnice dopravuje příliš mnoho těl a Spalovači ho podezřívají, že vedle sběru mrtvol také sám lidi zabíjí.') %$#
    ...
    def j64528_s51_r64527_action(self):
        ...
        #$% .register('64528', 'Vaxis mi řekl, že v severozápadní místnosti prvního patra Márnice je tajný portál - jestliže se k němu přiblížím s prstní kostí, zaktivuje se a přenese mě do tajné krypty, kde si, jak Vaxis říká, mohu dopřát "odpočinek." Sice neví, kde bych nějakou prstní kost mohl najít, nicméně mi navrhl, abych to zkusil někde v horním patře Márnice.') %$#
    ...
    def j64529_s51_r4568_action(self):
        ...
        #$% .register('64529', 'Vaxis mi řekl, že v severozápadní místnosti prvního patra Márnice je tajný portál - jestliže se k němu přiblížím s prstní kostí, zaktivuje se a vezme mě do tajné krypty, kde si, jak Vaxis říká, mohu dopřát "odpočinek."') %$#
    ...
    def j64530_s55_r4580_action(self):
        ...
        #$% .register('64530', 'Vaxis říkal, že Soego je nějaký divný - mluvil o tom, že má rád "krysy," ať už TO znamená cokoliv. Je paradoxní, že zrovna Vaxis o někom prohlašuje, že je divný.') %$#
    ...
    def j64531_s67_r4638_action(self):
        ...
        #$% .register('64531', 'Výměnou za několik jehel a nití a trochu balzamovací tekutiny mě Vaxis zamaskoval za zombie. Varoval mě, že jako zombie nesmím běhat, protože by běh zničil maskování, stejně jako nesmím mluvit, protože zombie "nemluví."') %$#
