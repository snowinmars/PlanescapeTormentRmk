...
label zm1445_s0: # - # IF ~  True()
    nr 'Tělo této mrtvoly je hrozivě poničené, špička nosu a několik prstů už definitivně uhnilo… muž zřejmě zemřel na nějakou hrozivou chorobu. Na jeho čele je vytetováno číslo "1445", rty jsou pevně sešity dohromady.{#zm1445_s0_1}'
...
label zm1445_s1: # from 0.0 0.1 0.2
    nr 'Mrtvola na tebe dál zírá.{#zm1445_s1_1}'
...
label zm1445_s2: # from 0.3
    nr 'Mrtvola neodpovídá. Asi už shnila příliš.{#zm1445_s2_1}'
