...
label zm199_s0: # - # IF ~  True()
    ...
    menu:
        ...
        '"Takže… děje se tady poslední dobou něco zajímavého?"{#zm199_s0_r34979}' if zm199Logic.r34979_condition():
            # a1 # r34979
            jump zm199_s1

        '"Vím, že nejsi zombie. Takhle nikoho neoblbneš."{#zm199_s0_r34980}' if zm199Logic.r34980_condition():
            # a2 # r34980
            jump zm199_s1

        'Použij na mrtvole tvou dovednost Kosti-vyprávějte.{#zm199_s0_r34981}' if zm199Logic.r34981_condition():
            # a3 # r34981
            jump zm199_s2

        '"Rád jsem si s tebou popovídal. Sbohem."{#zm199_s0_r34984}':
            # a4 # r34984
            jump zm199_dispose

        'Nechej mrtvolu být.{#zm199_s0_r34985}':
            # a5 # r34985
            jump zm199_dispose
