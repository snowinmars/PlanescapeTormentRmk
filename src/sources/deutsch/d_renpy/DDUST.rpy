...
label dust_s0: # - # IF ~  Global("Appearance","GLOBAL",1)
    ...
    menu:
        ...
        '"Wer bist du?"{#dust_s0_r303}':
            # a1 # r303
            jump dust_s1

        '"Wo bin ich hier?"{#dust_s0_r304}':
            # a2 # r304
            jump dust_s1

        '"Ich hätte ein paar Fragen…"{#dust_s0_r305}':
            # a3 # r305
            jump dust_s1

        'Laß ihn in Ruhe.{#dust_s0_r306}':
            # a4 # r306
            jump dust_dispose
...
label dust_s1: # from 0.0 0.1 0.2 0.3
    ...
    menu:
        ...
        '"Ich hätte da ein paar Fragen…"{#dust_s1_r312}':
            # a6 # r312
            jump dust_s2

        'Geh. Und zwar schnell.{#dust_s1_r1332}':
            # a7 # r1332
            jump dust_s2
...
label dust_s3: # externs morte_s64
    ...
    menu:
        ...
        '"Wer bist du?"{#dust_s3_r316}':
            # a10 # r316
            jump dust_s4

        '"Wo bin ich hier?"{#dust_s3_r317}':
            # a11 # r317
            jump dust_s4

        '"Ich hätte ein paar Fragen…"{#dust_s3_r319}':
            # a12 # r319
            jump dust_s4

        'Laß ihn in Ruhe.{#dust_s3_r382}':
            # a13 # r382
            jump dust_dispose
...
label dust_s4: # from 3.0 3.1 3.2 3.3 40.2 40.3
    ...
    menu:
        ...
        '"Nein, ich habe mich nicht verirrt. Ich hätte da ein paar Fragen…"{#dust_s4_r324}':
            # a16 # r324
            jump dust_s6

        '"Leb wohl."{#dust_s4_r325}':
            # a17 # r325
            jump dust_s5
...
label dust_s5: # from 4.0 4.3 6.4 16.2 51.1
    ...
    menu:
        ...
        'Brich ihm das Genick, bevor er rufen kann.{#dust_s5_r328}' if dustLogic.r328_condition():
            # a19 # r328
            jump dust_s41

        'Geh. Und zwar schnell.{#dust_s5_r329}':
            # a20 # r329
            jump dust_s2
...
label dust_s6: # from 4.1 4.2 51.2 51.3
    ...
    menu:
        ...
        '"Ich bin auf einer der Totenbänke in eurem Vorbereitungsraum aufgewacht."{#dust_s6_r332}':
            # a23 # r332
            jump dust_s8

        '"Ich bin hier, um jemandem zu treffen."{#dust_s6_r333}':
            # a24 # r333
            jump dust_s9

        '"Ich bin wegen einer Bestattung hier, aber da scheint etwas schiefgelaufen zu sein."{#dust_s6_r334}' if dustLogic.r334_condition():
            # a25 # r334
            jump dust_s16

        'Geh. Und zwar schnell.{#dust_s6_r337}':
            # a26 # r337
            jump dust_s5
...
label dust_s7: # from 6.0 9.0 20.0
    ...
    menu:
        ...
        'Brich ihm das Genick, bevor er rufen kann.{#dust_s7_r3887}' if dustLogic.r3887_condition():
            # a28 # r3887
            jump dust_s41

        '"Dann ruf sie doch zusammen. Würde sie gerne kennenlernen."{#dust_s7_r3888}':
            # a29 # r3888
...
label dust_s8: # from 6.1 16.0 20.1
    ...
    menu:
        ...
        'Brich ihm das Genick, bevor er rufen kann.{#dust_s8_r3885}' if dustLogic.r3885_condition():
            # a31 # r3885
            jump dust_s41

        '"Dann ruf sie doch zusammen. Würde sie gerne kennenlernen."{#dust_s8_r3886}':
            # a32 # r3886
...
label dust_s9: # from 6.2 20.2
    ...
    menu:
        ...
        '"Ich bin gekommen, um Dhall zu sehen."{#dust_s9_r342}' if dustLogic.r342_condition():
            # a34 # r342
            jump dust_s10

        '"Ich bin gekommen, um Dhall zu sehen."{#dust_s9_r343}' if dustLogic.r343_condition():
            # a35 # r343
            jump dust_s11

        '"Ich bin gekommen, um Deionarra zu sehen."{#dust_s9_r33183}' if dustLogic.r33183_condition():
            # a36 # r33183
            jump dust_s13

        '"Ich bin gekommen, um Deionarra zu sehen."{#dust_s9_r33185}' if dustLogic.r33185_condition():
            # a37 # r33185
            jump dust_s12

        '"Ich bin gekommen, um Soego zu sehen."{#dust_s9_r33186}' if dustLogic.r33186_condition():
            # a38 # r33186
            jump dust_s15

        '"Ich bin gekommen, um Soego zu sehen."{#dust_s9_r33187}' if dustLogic.r33187_condition():
            # a39 # r33187
            jump dust_s14

        'Lüge: "Äh… Adahn. Arbeitet er noch hier, oder…?"{#dust_s9_r33189}' if dustLogic.r33189_condition():
            # a40 # r33189
            $ dustLogic.r33189_action()
            jump dust_s21

        'Lüge: "Äh… Adahn. Arbeitet er noch hier, oder…?"{#dust_s9_r33190}' if dustLogic.r33190_condition():
            # a41 # r33190
            jump dust_s21

        '"Äh, niemanden. Ich hab„ mich versprochen."{#dust_s9_r33191}':
            # a42 # r33191
            jump dust_s20
...
label dust_s16: # from 6.3 20.3
    ...
    menu:
        ...
        '"Das könnte sein. Wo finden diese anderen Zeremonien statt?"{#dust_s16_r360}':
            # a50 # r360
            jump dust_s17

        '"Kannst du mir den Weg hier raus zeigen?"{#dust_s16_r361}':
            # a51 # r361
            jump dust_s5
...
label dust_s19: # from 17.1
    ...
    menu:
        ...
        '"Ihr Name ist Deionarra."{#dust_s19_r370}' if dustLogic.r370_condition():
            # a56 # r370
            jump dust_s12

        'Lüge: "Sein Name ist… äh, Adahn."{#dust_s19_r371}' if dustLogic.r371_condition():
            # a57 # r371
            $ dustLogic.r371_action()
            jump dust_s21

        'Lüge: "Sein Name ist… äh, Adahn."{#dust_s19_r372}' if dustLogic.r372_condition():
            # a58 # r372
            jump dust_s21

        'Beug dich nach vorne, als wenn du ihm etwas zuflüstern wolltest, und brich ihm das Genick.{#dust_s19_r373}' if dustLogic.r373_condition():
            # a59 # r373
            jump dust_s44

        'Beug dich nach vorne, als wenn du ihm etwas zuflüstern wolltest, und brich ihm das Genick.{#dust_s19_r1335}' if dustLogic.r1335_condition():
            # a60 # r1335
            jump dust_s45

        'Lauf weg, so schnell du kannst.{#dust_s19_r1336}':
            # a61 # r1336
            jump dust_s2
...
label dust_s20: # from 9.9 19.0
    ...
    menu:
        ...
        '"Ich bin auf einer der Totenbänke in eurem Vorbereitungsraum aufgewacht."{#dust_s20_r376}':
            # a63 # r376
            jump dust_s8

        '"Ich bin hier, um jemandem zu treffen."{#dust_s20_r377}':
            # a64 # r377
            jump dust_s9

        '"Ich bin wegen einer Bestattung hier, aber da scheint etwas schiefgelaufen zu sein."{#dust_s20_r378}' if dustLogic.r378_condition():
            # a65 # r378
            jump dust_s16

        'Lauf weg, so schnell du kannst.{#dust_s20_r379}':
            # a66 # r379
            jump dust_s2
...
label dust_s22: # - # IF ~  Global("Appearance","GLOBAL",2)
    ...
    menu:
        ...
        'Laß ihn in Frieden.{#dust_s22_r297}':
            # a69 # r297
            jump dust_dispose
...
label dust_s23: # from 22.0
    ...
    menu:
        ...
        '"Wo bin ich hier?"{#dust_s23_r384}':
            # a71 # r384
            jump dust_s25

        '"Ich hätte ein paar Fragen…"{#dust_s23_r391}':
            # a72 # r391
            jump dust_s26

        'Laß ihn in Ruhe.{#dust_s23_r392}':
            # a73 # r392
            jump dust_dispose
...
label dust_s24: # from 23.0
    ...
    menu:
        ...
        'Lüge: "Sein Name ist… äh, Adahn."{#dust_s24_r1337}' if dustLogic.r1337_condition():
            # a75 # r1337
            jump dust_s49

        '"Mein Name geht dich nichts an. Ich muß mich verabschieden. Leb wohl."{#dust_s24_r3904}' if dustLogic.r3904_condition():
            # a76 # r3904
            jump dust_s47

        '"Mein Name geht dich nichts an. Ich muß mich verabschieden. Leb wohl."{#dust_s24_r3905}' if dustLogic.r3905_condition():
            # a77 # r3905
            jump dust_s46
...
label dust_s25: # from 23.1
    ...
    menu:
        ...
        'Lüge: "Sein Name ist… äh, Adahn."{#dust_s25_r3906}' if dustLogic.r3906_condition():
            # a79 # r3906
            jump dust_s49

        '"Mein Name geht dich nichts an. Ich muß mich verabschieden. Leb wohl."{#dust_s25_r3907}' if dustLogic.r3907_condition():
            # a80 # r3907
            jump dust_s47

        '"Mein Name geht dich nichts an. Ich muß mich verabschieden. Leb wohl."{#dust_s25_r3908}' if dustLogic.r3908_condition():
            # a81 # r3908
            jump dust_s46
...
label dust_s26: # from 23.2 27.0 28.2 30.3 31.3 34.2 36.1 39.0 50.0
    ...
    menu:
        ...
        '"Kennst du jemanden namens Pharod?"{#dust_s26_r402}':
            # a83 # r402
            jump dust_s28

        '"Ich vermisse ein Journal. Hast du es zufällig gesehen?"{#dust_s26_r403}':
            # a84 # r403
            jump dust_s39

        '"Schon gut. Tut mir leid, daß ich dich gestört habe."{#dust_s26_r404}':
            # a85 # r404
            jump dust_s48
...
label dust_s27: # from 26.0
    ...
    menu:
        ...
        'Vielen Dank. Leb wohl."{#dust_s27_r407}':
            # a87 # r407
            jump dust_s48
...
label dust_s28: # from 26.1
    ...
    menu:
        ...
        '"Ich hätte noch ein paar andere Fragen…"{#dust_s28_r411}':
            # a90 # r411
            jump dust_s26

        '"Danke, daß du dir für mich Zeit genommen hast. Leb wohl."{#dust_s28_r425}':
            # a91 # r425
            jump dust_s48
...
label dust_s29: # from 28.0
    ...
    menu:
        ...
        '"Ich bin… hier neu. Ich… versuche mich zurechtzufinden."{#dust_s29_r3918}' if dustLogic.r3918_condition():
            # a93 # r3918
            jump dust_s47

        '"Nun ja… was ist schon ein Name? Bleib bei deinem Glauben, äh, Eingeweihter."{#dust_s29_r3919}' if dustLogic.r3919_condition():
            # a94 # r3919
            jump dust_s47

        '"Wenn du mir nicht helfen kannst, dann werde ich mir eben jemand suchen, der„s kann. Leb wohl."{#dust_s29_r3920}' if dustLogic.r3920_condition():
            # a95 # r3920
            jump dust_s46
...
label dust_s30: # from 28.1
    ...
    menu:
        ...
        '"Wo kann ich Dhall finden?"{#dust_s30_r416}' if dustLogic.r416_condition():
            # a97 # r416
            jump dust_s32

        '"Wo finde ich Dhall?"{#dust_s30_r417}' if dustLogic.r417_condition():
            # a98 # r417
            jump dust_s33

        '"Ich hätte noch ein paar Fragen…"{#dust_s30_r418}':
            # a99 # r418
            jump dust_s26

        '"Danke für die Information. Ich werde mit ihm reden."{#dust_s30_r33204}':
            # a100 # r33204
            jump dust_s48
...
label dust_s31: # from 30.0 32.0 33.0
    ...
    menu:
        ...
        '"Was ist ein „Githzerai“?"{#dust_s31_r421}':
            # a102 # r421
            jump dust_s35

        '"Gesegnet?"{#dust_s31_r422}':
            # a103 # r422
            jump dust_s36

        '"Ich verstehe. Ich hätte noch ein paar Fragen…"{#dust_s31_r423}':
            # a104 # r423
            jump dust_s26

        '"Danke, daß du dir für mich Zeit genommen hast. Ich muß jetzt gehen."{#dust_s31_r424}':
            # a105 # r424
            jump dust_s48
...
label dust_s32: # from 30.1
    ...
    menu:
        ...
        '"Danke, daß du dir für mich Zeit genommen hast. Ich muß mich jetzt verabschieden. Leb wohl."{#dust_s32_r429}':
            # a107 # r429
            jump dust_s48
...
label dust_s33: # from 30.2
    ...
    menu:
        ...
        '"Danke, daß du mir ein wenig Zeit geopfert hast. Ich muß mich jetzt von dir verabschieden. Leb wohl."{#dust_s33_r431}':
            # a109 # r431
            jump dust_s48
...
label dust_s34: # from 31.0
    ...
    menu:
        ...
        '"Wieso bezeichnest Du Dhalls Tod als Segen? Er ist wohl nicht sehr beliebt?"{#dust_s34_r437}':
            # a111 # r437
            jump dust_s36

        '"Oh. Ich hätte noch ein paar Fragen…"{#dust_s34_r438}':
            # a112 # r438
            jump dust_s26

        '"Vielen Dank für deine Zeit. Auf bald."{#dust_s34_r440}':
            # a113 # r440
            jump dust_s48
...
label dust_s35: # from 31.1 34.0
    ...
    menu:
        ...
        '"Ich bin… hier neu. Ich… versuche mich zurechtzufinden."{#dust_s35_r3909}' if dustLogic.r3909_condition():
            # a115 # r3909
            jump dust_s47

        '"Nun ja… was ist schon ein Name? Bleib bei deinem Glauben, äh, Eingeweihter."{#dust_s35_r3910}' if dustLogic.r3910_condition():
            # a116 # r3910
            jump dust_s47

        '"Wenn du mir nicht helfen kannst, dann werde ich mir eben jemand suchen, der„s kann. Leb wohl."{#dust_s35_r3911}' if dustLogic.r3911_condition():
            # a117 # r3911
            jump dust_s46
...
label dust_s36: # from 31.2 34.1
    ...
    menu:
        ...
        '"Ich verstehe. Wirklich ein Segen. Ich hätte da noch ein paar Fragen…"{#dust_s36_r442}':
            # a119 # r442
            jump dust_s26

        '"Ich verstehe. Nun, ich muß mich jetzt von dir verabschieden. Leb wohl."{#dust_s36_r443}':
            # a120 # r443
            jump dust_s48
...
label dust_s37: # from 36.0
    ...
    menu:
        ...
        '"Ich bin… hier neu. Ich… versuche mich zurechtzufinden."{#dust_s37_r446}' if dustLogic.r446_condition():
            # a122 # r446
            jump dust_s47

        '"Nun ja… was ist schon ein Name? Bleib bei deinem Glauben, äh, Eingeweihter."{#dust_s37_r3912}' if dustLogic.r3912_condition():
            # a123 # r3912
            jump dust_s47

        '"Wenn du mir nicht helfen kannst, dann werde ich mir eben jemand suchen, der„s kann. Leb wohl."{#dust_s37_r3913}' if dustLogic.r3913_condition():
            # a124 # r3913
            jump dust_s46
...
label dust_s38: # -
    ...
    menu:
        ...
        '"Schhhh! Ich kann dir ja gar keine Antwort geben, wenn du so schreist!"{#dust_s38_r449}' if dustLogic.r449_condition():
            # a126 # r449
            $ dustLogic.r449_action()
            jump dust_dispose

        '"Schhhh! Ich kann dir ja gar keine Antwort geben, wenn du so schreist!"{#dust_s38_r1339}' if dustLogic.r1339_condition():
            # a127 # r1339
...
label dust_s39: # from 26.2
    ...
    menu:
        ...
        '"Ich muß mich jetzt verabschieden. Leb wohl."{#dust_s39_r452}':
            # a129 # r452
            jump dust_s48
...
label dust_s40: # -
    ...
    menu:
        ...
        '"Sei gegrüßt."{#dust_s40_r1421}' if dustLogic.r1421_condition():
            # a131 # r1421
            jump morte_s63  # EXTERN

        '"Sei gegrüßt."{#dust_s40_r1422}' if dustLogic.r1422_condition():
            # a132 # r1422
            jump dust_s4

        '"Sei gegrüßt."{#dust_s40_r1423}' if dustLogic.r1423_condition():
            # a133 # r1423
            jump dust_s4

        'Laß ihn in Frieden.{#dust_s40_r1424}':
            # a134 # r1424
            jump dust_dispose
...
label dust_s42: # from 41.0 45.0
    ...
    menu:
        ...
        '"Besser du als ich, Staubie."{#dust_s42_r1429}' if dustLogic.r1429_condition():
            # a137 # r1429
...
label dust_s47: # from 24.2 25.2 29.1 29.2 35.1 35.2 37.1 37.2 49.1 49.2
    ...
    menu:
        ...
        'Brich ihm das Genick, bevor er rufen kann.{#dust_s47_r3915}' if dustLogic.r3915_condition():
            # a143 # r3915
            jump dust_s41

        '"Nein, nein… das stimmt nicht, äh… Ich meine, ich bin kein Spitzel… weißt du, ich bin hier auf einer der Totenbänke aufgewacht… und…"{#dust_s47_r3916}':
            # a144 # r3916
            jump dust_s2

        'Geh. Und zwar schnell.{#dust_s47_r3917}':
            # a145 # r3917
            jump dust_s2
...
label dust_s49: # from 24.0 24.1 25.0 25.1
    ...
    menu:
        ...
        '"Ich… bin hier neu. Ich… bin dabei, mich einzuarbeiten."{#dust_s49_r3899}' if dustLogic.r3899_condition():
            # a148 # r3899
            jump dust_s47

        '"Nun ja… was ist schon ein Name? Bleib bei deinem Glauben, äh, Eingeweihter."{#dust_s49_r3900}' if dustLogic.r3900_condition():
            # a149 # r3900
            jump dust_s47

        '"Wenn du mir nicht helfen kannst, dann werde ich mir eben jemand suchen, der„s kann. Leb wohl."{#dust_s49_r3901}' if dustLogic.r3901_condition():
            # a150 # r3901
            jump dust_s46
...
label dust_s50: # from 29.0 35.0 37.0 49.0
    ...
    menu:
        ...
        '"Heute grade nicht. Leb wohl."{#dust_s50_r3903}':
            # a152 # r3903
            jump dust_s46
...
label dust_s51: # - # IF ~  Global("Appearance","GLOBAL",0)
    ...
    menu:
        ...
        '"Ja."{#dust_s51_r66676}' if dustLogic.r66676_condition():
            # a154 # r66676
            jump dust_s5

        '"Nein."{#dust_s51_r66677}' if dustLogic.r66677_condition():
            # a155 # r66677
            jump dust_s6

        '"Nein, ich hab mich nicht verlaufen. Ich hätte da ein paar Fragen…"{#dust_s51_r66678}' if dustLogic.r66678_condition():
            # a156 # r66678
            jump dust_s6

        '"Leb wohl."{#dust_s51_r66679}' if dustLogic.r66679_condition():
            # a157 # r66679
            jump dust_s2
