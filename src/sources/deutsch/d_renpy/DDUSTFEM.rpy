...
label dustfem_s0: # - # IF ~  Global("Appearance","GLOBAL",1)
    nr 'Die Staubmenschen-Frau scheint dich nicht zu bemerken. Sie hält dich wohl für eine dieser lebenden Leichen, die hier arbeiten.{#dustfem_s0_1}'
...
label dustfem_s1: # from 0.0 0.1 0.2 0.3
    nr 'Die Staubmenschen-Frau zuckt zusammen und wirft den Kopf zu dir herum. Sie wirkt schockiert - deine Verkleidung muß ziemlich gut sein.{#dustfem_s1_1}'
...
label dustfem_s2: # from 1.1 1.2 4.3 5.2 5.3 6.4 19.6 20.4 47.2 47.3 51.4
    nr 'Die Staubmenschen-Frau geht einen Schritt zurück und klatscht dreimal fest in die Hände. Daraufhin ertönt der Klang einer großen Eisenglocke durch die ganze Leichenhalle.{#dustfem_s2_1}'
...
label dustfem_s3: # externs morte_s84
    nr 'Diese blasse Frau trägt eine lange dunkle Robe und riecht leicht muffig. Ihr Gesicht ist ausdruckslos; sie scheint in ihre Arbeit vertieft.{#dustfem_s3_1}'
...
label dustfem_s4: # from 3.0 3.1 3.2 3.3 40.2 40.3
    nr 'Die Staubmenschen-Frau blickt langsam auf und dreht sich zu dir um. "Hast du dich verlaufen?"{#dustfem_s4_1}'
...
label dustfem_s5: # from 4.0 16.2 51.1
    nr '"Ich rufe einen Wächter, der dich hinausführen wird. Warte einen Augenblick."{#dustfem_s5_1}'
...
label dustfem_s6: # from 4.1 4.2 51.2 51.3
    nr '"Was hast du hier zu suchen, wenn du dich nicht verirrt hast?"{#dustfem_s6_1}'
...
label dustfem_s7: # from 6.0 9.0 20.0
    nr '"Das geht mich leider sehr wohl etwas an. Vielleicht können dir die Wächter ja die Zunge lösen." Die Staubmenschen-Frau geht einen Schritt zurück; sie sieht aus, als würde sie jeden Moment die Wache rufen.{#dustfem_s7_1}'
...
label dustfem_s8: # from 6.1 16.0 20.1
    nr '"Du machst wohl Witze? Vielleicht würdest du das gerne den Wächtern erzählen." Die Staubmenschen-Frau geht einen Schritt zurück; sie sieht aus, als würde sie jeden Moment die Wache rufen.{#dustfem_s8_1}'
...
label dustfem_s9: # from 6.2 20.2
    nr '"Wen möchtest du hier treffen?"{#dustfem_s9_1}'
...
label dustfem_s10: # from 9.1
    nr '"Dhall ist im Empfangsraum auf diesem Stockwerk. Ich warne dich… er hat alle Hände voll zu tun und ist nicht gerade bei bester Gesundheit. Wenn es nicht absolut dringend ist, würde ich ihn lieber nicht stören."{#dustfem_s10_1}'
...
label dustfem_s11: # from 9.2
    nr '"Dhall ist höchstwahrscheinlich im Empfangsraum im ersten Stock. Er hat alle Hände voll zu tun und ist nicht gerade bei bester Gesundheit. Wenn es nicht absolut dringend ist, würde ich ihn lieber nicht stören."{#dustfem_s11_1}'
...
label dustfem_s12: # from 9.4 19.1
    nr '"Deionarra? Ich weiß, daß in der Gedenkhalle im Erdgeschoß eine Frau bestattet ist. Ob sie das ist?"{#dustfem_s12_1}'
...
label dustfem_s13: # from 9.3
    nr '"Deionarra? Ich weiß, daß im Nordwesten der Gedenkhalle eine Frau bestattet ist. Ob sie das ist?"{#dustfem_s13_1}'
...
label dustfem_s14: # from 9.6
    nr '"Ich glaube, Soego ist am Haupttor im Erdgeschoß. Er arbeitet hier während des Tiefstands als Führer."{#dustfem_s14_1}'
...
label dustfem_s15: # from 9.5
    nr '"Ich glaube, Soego ist am Haupttor. Er arbeitet hier während des Tiefstands als Führer."{#dustfem_s15_1}'
...
label dustfem_s16: # from 6.3 20.3
    nr '"Wer sollte bestattet werden? Vielleicht finden die Feierlichkeiten woanders in der Leichenhalle statt."{#dustfem_s16_1}'
...
label dustfem_s17: # from 16.1
    nr '"Mehrere Grabkammern umgeben die Leichenhalle. Sie folgen dem Verlauf der Mauer im Erdgeschoß und im ersten Stock. Kennst du den Namen des Verstorbenen?"{#dustfem_s17_1}'
...
label dustfem_s18: # from 17.0
    nr '"Frag doch einfach einen der Führer am Haupttor. Sie können dir bestimmt helfen."{#dustfem_s18_1}'
...
label dustfem_s19: # from 17.1
    nr 'Der Staubmensch wartet.{#dustfem_s19_1}'
...
label dustfem_s20: # from 9.9 19.0
    nr '"Ah ja. Und was hast du hier zu suchen?"{#dustfem_s20_1}'
...
label dustfem_s21: # from 9.7 9.8 19.2 19.3
    nr '"Nie gehört. Frag doch einfach einen der Führer am Haupttor… sie können dir vielleicht mehr sagen."{#dustfem_s21_1}'
...
label dustfem_s22: # - # IF ~  Global("Appearance","GLOBAL",2)
    nr 'Diese blasse Frau trägt eine lange dunkle Robe und riecht leicht muffig. Ihr Gesicht ist ausdruckslos; sie scheint in ihre Arbeit vertieft.{#dustfem_s22_1}'
...
label dustfem_s23: # from 22.0
    nr 'Sie dreht sich langsam um. Ihre Augen gleiten auf deine Robe. "Sei gegrüßt, Eingeweihter."{#dustfem_s23_1}'
...
label dustfem_s24: # from 23.0
    nr '"Das möchte ich auch gerne von dir wissen. Ich kenne dein Gesicht nicht. Wer bist du?"{#dustfem_s24_1}'
...
label dustfem_s25: # from 23.1
    nr '"Dies ist die Leichenhalle…" Der Staubmensch schaut dich an, als müßte er erst verdauen, was du gesagt hast. "Wie war doch gleich dein Name?"{#dustfem_s25_1}'
...
label dustfem_s26: # from 23.2 27.0 28.2 30.3 31.3 34.2 36.1 39.0 50.0
    nr 'Der Staubmensch wartet geduldig darauf, daß du fortfährst.{#dustfem_s26_1}'
...
label dustfem_s27: # from 26.0
    nr '"Am besten du gehst einfach durch das Haupttor. Es ist im Erdgeschoß."{#dustfem_s27_1}'
...
label dustfem_s28: # from 26.1
    nr '"Dieser Name…" Der Staubmensch hält kurz inne. "Dieser Name kommt mir irgendwie *bekannt* vor… ich glaube, es gab da mal einen Sammler, der so hieß. Dhall, der Schreiberling, könnte ihn kennen."{#dustfem_s28_1}'
...
label dustfem_s29: # from 28.0
    nr '"Sammler… lesen Tote von den Straßen Sigils auf und schaffen sie in die Leichenhalle…" Der Staubmensch zögert, dann runzelt er die Stirn. "Du bist nicht von hier. Wer bist du?"{#dustfem_s29_1}'
...
label dustfem_s31: # from 30.0 32.0 33.0
    nr 'Die Staubmenschen-Frau nickt. "Dhall ist krank. Er ist alt, selbst für einen Githzerai. Der Tod ist ihm gewiß nach diesem Siechtum. Er hat wirklich Glück."{#dustfem_s31_1}'
...
label dustfem_s32: # from 30.1
    nr '"Dhall ist im Empfangsraum in der nordwestlichen Winkel dieses Stockwerks. Ich warne dich… Dhall ist ziemlich beschäftigt… wenn er nicht gerade seiner Arbeit nachgeht, wird ein Großteil seiner Zeit von seiner Krankheit beansprucht."{#dustfem_s32_1}'
...
label dustfem_s33: # from 30.2
    nr '"Dhall ist höchstwahrscheinlich im Empfangsraum im ersten Stock. An deiner Stelle würde ich ihn nicht allzu lang aufhalten, da er alle Hände voll zu tun hat… wenn er nicht gerade seinen Pflichten nachkommt, schlägt er sich die meiste Zeit mit seiner Krankheit herum."{#dustfem_s33_1}'
...
label dustfem_s34: # from 31.0
    nr '"Ja, die Githzerai leben wesentlich länger als die Menschen."{#dustfem_s34_1}'
...
label dustfem_s35: # from 31.1 34.0
    nr '"Die Githzerai sind…" Die Staubmenschen-Frau zögert; dann sieht sie dich durchdringend an. "Du bist nicht von hier. Wer bist du?"{#dustfem_s35_1}'
...
label dustfem_s36: # from 31.2 34.1
    nr '"Er ist  gesegnet, weil er den Wahren Tod erlangen wird. Dann braucht er nicht mehr im Schatten dieser Existenz zu verweilen."{#dustfem_s36_1}'
...
label dustfem_s37: # from 36.0
    nr 'Die Staubmenschen-Frau nickt. "Ja." Sie runzelt die Stirn und sieht dich durchdringend an. "Du bist nicht von hier. Wer bist du?"{#dustfem_s37_1}'
...
# s38 # say1212
label dustfem_s38: # -
    nr '" Du bist keiner der Unseren, oder? Was führt dich hierher? Bist du ein Anarchist? Oder ein Spitzel eines anderen Bundes?" Die Staubmenschen-Frau geht einen Schritt zurück. "Wache! Wache!"{#dustfem_s38_1}'
...
label dustfem_s39: # from 26.2
    nr '"Ein Journal? Ich habe keines gesehen."{#dustfem_s39_1}'
...
# s40 # say1214
label dustfem_s40: # -
    nr 'Diese blasse Frau trägt eine lange dunkle Robe und riecht leicht muffig. Ihr Gesicht ist ausdruckslos; sie scheint in ihre Arbeit vertieft.{#dustfem_s40_1}'
...
label dustfem_s41: # from 1.0 5.1 7.1 8.1 47.1
    nr 'Bevor die Staubmenschen-Frau auch nur ein Wort sagen kann, packst du sie an den Schläfen und drehst ihren Kopf ruckartig nach links.{#dustfem_s41_1}'
...
label dustfem_s42: # from 41.0 45.0
    nr 'Es macht *Knacks*, und der Staubmensch fällt dir erschlafft in die Arme.{#dustfem_s42_1}'
...
label dustfem_s43: # from 42.0
    nr 'Zu deiner Überraschung scheint diese Handlung instinktiv zu sein, als hättest du das schon viele Male getan. Mit diesem Gedanken regt sich eine vage Erinnerung, die jedoch nicht stark genug ist, um an die Oberfläche zu gelangen.{#dustfem_s43_1}'
...
label dustfem_s44: # from 5.0 7.0 8.0 19.4 47.0
    nr 'Du bist nicht schnell genug. Die Staubmenschen-Frau weicht deinem Angriffsversuch aus. Sie geht einen Schritt zurück und klatscht dreimal fest in Hände. Daraufhin ertönt der Klang einer großen Eisenglocke durch die Leichenhalle.{#dustfem_s44_1}'
...
label dustfem_s45: # from 19.5
    nr 'Als du dich vorbeugst, um ihr etwas „zuzuflüstern“, beugt die Staubmenschen-Frau ihren Kopf auch nach vorne. Sobald du kannst, packst du sie an den Schläfen und drehst ihren Kopf ruckartig nach links.{#dustfem_s45_1}'
...
label dustfem_s46: # from 24.3 25.3 29.3 35.3 37.3 49.3 50.1
    nr 'Die Staubmenschen-Frau wirkt mißtrauisch. Sie sieht aus, als würde sie jeden Moment etwas sagen, doch dann schüttelt sie nur kurz den Kopf und wendet sich wieder ihrer Arbeit zu{#dustfem_s46_1}'
...
label dustfem_s47: # from 24.2 25.2 29.1 29.2 35.1 35.2 37.1 37.2 49.1 49.2
    nr 'Der Staubmensch mustert dich aufmerksam. "Du bist keiner von uns, oder? Was führt dich hierher? Bist du ein Anarchist? Oder ein Spitzel eines anderen Bundes? Ich glaube, dies ist ein Fall für die Wache…"{#dustfem_s47_1}'
...
label dustfem_s48: # from 10.0 11.0 12.0 13.0 14.0 15.0 26.3 27.1 28.3 30.4 31.4 32.1 33.1 34.3 36.2 39.1
    nr 'Die Staubmenschen-Frau nickt, bevor sie sich wieder ihrer Arbeit zuwendet.{#dustfem_s48_1}'
...
label dustfem_s49: # from 24.0 24.1 25.0 25.1
    nr 'Der Staubmensch runzelt die Stirn. "Dieser Name kommt mir nicht bekannt vor."{#dustfem_s49_1}'
...
label dustfem_s50: # from 29.0 35.0 37.0 49.0
    nr 'Die Staubmenschen-Frau runzelt weiter die Stirn und sagt mit einem leichten Nicken. "Sehr gut. Was kann ich für dich tun, Eingeweihter?"{#dustfem_s50_1}'
...
label dustfem_s51: # - # IF ~  Global("Appearance","GLOBAL",0)
    nr 'Der Staubmensch sieht dich mit versteinerter Miene an. "Hast du dich verlaufen?"{#dustfem_s51_1}'
...
label dustfem_s52: # from 51.0
    nr 'Der Staubmensch starrt dich einen Moment lang an und nickt dann. "Nun denn. Sag mir bescheid, wenn du Hilfe brauchst."{#dustfem_s52_1}'
