...
label morte2_s0: # - # IF WEIGHT #0 ~  Global("Mortuary_Walkthrough","GLOBAL",1) InParty("Morte")
    nr '"Pssst… „n guter Ratschlag, Meister: Ich würd“ mich ab jetzt zurückhalten - du mußt ja nicht mehr Leichen ins Totenbuch stecken als unbedingt notwendig… besonders die Ladies. Außerdem könnte es die Verwalter hier auf den Plan bringen, wenn du sie umbringst."{#morte2_s0_1}'
...
label morte2_s1: # from 0.0 3.0 7.0
    nr '"Sie nennen sich selbst die „Staubmenschen“. Sie sind gar nicht zu übersehen: Sie stehen auf Schwarz und totenstarre Gesichter. Sie sind eine räudige Bande ghulischer Todesanbeter, die glauben, daß jeder sterben sollte… je früher, desto besser."{#morte2_s1_1}'
...
label morte2_s2: # from 1.0
    nr '"Hast du nicht zugehört?! Ich sagte, daß die Staubies glauben, daß JEDER sterben muß, je früher, desto besser. Glaubst du, daß die Leichen, die du gesehen hast, sich im Totenbuch besser fühlen als außerhalb des Buchs?"{#morte2_s2_1}'
...
label morte2_s3: # from 0.1 2.0 7.1
    nr '"Der Tod sucht die Ebenen jeden Tag heim, Meister. Diese watschelnden Gerüste hier sind alles, was von den armen Schluckern übriggeblieben ist, die ihre Leichen nach ihrem Tod an die Verwalter verkauft haben."{#morte2_s3_1}'
...
label morte2_s4: # from 0.2 2.1 3.1
    nr '"Wa… im *Ernst*? Hör zu, Meister, diese toten Dinger sind die letzte Chance für ein paar hartgesottene Typen wie uns. Wir müssen *nett* sein… und nicht wegen ein paar Schlüsseln Kleinholz aus ihnen machen, ihnen die Gliedmaßen abhacken oder etwas Ähnliches tun."{#morte2_s4_1}'
...
label morte2_s5: # from 4.0
    nr '"Meister, SIE sind tot, WIR sind tot… verstehst du, worauf ich hinaus will? Nun?"{#morte2_s5_1}'
...
label morte2_s6: # from 5.0 5.1
    nr '"Meister, wir haben bereits etwas mit diesen hinkenden Damen gemein. Wir sind *alle* mindestens einmal gestorben: da haben wir doch schon Gesprächsstoff. Sie schätzen Männer mit dieser Art von Erfahrung."{#morte2_s6_1}'
...
label morte2_s8: # from 0.3 2.2 3.2 7.2 12.7 13.2 14.2 15.2 16.2 17.1 18.1 19.2 20.1 21.1 22.1
    nr '"Sieh mal, Meister. Offensichtlich bist du nach deinem Kuss mit dem Tod immer noch etwas verwirrt, sodass ich dir zwei kleine Ratschläge erteilen will: Erstens, wenn du Fragen hast, *fragst* du mich, in Ordnung?"  ^NHINWEIS: <SPEAKTO>^-{#morte2_s8_1}'
...
label morte2_s9: # from 8.0
    nr '"Zweitens, wenn du nur *halb* so vergeßlich bist, wie du den Eindruck machst, fang lieber an, dir Notizen zu machen - immer, wenn dir etwas begegnet, das wichtig sein *könnte*, schreib„s dir auf, damit du es nicht wieder vergißt."{#morte2_s9_1}'
...
label morte2_s10: # from 9.0
    nr '"Dann fang ein neues an, Meister. Ist doch kein Problem. Hier gibt„s genug Pergament und Tinte für dich."{#morte2_s10_1}'
...
label morte2_s12: # from 13.1 14.1 15.1 16.1 17.0 18.0 19.1 20.0 21.0 22.0 23.1 24.2 25.1 26.0 # IF WEIGHT #1 ~  !Global("Mortuary_Walkthrough","GLOBAL",0) !Global("Mortuary_Walkthrough","GLOBAL",1) !Global("Mortuary_Walkthrough","GLOBAL",3) InParty("Morte")
    nr '"Was nagt an dir, Meister?"{#morte2_s12_1}'
...
label morte2_s13: # from 12.0
    nr '"Ah, nun *komm* schon, Meister. Erzähl„ mir nicht, daß du es schon vergessen hast."{#morte2_s13_1}'
...
label morte2_s16: # from 15.0
    nr '"Nein… du warst nackt bis auf die Haut. Wie ich bereits gesagt habe, sieht so aus, als ob genug von einem Journal direkt auf deinen Körper geschrieben ist."{#morte2_s16_1}'
...
label morte2_s17: # from 16.0
    nr '"Nö. Trotzdem, irgendein Dussel muß ja wissen, wo man ihn finden kann. Fragen wir doch einfach rum… NACHDEM wir hier raus sind."{#morte2_s17_1}'
...
label morte2_s18: # from 12.1
    nr '"Man nennt diesen Ort die „Leichenhalle“… Es ist ein großer schwarzer Bau mit dem architektonischen Charme einer schwangeren Spinne."{#morte2_s18_1}'
...
label morte2_s19: # from 12.2 12.3
    nr '"Sie nennen sich selbst die „Staubmenschen“. Sie sind gar nicht zu übersehen: Sie stehen auf Schwarz und totenstarre Gesichter. Sie sind eine räudige Bande ghulischer Todesanbeter, die glauben, daß jeder sterben sollte… je früher, desto besser."{#morte2_s19_1}'
...
label morte2_s20: # from 19.0
    nr '"Hast du nicht zugehört?! Ich sagte, daß die Staubies glauben, daß JEDER sterben muß, je früher, desto besser. Glaubst du, daß die Leichen, die du gesehen hast, sich im Totenbuch besser fühlen als außerhalb des Buchs?"{#morte2_s20_1}'
...
label morte2_s21: # from 12.6
    nr '"Nun, du… du *benutzt* sie. Blutung stillen, und so."  ^NHINWEIS: <BANDAGES2>^-{#morte2_s21_1}'
...
label morte2_s22: # from 12.4
    nr '"Der Tod sucht die Ebenen jeden Tag heim, Meister. Diese watschelnden Gerüste hier sind alles, was von den armen Schluckern übriggeblieben ist, die ihre Leichen nach ihrem Tod an die Verwalter verkauft haben."{#morte2_s22_1}'
...
label morte2_s23: # from 12.5
    nr '"Wa… im *Ernst*? Hör zu, Meister, diese toten Dinger sind die letzte Chance für ein paar hartgesottene Typen wie uns. Wir müssen *nett* sein… und nicht wegen ein paar Schlüsseln Kleinholz aus ihnen machen, ihnen die Gliedmaßen abhacken oder etwas Ähnliches tun."{#morte2_s23_1}'
...
label morte2_s24: # from 23.0
    nr '"Meister, SIE sind tot, WIR sind tot… verstehst du, worauf ich hinaus will? Nun?"{#morte2_s24_1}'
...
label morte2_s25: # from 24.0 24.1
    nr '"Meister, wir haben bereits etwas mit diesen hinkenden Damen gemein. Wir sind *alle* mindestens einmal gestorben: da haben wir doch schon Gesprächsstoff. Sie schätzen Männer mit dieser Art von Erfahrung."{#morte2_s25_1}'
...
label morte2_s26: # from 25.0
    nr '"Tja… okay, *du* bist vielleicht nicht tot, aber *ich* bin„s. Und ich für meinen Teil hätte nichts dagegen, einen Sarg mit einem dieser sehnigen Kadaver hier zu teilen." Morte fängt an, in freudiger Erwartung mit den Zähnen zu klappern. "Natürlich müßten die Verwalter sich erst von ihnen trennen, und das ist ziemlich unwahrscheinlich…"{#morte2_s26_1}'
...
label morte2_s27: # - # IF WEIGHT #3 /* Triggers after states #: 31 even though they appear after this state */ ~  !InParty("Morte")
    nr '"Ich wußte doch, daß du zurückkommst, Meister! Hast wohl endlich eingesehen, daß du mich brauchst, was?"{#morte2_s27_1}'
...
label morte2_s28: # from 27.1
    nr '"Hmmm. Na, ich werde hier nicht ewig warten. Also werde ich dir noch eine LETZTE Chance geben. Bist du sicher, daß du meine weisen Ratschläge und meinen scharfen Verstand nicht brauchst?"{#morte2_s28_1}'
...
label morte2_s29: # from 28.0 28.2
    nr '"Willst du mich beleidigen, Meister? Habe ich was Falsches gesagt? Liegt es daran, daß ich keine Arme habe? Nun sag„s mir schon!"{#morte2_s29_1}'
...
label morte2_s30: # from 29.1
    nr '"Also, ich werde hier nicht EWIG warten. Solltest du dir„s doch noch anders überlegen, dann mußt du dich beeilen."{#morte2_s30_1}'
...
label morte2_s31: # - # IF WEIGHT #2 ~  Global("Mortuary_Walkthrough","GLOBAL",3) InParty("Morte")
    nr '"Du Heiligster. Das ist ein HÖLLISCHES Buch."{#morte2_s31_1}'
...
label morte2_s32: # from 31.0
    nr '"Wenn ich raten müßte, würde ich sagen, das ist das Buch, in das sie die Namen jedes armen Schluckers ritzen, der das Pech hat, hier abgeladen zu werden."{#morte2_s32_1}'
...
label morte2_s33: # from 32.0
    nr '"Äh… tja… *könnte* sein. Um das herauszufinden, mußt du deine Knochenschüssel mit dem schwebenden Staubie da drüben rasseln lassen. Ich bin aber nicht sicher, ob das so ne gute Idee ist."{#morte2_s33_1}'
