class SoegoLogic:
    ...
    def j63982_s1_r1438_action(self):
        ...
        #$% .register('63982', 'Ich habe am Eingangstor zur Leichenhalle einen Staubmenschen namens Soego getroffen... Er sieht müde aus, als ob er schon seit Wochen nicht mehr geschlafen hätte. Seinen Augen und der Blässe seiner Haut nach zu urteilen scheint er sich irgendeine Krankheit eingefangen zu haben.') %$#
    ...
    def j21805_s71_r21800_action(self):
        ...
        #$% .register('21805', 'Soego hat mir gesagt, ich solle nicht die Untoten in den Toten Landen angreifen, da er sie überzeugt hat, mir keinen Schaden zuzufügen, solange ich friedlich bleibe.') %$#
    ...
    def r21852_action(self):
        ...
        #$%.register('21856', 'Ich habe Soego gefunden. Er war Lycanthropy infiziert, und das hatte ihn in die Katakomben getrieben. Er war nicht mehr er selbst, und sein Staubmenschen-Glaube hatte ihn verlassen. %$#')
    ...
    def r21853_action(self):
        ...
        #$%.register('21857', 'Soego hat mir gesagt, daß er nicht weiß, wie man in den Thronsaal des Schweigenden Königs gelangt. Ich muß mir dort jedoch Zugang verschaffen, wenn ich den Schweigenden König töten soll. %$#')
    ...
    def r21915_action(self):
        ...
        #$%.register('21926', 'Ich habe Soego mit dem Inhalt seines Journals konfrontiert, und er hat sich in eine Wer-Ratte verwandelt und mich angegriffen. %$#')
    ...
    def j25254_s94_r25248_action(self):
        ...
        #$% .register('25254', 'Ich habe Soego erzählt, daß der Schweigende König nichts als eine verschrumpelte Leiche sei. Er sagte, das solle ich Viele-als-Einer erzählen, er würde mich dafür belohnen. Viele-als-Einer ist das Gehirn des Stocks der Schädelratten im Gedankenlabyrinth, westlich der Katakomben der Weinenden Steine.') %$#
    ...
    def j21996_s94_r21994_action(self):
        ...
        #$% .register('21996', 'Ich habe Soego erzählt, daß der Schweigende König nur eine verschrumpelte Leiche ist. Ich muß Viele-als-Einer selbst informieren, sobald sich eine Gelegenheit ergibt.') %$#
    ...
    def r22051_action(self):
        ...
        #$%.register('22052', 'Ich habe Soego gefunden. Er hat eine Gruppe untoter Wächter gefunden, die die Katakomben bewachten. Er versucht sie zu überzeugen, zum Wahren Tod überzuwechseln. %$#')
