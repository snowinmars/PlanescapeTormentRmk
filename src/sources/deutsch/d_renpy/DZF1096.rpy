...
label zf1096_s0: # - # IF ~  True()
    ...
    menu:
        ...
        '"Äh… Netter Zopf."{#zf1096_s0_r35100}' if zf1096Logic.r35100_condition():
            # a1 # r35100
            jump zf1096_s1

        '"Ich weiß, daß du kein Zombie bist, verstehst du. Du führst hier keinen an der Nase herum."{#zf1096_s0_r35101}' if zf1096Logic.r35101_condition():
            # a2 # r35101
            jump zf1096_s1

        'Wende deine Erzählende-Knochen-Fähigkeit auf die Leiche an.{#zf1096_s0_r35102}' if zf1096Logic.r35102_condition():
            # a3 # r35102
            jump zf1096_s2

        '"Es war nett, sich mit dir zu unterhalten. Leb wohl."{#zf1096_s0_r35107}' if zf1096Logic.r35107_condition():
            # a4 # r35107
            jump morte_s342  # EXTERN

        'Laß die Leiche in Ruhe.{#zf1096_s0_r35108}' if zf1096Logic.r35108_condition():
            # a5 # r35108
            jump morte_s342  # EXTERN

        'Danke für die anregende Unterhaltung. Leb wohl.{#zf1096_s0_r35109}' if zf1096Logic.r35109_condition():
            # a6 # r35109
            jump zf1096_dispose

        'Laß die Leiche in Ruhe.{#zf1096_s0_r35110}' if zf1096Logic.r35110_condition():
            # a7 # r35110
            jump zf1096_dispose

        'Es war nett, sich mit dir zu unterhalten. Leb wohl.{#zf1096_s0_r35111}' if zf1096Logic.r35111_condition():
            # a8 # r35111
            jump zf1096_dispose

        'Laß die Leiche in Ruhe.{#zf1096_s0_r35112}' if zf1096Logic.r35112_condition():
            # a9 # r35112
            jump zf1096_dispose
...
label zf1096_s1: # from 0.0 0.1 0.2
    ...
    menu:
        ...
        '"Na dann leb wohl."{#zf1096_s1_r35098}' if zf1096Logic.r35098_condition():
            # a11 # r35098
            jump zf1096_dispose

        '"Na dann leb wohl."{#zf1096_s1_r35099}' if zf1096Logic.r35099_condition():
            # a12 # r35099
            jump zf1096_dispose
...
label zf1096_s2: # from 0.3
    ...
    menu:
        ...
        '"Dann leb wohl."{#zf1096_s2_r35105}' if zf1096Logic.r35105_condition():
            # a14 # r35105
            jump zf1096_dispose

        '"Dann leb wohl."{#zf1096_s2_r35106}' if zf1096Logic.r35106_condition():
            # a15 # r35106
            jump zf1096_dispose
