...
label zm1201_s0: # - # IF ~  Global("1201_Note_Retrieved","GLOBAL",0)
    ...
    menu:
        ...
        '"Ich weiß, daß du kein Zombie bist, verstehst du. Du führst hier keinen an der Nase herum."{#zm1201_s0_r34957}' if zm1201Logic.r34957_condition():
            # a1 # r34957
            jump zm1201_s3

        'Wende deine Erzählende-Knochen-Fähigkeit auf die Leiche an.{#zm1201_s0_r34958}' if zm1201Logic.r34958_condition():
            # a2 # r34958
            jump zm1201_s4

        '"Es war nett, mit dir gesprochen zu haben. Leb wohl."{#zm1201_s0_r34959}':
            # a3 # r34959
            jump zm1201_dispose

        'Laß die Leiche in Ruhe.{#zm1201_s0_r34962}':
            # a4 # r34962
            jump zm1201_dispose
...
label zm1201_s1: # from 0.0
    ...
    menu:
        ...
        '"Hmmm. Es muß doch irgendwas geben, um diese Fäden zu durchtrennen…"{#zm1201_s1_r45122}' if zm1201Logic.r45122_condition():
            # a6 # r45122
            jump zm1201_dispose
...
label zm1201_s2: # from 1.0
    ...
    menu:
        ...
        'Laß die Leiche in Ruhe.{#zm1201_s2_r45123}':
            # a8 # r45123
            jump zm1201_dispose
...
label zm1201_s5: # from 2.0 # IF ~  Global("1201_Note_Retrieved","GLOBAL",1)
    ...
    menu:
        ...
        '"Tut mir leid, wenn ich an dir rumschnipple.Wollt nur mal sehn, was du im Mund hast."{#zm1201_s5_r45130}' if zm1201Logic.r45130_condition():
            # a12 # r45130
            jump zm1201_s3

        '"Ich weiß, daß du kein Zombie bist, verstehst du. Du führst hier keinen an der Nase herum."{#zm1201_s5_r45131}' if zm1201Logic.r45131_condition():
            # a13 # r45131
            jump zm1201_s3

        'Wende deine Erzählende-Knochen-Fähigkeit auf die Leiche an.{#zm1201_s5_r45132}' if zm1201Logic.r45132_condition():
            # a14 # r45132
            jump zm1201_s4

        '"Es war nett, mit dir gesprochen zu haben. Leb wohl."{#zm1201_s5_r45133}':
            # a15 # r45133
            jump zm1201_dispose

        'Laß die Leiche in Ruhe.{#zm1201_s5_r45134}':
            # a16 # r45134
            jump zm1201_dispose
