...
label zm1445_s0: # - # IF ~  True()
    nr 'Die Haut dieser Leiche ist mit Pocken übersät. Ihre Ohren, die Nasenspitze und Teile ihrer Finger sind abgefault… Der Mann mußt einer entsetzlichen Krankheit zum Opfer gefallen sein. Auf seiner Stirn ist die Nummer "1445" eintätowiert, und seine Lippen sind fest zusammengenäht.{#zm1445_s0_}'
...
label zm1445_s1: # from 0.0 0.1 0.2
    nr 'Die Leiche starrt dich weiter an.{#zm1445_s1_}'
...
label zm1445_s2: # from 0.3
    nr 'Die Leiche gibt keine Antwort. Es scheint, als wäre sie zu weit im Jenseits, um deine Fragen zu beantworten.{#zm1445_s2_}'
