...
label zm199_s0: # - # IF ~  True()
    ...
    menu:
        '"Na… gibt„s hier irgendwas Interessantes zu berichten?"' if zm199Logic.r34976_condition():
            # a0 # r34976
            $ zm199Logic.r34976_action()
            jump zm199_s1

        '"Na… irgendwas Interessantes passiert?"' if zm199Logic.r34979_condition():
            # a1 # r34979
            jump zm199_s1

        '"Ich weiß, daß du kein Zombie bist, verstehst du. Du führst hier keinen an der Nase herum."' if zm199Logic.r34980_condition():
            # a2 # r34980
            jump zm199_s1

        'Wende deine Erzählende-Knochen-Fähigkeit auf die Leiche an.' if zm199Logic.r34981_condition():
            # a3 # r34981
            jump zm199_s2
