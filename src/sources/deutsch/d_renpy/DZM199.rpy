...
label zm199_s1: # from 0.0 0.1 0.2
    nr 'Die Leiche starrt dich weiter an.{#zm199_s1_1}'
...
label zm199_s2: # from 0.3
    nr 'Die Leiche reagiert nicht. Sie scheint schon zu weit hinüber zu sein, um irgendeine deiner Fragen beantworten zu können..{#zm199_s2_1}'
