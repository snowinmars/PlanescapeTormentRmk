...
label zm310_s0: # - # IF ~  Global("Oinosian","GLOBAL",0)
    nr 'Dieser wiederbelebten Leiche wurden die Lippen zugenäht und die Nummer "310" in die Stirn geritzt. Der Geruch von Formaldehyd umgibt sie. Die Leiche richtet ihre leblosen Augen auf dich, als du dich ihr in den Weg stellst.{#zm310_s0_1}'
...
label zm310_s1: # from 0.0 0.1 0.2
    nr 'Die Leiche starrt dich weiter an.{#zm310_s1_1}'
...
label zm310_s2: # from 0.3
    nr 'Einen Moment lang glaubst du, daß diese Leiche zu weit hinüber ist, um dir antworten zu können… aber plötzlich erkennst du, daß sich wahrhaftiges Leid in ihre Gesichtszüge gegraben hat und du spürst, daß sich dahinter eine so tiefe Verzweiflung verbirgt, daß der Geist wieder in seine alte, körperliche Hülle zurückkehren mußte.{#zm310_s2_1}'
...
label zm310_s3: # from 2.0 4.2 5.2 6.2 7.2 8.1 9.0 10.0 11.2 12.1 13.1 14.1 15.1 16.0 18.0
    nr 'Er spricht mit der langsamen, monotonen Stimme eines gebrochenen, hoffnungslosen Mannes. Selbst jetzt unterscheidet er sich kaum von einem seelenlosen Zombie. "Was möchtet Ihr wissen, mein Herr?"{#zm310_s3_1}'
...
label zm310_s5: # from 3.1
    nr '"Ich lebte in Sigil, mein Herr. Im Stock. Der Ort erscheint mir gar nicht mehr so schrecklich, wie ich einst glaubte, jetzt wo ich in… Oinos lebe." Die Leiche blinzelt so langsam, daß du kurz dachtest, sie würde einfach die Augen schließen.{#zm310_s5_1}'
...
label zm310_s7: # from 3.3 4.1 5.1 8.0 12.0
    nr 'Als der Geist kurz die Augen schließt, geht ein leichtes Schaudern durch seine Hülle. "Im schrecklichen Oinos, mein Herr. In der Grauen Einöde. Dorthin wurde meine Seele verbannt, in den Schatten von Khin-Oin, dem Turm der Einöde."{#zm310_s7_1}'
...
label zm310_s8: # from 3.4
    nr '"Es gibt keinen Ausweg für mich, mein Herr. Ich bin auf alle Ewigkeit in der schrecklichen Einöde von Oinos gefangen. Für jemanden wie mich gibt es keine Hoffnung." Der Geist bietet immer mehr ein Bild des Jammers. Die Schultern seiner Hülle sinken unter der Last seines Leids zusammen.{#zm310_s8_1}'
...
label zm310_s9: # from 3.5 15.0
    nr '"So gut wie nichts, mein Herr. Ich weiß nur, daß man die Toten hierher bringt, um sie zu begraben oder zu verbrennen… oder um sie als Arbeiter zu verwenden, wie in meinem Fall."{#zm310_s9_1}'
...
label zm310_s10: # from 3.6
    nr 'Der Geist schüttelt langsam den Kopf von einer Seite zur anderen. "Nein, mein Herr. Ich kenne niemanden, der so heißt. Tut mir leid."{#zm310_s10_1}'
...
label zm310_s11: # from 7.0
    nr '"Da gibt es nicht viel zu sagen. Es ist das Land meines Meisters, des Herrn von Khin-Oin… eines Ortes voller Sorgen und Seuchen, wo Körper und Geist gleichermaßen verwesen, und wo nichts als Trostlosigkeit herrscht."{#zm310_s11_1}'
...
label zm310_s12: # from 5.0
    nr '"Ja, mein Herr. Ein elender Ort, aber nicht so schrecklich wie Oinos."{#zm310_s12_1}'
...
label zm310_s14: # from 11.0 13.0
    nr '"Ich kenne ihn nur als den Meister, den Herrn von Khin-Oin. Er ist ein übler Fürst - ein Ausbund an furcherregender Macht. Er besitzt meine Seele und wird sie immer besitzen und so lang mit Füßen treten, bis die Ewigkeit der Vergessenheit weicht."{#zm310_s14_1}'
...
label zm310_s15: # from 6.1
    nr '"Ja, mein Herr, ein Sammler. Einer von denen, die die Toten Sigils von den Straßen auflesen, und sie für eine Handvoll Geld an die Leichenhalle verkaufen, in der wir jetzt stehen." Der Geist hält kurz inne und blickt um sich, dann seufzt er leise.{#zm310_s15_1}'
...
label zm310_s16: # from 6.0
    nr '"Darüber will ich nicht sprechen, mein Herr. Es lohnt sich nicht." Der Geist scheint sich nicht erweichen zu lassen.{#zm310_s16_1}'
...
label zm310_s17: # from 2.1 3.7 4.3 5.3 6.3 7.3 8.2 9.1 10.1 11.3 12.2 13.2 14.2 15.2 16.1
    nr 'Erst als der Zombie sich wieder an die Arbeit macht, merkst du, daß der Geist den Körper verlassen hat.{#zm310_s17_1}'
...
label zm310_s18: # - # IF ~  Global("Oinosian","GLOBAL",1)
    nr 'Die Leiche scheint zu schrumpfen, sie beugt sich unter dem Gewicht der Verzweiflung des Geistes.{#zm310_s18_1}'
