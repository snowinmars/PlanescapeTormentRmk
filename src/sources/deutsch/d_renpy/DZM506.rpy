...
label zm506_s0: # from 3.2 # IF ~  Global("506_Thread","GLOBAL",0)
    nr 'Diese an allen Enden zusammengeflickte Leiche schlurft träge hin und her. Auf ihrer Stirn… und seitlich am Hals… und auf dem rechten Arm… ist die Zahl "506" eingenäht. Die Haut dieser zerfallenden Leiche ist mit so vielen Stichen bedeckt, daß sie wie eine bizarre Landkarte aussieht.{#zm506_s0_}'
...
label zm506_s1: # from 0.1 4.0 4.1 5.0 5.1 5.2
    nr 'Die Leiche starrt mit leerem Blick geradeaus.{#zm506_s1_}'
...
label zm506_s2: # from 0.2 5.3
    nr 'Die Leiche rührt sich nicht. Sie sieht so aus, als sei sie schon ein bißchen zu weit hinüber, um deine Fragen zu beantworten.{#zm506_s2_}'
...
label zm506_s4: # from 3.0
    nr 'Du durchtrennst den Faden sauber mit dem Skalpell. Dann ziehst du die Nadel heraus und ziehst die Stiche auf. Die Haut löst sich von der Stirn ab und gibt den Blick auf den kreideweißen Schädel der Leiche frei. Darauf ist zu deinem Erstaunen die Zahl "78" eingemeißelt.{#zm506_s4_}'
...
label zm506_s5: # from 4.2 # IF ~  Global("506_Thread","GLOBAL",1)
    nr 'Diese an allen Ende zusammengeflickte Leiche schlurft träge zwischen zwei Totenbänken hin und her. Obwohl fast über den ganzen Körper verteilt die Zahl "506" aufgenäht wurde, ist die Haut der Stirn abgeblättert und gibt den Blick auf die - direkt in den Knochen eingemeißelte - Zahl "78" frei.{#zm506_s5_}'
