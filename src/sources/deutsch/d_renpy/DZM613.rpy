...
label zm613_s0: # - # IF ~  True()
    nr 'Die Zahl "613" ist tief in die Stirn dieser schwerfälligen Leiche geschnitten, wobei etwa 2 cm zerfetzter, ledriger Haut die "1" von der "3" trennt. Als du genauer hinsiehst, kannst du dort eben noch eine "2" erkennen.{#zm613_s0_}'
...
label zm613_s1: # from 0.0 0.1 0.2
    nr 'Die Leiche starrt dich weiter an.{#zm613_s1_}'
...
label zm613_s2: # from 0.3
    nr 'Die Leiche antwortet nicht. Es sieht so aus, als ob sie schon zu tot ist, um noch auf irgendeine deiner Fragen zu antworten.{#zm613_s2_}'
