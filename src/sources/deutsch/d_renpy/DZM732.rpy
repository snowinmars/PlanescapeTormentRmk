...
label zm732_s0: # from 4.0 # IF ~  !HasItem("TomeBA","ZM732")
    nr 'Dieser tatterigen Leiche wurden die Augen und der Mund zugenäht, und die Zahl "732" ist in ihre Augenbraue geritzt. Die Fäden, die ihre Augenhöhlen zugenäht halten, sehen extrem alt aus… Du fragst dich, ob ihre Augen vor oder nach dem Tod des Mannes zugenäht wurden.{#zm732_s0_}'
...
label zm732_s1: # from 0.0 0.1 0.2
    nr 'Die Leiche starrt dich weiter an.{#zm732_s1_}'
...
label zm732_s2: # from 0.3
    nr 'Die Leiche antwortet nicht. Es sieht so aus, als ob sie schon zu tot ist, um noch auf irgendeine deiner Fragen zu antworten.{#zm732_s2_}'
