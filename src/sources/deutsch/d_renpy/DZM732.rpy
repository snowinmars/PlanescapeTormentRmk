...
label zm732_s0: # from 4.0 # IF ~  !HasItem("TomeBA","ZM732")
    nr 'Dieser tatterigen Leiche wurden die Augen und der Mund zugenäht, und die Zahl "732" ist in ihre Augenbraue geritzt. Die Fäden, die ihre Augenhöhlen zugenäht halten, sehen extrem alt aus… Du fragst dich, ob ihre Augen vor oder nach dem Tod des Mannes zugenäht wurden.'

    menu:
        '"Tut mir leid, daß ich dir das Buch weggenommen habe… Es sah einfach zu interessant aus."' if zm732Logic.r6533_condition():
            # a0 # r6533
            $ zm732Logic.r6533_action()
            jump zm732_s1

        '"Tut mir leid, daß ich dir das Buch weggenommen habe… Es sah einfach zu interessant aus."' if zm732Logic.r6532_condition():
            # a1 # r6532
            jump zm732_s1

        '"Ich weiß, daß du kein Zombie bist, verstehst du. Du führst hier keinen an der Nase herum."' if zm732Logic.r6534_condition():
            # a2 # r6534
            jump zm732_s1

        'Wende deine Erzählende-Knochen-Fähigkeit auf die Leiche an.' if zm732Logic.r6535_condition():
            # a3 # r6535
            jump zm732_s2
