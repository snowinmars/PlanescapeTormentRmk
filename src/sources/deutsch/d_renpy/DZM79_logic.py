class Zm79Logic:
    ...
    def j64536_s3_r64279_action(self):
        ...
        #$% .register('64536', 'Ich habe ein seltsames, gezahntes, rundes Symbol auf der Stirn von Zombie Nr. 79 gefunden. Aus irgendeinem Grund hatte ich das Gefühl, das Symbol könnte wichtig sein, aber ich weiß nicht warum.') %$#


    def j64537_s3_r64280_action(self):
        self.state_manager.journal_manager.update_journal('64537')
        #$% .register('64537', 'Ich habe ein seltsames, gezahntes, rundes Symbol auf der Stirn von Zombie Nr. 79 gefunden. Der bloße Anblick hat mich an den alten Kupferohrring erinnert, den ich im südöstlichen Vorbereitungsraum gefunden habe - Vielleicht gibt es ja eine Verbindung zwischen den beiden.') %$#
