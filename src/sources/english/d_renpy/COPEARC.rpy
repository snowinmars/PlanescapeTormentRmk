...
label copearc_s0: # - # IF ~  True()
    ...
    menu:
        ...
        'Insert your fingernail into the notch that matches where the triangle was pointing in the fanged circle you saw on zombie #79„s forehead.{#copearc_s0_r46725}' if copearcLogic.r46725_condition():
            # a1 # r46725
            $ copearcLogic.r46725_action()
            jump copearc_s2

        'Put the earring away.{#copearc_s0_r46726}':
            # a2 # r46726
...
label copearc_s1: # from 0.0
    ...
    menu:
        ...
        'Put the earring away.{#copearc_s1_r46729}':
            # a4 # r46729
            jump copearc_dispose
