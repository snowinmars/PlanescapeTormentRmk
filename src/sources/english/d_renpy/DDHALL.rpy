...
label dhall_s0: # externs morte_s103
    nr 'Before Morte can finish his rant, the scribe begins coughing violently. After a moment or two, the coughing spell dies down, and the scribe„s breathing resumes its ragged wheeze.{#dhall_s0_}'
...
label dhall_s1: # externs morte_s104
    nr 'Before Morte can finish, the scribe„s gray eyes flicker to you. "The weight of years hangs heavy upon me, Restless One." He places down his quill. "…but I do not yet count deafness among my ailments."{#dhall_s1_}'
...
label dhall_s2: # from 21.0
    nr '"Do you not know the woman„s corpse interred in the memorial hall below? I had thought that she had traveled with you in the past…" Dhall looks like he is about to start coughing again, then catches his breath. "Am I mistaken?"{#dhall_s2_}'
...
label dhall_s3: # from 9.0
    nr 'Dhall stares at you. "Are you certain?"{#dhall_s3_}'
...
label dhall_s4: # from 3.0 3.1
    nr '"I…" Dhall breaks into another fit of coughing. After a minute or two, he catches his breath enough to speak. "I… shall inform the guards at once."{#dhall_s4_}'
...
label dhall_s5: # - # IF ~  Global("Dhall","GLOBAL",0)
    nr 'This scribe looks very old… his skin is wrinkled and has a slight trace of yellow, like old parchment. Charcoal-gray eyes lie within an angular face, and a large white beard flows down the front of his robes like a waterfall. His breathing is ragged and irregular, but even his occasional coughing does not slow the scratching of his quill pen.{#dhall_s5_}'
...
label dhall_s6: # from 5.2
    nr 'The figure„s gray eyes flicker as he glances up from his book. "I suspected it might be you who was responsible for the attacks in the Mortuary. This…" He coughs slightly, then draws a ragged breath. "This is no way for you to enter the next life."{#dhall_s6_}'
...
label dhall_s7: # from 5.1
    nr 'The scribe stops scratching in the book before him, then looks up. His eyes are like two nails driven into his skull. "So…" He sounds tired, as if he has repeated the same thing many times before. "You have awoken from your sleep and returned to your dream." He continues more respectfully. "Well met… again, Restless One."{#dhall_s7_}'
...
label dhall_s8: # from 22.0
    nr '"You must understand. Your existence is a blasphemy to them. Many of our faction would order you cremated… if they were aware of your affliction."{#dhall_s8_}'
...
label dhall_s9: # from 2.5 3.2 4.0 6.0 6.1 8.2 10.5 12.1 13.0 14.4 15.2 16.3 17.3 18.2 19.2 20.2 21.1 22.2 23.2 24.1 25.2 26.2 27.0 28.1 29.2 30.0 31.1 32.6 33.3 34.2 35.2 36.2 37.1 38.2 39.0 40.0 41.3 42.4 43.3 45.0 47.4 48.2 49.2 51.2 52.2 53.1
    nr '"Very well. What did you wish to know?"{#dhall_s9_}'
...
label dhall_s10: # from 9.1
    nr '"You are in the Mortuary, Restless One. Again you have… come…" Before he can finish, Dhall breaks into a fit of coughing. After a moment, he calms himself and his breathing resumes its ragged wheeze. "…this is the waiting room for those about to depart the shadow of this life."{#dhall_s10_}'
...
label dhall_s12: # from 2.3 2.4 42.2 42.3 43.1 43.2
    nr '"Doubtless there are, but I know not their names, nor where they lie. One such as you has left a path many have walked, and few have survived." Dhall gestures around you. "All dead come here. Some must have traveled with you once."{#dhall_s12_}'
...
label dhall_s13: # from 9.3
    nr '"Hmmm… the front gate is the most obvious exit, but they will not let anyone other than Dustmen pass…" Dhall breaks into a ragged cough, then continues. "…one of the guides by the front gate has a key to it, but it is unlikely he will open it for you unless you are extremely persuasive."{#dhall_s13_}'
...
label dhall_s14: # from 10.3
    nr '"Yes, *again.* You have been brought here many times before, Restless One. I had hoped that this time would be your last, considering the wounds you had sustained." He sighs. "When will you give up your passions and leave this shadow of life?"{#dhall_s14_}'
...
label dhall_s15: # from 9.2 10.4 32.5
    nr 'Dhall snorts in contempt, as if he finds the memory repugnant. "Your moldy chariot ferried you to the Mortuary, Restless One. You would think you were royalty based on the number of loyal subjects that lay stinking and festering upon the cart that carried you."{#dhall_s15_}'
...
label dhall_s17: # from 16.0
    nr '"He is a… collector of the dead." Dhall draws a ragged breath, then continues. "We have such people in our city that scavenge the bodies of those that have walked the path of True Death and bring them to us so that they may be interred properly."{#dhall_s17_}'
...
label dhall_s18: # from 17.0 29.1 31.0 35.1 36.1
    nr '"If events persist as they have, Restless One, you have a much greater chance of Pharod finding you and bringing you to us again before you find whatever ooze puddle he wallows in this time."{#dhall_s18_}'
...
label dhall_s19: # from 17.4 18.0 18.3 29.3 31.2
    nr 'A slight warning creeps into Dhall„s tone. "Do not seek out Pharod, Restless One. I am certain that it will simply come full circle again, with you none the wiser and Pharod a few coppers richer. Accept death, Restless One. Do not perpetuate your circle of misery."{#dhall_s19_}'
...
label dhall_s20: # from 19.0
    nr 'Dhall is silent for a moment. When he finally speaks, he seems to do so reluctantly. "I do not know under which gutterstone Pharod lairs at the moment, but I imagine that he can be found somewhere beyond the Mortuary gates, in the Hive. Perhaps someone there will know where you can find him."{#dhall_s20_}'
...
label dhall_s21: # from 9.4
    nr '"I know scant little of you, Restless One. I know little more of those that have journeyed with you and who now lie in our keeping." Dhall sighs. "I ask that you no longer ask others to join with you, Restless One - where you walk, so walks misery. Let your burden be your own."{#dhall_s21_}'
...
label dhall_s22: # from 47.0
    nr 'Dhall sighs. "It is said there are souls who can never attain the True Death. Death has forsaken them, and their names shall never be penned in the dead-book. To awake from death as you have done… suggests you are one of these souls. Your existence is unacceptable to our faction."{#dhall_s22_}'
...
label dhall_s23: # from 8.0
    nr '"Because forcing our beliefs upon you is not just. You must give up this shadow of life on your own, not because we force you to." Dhall looks about to break into another coughing jag, but he manages to hold it in with some effort. "As long as I remain at my post, I will protect your right to search for your own truth."{#dhall_s23_}'
...
label dhall_s24: # from 25.0
    nr '"I am the one that catalogues the shells that come to our halls, Restless One." Dhall breaks into a fit of coughing, then steadies himself. "Only I see the faces of those that lie upon our slabs. The dark of your existence lies safe with me."{#dhall_s24_}'
...
label dhall_s25: # from 9.5 23.0
    nr '"I am a scribe, a cataloger of all the shells that come to the Mortuary." Dhall coughs again, then takes a deep breath. "As long as the stream of corpses flows through the Mortuary, I shall remain at my post."{#dhall_s25_}'
...
label dhall_s26: # from 9.6
    nr '"I am close now to the True Death, Restless One. It will not be long before I pass beyond the Eternal Boundary and find the peace I have been seeking. I tire of this mortal sphere…" Dhall gives a ragged sigh. "The planes hold no more wonders for one such as I."{#dhall_s26_}'
...
label dhall_s27: # from 26.1
    nr '"I do not wish to live forever nor live again, Restless One. I could not bear it."{#dhall_s27_}'
...
label dhall_s28: # from 2.2 42.1
    nr '"She *spoke* to you?" Dhall„s voice drops to a whisper. "Are the *fevers* upon you, Restless One? She has reached the True Death and passed well beyond your reach."{#dhall_s28_}'
...
label dhall_s29: # from 36.0
    nr 'Dhall pauses, considering. "Most likely. Are you missing anything… especially anything of value?" His voice dips as he frowns. "Not that Pharod would take exception to anything that wasn„t physically grafted to your body, and sometimes even that“s not enough to give his greedy mind pause."{#dhall_s29_}'
...
label dhall_s30: # from 28.0
    nr 'Dhall draws a semicircle in the air front of him with a finger. "This is an ill omen, Restless One. I pray you dreamed the conversation… yet I fear you did not."{#dhall_s30_}'
...
label dhall_s31: # from 29.0
    nr '"A journal? If it was of any value, then it is likely it lies in Pharod„s hands."{#dhall_s31_}'
...
label dhall_s33: # from 10.2 14.2 32.0 41.0 47.2 49.0
    nr '"Yes, a shadow. You see, Restless One, this life… it is not real. Your life, my life, they are shadows, flickerings of what life once was. This „life“ is where we end up *after* we die. And here we remain… trapped. Caged. Until we can achieve the True Death."{#dhall_s33_}'
...
label dhall_s34: # from 14.1 32.4
    nr '"Yes, the wounds that decorate your body… they look as if they would have sent a lesser man along the path of the True Death, yet it seems as if many of them have healed already." Dhall coughs violently for a moment, then steadies himself. "But those are only the surface wounds."{#dhall_s34_}'
...
label dhall_s35: # from 16.1 17.1 20.0
    nr '"There are some I respect, Restless One." Dhall takes a ragged breath and steadies himself. "Pharod is not one of them. He wears his ill repute like a badge of honor and takes liberties with the possessions of the dead. He is a knight of the post, cross-trading filth of the lowest sort."{#dhall_s35_}'
...
label dhall_s36: # from 35.0
    nr '"A knight of the post…" Dhall coughs. "…a thief. All Pharod brings to our walls come stripped of a little less of their dignity than they possessed in life. Pharod takes whatever he may pry from their stiffening fingers."{#dhall_s36_}'
...
label dhall_s37: # from 32.3
    nr '"Sigil is our fair city, Restless One."{#dhall_s37_}'
...
label dhall_s38: # from 10.1 14.0
    nr '"Restless is as good a term as any…" Dhall draws a ragged breath. "Something keeps you here, does it not? Something that must be resolved, some passion that must be quenched before you can reach the True Death?"{#dhall_s38_}'
...
label dhall_s40: # - # IF ~  Global("Dhall","GLOBAL",1)
    nr 'Dhall glances up as you approach. "So. You have returned…" Dhall takes a rasping breath, then breaks into a violent coughing spell. After a moment, it subsides, and he returns to his raspy breathing. "… greetings again, Restless One."{#dhall_s40_}'
...
label dhall_s41: # from 26.0 52.0
    nr '"The boundary between the shadow of this life and the True Death."{#dhall_s41_}'
...
label dhall_s42: # from 2.0 12.0 43.0
    nr '"The northwest memorial hall on the floor below us. Check the biers there… her name should be on one of the memorial plaques. Mayhap that will revive your memory."{#dhall_s42_}'
...
label dhall_s43: # from 2.1 42.0
    nr 'Dhall makes no response to this. He simply stares at you in silence.{#dhall_s43_}'
...
label dhall_s44: # from 1.0 6.2 7.0
    nr '"Know you? I…" There is a trace of bitterness in the scribe„s voice as he speaks. "I have *never* known you, Restless One. No more than you have known yourself." He is silent for a moment. "For you have forgotten, have you not?"{#dhall_s44_}'
...
label dhall_s45: # from 44.0
    nr '"As always, the question. And the wrong question, as always." He bows slightly, but the movement suddenly sends him into a bout of coughing. "I…" He pauses for a moment, catches his breath. "I… am Dhall."{#dhall_s45_}'
...
label dhall_s46: # from 45.1
    nr '"Very well, Restless One." Dhall nods. "But I fear time is not your enemy in this matter." He picks up his quill again. "When you wish to speak further, I will be here."{#dhall_s46_}'
...
label dhall_s47: # from 32.2
    nr '"We Dustmen are a faction, a gathering of those of us that recognize the illusion of this life. We await the next life, and help others on their journey."{#dhall_s47_}'
...
label dhall_s48: # from 32.1 33.0 38.0 41.1 47.1
    nr '"True Death is non-existence. A state devoid of reason, of sensation, of passion." Dhall coughs, then gives a ragged breath. "A state of purity."{#dhall_s48_}'
...
label dhall_s49: # from 48.0
    nr '"Is it worse than remaining in this shadow of what life once was? I think not."{#dhall_s49_}'
...
label dhall_s50: # from 33.1
    nr '"What makes you think this life *is* real? Look inside yourself. Do you not feel something lacking?" Dhall shakes his head. "This is a purgatory. There is only sorrow here. Misery. Torment. These are not the elements that make up „life.“ They are part of the cage that traps us in this shadow."{#dhall_s50_}'
...
label dhall_s51: # from 50.0 50.1 50.2
    nr 'Dhall shakes his head. "Passions carry weight. They anchor many to this shadow of life. As long as one clings to emotion, they will be continually reborn into this „life,“ forever suffering, never knowing the purity of True Death."{#dhall_s51_}'
...
label dhall_s53: # from 34.0
    nr '"I speak of the wounds of the mind. You have forgotten much, have you not? Mayhap your true wounds run much deeper than the scars that decorate your surface…" Dhall coughs again. "…but that is something that only you would know for certain."{#dhall_s53_}'
