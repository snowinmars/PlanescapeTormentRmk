...
label morte1_s0: # - # IF WEIGHT #1 /* Triggers after states #: 26 even though they appear after this state */ ~  !InParty("Morte") Global("Morte","GLOBAL",0)
    ...
    menu:
        'morte1_s0_r39793{#morte1_s0_r39793}': # '"Wh…? Who are you?"{#morte1_s0_r39793}'
            # a0 # r39793
...
label morte1_s1: # from 0.0
    ...
    menu:
        'morte1_s1_r39796{#morte1_s1_r39796}': # '"I… don„t know. I can“t remember."{#morte1_s1_r39796}'
            # a1 # r39796
            jump morte1_s2

        'morte1_s1_r39797{#morte1_s1_r39797}': # '"I asked *you* first, skull."{#morte1_s1_r39797}'
            # a2 # r39797
            jump morte1_s3
...
label morte1_s2: # from 1.0 3.0 4.0
    ...
    menu:
        'morte1_s2_r39799{#morte1_s2_r39799}': # '"Trapped?"{#morte1_s2_r39799}'
            # a3 # r39799
            jump morte1_s5
...
label morte1_s3: # from 1.1
    ...
    menu:
        'morte1_s3_r39801{#morte1_s3_r39801}': # '"I… don„t know. I can“t remember."{#morte1_s3_r39801}'
            # a4 # r39801
            jump morte1_s2

        'morte1_s3_r39802{#morte1_s3_r39802}': # '"You first, skull. It„s the last time I“ll ask."{#morte1_s3_r39802}'
            # a5 # r39802
            jump morte1_s4
...
label morte1_s4: # from 3.1
    ...
    menu:
        'morte1_s4_r39804{#morte1_s4_r39804}': # '"I… don„t know. I can“t remember."{#morte1_s4_r39804}'
            # a6 # r39804
            jump morte1_s2
...
label morte1_s5: # from 2.0
    ...
    menu:
        'morte1_s5_r39806{#morte1_s5_r39806}': # '"We„re locked in… where? What is this place?"{#morte1_s5_r39806}'
            # a7 # r39806
            jump morte1_s6
...
label morte1_s6: # from 5.0
    ...
    menu:
        'morte1_s6_r39808{#morte1_s6_r39808}': # '"„The Mortuary“? What… am I dead?"{#morte1_s6_r39808}'
            # a8 # r39808
            jump morte1_s7
...
label morte1_s7: # from 6.0
    ...
    menu:
        'morte1_s7_r39810{#morte1_s7_r39810}': # '"Scars? How bad are they?"{#morte1_s7_r39810}'
            # a9 # r39810
            jump morte1_s8
...
label morte1_s8: # from 7.0
    ...
    menu:
        'morte1_s8_r39812{#morte1_s8_r39812}': # '"Tattoos on my back? What do they say?"{#morte1_s8_r39812}'
            # a10 # r39812
            jump morte1_s9
...
label morte1_s9: # from 8.0
    ...
    menu:
        'morte1_s9_r39814{#morte1_s9_r39814}': # '"Pharod…? Does it say anything else?"{#morte1_s9_r39814}'
            # a11 # r39814
            jump morte1_s10
...
label morte1_s10: # from 9.0
    ...
    menu:
        'morte1_s10_r39816{#morte1_s10_r39816}': # '"No wonder my back hurts; there„s a damn novel written there. As for that journal I“m supposed to have with me… was there one with me while I was lying here?"{#morte1_s10_r39816}'
            # a12 # r39816
            jump morte1_s11
...
label morte1_s11: # from 10.0
    ...
    menu:
        'morte1_s11_r39818{#morte1_s11_r39818}': # '"What about Pharod? Do you know him?"{#morte1_s11_r39818}'
            # a13 # r39818
            jump morte1_s12
...
label morte1_s12: # from 11.0
    ...
    menu:
        'morte1_s12_r39820{#morte1_s12_r39820}': # '"How *do* we get out of here?"{#morte1_s12_r39820}'
            # a14 # r39820
            jump morte1_s13
...
label morte1_s13: # from 12.0
    ...
    menu:
        'morte1_s13_r39822{#morte1_s13_r39822}': # '"Walking corpses?"{#morte1_s13_r39822}'
            # a15 # r39822
            jump morte1_s14
...
label morte1_s14: # from 13.0
    ...
    menu:
        'morte1_s14_r39824{#morte1_s14_r39824}': # '"Is there some other way? I don„t want to kill them just for a key."{#morte1_s14_r39824}'
            # a16 # r39824
            $ morte1Logic.r39824_action()
            jump morte1_s15

        'morte1_s14_r39825{#morte1_s14_r39825}': # '"So I should attack one of these corpses and loot it for the key?"{#morte1_s14_r39825}'
            # a17 # r39825
            jump morte1_s16
...
label morte1_s15: # from 14.0
    ...
    menu:
        'morte1_s15_r39827{#morte1_s15_r39827}': # '"Well, all right… I„ll take one of them down and get the key."{#morte1_s15_r39827}'
            # a18 # r39827
            jump morte1_s16
...
label morte1_s16: # from 14.1 15.0
    ...
    menu:
        'morte1_s16_r39829{#morte1_s16_r39829}': # '"All right, I„ll look for one."{#morte1_s16_r39829}'
            # a19 # r39829
            jump morte1_s17
...
label morte1_s17: # from 16.0
    ...
    menu:
        'morte1_s17_r39831{#morte1_s17_r39831}': # '"All right. Thanks for the advice."{#morte1_s17_r39831}'
            # a20 # r39831
...
label morte1_s18: # - # IF WEIGHT #2 /* Triggers after states #: 26 even though they appear after this state */ ~  Global("Mortuary_Walkthrough","GLOBAL",0) !PartyHasItem("Scalpel") Global("ZM782_Dead_KAPUTZ","GLOBAL",0)
    ...
    menu:
        'morte1_s18_r39833{#morte1_s18_r39833}': # '"All right… I„ll keep searching."{#morte1_s18_r39833}'
            # a21 # r39833
            jump morte1_dispose
...
label morte1_s19: # - # IF WEIGHT #3 /* Triggers after states #: 26 even though they appear after this state */ ~  Global("Mortuary_Walkthrough","GLOBAL",0) PartyHasItem("Scalpel") Global("ZM782_Dead_KAPUTZ","GLOBAL",0)
    ...
    menu:
        'morte1_s19_r39835{#morte1_s19_r39835}': # '"Maybe you could *help* me, Morte."{#morte1_s19_r39835}'
            # a22 # r39835
            jump morte1_s20

        'morte1_s19_r39836{#morte1_s19_r39836}': # '"All right."{#morte1_s19_r39836}'
            # a23 # r39836
            jump morte1_s23
...
label morte1_s20: # from 19.0
    ...
    menu:
        'morte1_s20_r39838{#morte1_s20_r39838}': # '"I meant help in attacking the *corpse.*"{#morte1_s20_r39838}'
            # a24 # r39838
            jump morte1_s21

        'morte1_s20_r39839{#morte1_s20_r39839}': # '"All right, then."{#morte1_s20_r39839}'
            # a25 # r39839
            jump morte1_s23
...
label morte1_s21: # from 20.0
    ...
    menu:
        'morte1_s21_r39841{#morte1_s21_r39841}': # '"When I attack this corpse, you better be right there with me or you„ll be the next thing that I plunge this scalpel in."{#morte1_s21_r39841}'
            # a26 # r39841
            jump morte1_s22

        'morte1_s21_r39842{#morte1_s21_r39842}': # '"All right, then."{#morte1_s21_r39842}'
            # a27 # r39842
            jump morte1_s23
...
label morte1_s22: # from 21.0
    ...
    menu:
        'morte1_s22_r39844{#morte1_s22_r39844}': # '"I„m glad we understand each other."{#morte1_s22_r39844}'
            # a28 # r39844
            jump morte1_s23
...
label morte1_s23: # from 19.1 20.1 21.1 22.0
    ...
    menu:
        'morte1_s23_r39846{#morte1_s23_r39846}': # '"Let„s go."{#morte1_s23_r39846}'
            # a29 # r39846
            jump morte1_dispose
...
label morte1_s24: # - # IF WEIGHT #4 /* Triggers after states #: 26 even though they appear after this state */ ~  Global("Mortuary_Walkthrough","GLOBAL",0) !PartyHasItem("KeyPr") Global("ZM782_Dead_KAPUTZ","GLOBAL",1)
    ...
    menu:
        'morte1_s24_r39848{#morte1_s24_r39848}': # '"All right."{#morte1_s24_r39848}'
            # a30 # r39848
            jump morte1_dispose
...
label morte1_s25: # - # IF WEIGHT #5 /* Triggers after states #: 26 even though they appear after this state */ ~  Global("Mortuary_Walkthrough","GLOBAL",0) PartyHasItem("KeyPr")
    ...
    menu:
        'morte1_s25_r39850{#morte1_s25_r39850}': # '"I„ll try all the doors, then."{#morte1_s25_r39850}'
            # a31 # r39850
            jump morte1_dispose
...
label morte1_s26: # - # IF WEIGHT #0 ~  !InParty("Morte") GlobalGT("Morte","GLOBAL",0)
    ...
    menu:
        'morte1_s26_r39852{#morte1_s26_r39852}': # '"Yeah… let„s go."{#morte1_s26_r39852}'
            # a32 # r39852
            $ morte1Logic.r39852_action()
            jump morte1_dispose

        'morte1_s26_r39853{#morte1_s26_r39853}': # '"Not right now, Morte."{#morte1_s26_r39853}'
            # a33 # r39853
            jump morte1_s27
...
label morte1_s27: # from 26.1
    ...
    menu:
        'morte1_s27_r39855{#morte1_s27_r39855}': # '"Morte, you don„t have EITHER of those things."{#morte1_s27_r39855}'
            # a34 # r39855
            jump morte1_s28

        'morte1_s27_r39856{#morte1_s27_r39856}': # '"All right, I changed my mind. Come on, let„s go."{#morte1_s27_r39856}'
            # a35 # r39856
            $ morte1Logic.r39856_action()
            jump morte1_dispose

        'morte1_s27_r39857{#morte1_s27_r39857}': # '"Not at the moment, Morte. Maybe later."{#morte1_s27_r39857}'
            # a36 # r39857
            jump morte1_s28
...
label morte1_s28: # from 27.0 27.2
    ...
    menu:
        'morte1_s28_r39859{#morte1_s28_r39859}': # '"All right, I changed my mind. Come on, let„s go."{#morte1_s28_r39859}'
            # a37 # r39859
            $ morte1Logic.r39859_action()
            jump morte1_dispose

        'morte1_s28_r39860{#morte1_s28_r39860}': # '"Nothing like that. It„s just I don“t need your company right now. Farewell, Morte."{#morte1_s28_r39860}'
            # a38 # r39860
            jump morte1_s29
...
label morte1_s29: # from 28.1
    ...
    menu:
        'morte1_s29_r39862{#morte1_s29_r39862}': # '"I will. Farewell, Morte."{#morte1_s29_r39862}'
            # a39 # r39862
            jump morte1_dispose
...
label morte1_s30: # - # IF WEIGHT #6 ~  Global("Mortuary_Walkthrough","GLOBAL",1)
    ...
    menu:
        'morte1_s30_r39864{#morte1_s30_r39864}': # '"Nothing at the moment, Morte. Just checking to see if you were still with me."{#morte1_s30_r39864}'
            # a40 # r39864
            jump morte1_dispose
...
label morte1_s31: # externs zm825_s3 zm825_s0 zm569_s3 zm569_s0
    ...
    menu:
        'morte1_s31_r42299{#morte1_s31_r42299}': # '"But you„re dead. And you“re talking to me."{#morte1_s31_r42299}'
            # a41 # r42299
            jump morte1_s32
...
label morte1_s32: # from 31.0
    ...
    menu:
        'morte1_s32_r42301{#morte1_s32_r42301}': # '"I… see."{#morte1_s32_r42301}'
            # a42 # r42301
            jump morte1_s33
...
label morte1_s33: # from 32.0
    ...
    menu:
        'morte1_s33_r42303{#morte1_s33_r42303}': # '"All right, then. Let„s go."{#morte1_s33_r42303}'
            # a43 # r42303
            jump morte1_dispose
