class MorteLogic:
    ...
    def j64512_s85_r4676_action(self):
        ...
        #$% .register('64512', 'Apparently the man disguised as a zombie is a member of the Anarchists, some faction that's out to get authority figures and tear down anything that smells even remotely like 'establishment.'') %$#
    ...
    def r20612_action(self):
        ...
        #$%.register('20538', 'Marta the Seamstress seems to have the job of taking corpses given to her, ripping out their teeth, undoing their stitches, looking for any valuables she can find on or in the body, then stitching them back up again. %$#')
    ...
    def r41921_action(self):
        ...
        #$%.register('67862', 'I met the man who cursed Reekwind in the Civic Festhall: Jumble Murdersense. %$#')
    ...
    def r43910_action(self):
        ...
        #$%.register('39490', 'I told Nemelle her friend, Aelwyn, was looking for her. She rewarded me with a magical kiss, which increased my maximum hit points by three. %$#')
    ...
    def j39477_s478_r45093_action(self):
        ...
        #$% .register('39477', 'Morte mentioned something about the 'Rule of Threes.' Apparently, some people believe everything tends to happen in three, and they attach great meaning to the number.') %$#
    ...
    def r53629_action(self):
        ...
        #$%.register('53633', 'Morte said it was I that pulled him from the Pillar so long ago, though he doesn't really understand how. He also explained that he lost all the Pillar's accumulated knowledge when he was removed from it... which would explain why he's not *quite* as useful as he told that earlier incarnation of mine he would be. %$#')


    def j53661_s513_r53630_action(self):
        self.state_manager.journal_manager.update_journal('53661')
        #$% .register('53661', 'It turns out Morte came from something called the Pillar of Skulls, a pile of living, severed heads on Avernus, first layer of Baator. It's made up of the heads of all whose lies have led others to their deaths.') %$#
    ...
    def j65573_s652_r65569_action(self):
        ...
        #$% .register('65573', 'I confronted Morte about the extra line of text on my back that he'd "forgotten" to read. He claimed that it wasn't anything of substance, so he didn't read it to me. I'm sure he's lying, but I don't know why yet.') %$#
    ...
    def j65637_s667_r65631_action(self):
        ...
        #$% .register('65637', 'Morte told me he gained a new ability when he was sitting on Lothar's shelf, something called "Skull Mob." Apparently, he can summon some friends he met at Lothar's a limited number of times per day, and they'll attack an opponent Morte chooses, biting them, then running off. The damage they do depends on Morte's level of experience.') %$#


    def j65669_s675_r65666_action(self):
        self.state_manager.journal_manager.update_journal('65669')
        #$% .register('65669', 'Morte suggested I check out the Civic Festhall in the Clerk's Ward to try and find out more about the night hag, Ravel.') %$#


    def j65678_s677_r65674_action(self):
        self.state_manager.journal_manager.update_journal('65678')
        #$% .register('65678', 'Morte suggested someone in the Clerk's Ward might know where to obtain a piece of Ravel; failing that, we could try the Festhall and the sensory stones there. If *that* fails, I suppose we could always go visit some prostitutes... it sure would beat all this running around and talking to people.') %$#


    def j65712_s686_r65710_action(self):
        self.state_manager.journal_manager.update_journal('65712')
        #$% .register('65712', 'I confronted Morte on him telling me he's a mimir, but I didn't have anything to pen on him. I'm going to need to catch him in a lie in order to get the truth out of him, I think.') %$#
    ...
    def r65821_action(self):
        ...
        #$%.register('65825', 'I discovered why Morte has stayed with me all this time... it's because he felt guilty for having killed me once, when he was alive. Confronting him on his guilty feelings seemed to take some of the burden off of him, and he seemed to become stronger as a result. %$#')
