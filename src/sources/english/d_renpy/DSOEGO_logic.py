class SoegoLogic:
    ...
    def j63982_s1_r1438_action(self):
        ...
        #$% .register('63982', 'I met a Dustman named Soego at the Mortuary front gate... he looks tired, as if he hasn't slept in weeks. Judging from the eyes and pallor of his skin, it looks like he has caught some sort of illness.') %$#
    ...
    def j21805_s71_r21800_action(self):
        ...
        #$% .register('21805', 'Soego told me not to attack any undead in the Dead Nations, for they shall not harm me so long as I remain peaceful.') %$#
    ...
    def r21852_action(self):
        ...
        #$%.register('21856', 'I found Soego. He was infected with lycanthropy, which drove him into the catacombs. His mind was no longer his own and his Dustman beliefs were lost. %$#')
    ...
    def r21853_action(self):
        ...
        #$%.register('21857', 'Soego told me that he does not know how to enter the Silent King's throne room, which I will have to do if I am to kill the Silent King. %$#')
    ...
    def r21915_action(self):
        ...
        #$%.register('21926', 'I confronted Soego with contents of his journal, and he transformed into a wererat and attacked me. %$#')
    ...
    def j25254_s94_r25248_action(self):
        ...
        #$% .register('25254', 'I told Soego that the Silent King was nothing more than a wizened corpse. He said I should inform Many-as-One, and would be rewarded for doing so. Many-as-One is the hive mind of the cranium rats in the Warrens of Thought, east of the Weeping Stone catacombs.') %$#
    ...
    def j21996_s94_r21994_action(self):
        ...
        #$% .register('21996', 'I told Soego that the Silent King was nothing more than a wizened corpse. I will have to inform Many-as-One myself as soon as the opportunity arises.') %$#
    ...
    def r22051_action(self):
        ...
        #$%.register('22052', 'I found Soego. He has discovered a group of undead guardians who were protecting the catacombs. He is trying to convince them to join the True Death. %$#')
