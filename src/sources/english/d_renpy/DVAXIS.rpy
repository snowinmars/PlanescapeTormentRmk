...
label vaxis_s0: # - # IF ~  Global("Vaxis","GLOBAL",0)
    ...
    menu:
        ...
        '"So… seen anything interesting going on?"{#vaxis_s0_r455}' if vaxisLogic.r455_condition():
            # a1 # r455
            jump vaxis_s5

        '"I know you„re not a zombie, you know. You“re not fooling anyone."{#vaxis_s0_r456}' if vaxisLogic.r456_condition():
            # a2 # r456
            jump vaxis_s5

        'Use your Stories-Bones-Tell ability on the corpse.{#vaxis_s0_r457}' if vaxisLogic.r457_condition():
            # a3 # r457
            jump vaxis_s1

        '"It was great talking to you. Farewell."{#vaxis_s0_r458}':
            # a4 # r458
            jump vaxis_s5

        'Leave the corpse in peace.{#vaxis_s0_r459}':
            # a5 # r459
            jump vaxis_dispose
...
label vaxis_s1: # from 0.3 # IF ~  False()
    ...
    menu:
        ...
        'Leave the corpse in peace.{#vaxis_s1_r462}':
            # a7 # r462
            jump vaxis_dispose
...
label vaxis_s2: # from 1.0
    ...
    menu:
        ...
        '"Why are you disguised as a corpse?"{#vaxis_s2_r465}':
            # a9 # r465
            $ vaxisLogic.j64513_s2_r465_action()
            jump vaxis_s6

        'Leave. Quickly.{#vaxis_s2_r466}':
            # a10 # r466
...
label vaxis_s3: # from 2.2 5.2
    ...
    menu:
        ...
        '"Who are you?"{#vaxis_s3_r469}':
            # a12 # r469
            jump vaxis_s7

        '"Tell me who you are, or I„ll call the guards."{#vaxis_s3_r470}':
            # a13 # r470
            jump vaxis_s7

        'Lie: "Why… I was looking for you."{#vaxis_s3_r472}' if vaxisLogic.r472_condition():
            # a14 # r472
            $ vaxisLogic.r472_action()
            jump vaxis_s24

        '"I„m asking the questions here, *zombie.* Tell me who you are, or I“ll make that disguise a reality."{#vaxis_s3_r473}':
            # a15 # r473
            $ vaxisLogic.r473_action()
            jump vaxis_s7

        '"Sorry to trouble you… whoever you are. Farewell."{#vaxis_s3_r474}':
            # a16 # r474
            jump vaxis_s4
...
label vaxis_s4: # from 3.5 6.5 7.8 8.5 10.4 11.4 12.2 13.5 14.4 15.2 16.4 17.2 18.1 19.3 20.1 25.6 27.6 31.6 32.5 34.2 35.6 59.1 74.1 75.3 76.1
    ...
    menu:
        ...
        'Lie: "I wouldn„t even *think* of telling the Dustmen about you."{#vaxis_s4_r476}':
            # a18 # r476
            $ vaxisLogic.r476_action()
            jump vaxis_dispose

        'Truth: "I promise I won„t say anything to the Dustmen about you."{#vaxis_s4_r477}':
            # a19 # r477
            $ vaxisLogic.r477_action()
            jump vaxis_dispose

        '"Whatever. You mind your affairs, and I„ll mind mine."{#vaxis_s4_r478}':
            # a20 # r478
            jump vaxis_dispose
...
label vaxis_s5: # from 0.0 0.1 0.2 0.4
    ...
    menu:
        ...
        '"Why are you disguised as a corpse?"{#vaxis_s5_r481}':
            # a22 # r481
            $ vaxisLogic.j64513_s5_r481_action()
            $ vaxisLogic.r481_action()
            jump vaxis_s6

        'Leave. Quickly.{#vaxis_s5_r482}':
            # a23 # r482
...
label vaxis_s6: # from 2.0 2.1 5.0 5.1
    ...
    menu:
        ...
        '"Who are you?"{#vaxis_s6_r485}':
            # a25 # r485
            jump vaxis_s7

        '"Tell me who you are, or I„ll call the guards."{#vaxis_s6_r486}':
            # a26 # r486
            jump vaxis_s7

        'Lie: "Why… I was looking for you."{#vaxis_s6_r487}' if vaxisLogic.r487_condition():
            # a27 # r487
            $ vaxisLogic.r487_action()
            jump vaxis_s24

        '"I„m asking the questions here, *zombie.* Tell me who you are, or I“ll make that disguise a reality."{#vaxis_s6_r488}':
            # a28 # r488
            $ vaxisLogic.r488_action()
            jump vaxis_s7

        '"Sorry to trouble you… whoever you are. Farewell."{#vaxis_s6_r489}':
            # a29 # r489
            jump vaxis_s4
...
label vaxis_s7: # from 3.0 3.1 3.2 3.4 6.0 6.1 6.2 6.4
    ...
    menu:
        ...
        '"I„m not a spy. I got sealed in here by accident. Can you help me out?"{#vaxis_s7_r492}' if vaxisLogic.r492_condition():
            # a31 # r492
            jump vaxis_s31

        'Lie: "Yes, I„m spying on the… Dusties."{#vaxis_s7_r493}' if vaxisLogic.r493_condition():
            # a32 # r493
            $ vaxisLogic.r493_action()
            jump vaxis_s8

        'Lie: "Yes, I„m spying on the… Dusties."{#vaxis_s7_r494}' if vaxisLogic.r494_condition():
            # a33 # r494
            $ vaxisLogic.r494_action()
            jump vaxis_s9

        '"Why don„t you tell me what YOU“RE doing here before I call the guards."{#vaxis_s7_r495}' if vaxisLogic.r495_condition():
            # a34 # r495
            jump vaxis_s21

        '"Why don„t you tell me what YOU“RE doing here before I call the guards."{#vaxis_s7_r496}' if vaxisLogic.r496_condition():
            # a35 # r496
            jump vaxis_s17

        '"Look, I„m the one asking the questions here, *zombie.* Tell me what you“re doing here, or I„ll make that disguise a reality."{#vaxis_s7_r1306}' if vaxisLogic.r1306_condition():
            # a36 # r1306
            $ vaxisLogic.r1306_action()
            jump vaxis_s19

        '"Look, I„m the one asking the questions here, *zombie.* Tell me what you“re doing here, or I„ll make that disguise a reality."{#vaxis_s7_r1348}' if vaxisLogic.r1348_condition():
            # a37 # r1348
            $ vaxisLogic.r1348_action()
            jump vaxis_s22

        '"I must take my leave. Farewell."{#vaxis_s7_r1349}':
            # a38 # r1349
            jump vaxis_s4
...
label vaxis_s8: # from 7.2
    ...
    menu:
        ...
        'Lie: "Yes… I„ve been looking for you. I“m glad I finally found you."{#vaxis_s8_r1359}' if vaxisLogic.r1359_condition():
            # a41 # r1359
            $ vaxisLogic.r1359_action()
            jump vaxis_s24

        'Lie: "Yes… but I can„t speak too much about it right now, if you catch my meaning. What“s *your* mission here?"{#vaxis_s8_r1360}' if vaxisLogic.r1360_condition():
            # a42 # r1360
            $ vaxisLogic.r1360_action()
            jump vaxis_s28

        'Lie: "Yes… but I can„t speak too much about it right now. What are you doing here?"{#vaxis_s8_r1361}' if vaxisLogic.r1361_condition():
            # a43 # r1361
            $ vaxisLogic.r1361_action()
            jump vaxis_s28

        '"Uh, I don„t have time to talk right now… maybe some other time."{#vaxis_s8_r1362}':
            # a44 # r1362
            jump vaxis_s4
...
label vaxis_s10: # from 8.0 8.1
    ...
    menu:
        ...
        '"First, you„ll tell me what you“re doing here, or I„ll call the guards."{#vaxis_s10_r4363}' if vaxisLogic.r4363_condition():
            # a48 # r4363
            jump vaxis_s17

        '"Answer my damn questions, or I„ll make that disguise a reality before you get three paces."{#vaxis_s10_r4364}' if vaxisLogic.r4364_condition():
            # a49 # r4364
            $ vaxisLogic.r4364_action()
            jump vaxis_s19

        '"Answer my damn questions, or I„ll make that disguise a reality before you get three paces."{#vaxis_s10_r4365}' if vaxisLogic.r4365_condition():
            # a50 # r4365
            $ vaxisLogic.r4365_action()
            jump vaxis_s22

        '"All right, all right… I„m leaving."{#vaxis_s10_r4367}':
            # a51 # r4367
            jump vaxis_s4
...
label vaxis_s11: # externs morte_s86
    ...
    menu:
        ...
        '"So what are you doing here?"{#vaxis_s11_r4369}':
            # a53 # r4369
            jump vaxis_s28

        'Lie: "So you„re a spy for the Anarchists? Well, I“m spying on the Dusties, too… but I can„t speak too much about it right now, if you catch my meaning. What“s *your* mission here?"{#vaxis_s11_r4370}' if vaxisLogic.r4370_condition():
            # a54 # r4370
            $ vaxisLogic.r4370_action()
            jump vaxis_s28

        'Lie: "So you„re a spy for the Anarchists? I“m spying on the Dusties… but I can„t speak too much about it right now. What are you doing here?"{#vaxis_s11_r4371}' if vaxisLogic.r4371_condition():
            # a55 # r4371
            $ vaxisLogic.r4371_action()
            jump vaxis_s28

        '"Uh, I don„t have time to talk right now… maybe some other time."{#vaxis_s11_r4372}':
            # a56 # r4372
            jump vaxis_s4
...
label vaxis_s12: # from 7.0 11.0
    ...
    menu:
        ...
        '"I got… trapped in here somehow. Can you help me out?"{#vaxis_s12_r4375}':
            # a58 # r4375
            jump vaxis_s31

        '"Maybe I„ll speak of it another time."{#vaxis_s12_r4376}':
            # a59 # r4376
            jump vaxis_s4
...
label vaxis_s13: # from 12.0
    ...
    menu:
        ...
        '"„Barmee“? What„s that?"{#vaxis_s13_r4379}' if vaxisLogic.r4379_condition():
            # a61 # r4379
            jump vaxis_s16

        '"„Barmee“? What„s that?"{#vaxis_s13_r4380}' if vaxisLogic.r4380_condition():
            # a62 # r4380
            jump morte_s87  # EXTERN

        '"I know it„s hard to believe, but I“m not going to lie to you: I woke up from the dead on one of the slabs upstairs."{#vaxis_s13_r4381}':
            # a63 # r4381
            $ vaxisLogic.r4381_action()
            jump vaxis_s14

        '"Uh, no… actually, I was trapped in here somehow. Can you help me out?"{#vaxis_s13_r4382}':
            # a64 # r4382
            jump vaxis_s31

        '"Forget we spoke. I must be taking my leave."{#vaxis_s13_r4383}':
            # a65 # r4383
            jump vaxis_s4
...
label vaxis_s14: # from 13.0 13.3 15.0
    ...
    menu:
        ...
        '"I„m not going anywhere. Tell me what you“re doing here, or I„ll call the guards."{#vaxis_s14_r4386}' if vaxisLogic.r4386_condition():
            # a67 # r4386
            jump vaxis_s17

        '"You„ll answer my damn questions first, or I“ll make that disguise a reality."{#vaxis_s14_r4387}' if vaxisLogic.r4387_condition():
            # a68 # r4387
            $ vaxisLogic.r4387_action()
            jump vaxis_s19

        '"You„ll answer my damn questions first, or I“ll make that disguise a reality."{#vaxis_s14_r4388}' if vaxisLogic.r4388_condition():
            # a69 # r4388
            $ vaxisLogic.r4388_action()
            jump vaxis_s22

        '"All right, all right… farewell."{#vaxis_s14_r4389}':
            # a70 # r4389
            jump vaxis_s4
...
label vaxis_s15: # externs morte_s88
    ...
    menu:
        ...
        '"Uh, sorry. Actually, I was trapped in here somehow. Can you help me out?"{#vaxis_s15_r4392}':
            # a72 # r4392
            jump vaxis_s31

        '"Never mind. I must take my leave now."{#vaxis_s15_r4393}':
            # a73 # r4393
            jump vaxis_s4
...
label vaxis_s16: # from 13.1
    ...
    menu:
        ...
        '"I„m not going anywhere. Tell me what you“re doing here, or I„ll call the guards."{#vaxis_s16_r4396}' if vaxisLogic.r4396_condition():
            # a75 # r4396
            jump vaxis_s17

        '"You„ll answer my damn questions first, or I“ll make that disguise a reality."{#vaxis_s16_r4397}' if vaxisLogic.r4397_condition():
            # a76 # r4397
            $ vaxisLogic.r4397_action()
            jump vaxis_s19

        '"You„ll answer my damn questions first, or I“ll make that disguise a reality."{#vaxis_s16_r4398}' if vaxisLogic.r4398_condition():
            # a77 # r4398
            $ vaxisLogic.r4398_action()
            jump vaxis_s22

        '"All right, all right… I„m going."{#vaxis_s16_r4399}':
            # a78 # r4399
            jump vaxis_s4
...
label vaxis_s17: # from 7.5 10.1 14.1 16.1 25.3 27.3
    ...
    menu:
        ...
        '"You won„t escape if I KILL you. Now answer my questions, or I“ll make that disguise a reality."{#vaxis_s17_r4402}' if vaxisLogic.r4402_condition():
            # a80 # r4402
            $ vaxisLogic.r4402_action()
            jump vaxis_s22

        '"Burn in hell, then. I„m leaving."{#vaxis_s17_r4403}':
            # a81 # r4403
            jump vaxis_s4
...
label vaxis_s18: # from 17.0
    ...
    menu:
        ...
        '"Burn in hell, then. I„m leaving. You better watch yourself… *zombie.*"{#vaxis_s18_r4406}':
            # a83 # r4406
            jump vaxis_s4
...
label vaxis_s19: # from 7.6 10.2 14.2 16.2 25.4 27.4
    ...
    menu:
        ...
        '"What if I expose your disguise to the guards?"{#vaxis_s19_r4409}' if vaxisLogic.r4409_condition():
            # a85 # r4409
            jump vaxis_s21

        '"What if I expose your disguise to the guards?"{#vaxis_s19_r4410}' if vaxisLogic.r4410_condition():
            # a86 # r4410
            jump vaxis_s20

        '"Burn in hell, then. I„m leaving. You better watch yourself… *zombie.*"{#vaxis_s19_r4411}':
            # a87 # r4411
            jump vaxis_s4
...
label vaxis_s20: # from 19.2
    ...
    menu:
        ...
        '"Burn in hell, then. I„m leaving. You better watch yourself *zombie.*"{#vaxis_s20_r4414}':
            # a89 # r4414
            jump vaxis_s4
...
label vaxis_s21: # from 7.4 10.0 14.0 16.0 19.1 25.2 27.2
    ...
    menu:
        ...
        '"What have you seen the Dustmen do?"{#vaxis_s21_r4417}':
            # a91 # r4417
            jump vaxis_s29

        '"I had some other questions…"{#vaxis_s21_r4418}':
            # a92 # r4418
            jump vaxis_s43

        '"That„s all I wanted to know. Farewell, *zombie.*"{#vaxis_s21_r4419}':
            # a93 # r4419
            jump vaxis_dispose
...
label vaxis_s22: # from 7.7 10.3 14.3 16.3 17.1 25.5 27.5
    ...
    menu:
        ...
        '"What have you seen the Dustmen do?"{#vaxis_s22_r4422}':
            # a95 # r4422
            jump vaxis_s29

        '"I had some other questions…"{#vaxis_s22_r4423}':
            # a96 # r4423
            jump vaxis_s43

        '"That„s all I wanted to know. Now stay out of my way, *zombie.*"{#vaxis_s22_r4424}':
            # a97 # r4424
            jump vaxis_dispose
...
label vaxis_s23: # from 21.0 22.0
    ...
    menu:
        ...
        '"C„mon. Who are you watching this place for?"{#vaxis_s23_r4427}' if vaxisLogic.r4427_condition():
            # a99 # r4427
            jump morte_s89  # EXTERN

        '"It„ll be a LOT less painful for you if you tell me now who you“re spying for."{#vaxis_s23_r4428}' if vaxisLogic.r4428_condition():
            # a100 # r4428
            $ vaxisLogic.r4428_action()
            jump vaxis_s70

        '"It„ll be a LOT less painful for you if you tell me now who you“re spying for."{#vaxis_s23_r4429}' if vaxisLogic.r4429_condition():
            # a101 # r4429
            $ vaxisLogic.r4429_action()
            jump morte_s89  # EXTERN

        '"Never mind then. What have you seen the Dustmen do?"{#vaxis_s23_r4430}':
            # a102 # r4430
            jump vaxis_s29

        '"There was something else I wanted to know…"{#vaxis_s23_r4431}':
            # a103 # r4431
            jump vaxis_s43

        '"Forget it, then. Farewell, *zombie.*"{#vaxis_s23_r4432}':
            # a104 # r4432
            jump vaxis_dispose
...
label vaxis_s24: # from 3.3 6.3 8.2
    ...
    menu:
        ...
        '"Message from who?"{#vaxis_s24_r4435}':
            # a106 # r4435
            jump vaxis_s27

        '"No, I don„t have a message."{#vaxis_s24_r4436}':
            # a107 # r4436
            jump vaxis_s25
...
label vaxis_s25: # from 24.2
    ...
    menu:
        ...
        '"I wanted some information…"{#vaxis_s25_r4439}':
            # a109 # r4439
            jump vaxis_s43

        '"Tell me what you„re doing here, or I“ll call the guards."{#vaxis_s25_r4440}' if vaxisLogic.r4440_condition():
            # a110 # r4440
            jump vaxis_s21

        '"Tell me what you„re doing here, or I“ll call the guards."{#vaxis_s25_r4441}' if vaxisLogic.r4441_condition():
            # a111 # r4441
            jump vaxis_s17

        '"I want you to answer my damn questions, or I„ll make that disguise a reality before you get three paces."{#vaxis_s25_r4442}' if vaxisLogic.r4442_condition():
            # a112 # r4442
            $ vaxisLogic.r4442_action()
            jump vaxis_s19

        '"I want you to answer my damn questions, or I„ll make that disguise a reality before you get three paces."{#vaxis_s25_r4443}' if vaxisLogic.r4443_condition():
            # a113 # r4443
            $ vaxisLogic.r4443_action()
            jump vaxis_s22

        '"Sorry to trouble you… whoever you are. Farewell."{#vaxis_s25_r4444}':
            # a114 # r4444
            jump vaxis_s4
...
label vaxis_s26: # from 24.0
    ...
    menu:
        ...
        'Lie: "I have your new orders."{#vaxis_s26_r4447}' if vaxisLogic.r4447_condition():
            # a116 # r4447
            $ vaxisLogic.r4447_action()
            jump vaxis_s30

        'Lie: "I… have your new orders."{#vaxis_s26_r4448}' if vaxisLogic.r4448_condition():
            # a117 # r4448
            $ vaxisLogic.r4448_action()
            jump vaxis_s30

        '"Sorry, I don„t have a message."{#vaxis_s26_r4449}':
            # a118 # r4449
            jump vaxis_s27

        '"Never mind. Sorry to trouble you. Farewell."{#vaxis_s26_r4450}':
            # a119 # r4450
            jump vaxis_s27
...
label vaxis_s27: # from 24.1 26.3 26.4
    ...
    menu:
        ...
        '"I wanted some information…"{#vaxis_s27_r4453}':
            # a121 # r4453
            jump vaxis_s43

        '"Tell me what you„re doing here, or I“ll call the guards."{#vaxis_s27_r4454}' if vaxisLogic.r4454_condition():
            # a122 # r4454
            jump vaxis_s21

        '"Tell me what you„re doing here, or I“ll call the guards."{#vaxis_s27_r4455}' if vaxisLogic.r4455_condition():
            # a123 # r4455
            jump vaxis_s17

        '"I„m asking the questions here, *zombie.* Tell me who you are, or I“ll make that disguise a reality."{#vaxis_s27_r4456}' if vaxisLogic.r4456_condition():
            # a124 # r4456
            $ vaxisLogic.r4456_action()
            jump vaxis_s19

        '"I„m asking the questions here, *zombie.* Tell me who you are, or I“ll make that disguise a reality."{#vaxis_s27_r4457}' if vaxisLogic.r4457_condition():
            # a125 # r4457
            $ vaxisLogic.r4457_action()
            jump vaxis_s22

        '"Sorry to trouble you… whoever you are. Farewell."{#vaxis_s27_r4458}':
            # a126 # r4458
            jump vaxis_s4
...
label vaxis_s28: # from 8.3 8.4 11.1 11.2 11.3 26.0 30.0 43.5
    ...
    menu:
        ...
        '"I see. There was something else I wanted to ask you…"{#vaxis_s28_r4461}':
            # a128 # r4461
            jump vaxis_s43

        '"That„s all I wanted to know. Farewell."{#vaxis_s28_r4462}':
            # a129 # r4462
            jump vaxis_dispose
...
label vaxis_s29: # from 21.1 22.1 23.4 28.0 70.1 71.2
    ...
    menu:
        ...
        '"That„s all I wanted to know. Farewell."{#vaxis_s29_r4465}':
            # a131 # r4465
            jump vaxis_dispose
...
label vaxis_s30: # from 26.1 26.2
    ...
    menu:
        ...
        '"I need to find an escape route where I may leave unobserved."{#vaxis_s30_r4468}':
            # a133 # r4468
            jump vaxis_s49

        '"I am here to relieve you. Give me all the information you„ve gathered, all your possessions, then leave."{#vaxis_s30_r4469}' if vaxisLogic.r4469_condition():
            # a134 # r4469
            $ vaxisLogic.j64517_s30_r4469_action()
            $ vaxisLogic.r4469_action()
            jump vaxis_s72

        '"I am here to help you in any way you need."{#vaxis_s30_r4470}':
            # a135 # r4470
            jump vaxis_s35

        '"Your orders will have to wait for another time. I will be back."{#vaxis_s30_r4471}':
            # a136 # r4471
            jump vaxis_dispose
...
label vaxis_s31: # from 7.1 12.1 13.4 15.1 25.0 27.0 50.0
    ...
    menu:
        ...
        '"Maybe we could help each other out. What do you want in return?"{#vaxis_s31_r4474}' if vaxisLogic.r4474_condition():
            # a138 # r4474
            $ vaxisLogic.r4474_action()
            jump vaxis_s35

        '"Because I won„t *expose* your little disguise… if you help me."{#vaxis_s31_r4475}' if vaxisLogic.r4475_condition():
            # a139 # r4475
            jump vaxis_s33

        '"Because I won„t *expose* your little disguise… if you help me."{#vaxis_s31_r4476}' if vaxisLogic.r4476_condition():
            # a140 # r4476
            jump vaxis_s34

        '"You look like someone who„d much rather disguise themselves as a corpse than BE one. That reason enough?"{#vaxis_s31_r4477}' if vaxisLogic.r4477_condition():
            # a141 # r4477
            $ vaxisLogic.r4477_action()
            jump vaxis_s75

        '"You look like someone who„d much rather disguise themselves as a corpse than BE one. That reason enough?"{#vaxis_s31_r4478}' if vaxisLogic.r4478_condition():
            # a142 # r4478
            $ vaxisLogic.r4478_action()
            jump vaxis_s33

        '"Forget we met. I must take my leave. Farewell."{#vaxis_s31_r4479}':
            # a143 # r4479
            jump vaxis_s4
...
label vaxis_s32: # from 31.0
    ...
    menu:
        ...
        '"How about you help me, and I won„t call the guards?"{#vaxis_s32_r4482}' if vaxisLogic.r4482_condition():
            # a145 # r4482
            jump vaxis_s33

        '"How about you help me, and I won„t call the guards?"{#vaxis_s32_r4483}' if vaxisLogic.r4483_condition():
            # a146 # r4483
            jump vaxis_s34

        '"You look like someone who„d much rather be breathing than saying no to me. Now… for the last time: How do I get out of this place?"{#vaxis_s32_r4484}' if vaxisLogic.r4484_condition():
            # a147 # r4484
            $ vaxisLogic.r4484_action()
            jump vaxis_s75

        '"You look like someone who„d much rather be breathing than saying no to me. Now… for the last time: How do I get out of this place?"{#vaxis_s32_r4485}' if vaxisLogic.r4485_condition():
            # a148 # r4485
            $ vaxisLogic.r4485_action()
            jump vaxis_s33

        '"Not interested. Farewell."{#vaxis_s32_r4486}':
            # a149 # r4486
            jump vaxis_s4
...
label vaxis_s34: # from 31.3 32.2 35.3
    ...
    menu:
        ...
        '"You won„t escape if I KILL you. Now start talking, I“ll make that disguise a reality."{#vaxis_s34_r4490}' if vaxisLogic.r4490_condition():
            # a152 # r4490
            $ vaxisLogic.r4490_action()
            jump vaxis_s33

        '"Burn in hell, then. I„m leaving."{#vaxis_s34_r4492}':
            # a153 # r4492
            jump vaxis_s4
...
label vaxis_s35: # from 30.3 31.1 32.0
    ...
    menu:
        ...
        '"All right. Where is this key?"{#vaxis_s35_r4495}':
            # a155 # r4495
            jump vaxis_s36

        '"I don„t have time for this. Help me escape, or I“ll call the guards."{#vaxis_s35_r4496}' if vaxisLogic.r4496_condition():
            # a156 # r4496
            $ vaxisLogic.r4496_action()
            jump vaxis_s33

        '"I don„t have time for this. Help me escape, or I“ll call the guards."{#vaxis_s35_r4497}' if vaxisLogic.r4497_condition():
            # a157 # r4497
            $ vaxisLogic.r4497_action()
            jump vaxis_s34

        '"I„m not going to go fetch anything for you. Help me escape, or I“ll snap your neck right here and now."{#vaxis_s35_r4498}' if vaxisLogic.r4498_condition():
            # a158 # r4498
            $ vaxisLogic.r4498_action()
            jump vaxis_s75

        '"I„m not going to go fetch anything for you. Help me escape, or I“ll snap your neck right here and now."{#vaxis_s35_r4499}' if vaxisLogic.r4499_condition():
            # a159 # r4499
            $ vaxisLogic.r4499_action()
            jump vaxis_s33

        '"No thanks. Maybe some other time."{#vaxis_s35_r4500}':
            # a160 # r4500
            jump vaxis_s4
...
label vaxis_s36: # from 35.1 58.2
    ...
    menu:
        ...
        '"A Dustman woman… with yellow eyes and blades on her fingers? I already met her in the embalming room. Hold on - I„ll be back with the key shortly."{#vaxis_s36_r64520}' if vaxisLogic.r64520_condition():
            # a162 # r64520
            $ vaxisLogic.j64519_s36_r64520_action()
            jump vaxis_s38

        '"A Dustman woman… with yellow eyes and blades on her fingers? All right then. I„ll be back with the key."{#vaxis_s36_r4503}' if vaxisLogic.r4503_condition():
            # a163 # r4503
            $ vaxisLogic.j64518_s36_r4503_action()
            jump vaxis_s38

        '"This Dustman woman sounds really attractive. Are you sure you don„t want me to introduce the two of you?"{#vaxis_s36_r4504}':
            # a164 # r4504
...
label vaxis_s37: # from 36.3
    ...
    menu:
        ...
        '"That was a joke, see, you„re sup… forget it, I“ll go find your key."{#vaxis_s37_r66150}' if vaxisLogic.r66150_condition():
            # a166 # r66150
...
label vaxis_s38: # from 36.1 36.2 37.0 37.1
    ...
    menu:
        ...
        '"I„ll be back."{#vaxis_s38_r4509}' if vaxisLogic.r4509_condition():
            # a168 # r4509
            $ vaxisLogic.r4509_action()
            jump vaxis_dispose

        '"I„ll get your damned key… but you had best watch your threats, you hear me?"{#vaxis_s38_r4510}' if vaxisLogic.r4510_condition():
            # a169 # r4510
            jump vaxis_dispose

        '"I„ll be back."{#vaxis_s38_r4511}' if vaxisLogic.r4511_condition():
            # a170 # r4511
            jump vaxis_dispose
...
label vaxis_s40: # -
    ...
    menu:
        ...
        '"Forget it, then."{#vaxis_s40_r4516}':
            # a172 # r4516
            jump vaxis_dispose
...
label vaxis_s42: # from 35.0 36.0 58.0 58.1
    ...
    menu:
        ...
        '"Now… there was something I wanted to know…"{#vaxis_s42_r4522}' if vaxisLogic.r4522_condition():
            # a176 # r4522
...
label vaxis_s43: # from 21.2 22.2 23.5 25.1 27.1 28.1 29.0 42.1 44.2 45.1 46.2 47.2 48.0 51.1 52.0 53.0 54.0 56.0 58.3 59.0 60.3 61.4 62.3 63.1 64.0 70.2 71.3 77.0
    ...
    menu:
        ...
        '"How can I escape from here?"{#vaxis_s43_r4524}' if vaxisLogic.r4524_condition():
            # a178 # r4524
            jump vaxis_s49

        '"Where was that portal you mentioned again?"{#vaxis_s43_r4525}' if vaxisLogic.r4525_condition():
            # a179 # r4525
            jump vaxis_s52

        '"Can you disguise me as a zombie?"{#vaxis_s43_r4526}' if vaxisLogic.r4526_condition():
            # a180 # r4526
            jump vaxis_s63

        '"Can you disguise me as a zombie again?"{#vaxis_s43_r4527}' if vaxisLogic.r4527_condition():
            # a181 # r4527
            jump vaxis_s63

        '"What are you doing here?"{#vaxis_s43_r4528}' if vaxisLogic.r4528_condition():
            # a182 # r4528
            jump vaxis_s28

        '"Do you know someone named Pharod?"{#vaxis_s43_r4673}' if vaxisLogic.r4673_condition():
            # a183 # r4673
            jump vaxis_s44

        '"I„m missing a journal. Have you seen it?"{#vaxis_s43_r4530}' if vaxisLogic.r4530_condition():
            # a184 # r4530
            jump vaxis_s47

        '"Can you tell me anything about Dhall?"{#vaxis_s43_r4531}' if vaxisLogic.r4531_condition():
            # a185 # r4531
            jump vaxis_s53

        '"Can you tell me anything about Deionarra?"{#vaxis_s43_r4532}' if vaxisLogic.r4532_condition():
            # a186 # r4532
            jump vaxis_s54

        '"Can you tell me anything about Soego?"{#vaxis_s43_r4533}' if vaxisLogic.r4533_condition():
            # a187 # r4533
            jump vaxis_s55

        '"How did you get to look like that?"{#vaxis_s43_r4534}' if vaxisLogic.r4534_condition():
            # a188 # r4534
            jump vaxis_s60

        '"How did you get to look like that?"{#vaxis_s43_r4535}' if vaxisLogic.r4535_condition():
            # a189 # r4535
            jump vaxis_s39

        '"Never mind. I may have some questions later. Don„t go anywhere."{#vaxis_s43_r4536}':
            # a190 # r4536
            jump vaxis_dispose
...
label vaxis_s44: # from 43.6
    ...
    menu:
        ...
        '"Why don„t the Dustmen like Pharod?"{#vaxis_s44_r4539}':
            # a192 # r4539
            $ vaxisLogic.j64522_s44_r4539_action()
            jump vaxis_s46

        '"There was something else I wanted to know…"{#vaxis_s44_r4540}':
            # a193 # r4540
            jump vaxis_s43

        '"Never mind. I may have some questions later. Don„t go anywhere."{#vaxis_s44_r4541}':
            # a194 # r4541
            jump vaxis_dispose
...
label vaxis_s45: # from 44.0
    ...
    menu:
        ...
        '"There was something else I wanted to know…"{#vaxis_s45_r4544}':
            # a196 # r4544
            jump vaxis_s43

        '"Never mind. I may have some questions later. Don„t go anywhere."{#vaxis_s45_r4545}':
            # a197 # r4545
            jump vaxis_dispose
...
label vaxis_s46: # from 44.1 45.0
    ...
    menu:
        ...
        '"Uh… what?"{#vaxis_s46_r4548}' if vaxisLogic.r4548_condition():
            # a199 # r4548
            jump morte_s91  # EXTERN

        '"Oh. There was something else I wanted to know…"{#vaxis_s46_r4549}':
            # a200 # r4549
            jump vaxis_s43

        '"Never mind. I may have some questions later. Don„t go anywhere."{#vaxis_s46_r4550}':
            # a201 # r4550
            jump vaxis_dispose
...
label vaxis_s47: # from 43.7
    ...
    menu:
        ...
        '"Uh… what?"{#vaxis_s47_r4553}' if vaxisLogic.r4553_condition():
            # a203 # r4553
            jump morte_s92  # EXTERN

        '"Oh. There was something else I wanted to know…"{#vaxis_s47_r4554}':
            # a204 # r4554
            jump vaxis_s43

        '"Never mind. I may have some questions later. Don„t go anywhere."{#vaxis_s47_r4555}':
            # a205 # r4555
            jump vaxis_dispose
...
label vaxis_s48: # from 46.0 47.0
    ...
    menu:
        ...
        '"Never mind. I may have some questions later. Don„t go anywhere."{#vaxis_s48_r4558}':
            # a207 # r4558
            jump vaxis_dispose
...
label vaxis_s50: # from 33.0 49.0
    ...
    menu:
        ...
        '"Can you show me one of these portals?"{#vaxis_s50_r64509}' if vaxisLogic.r64509_condition():
            # a210 # r64509
            jump vaxis_s51

        '"Can you show me one of these portals?"{#vaxis_s50_r64510}' if vaxisLogic.r64510_condition():
            # a211 # r64510
            jump vaxis_s51

        '"Can you show me one of these portals?"{#vaxis_s50_r64511}' if vaxisLogic.r64511_condition():
            # a212 # r64511
            jump vaxis_s51
...
label vaxis_s51: # from 50.1 50.2 50.3 72.0
    ...
    menu:
        ...
        '"I had some other questions…"{#vaxis_s51_r4568}' if vaxisLogic.r4568_condition():
            # a214 # r4568
            $ vaxisLogic.j64529_s51_r4568_action()
            $ vaxisLogic.r4568_action()
            jump vaxis_s43

        '"An arch on the first floor, northwest room? All right, I„ll go check it out."{#vaxis_s51_r4569}' if vaxisLogic.r4569_condition():
            # a215 # r4569
...
label vaxis_s52: # from 43.2
    ...
    menu:
        ...
        '"Arch, first floor, northwest room, opens with a crooked finger bone? All right, I got it this time."{#vaxis_s52_r4572}':
            # a217 # r4572
            jump vaxis_dispose
...
label vaxis_s53: # from 43.8
    ...
    menu:
        ...
        '"Never mind. I may have some questions later. Don„t go anywhere."{#vaxis_s53_r4575}':
            # a219 # r4575
            jump vaxis_dispose
...
label vaxis_s54: # from 43.9
    ...
    menu:
        ...
        '"Never mind. I may have some questions later. Don„t go anywhere."{#vaxis_s54_r4578}':
            # a221 # r4578
            jump vaxis_dispose
...
label vaxis_s55: # from 43.10
    ...
    menu:
        ...
        '"Never mind. I may have some questions later. Don„t go anywhere."{#vaxis_s55_r4581}':
            # a223 # r4581
            jump vaxis_dispose
...
label vaxis_s56: # from 55.0
    ...
    menu:
        ...
        '"Never mind. I may have some questions later. Don„t go anywhere."{#vaxis_s56_r4584}':
            # a225 # r4584
            jump vaxis_dispose
...
label vaxis_s57: # - # IF ~  GlobalGT("Vaxis","GLOBAL",0)
    ...
    menu:
        ...
        '"Greetings."{#vaxis_s57_r4587}' if vaxisLogic.r4587_condition():
            # a227 # r4587
            jump vaxis_s58

        '"Greetings."{#vaxis_s57_r4588}' if vaxisLogic.r4588_condition():
            # a228 # r4588
            jump vaxis_s59

        '"Greetings."{#vaxis_s57_r4589}' if vaxisLogic.r4589_condition():
            # a229 # r4589
            jump vaxis_s58

        'Leave him alone.{#vaxis_s57_r4590}':
            # a230 # r4590
            jump vaxis_dispose
...
label vaxis_s58: # from 57.0 57.1 57.3
    ...
    menu:
        ...
        '"Here„s that embalming room key you wanted."{#vaxis_s58_r4593}' if vaxisLogic.r4593_condition():
            # a232 # r4593
            $ vaxisLogic.r4593_action()
            jump vaxis_s42

        '"Where is that key you mentioned again?"{#vaxis_s58_r4594}' if vaxisLogic.r4594_condition():
            # a233 # r4594
            jump vaxis_s36

        '"I had some questions for you…"{#vaxis_s58_r4595}':
            # a234 # r4595
            jump vaxis_s43

        '"Never mind."{#vaxis_s58_r4596}':
            # a235 # r4596
            jump vaxis_dispose
...
label vaxis_s59: # from 57.2
    ...
    menu:
        ...
        '"Never mind then."{#vaxis_s59_r4599}' if vaxisLogic.r4599_condition():
            # a237 # r4599
            jump vaxis_s4

        '"Never mind then."{#vaxis_s59_r4600}' if vaxisLogic.r4600_condition():
            # a238 # r4600
            jump vaxis_dispose
...
label vaxis_s60: # from 43.11
    ...
    menu:
        ...
        '"Doesn„t that hurt?"{#vaxis_s60_r4603}':
            # a240 # r4603
            jump vaxis_s62

        '"That disguise is pretty good. Say… can you disguise me as a zombie, too?"{#vaxis_s60_r4604}' if vaxisLogic.r4604_condition():
            # a241 # r4604
            jump vaxis_s63

        '"There was something else I wanted to know…"{#vaxis_s60_r4605}':
            # a242 # r4605
            jump vaxis_s43

        '"I have to leave. Farewell."{#vaxis_s60_r4606}':
            # a243 # r4606
            jump vaxis_dispose
...
label vaxis_s61: # from 60.0
    ...
    menu:
        ...
        '"That disguise is pretty good. Can you disguise me as a zombie?"{#vaxis_s61_r4609}' if vaxisLogic.r4609_condition():
            # a245 # r4609
            jump vaxis_s63

        '"There was something else I wanted to know…"{#vaxis_s61_r4610}' if vaxisLogic.r4610_condition():
            # a246 # r4610
            jump vaxis_s64

        '"I have to leave. Farewell."{#vaxis_s61_r4611}' if vaxisLogic.r4611_condition():
            # a247 # r4611
            jump vaxis_s64

        '"There was something else I wanted to know…"{#vaxis_s61_r4612}' if vaxisLogic.r4612_condition():
            # a248 # r4612
            jump vaxis_s43

        '"I have to leave. Farewell."{#vaxis_s61_r4613}' if vaxisLogic.r4613_condition():
            # a249 # r4613
            jump vaxis_dispose
...
label vaxis_s62: # from 60.1 61.0
    ...
    menu:
        ...
        '"There was something else I wanted to know…"{#vaxis_s62_r4616}' if vaxisLogic.r4616_condition():
            # a251 # r4616
            jump vaxis_s64

        '"I have to leave. Farewell."{#vaxis_s62_r4617}' if vaxisLogic.r4617_condition():
            # a252 # r4617
            jump vaxis_s64

        '"There was something else I wanted to know…"{#vaxis_s62_r4618}' if vaxisLogic.r4618_condition():
            # a253 # r4618
            jump vaxis_s43

        '"I have to leave. Farewell."{#vaxis_s62_r4674}' if vaxisLogic.r4674_condition():
            # a254 # r4674
            jump vaxis_dispose
...
label vaxis_s63: # from 43.3 43.4 60.2 61.1 62.0 64.1 64.2
    ...
    menu:
        ...
        '"I„ll think about it. I had some other questions…"{#vaxis_s63_r4621}':
            # a256 # r4621
            $ vaxisLogic.r4621_action()
            jump vaxis_s43

        '"No thanks. Maybe some other time… farewell."{#vaxis_s63_r4622}':
            # a257 # r4622
            $ vaxisLogic.r4622_action()
            jump vaxis_dispose

        '"Some embalming fluid and some thread? I„ll go see if I can find some."{#vaxis_s63_r4623}':
            # a258 # r4623
...
label vaxis_s64: # from 61.2 61.3 62.1 62.2
    ...
    menu:
        ...
        '"Sure. Can you do it?"{#vaxis_s64_r4626}':
            # a260 # r4626
            jump vaxis_s63

        '"Why not? I already feel like one of the walking dead."{#vaxis_s64_r4627}':
            # a261 # r4627
            jump vaxis_s63

        '"No… no… that„s all right. Farewell."{#vaxis_s64_r4628}':
            # a262 # r4628
...
label vaxis_s65: # from 63.0
    ...
    menu:
        ...
        'Try to hold still.{#vaxis_s65_r4631}' if vaxisLogic.r4631_condition():
            # a264 # r4631
            $ vaxisLogic.r4631_action()
            jump morte_s94  # EXTERN

        'Try to hold still.{#vaxis_s65_r4632}' if vaxisLogic.r4632_condition():
            # a265 # r4632
            $ vaxisLogic.r4632_action()
            jump vaxis_s66

        'Try to hold still.{#vaxis_s65_r64533}' if vaxisLogic.r64533_condition():
            # a266 # r64533
...
label vaxis_s66: # from 65.0 65.2 65.3
    ...
    menu:
        ...
        '"Mmm-hmmph-mmm… Fanks."{#vaxis_s66_r4635}' if vaxisLogic.r4635_condition():
            # a268 # r4635
            $ vaxisLogic.r4635_action()
            jump morte_s95  # EXTERN

        '"Mmm-hmmph-mmm… Fanks."{#vaxis_s66_r4636}' if vaxisLogic.r4636_condition():
            # a269 # r4636
            jump vaxis_s67
...
label vaxis_s70: # from 23.0 23.2 71.0 71.1
    ...
    menu:
        ...
        '"Never mind then. What have you seen the Dustmen do?"{#vaxis_s70_r4646}':
            # a275 # r4646
            jump vaxis_s29

        '"There was something else I wanted to know…"{#vaxis_s70_r4647}':
            # a276 # r4647
            jump vaxis_s43

        '"Forget it, then. Farewell, *zombie.*"{#vaxis_s70_r4648}':
            # a277 # r4648
            jump vaxis_dispose
...
label vaxis_s71: # externs morte_s90
    ...
    menu:
        ...
        '"It„ll be a LOT less painful for you if you tell me now why the Anarchists want you to spy on this place."{#vaxis_s71_r4651}':
            # a279 # r4651
            $ vaxisLogic.r4651_action()
            jump vaxis_s70

        '"Never mind then. What have you seen the Dustmen do?"{#vaxis_s71_r4652}':
            # a280 # r4652
            jump vaxis_s29

        '"There was something else I wanted to know…"{#vaxis_s71_r4653}':
            # a281 # r4653
            jump vaxis_s43

        '"Forget it, then. Farewell, *zombie.*"{#vaxis_s71_r4654}':
            # a282 # r4654
            jump vaxis_dispose
...
label vaxis_s72: # from 30.2
    ...
    menu:
        ...
        '"Very well. Farewell, Vaxis."{#vaxis_s72_r64532}' if vaxisLogic.r64532_condition():
            # a284 # r64532
            jump vaxis_dispose
...
label vaxis_s74: # from 34.0
    ...
    menu:
        ...
        '"Burn in hell, then. I„m leaving. You better watch yourself… *zombie!*"{#vaxis_s74_r4662}':
            # a287 # r4662
            jump vaxis_s4
...
label vaxis_s75: # from 31.4 32.3 35.4
    ...
    menu:
        ...
        '"How about I expose your disguise to the guards?"{#vaxis_s75_r4665}' if vaxisLogic.r4665_condition():
            # a289 # r4665
            jump vaxis_s76

        '"I„ll risk it. Prepare to die."{#vaxis_s75_r4666}':
            # a290 # r4666
            $ vaxisLogic.r4666_action()
            jump vaxis_dispose

        '"Burn in hell, then. I„m leaving. You better watch yourself… *zombie.*"{#vaxis_s75_r4667}':
            # a291 # r4667
            jump vaxis_s4
...
label vaxis_s76: # from 75.1
    ...
    menu:
        ...
        '"Burn in hell, then. I„m leaving. You better watch yourself… *zombie.*"{#vaxis_s76_r4670}':
            # a293 # r4670
            jump vaxis_s4
...
label vaxis_s77: # from 51.0
    ...
    menu:
        ...
        '"Very well. I„ll check upstairs for this crooked finger bone, then head to the first floor, to one of the arches in the northwest room. Got it."{#vaxis_s77_r64525}':
            # a295 # r64525
            jump vaxis_dispose
