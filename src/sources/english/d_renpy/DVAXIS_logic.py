class VaxisLogic:
    ...
    def j64513_s2_r464_action(self):
        ...
        #$% .register('64513', 'One of the zombies on the second floor of the Mortuary wasn't a zombie at all, but a man in disguise. Why anyone would disguise themselves as a zombie is beyond me.') %$#
    ...
    def j64517_s30_r4469_action(self):
        ...
        #$% .register('64517', 'I told the disguised spy that I was there to "relieve" him, and he handed over everything he had collected, mostly a lot of bandages and healing items, which he must have needed to maintain his disguise.') %$#
    ...
    def j64519_s36_r64520_action(self):
        ...
        #$% .register('64519', 'In exchange for the "zombie's" help, I agreed to go get an embalming key from that Dustwoman embalmer I met in the other room, Ei-Vene, I think her name was. How she could possibly use an embalming key with those blades for her hands is beyond me.') %$#


    def j64518_s36_r4503_action(self):
        self.state_manager.journal_manager.update_journal('64518')
        #$% .register('64518', 'In exchange for the "zombie's" help, I agreed to go get an embalming key from some Dustwoman with blades for hands and yellow eyes.') %$#
    ...
    def j64521_s42_r4521_action(self):
        ...
        #$% .register('64521', 'Got Vaxis his precious embalming key. He must need it to get new supplies to maintain his disguise, if the embalming fluid smell coming off of him is any indication.') %$#
    ...
    def j64522_s44_r4539_action(self):
        ...
        #$% .register('64522', 'It sounds like the Dustmen and Pharod aren't on the best of terms... Vaxis told me Pharod's bringing a lot of bodies to the Mortuary, and the Dustmen suspect that he's killing people before their hour's up.') %$#
    ...
    def j64529_s51_r4568_action(self):
        ...
        #$% .register('64529', 'Vaxis told me there's a secret portal in the northwest room of the first floor of the Mortuary - if you take a crooked finger bone up to it, it will activate and take me to a secret crypt, where Vaxis says I can "rest."') %$#
    ...
    def j64530_s55_r4580_action(self):
        ...
        #$% .register('64530', 'Vaxis said something about Soego being strange - saying that he liked "rats," whatever THAT means. Vaxis accusing anyone of being strange is ironic enough.') %$#
    ...
    def j64531_s67_r4638_action(self):
        ...
        #$% .register('64531', 'In exchange for some needle and thread and some embalming fluid, Vaxis disguised me as a zombie. He warned me that running would ruin the disguise, and that I shouldn't talk to others while disguised, as zombies don't "talk."') %$#
