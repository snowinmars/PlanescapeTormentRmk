...
label zm1041_s0: # - # IF ~  Global("Bei","GLOBAL",0)
    ...
    menu:
        ...
        '"So… seen anything interesting going on?"{#zm1041_s0_r6577}' if zm1041Logic.r6577_condition():
            # a1 # r6577
            jump zm1041_s1

        '"I know you„re not a zombie, you know. You“re not fooling anyone."{#zm1041_s0_r6578}' if zm1041Logic.r6578_condition():
            # a2 # r6578
            jump zm1041_s1

        'Use your Stories-Bones-Tell ability on the corpse.{#zm1041_s0_r6579}' if zm1041Logic.r6579_condition():
            # a3 # r6579
            jump zm1041_s2

        'Use your Stories-Bones-Tell ability on the corpse.{#zm1041_s0_r6580}' if zm1041Logic.r6580_condition():
            # a4 # r6580
            jump zm1041_s37

        '"It was great talking to you. Farewell."{#zm1041_s0_r6581}':
            # a5 # r6581
            jump zm1041_dispose

        'Leave the corpse in peace.{#zm1041_s0_r9095}':
            # a6 # r9095
            jump zm1041_dispose
...
label zm1041_s2: # from 0.3
    ...
    menu:
        ...
        '"I had some questions…"{#zm1041_s2_r9096}':
            # a9 # r9096
            $ zm1041Logic.r9096_action()
            jump zm1041_s4

        'Leave the spirit.{#zm1041_s2_r9097}':
            # a10 # r9097
...
label zm1041_s3: # from 2.0
    ...
    menu:
        ...
        '"I have no idea what you are saying… can you understand my words at all?"{#zm1041_s3_r9099}':
            # a12 # r9099
            jump zm1041_s5

        '"I cannot understand you. Farewell."{#zm1041_s3_r9100}':
            # a13 # r9100
            jump zm1041_dispose
...
label zm1041_s4: # from 2.1
    ...
    menu:
        ...
        '"I have no idea what you are saying… can you understand my words at all?"{#zm1041_s4_r9102}':
            # a15 # r9102
            jump zm1041_s5

        '"I cannot understand you. Farewell."{#zm1041_s4_r9103}':
            # a16 # r9103
            jump zm1041_dispose
...
label zm1041_s5: # from 3.0 3.1 4.0 4.1
    ...
    menu:
        ...
        '"Where are you from?"{#zm1041_s5_r9105}':
            # a18 # r9105
            jump zm1041_s7

        '"How did you end up here? As a zombie, I mean?"{#zm1041_s5_r9106}':
            # a19 # r9106
            jump zm1041_s8

        '"Where are you… where your spirit resides… now?"{#zm1041_s5_r9107}':
            # a20 # r9107
            jump zm1041_s11

        '"What do you know of this place?"{#zm1041_s5_r9108}':
            # a21 # r9108
            jump zm1041_s9

        '"Do you know someone named Pharod?"{#zm1041_s5_r9109}' if zm1041Logic.r9109_condition():
            # a22 # r9109
            jump zm1041_s10

        '"Nothing, never mind."{#zm1041_s5_r9110}':
            # a23 # r9110
            jump zm1041_dispose
...
label zm1041_s6: # from 5.0 14.0
    ...
    menu:
        ...
        '"Hmm. Sounds impressive."{#zm1041_s6_r9112}':
            # a25 # r9112
            jump zm1041_s13

        '"I see. I had more questions…"{#zm1041_s6_r9113}':
            # a26 # r9113
            jump zm1041_s14

        '"That„s all I wished to know. Farewell."{#zm1041_s6_r9114}':
            # a27 # r9114
            jump zm1041_dispose
...
label zm1041_s7: # from 5.1 14.1
    ...
    menu:
        ...
        '"I see. I had more questions…"{#zm1041_s7_r9116}':
            # a29 # r9116
            jump zm1041_s14

        '"That„s all I wished to know. Farewell."{#zm1041_s7_r9117}':
            # a30 # r9117
            jump zm1041_dispose
...
label zm1041_s8: # from 5.2 14.2
    ...
    menu:
        ...
        '"Hunting assassins?"{#zm1041_s8_r9119}':
            # a32 # r9119
            jump zm1041_s16

        '"I see, but do you know how your corpse come to be working here?"{#zm1041_s8_r9120}':
            # a33 # r9120
            jump zm1041_s17

        '"You speak well for one with so little time to learn a language."{#zm1041_s8_r9121}':
            # a34 # r9121
            jump zm1041_s18

        '"I see. I had more questions…"{#zm1041_s8_r9122}':
            # a35 # r9122
            jump zm1041_s14

        '"That„s all I wished to know. Farewell."{#zm1041_s8_r9123}':
            # a36 # r9123
            jump zm1041_dispose
...
label zm1041_s9: # from 5.4 14.4
    ...
    menu:
        ...
        '"Fell into this world?"{#zm1041_s9_r9125}':
            # a38 # r9125
            jump zm1041_s16

        '"You speak well for one with so little time to learn a language."{#zm1041_s9_r9126}':
            # a39 # r9126
            jump zm1041_s18

        '"I see. I had more questions…"{#zm1041_s9_r9127}':
            # a40 # r9127
            jump zm1041_s14

        '"Very well. Perhaps we will speak again."{#zm1041_s9_r9128}':
            # a41 # r9128
            jump zm1041_dispose
...
label zm1041_s10: # from 5.5 14.5
    ...
    menu:
        ...
        '"Very well. Perhaps we will speak again."{#zm1041_s10_r9130}':
            # a43 # r9130
            jump zm1041_dispose
...
label zm1041_s11: # from 5.3 14.3
    ...
    menu:
        ...
        '"I understand. I had more questions…"{#zm1041_s11_r9132}':
            # a45 # r9132
            jump zm1041_s14

        '"That„s all I wished to know. Farewell."{#zm1041_s11_r9133}':
            # a46 # r9133
            jump zm1041_dispose
...
label zm1041_s12: # from 6.0 16.1
    ...
    menu:
        ...
        '"Perhaps. I had more questions…"{#zm1041_s12_r9135}':
            # a48 # r9135
            jump zm1041_s14

        '"That„s all I wished to know. Farewell."{#zm1041_s12_r9136}':
            # a49 # r9136
            jump zm1041_dispose
...
label zm1041_s13: # from 6.1
    ...
    menu:
        ...
        '"I had more questions…"{#zm1041_s13_r9138}':
            # a51 # r9138
            jump zm1041_s14

        '"I see. Perhaps we will speak again."{#zm1041_s13_r9139}':
            # a52 # r9139
            jump zm1041_dispose
...
label zm1041_s14: # from 6.2 7.1 8.4 9.3 10.0 11.1 12.1 13.1 15.2 17.1 18.0 19.0 20.1 21.1 22.0 23.1 24.0 25.0 26.0 27.1 28.0 29.0 30.0 31.2 32.1 33.2 34.0 35.2 36.0 37.0 38.1
    ...
    menu:
        ...
        '"Where are you from?"{#zm1041_s14_r9141}':
            # a54 # r9141
            jump zm1041_s7

        '"How did you end up here? As a zombie, I mean?"{#zm1041_s14_r9142}':
            # a55 # r9142
            jump zm1041_s8

        '"Where are you… where your spirit resides… now?"{#zm1041_s14_r9143}':
            # a56 # r9143
            jump zm1041_s11

        '"What do you know of this place?"{#zm1041_s14_r9144}':
            # a57 # r9144
            jump zm1041_s9

        '"Do you know someone named Pharod?"{#zm1041_s14_r9145}' if zm1041Logic.r9145_condition():
            # a58 # r9145
            jump zm1041_s10

        '"What was that you spoke when you first appeared?"{#zm1041_s14_r9146}':
            # a59 # r9146
            jump zm1041_s26

        '"Never mind. Farewell."{#zm1041_s14_r9147}':
            # a60 # r9147
            jump zm1041_dispose
...
label zm1041_s15: # from 11.0
    ...
    menu:
        ...
        '"Final destination? Where were you to be sent?"{#zm1041_s15_r9149}':
            # a62 # r9149
            jump zm1041_s20

        '"Wait… I had other questions, before you continue."{#zm1041_s15_r9150}':
            # a63 # r9150
            jump zm1041_s14

        '"Perhaps I„ll hear the rest another time. Farewell."{#zm1041_s15_r9151}':
            # a64 # r9151
            jump zm1041_dispose
...
label zm1041_s16: # from 7.0 8.0 8.1 9.1 12.0 13.0
    ...
    menu:
        ...
        '"Tutor *and* bodyguard?"{#zm1041_s16_r9153}':
            # a66 # r9153
            jump zm1041_s12

        '"Perhaps I„ll hear the rest another time. Farewell."{#zm1041_s16_r9154}':
            # a67 # r9154
            jump zm1041_dispose
...
label zm1041_s17: # from 8.2 9.0
    ...
    menu:
        ...
        '"I see. Another question, if I may…"{#zm1041_s17_r9156}':
            # a69 # r9156
            jump zm1041_s14

        '"That„s all wished to know. Farewell."{#zm1041_s17_r9157}':
            # a70 # r9157
            jump zm1041_dispose
...
label zm1041_s18: # from 8.3 9.2
    ...
    menu:
        ...
        '"I understand. Thank you for speaking with me. Farewell."{#zm1041_s18_r9159}':
            # a72 # r9159
            jump zm1041_dispose
...
label zm1041_s19: # from 15.0 20.0
    ...
    menu:
        ...
        '"Anything I could do to help?"{#zm1041_s19_r9161}':
            # a74 # r9161
            $ zm1041Logic.r9161_action()
            jump zm1041_s24

        '"Poor fool… I wonder how long they„ll let you wander!"{#zm1041_s19_r9162}':
            # a75 # r9162
            $ zm1041Logic.r9162_action()
            jump zm1041_s25

        '"I wish you good luck. Farewell."{#zm1041_s19_r9163}':
            # a76 # r9163
            jump zm1041_dispose
...
label zm1041_s20: # from 15.1
    ...
    menu:
        ...
        '"I can imagine… I had another question…"{#zm1041_s20_r9165}':
            # a78 # r9165
            jump zm1041_s14

        '"Perhaps I„ll hear the rest another time. Farewell."{#zm1041_s20_r9166}':
            # a79 # r9166
            jump zm1041_dispose
...
label zm1041_s21: # from 16.0
    ...
    menu:
        ...
        '"Wait… I had other questions, before you continue."{#zm1041_s21_r9168}':
            # a81 # r9168
            jump zm1041_s14

        '"Perhaps I„ll hear the rest another time. Farewell."{#zm1041_s21_r9169}':
            # a82 # r9169
            jump zm1041_dispose
...
label zm1041_s22: # from 17.0
    ...
    menu:
        ...
        '"Interesting. I had best be going now; farewell."{#zm1041_s22_r9171}':
            # a84 # r9171
            jump zm1041_dispose
...
label zm1041_s23: # from 21.0
    ...
    menu:
        ...
        '"Before you go on, I had other questions…"{#zm1041_s23_r9173}':
            # a86 # r9173
            jump zm1041_s14

        '"That„s all I wished to know for now. Farewell."{#zm1041_s23_r9174}':
            # a87 # r9174
            jump zm1041_dispose
...
label zm1041_s24: # from 19.1
    ...
    menu:
        ...
        '"No worries. I had best leave, though. Farewell."{#zm1041_s24_r9176}':
            # a89 # r9176
            jump zm1041_dispose
...
label zm1041_s25: # from 19.2 33.1 35.1
    ...
    menu:
        ...
        'Walk off, leave the spirit floating there.{#zm1041_s25_r9178}':
            # a91 # r9178
            jump zm1041_dispose
...
label zm1041_s26: # from 14.6
    ...
    menu:
        ...
        '"No… but I think I„d like to know more about this poem."{#zm1041_s26_r9180}':
            # a93 # r9180
            jump zm1041_s28

        '"No. As a matter of fact, I think I„ll be leaving. Farewell."{#zm1041_s26_r9181}':
            # a94 # r9181
            jump zm1041_dispose
...
label zm1041_s27: # from 23.0
    ...
    menu:
        ...
        '"Oh. Before you go on, I had other questions…"{#zm1041_s27_r9183}':
            # a96 # r9183
            jump zm1041_s14

        '"I see. Thank you, but I„d best take my leave now."{#zm1041_s27_r9184}':
            # a97 # r9184
            jump zm1041_dispose
...
label zm1041_s28: # from 26.1
    ...
    menu:
        ...
        '"Interesting. What does it mean?"{#zm1041_s28_r9186}':
            # a99 # r9186
            jump zm1041_s29

        '"So you„re saying that I should have left your spirit alone? Have I offended you, calling you here?"{#zm1041_s28_r9187}' if zm1041Logic.r9187_condition():
            # a100 # r9187
            jump zm1041_s30

        '"Oh. I thank you for explaining that. Farewell."{#zm1041_s28_r9188}':
            # a101 # r9188
            jump zm1041_dispose
...
label zm1041_s29: # from 28.1
    ...
    menu:
        ...
        '"I understand. Farewell, then."{#zm1041_s29_r9190}':
            # a103 # r9190
            jump zm1041_dispose
...
label zm1041_s30: # from 28.2
    ...
    menu:
        ...
        '"I understand. Farewell, then."{#zm1041_s30_r9192}':
            # a105 # r9192
            jump zm1041_dispose
...
label zm1041_s31: # from 27.0
    ...
    menu:
        ...
        '"Hmm. You know, it„s odd how quickly you were able to pick up the language…"{#zm1041_s31_r9194}':
            # a107 # r9194
            jump zm1041_s38

        '"Oh. Before you go on, I had other questions…"{#zm1041_s31_r9195}':
            # a108 # r9195
            jump zm1041_s14

        '"I„ll have to hear the rest another time; farewell."{#zm1041_s31_r9196}':
            # a109 # r9196
            jump zm1041_dispose
...
label zm1041_s32: # from 31.0 38.0
    ...
    menu:
        ...
        '"Interesting story. I had more questions, though…"{#zm1041_s32_r9198}':
            # a111 # r9198
            jump zm1041_s14

        '"Fascinating. I had best leave you be, now. Farewell."{#zm1041_s32_r9199}':
            # a112 # r9199
            jump zm1041_dispose
...
label zm1041_s33: # from 32.0
    ...
    menu:
        ...
        '"It certainly seems easy for you to just not care about your duties because you„re dead. I don“t know if I could just let something like that go."{#zm1041_s33_r9201}':
            # a114 # r9201
            $ zm1041Logic.r9201_action()
            jump zm1041_s25

        '"Interesting. Let me ask you something else…"{#zm1041_s33_r9202}':
            # a115 # r9202
            jump zm1041_s14

        '"Hmm. I„ll leave you, now. Luck to you."{#zm1041_s33_r9203}':
            # a116 # r9203
            jump zm1041_dispose
...
label zm1041_s34: # from 33.0
    ...
    menu:
        ...
        '"Never mind, then. Farewell."{#zm1041_s34_r9206}':
            # a118 # r9206
            jump zm1041_dispose
...
label zm1041_s35: # -
    ...
    menu:
        ...
        '"Never mind. I don„t have time for this."{#zm1041_s35_r9208}':
            # a120 # r9208
            $ zm1041Logic.r9208_action()
            jump zm1041_s25

        '"All right. I had another question…"{#zm1041_s35_r9209}':
            # a121 # r9209
            $ zm1041Logic.r9209_action()
            jump zm1041_s14

        '"That is all I need. Farewell."{#zm1041_s35_r9210}':
            # a122 # r9210
...
label zm1041_s36: # from 35.0
    ...
    menu:
        ...
        '"I understand. Farewell, spirit."{#zm1041_s36_r9212}':
            # a124 # r9212
            jump zm1041_dispose
...
label zm1041_s37: # from 0.4 # IF ~  Global("Bei","GLOBAL",1)
    ...
    menu:
        ...
        '"Nothing; I shall leave you be."{#zm1041_s37_r9214}':
            # a126 # r9214
            jump zm1041_dispose
...
label zm1041_s38: # from 31.1
    ...
    menu:
        ...
        '"I see. Let me ask you something else, now…"{#zm1041_s38_r9720}':
            # a128 # r9720
            jump zm1041_s14

        '"I understand. Thank you for speaking with me. Farewell."{#zm1041_s38_r9721}':
            # a129 # r9721
            jump zm1041_dispose
