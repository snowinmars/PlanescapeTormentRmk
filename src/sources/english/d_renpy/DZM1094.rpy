...
label zm1094_s0: # - # IF ~  Global("Asonje","GLOBAL",0)
    ...
    menu:
        ...
        '"So… seen anything interesting going on?"{#zm1094_s0_r6566}' if zm1094Logic.r6566_condition():
            # a1 # r6566
            jump zm1094_s1

        '"I know you„re not a zombie, you know. You“re not fooling anyone."{#zm1094_s0_r6567}' if zm1094Logic.r6567_condition():
            # a2 # r6567
            jump zm1094_s1

        'Use your Stories-Bones-Tell ability on the corpse.{#zm1094_s0_r6568}' if zm1094Logic.r6568_condition():
            # a3 # r6568
            $ zm1094Logic.r6568_action()
            jump zm1094_s2

        '"It was great talking to you. Farewell."{#zm1094_s0_r6569}':
            # a4 # r6569
            jump zm1094_dispose

        'Leave the corpse in peace.{#zm1094_s0_r6570}':
            # a5 # r6570
            jump zm1094_dispose
...
label zm1094_s2: # from 0.3
    ...
    menu:
        ...
        'Leave the spirit.{#zm1094_s2_r9246}':
            # a8 # r9246
            jump zm1094_dispose
...
label zm1094_s3: # from 2.0
    ...
    menu:
        ...
        '"You… your remains, at least… are in a mortuary."{#zm1094_s3_r9248}':
            # a10 # r9248
            jump zm1094_s13

        '"No, I doubt you know me. Now, I had a question for you…"{#zm1094_s3_r9249}':
            # a11 # r9249
            jump zm1094_s14

        '"It is doubtful. Farewell."{#zm1094_s3_r9250}':
            # a12 # r9250
            jump zm1094_dispose
...
label zm1094_s4: # from 3.0
    ...
    menu:
        ...
        '"Where are you from?"{#zm1094_s4_r9252}':
            # a14 # r9252
            jump zm1094_s6

        '"How did you end up here? As a zombie, I mean?"{#zm1094_s4_r9253}':
            # a15 # r9253
            jump zm1094_s7

        '"Where are you… where your spirit resides… now?"{#zm1094_s4_r9254}':
            # a16 # r9254
            jump zm1094_s8

        '"What do you know of this place?"{#zm1094_s4_r9255}':
            # a17 # r9255
            jump zm1094_s9

        '"Do you know someone named Pharod?"{#zm1094_s4_r9256}' if zm1094Logic.r9256_condition():
            # a18 # r9256
            jump zm1094_s10

        '"Nothing, never mind."{#zm1094_s4_r9257}':
            # a19 # r9257
            jump zm1094_dispose
...
label zm1094_s5: # from 4.0 11.0
    ...
    menu:
        ...
        '"That is all I wished to know. Farewell."{#zm1094_s5_r9259}':
            # a21 # r9259
            jump zm1094_dispose
...
label zm1094_s6: # from 4.1 11.1
    ...
    menu:
        ...
        '"That is all I wished to know. Farewell."{#zm1094_s6_r9261}':
            # a23 # r9261
            jump zm1094_dispose
...
label zm1094_s7: # from 4.2 11.2
    ...
    menu:
        ...
        '"That is all I wished to know. Farewell."{#zm1094_s7_r9263}':
            # a25 # r9263
            jump zm1094_dispose
...
label zm1094_s8: # from 4.3 11.3
    ...
    menu:
        ...
        '"Yes, go. Farewell."{#zm1094_s8_r9265}':
            # a27 # r9265
            jump zm1094_dispose
...
label zm1094_s9: # from 4.4 11.4
    ...
    menu:
        ...
        '"I had another question…"{#zm1094_s9_r9267}':
            # a29 # r9267
            jump zm1094_s11

        '"That is all I wished to know. Farewell."{#zm1094_s9_r9268}':
            # a30 # r9268
            jump zm1094_dispose
...
label zm1094_s10: # from 4.5 11.5
    ...
    menu:
        ...
        '"That is all I wished to know. Farewell."{#zm1094_s10_r9270}':
            # a32 # r9270
            jump zm1094_dispose
...
label zm1094_s11: # from 5.0 6.0 7.0 8.0 9.1 10.0 12.0 27.0
    ...
    menu:
        ...
        '"Where are you from?"{#zm1094_s11_r9272}':
            # a34 # r9272
            jump zm1094_s6

        '"How did you end up here? As a zombie, I mean?"{#zm1094_s11_r9273}':
            # a35 # r9273
            jump zm1094_s7

        '"Where are you… where your spirit resides… now?"{#zm1094_s11_r9274}':
            # a36 # r9274
            jump zm1094_s8

        '"What do you know of this place?"{#zm1094_s11_r9275}':
            # a37 # r9275
            jump zm1094_s9

        '"Do you know someone named Pharod?"{#zm1094_s11_r9276}' if zm1094Logic.r9276_condition():
            # a38 # r9276
            jump zm1094_s10

        '"Nothing, never mind."{#zm1094_s11_r9277}':
            # a39 # r9277
            jump zm1094_dispose
...
label zm1094_s12: # from 9.0
    ...
    menu:
        ...
        '"That is all I wished to know. Farewell."{#zm1094_s12_r9279}':
            # a41 # r9279
            jump zm1094_dispose
...
label zm1094_s13: # from 3.1
    ...
    menu:
        ...
        '"It is doubtful. Farewell."{#zm1094_s13_r9281}':
            # a43 # r9281
            jump zm1094_dispose
...
label zm1094_s14: # from 3.2 13.0
    ...
    menu:
        ...
        '"Who are you?"{#zm1094_s14_r9286}' if zm1094Logic.r9286_condition():
            # a45 # r9286
            jump zm1094_s25

        '"Where are you from?"{#zm1094_s14_r9287}':
            # a46 # r9287
            jump zm1094_s16

        '"How did you end up here? As a zombie, I mean?"{#zm1094_s14_r9288}':
            # a47 # r9288
            jump zm1094_s17

        '"Where are you… where your spirit resides… now?"{#zm1094_s14_r9317}':
            # a48 # r9317
            jump zm1094_s18

        '"What do you know of this place?"{#zm1094_s14_r9318}':
            # a49 # r9318
            jump zm1094_s19

        '"Do you know someone named Pharod?"{#zm1094_s14_r9319}' if zm1094Logic.r9319_condition():
            # a50 # r9319
            jump zm1094_s20

        '"Nothing, never mind."{#zm1094_s14_r9320}':
            # a51 # r9320
            jump zm1094_dispose
...
label zm1094_s15: # from 14.0 22.0
    ...
    menu:
        ...
        '"I shall tell you another time. I had a question…"{#zm1094_s15_r9290}':
            # a53 # r9290
            $ zm1094Logic.r9290_action()
            jump zm1094_s22

        '"Another time, perhaps. Farewell."{#zm1094_s15_r9291}':
            # a54 # r9291
...
label zm1094_s16: # from 14.2 22.2
    ...
    menu:
        ...
        '"That is all I wished to know. Farewell."{#zm1094_s16_r9293}':
            # a56 # r9293
            jump zm1094_dispose
...
label zm1094_s17: # from 14.3 22.3
    ...
    menu:
        ...
        '"That is all I wished to know. Farewell."{#zm1094_s17_r9295}':
            # a58 # r9295
            jump zm1094_dispose
...
label zm1094_s18: # from 14.4 22.4
    ...
    menu:
        ...
        '"That is all I wished to know. Farewell."{#zm1094_s18_r9297}':
            # a60 # r9297
            jump zm1094_dispose
...
label zm1094_s19: # from 14.5 22.5
    ...
    menu:
        ...
        '"I see. I had another question…"{#zm1094_s19_r9299}':
            # a62 # r9299
            jump zm1094_s22

        '"That is all I wished to know. Farewell."{#zm1094_s19_r9300}':
            # a63 # r9300
            jump zm1094_dispose
...
label zm1094_s20: # from 14.6 22.6
    ...
    menu:
        ...
        '"I do not know. Farewell."{#zm1094_s20_r9302}':
            # a65 # r9302
            jump zm1094_dispose
...
label zm1094_s21: # from 15.0
    ...
    menu:
        ...
        'Make a name up: "I do not know… „Adahn“?"{#zm1094_s21_r9304}':
            # a67 # r9304
            $ zm1094Logic.r9304_action()
            jump zm1094_s23

        '"No, it is not important. Farewell."{#zm1094_s21_r9305}':
            # a68 # r9305
            jump zm1094_dispose
...
label zm1094_s22: # from 15.1 16.0 17.0 18.0 19.1 20.0 21.0 23.0 24.0 25.0 26.0
    ...
    menu:
        ...
        '"Who are you?"{#zm1094_s22_r9307}' if zm1094Logic.r9307_condition():
            # a70 # r9307
            jump zm1094_s25

        '"Where are you from?"{#zm1094_s22_r9308}':
            # a71 # r9308
            jump zm1094_s16

        '"How did you end up here? As a zombie, I mean?"{#zm1094_s22_r9309}':
            # a72 # r9309
            jump zm1094_s17

        '"Where are you… where your spirit resides… now?"{#zm1094_s22_r9310}':
            # a73 # r9310
            jump zm1094_s18

        '"What do you know of this place?"{#zm1094_s22_r9311}':
            # a74 # r9311
            jump zm1094_s19

        '"Do you know someone named Pharod?"{#zm1094_s22_r9312}' if zm1094Logic.r9312_condition():
            # a75 # r9312
            jump zm1094_s20

        '"Nothing, never mind."{#zm1094_s22_r9321}':
            # a76 # r9321
            jump zm1094_dispose
...
label zm1094_s23: # from 21.1
    ...
    menu:
        ...
        '"No, I did not. Farewell."{#zm1094_s23_r9314}':
            # a78 # r9314
            jump zm1094_dispose
...
label zm1094_s24: # from 19.0
    ...
    menu:
        ...
        '"Perhaps. Farewell."{#zm1094_s24_r9316}':
            # a80 # r9316
            jump zm1094_dispose
...
label zm1094_s25: # from 14.1 22.1
    ...
    menu:
        ...
        '"That is all I wished to know. Farewell."{#zm1094_s25_r9285}':
            # a82 # r9285
            jump zm1094_dispose
...
label zm1094_s26: # - # IF ~  GlobalGT("Asonje","GLOBAL",0) GlobalLT("Asonje","GLOBAL",3)
    ...
    menu:
        ...
        '"I was only passing by. Farewell."{#zm1094_s26_r20064}':
            # a84 # r20064
            jump zm1094_dispose
...
label zm1094_s27: # - # IF ~  Global("Asonje","GLOBAL",3)
    ...
    menu:
        ...
        '"I was only passing by. Farewell."{#zm1094_s27_r20066}':
            # a86 # r20066
            jump zm1094_dispose
