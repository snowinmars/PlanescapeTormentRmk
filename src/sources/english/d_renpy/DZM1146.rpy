...
label zm1146_s0: # - # IF ~  Global("Crispy","GLOBAL",0)
    ...
    menu:
        ...
        '"So… seen anything interesting going on?"{#zm1146_s0_r6522}' if zm1146Logic.r6522_condition():
            # a1 # r6522
            jump zm1146_s1

        '"I know you„re not a zombie, you know. You“re not fooling anyone."{#zm1146_s0_r6523}' if zm1146Logic.r6523_condition():
            # a2 # r6523
            jump zm1146_s1

        'Use your Stories-Bones-Tell ability on the corpse.{#zm1146_s0_r6524}' if zm1146Logic.r6524_condition():
            # a3 # r6524
            $ zm1146Logic.r6524_action()
            jump zm1146_s2

        '"It was great talking to you. Farewell."{#zm1146_s0_r6525}':
            # a4 # r6525
            jump zm1146_dispose

        'Leave the corpse in peace.{#zm1146_s0_r6526}':
            # a5 # r6526
            jump zm1146_dispose
...
label zm1146_s2: # from 0.3
    ...
    menu:
        ...
        '"I had questions for you…"{#zm1146_s2_r9413}':
            # a8 # r9413
            jump zm1146_s9

        'Leave the burning spirit.{#zm1146_s2_r9414}':
            # a9 # r9414
            jump zm1146_dispose
...
label zm1146_s3: # from 2.0
    ...
    menu:
        ...
        '"I had a question…"{#zm1146_s3_r9416}':
            # a11 # r9416
            jump zm1146_s9

        '"It is just as well, you stinking, smoldering husk; you probably deserve such a fate. Farewell."{#zm1146_s3_r9417}':
            # a12 # r9417
            jump zm1146_s6

        'Leave the tortured spirit.{#zm1146_s3_r9418}':
            # a13 # r9418
            jump zm1146_dispose
...
label zm1146_s4: # from 3.0
    ...
    menu:
        ...
        '"I had another question…"{#zm1146_s4_r9421}':
            # a15 # r9421
            jump zm1146_s9

        'Leave the tortured spirit to its suffering.{#zm1146_s4_r9422}':
            # a16 # r9422
            jump zm1146_dispose
...
label zm1146_s5: # from 4.0
    ...
    menu:
        ...
        '"All right. Farewell."{#zm1146_s5_r9424}':
            # a18 # r9424
            jump zm1146_dispose
...
label zm1146_s6: # from 3.2 17.0
    ...
    menu:
        ...
        'Strike him.{#zm1146_s6_r9426}':
            # a20 # r9426
            $ zm1146Logic.r9426_action()
            jump zm1146_s8

        'Ignore the wretch, turn away and leave.{#zm1146_s6_r9427}':
            # a21 # r9427
            jump zm1146_dispose
...
label zm1146_s9: # from 2.1 3.1 4.1 5.0 10.0 11.0 12.1 13.1 14.1 15.0 16.0 17.1 18.1 19.0 20.0
    ...
    menu:
        ...
        '"Where are you from?"{#zm1146_s9_r9429}':
            # a23 # r9429
            jump zm1146_s11

        '"How did you end up here? As a zombie, I mean?"{#zm1146_s9_r9430}':
            # a24 # r9430
            jump zm1146_s12

        '"Where are you… where your spirit resides… now?"{#zm1146_s9_r9431}':
            # a25 # r9431
            jump zm1146_s13

        '"What did you do to deserve such torment?"{#zm1146_s9_r9432}':
            # a26 # r9432
            jump zm1146_s14

        '"What do you know of this place?"{#zm1146_s9_r9433}':
            # a27 # r9433
            jump zm1146_s15

        '"Do you know someone named Pharod?"{#zm1146_s9_r9434}' if zm1146Logic.r9434_condition():
            # a28 # r9434
            jump zm1146_s16

        '"Nothing, never mind."{#zm1146_s9_r9435}':
            # a29 # r9435
            jump zm1146_dispose
...
label zm1146_s10: # from 9.0
    ...
    menu:
        ...
        '"Farewell, then."{#zm1146_s10_r9437}':
            # a31 # r9437
            jump zm1146_dispose
...
label zm1146_s11: # from 9.1
    ...
    menu:
        ...
        '"That is all I wished to know. Farewell."{#zm1146_s11_r9439}':
            # a33 # r9439
            jump zm1146_dispose
...
label zm1146_s12: # from 9.2
    ...
    menu:
        ...
        '"I had another question…"{#zm1146_s12_r9441}':
            # a35 # r9441
            jump zm1146_s9

        '"That is all I wished to know. Farewell."{#zm1146_s12_r9465}':
            # a36 # r9465
            jump zm1146_dispose
...
label zm1146_s13: # from 9.3
    ...
    menu:
        ...
        '"I had another question…"{#zm1146_s13_r9443}':
            # a38 # r9443
            jump zm1146_s9

        '"That is all wished to know. Farewell."{#zm1146_s13_r9444}':
            # a39 # r9444
            jump zm1146_dispose
...
label zm1146_s14: # from 9.4
    ...
    menu:
        ...
        '"I see. I had another question…"{#zm1146_s14_r9446}':
            # a41 # r9446
            jump zm1146_s9

        '"That is all I wished to know. Farewell."{#zm1146_s14_r9745}':
            # a42 # r9745
            jump zm1146_dispose
...
label zm1146_s15: # from 9.5
    ...
    menu:
        ...
        '"Farewell, then."{#zm1146_s15_r9448}':
            # a44 # r9448
            jump zm1146_dispose
...
label zm1146_s16: # from 9.6
    ...
    menu:
        ...
        '"That is all I wished to know. Farewell."{#zm1146_s16_r9450}':
            # a46 # r9450
            jump zm1146_dispose
...
label zm1146_s17: # from 13.0
    ...
    menu:
        ...
        '"I see. I had more questions for you…"{#zm1146_s17_r9451}':
            # a48 # r9451
            jump zm1146_s9

        '"That is all I wished to know. Farewell."{#zm1146_s17_r9452}':
            # a49 # r9452
            jump zm1146_dispose
...
label zm1146_s18: # from 12.0 14.0
    ...
    menu:
        ...
        '"I see. I had more questions for you…"{#zm1146_s18_r9464}':
            # a51 # r9464
            jump zm1146_s9

        '"That is all I wished to know. Farewell."{#zm1146_s18_r9746}':
            # a52 # r9746
            jump zm1146_dispose
...
label zm1146_s19: # from 18.0
    ...
    menu:
        ...
        '"That is all I wished to know. Farewell."{#zm1146_s19_r9748}':
            # a54 # r9748
            jump zm1146_dispose
...
label zm1146_s20: # - # IF ~  Global("Crispy","GLOBAL",1)
    ...
    menu:
        ...
        '"Nothing, I was just passing by. Farewell."{#zm1146_s20_r20101}':
            # a56 # r20101
            jump zm1146_dispose
