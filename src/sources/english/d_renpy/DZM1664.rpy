...
label zm1664_s0: # from 5.0 # IF ~  True()
    ...
    menu:
        'zm1664_s0_r47003{#zm1664_s0_r47003}' if zm1664Logic.r47003_condition(): # 'Examine the books.{#zm1664_s0_r47003}'
            # a0 # r47003
            jump zm1664_s3

        'zm1664_s0_r47004{#zm1664_s0_r47004}' if zm1664Logic.r47004_condition(): # 'Examine the books again.{#zm1664_s0_r47004}'
            # a1 # r47004
            jump zm1664_s6

        'zm1664_s0_r47005{#zm1664_s0_r47005}' if zm1664Logic.r47005_condition(): # '"I know you„re not a zombie, you know. You“re not fooling anyone."{#zm1664_s0_r47005}'
            # a2 # r47005
            jump zm1664_s1

        'zm1664_s0_r47006{#zm1664_s0_r47006}' if zm1664Logic.r47006_condition(): # 'Use your Stories-Bones-Tell ability on the corpse.{#zm1664_s0_r47006}'
            # a3 # r47006
            jump zm1664_s2

        'zm1664_s0_r47007{#zm1664_s0_r47007}': # '"It was great talking to you. Farewell."{#zm1664_s0_r47007}'
            # a4 # r47007
            jump zm1664_dispose

        'zm1664_s0_r47008{#zm1664_s0_r47008}': # 'Leave the corpse in peace.{#zm1664_s0_r47008}'
            # a5 # r47008
            jump zm1664_dispose
...
label zm1664_s1: # from 0.2 6.0
    ...
    menu:
        'zm1664_s1_r47010{#zm1664_s1_r47010}': # 'Leave the corpse in peace.{#zm1664_s1_r47010}'
            # a6 # r47010
            jump zm1664_dispose
...
label zm1664_s2: # from 0.3
    ...
    menu:
        'zm1664_s2_r47012{#zm1664_s2_r47012}': # 'Leave the corpse in peace.{#zm1664_s2_r47012}'
            # a7 # r47012
            jump zm1664_dispose
...
label zm1664_s3: # from 0.0
    ...
    menu:
        'zm1664_s3_r47014{#zm1664_s3_r47014}': # 'Take the page.{#zm1664_s3_r47014}'
            # a8 # r47014
...
label zm1664_s4: # from 3.0
    ...
    menu:
        'zm1664_s4_r47016{#zm1664_s4_r47016}': # 'Read through it.{#zm1664_s4_r47016}'
            # a9 # r47016
            jump zm1664_s5
...
label zm1664_s5: # from 4.0
    ...
    menu:
        'zm1664_s5_r47018{#zm1664_s5_r47018}': # 'Examine the zombie again.{#zm1664_s5_r47018}'
            # a10 # r47018
            jump zm1664_s0

        'zm1664_s5_r47019{#zm1664_s5_r47019}': # 'Take the page with you and leave.{#zm1664_s5_r47019}'
            # a11 # r47019
            jump zm1664_dispose
...
label zm1664_s6: # from 0.1
    ...
    menu:
        'zm1664_s6_r47022{#zm1664_s6_r47022}': # '"So how did you come to be a librarian? All the other jobs taken?"{#zm1664_s6_r47022}'
            # a12 # r47022
            jump zm1664_s1

        'zm1664_s6_r47023{#zm1664_s6_r47023}': # 'Leave the zombie in peace.{#zm1664_s6_r47023}'
            # a13 # r47023
            jump zm1664_dispose
