...
label zm1664_s1: # from 0.2 6.0
    nr 'The corpse stares blankly at the wall.{#zm1664_s1_}'
...
label zm1664_s2: # from 0.3
    nr 'The corpse does not stir. Despite the fact it looks recently dead, it does not seem able to answer any of your questions.{#zm1664_s2_}'
...
label zm1664_s3: # from 0.0
    nr 'The books appear to be old Mortuary ledgers, none of them of any particular interest. As you search through the texts, however, you notice a loose page folded between two of the books. You are suddenly struck with the feeling that someone tucked it there to hide it.{#zm1664_s3_}'
...
label zm1664_s4: # from 3.0
    nr 'The page doesn„t look like it belongs with the ledgers… it looks like it belongs in a log book. The tear is clean, as if with a knife, so you suspect the page was removed on purpose.{#zm1664_s4_}'
...
label zm1664_s5: # from 4.0
    nr 'You take a moment to read through the page… it„s a list of dead bodies brought to the Mortuary and logged in the Receiving Room. All the entries appear to be recent arrivals.  ^NNOTE: <READSTUFF>^-{#zm1664_s5_}'
...
label zm1664_s6: # from 0.1
    nr 'The books appear to be old Mortuary ledgers, none of them of any particular interest. You do another search through the texts, but you find nothing more.{#zm1664_s6_}'
