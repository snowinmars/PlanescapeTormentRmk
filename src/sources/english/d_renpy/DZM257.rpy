...
label zm257_s0: # - # IF ~  True()
    ...
    menu:
        ...
        '"Don„t you get dizzy with your eyeballs facing like that?"{#zm257_s0_r6511}' if zm257Logic.r6511_condition():
            # a1 # r6511
            jump zm257_s1

        '"I know you„re not a zombie, you know. You“re not fooling anyone."{#zm257_s0_r6512}' if zm257Logic.r6512_condition():
            # a2 # r6512
            jump zm257_s1

        'Use your Stories-Bones-Tell ability on the corpse.{#zm257_s0_r6513}' if zm257Logic.r6513_condition():
            # a3 # r6513
            jump zm257_s2

        '"It was great talking to you. Farewell."{#zm257_s0_r6514}':
            # a4 # r6514
            jump zm257_dispose

        'Leave the corpse in peace.{#zm257_s0_r6515}':
            # a5 # r6515
            jump zm257_dispose
...
label zm257_s2: # from 0.3
    ...
    menu:
        ...
        'Leave the spirit alone.{#zm257_s2_r9558}':
            # a8 # r9558
            jump zm257_dispose
...
label zm257_s3: # from 2.0
    ...
    menu:
        ...
        '"No. I would ask *you* a question…"{#zm257_s3_r9560}':
            # a10 # r9560
            jump zm257_s5

        'Leave the chaotic spirit.{#zm257_s3_r9561}':
            # a11 # r9561
            jump zm257_s6
...
label zm257_s4: # from 3.0 4.0 5.0
    ...
    menu:
        ...
        '"I do not understand. I have a question, however…"{#zm257_s4_r9563}':
            # a13 # r9563
            jump zm257_s5

        '"I do not understand you. Farewell."{#zm257_s4_r9564}':
            # a14 # r9564
            jump zm257_s6
...
label zm257_s5: # from 3.1 4.1 5.1
    ...
    menu:
        ...
        '"You do not understand. I had a question for *you*…"{#zm257_s5_r9566}':
            # a16 # r9566
            jump zm257_s5

        'Give up and leave the babbling spirit.{#zm257_s5_r9567}':
            # a17 # r9567
            jump zm257_s6
...
label zm257_s6: # from 3.2 4.2 5.2
    ...
    menu:
        ...
        'Ignore it, turn away.{#zm257_s6_r9569}':
            # a19 # r9569
            jump zm257_dispose
