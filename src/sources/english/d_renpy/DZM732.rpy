...
label zm732_s0: # from 4.0 # IF ~  !HasItem("TomeBA","ZM732")
    nr 'This doddering corpse has had its eyes sewn shut as well as its mouth, and the number "732" is carved into its brow. The threadwork that keeps its ocular cavities sealed looks extremely old… you wonder if the eyes were sewn shut before or after the man„s death.'

    menu:
        '"Sorry about taking that book from you… it just looked too interesting to pass up."' if zm732Logic.r6533_condition():
            # a0 # r6533
            $ zm732Logic.r6533_action()
            jump zm732_s1

        '"Sorry about taking that book from you… it just looked too interesting to pass up."' if zm732Logic.r6532_condition():
            # a1 # r6532
            jump zm732_s1

        '"I know you„re not a zombie, you know. You“re not fooling anyone."' if zm732Logic.r6534_condition():
            # a2 # r6534
            jump zm732_s1

        'Use your Stories-Bones-Tell ability on the corpse.' if zm732Logic.r6535_condition():
            # a3 # r6535
            jump zm732_s2
