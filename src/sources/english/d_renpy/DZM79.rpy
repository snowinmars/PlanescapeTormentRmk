...
label zm79_s0: # - # IF ~  True()
    ...
    menu:
        'zm79_s0_r34943{#zm79_s0_r34943}': # '"So… seen anything interesting going on?"{#zm79_s0_r34943}'
            # a0 # r34943
            $ zm79Logic.r34943_action()
            jump zm79_s1

        'zm79_s0_r34946{#zm79_s0_r34946}' if zm79Logic.r34946_condition(): # 'Examine the fanged circle.{#zm79_s0_r34946}'
            # a1 # r34946
            $ zm79Logic.r34946_action()
            jump zm79_s3

        'zm79_s0_r34947{#zm79_s0_r34947}' if zm79Logic.r34947_condition(): # '"I know you„re not a zombie, you know. You“re not fooling anyone."{#zm79_s0_r34947}'
            # a2 # r34947
            jump zm79_s1

        'zm79_s0_r34948{#zm79_s0_r34948}' if zm79Logic.r34948_condition(): # 'Use your Stories-Bones-Tell ability on the corpse.{#zm79_s0_r34948}'
            # a3 # r34948
            jump zm79_s2

        'zm79_s0_r34951{#zm79_s0_r34951}': # '"It was great talking to you. Farewell."{#zm79_s0_r34951}'
            # a4 # r34951
            jump zm79_dispose

        'zm79_s0_r34952{#zm79_s0_r34952}': # 'Leave the corpse in peace.{#zm79_s0_r34952}'
            # a5 # r34952
            jump zm79_dispose
...
label zm79_s1: # from 0.0 0.2
    ...
    menu:
        'zm79_s1_r34945{#zm79_s1_r34945}': # 'Leave the corpse in peace.{#zm79_s1_r34945}'
            # a6 # r34945
            jump zm79_dispose
...
label zm79_s2: # from 0.3 3.0 3.1
    ...
    menu:
        'zm79_s2_r34950{#zm79_s2_r34950}': # 'Leave the corpse in peace.{#zm79_s2_r34950}'
            # a7 # r34950
            jump zm79_dispose
...
label zm79_s3: # from 0.1
    ...
    menu:
        'zm79_s3_r64279{#zm79_s3_r64279}' if zm79Logic.r64279_condition(): # '"Hmmm. Interesting… how did that mark get there, corpse?"{#zm79_s3_r64279}'
            # a8 # r64279
            $ zm79Logic.j64536_s3_r64279_action()
            jump zm79_s2

        'zm79_s3_r64280{#zm79_s3_r64280}' if zm79Logic.r64280_condition(): # '"Hmmm… I wonder if the space between the fangs match the grooves on this copper earring I have…"{#zm79_s3_r64280}'
            # a9 # r64280
