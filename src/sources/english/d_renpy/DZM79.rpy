...
label zm79_s0: # - # IF ~  True()
    ...
    menu:
        ...
        'Examine the fanged circle.' if zm79Logic.r34946_condition():
            # a1 # r34946
            $ zm79Logic.r34946_action()
            jump zm79_s3

        '"I know you„re not a zombie, you know. You“re not fooling anyone."' if zm79Logic.r34947_condition():
            # a2 # r34947
            jump zm79_s1

        'Use your Stories-Bones-Tell ability on the corpse.' if zm79Logic.r34948_condition():
            # a3 # r34948
            jump zm79_s2
...
label zm79_s3: # from 0.1
    nr 'The fanged circle looks like it was branded on the corpse„s forehead long ago, presumably before it died. It might be a religious icon of some sort, or a rite of passage. You notice that one of the recesses between the inner “fangs„ has a small triangle within it, as if it has some special significance.'

    menu:
        '"Hmmm. Interesting… how did that mark get there, corpse?"' if zm79Logic.r64279_condition():
            # a8 # r64279
            $ zm79Logic.j64536_s3_r64279_action()
            jump zm79_s2

        '"Hmmm… I wonder if the space between the fangs match the grooves on this copper earring I have…"' if zm79Logic.r64280_condition():
            # a9 # r64280
