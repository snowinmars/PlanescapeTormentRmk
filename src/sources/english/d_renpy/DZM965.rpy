...
label zm965_s1: # externs morte_s481 morte_s480 # IF ~  !NearbyDialog("Dmorte")
    ...
    menu:
        'zm965_s1_r34923{#zm965_s1_r34923}' if zm965Logic.r34923_condition(): # '"So… why are you walking in a triangle?"{#zm965_s1_r34923}'
            # a0 # r34923
            $ zm965Logic.r34923_action()
            jump zm965_s2

        'zm965_s1_r45070{#zm965_s1_r45070}' if zm965Logic.r45070_condition(): # '"So… why are you walking in a triangle?"{#zm965_s1_r45070}'
            # a1 # r45070
            jump zm965_s2

        'zm965_s1_r45071{#zm965_s1_r45071}' if zm965Logic.r45071_condition(): # '"I know you„re not a zombie, you know. You“re not fooling anyone."{#zm965_s1_r45071}'
            # a2 # r45071
            jump zm965_s2

        'zm965_s1_r45072{#zm965_s1_r45072}' if zm965Logic.r45072_condition(): # 'Use Stories-Bones-Tell on the corpse.{#zm965_s1_r45072}'
            # a3 # r45072
            jump zm965_s3

        'zm965_s1_r45073{#zm965_s1_r45073}': # '"It was great talking to you. Farewell."{#zm965_s1_r45073}'
            # a4 # r45073
            jump zm965_dispose

        'zm965_s1_r45074{#zm965_s1_r45074}': # 'Leave the corpse in peace.{#zm965_s1_r45074}'
            # a5 # r45074
            jump zm965_dispose
...
label zm965_s2: # from 1.0 1.1 1.2
    ...
    menu:
        'zm965_s2_r34928{#zm965_s2_r34928}': # 'Leave the corpse in peace.{#zm965_s2_r34928}'
            # a6 # r34928
            jump zm965_dispose
...
label zm965_s3: # from 1.3
    ...
    menu:
        'zm965_s3_r45075{#zm965_s3_r45075}': # 'Leave the corpse in peace.{#zm965_s3_r45075}'
            # a7 # r45075
            jump zm965_dispose
