...
label deionarra_s0: # from 5.2 9.5 10.8 11.3 12.3 13.4 14.2 25.3 27.4 28.4 30.2 31.3 32.2 41.4 41.5 42.3 42.4 43.4 44.4
    nr '"Je t„attendrai dans les couloirs de la mort, mon Amour." Elle sourit, mais avec tristesse. Elle ferme les yeux et, dans un mouvement éthéré, disparaît.~ [DEN008B]{#deionarra_s0_1}'
...
label deionarra_s1: # - # IF WEIGHT #0 ~  Global("Deionarra","GLOBAL",0) !Global("Current_Area","GLOBAL",1203) !Global("Current_Area","GLOBAL",1200)
    nr 'Tu vois apparaître devant toi le fantôme d„une femme d“une grande beauté ; elle a les bras croisés, les yeux fermés, de longs cheveux ondoyants et une jupe qui semble mue par une brise surnaturelle. Elle se retourne légèrement et cille des yeux.{#deionarra_s1_1}'
...
label deionarra_s4: # - # IF WEIGHT #1 ~  Global("Deionarra","GLOBAL",2) !Global("Current_Area","GLOBAL",1203) !Global("Current_Area","GLOBAL",1200)
    nr 'De nouveau, Deionarra se matérialise… cette fois, le désespoir se lit sur son visage, et ses bras tendus semblent essayer d„atteindre quelque chose. Elle disparaît peu à peu, et sur son visage, le désespoir se transforme en rage. "Tu es revenu ! Pourquoi continues-tu de me tourmenter ?"~ [DEN002]{#deionarra_s4_1}'
...
label deionarra_s5: # - # IF WEIGHT #2 ~  Global("Deionarra","GLOBAL",1) !Global("Current_Area","GLOBAL",1203) !Global("Current_Area","GLOBAL",1200)
    nr 'De nouveau, Deionarra se matérialise… cette fois, le désespoir se lit sur son visage, et ses bras tendus semblent essayer d„atteindre quelque chose. Elle disparaît peu à peu, et sur son visage, le désespoir se transforme en soulagement. "Mon Amour… tu m“es revenu ! Serait-ce possible que la mémoire te soit revenue ?"~ [DEN003A]{#deionarra_s5_1}'
...
label deionarra_s6: # from 3.0
    nr '"Je le craignais. Je n„existe plus pour toi… C“était pour toi un inconvénient. Maintenant, tu as une excuse pour te débarrasser de moi !"{#deionarra_s6_1}'
...
label deionarra_s7: # from 3.1
    nr '"Oui…" dit-elle pleine d„espoir. "Quels souvenirs mon nom évoque-t-il ?"{#deionarra_s7_1}'
...
label deionarra_s8: # from 7.0 47.2
    nr 'Le visage de Deionarra se change en masque de colère. "Espèce de chien lépreux ! Traître de mon cœur ! J„aimerais te maudire mais cela serait inutile car tu es déjà pourchassé par ce tourment qui hante toutes tes réincarnations ! Pars !" Elle croise les bras et ferme les yeux.{#deionarra_s8_1}'
...
label deionarra_s9: # from 3.2 3.3 6.1 6.2 7.1 7.2 7.3
    nr '"Oh, le destin a enfin pitié ! Même la mort ne réussit pas à me chasser de ton esprit, mon Amour ! Ne vois-tu pas ? Ta mémoire reviendra ! Dis-moi comment t„aider et je le ferai !"{#deionarra_s9_1}'
...
label deionarra_s10: # from 5.0 11.1 12.1 13.1 14.0 25.1 27.2 28.0 30.0 31.1 32.0 34.1 35.1 36.0 41.1 42.0 43.1 44.2 74.0
    nr '"Que désires-tu savoir ?"{#deionarra_s10_1}'
...
label deionarra_s11: # from 6.0 9.0 10.1
    nr '"Tu es à la fois béni et maudit, mon Amour. Et tu es celui qui hante à jamais mes pensées et mon cœur !"{#deionarra_s11_1}'
...
label deionarra_s12: # from 9.1 10.2
    nr '"Où tu es ? Eh bien, tu es ici, avec moi, mon Amour… comme au temps où nous étions en vie. Désormais, la Frontière Éternelle nous sépare."{#deionarra_s12_1}'
...
label deionarra_s13: # from 11.0
    nr '"La nature de ta malédiction semble claire, mon Amour. Regarde-toi." Elle te désigne du doigt. "La mort ne veut pas de toi. Tes souvenirs t„ont abandonné. Tu ne t“es jamais demandé pourquoi ?"{#deionarra_s13_1}'
...
label deionarra_s14: # from 12.0
    nr 'Deionarra a l„air triste. "C“est une barrière que tu ne franchiras jamais, mon Amour. C„est une barrière entre ta vie et ce qu“il reste de la mienne."{#deionarra_s14_1}'
...
label deionarra_s15: # from 3.4 5.1 6.3 6.4 7.4 9.4 10.7 11.2 12.2 13.3 14.1 25.2 27.3 28.1 28.3 30.1 31.2 32.1 41.2 41.3 42.1 42.2 43.3 44.3 47.3
    nr '"Attends… j„ai beaucoup appris en voyageant avec toi, mon Amour. Ce que tu as perdu, je l“ai gagné. Je ne t„ai pas révélé tout ce que je savais. Je vois clair… alors que tu tâtonnes dans l“obscurité en quête d„une étincelle de raison."{#deionarra_s15_1}'
...
label deionarra_s16: # from 20.0 21.0
    nr 'Deionarra semble interloquée. Puis le ton de sa voix change et se fait presque implorant. "Mon but n„est pas de t“arracher un serment, mon Amour. Mais j„ai attendu si longtemps que tu me rejoignes…"{#deionarra_s16_1}'
...
label deionarra_s17: # from 15.1 15.2
    nr '"Le temps relâche son emprise et le frisson de l„oubli nous appelle doucement, mon Amour. Des images furtives de l“avenir se pressent devant mes yeux. Je te vois, mon Amour, comme aujourd„hui et…" Deionarra se tait.{#deionarra_s17_1}'
...
label deionarra_s18: # from 17.0 17.1
    nr '"Je vois ton avenir. Il ondule à travers les plans et se répand. Dois-je te dire ce que je vois ?"{#deionarra_s18_1}'
...
label deionarra_s19: # from 17.2 18.1
    nr '"Tu as toujours été ainsi, mon Amour. Tu refusais de tenir compte de l„appel de la mort. Le temps sera-t-il le prochain à être éconduit ?" Elle ferme les yeux et, dans un mouvement éthéré, disparaît.{#deionarra_s19_1}'
...
label deionarra_s20: # from 18.0
    nr '"Avant tout, j„exige une promesse. Promets-moi de revenir, de trouver un moyen de venir me sauver ou de me rejoindre."{#deionarra_s20_1}'
...
label deionarra_s21: # from 20.1
    nr 'Deionarra croise les bras. "En effet, mon Amour. Le prix de l„immortalité n“était visiblement pas assez élevé. L„intégrité est-elle trop pénible pour ceux de ton espèce ?"{#deionarra_s21_1}'
...
label deionarra_s22: # from 10.5 20.2 20.5 21.1 21.4 40.0
    nr '"Voici ce que mes yeux voient, mon Amour, libérés des chaînes du temps…"~ [DEN020]{#deionarra_s22_1}'
...
label deionarra_s23: # from 22.0
    nr '"Trois ennemis, tu rencontreras, mais aucun d„eux ne te surpassera dans ta pleine gloire. Ombres du mal, du bien et de la neutralité, elles sont issues des lois des plans et n“obéissent qu„à elles."~ [DEN021]{#deionarra_s23_1}'
...
label deionarra_s24: # from 23.0
    nr '"Tu arriveras à une prison de regrets et de douleur où les ombres elles-mêmes sont devenues folles. Un terrible sacrifice te sera alors demandé, mon Amour. Pour trouver le repos, il te faudra détruire ce qui te maintient en vie et sacrifier ton immortalité."~ [DEN022]{#deionarra_s24_1}'
...
label deionarra_s26: # from 3.5 4.1 6.5 6.6 7.5 15.0 15.3 20.3 21.2 21.5 28.2 47.4
    nr 'Deionarra a l„air furieuse. "Alors pars, comme tu l“as fait tant de fois ! Viens-tu uniquement pour me tourmenter ? Pars et ne reviens jamais !" Elle ferme les yeux, et dans un mouvement éthéré, disparaît.{#deionarra_s26_1}'
...
label deionarra_s27: # from 13.0
    nr '"Un jour, tu as déclaré que tu m„aimais et que tu m“aimerais jusqu„à ce que la mort nous sépare. Je l“ai cru, ignorant la vérité sur toi, sur ce que tu étais."{#deionarra_s27_1}'
...
label deionarra_s28: # from 27.0
    nr 'Elle ouvre la bouche pour parler mais aucun son n„en sort. Elle paraît troublée un moment. "Je… ne peux pas en parler. Je…" Sa voix se brise. "Demande-moi n“importe quoi sauf ça."{#deionarra_s28_1}'
...
label deionarra_s29: # from 24.0
    nr '"Je sais que tu dois mourir… pendant que tu le peux encore. La boucle *doit* être bouclée, mon Amour. Cette vie n„est pas pour toi. Tu dois retrouver ce qui t“a été pris et voyager dans l„au-delà, dans les plaines de la mort."~ [DEN023]{#deionarra_s29_1}'
...
label deionarra_s30: # from 25.0
    nr '"Je ne sais pas vraiment. Mais cela dure depuis trop longtemps."{#deionarra_s30_1}'
...
label deionarra_s31: # from 45.0
    nr '"Les portes sont les orifices de l„existence qui mènent à des lieux dans les plans intérieurs et extérieurs… Si tu trouves la bonne clé, tu peux t“échapper par l„une d“entre elles."{#deionarra_s31_1}'
...
label deionarra_s33: # from 4.0
    nr '"Je n„ai rien à te répondre ! Ton cœur infidèle t“a emmené jusque-là, qu„il te guide jusqu“au bout du chemin ! Maintenant, disparais !"{#deionarra_s33_1}'
...
label deionarra_s35: # from 33.0
    nr 'L„expression furieuse qui se lit sur le visage de Deionarra fond comme de l“eau… la vitesse de la métamorphose est aussi effrayante que l„expression désespérée qui se lit maintenant sur son visage. "Non… non, non… Je suis toujours la Deionarra de ton souvenir, mon Amour. Pardonne-moi, je t“en supplie."{#deionarra_s35_1}'
...
label deionarra_s36: # from 34.0 35.0
    nr 'Sa voix devient un murmure. "Oui… oui, je t„en conjure. Ne pars pas." Son expression suppliante te fait légèrement trembler… non pas de peur, mais de plaisir. Il te semble que ce n“est pas la première fois que tu manipules cette femme.{#deionarra_s36_1}'
...
label deionarra_s37: # from 33.1 47.0
    nr '"Moi, te *repousser* ?! Tu OSES m„accuser de te REPOUSSER ?!" Deionarra décrit un arc de cercle avec ses bras, puis les ramène devant elle, l“index de chaque main te désignant, comme si elle faisait acte de sorcellerie. "Tu OSES…!"{#deionarra_s37_1}'
...
label deionarra_s39: # from 38.0 38.1
    nr '"Une fois prononcée, cette malédiction ne peut plus être annulée." La voix de Deionarra devient un sifflement. "N„oublie pas : j“ai toute l„éternité, mon Amour. J“attendrai ton arrivée aux portes de la mort." Elle sourit, mais il n„y a aucune joie dans ce sourire. "Nous nous *retrouverons*."{#deionarra_s39_1}'
...
label deionarra_s40: # from 16.0 20.4 21.3
    nr 'Deionarra se raidit. Elle semble sur le point de dire quelque chose, puis soupire d„un air désespéré. "Fort bien, mon Amour… comme toujours, je vais devoir te faire confiance." Elle ferme les yeux.{#deionarra_s40_1}'
...
label deionarra_s41: # from 10.6
    nr 'Deionarra secoue la tête d„un air triste. "Une fois lancée, cette malédiction ne peut plus être annulée. Pardonne-moi, mon Amour."{#deionarra_s41_1}'
...
label deionarra_s42: # from 41.0
    nr '"Si c„est le cas, je ne les connais pas." Deionarra a l“air pleine d„espoir. "Mais j“en connais des plus puissants que moi qui seraient peut-être capables de la lever. Une fois de plus, je te demande pardon, mon Amour. Je ne sais pas ce que j„ai fait."{#deionarra_s42_1}'
...
label deionarra_s43: # from 9.2 10.3 44.0
    nr '"Partir… ?" La voix de Deionarra devient un sifflement, puis redevient plus forte. "*Partir* ?! C„est à moi, qui suis prisonnière ici à cause de toi, que tu demandes comment *partir* d“ici ?!"{#deionarra_s43_1}'
...
label deionarra_s44: # from 9.3 10.4
    nr 'Alors que tu es sur le point de poser la question à Deionarra, ta gorge reste nouée. Il te semble que, si tu lui avoues que tu cherches un moyen de t„échapper, elle pensera que tu l“abandonnes. Si tu veux lui demander comment partir, tu dois le faire avec tact.{#deionarra_s44_1}'
...
label deionarra_s45: # from 46.0 46.1
    nr '"Je sens que cet endroit recèle de nombreuses portes invisibles à l„œil humain. Peut-être pourrais-tu utiliser l“une d„entre elles pour t“échapper."{#deionarra_s45_1}'
...
label deionarra_s47: # from 43.0
    nr '"Tu viens à moi dans la mort, juste pour me dire que tu as besoin de mon aide pour pouvoir m„abandonner *encore* ?!" Son visage est un masque de colère. "Je suis *morte* pour toi, mon Amour. J“en *souffre* encore aujourd„hui !"{#deionarra_s47_1}'
...
label deionarra_s48: # from 33.5 39.0 39.1
    nr 'Deionarra ferme les yeux, et, dans un souffle éthéré, disparaît.{#deionarra_s48_1}'
...
label deionarra_s49: # - # IF WEIGHT #3 ~  Global("Deionarra","GLOBAL",0) Global("Current_Area","GLOBAL",1203)
    nr 'Tu vois devant toi une silhouette fantomatique absolument magnifique. Elle a de long cheveux flottants et sa robe est agitée par une sorte de brise éthérée. Ses yeux se posent sur toi et tu ressens une étrange sensation, comme si tu regardais plusieurs paires d„yeux en même temps.{#deionarra_s49_1}'
...
label deionarra_s50: # - # IF WEIGHT #4 ~  GlobalGT("Deionarra","GLOBAL",0) Global("Current_Area","GLOBAL",1203)
    nr 'Devant toi, se tient la silhouette fantomatique de Deionarra. Sa robe immatérielle est agitée par une sorte de brise éthérée. Ses yeux se posent sur toi et tu ressens une étrange sensation comme si tu regardais plusieurs paires d„yeux en même temps.{#deionarra_s50_1}'
...
label deionarra_s51: # from 49.0 50.0
    nr '"Mon amour, enfin je t„ai *trouvé*… Je te cherche depuis que ce cristal t“a dissocié - cette Forteresse est grande de plusieurs kilomètres et je craignais de t„avoir perdu." Ses yeux fantomatiques t“examinent à l„affût de nouvelles blessures. "Est-ce que tu vas bien ?"{#deionarra_s51_1}'
...
label deionarra_s52: # from 51.0
    nr '"Je pense que le véritable objectif du cristal était de t„emprisonner ici. Mais ce n“est pas un obstacle pour un être comme moi." Elle ferme les yeux. "Mes yeux perçoivent beaucoup de choses et je connais bien les couloirs de cette Forteresse."{#deionarra_s52_1}'
...
label deionarra_s53: # from 52.0 58.0 59.0
    nr '"Si tu es emprisonné ici, mon Amour, je ferai en sorte que tu sois libéré. Où souhaites-tu aller ?"{#deionarra_s53_1}'
...
label deionarra_s54: # from 53.0 53.1 53.2 53.3
    nr '"Comme tu le désires, mon Amour." Elle tend une main vers toi. "Touche ma main et les murs de cette Forteresse n„existeront plus."{#deionarra_s54_1}'
...
label deionarra_s55: # from 53.4
    nr '"De quoi parles-tu ?"{#deionarra_s55_1}'
...
label deionarra_s56: # from 55.0
    nr 'Alors que tu prononces ces mots, le visage de Deionarra n„est plus qu“un masque.{#deionarra_s56_1}'
...
label deionarra_s57: # from 56.0 56.1 56.2
    nr '"M„aimes-tu ? Si tu réponds oui, mon Amour, alors rien de ce qui s“est passé n„a d“importance."{#deionarra_s57_1}'
...
label deionarra_s58: # from 55.1 57.0 57.1
    nr '"Alors je t„aiderai, mon Amour. Dis-moi comment et je le ferai."{#deionarra_s58_1}'
...
label deionarra_s59: # from 57.2
    nr '"Alors… tout sera fini entre nous, mon amour. Je suis restée ici pour toi, pour nulle autre raison. Je t„aiderai une dernière fois, puis je franchirai la Frontière Éternelle comme j“aurais déjà dû le faire."{#deionarra_s59_1}'
...
label deionarra_s60: # - # IF WEIGHT #6 /* Triggers after states #: 62 even though they appear after this state */ ~  Global("Deionarra","GLOBAL",0) Global("Current_Area","GLOBAL",1200) Global("1200_Cut_Scene_2","GLOBAL",0)
    nr 'Tu vois devant toi une silhouette fantomatique absolument magnifique. Elle a de long cheveux flottants et sa robe est agitée par une sorte de brise éthérée. Elle se tient à la limite de la chaussée de pierres noires, le regard perdu dans le vide du plan.{#deionarra_s60_1}'
...
label deionarra_s61: # - # IF WEIGHT #7 /* Triggers after states #: 62 even though they appear after this state */ ~  GlobalGT("Deionarra","GLOBAL",0) Global("Current_Area","GLOBAL",1200) Global("1200_Cut_Scene_2","GLOBAL",0)
    nr 'Devant toi se tient la silhouette fantomatique de Deionarra. Sa robe immatérielle est agitée par une sorte de brise éthérée. Elle se tient à la limite de la chaussée de pierres noires, le regard perdu dans le vide du plan.{#deionarra_s61_1}'
...
label deionarra_s62: # from 60.0 61.0 # IF WEIGHT #5 ~  Global("Current_Area","GLOBAL",1200) Global("1200_Cut_Scene_2","GLOBAL",1)
    nr '"Mon Amour ! Tu ne devrais *pas* être ici ! Tu dois partir !"{#deionarra_s62_1}'
...
label deionarra_s63: # from 62.0 62.1
    nr '"C„est la Forteresse des Regrets. C“est l„endroit où l“instant de ma mort est retenu prisonnier et je ne peux m„éloigner de ses corridors. Si tu trouves un moyen de retourner à Sigil, utilise-le ; si tu restes ici, mon Amour, tu mourras."{#deionarra_s63_1}'
...
label deionarra_s64: # from 63.0 63.1 63.2
    nr 'Elle secoue la tête. "Non, mon Amour. Cette Forteresse a quelque chose de particulier - l„aura qui l“entoure l„isole du reste des plans. C“est cette aura qui est une barrière à ton immortalité."{#deionarra_s64_1}'
...
label deionarra_s66: # from 64.0 65.0
    nr '"Aussi, si tu meurs ici, c„est la fin, car rien ne vit en ces lieux - tu dois donc être prudent. Retourne à Sigil, quitte cet endroit maudit !"{#deionarra_s66_1}'
...
label deionarra_s67: # from 66.0 66.1
    nr '"Mon Amour, si tu as amené *quelque chose* de vivant ici, elle est en danger - à cause des ombres mais aussi à cause de toi. Si tu devais mourir ici, ton immortalité chercherait la chose vivante la plus proche, et elle mourra à ta place. Tu dois partir, maintenant !"{#deionarra_s67_1}'
...
label deionarra_s68: # from 66.2 66.3 67.0
    nr '"Il n„y a pas de ténèbres naturelles dans la Forteresse, mon Amour, seules les ombres de ceux qui sont morts à ta place. Les énergies de ce plan les nourrissent et leur haine pour toi ne connaît aucune limite. Elles ne te permettront pas de partir." Elle jette un regard aux murs de la Forteresse . "N“entre pas, je t„en supplie !"{#deionarra_s68_1}'
...
label deionarra_s69: # from 68.0 68.1
    nr '"Si tu es venu avec d„autres, ils ont été séparés de toi à ton arrivée - c“est dans la nature de cet endroit de séparer les êtres vivants… puis de les tuer." Elle semble affolée. "La Forteresse est grande de plusieurs kilomètres - y trouver tes amis sera difficile."{#deionarra_s69_1}'
...
label deionarra_s71: # from 70.0
    nr '"L„anneau contient encore une partie de moi, mon Amour. Quand tu le portes, tu portes mon cœur avec toi." Elle ferme les yeux un moment et, soudain, tu te sens baigné de chaleur. Deionarra ouvre les yeux, puis sourit. "Je savais que tu reviendrais vers moi avec. Maintenant conserve-le avec ma bénédiction et garde-le près de ton cœur. Par son intermédiaire, je te défendrai."{#deionarra_s71_1}'
...
label deionarra_s73: # from 72.0
    nr 'Alors que Deionarra te parle, tu ressens une étrange sensation au niveau de la nuque. Quelque chose te pousse à regarder ta main et, quand tu le fais, tu vois par transparence le sang qui coule lentement dans tes veines pour irriguer tes muscles et donner vie à ton corps…{#deionarra_s73_1}'
...
label deionarra_s74: # from 73.0
    nr 'Et tu sais que Deionarra a raison. Tu te rappelles soudain comment trouver et faire renaître la moindre étincelle de vie, ce qui t„intrigue et te fascine à la fois.  ^NREMARQUE : tu viens de te rappeler comment ramener les autres à la vie. Pour utiliser le pouvoir, clique sur “Capacité spéciale„ dans le menu rapide. Seuls peuvent bénéficier de ce pouvoir les membres de ton groupe qui sont morts en ta présence ; il ne fonctionne pas sur les individus qui ne t“accompagnent pas dans ta quête, ni sur les compagnons que tu retires de ton groupe une fois morts.^-{#deionarra_s74_1}'
...
label deionarra_s75: # from 68.2 69.0
    nr '"Très bien, mon amour. Si tu souhaites continuer, il faut que tu saches ceci : une fois l„entrée de la forteresse franchie, tu te retrouveras dans une grande antichambre emplie d“ombres. Dépêche-toi et ne les laisse surtout pas se rassembler autour de toi, sans quoi tu mourras !"{#deionarra_s75_1}'
