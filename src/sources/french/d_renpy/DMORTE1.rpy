...
label morte1_s0: # - # IF WEIGHT #1 /* Triggers after states #: 26 even though they appear after this state */ ~  !InParty("Morte") Global("Morte","GLOBAL",0)
    nr '"Hé, chef, ça va ? Tu fais l„mort ou t“essaies d„bluffer les Hommes-Poussière ? J“ai vraiment cru qu„t“étais clamsé."~ [MRT001]{#morte1_s0_}'
...
label morte1_s1: # from 0.0
    nr '"Euh… qui *je* suis ? Et pourquoi *tu* ne commencerais pas ? Qui tu es, toi ?"{#morte1_s1_}'
...
label morte1_s2: # from 1.0 3.0 4.0
    nr '"Tu ne te souviens pas de ton *nom* ? Hé ben ! La PROCHAINE fois que tu passes la nuit dans ce bled, vas-y doucement sur la bibe. J„m“appelle Morte. Moi aussi, j„suis piégé ici."{#morte1_s2_}'
...
label morte1_s3: # from 1.1
    nr '"Ouais, et je t„ai demandé en *deuxième*. Comment tu t“appelles ?"{#morte1_s3_}'
...
label morte1_s4: # from 3.1
    nr '"Pffff… c„que t“es têtu. Très bien, c„est *moi* qui vais jouer les gentils. Je m“appelle Morte. Et toi ?"{#morte1_s4_}'
...
label morte1_s5: # from 2.0
    nr '"Ouais, comme t„as pas encore eu le temps de te remettre d“aplomb, voilà la chanson : j„ai essayé toutes les portes et cette salle est fermée à clé plus sûrement qu“une ceinture de chasteté."{#morte1_s5_}'
...
label morte1_s6: # from 5.0
    nr '"Ça s„appelle la “Morgue„… c“est un grand édifice noir avec tout le charme architectural d„une araignée pleine."{#morte1_s6_}'
...
label morte1_s7: # from 6.0
    nr '"Pas de mon point de vue. Tu as plein de cicatrices… on dirait qu„un bige t“a peint avec un couteau. Raison de plus pour jouer un air à cet endroit avant que celui qui a commencé la gravure revienne finir son boulot."{#morte1_s7_}'
...
label morte1_s8: # from 7.0
    nr '"Ben… les trucs gravés sur ta poitrine ne sont pas TROP moches… mais ceux que tu as dans le dos…" Morte s„interrompt. "En gros, on dirait que tu as une galerie entière de tatouages sur le dos, chef. Comme si ça voulait dire quelque chose…"{#morte1_s8_}'
...
label morte1_s9: # from 8.0
    nr '"Hé ! C„est comme si t“avais été livré avec le mode d„emploi…" Morte s“éclaircit la voix. "Voyons… ça commence par…  „Je sais que tu as l“impression d„avoir bu plusieurs barils d“eau du Styx, mais il faut te RESSAISIR. Parmi tes biens, tu dois avoir un JOURNAL qui pourra éclaircir le soltif de cette affaire. PHAROD devrait pouvoir te donner les dernières notes de la chanson, s„il n“est pas déjà inscrit dans le livre des morts.„{#morte1_s9_}'
...
label morte1_s11: # from 10.0
    nr '"Non… t„étais nu comme un ver quand t“es arrivé ici. De toute façon, t„as déjà un journal écrit sur le corps."{#morte1_s11_}'
...
label morte1_s12: # from 11.0
    nr '"Ça m„dit rien… mais ceci dit, j“connais pas grand monde. Enfin, y a bien un bige qui doit savoir où trouver Pharod… euh, une fois qu„on sera sorti d“ici, j„veux dire."{#morte1_s12_}'
...
label morte1_s13: # from 12.0
    nr '"Bon, toutes les portes sont fermées, nous avons donc besoin de la clé. Il y a des chances qu„un des cadavres errants ici l“ait."{#morte1_s13_}'
...
label morte1_s14: # from 13.0
    nr '"Ouais, les gardiens de la Morgue utilisent les corps morts comme main-d„œuvre bon marché. Les cadavres sont aussi muets que des pierres, ils sont inoffensifs et n“attaqueront que si tu les provoques."{#morte1_s14_}'
...
label morte1_s15: # from 14.0
    nr '"Quoi, tu penses que ça va les vexer ? Ils sont MORTS. Mais le point positif, c„est que si tu les tues, ils pourront au moins se reposer avant que leurs gardiens les ressuscitent pour les remettre au travail."{#morte1_s15_}'
...
label morte1_s16: # from 14.1 15.0
    nr '"Bon, avant de faire ça, arme-toi. Je crois avoir vu un scalpel sur une des étagères par ici."  ^NREMARQUE : Fouille les étagères dans la pièce et trouve une arme pour attaquer les zombis. <SEARCH_WEAPON>^-{#morte1_s16_}'
...
label morte1_s18: # - # IF WEIGHT #2 /* Triggers after states #: 26 even though they appear after this state */ ~  Global("Mortuary_Walkthrough","GLOBAL",0) !PartyHasItem("Scalpel") Global("ZM782_Dead_KAPUTZ","GLOBAL",0)
    nr '"Il devrait y avoir un scalpel sur l„une de ces étagères. Je le trouverais avant d“en découdre avec un de ces cadavres."  ^NREMARQUE : Fouille les étagères dans la pièce et trouve une arme pour attaquer les zombis. <SEARCH_WEAPON>^-{#morte1_s18_}'
...
label morte1_s19: # - # IF WEIGHT #3 /* Triggers after states #: 26 even though they appear after this state */ ~  Global("Mortuary_Walkthrough","GLOBAL",0) PartyHasItem("Scalpel") Global("ZM782_Dead_KAPUTZ","GLOBAL",0)
    nr '"Bien, tu as trouvé le scalpel ! Bon, va chercher ces cadavres… et ne t„en fais pas, je resterai derrière et te fournirai de précieux conseils tactiques."{#morte1_s19_}'
...
label morte1_s20: # from 19.0
    nr '"Je t„aiderai. Les bons conseils ne sont pas si évidents."{#morte1_s20_}'
...
label morte1_s21: # from 20.0
    nr '"Moi ? Mais je suis un romantique, pas un soldat. Je te gênerai."{#morte1_s21_}'
...
label morte1_s22: # from 21.0
    nr '"Bon… d„accord. Je vais t“aider."  ^NREMARQUE : si tu veux que Morte t„aide à attaquer, il te suffit de vérifier que vous êtes tous deux sélectionnés lorsque vous attaquez le cadavre. Morte se joindra à l“attaque.^-{#morte1_s22_}'
...
label morte1_s23: # from 19.1 20.1 21.1 22.0
    nr '"Le moment est venu de renvoyer ces cadavres dans l„au-delà…"  ^NREMARQUE : <ATTACKNOTE>^-{#morte1_s23_}'
...
label morte1_s24: # - # IF WEIGHT #4 /* Triggers after states #: 26 even though they appear after this state */ ~  Global("Mortuary_Walkthrough","GLOBAL",0) !PartyHasItem("KeyPr") Global("ZM782_Dead_KAPUTZ","GLOBAL",1)
    nr '"D„accord, on dirait que tu t“es occupé du bon cadavre. Maintenant il faut que tu trouves la clé. Elle aurait dû être sur lui. Une fois qu„on l“aura, on pourra sortir d„ici."  ^NREMARQUE : <DEADPILE>^-{#morte1_s24_}'
...
label morte1_s25: # - # IF WEIGHT #5 /* Triggers after states #: 26 even though they appear after this state */ ~  Global("Mortuary_Walkthrough","GLOBAL",0) PartyHasItem("KeyPr")
    nr '"Parfait, voilà la clé. Elle doit rentrer dans le verrou de l„une des portes de la salle."{#morte1_s25_}'
...
label morte1_s26: # - # IF WEIGHT #0 ~  !InParty("Morte") GlobalGT("Morte","GLOBAL",0)
    nr '"Je savais que tu reviendrais, chef ! T„as finalement réalisé que t“avais besoin de moi, hein ?"~ [MRT516]{#morte1_s26_}'
...
label morte1_s27: # from 26.1
    nr '"Hmmff. Bien, je ne sais pas combien de temps je vais attendre ici, alors je vais te donner un DERNIÈRE chance. Tu es sûr que tu ne veux pas de mes sages conseils et de mon vif esprit ?"{#morte1_s27_}'
...
label morte1_s28: # from 27.0 27.2
    nr '"Est-ce que tu essaies de me vexer, chef ? Qu„est-ce qu“il y a, c„est quelque chose que j“ai dit ? Le fait que je n„aie pas de bras ? Quoi ?"{#morte1_s28_}'
...
label morte1_s29: # from 28.1
    nr '"Bien, je ne vais pas attendre pour TOUJOURS, alors tu ferais mieux de revenir, dès que tu auras changé d„avis."{#morte1_s29_}'
...
label morte1_s30: # - # IF WEIGHT #6 ~  Global("Mortuary_Walkthrough","GLOBAL",1)
    nr '"Qu„est-ce qui te dérange, chef ?"~ [MRT515]{#morte1_s30_}'
...
label morte1_s31: # externs zm825_s3 zm825_s0 zm569_s3 zm569_s0
    nr '"Euh, chef… Ils ne peuvent pas t„entendre, d“accord ? Ils sont morts."{#morte1_s31_}'
...
label morte1_s32: # from 31.0
    nr '"Ouais, mais *je suis* spécial. Ce n„est pas la mort qui pourrait m“ôter mon goût de vivre. Ces cadavres, là…" Morte roule les yeux. "Ils ne devaient déjà pas avoir beaucoup de personnalité à l„origine."{#morte1_s32_}'
...
label morte1_s33: # from 32.0
    nr '"Écoute, chef… Te regarder essayer de parler avec ces cadavres, c„est pas très bon pour mon moral. Laissons ça aux azimutés, d“accord ?"{#morte1_s33_}'
...
label morte1_s34: # externs zm782_s0
    nr '"On dirait que c„est le suppliant chanceux, chef. Regarde… Il tient la clé dans sa main."{#morte1_s34_}'
