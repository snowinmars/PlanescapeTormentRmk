class SoegoLogic:
    ...
    def j63982_s1_r1438_action(self):
        ...
        #$% .register('63982', 'J'ai rencontré un Homme-Poussière du nom de Soego à l'entrée de la Morgue. Il a l'air épuisé, comme s'il n'avait pas dormi depuis plusieurs semaines. À en juger par ses yeux enfoncés dans leurs orbites et la pâleur de sa peau, je dirais qu'il est malade.') %$#
    ...
    def j21805_s71_r21800_action(self):
        ...
        #$% .register('21805', 'Soego m'a conseillé de ne pas attaquer les morts-vivants des Nations Mortes, car ils ne me feront aucun mal tant que je les laisserai en paix.') %$#
    ...
    def r21852_action(self):
        ...
        #$%.register('21856', 'J'ai trouvé Soego. Il était atteint de lycanthropie, ce qui l'a conduit dans les catacombes. Son esprit ne lui appartenait déjà plus et il avait perdu ses croyances d'Homme-Poussière. %$#')
    ...
    def r21853_action(self):
        ...
        #$%.register('21857', 'Soego m'a dit qu'il ne savait pas comment pénétrer dans la salle du trône du Roi Silencieux. Mais il faudra bien que j'y parvienne si je veux tuer ce dernier. %$#')
    ...
    def r21915_action(self):
        ...
        #$%.register('21926', 'J'ai interrogé Soego au sujet de son journal. Il s'est transformé en rat-garou et m'a attaqué. %$#')
    ...
    def j25254_s94_r25248_action(self):
        ...
        #$% .register('25254', 'J'ai expliqué à Soego que le Roi Silencieux n'était rien de plus qu'un cadavre desséché. Il m'a dit d'en informer Tant-en-Un et qu'il me donnerait une récompense. Tant-en-Un est l'esprit des rats-crâne de la Ruche, dans les Dédales de la Pensée, à l'est des catacombes de la Pierre Pleureuse.') %$#
    ...
    def j21996_s94_r21994_action(self):
        ...
        #$% .register('21996', 'J'ai expliqué à Soego que le Roi Silencieux n'était rien de plus qu'un cadavre desséché. Il faudra que je prévienne Tant-en-Un moi-même dès que j'en aurai l'occasion.') %$#
    ...
    def r22051_action(self):
        ...
        #$%.register('22052', 'J'ai trouvé Soego. Il a découvert un groupe de gardiens morts-vivants qui gardaient les catacombes. Il essaie de les convaincre de rejoindre la Vraie Mort. %$#')
