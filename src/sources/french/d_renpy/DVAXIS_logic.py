class VaxisLogic:
    ...
    def j64513_s2_r464_action(self):
        ...
        #$% .register('64513', 'L'un des zombis du premier étage de la Morgue était en fait un homme déguisé. Mais quant à savoir qui peut avoir envie de se faire passer pour un zombi…') %$#
    ...
    def r4469_action(self):
        ...
        #$%.register('64517', 'J'ai dit à l'espion déguisé que j'étais là pour le remplacer et il m'a remis tout ce qu'il avait trouvé, c'est-à-dire principalement des bandages et des objets curatifs. Il devait en avoir besoin pour maintenir le change. %$#')
    ...
    def j64519_s36_r64520_action(self):
        ...
        #$% .register('64519', 'En échange de l'aide du "zombi", j'ai accepté d'aller chercher une clé d'embaumement auprès de la femme Homme-Poussière embaumeuse que j'ai rencontrée dans l'autre pièce (Ei-Vene, je crois…). J'ai du mal à comprendre comment elle peut se servir d'une clé, vu qu'elle a des lames en guise de doigts.') %$#


    def j64518_s36_r4503_action(self):
        self.state_manager.journal_manager.update_journal('64518')
        #$% .register('64518', 'En échange de l'aide du "zombi", j'ai accepté d'aller chercher une clé d'embaumement auprès d'une femme Homme-Poussière aux yeux jaunes et ayant des lames en guise de doigts.') %$#
    ...
    def r4521_action(self):
        ...
        #$%.register('64521', 'J'ai obtenu la clé d'embaumement que Vaxis désirait tant. Si j'en juge par l'odeur de lotion d'embaumement qu'il dégage, il doit s'en servir pour aller chercher de quoi maintenir le change en renouvelant son déguisement. %$#')
    ...
    def j64522_s44_r4539_action(self):
        ...
        #$% .register('64522', 'On dirait que les Hommes-Poussière et Pharod ne sont pas en très bons termes. Vaxis m'a expliqué que Pharod apportait énormément de cadavres à la Morgue et que les Hommes-Poussière le soupçonnaient de tuer les gens avant leur heure.') %$#
    ...
    def r64527_action(self):
        ...
        #$%.register('64528', 'Vaxis m'a dit qu'il y avait un portail secret dans la pièce située au nord-ouest du rez-de-chaussée de la Morgue. Il suffit d'y amener un os de doigt tordu pour qu'il s'active et mène à une crypte secrète où Vaxis dit que je pourrai me reposer. Il ignore où trouver l'os nécessaire, mais m'a conseillé d'essayer l'étage supérieur de la Morgue. %$#')
    ...
    def r4568_action(self):
        ...
        #$%.register('64529', 'Vaxis m'a dit qu'il y avait un portail secret dans la pièce située au nord-ouest du rez-de-chaussée de la Morgue. Il suffit d'y amener un os de doigt tordu pour qu'il s'active et mène à une crypte secrète où Vaxis dit que je pourrai me reposer. %$#')
    ...
    def r4580_action(self):
        ...
        #$%.register('64530', 'Vaxis m'a dit que Soego était bizarre et qu'il aimait les rats. J'ignore ce que cela signifie, mais je trouve ironique que Vaxis puisse accuser qui que ce soit d'être bizarre… %$#')
    ...
    def j64531_s67_r4638_action(self):
        ...
        #$% .register('64531', 'En échange de fil, d'une aiguille et de lotion d'embaumement, Vaxis m'a déguisé en zombi. Il m'a prévenu que je ne devais pas courir si je ne voulais pas me faire remarquer, et qu'il ne fallait pas non plus que j'ouvre la bouche, car les zombis ne parlent pas.') %$#
