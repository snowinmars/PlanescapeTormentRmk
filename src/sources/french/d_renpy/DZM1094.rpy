...
label zm1094_s0: # - # IF ~  Global("Asonje","GLOBAL",0)
    nr 'Le numéro „1094“ est gravé sur le front de ce cadavre errant. Ses lèvres sont cousues, et l„odeur chimique de formol frais flotte dans l“air sous la forme d„un nuage. Malgré ses formes floues et sans vie et ses yeux laiteux, ce corps devait être autrefois celui d“un beau jeune homme.{#zm1094_s0_}'
...
label zm1094_s1: # from 0.0 0.1 0.2
    nr 'Le cadavre continue à te fixer.{#zm1094_s1_}'
...
label zm1094_s3: # from 2.0
    nr 'Soudain, l„esprit s“aperçoit de ta présence et te dédie un sourire désarmant qui fait sauter tous les points de suture autour de sa bouche. Étonné, il porte la main à ses lèvres, hausse les épaules et te salue d„un hochement de tête. "Où… où suis-je ? Drôle d“endroit ! On se connaît ?" Il a un petit toussotement et masse sa gorge roide.{#zm1094_s3_}'
...
label zm1094_s4: # from 3.0
    nr 'Il se départit aussitôt de son attitude cordiale. Il t„observe un long moment, sourcils froncés ; des lambeaux de fil de suture pendent à ses lèvres grises et parcheminées. "Très bien, pose donc tes questions." Il détourne la tête, comme s“il s„ennuyait.{#zm1094_s4_}'
...
label zm1094_s5: # from 4.0 11.0
    nr '"Je m„appelais Asonje. Puis-je disposer ?"{#zm1094_s5_}'
...
label zm1094_s6: # from 4.1 11.1
    nr '"Je ne m„en souviens pas. Autre chose ?"{#zm1094_s6_}'
...
label zm1094_s7: # from 4.2 11.2
    nr 'L„esprit hausse les épaules, les yeux au ciel. "Je n“en sais rien. Qu„importe, d“ailleurs ?" Sa bouche dessine un pli amer, et il te dévisage d„un regard dur ; la lueur spectrale au fond de ses orbites prend un éclat furieux. "Autre chose ?"{#zm1094_s7_}'
...
label zm1094_s8: # from 4.3 11.3
    nr '"Mon esprit réside en Arborée…" Il s„interrompt, perdu dans ses souvenirs. "Il me tarde d“y retourner et de mettre fin à cet interrogatoire aussi égoïste que déplacé et lassant. Puis-je disposer ?"{#zm1094_s8_}'
...
label zm1094_s9: # from 4.4 11.4
    nr 'Il te jette un regard exaspéré. "Rien, bien sûr!" Il secoue la tête, agacé ; dans le mouvement, les fils de suture se balancent.{#zm1094_s9_}'
...
label zm1094_s10: # from 4.5 11.5
    nr '"Non." L„esprit ne semble guère te prêter beaucoup d“attention.{#zm1094_s10_}'
...
label zm1094_s11: # from 5.0 6.0 7.0 8.0 9.1 10.0 12.0 27.0
    nr 'Il pousse un grand soupir qui emplit l„atmosphère d“une odeur de formol. "Oui, oui… pose tes questions."{#zm1094_s11_}'
...
label zm1094_s12: # from 9.0
    nr '"Tu en sais autant que moi, mon beau. J„aimerais disposer, à présent, si cela ne t“ennuie pas."{#zm1094_s12_}'
...
label zm1094_s13: # from 3.1
    nr 'Après un temps de réflexion, il s„esclaffe. "Oui ! Voilà qui expliquerait tout, hein ? Je te connais, au fait ?" Il incline la tête pour te dévisager. Tâcher de découvrir ton identité doit lui paraître un jeu.{#zm1094_s13_}'
...
label zm1094_s14: # from 3.2 13.0
    nr 'L„esprit hausse les épaules et sourit. "Tu as peut-être raison ! Que voulais-tu me demander ?" D“un air absent, il entreprend de retirer de ses lèvres les fils de suture brisés qu„il laisse tomber par terre un par un.{#zm1094_s14_}'
...
label zm1094_s15: # from 14.0 22.0
    nr '"Je m„appelais Asonje. Et toi ?"{#zm1094_s15_}'
...
label zm1094_s16: # from 14.2 22.2
    nr '"Je suis de partout et de nulle part ! En vérité, j„ignore où je suis né. J“ai beaucoup voyagé et habité en divers endroits durant ma vie. À présent, j„ai l“Arborée toute entière à explorer…" Il a l„air ravi.{#zm1094_s16_}'
...
label zm1094_s17: # from 14.3 22.3
    nr 'Son sourire s„efface, et il prend un air troublé. "Bizarre… Je n“en sais rien ! Je ne me souviens pas comment je suis mort." Il hausse les épaules. "Peu importe !" Il retrouve son sourire réjoui qui, bien que plaqué sur ce visage cadavérique, a quelque chose de réconfortant.{#zm1094_s17_}'
...
label zm1094_s18: # from 14.4 22.4
    nr '"L„Arborée ! Il n“y a pas plus merveilleux. Jamais dans ma vie de mortel je n„ai vu un lieu aussi vibrant… aussi majestueux…" Il marque une pause, perdu dans ses pensées. "La beauté de cette contrée, de ses habitants… ah, un endroit magnifique. En fait, il me manque déjà, pour dire vrai !"{#zm1094_s18_}'
...
label zm1094_s20: # from 14.6 22.6
    nr 'L„esprit réfléchit. "Non, dit-il, je crains de n“avoir jamais entendu parler de cet homme. Un ami à toi ?"{#zm1094_s20_}'
...
label zm1094_s21: # from 15.0
    nr 'Il paraît surpris. "Curieux ! Et dommage… Comment veux-tu que je t„appelle, alors ?" Il te considère d“un air interrogateur.{#zm1094_s21_}'
...
label zm1094_s22: # from 15.1 16.0 17.0 18.0 19.1 20.0 21.0 23.0 24.0 25.0 26.0
    nr '"Certes. Vas-y !" Il sourit d„un air aimable et attend ta question avec intérêt. Son sourire paraît presque normal, sans les fils de suture.{#zm1094_s22_}'
...
label zm1094_s23: # from 21.1
    nr 'Sentant ta frustration, l„esprit a un rire franc. "Pauvre bougre ! Ce sera donc Adahn, l“ami. Alors, tu as une question à me poser ?"{#zm1094_s23_}'
...
label zm1094_s25: # from 14.1 22.1
    nr '"Je m„appelais Asonje."{#zm1094_s25_}'
...
label zm1094_s26: # - # IF ~  GlobalGT("Asonje","GLOBAL",0) GlobalLT("Asonje","GLOBAL",3)
    nr '"T„es de retour, hein ?" Il affiche un large sourire.{#zm1094_s26_}'
...
label zm1094_s27: # - # IF ~  Global("Asonje","GLOBAL",3)
    nr '"Oh, toi… encore." Il fronce les sourcils et détourne son regard.{#zm1094_s27_}'
