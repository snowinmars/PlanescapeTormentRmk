...
label zm257_s0: # - # IF ~  True()
    nr 'Les yeux de ce cadavre sont rapprochés et il souffre d„un léger strabisme divergent : l“un de ses yeux donne sur la gauche, l„autre sur la droite. Tu peux tout juste déchiffrer le numéro “257„ gravé sur son front meurtri ; on dirait qu“il a reçu plusieurs coups sur la tête, ce qui rend le numéro difficile à déchiffrer.{#zm257_s0_1}'
...
label zm257_s1: # from 0.0 0.1 0.2
    nr 'Il ne semble pas y avoir une seule lueur de compréhension dans les yeux du cadavre ; ils regardent en silence vers la droite et la gauche.{#zm257_s1_1}'
...
label zm257_s3: # from 2.0
    nr 'Le corps possédé sautille et gambade en chantant d„une voix qui enfle et retombe de manière aléatoire. "TU es l“ESPRIT, je suis le VIVANT, tu DOIS répondre à mes QUESTIONS !" Ta perplexité semble le ravir ; il met deux doigts dans sa bouche, l„étire en un affreux sourire avec un rire maniaque tout en tirant une langue blanche qui te paraît très chargée.{#zm257_s3_1}'
...
label zm257_s6: # from 3.2 4.2 5.2
    nr 'Alors que l„esprit déserte le cadavre, ses lèvres déchiquetées s“étirent en un sourire sagace et ses yeux brillants te fixent du regard acéré d„un psychopathe, puis il murmure deux mots, en tout trois syllabes prononcées avec une extrême précision : "Les Limbes…"{#zm257_s6_1}'
...
label zm257_s7: # from 6.0
    nr '… et il disparaît. Tu n„es guère plus avancé, et tu te sens même un peu mal à l“aise. Quant au zombi, il reprend son travail.{#zm257_s7_1}'
