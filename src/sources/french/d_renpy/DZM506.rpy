...
label zm506_s0: # from 3.2 # IF ~  Global("506_Thread","GLOBAL",0)
    nr 'Le mort-vivant couvert de cicatrices va et vient entre deux tables. Le numéro „506“ a été cousu sur son front, sur le côté de son cou et en bien d„autres endroits encore. Tant de lambeaux de chair lui ont été rajoutés de part et d“autre qu„on dirait une carte de la ville en trois dimensions.{#zm506_s0_1}'
...
label zm506_s1: # from 0.1 4.0 4.1 5.0 5.1 5.2
    nr 'Le cadavre regarde droit devant, sans se rendre compte de rien.{#zm506_s1_1}'
...
label zm506_s2: # from 0.2 5.3
    nr 'Le cadavre ne bouge pas. Il a l„air trop absent pour répondre à tes questions.{#zm506_s2_1}'
...
label zm506_s4: # from 3.0
    nr 'Tu coupes le fil à l„aide du scalpel, puis tu ôtes l“aiguille et tu défais les points. Ce faisant, tu remarques que le lambeau de chair qui recouvrait le front s„écarte de lui-même pour révéler la boîte crânienne du cadavre. À ta grande surprise, le numéro “78„ a été gravé au burin dans la partie frontale du crâne.{#zm506_s4_1}'
...
label zm506_s5: # from 4.2 # IF ~  Global("506_Thread","GLOBAL",1)
    nr 'Ce cadavre recousu de toute part va incessamment d„une table à l“autre. Le numéro „506“ a été cousu un peu partout sur son corps, mais le lambeau de chair qui recouvrait son front pend et révèle que le numéro „78“ a été gravé au burin sur la partie frontale de sa boîte crânienne.{#zm506_s5_1}'
