...
label zm782_s0: # - # IF ~  True()
    ...
    menu:
        ...
        '"Je cherche une clé… tu n„en aurais pas une, par hasard ?"{#zm782_s0_r24712}' if zm782Logic.r24712_condition():
            # a1 # r24712
            jump zm782_s1

        'Examine le cadavre et regarde s„il possède une clé.{#zm782_s0_r24713}':
            # a2 # r24713
            jump zm782_s2

        '"Ça m„a fait plaisir de parler avec toi. Au revoir."{#zm782_s0_r24714}':
            # a3 # r24714
            jump zm782_s2

        'Laisse le cadavre tranquille.{#zm782_s0_r24717}':
            # a4 # r24717
            jump zm782_dispose
...
label zm782_s1: # from 0.1
    ...
    menu:
        ...
        'Laisse le cadavre tranquille.{#zm782_s1_r42304}':
            # a6 # r42304
            jump zm782_dispose
...
label zm782_s2: # from 0.2 0.3
    ...
    menu:
        ...
        'Laisse le cadavre tranquille.{#zm782_s2_r42305}':
            # a8 # r42305
            jump zm782_dispose
