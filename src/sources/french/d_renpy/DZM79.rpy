...
label zm79_s0: # - # IF ~  True()
    nr 'La grosse tête de ce cadavre a été tranchée, puis recousue à la hâte. Divers types de sutures semblent indiquer que sa tête ne cesse de tomber et d„être rattachée ensuite. Un numéro - “79„ - est gravé sur sa tempe, entouré d“un cercle denté pyrogravé dans sa chair.'
    ...
    menu:
        ...
        'Examine le cercle denté.' if zm79Logic.r34946_condition():
            # a1 # r34946
            $ zm79Logic.r34946_action()
            jump zm79_s3

        '"Je sais que tu n„es pas un zombi, tu sais. Personne n“est dupe."' if zm79Logic.r34947_condition():
            # a2 # r34947
            jump zm79_s1

        'Utilise Histoires-Os-Conter sur le cadavre.' if zm79Logic.r34948_condition():
            # a3 # r34948
            jump zm79_s2
...
label zm79_s3: # from 0.1
    nr 'Il semble que le cercle ait été tatoué sur le front du cadavre il y a bien longtemps, certainement avant sa mort. Cela peut être une sorte de symbole religieux ou un rite d„initiation. Tu remarques qu“il y a un petit triangle dans un des espaces entre les „canines“ intérieures, comme s„il avait une signification particulière'

    menu:
        '"Hmmm. Intéressant… comment cette marque est-elle arrivée là, cadavre ?"' if zm79Logic.r64279_condition():
            # a8 # r64279
            $ zm79Logic.j64536_s3_r64279_action()
            jump zm79_s2

        '"Hmmm… Je me demande si l„espace entre ces canines correspond à la cannelure sur la boucle d“oreille de cuivre que j„ai sur moi…"' if zm79Logic.r64280_condition():
            # a9 # r64280
