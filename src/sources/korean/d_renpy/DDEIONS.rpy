...
label deionarra_s0: # from 5.2 9.5 10.8 11.3 12.3 13.4 14.2 25.3 27.4 28.4 30.2 31.3 32.2 41.4 41.5 42.3 42.4 43.4 44.4
    nr '"나는 당신을 죽음의 전당에서 기다리겠어요, 내 사랑." 그녀는 미소를 짓는다, 하지만 그 미소에는 슬픔만이 가득할 뿐이다. 그녀는 눈을 감고 희미한 소리와 함께 사라진다.~ [DEN008B]{#deionarra_s0_}'
...
label deionarra_s1: # - # IF WEIGHT #0 ~  Global("Deionarra","GLOBAL",0) !Global("Current_Area","GLOBAL",1203) !Global("Current_Area","GLOBAL",1200)
    nr '당신 앞에는 놀랄 정도로 아름다운 유령이 서 있다. 그녀는 팔을 포개 놓고 있으며 그녀의 눈은 감겨 있다. 그녀는 길고 흐르는 듯한 머리를 지니고 있으며, 그녀의 가운은 희미한 바람에 살랑거리는 것 같다. 당신이 보고 있는 동안 그녀는 약간 움직이며 눈을 깜박이기 시작한다.{#deionarra_s1_}'
...
label deionarra_s2: # from 1.0 1.1
    nr '그녀는 천천히 눈을 뜬다, 그리고 잠시 동안 혼란스러운 듯 눈을 깜박인다, 마치 자신이 어디 있는지 잘 모르겠다는 듯. 그녀는 주변을 천천히 둘러보다가 당신을 보게 된다. 그녀의 평화롭던 표정은 악귀와 같은 표정으로 돌변한다. "당신! 당신은 왜 이 곳에 온 거죠! 당신이 가져온 불행을 직접 구경하고 싶었던 건가요? 아니면 죽어서도 난 당신에게 티끌만한 쓸모라도 있는 건가요? 그녀는 목소리를 낮춘다. "… 내 사랑."~ [DEN001]{#deionarra_s2_}'
...
label deionarra_s3: # from 2.0 2.1 2.2 10.0
    nr '혼령은 애걸하는 듯한 손짓을 한다. "어째서 정신의 도둑들은 계속 당신 기억으로부터 내 이름을 훔쳐 가는 거죠? 내 이름을 *기억*하지 못하시나요, 내 사랑?" 유령은 그녀의 팔을 내뻗는다. "생각하세요…" 그녀의 목소리는 다시 절박해진다. "데이오나라 라는 이름은 분명히 당신 안에서 어떤 기억을 불러낼 거예요."{#deionarra_s3_}'
...
label deionarra_s4: # - # IF WEIGHT #1 ~  Global("Deionarra","GLOBAL",2) !Global("Current_Area","GLOBAL",1203) !Global("Current_Area","GLOBAL",1200)
    nr '데이오나라는 다시 한 번 실체화한다.. 이번에 그녀의 얼굴은 절박함으로 가득 차 있으며, 무엇을 잡으려는 듯 팔을 내뻗고 있다. 그녀가 다시 희미해짐에 따라 그녀 얼굴의 절박함은 분노로 변한다. "당신이 또 왔군요! 왜 내게 계속 고통을 주는 거죠?"~ [DEN002]{#deionarra_s4_}'
...
label deionarra_s5: # - # IF WEIGHT #2 ~  Global("Deionarra","GLOBAL",1) !Global("Current_Area","GLOBAL",1203) !Global("Current_Area","GLOBAL",1200)
    nr '데이오나라는 다시 한 번 실체화한다.. 이번에 그녀의 얼굴은 절박함으로 가득 차 있으며, 무엇을 잡으려는 듯 팔을 내뻗고 있다. 그녀가 다시 희미해짐에 따라 그녀 얼굴의 절박함은 안도로 변한다. "내 사랑… 내게로 돌아와 주셨군요! 혹시 기억이 돌아온 건가요?"~ [DEN003A]{#deionarra_s5_}'
...
label deionarra_s6: # from 3.0
    nr '"그럼 내가 우려했던 대로군요. 당신은 나에 대한 기억을 완전히 잃어버렸군요… 이제 당신에게는 나에 대한 기억을 버렸듯이 날 아무런 거리낌없이 버릴 구실이 있군요!"{#deionarra_s6_}'
...
label deionarra_s7: # from 3.1
    nr '"그래요…" 그녀는 기대에 부푼 듯하다. "내 이름이 어떤 기억들을 불러내지요?"{#deionarra_s7_}'
...
label deionarra_s8: # from 7.0 47.2
    nr '데이오나라의 얼굴이 악귀처럼 변한다. "이 나병에 걸린 개 같으니! 내 가슴의 배신자! 난 당신을 저주하고 싶어요, 하지만 내 저주 없이도 이미 당신의 화신들은 예외없이 고통에 쫓기고 있어요! 꺼지세요! 그녀는 두 팔을 포개고 눈을 감는다.{#deionarra_s8_}'
...
label deionarra_s9: # from 3.2 3.3 6.1 6.2 7.1 7.2 7.3
    nr '"아, 마침내 운명의 여신이 자비를 베푸는군요! 죽음조차도 날 당신 마음으로부터 날 내몰 수는 없어요, 내 사랑! 보이지 않으시나요? 당신 기억은 돌아올 거예요! 말씀만 하세요, 내가 도와드릴 테니!"{#deionarra_s9_}'
...
label deionarra_s11: # from 6.0 9.0 10.1
    nr '"당신은 저주와 축복을 동시에 받은 존재예요, 내 사랑. 그리고 당신은 늘 내 마음과 가슴 가까이에 있는 분이에요."{#deionarra_s11_}'
...
label deionarra_s12: # from 9.1 10.2
    nr '"당신이 어디 계시느냐고요? 당신은 이 곳에 나와 함께 있어요, 내 사랑… 우리 두 사람이 모두 살아 있었을 때처럼. 하지만 이제는 영원한 경계가 우릴 갈라 놓고 있어요."{#deionarra_s12_}'
...
label deionarra_s13: # from 11.0
    nr '"당신의 저주의 본질은 명백해요, 내 사랑. 스스로를 보세요," 그녀는 당신을 가리킨다. "죽음이 당신을 거부해요. 당신 기억은 당신을 저버렸어요. 잠시 멈추고 생각해본 적은 없나요?"{#deionarra_s13_}'
...
label deionarra_s14: # from 12.0
    nr '데이오나라는 슬퍼하는 듯하다. "그건 당신이 결코 넘지 못할 경계예요, 내 사랑. 그것은 당신과 내 잔재 사이에 서 있는 경계예요…"{#deionarra_s14_}'
...
label deionarra_s15: # from 3.4 5.1 6.3 6.4 7.4 9.4 10.7 11.2 12.2 13.3 14.1 25.2 27.3 28.1 28.3 30.1 31.2 32.1 41.2 41.3 42.1 42.2 43.3 44.3 47.3
    nr '"기다리세요… 나는 당신과 여행하는 동안 많은 것을 배웠어요, 내 사랑, 그리고 당신이 잃어버린 것도 난 간직하고 있어요. 난 당신에게 내가 아는 것 전부를 밝히지는 않았어요. 당신은 기억의 불꽃을 찾아 어둠 속에서 헤매고 있지만… 나는 뚜렷하게 볼 수가 있어요."{#deionarra_s15_}'
...
label deionarra_s16: # from 20.0 21.0
    nr '데이오나라는 놀란 듯하다, 그리고 그녀의 어조는 마치 간청이라는 하는 것처럼 바뀐다. "난… 당신으로부터 맹세를 받아내려는 건 아니에요. 단지 난 당신이 경계를 넘어 나와 함께 하기를 너무나도 오랫동안 기다렸을…"{#deionarra_s16_}'
...
label deionarra_s17: # from 15.1 15.2
    nr '"망각의 냉기가 우리를 천천히 엄습함에 따라 시간조차도 그 손을 늦추고 있어요. 앞으로 벌어질 일들이 벌떼처럼 내 시야를 스쳐 지나가고 있어요. 당신 모습도 보여요, 내 사랑 자금과 같은 당신 모습이 보여요. 그리고…" 데이오나라는 조용해진다.{#deionarra_s17_}'
...
label deionarra_s18: # from 17.0 17.1
    nr '"내겐 당신을 기다리고 있는 운명이 보여요. 그것은 이 지점에서 시작하여 전 차원에 파문처럼 퍼져 나가고 있어요. 당신에게 내가 보고 있는 것들을 말씀 드릴까요?{#deionarra_s18_}'
...
label deionarra_s19: # from 17.2 18.1
    nr '"당신은 항상 그랬어요, 내 사랑. 당신은 늘 죽음의 부름에 귀를 기울이지 않았어요. 당신이 다음에 거부할 대상은 시간이 될 건가요?" 그녀는 눈을 감고 희미한 소리와 함께 사라진다.{#deionarra_s19_}'
...
label deionarra_s20: # from 18.0
    nr '"먼저, 내게 약속을 해주세요. 돌아오겠다고 약속해 주세요. 그리고 나와 함께 있을 수 있는 방법을 모색하겠다고."{#deionarra_s20_}'
...
label deionarra_s21: # from 20.1
    nr '데이오나라는 그녀의 팔을 접는다. "그건 그래요, 내 사랑. 하지만 불사의 대가는 별로 크지 않았던 것 같군요. 당신과 같은 사람에게 성실하기를 바라는 건 무리인가요?"{#deionarra_s21_}'
...
label deionarra_s22: # from 10.5 20.2 20.5 21.1 21.4 40.0
    nr '"이것이 시간의 구속을 초월하여 내 눈에 들어온 광경이에요, 내 사랑…"~ [DEN020]{#deionarra_s22_}'
...
label deionarra_s23: # from 22.0
    nr '"당신은 세 적을 만나게 될 거예요, 하지만 그들 중 어느 누구도 최전성기의 당신만큼 위험하지는 않아요. 그들은 차원의 법칙에 의해 삶을 얻고 뒤틀려진 선, 악, 그리고 중립의 그림자들이에요."~ [DEN021]{#deionarra_s23_}'
...
label deionarra_s24: # from 23.0
    nr '"당신은 그림자들조차도 미쳐 버린 슬픔과 후회로 만든 요새에 이르게 될 거예요. 그 곳에서 당신은 끔찍한 희생을 치르게 될 거예요, 내 사랑. 만사를 해결하기 위해서 당신은 스스로를 살아 있도록 만드는 것을 파괴하고 불사신이기를 포기해야만 해요."~ [DEN022]{#deionarra_s24_}'
...
label deionarra_s25: # from 13.2 29.0
    nr '"나는 죽음으로부터 생환할 수 있는 당신의 능력을 의심하지는 않아요. 하지만 당신이 죽을 때마다 당신의 기억과 정신은 약해져 가요. 당신은 기억을 잃었다고 말하고 있어요. 그건 수많은 죽음을 겪어서 생긴 부작용이 아닌가요? 만약 그렇다면 앞으로도 계속 죽을 경우 당신은 무엇을 잃게 되죠? 만약 당신이 완전히 발광하게 되면 당신은 스스로가 죽을 수 없다는 사실조차 모르게 될지도 몰라요. 그렇게 된다면 당신은 진정한 파멸을 맞이하게 될 거예요."{#deionarra_s25_}'
...
label deionarra_s26: # from 3.5 4.1 6.5 6.6 7.5 15.0 15.3 20.3 21.2 21.5 28.2 47.4
    nr '데이오나라는 분노한 것 같다. "떠나세요, 당신이 이전에도 수백 번 그랬듯이! 당신은 내게 고통을 주기 위해서만 날 찾아오는 건가요? 떠나서 다시는 돌아오지 마세요!" 그녀는 눈을 감고 희미한 소리를 내며 사라진다.{#deionarra_s26_}'
...
label deionarra_s27: # from 13.0
    nr '"나는 당신이 한때 날 사랑하고 있으며 죽음이 우리 둘을 데려갈 때까지 나를 사랑하겠다고 말했던 것을 기억하고 있어요. 나는 그 말을 믿었어요, 당신이 누구이며, 또 어떤 사람인지도 모르고."{#deionarra_s27_}'
...
label deionarra_s28: # from 27.0
    nr '"우리는 당신의 본질에 대해 이미 얘기를 했어요." 데이오나라는 냉담한 표정을 짓는다. "그 일에 대해서는 다시 얘기하지 않겠어요."{#deionarra_s28_}'
...
label deionarra_s29: # from 24.0
    nr '"나는 당신이 아직 죽을 수 있을 때… 죽어야 한다는 것을 알아요. 윤회의 고리는 끊어져야만 해요, 내 사랑. 당신은 이러한 삶을 살아서는 안 되었어요. 당신은 자신이 빼앗긴 것을 찾은 후, 경계를 넘어 죽은 자들의 세계로 가야만 해요."~ [DEN023]{#deionarra_s29_}'
...
label deionarra_s30: # from 25.0
    nr '"나도 그것이 오랫동안 계속되어왔다는 사실말고는 모르겠어요."{#deionarra_s30_}'
...
label deionarra_s31: # from 45.0
    nr '"전이문들은 존재에 생긴 구멍들로, 각 전이문은 다원 우주의 특정한 지점으로 통하고 있어요… 만약 당신이 적절한 열쇠를 찾을 수가 있다면, 그것들 중 하나를 통해 탈출 할 수 있을 거예요."{#deionarra_s31_}'
...
label deionarra_s32: # from 31.0
    nr '데이오나라는 기억을 해내려고 애쓰는 듯 잠시 말을 멈춘다, "당신이 적절한 „열쇠“를 지니고 있으면 전이문은 당신 앞에 그 모습을 드러낼 거예요. 불행히도 어떤 것이든 이러한 열쇠가 될 수 있어요.. 감정, 나뭇조각, 은박을 입힌 유리로 만든 대거, 천조각, 당신이 부르는 콧노래… 아마 이 곳에서 나가는 데 사용할 수 있는 열쇠를 아는 것은 더스트맨들뿐일 거예요."{#deionarra_s32_}'
...
label deionarra_s33: # from 4.0
    nr '"당신에게 해줄 대답 따위는 없어요! 당신의 불성실한 마음이 당신을 여기까지 인도했다면, 그것이 나머지 길도 인도하도록 하세요! 이제 내 앞에서 꺼져요!"{#deionarra_s33_}'
...
label deionarra_s34: # from 33.2 33.3 33.4
    nr '데이오나라의 표정에서 분노가 마치 눈 녹듯이 사라진다… 이러한 변화의 속도는 지금 그녀의 얼굴에 나타난 절박한 표정만큼이나 섬뜩하다. "아니에요! 기다리세요, 내 사랑!" 그녀는 애걸하는 목소리로 말한다. "제발 절 용서하세요, 이렇게 빌겠어요! 제발 떠나지 마세요!"{#deionarra_s34_}'
...
label deionarra_s35: # from 33.0
    nr '데이오나라의 표정에서 분노가 마치 눈 녹듯이 사라진다… 이러한 변화의 속도는 지금 그녀의 얼굴에 나타난 절박한 표정만큼이나 섬뜩하다. "아니… 아니에요… 나는 아직도 당신이 기억하는 그대로의 데이오나라예요. 제발 절 용서하세요, 이렇게 빌겠어요."{#deionarra_s35_}'
...
label deionarra_s36: # from 34.0 35.0
    nr '그녀의 목소리는 알아듣기 어려울 정도로 작은 속삭임으로 변한다. "그래요… 제발. 떠나지 마세요." 그녀의 애걸하는 듯한 표정은 당신을 전율시킨다… 공포 때문이 아니라 쾌락 때문에. 당신이 그녀를 교묘하게 조종한 것은 이번이 처음은 아니라는 생각이 든다.{#deionarra_s36_}'
...
label deionarra_s37: # from 33.1 47.0
    nr '"*당신*을 저버렸다고?! 감히 당신이 내게 그런 말을 하는 건가요?!" 그녀는 팔을 바깥쪽으로 뻗으면서 호를 그린다, 그리고 팔을 다시 자신의 정면으로 가져온 후 양손의 집게손가락으로 당신을 가리킨다. 그녀는 어떤 주문을 영창하려는 것 같다. "감히 당신이…!"{#deionarra_s37_}'
...
label deionarra_s38: # from 37.0 37.1
    nr '"타버려요! 당신을 베이터의 업화가 안에서부터 삼키면서 태우듯이 타버려요! 타버려요, 그리고 그것조차도 당신에 대한 내 증오의 *일부*에 불과하다는 걸 아세요! 나는 당신을 저주해요, 난 당신이 자신의 비참한 삶이 아닌 삶의 사슬로부터 영원히 벗어나지 못하도록 저주해요. 당신같은 사람은 시름시름 시들어 가며 죽어야 해요, 그리고 당신의 정신은 그 썩은 몸뚱이 안에서 말라 죽어야 해요!"{#deionarra_s38_}'
...
label deionarra_s39: # from 38.0 38.1
    nr '"한 번 건 저주는 풀 수가 없어요." 데이오나라는 속삭이듯 말한다. "이 사실을 아세요: 내게는 영원한 시간이 있어요, „내 사랑.“ 나는 당신이 명부로 오기를 기다리겠어요." 그녀는 미소를 짓는다, 하지만 즐거운 기색은 없다. "우리는 다시 함께 있게 될 거예요."{#deionarra_s39_}'
...
label deionarra_s40: # from 16.0 20.4 21.3
    nr '데이오나라는 경직한다. 그녀 뭔가 말할 것이 있는 듯하나, 체념한 듯 한숨을 쉰다. "알겠어요, 내 사랑… 전과 마찬가지로 당신을 믿어야 할 것 같군요." 그녀는 눈을 감는다."{#deionarra_s40_}'
...
label deionarra_s41: # from 10.6
    nr '데이오나라는 슬픈 듯 고개를 젓는다. "일단 건 저주는 풀 수가 없어요. 용서하세요, 내 사랑."{#deionarra_s41_}'
...
label deionarra_s42: # from 41.0
    nr '"그렇다 해도 나는 그 방법을 알지 못해요." 데이오나라는 희망에 부픈 듯하다. "하지만 나보다 강력한 마력을 지닌 사람이라면 그 저주를 풀 수 있을지도 몰라요. 다시 한 번 당신의 용서를 구하겠어요. 내 사랑. 나는 내가 무슨 짓을 하고 있었는지 몰랐어요."{#deionarra_s42_}'
...
label deionarra_s43: # from 9.2 10.3 44.0
    nr '"떠난다고요…?" 데이오나의 목소리는 낮아졌다가 다시 올라간다. "*떠난다고요?!*" 당신 때문에 여기 갇힌 내게 어떻게 하면 여기를 떠날 수 있느냐고 묻는 건가요?"{#deionarra_s43_}'
...
label deionarra_s44: # from 9.3 10.4
    nr '당신은 데이오나라에게 질문을 하려다 목구멍에서 멈춘다. 만약 그녀에게 탈출로에 대해서 물으면 그녀가 당신이 자신을 버리려고 한다고 느낄지도 모른다는 생각이 든다. 만약 당신이 그녀에게 여기서 나갈 방법에 대해 묻고 싶다면 세심한 주의를 기울여야 할 것 같다.{#deionarra_s44_}'
...
label deionarra_s45: # from 46.0 46.1
    nr '"이 장소에는 인간의 눈으로는 볼 수 없는 문들이 많이 감추어져 있어요. 당신은 이러한 전이문들 중 하나를 탈출하는 데 이용할 수 있을 거예요."{#deionarra_s45_}'
...
label deionarra_s46: # from 43.2 44.1 47.1
    nr '"위험에 처했다고요?" 데이오나라는 걱정하는 듯하다. "물론이에요, 내 사랑, 난 최선을 다해 당신을 돕겠어요…" 그녀는 잠시 눈을 감는다, 그리고 당신은 에테르의 미풍이 그녀의 몸을 통과함에 따라 그녀의 머리카락이 바람에 날리는 것을 본다. 잠시 후 바람은 가라앉고 그녀는 천천히 눈을 뜬다. "아마 방법이 있을 것 같아요."{#deionarra_s46_}'
...
label deionarra_s47: # from 43.0
    nr '"당신은 내가 죽은 후에 와서 날 *다시* 버리기 위해 내 도움이 필요하다는 건가요?" 그녀의 얼굴은 분노로 타오르고 있다. "나는 당신을 위해 *죽었어요*, 내 사랑, 그리고 지금도 그 때문에 *고통받고* 있어요!"{#deionarra_s47_}'
...
label deionarra_s48: # from 33.5 39.0 39.1
    nr '데이오나라는 눈을 감는다, 그리고 미약한 바람과 함께 사라진다.{#deionarra_s48_}'
...
label deionarra_s49: # - # IF WEIGHT #3 ~  Global("Deionarra","GLOBAL",0) Global("Current_Area","GLOBAL",1203)
    nr '당신 앞에는 놀랄 정도로 아름다운 유령이 서 있다. 그녀는 길고 흐르는 듯한 머리를 지니고 있으며, 그녀의 가운은 희미한 바람에 살랑거리는 것 같다. 그녀의 시선이 당신에게 닿자 당신은 여러 쌍의 눈들이 당신을 동시에 쳐다보고 있는 듯한 기묘한 감각을 느낀다.{#deionarra_s49_}'
...
label deionarra_s50: # - # IF WEIGHT #4 ~  GlobalGT("Deionarra","GLOBAL",0) Global("Current_Area","GLOBAL",1203)
    nr '당신 앞에는 데이오나라의 유령이 서 있다. 그녀는 길고 흐르는 듯한 머리를 지니고 있으며, 그녀의 가운은 희미한 바람에 살랑거리는 것 같다. 그녀의 시선이 당신에게 닿자 당신은 여러 쌍의 눈들이 당신을 동시에 쳐다보고 있는 듯한 기묘한 감각을 느낀다.{#deionarra_s50_}'
...
label deionarra_s51: # from 49.0 50.0
    nr '"내 사랑, 마침내 당신을 *찾았군요*… 나는  당신이 수정에 의해 분열된 후 당신을 찾았어요 - 이 요새의 크기는 수천 킬로미터가 넘기 때문에 난 당신을 잃지는 않았을까 걱정했어요." 그녀는 당신을 살피며 몸에 새로운 상처는 없는지 확인한다. "괜찮으세요?"{#deionarra_s51_}'
...
label deionarra_s52: # from 51.0
    nr '"수정의 진정한 목적은 당신을 감금하는 것이었던 같아요. 하지만 나와 같은 존재에게는 아무런 장애물이 되지 못해요." 그녀는 눈을 감는다. "내 눈은 많은 곳을 보며, 나는 이 요새의 구석구석을 잘 알고 있어요."{#deionarra_s52_}'
...
label deionarra_s53: # from 52.0 58.0 59.0
    nr '"만약 당신이 이 곳에 갇혔다면, 내 사랑, 내가 당신을 풀어 드리겠어요. 어디로 가고 싶으시죠?"{#deionarra_s53_}'
...
label deionarra_s54: # from 53.0 53.1 53.2 53.3
    nr '"당신이 원하시는 대로 해 드리겠어요, 내 사랑." 그녀는 손을 내민다. "제 손을 잡으세요, 그러면 이 요새의 벽도 더 이상 당신을 가로막지 못할 거예요."{#deionarra_s54_}'
...
label deionarra_s55: # from 53.4
    nr '"무슨 말씀을 하시는 거죠?"{#deionarra_s55_}'
...
label deionarra_s56: # from 55.0
    nr '당신이 얘기를 할 때 데이오나라의 얼굴은 마치 가면과도 같다.{#deionarra_s56_}'
...
label deionarra_s57: # from 56.0 56.1 56.2
    nr '"당신은 날 *사랑*하시나요? 만약 그렇다고 말씀하시면, 내 사랑, 지금까지 있었던 일들은 다 괜찮아요."{#deionarra_s57_}'
...
label deionarra_s58: # from 55.1 57.0 57.1
    nr '"그렇다면 당신을 돕겠어요, 내 사랑. 내가 어떻게 도와드리면 되는지 말씀하세요, 그럼 그렇게 하겠어요{#deionarra_s58_}'
...
label deionarra_s59: # from 57.2
    nr '"그렇다면… 이것으로 우리들 사이의 관계도 끝이군요, 내 사랑. 나는 오직 당신만을 위해 이 곳에 남았어요. 나는 당신을 마지막으로 한 번만 더 도와드리겠어요, 그리고 그 다음에는 운명에 순응하여 영원의 경계 너머로 떠나겠어요."{#deionarra_s59_}'
...
label deionarra_s60: # - # IF WEIGHT #6 /* Triggers after states #: 62 even though they appear after this state */ ~  Global("Deionarra","GLOBAL",0) Global("Current_Area","GLOBAL",1200) Global("1200_Cut_Scene_2","GLOBAL",0)
    nr '당신 앞에는 데이오나라의 유령이 서 있다. 그녀는 길고 흐르는 듯한 머리를 지니고 있으며, 그녀의 가운은 희미한 바람에 살랑거리는 것 같다. 그녀는 검은 돌로 만든 둑길의 가장자리에 서서 이 차원의 허공을 바라보고 있다.{#deionarra_s60_}'
...
label deionarra_s61: # - # IF WEIGHT #7 /* Triggers after states #: 62 even though they appear after this state */ ~  GlobalGT("Deionarra","GLOBAL",0) Global("Current_Area","GLOBAL",1200) Global("1200_Cut_Scene_2","GLOBAL",0)
    nr '당신 앞에는 데이오나라의 유령이 서 있다. 그녀는 길고 흐르는 듯한 머리를 지니고 있으며, 그녀의 가운은 희미한 바람에 살랑거리는 것 같다. 그녀는 검은 돌로 만든 둑길의 가장자리에 서서 이 차원의 허공을 바라보고 있다.{#deionarra_s61_}'
...
label deionarra_s62: # from 60.0 61.0 # IF WEIGHT #5 ~  Global("Current_Area","GLOBAL",1200) Global("1200_Cut_Scene_2","GLOBAL",1)
    nr '"내 사랑! 당신은 이 곳에 오시면 안돼요! 당장 떠나야 해요!{#deionarra_s62_}'
...
label deionarra_s63: # from 62.0 62.1
    nr '"이 곳은 후회의 요새예요. 이 곳은 내 죽음의 순간을 감금하고 있는 장소예요, 그리고 나는 여기서 멀리 떨어질 수가 없어요. 당신은 시길로 돌아갈 방법을 찾아야만 해요. 여기 머무르면 당신은 죽게 될 거예요, 내 사랑."{#deionarra_s63_}'
...
label deionarra_s64: # from 63.0 63.1 63.2
    nr '그녀는 고개를 젓는다. "그렇지가 않아요, 내 사랑. 이 요새는 다른 곳과는 달라요 - 이 곳을 덮고 있는 장벽은 요새를 다른 차원들로부터 차단하고 있어요. 그것은 바로 당신의 불사성을 가로막고 있는 장벽이기도 해요.{#deionarra_s64_}'
...
label deionarra_s65: # from 64.1
    nr '"이 곳을 지키고 있으면서 나는 당신의 불사성의 특성을 알게 되었어요, 내 사랑. 그것은 다른 자의 목숨을 갈망하는 괴물과도 같아요, 당신이 죽으면, 그것은 당신 대신 다른 사람의 목숨을 빼앗음으로서 당신이 살도록 해주어요. 당신 대신 죽은 영혼은 이 요새로 와서 그림자가 돼요. 이 곳의 장벽은 당신의 불사성이 다른 희생자를 찾는 것을 막고 있어요."{#deionarra_s65_}'
...
label deionarra_s66: # from 64.0 65.0
    nr '"만약 당신이 이 곳에서 죽는다면, 이 곳에는 살아 있는 생명체가 달리 없기 때문에 그걸로 끝이에요. 그러니 조심하셔야 해요. 빨리 이 저주받은 장소를 떠나 시길로 돌아가세요{#deionarra_s66_}'
...
label deionarra_s67: # from 66.0 66.1
    nr '"내 사랑, 만약 당신이 이 곳에 살아 있는 생명체를 데리고 왔다면 그들은 심각한 위험에 처해 있어요 - 그림자들과 당신 양쪽 모두에 의해. 만약 당신이 여기서 죽는다면, 불사성은 요새 안에서 가장 가까운 곳에 있는 생명을 노릴 거예요, 그리고 그 또는 그녀가 당신 대신 죽게 되지요. 당신은 당장 여기를 떠나셔야 해요."{#deionarra_s67_}'
...
label deionarra_s68: # from 66.2 66.3 67.0
    nr '"요새 안에는 천연의 어둠은 없어요, 내 사랑, 단지 당신 대신 죽은 자들의 그림자들만이 있을 뿐이에요. 이 차원의 에너지가 그들을 움직이고 있으며, 그들의 당신에 대한 증오는 상상을 초월할 정도예요. 그들은 당신이 떠나는 것을 결코 허용하지 않을 거예요." 그녀는 요새의 벽을 흘긋 쳐다본다. "들어가지 마세요, 애원하겠어요!"{#deionarra_s68_}'
...
label deionarra_s69: # from 68.0 68.1
    nr '"만약 당신이 다른 이들과 함께 왔다면, 그들은 도착하자마자  당신으로부터 격리되었을 거예요 - 산 자들을 나눈 뒤… 죽이는 것은 이 곳의 본질이에요." 그녀는 걱정이 되는 듯하다. "요새는 광활해요 - 당신 친구들을 찾기는 쉽지가 않을 거예요."{#deionarra_s69_}'
...
label deionarra_s70: # from 75.0
    nr '"한 가지가 더 있어요…" 데이오나라는 희미한 기억을 상기하려는 듯 잠시 멈춘다.  "방 안에는… 거대한 시계들이 있어요…" 그녀의 목소리는 한층 안정되고 확실해진다. "당신이 그 방에 갇혔을 때 당신으로 하여금 그 방에서 탈출할 수 있도록 해준 열쇠라고 당신이 전에 얘기한 적이 있는 시계들…" 그녀는 당신을 쳐다본다. "나는 내가 당신 가는 길을 막을 수 없다는 것을 잘 알아요, 내 사랑 -- 나는 당신을 지켜보면서 내 능력껏 당신을 돕겠어요."{#deionarra_s70_}'
...
label deionarra_s71: # from 70.0
    nr '"이 반지에는 아직도 내 일부가 담겨 있어요, 내 사랑. 당신이 그것을 지니고 계시면, 내 마음을 지니고 계신 것과 같아요." 그녀는 잠시 눈을 감는다, 그리고 당신은 갑자기 따뜻함이 당신 몸을 어루만지고 지나가는 것을 느낀다, 데이오나라는 눈을 뜨고 미소를 짓는다. "나는 당신이 그 반지를 가지고 돌아오실 줄 알고 있었어요. 이제 내 축복과 함께 반지를 가져가세요, 그리고 당신 심장 가까운 곳에 지니도록 하세요. 그것을 통해 내가 당신을 지키겠어요."{#deionarra_s71_}'
...
label deionarra_s72: # from 27.1
    nr '"당신… 나는…" 그녀의 몸이 갑자기 얼어붙은 듯 경직된다, 그리고 그녀는 자신의 목소리가 두려운 듯 천천히, 그리고 조심스럽게 말한다. "진실은 다음과 같아요: 당신은 죽음을 여러 번 죽는 사람이에요. 이러한 죽음들은 당신에게 살아 있는 생명에 대한 앎을 주었고, 당신 손 안에는 삶과… 죽음의 불꽃이 있어요. 당신 곁에서 죽는 사람들은 당신이 불러낼 수 있는 자신들의 흔적을 지니고 있어요…"{#deionarra_s72_}'
...
label deionarra_s73: # from 72.0
    nr '데이오나라 말을 하자 당신은 후두부에서 뭔가가 기어가는 것 겉은 감각을 느낀다… 당신은 갑자기 손을 쳐다보고 싶다는 충동을 느낀다. 손을 들어 그것을 쳐다보자, 당신은 피가 천천히 당신의 팔 속을 흐르며 근육 속으로 유입되고, 근육은 다시 뼈에 힘을 주는 등의 신체 대사를 육안으로 볼 수가 있다.{#deionarra_s73_}'
...
label deionarra_s74: # from 73.0
    nr '그리고 당신은 데이오나라의 말이 *옳다는* 것을 깨닫는다. 갑자기 당신은 육체에 남은 가장 희미한 불꽃을 구슬러 그것을 다시 불러내는 방법을 깨닫는다… 이 생각은 당신을 두렵게 하는 동시에 호기심을 돋운다.  주: 당신은 사자를 소생시키는 방법을 기억해냈다. 이 능력을 사용하려면, 퀵 메뉴에서 특수 능력 버튼을 선택하면 된다. 이 능력은 당신이 있는 상황에서 죽은 파티 멤버에게만 효과가 있다. 이 능력은 당신과 여행을 함께 하지 않는 자에게는 효과가 없으며, 죽은 상태로 파티에서 제거된 캐릭터에게도 효과가 없다.{#deionarra_s74_}'
...
label deionarra_s75: # from 68.2 69.0
    nr '"좋아요, 내 사랑… 만약 가고자 하신다면, 이 사실을 아셔야 해요 - 요새의 입구를 지나면 무수한 그림자들이 기다리고 있는 대기실이 있어요. 당신은 그들이 무리로 당신을 공격할 기회를 주지 말고 신속하게 이동하셔야 해요, 아니면 목숨을 잃게 될 거예요!"{#deionarra_s75_}'
