...
# s0 # say986
label morte_s0: # -
    nr '"이봐, 대장. 괜찮아? 시체흉내를 내고 있는 거야, 아니면 더스티들을 속이려는 거야? 난 대장이 정말로 죽은 줄 알았다고."{#morte_s0_1}'
...
label morte_s1: # from 0.0 29.0 31.0
    nr '"나?" 해골은 화가 난 듯하다. "*당신*부터 먼저 대답하는 게 어때, 이 상처딱지 덩어리야? 당신은 누구지?"{#morte_s1_1}'
...
label morte_s2: # from 1.0 4.0 5.0
    nr '"당신은 자기가 누군지도 모르는 거야? 그냥 „엿먹고 늘어져, 얼간아“라고 했을 수도 있잖아. 그건 괜찮아… 당신 머리는 텅 비었다고 치자고. 아무려면 어때. 나는 모트라고. 뭐 일단 인사는 해 두도록 하지.{#morte_s2_1}'
...
label morte_s3: # from 1.1 4.1 5.1
    nr '"당신은 *기억*을 못해? 유별난 밤이었던 모양이군. 당신이 자신이 아무도 해치지 않았기를 바라는 게 좋을 걸… 내 이름은 모트라고. 일단 인사는 해 두도록 하지." 그는 잠시 말을 멈춘다." 이건 꼭 물어봐야겠는데, 당신은 자학증세가 있는 센세이트들 중 하나야, 아니면 누가 당신 몸에 그런 상처들을 낸 거야?"{#morte_s3_1}'
...
label morte_s4: # from 1.2
    nr '"그래, 내가 나중에 물었어. 당신 이름은 뭐지?"{#morte_s4_1}'
...
label morte_s5: # from 4.2
    nr '"정말 당신은 젖은 로프만큼이나 빡빡하군. 좋아, 좋아… 여기선 내가 참지… 나는 모트, 모트 릭터스그린이라고. 자 이제 내게 어떤 불행한 이름이 당신이라는 소유주를 가지고 있는지 말해주겠어?"{#morte_s5_1}'
...
label morte_s6: # from 2.0 29.1 31.1
    nr '"우린 시체안치소라고 불리는 쓰레기 더미 속에 있지… 그건 임신한 거미만큼이나 매력적인 모양새의 커다란 검은 건물이라고."{#morte_s6_1}'
...
label morte_s7: # from 6.0 9.0
    nr '"글쎄, 그건 나도 모르겠어… 하지만 시체안치소는 이 도시의 시체들을 처리하는 곳이지. 시체들은 운이 좋으면 매장되거나 화장되고, 운이 나쁘면 부활되어 노에로 일하게 되지. 별로 있고 싶은 곳이 아니야. 만약 내가 당신이라면 가장 가까운 출구를 찾아 당장 도망치겠어."{#morte_s7_1}'
...
label morte_s8: # from 7.3
    nr '그는 잠시 말을 멈춘다. "그래, 그런 모양이야. 아마 어떤 불한당이 당신을 죽은 걸로 생각하고 이 곳에 가져온 거겠지. 당신의 시체 흉내에는 나도 속을 뻔했다고… 당신을 이 곳으로 끌고 온 자를 찾아 놈에게 물어보는 건 어때?" 모트는 고개를 끄덕인다. "최근에 죽은 사람치고는 괜찮은 생각이군… 아직 당신 뇌가 멀쩡하다니 다행한 일이야."{#morte_s8_1}'
...
label morte_s9: # from 7.1
    nr '"그래, 참 멋진 삶이지… 포름알데히드의 지속적인 사용과 떨어진 사지를 꿰매는 일만 제외한다면 천국이라고."{#morte_s9_1}'
...
label morte_s10: # from 7.0
    nr '"어… 내가 말했듯이 시체안치소라고. 괜찮아, 대장? 별로 좋아 보이지 않는데."{#morte_s10_1}'
...
label morte_s11: # from 7.2
    nr '"대장, 내가 보기에 대장이 그 철판에서 깨어날 확률은 희박했어. 난 대장이 마침내 가는 줄 알았다고 무슨 말인지 알겠어?"{#morte_s11_1}'
...
label morte_s12: # from 3.0 33.0
    nr '"대장은 센세이트가 뭔지도 모른단 말이야? 오, 내가 멋들어지게 강의를 해주지! 그들은 다원 우주에서 오감으로 느낄 수 있는 건 모두 체험하겠다는 작자들로, 그 체험 중에는 물론… 아니, 지금은 일단 접어 두자고. 어쨌든 그 흉터들은 어떻게 된 거야?"{#morte_s12_1}'
...
label morte_s13: # from 3.1 9.1 10.1 11.1 12.0 33.1
    nr '"마치 누가 몸에 칼로 그림을 그리려고 했던 것 같아. 온몸에 흉터투성이야… 심지어는 등에까지…" 잠시 멈춘다. "대장 등에는 아예 문신 갤러리가 있군. 무슨 글이 적혀 있는 것 같은데…"{#morte_s13_1}'
...
label morte_s14: # from 8.0 29.3
    nr '"이 도시에 사는 사람들의 일부는 거리에서 시체를 수거한 후 이 곳에 가지고 와서 돈을 받고 팔지. 별로 좋은 직업은 아니지만 다원 우주의 변기와도 같은 이 도시에서 사는 사람들에게는 선택의 폭이 별로 넓지 않거든."{#morte_s14_1}'
...
label morte_s15: # from 14.0
    nr '"에… 돈. 징크는 돈의 속칭이야. 대장이 온 곳에는 돈도 없어?"{#morte_s15_1}'
...
label morte_s16: # from 10.0 11.0
    nr '그는 잠시 멈춘다. "모르겠어. 하지만 대장은 내게 말을 하고 있어… 이 근처에서 걸어다니는 시체들은 그러질 않거든. 내가 보기에 대장은 죽지도 않았는데 더스트들이 실수를 한건 같아. 무슨 계약서에 서명을 한 기억은 없어? 누군가를 언데드로 부활시키기 전에 녀석들은 각종 공문서들을 작성해야 하거든.{#morte_s16_1}'
...
label morte_s17: # from 16.1 18.0
    nr '"그래, „사망자 명단.“ 몰라? 어, 그럴 수도 있겠지. „사망자 명단“에 대해서는 잊어버리자고. 대장은 살아 있으니까, 거기에는 없어."{#morte_s17_1}'
...
label morte_s18: # from 16.2 17.0
    nr '"그래, 벽돌이라도 깨트리고 싶겠지. 법이 시길을 움직이고 있고, 무슨 계약에 서명하지 않고는 오줌도 눌 수가 없다니까."{#morte_s18_1}'
...
label morte_s19: # from 15.0
    nr '"원 세상에 당신은 완전히 맛이 갔군. 자기가 어디서 왔는지 기억이나 하슈? 어딘가에 있는 백치들의 왕국에서 왕이 실종된 것이 틀림없군. 대장은 신을 모독하기라도 한 거야, 아니면 늘 이토록 무식했어?"{#morte_s19_1}'
...
label morte_s20: # from 2.2 31.2
    nr '"대장, 나도 몰라. 하지만 대장의 죽은 척하는 재주 하나만은 끝내주더군. 대장이 저기 누워 있었을 때 가슴도, 눈도, 그리고 다른 부위도 미동도 하지 않았어. 술이라도 마셨었어? 그게 사건의 진상이야?"{#morte_s20_1}'
...
label morte_s21: # from 2.1 6.1 29.2 30.0 31.3 34.2 35.1 36.1
    nr '"그래 그건 좋은 질문이군. 대장은 시간에 쫓기고 있어. 마약 더스트맨이 대장을 발견하면 대장의 소생 „문제“를 화장터에 대장을 던져 버림으로서 해결해줄 거라고. 계속 죽은 척을 해도 화장터로 가기는 마찬가지고. 모드론의 선택? 어떻게 할 거지?"{#morte_s21_1}'
...
label morte_s22: # from 21.1
    nr '"아, *좋은* 생각이군, 대장! 왜 *내*가 그 생각을 못했을까? 그런데 어떻게 탈출을 할 거야? 내가 대장한테 히트를 하나 주지. 헌데 약간의 협조가 필요해."{#morte_s22_1}'
...
label morte_s23: # from 21.3 21.4 22.0 26.0
    nr '"내가 보기에 대장은 이 곳에서 나가야 할 절실한 이유가 있어. 나는 기다려도 상관이 없지. 내가 직면하고 있는 위험은 지루해서 죽는 것 뿐이니까. 상부상조하자고."{#morte_s23_1}'
...
label morte_s24: # from 23.0 23.1
    nr '"그렇게 보이지 않을지도 모르지만 난 대장이 여기서 나가는 걸 도울 수 있고 대장은 내가 여기서 나가는 걸 도울 수 있다고. 난 손이 없어 약간 불편한 처지지. 대장은 골이 빈 반면, 나는 이 토굴에서 빠져나가기에 충분한 경험과 노하우를 지니고 있거든. 우리가 서로 협력하면 둘 다 무사히 나갈 수 있지. 어때, 친구?"{#morte_s24_1}'
...
label morte_s25: # from 21.2
    nr '"아, *좋은* 생각이군, 대장! 왜 *내*가 그 생각을 못했을까?" 그는 조롱하는 어조로 말한다. "그런데 더스트맨 나으리, 나는 죽었고 당신네 시체안치소에 있는 철판 위에서 깨어났습니다. 날 도와주실 수 있겠습니까?" "그래, 그들이 참 잘도 도와주겠다. 아마 몇 초 정도 쳐다본 다음에는 경비병들을 불러서 대장을 전용 화로에 쳐 넣을 걸."{#morte_s25_1}'
...
label morte_s26: # from 25.0 25.1
    nr '"날 그냥 믿으라고… 대장이 스스로를 얼마나 강하다고 생각하든, 아니면 그들에게 무슨 말을 하든 그건 아무런 상관이 없어. 결국에는 그들이 대장을 잡아서 처리할 테니까. 대장이 아무리 강하다고 해도 밀폐된 무덤을 부수고 탈출하거나 불의 원소계에서 살아남을 정도로 강하지는 않아. 죽음으로부터 깨어나는 일 하나만 가지고도 여기 있는 친구들을 우려하게 만들고도 남는다고. 바보짓은 하지 말라고."{#morte_s26_1}'
...
label morte_s27: # from 24.1
    nr '"운명 따위는 엿이나 먹고 늘어지라고 해. 잘 들어, 대장. „운명“과 „나쁜“ „비참한“ 등의 부정적인 의미를 지닌 단어들이 한 문장에 동시에 나타나는 빈도가 얼마나 높은지 한 번 생각해 봐, 그럼 인생의 수수께끼들 중 하나가 풀릴 걸. 가장 좋은 선택은 운명보고 나가 뒈지라고 하는 거야, 늘 운명이 결코 허락하려고 하지 않는 선택지가 있는 법이니까.{#morte_s27_1}'
...
label morte_s28: # from 24.0 27.0 27.1
    nr '"좋아… 그럼 이 곳을 어서 뜨자고. 여기서 나가는 문은 잠겨 있으니까 우린 열쇠를 찾아야 해. 아마 이 방에 있는 걸어다니는 시체들 중 하나가 가지고 있을 거야."{#morte_s28_1}'
...
# s29 # say996
label morte_s29: # -
    nr '"아, 그래 대장은 이 모트와 또 얘기가 하고 싶은 거야?"{#morte_s29_1}'
...
label morte_s30: # from 21.0
    nr '"더스티들? 그들은 이 곳을 관리하고 있지. 그들을 알아보는 건 쉽지. 예외없이 검은 법복을 입고 있는데다가 꼭 사후경직을 일으킨 것 같은 얼굴들을 하고 있으니까. 그들은 스스로를 더스트맨이라고 부르며 당파 행세를 하고 있지만 실제로는 악귀같은 죽음 숭배자에 불과하다고. 그들은 피하는 게 좋아."{#morte_s30_1}'
...
label morte_s32: # from 16.0 19.0 20.0
    nr '"*아무 것도* 기억을 못한다고? 그거 타나리 똥같은 헛소리군. 정말이야?"{#morte_s32_1}'
...
label morte_s33: # from 32.0
    nr '"원 세상에… 어쨌든, 대장, 아마 대장 기억은 뇌 깊숙한 곳으로 가라앉은 것뿐일거라고. 운만 좋으면 다시 떠오를 거야, 날 믿으라고. 정말 요란한 밤이었던 모양이군. 누굴 해치거나 법을 어기는 일은 하지 안 했다면 좋으련만… 그래서 말인데, 당신은 자학증세가 있는 센세이트들 중 하나야, 아니면 누가 당신 몸에 그런 상처들을 낸 거야?"{#morte_s33_1}'
...
label morte_s34: # from 13.0
    nr '"무슨 지시 사항인 것 같군…" 모트는 헛기침을 한다. "어디 볼까. 그 내용은…"  주: "네가 스틱스 강물을 몇 통이나 마신 듯한 기분인 것은 알지만, 정신을 차리고 집중해야 한다. 네 소지품들 중에는 이 중대사에 대해서 일부나마 밝혀 줄 일지가 한 권 있을 것이다. 만약 파로드가 이미 죽지 않았다면 그가 나머지 부분에 대해 설명해줄 수 있을 것이다,  절대로 이 피부조각이나 일지를 잃어서는 안 된다, 아니면 우린 다시 스틱스에 빠지는 신세가 될 테니까. 알겠나? 그리고 내 말을 믿게 - 뭘 하든 간에 네가 누구이며, 어떤 일이 네게 일어나고 있으며, 어디서 왔는지에 대해 말해서는 안돼. 그렇지 않으면 화장터로 직행하게 될 테니."{#morte_s34_1}'
...
label morte_s35: # from 34.1 36.0
    nr '"아니… 여기 왔을 때 대장은 깨끗하게 털린 상태였어. 게다가 대장 몸에는 충분하고도 남을 정도의 일지가 적혀 있는 것 같군."{#morte_s35_1}'
...
label morte_s36: # from 34.0 35.0
    nr '"내가 아는 사람은 아냐. 하지만 난 별로 아는 사람이 없으니까. 그래도 이 파로드란 자가 어디 있는지 아는 사람은 있을 거야… 물론 그건 우리가 이 곳에서 탈출한 후의 얘기지만."{#morte_s36_1}'
...
# s37 # say1818
label morte_s37: # -
    nr '"정말 좋은 향수 냄새군! 우린 우리가 찾고 있는 걸 아가씨 집에 놓고 온 모양이야."{#morte_s37_1}'
...
# s38 # say1844
label morte_s38: # -
    nr '"대장, 내게 돈 좀 줄 수 있겠어? 내가… 을 한지는… 정말 오래 됐거든."{#morte_s38_1}'
...
# s40 # say2048
label morte_s40: # -
    nr '"네 꼬리나 몸이 판매용이 아니라는 건 참 다행한 일이군. 그 따위로는 입에 풀칠도 못할 테니."{#morte_s40_1}'
...
# s41 # say2067
label morte_s41: # -
    nr '"그년은 티플링이라고, 대장. 그것들은 마족의 피가 섞인 탓에 편집적이고 화를 잘 내지… 하지만 귀여운 꼬리로군. 그런 못생긴 년에게 달려 있다는 게 애석하지만."{#morte_s41_1}'
...
# s42 # say2074
label morte_s42: # -
    nr '"내 턱을 아예 통째로 떼어내는 건 어때, 이년아? 내 귀에 들리는 건 벌통 쓰레기가 재잘거리는 소리뿐이군! 어디 한 번 덤벼 봐! 네년 다리를 물어서 뜯어내 버릴 테니."{#morte_s42_1}'
...
# s43 # say2079
label morte_s43: # -
    nr '"미미르란 말하는 백과사전이지. 그건 바로 나라고, 대장."{#morte_s43_1}'
...
# s44 # say2348
label morte_s44: # -
    nr '"포기해, 대장. 기스와 얘기하려는 건 레이저바인과 사귀려는 것과 마찬가지라고."{#morte_s44_1}'
...
# s45 # say2354
label morte_s45: # -
    nr '"나라면 여기 있는 „모르는 게 약이다“라고 말하고 있는 것 같은 늙은이와 얘기하려는 데 시간을 낭비하지 않겠어. 여길 떠나자고, 대장."{#morte_s45_1}'
...
label morte_s46: # externs zf916_s2 zf916_s1 zf916_s0
    nr '"잠깐. 대장은 그녀가 날 어떤 눈으로 쳐다보는지 봤어? 허? 보이지? 내 후두부를 바라보는 그녀의 시선이?"{#morte_s46_1}'
...
label morte_s47: # from 46.0 46.1 121.1 121.2
    nr '"뭐… 눈이라도 먼 거야?! 그녀는 날 유혹하고 있었다고! 그녀는 정말 노골적으로 날 원했다고!"{#morte_s47_1}'
...
label morte_s48: # from 47.1 47.2
    nr '"그래, 그래, 뭐든 간에. 나처럼 죽은 지 오래되면 신호를 감지할 수가 있다고. 대장이 느끼기에는 너무 미묘할지도 모르지만. 그러니 내가 죽은 지 얼마되지 않은 섹시한 계집들과 뜨거운 밤을 보낼 동안 대장은 „어?“ „뭐가 어떻게 돌아가고 있는 거지?“ „내 기-기억이 어디로 갔지“하며 멍하니 서 있을 수밖에."{#morte_s48_1}'
...
label morte_s49: # from 47.0
    nr '"당신? 말도 안돼. 저 세상으로 간 계집들은 육체적인 매력이나 몸통이 있는지 여부는 신경도 쓰지 않는다고. 그녀들은 기백이 있는 남자를 원한다고. 그건 바로 나야, 대장. 당신? 대장같은 시체는 동전만큼이나 흔하다고."{#morte_s49_1}'
...
# s50 # say2709
label morte_s50: # -
    nr '"뭐? 뭐야? 이 계집이 대장을 귀찮게 하는 거야?"{#morte_s50_1}'
...
# s51 # say2711
label morte_s51: # -
    nr '"난 그걸 믿어. 그가 당신을 메인 메뉴로 돌려보내고 난 그냥 빼 주는 게 좋을 것 같군."{#morte_s51_1}'
...
label morte_s53: # from 52.0
    nr '"그는 다버스야. 그들은 퍼즐과 같은 기호로 „말하지.“ 만약 그가 무슨 말을 하는지 모르겠다면 번역해 줄 토박이를 찾거나 그와 의사소통을 할 방법을 찾는 게 좋을 걸. 정말 짜증나는 놈들이지. 내 생각에 놈들은 말을 할 수 있으면서도 일부로 퍼즐을 내서 다른 사람들을 골탕먹이려는 것 같아."{#morte_s53_1}'
...
label morte_s54: # from 53.0
    nr '"들리는 얘기로는 그들은 레이디 오브 페인의 청소부라는군. 그들은 레이디의 기분에 따라 시길을 부수거나 수리하지. 그들은 시체 파리보다도 징그럽다고." 모트는 한숨을 쉰다. "하지만 다버스는 때려죽일 수도 없어, 그러면 레이디가… 화를 낼 테니."{#morte_s54_1}'
...
label morte_s55: # externs eivene_s3
    nr '"내 생각에 그녀는 귀에 이상이 있는 것 같아, 대장. 관두고 그냥 가자고."{#morte_s55_1}'
...
label morte_s56: # from 55.0
    nr '"에… 그녀는 *티플링*이야, 대장. 조상이 옛날에 마족과 관계를 가진 탓에 몸에 마족의 피가 흐르고 있지. 그들 중 일부는 약간 미쳤고… 외관 역시 괴이하지."{#morte_s56_1}'
...
label morte_s57: # externs eivene_s20
    nr '"내 생각에 그녀는 귀에 이상이 있는 것 같아, 대장. 관두고 그냥 가자고."{#morte_s57_1}'
...
label morte_s58: # from 57.0
    nr '"에… 그녀는 *티플링*이야, 대장. 조상이 옛날에 마족과 관계를 가진 탓에 몸에 마족의 피가 다소 흐르고 있지. 그들 중 일부는 약간 미쳤고… 대개 외관 역시 괴이하지."{#morte_s58_1}'
...
label morte_s59: # externs eivene_s9
    nr '"대장에게 새로운 친구가 생긴 것 같군. 두 사람이 함께 시간을 보내거나, 또는…?{#morte_s59_1}'
...
label morte_s60: # externs eivene_s13
    nr '"내게 코가 없다는 걸 감사하게 된 건 이번으로 태어나서 두 번째인 것 같군."{#morte_s60_1}'
...
label morte_s62: # from 61.0
    nr '"만약 대장이 더스트맨과 주둥아리를 놀릴 생각이라면 난 좀 빼줘. 나하고 그들은 상성이 별로 좋지 않으니까… 그리고 대장도 그들과 가까이 하지 않는 게 좋아. 대장 말에 귀를기울이기 보다는 대장을 매장하거나 화장할 가능성이 더 크니까. 미친 짓 하지 말고 그냥 여기서 나가자고."{#morte_s62_1}'
...
label morte_s63: # externs dust_s40
    nr '"이봐! 귀가 먹었어? 대체 뭘 하는 거야?"{#morte_s63_1}'
...
label morte_s64: # from 62.0 63.0
    nr '"그럼 내 말을 듣지 말라고. 대장 장례식을 치르게 될 테니."{#morte_s64_1}'
...
# s65 # say3964
label morte_s65: # -
    nr '"와우, 대장. 그건 파괴 행위야. 그 볼트들은 그 뼈들을 고정시키는 유일한 것들이라고. 이런 오래된 친구들에게는 이미 사령술도 별 효과가 없다고."{#morte_s65_1}'
...
label morte_s66: # from 65.0 65.1 65.2
    nr '"오, 문제가 된다는 얘긴 아니야." 모트는 기묘한 스타일로 아래 위로 움직이는 데 그건 어깨를 으쓱한다는 표현인 듯하다. "난 대장이 그걸 아는가 확인해 보려고 했을 뿐이야, 마음대로 하라고."{#morte_s66_1}'
...
label morte_s67: # from 66.3
    nr '"흠… 이 회색 수염이 내가 자기 몸을 빌려도 뭐라고 하지 않을지 모르겠군…"{#morte_s67_1}'
...
label morte_s68: # from 67.0
    nr '"회색 수염… 대장도 알다시피 늙다리, 늙은이, 노인 등을 가리키는 말이야."{#morte_s68_1}'
...
label morte_s69: # from 67.1 68.0
    nr '모트는 잠시 그 스켈레톤을 살펴보더니 고개를 젓는다. "아니… 내겐 이것보다 신선한 놈이 필요해. 그리고 좀 더 품위가 있는 몸이… 이건 사방에 금하고 깨진 곳 투성이야 "{#morte_s69_1}'
...
label morte_s70: # from 67.2 68.1 69.0 127.0
    nr '"아, 대장은 정말 웃기는군." 모트는 당신을 노려본다. "그리고 대장은 그런 말을 할 입장이 아니지. 대장이 근처에 있으면 거울들이 자비를 구한다고."{#morte_s70_1}'
...
label morte_s71: # from 70.0
    nr '모트는 코방귀를 뀐다. 허파도 없이 어떻게 그런 일을 할 수가 있는지 당신으로서는 알 수가 없다.{#morte_s71_1}'
...
label morte_s72: # from 71.0
    nr '"대장이 준비실을 탈출하도록 도와준 건 점점 더 커져만 가는 내 후회하는 일 목록에 방금 추가되었어." 모트는 다시 코방귀를 뀐다. "난 그냥 당신이 썩도록… 아니, 더 썩도록 내버려 두었어야 했어."{#morte_s72_1}'
...
label morte_s74: # from 73.0
    nr '"아… 미안." 모트는 스켈레톤의 머리 쪽으로 이동하여 그것을 쳐다본 후, 아래쪽으로 내려오면서 갑옷과 칼을 살펴본다. "오, 예스! 그래, 좋았어! 이거면 될 것 같아."{#morte_s74_1}'
...
label morte_s75: # from 74.2 74.3
    nr '"그럼 대체 왜 내게 그걸 원하느냐고 물어본 거야? 자신의 잔인성을 배양하기 위한 연습이라도 한 거야?" 모트는 분노한 듯 아래위로 움직인다. "내가 대장을 위해 그토록 헌신했는데…"{#morte_s75_1}'
...
label morte_s76: # from 75.2
    nr '모트는 당신을 잠시 응시한다. "뭐야, 우리가 예전에 결혼한 적이라도 있는 거야? „나는 자네가 다치는 걸 원하지 않아“하는 따위의 헛소리는 대체 뭐야?" 모트는 당신을 노려본다. 만약 대장이 정말 나에 대해 신경을 썼다면 내 머리를 저 자이언트 스켈레톤의 몸통에 부착할 방법을 찾으려고 했을 거라고."{#morte_s76_1}'
...
label morte_s78: # from 77.0
    nr '"만약 대장이 더스트맨과 주둥아리를 놀릴 생각이라면 난 좀 빼줘. 나하고 그들은 상성이 별로 좋지 않으니까… 그리고 대장도 그들과 가까이 하지 않는 게 좋아. 대장 말에 귀를기울이기 보다는 대장을 매장하거나 화장할 가능성이 더 크니까. 미친 짓 하지 말고 그냥 여기서 나가자고."{#morte_s78_1}'
...
# s79 # say4136
label morte_s79: # -
    nr '"이봐! 귀가 먹었어? 대체 뭘 하는 거야?"{#morte_s79_1}'
...
label morte_s80: # from 78.0 79.0
    nr '"그럼 내 말을 듣지 말라고. 대장 장례식을 치르게 될 테니."{#morte_s80_1}'
...
label morte_s82: # from 81.0
    nr '"만약 대장이 더스트맨과 주둥아리를 놀릴 생각이라면 난 좀 빼줘. 나하고 그들은 상성이 별로 좋지 않으니까… 그리고 대장도 그들과 가까이 하지 않는 게 좋아. 대장 말에 귀를기울이기 보다는 대장을 매장하거나 화장할 가능성이 더 크니까. 미친 짓 하지 말고 그냥 여기서 나가자고."{#morte_s82_1}'
...
label morte_s83: # externs dustfem_s40
    nr '"이봐! 귀가 먹었어? 대체 뭘 하는 거야?"{#morte_s83_1}'
...
label morte_s84: # from 82.0 83.0
    nr '"그럼 내 말을 듣지 말라고. 대장 장례식을 치르게 될 테니."{#morte_s84_1}'
...
label morte_s85: # externs vaxis_s9
    nr '모트는 대회에 끼어 들어 당신에게 속삭인다. "세상에… 얼간이는 *아나키스트*야. 아마 좀비로 변장하는 건 그 미치광이들로서도 처음일 걸."{#morte_s85_1}'
...
label morte_s86: # from 85.0
    nr '"아나키스트…그들은 당파들 중 하나지…" 모트는 욕설을 퍼부으려고 하는 것 같다, 하지만 그는 곧 좀비가 당신들 둘을 바라보며 귀를 바짝 기울이고 있다는 사실을 눈치챈다. "…그들은, 어, 모든 사람들을 정부의 사슬로부터 *해방*시키려고 하지. 구체제를 붕괴시키고 아무런 질서도 없는 새로운 질서를 수립하려고 해."{#morte_s86_1}'
...
label morte_s87: # externs vaxis_s13
    nr '속삭인다: "그는 대장이 미친 건 아닌가 생각하고 있는 거야… 뭐 그건 나도 마찬가지지만. 이제 그만 „난 죽음에서 깨어났소“하는 잡소리는 집어치워. 대장은 날 정말 창피하게 만들고 있다고.{#morte_s87_1}'
...
label morte_s88: # from 87.0 87.1 87.2 87.3
    nr '모트는 한숨을 쉰다. "이봐, 대장… 정신 좀 차리라고. 모든 사람들에게 항상 진실만 얘기할 수는 없어. 우리가 만나는 모든 사기꾼들에게 봉이 되어줄 순 없잖아?"{#morte_s88_1}'
...
label morte_s89: # externs vaxis_s23
    nr '"잠깐…" 모트는 놀란 듯하다. "이 얼간이는 *아나키스트*가 틀림없어. 헤, 아마 좀비로 변장하는 건 그 미치광이들로서도 처음일 걸."{#morte_s89_1}'
...
label morte_s90: # from 89.0
    nr '"아나키스트… 그들은 권력자들을 염탐하고 약간이라도 질서나 통제의 냄새가 나는 것은 무엇이든 무너트리려는 데 시간을 낭비하는 당파지." 모트는 코방귀를 뀐다. "아나키스트는 일단 모든 조직과 체제가 붕괴되면 다원 우주의 모든 자들은 즐겁게 자유롭게 각기 자신만의 „진실“을 찾을 수 있을 거라고 믿지. 그들은 새로운 질서를 수립하기를 원해 -- 아무런 질서도 없는 질서를."{#morte_s90_1}'
...
label morte_s91: # externs vaxis_s46
    nr '"그의 말로는 이 파로드란 작자가 더스트맨에게 많은 사자를… 시체를 팔고 있는 모양이야. 그게 수집자들이 하는 일이지. 그들은 시체를 모아서 더스트맨에게 팔지. 이 파로드란 자가 얼마나 많은 시체를 팔았는지, 더스트맨은 파로드가 벌통의 주민들을 미처 때가 되기도 전여 죽여서 가져오는 것은 아닌가 의심하는 것 같아."{#morte_s91_1}'
...
label morte_s92: # externs vaxis_s47
    nr '"그는 누가 당신 물건을 강탈했는지 알고 싶어해. 그런 일이 있기는 있었을 거야."{#morte_s92_1}'
...
label morte_s93: # externs vaxis_s39
    nr '"그래, *그들*은 정말 얼간이야."{#morte_s93_1}'
...
label morte_s94: # externs vaxis_s65
    nr '"이런 짓거리를 계속하고 있다니 믿을 수가 없군. 대장은 얼마나 더럽게 미친 거야?"{#morte_s94_1}'
...
label morte_s95: # externs vaxis_s66
    nr '"그의 입을 더 단단히 꿰매 버릴 순 없겠어?"{#morte_s95_1}'
...
label morte_s97: # from 96.0
    nr '"만약 대장이 더스트맨과 주둥아리를 놀릴 생각이라면 난 좀 빼줘. 나하고 그들은 상성이 별로 좋지 않으니까… 그리고 대장도 그들과 가까이 하지 않는 게 좋아. 대장 말에 귀를기울이기 보다는 대장을 매장하거나 화장할 가능성이 더 크니까. 미친 짓 하지 말고 그냥 여기서 나가자고."{#morte_s97_1}'
...
# s98 # say5035
label morte_s98: # -
    nr '"이봐! 귀가 먹었어? 대체 뭘 하는 거야?"{#morte_s98_1}'
...
label morte_s99: # from 97.0 98.0
    nr '"그럼 내 말을 듣지 말라고. 대장 장례식을 치르게 될 테니."{#morte_s99_1}'
...
label morte_s100: # externs soego_s20
    nr '"뭘 하는 거야?! 만약 그를 죽일 거라면 빨리 해치우라고!{#morte_s100_1}'
...
label morte_s101: # externs soego_s10
    nr '"적어도 그는 걸을 수가 있잖아. 모트는 코방귀를 뀐다. "떠다니는 것도 좋지만 누굴 걷어찰 수가 없잖아."{#morte_s101_1}'
...
label morte_s102: # externs dhall_s5
    nr '"와우, 대장! 무슨 짓을 하는 거야?"{#morte_s102_1}'
...
label morte_s103: # from 102.0
    nr '"이봐, 더스티랑 얘기를 하는 건 자살…"{#morte_s103_1}'
...
label morte_s104: # externs dhall_s0
    nr '"*특히* 아픈 더스티하고는 얘기를 하지 않는 게 좋아. 자, 어서 떠나자고. "여기서 빨리 떠날수록 우리에게 좋--"{#morte_s104_1}'
...
label morte_s105: # externs deionarra_s8 deionarra_s48 deionarra_s26 deionarra_s19 deionarra_s0
    nr '"다시 돌아왔어, 대장? 날 버리다니 너무 하잖아."{#morte_s105_1}'
...
label morte_s107: # from 106.0
    nr '"대장이 어떤 여자와 얘기를 하고 있었다고? 어디?" 모트는 흥분한 듯 주위를 둘러본다. "그녀는 어떻게 생겼지?"{#morte_s107_1}'
...
label morte_s108: # from 107.0
    nr '"에… 아니, 대장은 거기서 그냥 두리번거리다가 마치 석상처럼 서 있었다고.. 나는 대장이 또 미친 건 아닌가 걱정을 했었디고."{#morte_s108_1}'
...
# s109 # say6324
label morte_s109: # -
    nr '"내가 전에 했던 일이 생각나는군." 그는 좀 창피한 듯하다. "그래, 팔은 없었지만…"{#morte_s109_1}'
...
label morte_s110: # externs s42_s3 s42_s0
    nr '"와우, 대장. 그건 파괴 행위야. 그 볼트들은 그 뼈들을 고정시키는 유일한 것들이라고. 이런 오래된 친구들에게는 이미 사령술도 별 효과가 없다고."{#morte_s110_1}'
...
label morte_s111: # externs s42_s3 s42_s2 s42_s0
    nr '"흠… 이 회색 수염이 내가 자기 몸을 빌려도 뭐라고 하지 않을지 모르겠군…"{#morte_s111_1}'
...
label morte_s112: # externs s42_s13
    nr '"그만두라고. 그의 팔은 곧 떨어질 거라고."{#morte_s112_1}'
...
label morte_s113: # from 54.0 54.1
    nr '"그녀는 이 도시의 지배자야. 대장도 그녀를 보면 알 거야. 그녀의 얼굴 주변에는 칼날들이 달렸고, 그녀는 거인만큼이나 거대하며, 저 친구들처럼 공중에 떠다니지." 모트는 당신들 둘을 바라보고 있는 다버스를 가리킨다. "아무도 그녀에 대해서 자세히 알지는 못해… 그녀는 거의 말을 하지 않아. 대장이 알아야 할 건 그녀를 화나게 해서는 안 된다는 것 뿐이야. 이건 내 충고인데, 만약 그녀를 보게 되면 도망치라고."{#morte_s113_1}'
...
# s114 # say6784
label morte_s114: # -
    nr '모트는 조롱한다. "이 떠다니는 염소 대가리들이 하는 말을 해석하느니 차라리 타나리 창자를 걸러내는 게 낫지. 통역을 원해? 시길 토박이를 찾아보라고."{#morte_s114_1}'
...
# s115 # say6786
label morte_s115: # -
    nr '"아, 물론 그들에게도 이름이 있겠지."{#morte_s115_1}'
...
# s117 # say6794
label morte_s117: # -
    nr '모트는 조롱한다. "이 떠다니는 염소 대가리들이 하는 말을 해석하느니 차라리 타나리 창자를 걸러내는 게 났지. 통역을 원해? 여기 있는 휜들링 계집에게 부탁하라고." 그는 안나를 가리킨다. "그녀는 벌통 토박이니까."{#morte_s117_1}'
...
# s118 # say6797
label morte_s118: # -
    nr '모트는 조롱한다. "이 떠다니는 염소 대가리들이 하는 말을 해석하느니 차라리 타나리 창자를 걸러내는 게 났지. 통역을 원해?" 그는 다콘을 가리킨다. "여기 있는 „나는 잘났으니 너희들 따위와는 얘기를 안 해“하는 양반에게 부탁하라고."{#morte_s118_1}'
...
# s119 # say6800
label morte_s119: # -
    nr '모트는 조롱한다. "이 떠다니는 염소 대가리들이 하는 말을 해석하느니 차라리 타나리 창자를 걸러내는 게 났지. 통역을 원해? 타나리에게 부탁하라고." 그는 훨-후럼-그레이스를 가리킨다. "아마 그녀는 이 친구들하고 늘 대화를 나누고 있을 거라고."{#morte_s119_1}'
...
# s120 # say7040
label morte_s120: # -
    nr '당신이 돌아서자 모트가 당신을 쳐다보고 있다. "에? 에?"{#morte_s120_1}'
...
label morte_s121: # from 120.0
    nr '"저 죽은 미인이 날 어떻게 쳐다보는지 봤어?" 모트는 잔뜩 기대라도 하듯 이빨을 딱딱거린다. "그녀는 자신의 관을 따뜻하게 해줄 행운아를 찾고 있었다고."{#morte_s121_1}'
...
label morte_s122: # from 121.0
    nr '모트는 당신을 무시하고 사색에 잠긴다. "나는 주목을 받는 게 싫지는 않아… 하지만 난 남들이 날 해골 이상의 존재로 봐주기를 원해, 이해하지? 내게는 동물적 본능 이상의 감정이 있어. 나는 사랑을 원한다고."{#morte_s122_1}'
...
label morte_s123: # from 122.0
    nr '"와우, 대장…" 모트는 팔이 미치는 범위 밖으로 약각 물러난다. "여자들은 애인을 원하지 전사를 원하지 않는다고."{#morte_s123_1}'
...
label morte_s124: # from 122.1
    nr '"그래, 난 해골에 불과할지도 모르지만 마음만은 따뜻하다고."{#morte_s124_1}'
...
label morte_s125: # from 124.0
    nr '"뭐, 대장은 내 꿈과 포부에 침을 뱉으려고 내 삶에 껴든 거야?! 좋아, 그럼 그렇게 하라고. 내게 심장은 없을지 모르지만 영혼은 있다고."{#morte_s125_1}'
...
label morte_s126: # from 123.0
    nr '"만약 대장에게 죽을 때 잃어버린 감각이 반만이라도 남아있었다면 그런 소린 안 할 걸." 모트는 지금까지보다 한층 더 찰난 체 하는 목소리로 말한다. "사랑에 대해서 나보다 잘 아는 사람이 있으면 나오라고 해."{#morte_s126_1}'
...
# s127 # say7071
label morte_s127: # -
    nr '모트는 스켈레톤을 잠시 살펴본 후 고개를 젓는다. "아니… 이 놈은 너무 깨끗해… 살이 거의 남아있지 않잖아. 게다가 뼈에서 그 백색 도료를 다 제거하긴 힘들 것 같아."{#morte_s127_1}'
...
# s129 # say7187
label morte_s129: # -
    nr '"미미르는 말하는 백과사전이지. 그건 바로 나야, 대장."{#morte_s129_1}'
...
# s130 # say7188
label morte_s130: # -
    nr '모트는 창녀가 음탕한 욕설을 유수처럼 쏟아 내는 걸 최면이라도 걸린 듯 쳐다본다. 말사태가 끝난 후 모트는 잠시 조용히 있다가 당신 쪽으로 고개를 돌린다. "와우, 대장. 내 역설의 레퍼토리가 늘었어." 모트는 숨을 헐떡이는 정녀에게로 다시 고개를 돌린다. "난 사랑에 빠진 것 같아."~ [MRT387]{#morte_s130_1}'
...
# s131 # say7775
label morte_s131: # -
    nr '"와우, 대장." 모트는 당신이 그 생물과 미쳐 얘기하기도 전에 말을 가로막는다. "관둬. 거리에서 아무 마족이나 붙잡고 말을 걸지 마. 놈을 그냥 내버려 두라고."{#morte_s131_1}'
...
label morte_s132: # from 131.0
    nr '"아니, 안돼." 모트는 그 생물을 흘긋 보더니 다시 당신 쪽으로 고개를 돌리고 속삭이는 듯한 목소리로 말한다. "그들은 성질이 까다로워. 그냥 가자고."{#morte_s132_1}'
...
# s133 # say7805
label morte_s133: # -
    nr '당신이 그 생물과 얘기하려고 하자 모트는 한숨을 쉰다.{#morte_s133_1}'
...
label morte_s134: # from 133.0
    nr '"아, 아무 것도 아냐. 체험이 가장 좋은 선생이지." 모트는 고개를 끄덕여 그 생물을 가리킨다. "어서 하라고."{#morte_s134_1}'
...
label morte_s135: # from 44.0 44.1
    nr '"그래, „기스“야…" 모트는 아직도 당신을 응시하고 있는 기스를 흘긋 본다. "다른 때 다시 얘기하자고."{#morte_s135_1}'
...
# s136 # say9860
label morte_s136: # -
    nr '"이봐, 대장… 대장은 그를 깨우기도 전에 먼저 죽일 거라고!"{#morte_s136_1}'
...
# s137 # say11946
label morte_s137: # -
    nr '모트가 다가온다. "뭐야, 대장?"{#morte_s137_1}'
...
label morte_s138: # from 137.0
    nr '모트는 당신 손바닥을 쳐다본다. "왝!" 그는 역겨워 하는 것 같다. "정말 추악하게 생겼군, 안 그래?"{#morte_s138_1}'
...
# s139 # say11948
label morte_s139: # -
    nr '"말도 안돼." 모트는 몸서리친다. "대장이라면 그런 걸 몸 안에 넣고 싶겠어?"{#morte_s139_1}'
...
label morte_s140: # from 139.0
    nr '"그 작은 요물들이 내 가까이에 오기만 하면…" 모트는 잠시 멈춘다. "이빨을 어떻게 협박해야 하는지는 나도 모르겠는데…"{#morte_s140_1}'
...
label morte_s141: # from 139.1 140.1
    nr '몸부림은 오래가지 않는다. 당신은 모트의 머리를 팔에 끼우고 누른다(달리 잡을 부위가 없으니까). 모트는 당신을 물어뜯어 당신으로부터 벗어나려고 하나, 이빨들은 당신 손에서 뛰쳐나와 모트의 입안으로 벌떼처럼 몰려 들어간다. 모트는 잉그레스의 이빨들이 그의 이빨들을 뽑아 내고 그 빈자리를 대신 채우는 동안 마구 악을 쓴다.{#morte_s141_1}'
...
label morte_s142: # from 149.0
    nr '모트는 계속 악을 쓴다. 이빨들은 자리를 잡고 구멍을 뚫는 끔찍한 소리를 내면서 잇몸에 뿌리를 내리기 시작한다.{#morte_s142_1}'
...
label morte_s143: # from 141.0 142.0
    nr '모트에게는 당신 소리가 들리지 않는 듯하다… 그는 계속해서 악을 쓴다. 그러더니 갑자기 이빨들을 서로 부딪히게 만든다. 그러나 그가 세 번 이빨을 으드득한 직후, 아랫니와 윗니가 서로 잠겨 그가 입을 열지 못하게 만든다.{#morte_s143_1}'
...
label morte_s144: # from 143.0
    nr '모트는 눈을 크게 뜨고 당신에게 뭐라고 중얼거린다.{#morte_s144_1}'
...
label morte_s145: # from 144.0
    nr '이빨들은 갑자기 풀리고 모트는 심호흡을 한다. "난 대장에게 꼭 복수를 할 거야." 그가 말한다. "그건 정말 추잡한 짓이었어."{#morte_s145_1}'
...
label morte_s146: # from 145.0 150.0
    nr '모트는 실험 삼아 턱을 움직여 본다. "기묘하군. 하지만 과히 나쁘진 않은데." 갑자기 이빨은 길게 늘어나 송곳니가 된다. "오오! 그들은 변화할 수 있군!" 그것들은 보통 크기로 줄었다가, 다시 송곳니가 되었다가, 다시 보통 크기로 돌아온다… "내 마음에 들 것 같군…"{#morte_s146_1}'
...
label morte_s147: # from 146.0 146.1
    nr '"아, 하지만 복수는 할 거야." 모트는 대답한다. 그가 히죽 웃자 이빨은 다시 송곳니가 된다. "기다리시라고."{#morte_s147_1}'
...
# s148 # say11957
label morte_s148: # -
    nr '"뭐야?" 모트는 가까이 와서 당신 손바닥을 들여다 본다. "이봐… 그것들은 무슨 계획을 하는 것 같군, 안 그래?"{#morte_s148_1}'
...
label morte_s149: # from 148.0
    nr '그 다음에 일어난 일은 형용하기 어렵고… 보기에 정말 고통스럽다. 당신이 미처 손바닥을 접기 전에 이빨들은 당신 손에서 뛰쳐나와 모트의 입안으로 벌떼처럼 몰려 들어간다. 모트는 잉그레스의 이빨들이 그의 이빨들을 뽑아 내고 그 빈자리를 대신 채우는 동안 마구 악을 쓴다.{#morte_s149_1}'
...
label morte_s150: # from 144.1
    nr '이빨들은 갑자기 풀리고 모트는 심호흡을 한다. "난 대장에게 꼭 복수를 할 거야! 모두 대장이 꾸민 일이지! 난 알아!"{#morte_s150_1}'
...
# s151 # say12389
label morte_s151: # -
    nr '모트는 당신에게 속삭인다. "보스, 뭔가 낌새가 이상해. 아무 마족이나 휴가를 갈 정도로 블러드 워의 상황은 급변하지 않았다고. 그들은 뭔가를 *원하는* 게 틀림없어. 조심하라고." 그 동안에도 테가린은 계속 동료와 얘기를 하고 있다.{#morte_s151_1}'
...
# s152 # say12449
label morte_s152: # -
    nr '"보스, 저 자식들이 무슨 음모를 꾸미고 있다는 건 그 어느 때보다도 명백해. 내가 듣기에 그들은 탈영을 했고, 베이터에서의 자신들의 지위를 향상시킬 방법을 모색하고 있는 것 같아. 놈들하고는 얘기하지 않는 게 좋아, 보스… 대장은 어떤 게임을 하는지 모르고, 잘못하면 문자 그대로 불타버릴 수도 있다고."{#morte_s152_1}'
...
# s153 # say12466
label morte_s153: # -
    nr '모트는 가까이 다가와 당신 귀에 대고 속삭인다. "그가 옳아, 대장… 왜 대장이 그렇게 화가 난 건지 모르겠군…"{#morte_s153_1}'
...
# s155 # say12621
label morte_s155: # -
    nr '모트는 모든 관심이 자신에게 쏠리자 놀란 듯하다. "뭐야? 뭐야?" 만약 그에게 입술이 있었다면 그가 천진난만하게 휘파람을 불었을 것이라는 생각이 든다.{#morte_s155_1}'
...
label morte_s156: # from 155.0
    nr '"이 사람 얘기를 듣자고, 어때?" 모트는 고개를 돌려 쥐 사냥꾼을 냉엄하게 바라본다.{#morte_s156_1}'
...
label morte_s157: # from 155.1 156.1
    nr '모트는 부끄러운 듯 눈알을 희번덕거린다. "그건… 말하는 백과사전이야. 별로 자랑스러운 건 아니야. 자, 이 친구가 하는 얘기를 듣자고, 좋아?"{#morte_s157_1}'
...
label morte_s158: # from 156.0
    nr '"이봐, 대장… 내가 왜 대장에게 뭘 숨기겠어? 나는 대장에게 필요한 건 모두 말했다고. 그냥 이 친구가 하는 얘기나 듣자고."{#morte_s158_1}'
...
# s160 # say12626
label morte_s160: # -
    nr '"죽었어, 대장… 죽었단 말이야."{#morte_s160_1}'
...
# s161 # say12627
label morte_s161: # -
    nr '"죽었어, 대장… 죽었단 말이야."{#morte_s161_1}'
...
# s162 # say13748
label morte_s162: # -
    nr '"가지가 너무 많이 꺾인 나무로군." 모트는 눈알을 희번덕거린다. "카오시텍츠와 얘기를 하는 건 무의미해, 대장. 놈들은 미치광이야."{#morte_s162_1}'
...
label morte_s163: # from 162.0 162.1
    nr '"그들은 우두머리가 오래 가지 못한다는 것 말고는… 아무런 규칙도 없는 „당파“야. 그들은 „카오스맨“이라고도 불려. 그 이유는 설명할 필요도 없겠지."{#morte_s163_1}'
...
label morte_s164: # from 163.0
    nr '"마치 파리가 꼬이는 것처럼 새로운 멤버들이 모여들어… 충분히 미쳤거나 혼돈스러운 놈들이 말이야. 아마 신규 멤버를 모집하는 자도 없을 거야… 하지만 녀석들에 대해 확실히 말할 수 있는 건 아무 것도 없으니까."{#morte_s164_1}'
...
# s165 # say13828
label morte_s165: # -
    nr '"가지가 너무 많이 꺾인 나무로군." 모트는 눈알을 희번덕거린다. "카오시텍츠와 얘기를 하는 건 무의미해, 대장. 놈들은 미치광이야."{#morte_s165_1}'
...
label morte_s166: # from 165.0 165.1
    nr '"그들은 우두머리가 오래 가지 못한다는 것 말고는… 아무런 규칙도 없는 „당파“야. 그들은 „카오스맨“이라고도 불려. 그 이유는 설명할 필요도 없겠지."{#morte_s166_1}'
...
label morte_s167: # from 166.0
    nr '"마치 파리가 꼬이는 것처럼 새로운 멤버들이 모여들어… 충분히 미쳤거나 혼돈스러운 놈들이 말이야. 아마 신규 멤버를 모집하는 자도 없을 거야… 하지만 녀석들에 대해 확실히 말할 수 있는 건 아무 것도 없으니까."{#morte_s167_1}'
...
# s168 # say14075
label morte_s168: # -
    nr '"좋아 그럼…" 모트는 당신에게 조용히 말한다. "가자고, 대장. 이 더스티는 비료나 되라고 하고."{#morte_s168_1}'
...
# s169 # say15339
label morte_s169: # -
    nr '"저 잘난 체하는 놈을 주 동강 내라고, 보스! 본때를 보여주라고!"{#morte_s169_1}'
...
# s171 # say15341
label morte_s171: # -
    nr '"난 덩치가 큰 흉터투성이 사내에게 동전 열 닢을 걸겠어!" 모트는 가까이 다가와 속삭인다. "그건 대장이야. 우릴 실망시키지 말라고."{#morte_s171_1}'
...
# s172 # say15342
label morte_s172: # -
    nr '"좋아, 대장. 이번에는 놈을 혼내 주라고. 비겁하게 싸워도 좋아!"{#morte_s172_1}'
...
# s173 # say15343
label morte_s173: # -
    nr '"그래, 이 건방지고 잘난 체하는 엘리트주의자야… 그가 하는 말은 들었지!"{#morte_s173_1}'
...
# s174 # say15344
label morte_s174: # -
    nr '"*내*가 누구냐고? 흥! 난 네 아버지였을 수도 있지만 그 원숭이가 날 위층에서 때렸 거든."{#morte_s174_1}'
...
label morte_s175: # from 174.0 174.1
    nr '"뭐가 문제지, 공주님? 할 말이 없나? 파리가 네 목구멍으로 들어가기 전에 그 내려간 턱이나 들어 올리라고! 그래, 무슨 말인지 알겠지? 네 야한 브래지어를 챙겨 가지고 네가 있어야 할 곳인 네 어머니의 역겨운 스커트 속으로 기어 들어가라고! 그리고 그년에게 내 안부를 전하는 걸 잊지 말도록!"{#morte_s175_1}'
...
label morte_s176: # from 175.0
    nr '"허? 미안해, 대장. 난 저런 자식을 보면 참을 수가 없어."{#morte_s176_1}'
...
label morte_s177: # from 175.1
    nr '"내가 아는 게 그 정도라면 나는-"{#morte_s177_1}'
...
# s178 # say15348
label morte_s178: # -
    nr '"뭐? 난 미미르에 불과하다고, 대장! 난 „결투“를 할 수가 없어!"{#morte_s178_1}'
...
# s179 # say15349
label morte_s179: # -
    nr '"그건… 일종의 말하는 백과사전이야. 그 일에 대해선 말하고 싶지가 않아. 좀 부끄럽거든, 정말이야."{#morte_s179_1}'
...
# s180 # say15350
label morte_s180: # -
    nr '"이봐, 대장… 놈을 그렇게 그냥 보내 줄 거여? 가서 그 좀스러운 방탕자를 혼내주자고! 대장이 놈을 잡으면 난 그의 눈을 공격할게!"{#morte_s180_1}'
...
label morte_s181: # from 185.0
    nr '"허? 그래, 대장. 하라는 대로 하지."{#morte_s181_1}'
...
label morte_s182: # from 181.1
    nr '모트는 조용히 당신을 바라보더니 고개를 끄덕인다. "그래, 할 수도 있겠지. 만약 그게 대장한테 중요하다면 하겠어."{#morte_s182_1}'
...
# s183 # say16615
label morte_s183: # -
    nr '"글쎄, 이런 짓이 무슨 소용이 있는지 *정말* 모르겠군. 그런다고 해서 이 나무들이 살아날 건 아니라고, 대장."{#morte_s183_1}'
...
# s184 # say16616
label morte_s184: # -
    nr '"이런 젠장. 이런 식으로 시간을 낭비한다니 믿을 수가 없군!"{#morte_s184_1}'
...
# s185 # say16617
label morte_s185: # -
    nr '"이봐, 대장. 난 별난 것들을 많이 봤어… 하지만 그런 일이 정말 *가능*하다니 정말 믿을 수가 없어."{#morte_s185_1}'
...
# s186 # say16618
label morte_s186: # -
    nr '"오! 도저히 지켜볼 수가 없군!"{#morte_s186_1}'
...
# s187 # say17533
label morte_s187: # -
    nr '"나쁠 것 없지. 우리가 기분이 나쁠 때 놈을 걷어차면 참 재미있겠지, 안 그래?" 흠… 뭐 적어도 대장이 나 대신 걷어차 줄 수는 있겠지. 나도 그 뜨거운 석탄으로 쑤시면 4.5 미터를 뛴다는 걸 보고 싶어!"{#morte_s187_1}'
...
# s188 # say18801
label morte_s188: # -
    nr '모트는 시선을 그에게로 돌린다. "꺼져."{#morte_s188_1}'
...
# s189 # say18809
label morte_s189: # -
    nr '모트는 사내의 손가락을 엽기적인 담배처럼 이빨로 물고 있다. 그는 손가락을 문 채로 말한다. "또 날 건드리면 네놈 손도 무사하지 못할 걸."{#morte_s189_1}'
...
label morte_s190: # from 189.0
    nr '모트는 손가락을 사내를 향해 내뱉는다. 그것은 사내의 가슴에 맞고 땅바닥에 떨어진다.{#morte_s190_1}'
...
# s191 # say18816
label morte_s191: # -
    nr '모트는 돌아서 당신을 향한다. "대장, 이 쓰레기에겐 아무 것도 주지 마."{#morte_s191_1}'
...
# s192 # say18818
label morte_s192: # -
    nr '모트는 사내 쪽으로 시선을 돌린다. "너한테 얘기한 게 아니야, 이 머저리야. 너한테 얘기할 때는 너같은 놈도 이해할 수 있도록 꿀꿀거려 줄 테니까 안심하라고."{#morte_s192_1}'
...
# s194 # say18826
label morte_s194: # -
    nr '"난 다원 우주에서 제일 멍청한 자와 떠다니고 있군."{#morte_s194_1}'
...
# s196 # say18832
label morte_s196: # -
    nr '"내가 떠 있는 곳에서도 별로 보기가 좋지 않군."{#morte_s196_1}'
...
# s197 # say19031
label morte_s197: # -
    nr '"이봐, 덩치 큰 친구. 벽 속의 당신 친구는 잘 지내고 있어?"{#morte_s197_1}'
...
# s198 # say19032
label morte_s198: # -
    nr '모트는 고개를 숙인다. "대장 마음대로 하라고."{#morte_s198_1}'
...
# s199 # say19551
label morte_s199: # -
    nr '"와우, 대장… 정말 예쁘군, 안 그래? 아무 데서나 저런 미인을 만날 수 있는 건 아니라고."{#morte_s199_1}'
...
label morte_s200: # from 199.0
    nr '모트는 해골 안에서 눈알을 굴린다. "허! 언젠가는 대장도 내 말을 이해하게 될 거라고."{#morte_s200_1}'
...
label morte_s201: # from 199.1
    nr '"그래, 보라고, 내가 얘기했… 이봐!" 모트는 돌아서 당신을 마주본다. "나한테 빈정대는 거야?"{#morte_s201_1}'
...
# s202 # say19681
label morte_s202: # -
    nr '" 에… 그… 것하고는 얘기하지 않는 게 좋을 걸."{#morte_s202_1}'
...
label morte_s203: # from 202.0
    nr '"그들도 한때는 인간이었어… 하지만 그들, 또는 그들의 선조가 시체를 먹었고 그 결과로 저 꼴이 된 거지. 정말 역겨운 얘기야, 대장… 그들은 동물과 별로 다를 것이 없어. 놈들은 *워험한* 동물이야."{#morte_s203_1}'
...
# s204 # say19702
label morte_s204: # -
    nr '" 에… 그… 것하고는 얘기하지 않는 게 좋을 걸."{#morte_s204_1}'
...
label morte_s205: # from 204.1 206.0
    nr '"그들도 한때는 인간이었어… 하지만 그들, 또는 그들의 선조가 시체를 먹었고 그 결과로 저 꼴이 된 거지. 정말 역겨운 얘기야, 대장… 그들은 동물과 별로 다를 것이 없어. 놈들은 *워험한* 동물이야."{#morte_s205_1}'
...
label morte_s206: # from 204.0
    nr '"그건 같은 게 아니라고, 대장…"{#morte_s206_1}'
...
# s207 # say20469
label morte_s207: # -
    nr '"이 늙은이는 장님에다가 귀도 거의 먹었다고."{#morte_s207_1}'
...
# s208 # say20470
label morte_s208: # -
    nr '"내장이라는 의미인 것 같아. 그 의미였기를 바래."{#morte_s208_1}'
...
# s209 # say20471
label morte_s209: # -
    nr '모트는 마타 쪽으로 돌아선다. "그래, „물건들.“" 그는 다시 당신 쪽으로 돌아선다. "다 의미론의 문제지."{#morte_s209_1}'
...
# s210 # say20472
label morte_s210: # -
    nr '"난 이 짓거리를 보지 *않을* 거야."{#morte_s210_1}'
...
label morte_s212: # from 211.0
    nr '"그는 다버스야. 그들은 퍼즐과 같은 기호로 „말하지.“ 만약 그가 무슨 말을 하는지 모르겠다면 번역해 줄 토박이를 찾거나 그와 의사소통을 할 방법을 찾는 게 좋을 걸. 정말 짜증나는 놈들이지. 내 생각에 놈들은 말을 할 수 있으면서도 일부로 퍼즐을 내서 다른 사람들을 골탕먹이려는 것 같아."{#morte_s212_1}'
...
label morte_s213: # from 212.0
    nr '"들리는 얘기로는 그들은 레이디 오브 페인의 청소부라는군. 그들은 레이디의 기분에 따라 시길을 부수거나 수리하지. 그들은 시체 파리보다도 징그럽다고." 모트는 한숨을 쉰다. "하지만 다버스는 때려죽일 수도 없어, 그러면 레이디가… 화를 낼 테니."{#morte_s213_1}'
...
label morte_s214: # from 213.0 213.1
    nr '"그녀는 이 도시의 지배자야. 대장도 그녀를 보면 알 거야. 그녀의 얼굴 주변에는 칼날들이 달렸고, 그녀는 거인만큼이나 거대하며, 저 친구들처럼 공중에 떠다니지." 모트는 당신들 둘을 바라보고 있는 다버스를 가리킨다. "아무도 그녀에 대해서 자세히 알지는 못해… 그녀는 거의 말을 하지 않아. 대장이 알아야 할 건 그녀를 화나게 해서는 안 된다는 것 뿐이야. 이건 내 충고인데, 만약 그녀를 보게 되면 도망치라고."{#morte_s214_1}'
...
label morte_s215: # from 214.0 214.1
    nr '모트는 다버스를 흘긋 보더니 눈을 크게 뜬다. "아하! 난 너희들 염소 대가리들도 걸을 수 있는 줄 진작부터 알고 있었지!" 모트는 즐거워하며 당신 쪽으로 고개를 돌린다. "하! 이 녀석은 땅 위로 떠다닐 정도로 고상하지 않은 모양이야."{#morte_s215_1}'
...
# s216 # say21607
label morte_s216: # -
    nr '모트는 조롱한다. "이 떠다니는 염소 대가리들이 하는 말을 해석하느니 차라리 타나리 창자를 걸러내는 게 났지. 통역을 원해? 시길 토박이를 찾아보라고."{#morte_s216_1}'
...
# s217 # say21608
label morte_s217: # -
    nr '모트는 조롱한다. "이 떠다니는 염소 대가리들이 하는 말을 해석하느니 차라리 타나리 창자를 걸러내는 게 났지. 통역을 원해? 여기 있는 휜들링 계집에게 부탁하라고." 그는 안나를 가리킨다. "그녀는 벌통 토박이니까."{#morte_s217_1}'
...
# s218 # say21609
label morte_s218: # -
    nr '모트는 조롱한다. "이 떠다니는 염소 대가리들이 하는 말을 해석하느니 차라리 타나리 창자를 걸러내는 게 났지. 통역을 원해?" 그는 다콘을 가리킨다. "여기 있는 „나는 잘났으니 너희들 따위와는 얘기를 안 해“하는 양반에게 부탁하라고."{#morte_s218_1}'
...
# s219 # say21610
label morte_s219: # -
    nr '모트는 조롱한다. "이 떠다니는 염소 대가리들이 하는 말을 해석하느니 차라리 타나리 창자를 걸러내는 게 났지. 통역을 원해? 타나리에게 부탁하라고." 그는 훨-후럼-그레이스를 가리킨다. "아마 그녀는 이 친구들하고 늘 대화를 나누고 있을 거라고."{#morte_s219_1}'
...
label morte_s220: # externs soego_s93
    nr '"당신은 그들을 죽이고 싶은 거겠지. 유정은 더스트맨을 위협하니까."{#morte_s220_1}'
...
# s221 # say22849
label morte_s221: # -
    nr '모트는 당신을 쳐다보고 고개를 젓는다{#morte_s221_1}'
...
label morte_s222: # from 221.0
    nr '"이봐! 녀석은 그런 말을 하지 않았어!"{#morte_s222_1}'
...
label morte_s224: # from 223.0
    nr '"나는. 그걸. 잠시. 손에. 쥐고. 싶을. 뿐이야."{#morte_s224_1}'
...
label morte_s226: # from 225.0
    nr '"나는 그 모드론 입방체를 박살낼 거야."~ [MRT251]{#morte_s226_1}'
...
# s227 # say22892
label morte_s227: # -
    nr '"오오!" 크래독이 화내는 욕설을 퍼붓는 것을 들으며 모트는 이빨을 딱딱거린다… 모트는 크래독이 하는 욕을 머릿속에 암기하려는 듯하다.~ [MRT387]{#morte_s227_1}'
...
# s228 # say24174
label morte_s228: # -
    nr '"이봐, 보스 난 정말 그가 말을 하다가… 잠시… 멈추는… 데는… 정말… 질렸어… 이제… 그가 입을… 다문 건… 정말 다행이야."{#morte_s228_1}'
...
# s229 # say24176
label morte_s229: # -
    nr '"보스, 무한한 물을 가지고 대체 우리에게 무슨 필요가 있지? 어디 불이라도 났어?"{#morte_s229_1}'
...
label morte_s230: # from 229.1
    nr '"해야 할 옳은 일? 혹시 잊어먹었다면 상기시켜주겠는데, 대장에게는 스스로 해결해야 할 문제가 있다고! 하지만 결정권을 쥐고 있는 건 대장이니까 하고 싶은 대로 하라고."{#morte_s230_1}'
...
# s231 # say24903
label morte_s231: # -
    nr '"이봐… 괜찮아? 난 대장이 정말로 죽은 줄 알았다고."{#morte_s231_1}'
...
label morte_s232: # from 231.0
    nr '"어… 내가 누구냐고?. "*당신*부터 먼저 대답하는 게 어때? 당신은 누구지?"{#morte_s232_1}'
...
label morte_s233: # from 232.0 234.0 235.0
    nr '"자기 *이름*도 기억을 못해? 헤, 다음 번에 거리에 나가 밤을 보낼 때는 술 좀 작작 마시라고. 내 이름은 모트야. 나도 여기 갇혔어.{#morte_s233_1}'
...
label morte_s234: # from 232.1
    nr '"그래, 내가 *나중에* 물었어. 당신 이름은 뭐지?"{#morte_s234_1}'
...
label morte_s235: # from 234.1
    nr '"정말 당신은 젖은 로프만큼이나 빡빡하군. 좋아, 좋아… 여기선 내가 참지… 나는 모트야. 당신은 누구지?"{#morte_s235_1}'
...
label morte_s236: # from 233.0
    nr '"그래, 당신은 일어나 여길 돌아다닐 시간이 없었으니 내가 말해주지. 모든 문을 다 시험해봤지만 소용이 없었어. 이 방은 정조대만큼이나 단단히 잠겨 있어."{#morte_s236_1}'
...
label morte_s237: # from 236.0
    nr '"그것은 „시체안치소“라고 불리지… 임신한 거미만큼이나 매력적인 모양새의 커다란 검은 건물이라고."{#morte_s237_1}'
...
label morte_s238: # from 237.0
    nr '"내 입장에서는 아니야. 하지만 당신 몸은 흉터투성이로군. 어떤 얼간이가 당신 몸에 나이프로 그림이라도 그린 모양이야. 놈이 당신을 끝장내려고 다시 올지도 모르니 그만큼 여기서 도망쳐야 할 이유가 는 셈이지."{#morte_s238_1}'
...
label morte_s239: # from 238.0
    nr '"모든 문이 다 잠겼으니 열쇠를 찾아야 해. 이 방 안을 활보하고 있는 시체들 중 하나가 가지고 있을 가능성이 높아."{#morte_s239_1}'
...
label morte_s240: # from 28.0 239.0
    nr '"그래, 시체안치소의 관리인들은 시체들을 싸구려 노동력으로 활용하고 있어. 이 시체들은 돌처럼 멍청하지만 별로 위험하지는 않아. 그리고 먼저 공격하지 않는 한 공격을 하진 않아."{#morte_s240_1}'
...
label morte_s241: # from 240.0
    nr '"그러면 그들의 기분이 상할 거라고 생각하는 거야? 그들은 이미 죽었어. 만약 당신이 긍정적인 측면에서 생각하고 싶다면 이렇게 생각하라고. 만약 당신이 그들을 죽이면 그들은 관리인들이 소생시킬 때까지는 휴식을 취할 수 있다고 말이야."{#morte_s241_1}'
...
label morte_s242: # from 240.1 241.0
    nr '"그러기 전에 먼저 무장부터 하라고. 이 근처의 선반에 메스가 하나 있을 거야.  주: 방안을 뒤져 좀비를 공격할 무기를 찾으시오.{#morte_s242_1}'
...
label morte_s243: # from 242.0
    nr '"마지막으로 한가지 더: 이 시체들은 거북이처럼 느리지만 놈들에게 한 대 맞으면 마치 공성용 망치와 키스하는 기분이 들거야. 불리해지면 튀라고. 당신은 달릴 수 있지만 놈들은 그럴 수가 없으니까. 회복할 동안 놈들과는 일정 거리를 유지하라고."  ^NNOTE: <도주> 만약 죽을 위험에 처하게 되면 달리기를 이용해 회복할 동안 좀비들로부터 일정 거리를 유지하라.^-{#morte_s243_1}'
...
# s244 # say25962
label morte_s244: # -
    nr '"일종의 말하는 백과사전이야, 대장. 난 그 일에 대해선 말하고 싶지가 않아."{#morte_s244_1}'
...
# s245 # say25964
label morte_s245: # -
    nr '모트는 눈썹(?)을 흔들어 대며 여인 쪽으로 날아간다. "그게 전부가-"{#morte_s245_1}'
...
label morte_s246: # from 245.0
    nr '"그래, 그래. 좋다고." 모트는 눈알을 굴리며 중얼거리기 시작한다. "젠장, 차라리 죽는 게…"{#morte_s246_1}'
...
# s247 # say25970
label morte_s247: # -
    nr '모트는 그녀의 말을 끊는다: "말인데, 대장, 그건 모두 미미르의 *품질*에 달렸어. 일부는 나처럼 다른 미미르보다 더 많은 마력이 부여되어 있어. 단지 그뿐이야. 그래… „자의식“이… 더 강하다는 게 옳은 표현이지."{#morte_s247_1}'
...
# s248 # say25973
label morte_s248: # -
    nr '"이봐! 난 그냥 재미 좀 보려는 거라고, 대장!"{#morte_s248_1}'
...
# s249 # say27285
label morte_s249: # -
    nr '"충고를 하겠어, 대장. 여기서부터는 조용히 움직이자고. 필요 이상으로 시체들을 훼손할 필요는 없어… 특히 여자 시체들은. 또한 그들을 „죽이면“ 관리자들을 여기로 불러오는 결과를 야기할 수도 있어."{#morte_s249_1}'
...
label morte_s250: # from 249.0 252.0 256.0
    nr '"그들은 자신들을 „더스트맨“이라고 부르고 있어. 그들을 알아보는 건 쉽지. 예외없이 검은 법복을 입고 있는데다가 꼭 사후경직을 일으킨 것 같은 얼굴들을 하고 있으니까. 그들은 악귀같은 죽음 숭배자들이야. 그들은 모두 다 죽어야 한다고 믿고 있어… 그것도 빠르면 빠를수록 좋다고."{#morte_s250_1}'
...
label morte_s251: # from 250.0
    nr '"내가 말할 때 뭘 하고 있었어?! 더스트맨은 모두가 다 죽어야 하며, 그것도 빠르면 빠를수록 좋다고 믿고 있다고 내가 이미 말했잖아. 대장이 보기엔 지금까지 우리가 본 시체들이 죽어서 더 행복해진 것 같아?"{#morte_s251_1}'
...
label morte_s252: # from 249.1 251.0 256.1
    nr '"다원 우주에서는 매일 누군가 반드시 죽어, 대장. 이 얼간이들은 이 곳의 관리자들에게 사후의 시체에 대한 권리를 판 한심한 작자들의 잔해라고."{#morte_s252_1}'
...
label morte_s253: # from 249.2 251.1 252.1
    nr '"뭐- *진담*이야? 이봐, 대장, 이 죽은 아가씨들은 우리들처럼 산전수전 다 겪은 친구들에게 주어진 마지막 기회라고. 우리는 *기사도* 정신을 발휘해야 해… 열쇠를 찾으려고 그녀들을 칼로 베거나 사지를 절단하는 짓 따위는 해서는 안돼."{#morte_s253_1}'
...
label morte_s254: # from 253.0
    nr '"대장, 그들은 죽었어, 그리고 우리들도 죽었어… 내가 무슨 말을 하려는지 알겠어? 그래?"{#morte_s254_1}'
...
label morte_s255: # from 254.0 254.1
    nr '"대장, 우린 이미 이 절뚝거리는 아가씨들과 대화를 시작할 화제거리도 가지고 있다고. 우리들은 *모두* 적어도 한 번씩은 죽어 봤어. 그러니 우린 공통의 화제가 있는 셈이지. 그들은 우리처럼 죽은 경험이 있는 사내들을 환영할 거라고."{#morte_s255_1}'
...
label morte_s256: # from 255.0
    nr '"그래… 좋아. *대장*은 죽지 않았을지도 모르지만 *난* 죽었어. 그리고 나라면 여기 있는 체격 좋은 멋진 시체 아가씨들과 기꺼이 관을 함께 쓰겠어." 모트는 기대에 부푼 듯 이빨을 딱딱거리기 시작한다. "물론 그러기 위해서는 우선 관리인들이 그들을 포기해야 하는데 그럴 가능성은 희박하지…"{#morte_s256_1}'
...
label morte_s257: # from 249.3 251.2 252.2 256.2
    nr '"이봐, 대장. 대장은 죽음과 키스를 한 탓에 아직도 정신이 좀 오락가락한 것 같아. 그러니 내가 두 가지 충고를 하겠어. 첫째, 질문할 게 있으면 내게 *물어.* 알겠어?"  ^NNOTE: <SPEAKTO>^-{#morte_s257_1}'
...
label morte_s258: # from 257.0
    nr '"둘째, 대장이 겉보기의 *반*만큼이라도 건망증이 심하다면, 뭐든지 기록을 하는 습관을 기르라고. 조금이라도 중요할 것 같은 얘기를 듣게 되면 잊지 않도록 즉각 기록을 해."{#morte_s258_1}'
...
label morte_s259: # from 258.0
    nr '"그래, 일지같은 것에 말이야. 만약 대장이 현재의 위치와 같은 중요한 사안들에 대해 가물가물하게 되면 일지를 읽어 기억을 상기시키라고. 알겠어?"  ^NNOTE: 일지를 보려면 퀵 메뉴에 있는 일지 버튼을 누른다. 일지는 게임 진행 동안 자동으로 갱신된다.^-{#morte_s259_1}'
...
# s260 # say27296
label morte_s260: # -
    nr '"이 근처의 선반에 메스가 하나 있을 거야. 나라면 이 주변의 시체들과 싸우기 전에 우선 그것부터 찾겠어."{#morte_s260_1}'
...
label morte_s261: # - # IF WEIGHT #8 /* Triggers after states #: 729 444 325 281 742 737 733 487 even though they appear after this state */ ~  Global("Mortuary_Walkthrough","GLOBAL",0) PartyHasItem("Scalpel") Global("ZM782_Dead_KAPUTZ","GLOBAL",0)
    nr '"좋아, 메스를 찾았군! 그럼 이제 가서 저 시체들을 처치하라고… 그리고 걱정하지마. 난 뒤에서 귀중한 전술적 조언을 해줄 테니까."{#morte_s261_1}'
...
label morte_s262: # from 261.0
    nr '"나는 물론 대장을 *도울* 거야. 좋은 충고는 얻기 힘든 거라고."{#morte_s262_1}'
...
label morte_s263: # from 262.0
    nr '"나? 나는 낭만주의자지 군인이 아니야. 난 방해만 될 거야."{#morte_s263_1}'
...
label morte_s264: # from 263.0
    nr '"에… 좋아. 대장을 돕겠어."  주: 만약 당신이 모트가 당신의 공격에 협조하기를 바란다면, 시체를 공격할 때 두 사람 모두를 선택하면 된다. 그러면 모트도 공격에 참가할 것이다.{#morte_s264_1}'
...
# s265 # say27301
label morte_s265: # -
    nr '"좋아, 방금 대장이 처치한 놈이 바로 우리가 찾고 있던 시체인 것 같군. 이제 열쇠를 찾아야 해. 그건 틀림없이 그의 몸 어딘가에 있을 거야. 일단 그걸 찾기만 하면 우린 이 곳과 작별이라고."{#morte_s265_1}'
...
# s266 # say27302
label morte_s266: # -
    nr '"좋아, 그게 바로 우리가 원하는 열쇠야. 그건 이 방의 문들 중 하나를 열 수 있을 거야."{#morte_s266_1}'
...
# s267 # say27911
label morte_s267: # -
    nr '모트는 당신 귀에다 대고 속삭인다: "변호사."{#morte_s267_1}'
...
# s268 # say27912
label morte_s268: # -
    nr '"일종의 말하는 백과사전이야, 대장. 난 그 일에 대해선 말하고 싶지가 않아."{#morte_s268_1}'
...
# s269 # say27913
label morte_s269: # -
    nr '모트는 눈썹(?)을 흔들어 대며 여인 쪽으로 날아간다. "그게 전부가-"{#morte_s269_1}'
...
label morte_s270: # from 269.0
    nr '"그래, 그래. 좋다고." 모트는 눈알을 희번덕거리며 중얼거리기 시작한다. "젠장, 차라리 죽는 게…"{#morte_s270_1}'
...
# s271 # say27919
label morte_s271: # -
    nr '모트는 그녀의 말을 끊는다: "말인데, 대장, 그건 모두 미미르의 *품질*에 달렸어. 일부는 나처럼 다른 미미르보다 더 많은 마력이 부여되어 있어. 단지 그뿐이야. 그래… „자의식“이… 더 강하다는 게 옳은 표현이지."{#morte_s271_1}'
...
# s272 # say27922
label morte_s272: # -
    nr '"이봐! 난 그냥 재미 좀 보려는 거라고, 대장!"{#morte_s272_1}'
...
# s273 # say28036
label morte_s273: # -
    nr '모트는 만족스러운 듯 고개를 끄덕인다. "이봐, 이 친구 꽤 하는데."{#morte_s273_1}'
...
# s274 # say28037
label morte_s274: # -
    nr '모트는 만족스러운 듯 고개를 끄덕인다. "이봐, 이 친구 꽤 하는데."{#morte_s274_1}'
...
# s276 # say28631
label morte_s276: # -
    nr '"그녀는 타나리의 일종인 서큐버스라고, 대장."{#morte_s276_1}'
...
# s277 # say28632
label morte_s277: # -
    nr '"닥쳐, 휜들링!" 모트는 이빨을 딱딱거린다. "나는 서큐버스가 우리와 함께 여행하겠다면 대환영이야… 니가 창자에 마름쇠를 쑤셔 넣는 것만큼이나 재미가 없는 년이라는 건 세상이 다 아는 사실이야."{#morte_s277_1}'
...
# s278 # say28633
label morte_s278: # -
    nr '"이봐, 잠깐! 차원에 대해 해박한 지식을 가지고 있는 사람은 바로 *나*라고! 그건 내 담당이야, 대장!"{#morte_s278_1}'
...
label morte_s279: # from 278.0
    nr '"눈에 보약이지! 우리가 아는 어떤 아가씨도 피부를 좀 화끈하게 드러내면 봐줄만 할 텐데!" 모트는 갑자기 조용해진다. "뭐, 내가 별 신경을 쓴다는 얘기는 아니지만, 얘기를 해두는 게 좋을 것 같아서 말한 거야."{#morte_s279_1}'
...
label morte_s281: # - # IF WEIGHT #4 /* Triggers after states #: 742 737 733 487 even though they appear after this state */ ~  Global("Morte_Stolen","GLOBAL",2) !GlobalGT("Fortress_Morte","GLOBAL",2)
    nr '"고마워, 대장. 내가 다시 대장과 함께 여행을 하게 돼 얼마나 기쁜지는 말로 표현할 수도 없어." 그의 목소리는 비꼬는 기색이 역력하다. "그리고 나는 그 곳에 있는 동안 새로운 특기를 배웠다고."{#morte_s281_1}'
...
label morte_s282: # from 281.1
    nr '"정말? 참으로 자상도 하군, 보스는. 좋은 생각이야. 대장을 조건부로 용서를 해주지. 다시 그러지만 말라고."{#morte_s282_1}'
...
label morte_s283: # from 281.2
    nr '"왠지 대장 말을 조금도 믿을 수가 없군. 그냥 이 일이 있었다는 사실을 잊자고. 가자."{#morte_s283_1}'
...
# s284 # say28741
label morte_s284: # -
    nr '"고마워, 대장. 당장 여기서 나가자고!" 모트는 잠시 멈춘다. "보스, 그런데… 그런데 그 친구들은 정말 뭘 알더군. 그들은 내게 멋진 걸 가르쳐 주었어."{#morte_s284_1}'
...
# s285 # say28962
label morte_s285: # -
    nr '"어… 대장? 전에 석상을 본 적은 있지? 그것이 말을 하지 않는다는 건 대장도 알지?"{#morte_s285_1}'
...
label morte_s286: # from 285.0
    nr '"글쎄… 어…흠. 그건 대장 말이 옳군."{#morte_s286_1}'
...
# s287 # say28964
label morte_s287: # -
    nr '"해부학적으로 너무 정확해서 그런 건 아냐, 대장?{#morte_s287_1}'
...
label morte_s288: # from 287.0
    nr '"물론이야, 대장. 나도 그건 알고 있었어."{#morte_s288_1}'
...
# s289 # say28966
label morte_s289: # -
    nr '모트는 눈알을 부라리며 시끄럽게 떠든다. "세상에, 이렇게… 말하는… 얼간이가 다시는 없기를!"{#morte_s289_1}'
...
# s290 # say29677
label morte_s290: # -
    nr '"이봐, 대장. 그는 손가락을 포개고 있어!{#morte_s290_1}'
...
# s291 # say30527
label morte_s291: # -
    nr '모트가 작은 목소리로 말참견을 한다. "그는 자기가 변호사라는거야. 법적 자문가지. 법정에서 수다를 떠는 작자들 중 하나라고."{#morte_s291_1}'
...
# s292 # say30816
label morte_s292: # -
    nr '모트는 뒤를 돌아본다. "어디?! 어디?!"{#morte_s292_1}'
...
# s293 # say30817
label morte_s293: # -
    nr '모트는 헐떡거린다. "뒤를 보라고, 떠다니는 해골이 또 있어!"{#morte_s293_1}'
...
# s294 # say30818
label morte_s294: # -
    nr '"바로 내가 가리키고 있는 곳에! 저기!"{#morte_s294_1}'
...
# s295 # say30819
label morte_s295: # -
    nr '모트는 일부러 화난 시늉을 한다: "아까운 걸 놓쳤어! 아예 *행렬*로 지나갔는데! 아마 위대한 고리가 다시 백만 번 회전할 때까지는 못 볼 걸!"{#morte_s295_1}'
...
# s296 # say30820
label morte_s296: # -
    nr '모트는 어깨를 으쓱하려는 시늉을 하려는 듯 아래위로 약간 움직인다. "나는 그걸 인간의 본질에 대한 예리한 통찰력이라고 부르지."{#morte_s296_1}'
...
# s297 # say30821
label morte_s297: # -
    nr '"이보, 대장, 그 정도 지랄이라면 통할지도 모르겠는데!"{#morte_s297_1}'
...
# s298 # say31566
label morte_s298: # -
    nr '"레이디의 칼날 달린 젖꼭지여! 세상에…"  당신의 마지막 남은 감각조차 사라짐에 따라 정적이 사방을 지배한다. ~ [MRT387]{#morte_s298_1}'
...
# s299 # say32367
label morte_s299: # -
    nr '"„비밀?!“ 제발 봐줘! 이런 쓰레기 같은 지랄을 정말 *들을* 건 아니지, 그렇지? 자… 가서 해골의 입술의 불타는 정열을 아직 체험하지 못한 센세이트 계집들이나 찾아보자고." 그는 기대에 가득 차 눈썹을 아래위로 움직인다.{#morte_s299_1}'
...
# s300 # say32371
label morte_s300: # -
    nr '모트는 속삭인다: "새로운 고통의 시작일 뿐이지."{#morte_s300_1}'
...
# s301 # say32376
label morte_s301: # -
    nr '모트는 속삭인다: "그건 그렇지."{#morte_s301_1}'
...
# s302 # say32381
label morte_s302: # -
    nr '모트는 속삭인다: "영원한 지루함."{#morte_s302_1}'
...
label morte_s303: # from 301.2
    nr '모트는 속삭인다: "이제야 우리 둘이 죽은 뒤 어디로 갈지 알 것 같군."{#morte_s303_1}'
...
# s304 # say32391
label morte_s304: # -
    nr '모트는 속삭인다: "그건 운이 좋을 경우 얘기지."{#morte_s304_1}'
...
# s305 # say32396
label morte_s305: # -
    nr '모트는 속삭인다: "그게 무슨 상이라도 된다는 거야? 같은 일을 *반복*하는 게? 이런, 난 정말 다시 태어나도 떠다니는 해골이 되고 싶은 걸. 와! 놈보고 엿이나 먹으라고 해. 놈은 정말 얼간이야. 정말 죽어본 적이 없는 사람처럼 말하는군. 그렇지?"{#morte_s305_1}'
...
# s306 # say32401
label morte_s306: # -
    nr '모트는 속삭인다: "오, 이건 정말 지나가는 개도 웃을 소리군."{#morte_s306_1}'
...
# s307 # say32406
label morte_s307: # -
    nr '모트는 크게 고함을 지른다: "개지랄 같은 소리군!"{#morte_s307_1}'
...
# s308 # say32407
label morte_s308: # -
    nr '모트는 강사의 시야 아래로 내려간 다음 당신 쪽으로 고개를 돌려 속삭인다. "대장, 가서 놈에게 진짜 비밀이 뭔질 보여주라고."{#morte_s308_1}'
...
# s309 # say32410
label morte_s309: # -
    nr '"멋지군! 또 다른 죽음이라! 나도 끼워 달라고!" 청중석에서 웃음이 터진다. 연사는 화가 난 듯하다.{#morte_s309_1}'
...
# s310 # say32651
label morte_s310: # -
    nr '"내가 이 미친년의 따귀라도 한 대 갈겨 줄까, 대장?"{#morte_s310_1}'
...
# s311 # say32652
label morte_s311: # -
    nr '"난 대장의 해괴망칙한 방법이 너무 마음에 들어."{#morte_s311_1}'
...
# s312 # say32653
label morte_s312: # -
    nr '당신이 그녀 앞에 무릎을 꿇으려 하자 모트가 소리를 지른다: "대장! 정말 그러려는 건 아니겠지? 대장이 그런 쪽에 관심이 있다면 모를까…"{#morte_s312_1}'
...
label morte_s313: # from 312.1
    nr '"그래, 일리는 있어… 하지만 그래도…"{#morte_s313_1}'
...
# s314 # say32655
label morte_s314: # -
    nr '모트는 킬킬 웃으며 이빨을 딱딱거린다. "그냥 보통 바람둥이라는 거지, 대장?"{#morte_s314_1}'
...
label morte_s316: # from 310.0
    nr '모트는 당신에게 눈짓을 하면서 그녀를 부른다. "이봐, 너! 그래, 거기 너, 이 뻔뻔한 창녀야… 내가 말을 할 때는 날 봐야지! 대체 왜 그렇게 신랄하게 나오는 거야?"{#morte_s316_1}'
...
# s317 # say32658
label morte_s317: # -
    nr '"아, 술탄은 아들을 원했는데 딸이 나온 탓에 어린 사막의 공주님은 반바지만 입고 다니나? 말해봐, „사막의 공주님,“ 넌 널 인정하지 않으려는 아버지에 대한 반발로 밤마다 몇 명의 곁눈질하는 아부꾼들을 거느리고 그런 몰골로 나와서는 술을 처먹고 사람들에게 시비나 거는 거야?"{#morte_s317_1}'
...
# s318 # say32659
label morte_s318: # -
    nr '"싸움질을 해댄다고 해서 스스로에 대해 조금이라도 만족할 수 있게 될 것 같아? 자신이 가치가 있는 존재라고 느끼게 될 거라고 생각해? 어림없어! 만약 이게 자긍심을 찾으려고 네가 쓰는 방법이라면 내가 충고 한 마디 하지. 집어치우고 집에나 가, 그리고 어떤 놈팡이의 하렘에나 들어가라고!"{#morte_s318_1}'
...
# s319 # say32660
label morte_s319: # -
    nr '모트는 당신 쪽으로 고개를 돌린다. "보라고, 대장, 난 어떻게 될지 진작부터 알고 있었어. 우린 모두 이 건에 관해서 모트가 옳다는 걸 알지. 하지만 딱하군, 어리고 자존심 강한 사막의 공주님, 사람들 앞에서 쓰러져 망신-"{#morte_s319_1}'
...
# s320 # say33073
label morte_s320: # -
    nr '"블러드 워? 거버너가 법에 대해 강의하는 것보다 지루해. 정열에 대해 가르침을 필요로 하는 젊은 센세이트나 찾아보자고!" 그는 기대에 가득 차 눈썹을 아래위로 움직인다.{#morte_s320_1}'
...
# s321 # say33300
label morte_s321: # -
    nr '모트는 눈알을 희번덕거리며 외친다 "와! 저것 좀 봐! 말하는 똥이야!"{#morte_s321_1}'
...
# s322 # say33301
label morte_s322: # -
    nr '모트는 당신 쪽으로 재빨리 움직이며 사내에게 얘기를 한다. "이 덩치 큰 흉터투성이 친구한테 한 말이라고… 당신이 아니야! 화나진 않은 거지?{#morte_s322_1}'
...
# s323 # say33423
label morte_s323: # -
    nr '모트는 눈알을 희번덕거리며 외친다 "와! 저것 좀 봐! 말하는 똥이야!"{#morte_s323_1}'
...
# s324 # say33429
label morte_s324: # -
    nr '모트는 당신 쪽으로 재빨리 움직이며 사내에게 얘기를 한다. "이 덩치 큰 흉터투성이 친구한테 한 말이라고… 당신이 아니야! 화나진 않은 거지?{#morte_s324_1}'
...
label morte_s325: # - # IF WEIGHT #5 /* Triggers after states #: 742 737 733 487 even though they appear after this state */ ~  !InParty("Morte") !GlobalGT("Fortress_Morte","GLOBAL",2)
    nr '"난 대장이 돌아올 줄 알고 있었어! 드디어 대장에겐 내가 필요하다는 사실을 깨달은 거야?"~ [MRT516]{#morte_s325_1}'
...
label morte_s326: # from 325.1
    nr '"흠. 글쎄, 내가 여기서 얼마나 더 기다릴 수 있을 지는 나도 모르겠어. 그러니 난 대장에게 마지막으로 단 한 번의 기회를 주겠어. 정말 내 현명한 충고와 기민한 재치를 필요로 하지 않는 거야?"{#morte_s326_1}'
...
label morte_s327: # from 326.0 326.2
    nr '"일부러 내 감정을 상하게 하려는 거야, 대장? 내가 무슨 말이라도 잘못했어? 아니면 내게 팔이 없어서야? 뭐야?"{#morte_s327_1}'
...
label morte_s328: # from 327.1
    nr '"좋아, 하지만 난 여기서 영원히 기다리진 않을 거니까 생각이 바뀌면 당장 돌아오라고."{#morte_s328_1}'
...
label morte_s329: # from 649.2 650.2 651.3 652.2 653.1 654.1 655.1 656.1 657.1 658.0 659.1 660.1 661.1 662.0 663.2 664.1 665.2 666.1 667.1 668.0 669.9 670.0 671.0 672.0 673.0 674.0 675.1 676.0 677.2 678.1 679.0 680.0 681.0 682.1 683.0 684.1 685.1 686.2 687.1 688.2 689.1 690.1 695.2 696.1 697.1 699.1 700.1 706.1 707.1 708.1 709.1 710.1 711.1 712.1 714.1 715.1 721.0 722.0 723.1 725.0 726.1 727.0
    nr '"뭘 그렇게 골똘하게 생각하는 거야?"{#morte_s329_1}'
...
label morte_s330: # externs zf114_s2 zf114_s1 zf114_s0
    nr '"잠깐. 대장은 그녀가 날 어떤 눈으로 쳐다보는지 봤어? 허? 보이지? 내 후두부를 바라보는 그녀의 시선이?"{#morte_s330_1}'
...
label morte_s331: # from 330.0 330.1
    nr '"뭐… 눈이라도 먼 거야?! 그녀는 날 유혹하고 있었다고! 그녀는 정말 노골적으로 날 원했다고!"{#morte_s331_1}'
...
label morte_s332: # from 331.0
    nr '"당신? 말도 안돼. 저 세상으로 간 계집들은 육체적인 매력이나 몸통이 있는지 여부는 신경도 쓰지 않는다고. 그녀들은 기백이 있는 남자를 원한다고. 그건 바로 나야, 대장. 당신? 대장같은 시체는 동전만큼이나 흔하다고."{#morte_s332_1}'
...
label morte_s333: # from 331.1 331.2
    nr '"나처럼 죽은 지 오래되면 신호를 감지할 수가 있다고. 대장이 느끼기에는 너무 미묘할지도 모르지만. 그러니 내가 죽은 지 얼마되지 않은 섹시한 계집들과 뜨거운 밤을 보낼 동안 대장은 „어?“ „뭐가 어떻게 돌아가고 있는 거지?“ „내 기-기억이 어디로 갔지“하며 멍하니 서 있을 수밖에."{#morte_s333_1}'
...
label morte_s334: # externs zf594_s2 zf594_s1 zf594_s0
    nr '"잠깐. 대장은 그녀가 날 어떤 눈으로 쳐다보는지 봤어? 허? 보이지? 내 후두부를 바라보는 그녀의 시선이?"{#morte_s334_1}'
...
label morte_s335: # from 334.0 334.1
    nr '"뭐… 눈이라도 먼 거야?! 그녀는 날 유혹하고 있었다고! 그녀는 정말 노골적으로 날 원했다고!"{#morte_s335_1}'
...
label morte_s336: # from 335.0
    nr '"당신? 말도 안돼. 저 세상으로 간 계집들은 육체적인 매력이나 몸통이 있는지 여부는 신경도 쓰지 않는다고. 그녀들은 기백이 있는 남자를 원한다고. 그건 바로 나야, 대장. 당신? 대장같은 시체는 동전만큼이나 흔하다고."{#morte_s336_1}'
...
label morte_s337: # from 335.1 335.2
    nr '"나처럼 죽은 지 오래되면 신호를 감지할 수가 있다고. 대장이 느끼기에는 너무 미묘할지도 모르지만. 그러니 내가 죽은 지 얼마되지 않은 섹시한 계집들과 뜨거운 밤을 보낼 동안 대장은 „어?“ „뭐가 어떻게 돌아가고 있는 거지?“ „내 기-기억이 어디로 갔지“하며 멍하니 서 있을 수밖에."{#morte_s337_1}'
...
label morte_s338: # externs zf626_s2 zf626_s1 zf626_s0
    nr '"잠깐. 대장은 그녀가 날 어떤 눈으로 쳐다보는지 봤어? 허? 보이지? 내 후두부를 바라보는 그녀의 시선이?"{#morte_s338_1}'
...
label morte_s339: # from 338.0 338.1
    nr '"뭐… 눈이라도 먼 거야?! 그녀는 날 유혹하고 있었다고! 그녀는 정말 노골적으로 날 원했다고!"{#morte_s339_1}'
...
label morte_s340: # from 339.0
    nr '"당신? 말도 안돼. 저 세상으로 간 계집들은 육체적인 매력이나 몸통이 있는지 여부는 신경도 쓰지 않는다고. 그녀들은 기백이 있는 남자를 원한다고. 그건 바로 나야, 대장. 당신? 대장같은 시체는 동전만큼이나 흔하다고."{#morte_s340_1}'
...
label morte_s341: # from 339.1 339.2
    nr '"나처럼 죽은 지 오래되면 신호를 감지할 수가 있다고. 대장이 느끼기에는 너무 미묘할지도 모르지만. 그러니 내가 죽은 지 얼마되지 않은 섹시한 계집들과 뜨거운 밤을 보낼 동안 대장은 „어?“ „뭐가 어떻게 돌아가고 있는 거지?“ „내 기-기억이 어디로 갔지“하며 멍하니 서 있을 수밖에."{#morte_s341_1}'
...
label morte_s342: # externs zf1096_s2 zf1096_s1 zf1096_s0
    nr '"잠깐. 대장은 그녀가 날 어떤 눈으로 쳐다보는지 봤어? 허? 보이지? 내 후두부를 바라보는 그녀의 시선이?"{#morte_s342_1}'
...
label morte_s343: # from 342.0 342.1
    nr '"뭐… 눈이라도 먼 거야?! 그녀는 날 유혹하고 있었다고! 그녀는 정말 노골적으로 날 원했다고!"{#morte_s343_1}'
...
label morte_s344: # from 343.0
    nr '"당신? 말도 안돼. 저 세상으로 간 계집들은 육체적인 매력이나 몸통이 있는지 여부는 신경도 쓰지 않는다고. 그녀들은 기백이 있는 남자를 원한다고. 그건 바로 나야, 대장. 당신? 대장같은 시체는 동전만큼이나 흔하다고."{#morte_s344_1}'
...
label morte_s345: # from 343.1 343.2
    nr '"나처럼 죽은 지 오래되면 신호를 감지할 수가 있다고. 대장이 느끼기에는 너무 미묘할지도 모르지만. 그러니 내가 죽은 지 얼마되지 않은 섹시한 계집들과 뜨거운 밤을 보낼 동안 대장은 „어?“ „뭐가 어떻게 돌아가고 있는 거지?“ „내 기-기억이 어디로 갔지“하며 멍하니 서 있을 수밖에."{#morte_s345_1}'
...
label morte_s346: # externs zf1072_s2 zf1072_s1 zf1072_s0
    nr '"잠깐. 대장은 그녀가 날 어떤 눈으로 쳐다보는지 봤어? 허? 보이지? 내 후두부를 바라보는 그녀의 시선이?"{#morte_s346_1}'
...
label morte_s347: # from 346.0 346.1
    nr '"뭐… 눈이라도 먼 거야?! 그녀는 날 유혹하고 있었다고! 그녀는 정말 노골적으로 날 원했다고!"{#morte_s347_1}'
...
label morte_s348: # from 347.0
    nr '"당신? 말도 안돼. 저 세상으로 간 계집들은 육체적인 매력이나 몸통이 있는지 여부는 신경도 쓰지 않는다고. 그녀들은 기백이 있는 남자를 원한다고. 그건 바로 나야, 대장. 당신? 대장같은 시체는 동전만큼이나 흔하다고."{#morte_s348_1}'
...
label morte_s349: # from 347.1 347.2
    nr '"나처럼 죽은 지 오래되면 신호를 감지할 수가 있다고. 대장이 느끼기에는 너무 미묘할지도 모르지만. 그러니 내가 죽은 지 얼마되지 않은 섹시한 계집들과 뜨거운 밤을 보낼 동안 대장은 „어?“ „뭐가 어떻게 돌아가고 있는 거지?“ „내 기-기억이 어디로 갔지“하며 멍하니 서 있을 수밖에."{#morte_s349_1}'
...
label morte_s350: # externs zf832_s2 zf832_s1 zf832_s0
    nr '"잠깐. 대장은 그녀가 날 어떤 눈으로 쳐다보는지 봤어? 허? 보이지? 내 후두부를 바라보는 그녀의 시선이?"{#morte_s350_1}'
...
label morte_s351: # from 350.0 350.1
    nr '"뭐… 눈이라도 먼 거야?! 그녀는 날 유혹하고 있었다고! 그녀는 정말 노골적으로 날 원했다고!"{#morte_s351_1}'
...
label morte_s352: # from 351.0
    nr '"당신? 말도 안돼. 저 세상으로 간 계집들은 육체적인 매력이나 몸통이 있는지 여부는 신경도 쓰지 않는다고. 그녀들은 기백이 있는 남자를 원한다고. 그건 바로 나야, 대장. 당신? 대장같은 시체는 동전만큼이나 흔하다고."{#morte_s352_1}'
...
label morte_s353: # from 351.1 351.2
    nr '"나처럼 죽은 지 오래되면 신호를 감지할 수가 있다고. 대장이 느끼기에는 너무 미묘할지도 모르지만. 그러니 내가 죽은 지 얼마되지 않은 섹시한 계집들과 뜨거운 밤을 보낼 동안 대장은 „어?“ „뭐가 어떻게 돌아가고 있는 거지?“ „내 기-기억이 어디로 갔지“하며 멍하니 서 있을 수밖에."{#morte_s353_1}'
...
label morte_s354: # externs zf679_s2 zf679_s1 zf679_s0
    nr '"잠깐. 대장은 그녀가 날 어떤 눈으로 쳐다보는지 봤어? 허? 보이지? 내 후두부를 바라보는 그녀의 시선이?"{#morte_s354_1}'
...
label morte_s355: # from 354.0 354.1
    nr '"뭐… 눈이라도 먼 거야?! 그녀는 날 유혹하고 있었다고! 그녀는 정말 노골적으로 날 원했다고!"{#morte_s355_1}'
...
label morte_s356: # from 355.0
    nr '"당신? 말도 안돼. 저 세상으로 간 계집들은 육체적인 매력이나 몸통이 있는지 여부는 신경도 쓰지 않는다고. 그녀들은 기백이 있는 남자를 원한다고. 그건 바로 나야, 대장. 당신? 대장같은 시체는 동전만큼이나 흔하다고."{#morte_s356_1}'
...
label morte_s357: # from 355.1 355.2
    nr '"나처럼 죽은 지 오래되면 신호를 감지할 수가 있다고. 대장이 느끼기에는 너무 미묘할지도 모르지만. 그러니 내가 죽은 지 얼마되지 않은 섹시한 계집들과 뜨거운 밤을 보낼 동안 대장은 „어?“ „뭐가 어떻게 돌아가고 있는 거지?“ „내 기-기억이 어디로 갔지“하며 멍하니 서 있을 수밖에."{#morte_s357_1}'
...
label morte_s358: # externs zf444_s2 zf444_s1 zf444_s0
    nr '"잠깐. 대장은 그녀가 날 어떤 눈으로 쳐다보는지 봤어? 허? 보이지? 내 후두부를 바라보는 그녀의 시선이?"{#morte_s358_1}'
...
label morte_s359: # from 358.0 358.1
    nr '"뭐… 눈이라도 먼 거야?! 그녀는 날 유혹하고 있었다고! 그녀는 정말 노골적으로 날 원했다고!"{#morte_s359_1}'
...
label morte_s360: # from 359.0
    nr '"당신? 말도 안돼. 저 세상으로 간 계집들은 육체적인 매력이나 몸통이 있는지 여부는 신경도 쓰지 않는다고. 그녀들은 기백이 있는 남자를 원한다고. 그건 바로 나야, 대장. 당신? 대장같은 시체는 동전만큼이나 흔하다고."{#morte_s360_1}'
...
label morte_s361: # from 359.1 359.2
    nr '"나처럼 죽은 지 오래되면 신호를 감지할 수가 있다고. 대장이 느끼기에는 너무 미묘할지도 모르지만. 그러니 내가 죽은 지 얼마되지 않은 섹시한 계집들과 뜨거운 밤을 보낼 동안 대장은 „어?“ „뭐가 어떻게 돌아가고 있는 거지?“ „내 기-기억이 어디로 갔지“하며 멍하니 서 있을 수밖에."{#morte_s361_1}'
...
label morte_s362: # externs zf1148_s2 zf1148_s1 zf1148_s0
    nr '"잠깐. 대장은 그녀가 날 어떤 눈으로 쳐다보는지 봤어? 허? 보이지? 내 후두부를 바라보는 그녀의 시선이?"{#morte_s362_1}'
...
label morte_s363: # from 362.0 362.1
    nr '"뭐… 눈이라도 먼 거야?! 그녀는 날 유혹하고 있었다고! 그녀는 정말 노골적으로 날 원했다고!"{#morte_s363_1}'
...
label morte_s364: # from 363.0
    nr '"당신? 말도 안돼. 저 세상으로 간 계집들은 육체적인 매력이나 몸통이 있는지 여부는 신경도 쓰지 않는다고. 그녀들은 기백이 있는 남자를 원한다고. 그건 바로 나야, 대장. 당신? 대장같은 시체는 동전만큼이나 흔하다고."{#morte_s364_1}'
...
label morte_s365: # from 363.1 363.2
    nr '"나처럼 죽은 지 오래되면 신호를 감지할 수가 있다고. 대장이 느끼기에는 너무 미묘할지도 모르지만. 그러니 내가 죽은 지 얼마되지 않은 섹시한 계집들과 뜨거운 밤을 보낼 동안 대장은 „어?“ „뭐가 어떻게 돌아가고 있는 거지?“ „내 기-기억이 어디로 갔지“하며 멍하니 서 있을 수밖에."{#morte_s365_1}'
...
label morte_s366: # externs zf891_s2 zf891_s1 zf891_s0
    nr '"잠깐. 대장은 그녀가 날 어떤 눈으로 쳐다보는지 봤어? 허? 보이지? 내 후두부를 바라보는 그녀의 시선이?"{#morte_s366_1}'
...
label morte_s367: # from 366.0 366.1
    nr '"뭐… 눈이라도 먼 거야?! 그녀는 날 유혹하고 있었다고! 그녀는 정말 노골적으로 날 원했다고!"{#morte_s367_1}'
...
label morte_s368: # from 367.0
    nr '"당신? 말도 안돼. 저 세상으로 간 계집들은 육체적인 매력이나 몸통이 있는지 여부는 신경도 쓰지 않는다고. 그녀들은 기백이 있는 남자를 원한다고. 그건 바로 나야, 대장. 당신? 대장같은 시체는 동전만큼이나 흔하다고."{#morte_s368_1}'
...
label morte_s369: # from 367.1 367.2
    nr '"나처럼 죽은 지 오래되면 신호를 감지할 수가 있다고. 대장이 느끼기에는 너무 미묘할지도 모르지만. 그러니 내가 죽은 지 얼마되지 않은 섹시한 계집들과 뜨거운 밤을 보낼 동안 대장은 „어?“ „뭐가 어떻게 돌아가고 있는 거지?“ „내 기-기억이 어디로 갔지“하며 멍하니 서 있을 수밖에."{#morte_s369_1}'
...
label morte_s370: # from 377.3
    nr '"흠… 이 회색 수염이 내가 자기 몸을 빌려도 뭐라고 하지 않을지 모르겠군…"{#morte_s370_1}'
...
label morte_s371: # from 370.0
    nr '"회색 수염… 대장도 알다시피 늙다리, 늙은이, 노인 등을 가리키는 말이야."{#morte_s371_1}'
...
label morte_s372: # from 370.1 371.0
    nr '모트는 잠시 그 스켈레톤을 살펴보더니 고개를 젓는다. "아니… 내겐 이것보다 신선한 놈이 필요해. 그리고 좀 더 품위가 있는 몸이… 이건 사방에 금하고 깨진 곳 투성이야 "{#morte_s372_1}'
...
label morte_s373: # from 370.2 371.1 372.0
    nr '"아, 대장은 정말 웃기는군." 모트는 당신을 노려본다. "그리고 대장은 그런 말을 할 입장이 아니지. 대장이 근처에 있으면 거울들이 자비를 구한다고."{#morte_s373_1}'
...
label morte_s374: # from 373.0
    nr '모트는 코방귀를 뀐다. 허파도 없이 어떻게 그런 일을 할 수가 있는지 당신으로서는 알 수가 없다.{#morte_s374_1}'
...
label morte_s375: # from 374.0
    nr '"대장이 준비실을 빠져나오도록 도와준 건 점점 늘어나는 후회할 것들 목록에 추가되었어." 모트는 다시 코를 씨근거린다. "대장이 그냥 썩도록 내버려 두었어야 했어…"{#morte_s375_1}'
...
label morte_s376: # externs s1221_s3 s1221_s0
    nr '"와우, 대장. 그건 파괴 행위야. 그 볼트들은 그 뼈들을 고정시키는 유일한 것들이라고. 이런 오래된 친구들에게는 이미 사령술도 별 효과가 없다고."{#morte_s376_1}'
...
label morte_s377: # from 376.0 376.1 376.2
    nr '"오, 문제가 된다는 얘긴 아니야." 모트는 기묘한 스타일로 아래 위로 움직이는 데 그건 어깨를 으쓱한다는 표현인 듯하다. "난 대장이 그걸 아는가 확인해 보려고 했을 뿐이야, 마음대로 하라고."{#morte_s377_1}'
...
label morte_s378: # from 385.3
    nr '"흠… 이 회색 수염이 내가 자기 몸을 빌려도 뭐라고 하지 않을지 모르겠군…"{#morte_s378_1}'
...
label morte_s379: # from 378.0
    nr '"회색 수염… 대장도 알다시피 늙다리, 늙은이, 노인 등을 가리키는 말이야."{#morte_s379_1}'
...
label morte_s380: # from 378.1 379.0
    nr '모트는 잠시 그 스켈레톤을 살펴보더니 고개를 젓는다. "아니… 내겐 이것보다 신선한 놈이 필요해. 그리고 좀 더 품위가 있는 몸이… 이건 사방에 금하고 깨진 곳 투성이야 "{#morte_s380_1}'
...
label morte_s381: # from 378.2 379.1 380.0
    nr '"아, 대장은 정말 웃기는군." 모트는 당신을 노려본다. "그리고 대장은 그런 말을 할 입장이 아니지. 대장이 근처에 있으면 거울들이 자비를 구한다고."{#morte_s381_1}'
...
label morte_s382: # from 381.0
    nr '모트는 코방귀를 뀐다. 허파도 없이 어떻게 그런 일을 할 수가 있는지 당신으로서는 알 수가 없다.{#morte_s382_1}'
...
label morte_s383: # from 382.0
    nr '"대장이 준비실을 빠져나오도록 도와준 건 점점 늘어나는 후회할 것들 목록에 추가되었어." 모트는 다시 코를 씨근거린다. "대장이 그냥 썩도록 내버려 두었어야 했어…"{#morte_s383_1}'
...
label morte_s384: # externs s748_s3 s748_s0
    nr '"와우, 대장. 그건 파괴 행위야. 그 볼트들은 그 뼈들을 고정시키는 유일한 것들이라고. 이런 오래된 친구들에게는 이미 사령술도 별 효과가 없다고."{#morte_s384_1}'
...
label morte_s385: # from 384.0 384.1 384.2
    nr '"오, 문제가 된다는 얘긴 아니야." 모트는 기묘한 스타일로 아래 위로 움직이는 데 그건 어깨를 으쓱한다는 표현인 듯하다. "난 대장이 그걸 아는가 확인해 보려고 했을 뿐이야, 마음대로 하라고."{#morte_s385_1}'
...
label morte_s386: # from 393.3
    nr '"흠… 이 회색 수염이 내가 자기 몸을 빌려도 뭐라고 하지 않을지 모르겠군…"{#morte_s386_1}'
...
label morte_s387: # from 386.0
    nr '"회색 수염… 대장도 알다시피 늙다리, 늙은이, 노인 등을 가리키는 말이야."{#morte_s387_1}'
...
label morte_s388: # from 386.1 387.0
    nr '모트는 잠시 그 스켈레톤을 살펴보더니 고개를 젓는다. "아니… 내겐 이것보다 신선한 놈이 필요해. 그리고 좀 더 품위가 있는 몸이… 이건 사방에 금하고 깨진 곳 투성이야 "{#morte_s388_1}'
...
label morte_s389: # from 386.2 387.1 388.0
    nr '"아, 대장은 정말 웃기는군." 모트는 당신을 노려본다. "그리고 대장은 그런 말을 할 입장이 아니지. 대장이 근처에 있으면 거울들이 자비를 구한다고."{#morte_s389_1}'
...
label morte_s390: # from 389.0
    nr '모트는 코방귀를 뀐다. 허파도 없이 어떻게 그런 일을 할 수가 있는지 당신으로서는 알 수가 없다.{#morte_s390_1}'
...
label morte_s391: # from 390.0
    nr '"대장이 준비실을 빠져나오도록 도와준 건 점점 늘어나는 후회할 것들 목록에 추가되었어." 모트는 다시 코를 씨근거린다. "대장이 그냥 썩도록 내버려 두었어야 했어…"{#morte_s391_1}'
...
label morte_s392: # externs s996_s3 s996_s0
    nr '"와우, 대장. 그건 파괴 행위야. 그 볼트들은 그 뼈들을 고정시키는 유일한 것들이라고. 이런 오래된 친구들에게는 이미 사령술도 별 효과가 없다고."{#morte_s392_1}'
...
label morte_s393: # from 392.0 392.1 392.2
    nr '"오, 문제가 된다는 얘긴 아니야." 모트는 기묘한 스타일로 아래 위로 움직이는 데 그건 어깨를 으쓱한다는 표현인 듯하다. "난 대장이 그걸 아는가 확인해 보려고 했을 뿐이야, 마음대로 하라고."{#morte_s393_1}'
...
label morte_s394: # from 401.3
    nr '"흠… 이 회색 수염이 내가 자기 몸을 빌려도 뭐라고 하지 않을지 모르겠군…"{#morte_s394_1}'
...
label morte_s395: # from 394.0
    nr '"회색 수염… 대장도 알다시피 늙다리, 늙은이, 노인 등을 가리키는 말이야."{#morte_s395_1}'
...
label morte_s396: # from 394.1 395.0
    nr '모트는 잠시 그 스켈레톤을 살펴보더니 고개를 젓는다. "아니… 내겐 이것보다 신선한 놈이 필요해. 그리고 좀 더 품위가 있는 몸이… 이건 사방에 금하고 깨진 곳 투성이야 "{#morte_s396_1}'
...
label morte_s397: # from 394.2 395.1 396.0
    nr '"아, 대장은 정말 웃기는군." 모트는 당신을 노려본다. "그리고 대장은 그런 말을 할 입장이 아니지. 대장이 근처에 있으면 거울들이 자비를 구한다고."{#morte_s397_1}'
...
label morte_s398: # from 397.0
    nr '모트는 코방귀를 뀐다. 허파도 없이 어떻게 그런 일을 할 수가 있는지 당신으로서는 알 수가 없다.{#morte_s398_1}'
...
label morte_s399: # from 398.0
    nr '"대장이 준비실을 빠져나오도록 도와준 건 점점 늘어나는 후회할 것들 목록에 추가되었어." 모트는 다시 코를 씨근거린다. "대장이 그냥 썩도록 내버려 두었어야 했어…"{#morte_s399_1}'
...
label morte_s400: # externs s863_s3 s863_s0
    nr '"와우, 대장. 그건 파괴 행위야. 그 볼트들은 그 뼈들을 고정시키는 유일한 것들이라고. 이런 오래된 친구들에게는 이미 사령술도 별 효과가 없다고."{#morte_s400_1}'
...
label morte_s401: # from 400.0 400.1 400.2
    nr '"오, 문제가 된다는 얘긴 아니야." 모트는 기묘한 스타일로 아래 위로 움직이는 데 그건 어깨를 으쓱한다는 표현인 듯하다. "난 대장이 그걸 아는가 확인해 보려고 했을 뿐이야, 마음대로 하라고."{#morte_s401_1}'
...
# s402 # say38265
label morte_s402: # -
    nr '"난 벌써 이 아가씨와 사랑에 빠졌다고!"{#morte_s402_1}'
...
# s404 # say39000
label morte_s404: # -
    nr '모트가 속삭인다. 이건 좋지가 않아, 대장. 조심하라고, 그렇지 않으면 놈들이 대장 정신을 흔적도 없이 날려버릴 테니… 그들은 수가 많을 수록 강해져. 각 개체가 집합적인 뇌의 일부가 돼. 놈들은 정말 위험해."{#morte_s404_1}'
...
# s405 # say39001
label morte_s405: # -
    nr '모트가 속삭인다. 이건 좋지가 않아, 대장. 조심하라고, 그렇지 않으면 놈들이 대장 정신을 흔적도 없이 날려버릴 테니… 그들은 수가 많을 수록 강해져. 각 개체가 집합적인 뇌의 일부가 돼. 놈들은 정말 위험해."{#morte_s405_1}'
...
# s406 # say39002
label morte_s406: # -
    nr '모트가 속삭인다. "나는 그들이 무슨 생각을 하고 있는지 모르겠어, 하지만 생각을 읽히지 않도록 조심해. 그들은 정신적 집합체고, 쥐의 수가 들어날 수록 그 능력도 늘어나. 썰렁한 표현일지도 모르겠지만 그들은 궁지에 몰린 쥐들처럼 싸워. 우린 지금 놈들의 소굴에 있어, 보스, 그러니 놈들은 배수의 진을 친 셈이지. 각별히 조심하라고."{#morte_s406_1}'
...
# s407 # say39564
label morte_s407: # -
    nr '"놀라운 우연이야! 나도 사냥을 한다고."{#morte_s407_1}'
...
# s408 # say39565
label morte_s408: # -
    nr '"나? 왜 *내가* 얘기를 해야 하지?"{#morte_s408_1}'
...
label morte_s409: # from 408.0
    nr '"아니, 아니, 하겠어… 판에 박은 것에서 벗어나 좀 불평을 하면 어떨까 생각해본 것 뿐이야. 그리고 난 주목을 받는 걸 좋아하거든."{#morte_s409_1}'
...
label morte_s410: # from 409.0
    nr '"제발! 응? 제-발? 끝내주는 얘기라고! 캐릭터들도 많이 등장하고 액션으로 넘치는 데다가, 전조를 바친 후 충격적인 대단원을 맞이하는 스릴 넘치는 스토리야!"{#morte_s410_1}'
...
label morte_s412: # from 410.1 411.0
    nr '"모르겠어! 하지만 대단한 것처럼 들려!"{#morte_s412_1}'
...
label morte_s414: # from 409.1 410.2 411.1 412.0 413.0
    nr '"한 노인이 어두운 길에 홀로 앉아 있었어. 그는 어느 방향으로 가야할지 몰랐고, 그는 행선지와 자신이 누구인가를 망각하고 있었어. 그는 피곤한 다리를 쉬게 하기 위하여 잠시 앉았지, 그리고 올려다 보니 갑자기 눈 앞에 어떤 노파가 있는 거야. 그녀는 이빨도 없이 싱긋 웃었지, 그리고 깔깔거리면서 말했어. "„이제 당신의 *세 번째* 소원을 말할 차례요. 무엇을 원하시오?"{#morte_s414_1}'
...
label morte_s415: # from 414.0
    nr '"„세 번째 소원?“ 남자는 당황했어. „첫 번째와 두 번째 소원도 말한 적이 없는데 어떻게 세 번째 소원을 말하라는 거요?“"{#morte_s415_1}'
...
label morte_s416: # from 415.0
    nr '"„당신의 두 소원은 이미 성취되었소,“ 노파가 말했지, „하지만 당신의 두 번째 소원은 모든 걸 첫 번째 .소원을 말하기 전 상태로 되돌려 달라는 것이었소. 그래서 당신은 아무 것도 기억하지 못하는 거요. 왜냐하면 모든 것이 *정확히* 당신이 어떤 소원도 말하기 전 상태로 되돌아갔기 때문이오.“ 그녀는 불쌍한 노인을 보며 깔깔 웃었지. „그래서 하나의 소원만 남은 거요.“"{#morte_s416_1}'
...
label morte_s417: # from 416.0
    nr '"„좋소,“ 노인이 말했어, "나는 이 얘기를 믿지 않소, 하지만 소원을 말해서 손해 볼 건 없으니까. 나는 내가 누군지 알고 싶소.„"  "“재미있군,„ 노파는 소원을 들어주고 영원히 사라지면서 말했어. “그게 바로 당신의 첫 번째 소원이었소.„"{#morte_s417_1}'
...
# s418 # say39575
label morte_s418: # -
    nr '"빌어먹을, 대체 그게 뭐야, 이 바보 같은 폴리곤아?! 그건 내가 들어본 것들 중 가장 지루한 쓰레기야!"{#morte_s418_1}'
...
# s420 # say39577
label morte_s420: # -
    nr '"*자,* 흰들링. 네게는 이미 절대로 내놓지 않으려 할 꼬리가 하나 있다고."{#morte_s420_1}'
...
# s421 # say40068
label morte_s421: # -
    nr '모트는 여자의 빤한 태도를 흉내내며 당신 주위를 돈다. "천상의 신들이여, 대장… 그녀가 옳아! 지금까진 몰랐는데… 대장은 *흉터*로 뒤덮여 있어!"{#morte_s421_1}'
...
# s422 # say40074
label morte_s422: # -
    nr '모트는 눈썹을 움직인다. "그래, 당신은 너무 „뻔뻔해“… 그건 아마 당신의 흔들리는 유-"{#morte_s422_1}'
...
# s425 # say40082
label morte_s425: # -
    nr '모트는 혼자서 중얼거린다. "그 안에 뭔가가 있다는 건 좋은 일인 것 깉군."{#morte_s425_1}'
...
# s426 # say40222
label morte_s426: # -
    nr '"오, 안돼… 우리에게 당장 말해줘야 해."{#morte_s426_1}'
...
# s427 # say40275
label morte_s427: # -
    nr '모트는 당신 가까이로 날아와 속삭인다. "그녀의 애인이 불쌍하군. 그는 자기 애인의 본색을 모르고 있을 거야. 저런 계집은 골칫거리일 뿐이야.{#morte_s427_1}'
...
# s428 # say40685
label morte_s428: # -
    nr '모트는 조용히 속삭인다: "와… 정말 무시무시한 계집이야."{#morte_s428_1}'
...
# s429 # say40846
label morte_s429: # -
    nr '"이봐, 대장! 지금 우리는 다원 우주에서 가장 섹시한 계집들이 모인 곳에 와 있다고, 그런데 대장은 *모드론*과 얘기를 하는 거야?"{#morte_s429_1}'
...
label morte_s430: # from 429.0
    nr '모트는 역겨워 못 견디겠다는 듯 말한다. "대체 무슨 얘기를 하겠다는 거야? 짜증나는 태엽 벌레를… 놈들은 늘 다원 우주에 법과 질서를 강제하려고 날뛰고 있다고. *선*에는 관심도 없고 *질서*만. 놈들에겐 신경 끄고서 아가씨들하고 얘기나 하지고."{#morte_s430_1}'
...
label morte_s431: # from 429.2 430.1
    nr '모트는 크게 한숨을 쉰다. "좋아. 마음대로 해. 하지만 나중에 나보고 뭐라지는 마. 하지만 놈들로부터 뭘 알아내긴 힘들 거야, 대장… 얘기 상대로는 묘한 것들이니까."{#morte_s431_1}'
...
# s432 # say41135
label morte_s432: # -
    nr '"뭐든지!" 모트가 외친다. "뭐든지 하고 싶은 대로 하라고!"{#morte_s432_1}'
...
# s433 # say41136
label morte_s433: # -
    nr '"정말 눈물이 나오려고 하는군… 왜 *몸*이 있었을 때는 이런 아가씨를 만나지 못했던 거지?!"{#morte_s433_1}'
...
# s434 # say41632
label morte_s434: # -
    nr '"내 친구는 네년이 매력적이라고 생각했었지, 하지만 으악! 그는 정말 끔찍한 착각을 한 거지!"{#morte_s434_1}'
...
label morte_s435: # from 436.0
    nr '"좋소, 대장, 알았다고. 지독한 년이야, 안 그래?" 모트는 *흥* 소리를 내고 눈썹을 움직인다. "그것 참 마음에 드는데!"{#morte_s435_1}'
...
# s436 # say41636
label morte_s436: # -
    nr '"내게 거시기가 있었더라도 네년 근처에 갖다 대기라도 했을 것 같아? 매음굴에 대해 어디서 주워듣고는 여기 와서 돈이라도 벌 생각이라도 했던 거야, 이 벼룩에게 물린 시궁창에서 나온 창녀야! 흥! 네 털복숭이 다리에서 진드기들이 서 말은 튀어나오는 데도 불구하고 그들이 널 들여보내 주었다는 사실이 믿기지 않는군!"{#morte_s436_1}'
...
# s437 # say41639
label morte_s437: # -
    nr '"*그*라고 해! „*그*는 지금도 입이 꽤 더러운 것 같은데“라고 하라고, 똥주머니 키마스사이… 이 더러운 염소다리 창녀야!"{#morte_s437_1}'
...
# s438 # say41640
label morte_s438: # -
    nr '"아마 너보단 낫겠지?" 모트는 눈썹을 움직인다. "에? 에?"{#morte_s438_1}'
...
# s439 # say41641
label morte_s439: # -
    nr '"좋아, *티플링.* 하지만 네게서 한두 가지 정도 배운 건 인정하지. 좋은 생각이었어, 대장!"~ [MRT387]{#morte_s439_1}'
...
label morte_s440: # from 444.7 445.2 446.2 447.2 448.2 449.1 450.1 451.2 452.1 453.1 454.1
    nr '"이봐, 대장. 대장은 죽음과 키스를 한 탓에 아직도 정신이 좀 오락가락한 것 같아. 그러니 내가 두 가지 충고를 하겠어. 첫째, 질문할 게 있으면 내게 *물어.* 알겠어?"  ^NNOTE: <SPEAKTO>^-{#morte_s440_1}'
...
label morte_s441: # from 440.0
    nr '"둘째, 대장이 겉보기의 *반*만큼이라도 건망증이 심하다면, 뭐든지 기록을 하는 습관을 기르라고. 조금이라도 중요할 것 같은 얘기를 듣게 되면 잊지 않도록 즉각 기록을 해."{#morte_s441_1}'
...
label morte_s442: # from 441.0
    nr '"그럼 새 일지를 쓰기 시작하라고. 그 따윈 별 문제도 아냐. 여긴 대장이 평생 쓰고 남을 정도의 양피지와 잉크가 있으니까."{#morte_s442_1}'
...
label morte_s443: # from 442.0
    nr '"그것을 써서 대장의 여정을 파악하라고. 만약 대장이 중요한 사안들, 예들 들어 대장이 누구인가.,.. 또는 더 중요하게 *내*가 누구인가에 대해 가물가물하게 되면 일지를 읽어 기억을 상기시키라고. 알겠어?"  ^NNOTE: 일지를 보려면 퀵 메뉴에 있는 일지 버튼을 누른다. 일지는 게임 진행 동안 자동으로 갱신된다.^-{#morte_s443_1}'
...
label morte_s444: # from 445.1 446.1 447.1 448.1 449.0 450.0 451.1 452.0 453.0 454.0 455.1 456.2 457.1 458.0 # IF WEIGHT #6 /* Triggers after states #: 742 737 733 487 even though they appear after this state */ ~  !Global("Mortuary_Walkthrough","GLOBAL",0) !Global("Mortuary_Walkthrough","GLOBAL",1) Global("AR0200_Visited","GLOBAL",0) InParty("Morte") !GlobalGT("Fortress_Morte","GLOBAL",2)
    nr '"대체 뭘 그렇게 골똘히 생각하는 거야, 대장?"~ [MRT515]{#morte_s444_1}'
...
label morte_s445: # from 444.0
    nr '"이봐, 대장. 설마 벌써 까먹은 건 아니겠지?"{#morte_s445_1}'
...
label morte_s446: # from 445.0
    nr '"그 소리를 많이 듣게 될 것 같군." 모트는 헛기침을 한다. "어디 보자…"  „네가 스틱스 강물을 몇 통이나 마신 듯한 기분인 것은 알지만, 정신을 차리고 집중해야 한다. 네 소지품들 중에는 이 중대사에 대해서 일부나마 밝혀 줄 일지가 한 권 있을 것이다. 만약 파로드가 이미 죽지 않았다면 그가 나머지 부분에 대해 설명해줄 수 있을 것이다.“{#morte_s446_1}'
...
label morte_s447: # from 446.0
    nr '"그래, 그래, 기다리라고." 모트는 잠시 멈춘다. "좋아, 이게 마지막이야…"  „절대로 일지를 잃어서는 안 된다, 아니면 우린 다시 스틱스에 빠지는 신세가 될 테니까. 알겠나? 그리고 내 말을 믿어라 - 뭘 하든 간에 네가 누구이며, 어떤 일이 네게 일어나고 있으며, 어디서 왔는지에 대해 말해서는 안 된다. 그렇지 않으면 화장터로 직행하게 될 테니. 내가 말하는 대로 해라: 일지를 읽은 후 파로드를 찾아라.“{#morte_s447_1}'
...
label morte_s448: # from 447.0
    nr '"아니… 여기 왔을 때 대장은 깨끗하게 털린 상태였어. 이미 말했듯이 대장 몸에는 충분하고도 남을 정도의 일지가 적혀 있다고."{#morte_s448_1}'
...
label morte_s449: # from 448.0
    nr '"아니. 그래도 이 파로드란 자가 어디 있는지 아는 사람은 있을 거야… 물론 그건 우리가 이 곳에서 탈출한 후의 얘기지만."{#morte_s449_1}'
...
label morte_s450: # from 444.1
    nr '"그것은 „시체안치소“라고 불리지… 임신한 거미만큼이나 매력적인 모양새의 커다란 검은 건물이라고."{#morte_s450_1}'
...
label morte_s451: # from 444.2 444.3
    nr '"그들은 자신들을 „더스트맨“이라고 부르고 있어. 그들을 알아보는 건 쉽지. 예외없이 검은 법복을 입고 있는데다가 꼭 사후경직을 일으킨 것 같은 얼굴들을 하고 있으니까. 그들은 악귀같은 죽음 숭배자들이야. 그들은 모두 다 죽어야 한다고 믿고 있어… 그것도 빠르면 빠를수록 좋다고."{#morte_s451_1}'
...
label morte_s452: # from 451.0
    nr '"내가 말할 때 뭘 하고 있었어?! 더스트맨은 모두가 다 죽어야 하며, 그것도 빠르면 빠를수록 좋다고 믿고 있다고 내가 이미 말했잖아. 대장이 보기엔 지금까지 우리가 본 시체들이 죽어서 더 행복해진 것 같아?"{#morte_s452_1}'
...
label morte_s453: # from 444.6
    nr '"어… 그것들을 쓰라고. 지혈 등의 용도로 말이야."  ^NNOTE: <BANDAGES2>^-{#morte_s453_1}'
...
label morte_s454: # from 444.4
    nr '"다원 우주에서는 매일 누군가 반드시 죽어, 대장. 이 비틀거리는 얼간이들은 이 곳의 관리자들에게 사후의 시체에 대한 권리를 판 한심한 작자들의 잔해라고."{#morte_s454_1}'
...
label morte_s455: # from 444.5
    nr '"뭐- *진담*이야? 이봐, 대장, 이 죽은 아가씨들은 우리들처럼 산전수전 다 겪은 친구들에게 주어진 마지막 기회라고. 우리는 *기사도* 정신을 발휘해야 해… 열쇠를 찾으려고 그녀들을 칼로 베거나 사지를 절단하는 짓 따위는 해서는 안돼."{#morte_s455_1}'
...
label morte_s456: # from 455.0
    nr '"대장, 그들은 죽었어, 그리고 우리들도 죽었어… 내가 무슨 말을 하려는지 알겠어? 그래?"{#morte_s456_1}'
...
label morte_s457: # from 456.0 456.1
    nr '"대장, 우린 이미 이 절뚝거리는 아가씨들과 대화를 시작할 화제거리도 가지고 있다고. 우리들은 *모두* 적어도 한 번씩은 죽어 봤어. 그러니 우린 공통의 화제가 있는 셈이지. 그들은 우리처럼 죽은 경험이 있는 사내들을 환영할 거라고."{#morte_s457_1}'
...
label morte_s458: # from 457.0
    nr '"그래… 좋아. *대장*은 죽지 않았을지도 모르지만 *난* 죽었어. 그리고 나라면 여기 있는 체격 좋은 멋진 시체 아가씨들과 기꺼이 관을 함께 쓰겠어." 모트는 기대에 부푼 듯 이빨을 딱딱거리기 시작한다. "물론 그러기 위해서는 우선 관리인들이 그들을 포기해야 하는데 그럴 가능성은 희박하지…"{#morte_s458_1}'
...
# s459 # say41910
label morte_s459: # -
    nr '"신들이시여! 그건 정말 골때리는 책이군!"{#morte_s459_1}'
...
label morte_s460: # from 459.0
    nr '"추측을 하자면 그 책은 이 곳에 실려오는 모든 불행한 작자들의 이름을 기록하는 책인 것 같아."{#morte_s460_1}'
...
label morte_s461: # from 460.0
    nr '"어… 그럴 수도 있겠지. 알아보려면 저기 있는 저 떠다니는 더스티와 얘기를 해야 할 거야. 그게 좋은 생각인지는 모르겠지만."{#morte_s461_1}'
...
# s462 # say41919
label morte_s462: # -
    nr '모트는 속삭인다: "어느 정신병원에서 환자가 한 명 부족하다고 난리가 났겠군."{#morte_s462_1}'
...
# s463 # say41923
label morte_s463: # -
    nr '"이런… 대장은 저주에 걸린 모양이야…"{#morte_s463_1}'
...
# s464 # say42929
label morte_s464: # -
    nr '"그 계집을 무시하라고… 마치 아무런 관심도 없는 것처럼 행동해. 그러면 효과가 있을 거라고!"{#morte_s464_1}'
...
# s465 # say42930
label morte_s465: # -
    nr '"날 믿으라고. 그녀를 무시하기 시작해서 마찰을 일으킨 후 그들이 궁금해 하도록 그냥 내버려 두라고, 그럼 대체 무슨 일인지 알려고 법석을 떨 테니. 그렇지, 대장?"{#morte_s465_1}'
...
# s466 # say43543
label morte_s466: # -
    nr '"그게 기스는 번식을 하면 안 되는 이유야. 맨날 믿음이 어쩌고저쩌고 횡설수설 하지 않으면 „죽일 마인드 훌레이어와 기스양키는 어디 있지“ 하면서 주접을 떨지. 난 그들이 성교를 즐기기나 하는지 모르겠어. 그들은 도중에 미쳐버리거나 늘 너무 한 곳에 집중만 해 유머 감각이 마비된 모양이야. 그들은 노상 집중, 하나의 정신, 공동체 내의 신뢰 등에 대해 지껄이지만, 그들이 뇌 빠는 놈들로부터 해방되자 마자 자기네들끼리 원수가 된 꼴 좀 보라고. 어디 내게 종교와 이데올로기가 다원 우주를 파멸로 이끌지 않을 거라고 말해보시지."{#morte_s466_1}'
...
# s469 # say43915
label morte_s469: # -
    nr '"이런, 정말 성깔 한 번 화끈한 계집이군! 관심에 굶주렸나? 만약 네가 그냥 질투를 하는 것뿐이라면 내가 네게 침을 흘려 줄 수도 있지…" 모트는 안나를 향해 날아가며 군침을 삼킨다.{#morte_s469_1}'
...
# s470 # say43916
label morte_s470: # -
    nr '모트는 갑자기 멈춘다, 그리고 알아들을 수 없는 말로 중얼거리며 고개를 돌린다.{#morte_s470_1}'
...
# s471 # say43922
label morte_s471: # -
    nr '"이보, 대장… 틀림없이 뭔가를 생각해낼 수 있을 거야. 그렇지?{#morte_s471_1}'
...
# s472 # say44244
label morte_s472: # -
    nr '모트는 가까이 다기와 속삭인다: "난 아냐. 난 괜찮다고. 에, 대장? 윙크-윙크, 슬쩍-슬쩍…"{#morte_s472_1}'
...
# s473 # say44245
label morte_s473: # -
    nr '모트는 공포에 질려 공황 상태에 빠진다. "안돼!!! 이봐, 미쳤어?! 그건 말도 안 되는 소리야!"{#morte_s473_1}'
...
# s474 # say44677
label morte_s474: # -
    nr '모트는 눈알을 부라린다. "얼간이들이 돌격하는군…"{#morte_s474_1}'
...
# s475 # say44944
label morte_s475: # -
    nr '"난 시 공회당이 너무 좋아."{#morte_s475_1}'
...
# s476 # say45026
label morte_s476: # -
    nr '모트는 크게 한숨을 쉰다. "이봐, 대장! 정말 여기 남아 있을 거야?"{#morte_s476_1}'
...
label morte_s477: # externs zm965_s0
    nr '"헤. 누가 이 녀석한테 삼의 법칙으로 걷는 걸 멈추라고 하는 걸 까먹은 모양이야."{#morte_s477_1}'
...
label morte_s478: # from 477.0
    nr '"이 시체들에게는 지능이라고는 거의 남아 있지를 않아, 그래서 한 번에 한 가지 이상의 일은 할 수가 없지… 일단 그들에게 뭘 시키면, 누가 멈추라고 할 때까지 계속 한다고. 아마 이 불쌍한 녀석은 무슨 일을 끝낸 후에 아무도 그만 하라고 명령하지 않아 저러고 있을 거야."{#morte_s478_1}'
...
label morte_s479: # from 478.1 481.0
    nr '"에? 삼의 법칙은 다원 우주의 „법칙들“ 중 하나로 모든 건 삼의 단위로 발생하는 경향이 있다는 얘기지… 아니면 세 부분으로 구성되어 있던지… 또는 늘 선택지는 셋이라든지… 등등."{#morte_s479_1}'
...
label morte_s480: # from 479.0
    nr '"내 생각으로는 말도 안 되는 쓰레기야. 어떤 숫자든 간에 하나를 골라 그것에 큰 의미를 부여하려고 하면, 괜히 모든 게 다 그렇게 보이는 거라고."{#morte_s480_1}'
...
label morte_s481: # from 478.0 480.0
    nr '"이 곳의 관리인들이나 어떤 사령술사가 그들을 되살려냈겠지. 아마 이 곳의 관리인들일 거야, 싸구려 노동력을 필요로 하는 건 그들이니까."{#morte_s481_1}'
...
# s483 # say45709
label morte_s483: # -
    nr '"오! 경매! 여기서 안나를 팔 수도 있겠군."{#morte_s483_1}'
...
# s484 # say45710
label morte_s484: # -
    nr '"오! 경매! 여기서 다콘을 팔 수도 있겠군."{#morte_s484_1}'
...
# s485 # say45711
label morte_s485: # -
    nr '"오! 경매! 여기서 내 몸을 살 수도 있겠군."{#morte_s485_1}'
...
# s486 # say45714
label morte_s486: # -
    nr '"사랑이 틀림없어. 사랑이라고, 그렇지, 보스?"{#morte_s486_1}'
...
label morte_s487: # - # IF WEIGHT #0 ~  NumTimesTalkedTo(0) InParty("Morte") !GlobalGT("Fortress_Morte","GLOBAL",2)
    nr '"이봐, 보라고! 떠다니는 머리가 또 있어."{#morte_s487_1}'
...
# s488 # say47813
label morte_s488: # -
    nr '"이 메이스는 꽤나 인간이 되고 싶은 모양이군. 입 닥쳐, 무기."{#morte_s488_1}'
...
# s489 # say49443
label morte_s489: # -
    nr '"오오, 기스양키군. 틀림없이 다콘은 *기꺼이* 그를 도울 거야."{#morte_s489_1}'
...
# s490 # say50162
label morte_s490: # -
    nr '"아, 물론 그들에게도 이름이 있겠지."{#morte_s490_1}'
...
# s492 # say50263
label morte_s492: # -
    nr '모트는 조롱한다. "이 떠다니는 염소 대가리들이 하는 말을 해석하느니 차라리 타나리 창자를 걸러내는 게 났지. 통역을 원해? 시길 토박이를 찾아보라고."{#morte_s492_1}'
...
# s493 # say50266
label morte_s493: # -
    nr '모트는 조롱한다. "이 떠다니는 염소 대가리들이 하는 말을 해석하느니 차라리 타나리 창자를 걸러내는 게 났지. 통역을 원해? 여기 있는 휜들링 계집에게 부탁하라고." 그는 안나를 가리킨다. "그녀는 벌통 토박이니까."{#morte_s493_1}'
...
# s494 # say50269
label morte_s494: # -
    nr '모트는 조롱한다. "이 떠다니는 염소 대가리들이 하는 말을 해석하느니 차라리 타나리 창자를 걸러내는 게 났지. 통역을 원해?" 그는 다콘을 가리킨다. "여기 있는 „나는 잘났으니 너희들 따위와는 얘기를 안 해“하는 양반에게 부탁하라고."{#morte_s494_1}'
...
# s495 # say50272
label morte_s495: # -
    nr '모트는 조롱한다. "이 떠다니는 염소 대가리들이 하는 말을 해석하느니 차라리 타나리 창자를 걸러내는 게 났지. 통역을 원해? 타나리에게 부탁하라고." 그는 훨-후럼-그레이스를 가리킨다. "아마 그녀는 이 친구들하고 늘 대화를 나누고 있을 거라고."{#morte_s495_1}'
...
label morte_s497: # from 496.0
    nr '"그는 다버스야. 그들은 퍼즐과 같은 기호로 „말하지.“ 만약 그가 무슨 말을 하는지 모르겠다면 번역해 줄 토박이를 찾거나 그와 의사소통을 할 방법을 찾는 게 좋을 걸. 정말 짜증나는 놈들이지. 내 생각에 놈들은 말을 할 수 있으면서도 일부로 퍼즐을 내서 다른 사람들을 골탕먹이려는 것 같아."{#morte_s497_1}'
...
label morte_s498: # from 497.0
    nr '"들리는 얘기로는 그들은 레이디 오브 페인의 청소부라는군. 그들은 레이디의 기분에 따라 시길을 부수거나 수리하지. 그들은 시체 파리보다도 징그럽다고." 모트는 한숨을 쉰다. "하지만 다버스는 때려죽일 수도 없어, 그러면 레이디가… 화를 낼 테니."{#morte_s498_1}'
...
label morte_s499: # from 498.0 498.1
    nr '"그녀는 이 도시의 지배자야. 대장도 그녀를 보면 알 거야. 그녀의 얼굴 주변에는 칼날들이 달렸고, 그녀는 거인만큼이나 거대하며, 저 친구들처럼 공중에 떠다니지." 모트는 당신들 둘을 바라보고 있는 다버스를 가리킨다. "아무도 그녀에 대해서 자세히 알지는 못해… 그녀는 거의 말을 하지 않아. 대장이 알아야 할 건 그녀를 화나게 해서는 안 된다는 것 뿐이야. 이건 내 충고인데, 만약 그녀를 보게 되면 도망치라고."{#morte_s499_1}'
...
# s500 # say50410
label morte_s500: # -
    nr '"뭐? 뭐야? 그 안에 어떤 내용이 들어 있는 거야, 대장?"{#morte_s500_1}'
...
label morte_s501: # from 500.0 500.1
    nr '"뭐?! 날 놀리는 거지? 그렇지? 자, 나도 좀 보자고!"{#morte_s501_1}'
...
label morte_s502: # from 501.1
    nr '모트는 뭐라고 비꼬려고 하다가… 그만둔다.{#morte_s502_1}'
...
label morte_s503: # from 500.2 501.0
    nr '모트는 날아와서 당신 어깨 너머로 사본의 내용을 살펴본다. 페이지를 훑어보자마자 그의 두 눈이 눈구멍에서 빠질 정도로 튀어나온다. "오오. 오오오오오. 오, 나는… 하지만… 와우."{#morte_s503_1}'
...
# s504 # say50697
label morte_s504: # -
    nr '"워! 워! 워! 농담이지, 그렇지? 진심은 아니겠지, 대장!{#morte_s504_1}'
...
# s505 # say50701
label morte_s505: # -
    nr '"믿을 수가 없군… 대장, 당신은 전에도 정말 갈 때까지 간 적이 있지만, 이번만큼은 정말 차원이 다르군. 어디 베이터에서 보자고, 이 두들겨 터져 몰골은 말이 아니고, X은 좁쌀만하고, 배신이나 때리고, 은혜라고는 모르고, 두창 자국 투성이고, 똥이나 먹고, 머리는 기름투성이고, 이빨은 뻐드렁니인 쓰레기 같은 기억상실증 환자야! 내 말을 명심해, 이 X같은 새끼야! 계속 이런 식으로 놀면 넌 곧 아주 *영원히* 죽게 될 거야… 어디 그 꼴이 어떨지 기대하고 있겠어!"{#morte_s505_1}'
...
# s506 # say52571
label morte_s506: # -
    nr '"그것이 그를 삼켰지만 그가 그 쪽에서 튀어나왔는지는 모르겠군."{#morte_s506_1}'
...
# s507 # say52573
label morte_s507: # -
    nr '"누가 새장 속에 있어야 할지 알 것 같군…"{#morte_s507_1}'
...
# s508 # say52574
label morte_s508: # -
    nr '"글쎄, 내겐 레이디의 미로들 중 한 곳으로 가서 시길의 역사상 가장 사악한 괴물을 만나는 것 말고는 할 일이 없었어, 그래서 나는 „물론이지“라고-"{#morte_s508_1}'
...
label morte_s509: # from 508.0
    nr '"„조용하라고?!“" 모트는 이빨을 딱딱거린다. "웃기고 자빠졌네! 마귀할멈이 골통을 딸랑거리는 걸 듣는 것만도 지겨워 죽겠는데, 이제는 내게 피부가 없다고 뭐라고 해? 그게 어떻다는 거야? 피부가 있다고 해서 저 할망구 꼴이 조금이라도 나아 보여? 내가 좋아서 이 꼴로 있는 줄 아나? 그리고 또-"{#morte_s509_1}'
...
# s510 # say52644
label morte_s510: # -
    nr '"엽기적이군. 우리는 지금 정확히 어디 서 있는 거지?"{#morte_s510_1}'
...
label morte_s512: # from 522.0 523.0 524.0
    nr '당신이 기둥에 가까이 다가가자 모트가 쉿 소리를 내 당신을 제지한다: "쉿! 대장! 대장… 내 말을 들어봐, 난 저것이 날 보게 할 수는 없어. 대장은 여기서 날 데리고 나가야 해… 날 다른 곳에 떨구었다가 나중에 다시 줍든지 하라고…"{#morte_s512_1}'
...
label morte_s513: # from 512.1
    nr '"어… 난 그것에 대해 별로 얘기하고 싶지 않아. 빨리 가자고, 좋지 ?" 모트의 목소리가 두려움으로 떨리고 있다. 그의 시선은 당신과 머리들로 만들어진 거대한 기둥 사이를 쉴 새 없이 오가고 있다.{#morte_s513_1}'
...
label morte_s514: # from 513.0 513.1
    nr '모트는 당신을 제대로 쳐다보지도 못하고 한숨만 쉰다. 마침내 그가 항복한다. "좋아, 좋아… 얘기할께. 베이터의 제1층인 아버누스에는 거짓말로 남을 죽음에 이르게 한 자들의 골통들로 만들어진 기둥이 있어. 바로 저기 있는 게 그거야. 내가 죽은 후에 간 곳이 바로 저기였어. 나머지는 대장 머리로 생각해보라고."{#morte_s514_1}'
...
label morte_s515: # from 514.1
    nr '"그래. 나는… 과장된 얘기를 한두 가지 했지. 내 제안들 중 하나가 대장을 죽음으로 이끌었어. 그것들 중 하나가. 아니면 다른 것들이었는지도 모르고. 난 정말 몰라. 이제 그런 기억들은 다 잃어버렸어."{#morte_s515_1}'
...
label morte_s516: # from 514.0
    nr '"그래. 나는… 과장된 얘기를 한두 가지 했지. 내 제안들 중 하나-"{#morte_s516_1}'
...
# s517 # say53667
label morte_s517: # -
    nr '모트는 침착하게 얘기를 계속한다. "… 내 *제안들* 중 하나가 대장을 죽음으로 이끌었어. 그것들 중 하나가. 아니면 다른 것들이었는지도 모르고. 이제 그런 기억들은 다 잃어버렸어."{#morte_s517_1}'
...
label morte_s518: # from 515.0 517.0
    nr '모트는 당신 발을 쳐다본다 - 그가 그토록 비참한 모습을 하고 있는 것은 일찍이 본 적이 없다. "그 기억들, 그것들.. 이봐, 대장, 난 내가 인간이었을 때 일도 기억이 나지 않아. 나는 기둥의 일원이 되기 전에 내가 어떤 삶을 살았는지를 기억할 수가 없어…"{#morte_s518_1}'
...
# s519 # say53794
label morte_s519: # -
    nr '모트는 다콘을 흘긋 본 후 당신을 쳐다본다. "그래, 그럴지도 모르지. 죽으면 다 그렇게 되는 거니까. 기억을 잃지… 생전에 나는 사회의 신뢰할 수 있는 구성원은 아니었던 것 같아… 하지만 정말로 그런 사람이 어디 있어?" 모트는 다시 한숨을 쉰다. "하지만 어쩔 수가 없어. 늘 정직한 것만큼 괴로운 것도 또 없다고. 하지만 이봐, 대장, 그 대가리들이 날 보면 날 되찾으려고 할거야, 그것도 아주 맹렬히. 그렇게 되도록 내버려 둘 순 없어!"{#morte_s519_1}'
...
label morte_s520: # from 518.1
    nr '"어쨌든, 생전에 나는 사회의 신뢰할 수 있는 구성원은 아니었던 것 같아… 하지만 정말로 그런 사람이 어디 있어?" 모트는 다시 한숨을 쉰다. "하지만 어쩔 수가 없어. 늘 정직한 것만큼 괴로운 것도 또 없다고. 하지만 이봐, 대장, 그 대가리들이 날 보면 날 되찾으려고 할거야, 그것도 아주 맹렬히. 그렇게 되도록 내버려 둘 순 없어!"{#morte_s520_1}'
...
label morte_s521: # from 519.1 520.1 523.1 524.1
    nr '"대장이 날 꺼냈어. 난 안간힘을 써서 기둥의 정면까지 올라온 다음 대장이 날 발견할 때까지 미친 듯이 울고 소리를 질러댔어. 벌써 알지도 모르겠지만, 대장이 여기 온 건 이번이 처음이 아냐. 어쨌든 난 여기서 해방시켜 달라고 대장한테 애원을 했고, 구해주기만 하면 대장이 죽는 날까지 대장을 따르면서 내가 지닌 지식을 공유하겠다고 맹세했어… 대장이 날 기둥에서 빼내기 전에 난 그게 얼마나 오랜 세월이 될지 알지 못했어."{#morte_s521_1}'
...
label morte_s523: # from 519.2 520.2 522.1 524.2
    nr '모트는 갑자기 변명을 늘어놓기 시작한다. "왜냐하면 난 대장이 어떤 사람이 될지 몰랐기 때문이야! 대장의 화신들 중 일부는 완전히 발광한 자들이었다고! 언젠가는 깨어나더니 내가 대장 해골이라는 생각에 사로잡혀 날 부셔서 먹겠다고 날 쫓아서 온 시길을 돌아다니기도 했지… 다행히도 그 때 대장이 거리에서 마차에 치어서 죽는 바람에 무사할 수 있었지. 그리고 „질서와 선“을 존중하는 또 다른 화신은 기둥이 내가 있어야 할 곳이라고 하면서 날 거기 다시 처박으려고 했어." 모트는 억지로 웃는다. "그게 이유야. 게다가 그걸 모른다고 해서 대장이 해를 입은 것도 아니잖아…"{#morte_s523_1}'
...
label morte_s524: # from 519.3 520.3 522.2 523.2
    nr '"잘 몰라. 아마 수백 년은 넘겠지. 나는 내 능력껏 대장이 길을 찾도록 도왔지만…" 모트는 한숨을 쉰다, 그리고 고개를 들어 당신을 마주본다. "여기까지 올 수 있었던 적도 드물었어. 아마 내 기억으로는 네댓 번이 고작일 거야. 아마 이번이야말로… 대장이 성공해서 대체 대장에게 무슨 일이 일어난 건지 알아낼 수 있을지도 몰라."{#morte_s524_1}'
...
# s526 # say53824
label morte_s526: # -
    nr '모트는 이빨을 덜거덕거리며 공포로 떤다. "난 돌아갈 수 없어, 대장! 그럴 수 없어! 그럴 수 없어! 그럴 수 없어!"{#morte_s526_1}'
...
# s527 # say53829
label morte_s527: # -
    nr '"이봐, 대장, 내가 방금 전에 저게 뭔지 말했잖아?! 그것은 다른 사람들을 죽음으로 몬 „조언“을 한 거짓말쟁이들의 머리들로 만들어졌다고. 그것은 엄청난 양의 지식을 가지고 있어 거의 어떤 질문에도 대답을 해줄 수가 있지만, 그 대가로 엄청난 요구를 한다고. 그런 질문은 하지마!"{#morte_s527_1}'
...
# s528 # say53830
label morte_s528: # -
    nr '"재발 날 거기 다시 넣지 말아줘, 대장. 제발 !"{#morte_s528_1}'
...
# s529 # say53831
label morte_s529: # -
    nr '"대장?! 안돼! 안돼! 그럴 수 없어! 제발!"{#morte_s529_1}'
...
label morte_s530: # from 529.0 529.1 529.2
    nr '모트는 회의적인 눈초리로 당신을 쳐다본다. "정말이야? 맹세할 수 있어? 이봐, 내가 무슨 말을 하고 있는 거지?! 안돼! 어림없어! 날 다시 거기에 넣을 순 없어!"{#morte_s530_1}'
...
label morte_s531: # from 529.3
    nr '모트는 한동안 당신을 조용히 쳐다본다, 그리고 어이가 없다는 듯 입을 크게 벌린다. "뭐?! 어림없어! 대장은 그 때만큼 강하질 않아… 이봐, 잊어버리자고. 대장은 할 수가 없어, 그러니 그런 얘기는 집어치워! 날 다시 거기에 넣을 순 없어!"{#morte_s531_1}'
...
# s532 # say53857
label morte_s532: # -
    nr '"워, 이것 보라고… 기다려! 그렇게 서두르지 말라고! 기둥… 난 갈라진-혀의 흐줄이 어디 있는지 말해줄 수 있어! 자, 알고 싶지 않아? 만약 그가 나 대신 그 정보를 준다면? 어떻게 생각해?"{#morte_s532_1}'
...
label morte_s533: # from 532.0
    nr '"뭐?" 대장 미쳤어?! *난* 배신할 수 있고, 그 *마족*은 배신하지 못하겠다고?! 놈이 대장을 도운 건 저주에 의해 그렇게 강제당하기 때문이라고! 나는 어떻고? 대장을 시체안치소에서 꺼내준 게 누구지? 대장이 그 요새인지 뭔지 하는 데서 기다리고 놈과 맞설 때 대장 옆에 서 있을… 아니, 떠 있을 사람이 누구지?! 허?! 허?! 그 후줄이라는 똥궁둥이는 절대 아니라고!{#morte_s533_1}'
...
label morte_s534: # from 540.3 541.2 542.2 543.1 544.1 545.2 546.1 547.1 548.4 549.2 550.2 551.1 552.1 553.2 554.2 555.2 556.1 557.1 562.0 563.0 564.0
    nr '"안 갈 이유가 없지, 대장." 모트는 고개를 젓는다. "내 말은 이미 우리는 다원 우주에서 온갖 끔찍한 차원이란 차원은 다 가봤다는 거야. 지금 와서 절벽 아래로 한 걸음 더 내딛지 못할 이유는 없지." 모트는 이빨을 덜거덕거리며 한숨을 쉰다. "준비는 다 됐어? 만약 아직 덜 됐다면…"{#morte_s534_1}'
...
label morte_s535: # from 534.1
    nr '"그래, 나…" 모트는 빛나는 청색 커튼을 흘긋 보더니 다시 한숨을 쉰다. "좋아. 가자고. 어딜 가더라도 시체안치소에서 골통을 딸랑거리는 것보다는 낫겠지."{#morte_s535_1}'
...
# s536 # say54161
label morte_s536: # -
    nr '"어…" 모트는 머뭇거린다. 그는 전이문과 당신을 번갈아 보더니 한숨을 쉰다. "이봐, 난 여기서 별로 얘기를 하고 싶지는 않지만… 어… 그래, 대장에게 꼭 해야 할 얘기가 있어…"{#morte_s536_1}'
...
label morte_s537: # from 536.0 536.1
    nr '"그건 우리가 갈 곳… 아니, 실은 *가본* 적이 있는 곳에 대해서야…"{#morte_s537_1}'
...
# s538 # say54168
label morte_s538: # -
    nr '"어… 대장?" 모트는 머뭇거린다. 그는 전이문과 당신을 번갈아 보더니 한숨을 쉰다. "이봐, 난 여기서 별로 얘기를 하고 싶지는 않지만… 어… 그래, 대장에게 꼭 해야 할 얘기가 있어…"{#morte_s538_1}'
...
label morte_s539: # from 538.0 538.1
    nr '"그건 우리가 갈 곳… 아니, 실은 *가본* 적이 있는 곳에 대해서야…"{#morte_s539_1}'
...
label morte_s540: # from 537.0 537.2 539.0 539.2
    nr '"실은 우리가 이 과정을 거치는 건 이번이 처음이 아니야… 우리는 이 „후회의 요새“란 곳에 가본 적이 있어… 하지만… 우리… 난 그 때는 알지 못했지."{#morte_s540_1}'
...
label morte_s541: # from 540.0 540.2
    nr '"직접 가보지 않으면 설명하기가 힘들어… 게다가 대장은 *다른* 대장을 몰라 -- 그는 우리들에게 비밀을 말해줄 그런 부류의 사람이 아니었어. 나는 그가 어떤 장소를 찾고 있다는 건 알았지만, 그 이유나 위치, 그리고 그 곳이 어떤 곳인지도 몰랐어, 그러니 대장한테 아무런 얘기도 못 해주었던 거지… 나는 그 곳에 우리가 도착했을 때 일어났던 일밖에 몰라…"{#morte_s541_1}'
...
label morte_s542: # from 540.1
    nr '모트는 불안해 하는 듯하다. "아냐! 아냐! 우리… 나는… 그런 것들에 대해 전혀 알지 못했어! 대장은 비밀을 남과 공유하는 그런 스타일이 아니었잖아! 그…그 *다른* 대장은 비밀은 대부분은 혼자서만 간직하고 있었고, 그래서 우린 사전에 우리가 왜 가야하며, 또 어떤 곳으로 가는지조차 알지 못했어! 나는 그 곳에 우리가 도착했을 때 일어났던 일밖에 몰라…"{#morte_s542_1}'
...
label morte_s543: # from 541.1 542.1
    nr '"그래, 우리는 이 - 이 요새로 갔지, 하지만 우리가 그 곳에 한 발짝도 디디기 전에 우린 뿔뿔이 흩어져 자신들의 목숨을 구하기 위해 싸워야만 했지… 만약 대장이 그 곳으로 갈 결심이라면, 내가 맨 먼저 해주고 싶은 말은 이거야. 저 전이문으로 들어가는 사람은 누구든지 다른 사람들로부터 *한참* 떨어진 곳에 도착하게 될 가능성이 높아. 그리고 중요한 건, 그렇다 하더라도 대장은 그 곳에 도와줄 사람들을 데리고 가야한다는 거야…"{#morte_s543_1}'
...
label morte_s544: # from 534.0 541.0 542.0
    nr '"그래, 우리는 이 - 이 요새로 갔지, 하지만 우리가 그 곳에 한 발짝도 디디기 전에 우린 뿔뿔이 흩어져 자신들의 목숨을 구하기 위해 싸워야만 했지…" 그는 몸서리친다. "만약 대장이 그 곳으로 갈 결심이라면, 내가 맨 먼저 해주고 싶은 말은 이거야. 저 전이문으로 들어가는 사람은 누구든지 다른 사람들로부터 *한참* 떨어진 곳에 도착하게 될 가능성이 높아. 그리고 중요한 건, 설령 우리가 흩어진다고 하더라도 우리가 대장의 마지막 희망이 될 수도 있다는 사실이야…"{#morte_s544_1}'
...
label morte_s545: # from 543.0 544.0
    nr '"왜냐하면 이 요새에서 대장를 기다리고 있는 것이 무엇이든 간에, 대장, 놈은 이미 대장을 한 번 격퇴했어… 그리고 난 오늘까지도 대장이 그 때 어떻게 살아남았는지 모르겠어, 하지만 만약 대장이 또 지면, 대장을 그 요새에서 끌고 나올 사람이 필요해…"{#morte_s545_1}'
...
label morte_s546: # from 545.1
    nr '"이 „후회의 요새“… 그 곳은 수십 킬로미터가 넘게 펼쳐지고 있어, 대장. 그 곳은 요새지만, 하나의 독립된 차원처럼 느껴져 - 돌과 어둠과 그림자들로 구성된. 그 곳에는 사방이 그림자들로 득실거려. 대장이 그 곳에 갈 거면, 준비를 단단히 해야 할 거야…"{#morte_s546_1}'
...
label morte_s547: # from 545.0
    nr '"이 „후회의 요새“… 그 곳은 수십 킬로미터가 넘게 펼쳐지고 있어, 대장. 그 곳은 요새지만, 하나의 독립된 차원처럼 느껴져 - 돌과 어둠과 그림자들로 구성된. 그 곳에는 사방이 그림자들로 득실거려. 우리가 그 곳에 갈 거면, 준비를 단단히 해야 할 거야…"{#morte_s547_1}'
...
label morte_s548: # from 546.0 547.0
    nr '"대장, 난 대장에게 무슨 일이 일어났는지 몰라, 하지만 내게 무슨 일이 일어났는지는 알아… 나는 날 죽이려고 쫓아오는 그림자들을 피해 방에서 방으로 도망쳐 다녔어… 그러다가… 갑자기 우리는 마치 누군가가 우리를 끌어당긴 것처럼 시길로 돌아오게 되었어…"{#morte_s548_1}'
...
label morte_s549: # from 548.1
    nr '모트는 잠시 침묵한다. "아니… 다른 사람들도 있었어. 다콘… 데이오나라란 센세이트 계집, 늘 술에 취해 있던 눈먼 궁수, 그리고 대장과 나… 그리고 완전히 아수라장이 되었지. 대장, 나, 그리고 다콘이 살아 돌아온 건 분명하지만, 다른 둘은 생환하지 못했어. 그들에게 무슨 일이 일어났는지는 나도 몰라."{#morte_s549_1}'
...
label morte_s550: # from 548.2
    nr '모트는 잠시 침묵한다. "아니… 다른 사람들도 있었어. 늙은 기스 다콘… 데이오나라란 센세이트 계집, 늘 술에 취해 있던 눈먼 궁수, 그리고 대장과 나… 그리고 완전히 아수라장이 되었지. 대장, 나, 그리고 다콘이 살아 돌아온 건 분명하지만, 다른 둘은 생환하지 못했어. 그들에게 무슨 일이 일어났는지는 나도 몰라."{#morte_s550_1}'
...
label morte_s551: # from 549.0 549.1 550.0 550.1
    nr '모트는 고개를 젓는다. "내가 아는 한은 아냐."{#morte_s551_1}'
...
label morte_s552: # from 548.3 551.0
    nr '"대장, 내가 말해줄 건 - 우리는 도착하자마자 흩어지게 되고, 그 곳은 거대한 장소이며, 그림자들로 득실거리고… 그 곳 어딘가에는 우리들 중 그 누구보다도 강대한 존재가 기다리고 있다는 것밖에 없어. 그 이상은 더 할 말이 없어…"{#morte_s552_1}'
...
label morte_s553: # from 552.0
    nr '"글쎄…" 모트는 잠시 멈춘다. "그래, 대장이 알아야 할 것이 하나 더 있어 - 내가 전에 알았던 대장, 우릴 이 곳으로 이끌었던 대장은 지금의 대장과는 전혀 달라."{#morte_s553_1}'
...
label morte_s554: # from 553.0
    nr '"다른 대장, 그는… 누구에게도 관심을 두지 않았어. 그 누구에게도. 우리들 모두가 요새에서 죽었더라도 그는 눈 하나 깜짝하지 않았을 거야. 그러니… 나는 대장이 그와는 다른 사람으로 계속 있어 주었으면 해, 왜냐하면 난 지금의 대장이 더 좋거든. 훨씬 더."{#morte_s554_1}'
...
label morte_s555: # from 553.1
    nr '내가 말하려는 건 대장이 지금까지 한 완고하고 아둔한 짓거리에도 불구하고, 대장이 그보다는 인간미가 더 있다는 거야. 다른 당신… 그는 이 세상에 자기 혼자만 존재한다고 생각하는 사람이었어. 그러니… 그것만 기억해 두라고."{#morte_s555_1}'
...
label morte_s556: # from 554.0 554.1 555.0 555.1
    nr '"아니…" 모트는 잠시 멈춘다. "한 가지가 더 있어. 난 *다른* 대장을 좋아하지 않았지만, 그는 무섭게 영리한 사람이었어 - 난 그보다 더 똑똑한 사람은 여태껏 본 적이 없어. 그는 늘 모든 가능성을 염두에 두고 있었지. 만약 그조차도 요새에서 죽었다면, 그건… 젠장."{#morte_s556_1}'
...
label morte_s557: # from 556.0
    nr '"아니…" 모트는 고개를 젓는다. "그런 얘기가 아냐, 대장. 왜냐하면 늘 누가 가장 똑똑하거나 강한가만 중요한 건 아니기 때문이야… 때로는 당신이 누구인가, 당신이 진정으로 원하는 것은 무엇인가가 더 중요해. 내 말은 이거야, 대장은 한때 불사신이 되기를 원했었어, 하지만 그게 정말 대장이 원했던 거였어? 내가 말하려는 건 이번에는 대장이 정말로 뭘 원하는지를 확실히 해 두라는 거야."{#morte_s557_1}'
...
label morte_s558: # from 557.0
    nr '"그래… 알아, 대장. 그리고 난 대장에게는 거짓말을 할 수가 없어… 난 가고 싶지 않아… 하지만 가겠어. 일단 저 전이문으로 들어가면 대장 혼자의 문제가 아니라는 것만 알라고. 대장에게 우리들 모두의 목숨이 걸려 있으니까. 그리고 우리는 대장과는 달리 한 번 죽으면 다시 일어나지 못해."{#morte_s558_1}'
...
# s559 # say54762
label morte_s559: # -
    nr '모트가 반격한다: "당신 냄새도 만만치 않군. 마지막으로 목욕을 한 게 언제지?"{#morte_s559_1}'
...
# s560 # say54763
label morte_s560: # -
    nr '모트가 반격한다: "당신 냄새도 만만치 않군. 마지막으로 목욕을 한 게 언제지?"{#morte_s560_1}'
...
# s561 # say54764
label morte_s561: # -
    nr '모트가 반격한다: "당신 냄새도 만만치 않군. 마지막으로 목욕을 한 게 언제지?"{#morte_s561_1}'
...
label morte_s562: # from 558.2
    nr '"래벌이 미로에서 한 말 있잖아… 대장이 자석처럼 고통받는 사람들을 자신에게 끌어당긴다는." 모트는 고개를 젓는다. "아나 그건 대장이 지금까지 쭉 고통을 받아 왔기 때문인 것 같아… 아마 대장 문제가 해결되면… 우리도 약간의 안식이나마 얻을 수 있게 될지도 모르지. 아마도."{#morte_s562_1}'
...
label morte_s563: # from 558.3
    nr '"래벌이 미로에서 한 말… 그리고 휄이 토먼트의 심벌에 대해서 한 말 기억하지? 대장이 자석처럼 고통받는 사람들을 자신에게 끌어당긴다는." 모트는 고개를 젓는다. "아나 그건 대장이 지금까지 쭉 고통을 받아 왔기 때문인 것 같아… 아마 대장 문제가 해결되면… 우리도 약간의 안식이나마 얻을 수 있게 될지도 모르지. 아마도."{#morte_s563_1}'
...
label morte_s564: # from 558.4
    nr '"난 대장을 오랫동안 알아 왔어, 대장. 그래서 하는 말인데, 대장에게는 뭔가가 있어… 대장이 자석처럼 고통받는 사람들을 자신에게 끌어당겨." 모트는 고개를 젓는다. "아나 그건 대장이 지금까지 쭉 고통을 받아 왔기 때문인 것 같아… 아마 대장 문제가 해결되면… 우리도 약간의 안식이나마 얻을 수 있게 될지도 모르지. 아마도."{#morte_s564_1}'
...
# s566 # say54841
label morte_s566: # -
    nr '"그 해골은 나였어." 모트가 조용히 말한다: "여자는 데이오나라란 계집이었고, 궁수에 대해서는 아는 게 없어…"{#morte_s566_1}'
...
# s567 # say54842
label morte_s567: # -
    nr '"그래…" 모트는 이빨을 덜거덕거린다. 몸을 떠는 동작인 것 같다. "대장, 이 요새는… 사방에 그림자들투성이야…"{#morte_s567_1}'
...
# s568 # say54843
label morte_s568: # -
    nr '"그들은 해골들의 기둥처럼 내게 말을 했어…" 모트는 목소리를 낮춘다. "그들 *알고* 있었어…"{#morte_s568_1}'
...
# s569 # say54845
label morte_s569: # -
    nr '"대장, 내가 말해줄 건 - 우리는 도착하자마자 흩어지게 되고, 그 곳은 거대한 장소이며, 그림자들로 득실거리고… 그 곳 어딘가에는 우리들 중 그 누구보다도 강대한 존재가 기다리고 있다는 것밖에 없어."{#morte_s569_1}'
...
# s570 # say54846
label morte_s570: # -
    nr '"대장, 내가 말해줄 건 - 어떤 그룹이든 그 곳에 도착하면 흩어지게 되어 있고, 그 곳은 거대한 장소이며, 그림자들로 득실거리고… 그 요새 어딘가에는 대장이 지금까지 만난 그 어떤 존재보다도 강대한 존재가 기다리고 있다는 것밖에 없어.{#morte_s570_1}'
...
# s571 # say55832
label morte_s571: # -
    nr '"대장, 이 녀석은 말썽거리야… 이 모드론은 불량이야."{#morte_s571_1}'
...
label morte_s572: # from 571.0
    nr '"그래, 모드론들도 때로는 혼돈의 영향을 좀 받게 되지, 그리고 그런 일이 일어나면… 글쎄, 내가 생각할 수 있는 가장 좋은 설명은 불량 모드론은… 일종의 거꾸로 된 모드론이라는 거야.{#morte_s572_1}'
...
# s573 # say55837
label morte_s573: # -
    nr '"대장, 재미있긴 한데, 이 얼간이 폴리곤하고 우리 골통들을 딸랑거리느니, 차라리 바테주 궁덩이 밑에서 의자를 빼내는 게 더 보람이 있을 거야."{#morte_s573_1}'
...
label morte_s574: # from 573.0
    nr '"대장, 난 이 주사위가 뭐라고 딸랑거리는지 모르겠어."{#morte_s574_1}'
...
label morte_s575: # from 574.0
    nr '"뭐… 난 대장보다는 더 안다고, 이 비틀거리는 목쉰 기억상실증 환자야! 그리고 대장의 그 빈 골통에 넣고 딸랑거릴 게 세 가지 있으니까 잘 들어 두라고: 1. 진정한 차원 전문가 따위는 없다. 2. 그나마 대장 주변에 있는 사람들 중 전문가 비슷하기라도 한 건 나밖에 없다. 3. 내게 경의를 좀 표해라. 왜냐고? 2를 참조해."{#morte_s575_1}'
...
# s576 # say55848
label morte_s576: # -
    nr '"미캐너스? 지루하다는 말이 그 곳보다 더 잘 어울리는 곳도 없을 걸, 대장. 모드론과 커다란 톱니바퀴 밖에 없는 차원을 한 번 상상해 보라고. 바로 그 곳이 특대급으로 지루한 차원 미캐너스야. 방문하기는커녕 생각하고 싶지도 않은 곳이지."{#morte_s576_1}'
...
# s577 # say55855
label morte_s577: # -
    nr '"경건한 여신관 아가씨, 미안하지만 미캐너스는 전우주에서 제일 지루한 차원이야… 만약 당신이 그 곳에 간다면 얘기가 좀 달라질지도 모르지만…" 모트는 눈을 부라린다. "하지만 내 생각에는 그것도 오래가지는 못할 거야."{#morte_s577_1}'
...
# s578 # say55860
label morte_s578: # -
    nr '"모든 모드론은 이 „풀“의 일원이야, 대장, 일종의 거대한 에너지 은행이라고나 할까… 어떤 모드론이 죽으면 그것을 만드는 데 사용되었던 에너지는 다시 그 곳으로 흡수되어 새로운 모드론이 나오게 되지. 그런데 문제는… 만약 모드론이 약간 돌아버릴 경우, 그러한 연결은 끊어지지만 에너지는 여전히 가지고 있게 된다는 점이지."{#morte_s578_1}'
...
# s579 # say55867
label morte_s579: # -
    nr '모트는 훨-후럼-그레이스를 노려본다. "그래, 댁은 괜찮소? 내가 이미 대답을 했소다, 그러니 댁은 나서지 말라고. 여기선 내가 정보 공급책이지 댁이 아니니까. 알겠느냐고?"{#morte_s579_1}'
...
# s580 # say55870
label morte_s580: # -
    nr '"오, 알겠군! 만약 내가 서큐버스였다면, 대장도 내 말에 더 귀를 기울이겠지, 그거야? 내가 가끔씩 살결을 드러내 보이면 나도 존중을 받게 되는 건가, 허? 그건 너무 천박하고 피상적이야, 대장! 젠장, 나는…"{#morte_s580_1}'
...
# s582 # say55873
label morte_s582: # -
    nr '"오, 그래?! 내가…?! 좋아…! 그래… 대장도 들었지?! 서큐버스가 한 말 말이야? 그녀가 옳아. 내 설명이 더 이해하기가 쉬워, 내가 더 잘 알고 있다고. 내 말이 무슨 뜻인지 알겠어? 이제 내가 왜 필요한지 알겠어?"{#morte_s582_1}'
...
label morte_s585: # from 584.0
    nr '"그들은 그의 에너지를 가져갈 거야, 대장, 그리고 새로운 모드론을 만들어 내겠지만, 그건 노돔은 아니야. 왜냐하면 그가 실제로 더 이상 모드론이 아니기 때문야. 그는 차원들의 영향을 너무 많이 받았어. 그들은 그를 대체할 비-노돔을 만들 거야."{#morte_s585_1}'
...
label morte_s586: # from 585.0
    nr '모트는 잠시 얘기를 멈춘다. "글쎄… 그래, 그렇게 말할 수도 있겠지. 내 말은 그가 불량품이 되지 않았다면 상관이 없었을 거라는 거야… 그가 죽더라도 그와 똑같은 새 모드론이 탄생할 테니까… 하지만 그는 „거꾸로 된“ 상태이기 때문에, 그가 죽으면 그의 그러한 특성은 사라지게 될 거야."{#morte_s586_1}'
...
# s587 # say55901
label morte_s587: # -
    nr '"아아악! 신들과 내 정신 건강을 위해 부탁하겠는데, 제발 집어치워! 그에게 그런 식으로 계속 그걸 물어보다가는 그가 고장이 나버릴 거라고!"{#morte_s587_1}'
...
label morte_s588: # from 587.0
    nr '"오." 모트는 싱긋 웃는다. "뭔가를 말했을 수도 있었겠지. 암, 계속하시라고. 물론이지…" 모트는 노돔을 흉내내 이빨을 *찰깍*거린다. "만약 대장이 모드론에 대해 알고 싶다면 내게 물어보라고."{#morte_s588_1}'
...
label morte_s589: # from 587.1
    nr '"이봐, 대장, 보통 모드론은 자신들에게 주어진 기본적인 임무 이외의 것들의 거의 이해하지 못해, 그리고 이 얼간이는 다원 우주에 대해서는 완전한 새내기라고. 그 입방체를 헷갈리게 하지 말라고, 알겠어? 적어도 그가 무장을 하고 있을 동안에는 말이야. 모드론에 대해 알고 싶다면 그가 아니라 내게 물어보라고."{#morte_s589_1}'
...
label morte_s590: # from 588.0 589.0
    nr '"설명하자면 이래, 대장: 모드론이란 그들의 고향 차원인 미캐너스에서 철꺽거리고 다니는 멍청한 기하학적 도형들이라고… 그들은 깔끔하고 질서 정연하지, 그리고 다원 우주의 다른 곳들도 그렇게 되기를 원해. 그래서 그들은 귀찮은 해충들인 거라고."{#morte_s590_1}'
...
label morte_s591: # from 590.1
    nr '"그 곳은 이러한 태엽장치로 돌아가는 일벌들의 발상지지. 그에게 그 곳에 대해 물어보고 어떤 대답을 하는지 한 번 들어보라고. 그 곳은 그들이 빈둥거리면서 늘 모든 것들을 정리하는 곳이지… 이걸 목록화 해라, 이걸 정돈해라, 저걸 정돈해라, 그걸 법문화해라, 등등."{#morte_s591_1}'
...
label morte_s592: # from 590.0 591.0 591.1
    nr '모트는 노돔을 흘긋 본다. 그는 마치 왼쪽 석궁의 얘기를 듣고 있는 듯 그것을 머리 옆쪽에 갖다 대고 있다.{#morte_s592_1}'
...
label morte_s593: # from 592.0
    nr '"왜냐하면 말이야, 대장, 혼돈 역시 우주에서 나름대로의 역할을 지니고 있어. 만약 모든 것이 *모드론*의 관점 대로 되어버린다면, 아마 삶이란 것이 거의 존재할 수 없을 거야… 적어도 내가 살고 싶은 종류의 삶은. 그들은 모든 것을 질서 정연하게 만들려고 해. 왝!"{#morte_s593_1}'
...
# s595 # say56030
label morte_s595: # -
    nr '"기다려, 대장… 배이터는 안돼. 이 마족은 뭔가를 숨기고 있는 거라고… 그리고 설령 „해골들의 기둥“이란 것이 실제로 존재하더라도, 다원 우주에서 가장 위험한 곳들 중 한 곳에 가는 일 없이 이 요새란 곳에 갈 방법을 알고 있는 자를 찾을 수 있을 거라고."{#morte_s595_1}'
...
label morte_s596: # from 595.1
    nr '"그 곳은 위험한 곳이야, 대장. 난 가기 싫어. 난 그 곳에 간 적이 있고 그 곳은 결코 쾌적한 곳이 아냐. 알겠어?"{#morte_s596_1}'
...
# s597 # say56936
label morte_s597: # -
    nr '"이 영감은 안 나타나는 곳이 없군!"{#morte_s597_1}'
...
# s599 # say60950
label morte_s599: # -
    nr '"이봐, 죽는 게 꼭 나쁜 건 아니라고. 낙관적으로 보라고… 적어도 저런 얼토당토 않은 것들하고 얘기할 필요도 없잖아."{#morte_s599_1}'
...
# s600 # say61408
label morte_s600: # -
    nr '"이봐, 대장… 어떻게 생각해? 이 모트에게 적선 좀 하라고. 알다시피 꽤 됐잖아…"{#morte_s600_1}'
...
# s601 # say61409
label morte_s601: # -
    nr '"만세! 고마워, 대장!" 모트는 돌아서서 여자를 따라간다.{#morte_s601_1}'
...
# s602 # say61410
label morte_s602: # -
    nr '모트는 당신이 있다는 것조차 거의 깨닫지 못하고 있는 것 같다, 그리고 그는 낄낄거림과 즐거운 탄식을 번갈아 가며 하고 있다.{#morte_s602_1}'
...
# s603 # say61481
label morte_s603: # -
    nr '"나? 난 벡크너의 머리라고."~ [MRT562]{#morte_s603_1}'
...
# s604 # say61482
label morte_s604: # -
    nr '"신들은 정말로 자비롭도다!!"~ [MRT485]{#morte_s604_1}'
...
# s605 # say61483
label morte_s605: # -
    nr '"그것은 벡크너의 머리와 관련된 긴 이야기야. 난 얘기하고 싶지 않아."~ [MRT559A]{#morte_s605_1}'
...
# s606 # say61484
label morte_s606: # -
    nr '"제발 화제를 바꿀 순 없겠어?"~ [MRT559B]{#morte_s606_1}'
...
# s607 # say61485
label morte_s607: # -
    nr '"나? 귀여운 모트지."~ [MRT560]{#morte_s607_1}'
...
# s608 # say61486
label morte_s608: # -
    nr '"나? 추억의 모트지."~ [MRT561]{#morte_s608_1}'
...
# s609 # say61487
label morte_s609: # -
    nr '"당신 베개에 눕게 해준다면."~ [MRT486A]{#morte_s609_1}'
...
# s610 # say61488
label morte_s610: # -
    nr '"아무 것도 아니야, 아니리고.~ [MRT486B]{#morte_s610_1}'
...
# s611 # say61489
label morte_s611: # -
    nr '"멍멍! 멍멍! 헤! 헤! 헤!"~ [MRT484]{#morte_s611_1}'
...
# s612 # say62890
label morte_s612: # -
    nr '"그녀는 타나리의 일종인 서큐버스라고, 대장."{#morte_s612_1}'
...
# s613 # say63454
label morte_s613: # -
    nr '"난 설 수가 없어. 알다시피 다리가 없잖아."~ [MRT482]{#morte_s613_1}'
...
# s614 # say63455
label morte_s614: # -
    nr '"난 네가 예쁘게 생겼다고 생각했는데, 착각이었군."~ [MRT483]{#morte_s614_1}'
...
# s615 # say63456
label morte_s615: # -
    nr '"난 널 첨 봤을 때 숨쉬는 걸 멈췄어, 흰들링."~ [MRT524]{#morte_s615_1}'
...
# s616 # say63457
label morte_s616: # -
    nr '"내게도 이름이 있다고."~ [MRT526]{#morte_s616_1}'
...
# s617 # say63458
label morte_s617: # -
    nr '"네가 그 얘기를 꺼내다니 재밌군… 왜냐하면 일전에 녀석들에게 네 값을 물어봤거든."~ [MRT531]{#morte_s617_1}'
...
# s618 # say63459
label morte_s618: # -
    nr '"입만 닥치면 너도 과히 나쁘진 않은데."~ [MRT530]{#morte_s618_1}'
...
# s619 # say63460
label morte_s619: # -
    nr '"하지만 넌 이미 내 마음을 가지고 있는걸, 흰들링."~ [MRT532]{#morte_s619_1}'
...
# s620 # say63462
label morte_s620: # -
    nr '"더 나쁜 것도 얼마든지 있어."~ [MRT525]{#morte_s620_1}'
...
# s621 # say63463
label morte_s621: # -
    nr '"그런데 말이지, *너는* 부분적으로나마 마족이라고."~ [MRT533A]{#morte_s621_1}'
...
# s622 # say63464
label morte_s622: # -
    nr '"내가 떠 있는 곳에서 보면 경치 좋은데."~ [MRT533B]{#morte_s622_1}'
...
# s623 # say63666
label morte_s623: # -
    nr '"나도 눈치챘어. 가서 대장과 네 식견을 나누지 그래?"~ [MRT563]{#morte_s623_1}'
...
# s624 # say63667
label morte_s624: # -
    nr '"허영이다, 이 얼간이 폴리곤아."~ [MRT468A]{#morte_s624_1}'
...
# s625 # say63668
label morte_s625: # -
    nr '"그럼 너부터 좀 „효율적“이 되라고, 이 딸랑거리는 폴리곤 녀석아."~ [MRT469A]{#morte_s625_1}'
...
# s626 # say63669
label morte_s626: # -
    nr '"기다려, 난 그런 말 하지 않았어!"~ [MRT470B]{#morte_s626_1}'
...
# s627 # say63670
label morte_s627: # -
    nr '"아직도 안나는 옷을 입고 있어?"~ [MRT565A]{#morte_s627_1}'
...
# s628 # say63671
label morte_s628: # -
    nr '"그럼 답은 예스지."~ [MRT565B]{#morte_s628_1}'
...
# s629 # say63672
label morte_s629: # -
    nr '"아가리 닥치지 않으면 내가 열 아홉을 세겠어."~ [MRT564]{#morte_s629_1}'
...
# s630 # say63673
label morte_s630: # -
    nr '"자유 의지가 내 명령에 절대복종한다는 뜻이라면 답은 예스야."~ [MRT569A]{#morte_s630_1}'
...
# s631 # say63674
label morte_s631: # -
    nr '"다원 우주에 온 걸 환영하네, 친구."~ [MRT569B]{#morte_s631_1}'
...
# s632 # say63675
label morte_s632: # -
    nr '"훨-후럼-그레이스는 누드야?"~ [MRT568A]{#morte_s632_1}'
...
# s633 # say63676
label morte_s633: # -
    nr '"그럼 네 질문에 대한 답은 예스야."~ [MRT568B]{#morte_s633_1}'
...
# s634 # say63677
label morte_s634: # -
    nr '"안나, 훨-후럼-그레이스와 내가 키메르족의 개펄에서 목욕을 하고 있어."~ [MRT571A]{#morte_s634_1}'
...
# s635 # say63678
label morte_s635: # -
    nr '"어떤 사람들은 사전을 쓰고, 다른 사람들은 그것을 읽지."~ [MRT572B]{#morte_s635_1}'
...
# s636 # say63679
label morte_s636: # -
    nr '"안나, 한 병의 후리욘디안 호박색 와인과 시 공회당의 호화 객실."~ [MRT573]{#morte_s636_1}'
...
# s638 # say63681
label morte_s638: # -
    nr '"오, 가서 다른 사람이나 귀찮게 해, 이 멍청이 계산기야."~ [MRT576A]{#morte_s638_1}'
...
# s639 # say63682
label morte_s639: # -
    nr '"몰라. 그건 그냥… 그건… 알잖아… 그건 사라졌어."~ [MRT576B]{#morte_s639_1}'
...
# s640 # say63683
label morte_s640: # -
    nr '"아가리 닥치지 않으면 내가 보여주지."~ [MRT576C]{#morte_s640_1}'
...
# s641 # say63684
label morte_s641: # -
    nr '"가서 곰용 덫하고나 키스해."~ [MRT575A]{#morte_s641_1}'
...
# s642 # say63685
label morte_s642: # -
    nr '"날 믿으라고. 안나에게는 키스가 필요해."~ [MRT575B]{#morte_s642_1}'
...
# s643 # say63686
label morte_s643: # -
    nr '::천진 난만하게 휘파람을 분다::~ [MRT472A]{#morte_s643_1}'
...
# s644 # say63688
label morte_s644: # -
    nr '"아무도 그에게 얘길 해주진 않았어!"~ [MRT473D]{#morte_s644_1}'
...
# s645 # say63689
label morte_s645: # -
    nr '"그건 순수하게 자발적인 거야, 멍청아. 어… 내가 안다는 얘기가 아니라…"~ [MRT577]{#morte_s645_1}'
...
# s646 # say63858
label morte_s646: # -
    nr '"날 믿으라고, 당신은 그를 만난 적이 없어."~ [MRT475AA]{#morte_s646_1}'
...
# s647 # say64990
label morte_s647: # -
    nr '"기다려, 대장… 이걸 봐." 내려다보니 아치로 향하고는… 돌아오지 않는 몇 개의 더러운 발자국이 있다. "이 부근에 전이문이 있는 것이 틀림없어."{#morte_s647_1}'
...
label morte_s648: # from 647.0
    nr '"모르겠어, 대장. 통행량을 감안할 때 흔한 열쇠가 틀림없어. 아마 이 근처에 서는 인간 쓰레기들이라면 알지도 몰라…"{#morte_s648_1}'
...
label morte_s649: # from 329.0 729.0
    nr '"오, 이봐, 대장. 또 까먹었다고는 제발 얘기하지 말라고."{#morte_s649_1}'
...
label morte_s650: # from 649.0 649.1
    nr '"그 소리를 많이 듣게 될 것 같군." 모트는 헛기침을 한다. "어디 보자…"  „네가 스틱스 강물을 몇 통이나 마신 듯한 기분인 것은 알지만, 정신을 차리고 집중해야 한다. 네 소지품들 중에는 이 중대사에 대해서 일부나마 밝혀 줄 일지가 한 권 있을 것이다. 만약 파로드가 이미 죽지 않았다면 그가 나머지 부분에 대해 설명해줄 수 있을 것이다.“{#morte_s650_1}'
...
label morte_s651: # from 650.0 650.1
    nr '"그래, 그래, 기다리라고." 모트는 잠시 멈춘다. "좋아, 이게 마지막이야…"  „절대로 일지를 잃어서는 안 된다, 아니면 우린 다시 스틱스에 빠지는 신세가 될 테니까. 알겠나? 그리고 내 말을 믿어라 - 뭘 하든 간에 네가 누구이며, 어떤 일이 네게 일어나고 있으며, 어디서 왔는지에 대해 말해서는 안 된다. 그렇지 않으면 화장터로 직행하게 될 테니. 내가 말하는 대로 해라: 일지를 읽은 후 파로드를 찾아라.“{#morte_s651_1}'
...
label morte_s652: # from 651.1
    nr '"무슨 소리야, 대장? 그것뿐이라고."{#morte_s652_1}'
...
label morte_s653: # from 651.0
    nr '"물론 끝에 해골을 믿지 말라는 헛소리가 있기는 하지만."{#morte_s653_1}'
...
label morte_s654: # from 329.4 652.0 652.1 729.4
    nr '"오… 맨끝에 있는 거 말이야? 쓰레기인 것 같아서 소리내어 읽지 않았어."{#morte_s654_1}'
...
label morte_s655: # from 653.0 654.0
    nr '"그건 내용이 의심스러워. 내 말은 말이야, 대장은 날 믿잖아. 그렇지, 대장?"{#morte_s655_1}'
...
label morte_s656: # from 655.0
    nr '"아냐! 대체 뭐가 문제야, 대장? 나 아직 대장을 잘못 인도한 적이 없다고."{#morte_s656_1}'
...
label morte_s657: # from 656.0
    nr '"아무 것도 없어! 난 대장에 모든 걸… 거의 모든 걸 말해주었어, 위험한 건 빼고 말이야."{#morte_s657_1}'
...
label morte_s658: # from 657.0
    nr '"대장, 정말 그 이외에는 아무 것도 없어. 난 대장에게 절대 숨기지 않는다고."{#morte_s658_1}'
...
label morte_s659: # from 329.1 729.1
    nr '"시길은 무한히 높은 첨탑 위에 위치한 고리 모양의 도시로, 어떤 사람들은 이 곳을 다원 우주의 중심이라고 하지… 물론 „어떻게“ 그것이 무한히 높은 첨탑 위에 존재할 수 있으며, 대체 무슨 근거로 시길이 „다원 우주의 중심“이라고 하는가에 대해서는 이론의 여지가 많지…"{#morte_s659_1}'
...
label morte_s660: # from 659.0
    nr '"시길은 „문들의 도시“라고 불려. 여기저기로 통하는 보이지 않는 문들이 많기 때문이지. 어떤 아치, 문틀, 술통의 테, 책장 또는 유리창도 조건만 맞으면 전이문이 될 수 있어. 모든 건 그걸 열 수 있는 열쇠가 있느냐에 달렸지"{#morte_s660_1}'
...
label morte_s661: # from 660.0
    nr '"가장 좋은 설명은 대부분의 전이문들은 „자고“ 있다는 거야. 자고 있는 상태에서는 옆을 지나거나, 그 안으로 들어가거나, 그 위로 지나도 아무 일도 일어나지 않아. 하지만 작 전이문에게는 그것을 „깨울“ 수 있는 뭔가가 존재해. 그건 혼자서 부르는 콧노래일 수도 있고, 일주일 동안 묵은 바이토피아산 빵 한 덩어리이거나 첫사랑의 추억을 기억하는 것일 수도 있어. 어쨌든 조건이 맞으면 문은 열리고 그 반대편에 있는 곳으로 이동할 수가 있어."{#morte_s661_1}'
...
label morte_s662: # from 661.0
    nr '"어디든지, 대장. 어떤 곳이든지 시길에는 그 곳으로 통하는 전이문이 있어. 그게 시길이 다원 우주 전역에서 각광받는 이유지."{#morte_s662_1}'
...
label morte_s663: # from 329.2 729.2
    nr '"이봐! 수다는 내 최대의 장기라고." 그는 이빨을 잠시 딱딱거린 후 싱긋 웃는다. "에? 에?"{#morte_s663_1}'
...
label morte_s664: # from 663.0
    nr '"하지만 말이야, 대장. 나는 수다를 제대로 떠는 데는 재능이 있어. 나는 말로 다른 사람들의 뚜껑이 열리게 만들 수가 있어. 나는 사람들을 정말 열받게 만들 수 있는 각종 욕설을 무수히 알고 있다고, 알아?"{#morte_s664_1}'
...
label morte_s665: # from 664.0
    nr '"그건 내가 지닌 여러 재능들 중 하나야… 난 그걸 „저주의 연도“라고 부르지. 아시다시피 난 *적절한* 코멘트를 함으로서 사람 머리뚜껑이 열리게 만들 수가 있어. 물론 그 후에는 열나게 도망을 쳐야 하지만… 내 말이 무슨 뜻인지 대장도 아마 알 거야{#morte_s665_1}'
...
label morte_s666: # from 329.3 665.0 729.3
    nr '"나는 사람들이 화가 나 날 쫓아오게 될 때까지 욕설을 퍼부어 댈 수가 있어."  주: 모트에게는 „저주의 연도“라는 능력이 있다. 그것은 마법과는 무관한 일종의 도발로, 회피 판정에 실패할 경우 대상은 아머 클래스와 명중률에 페널티를 받는다, 그리고 모트를 직접 공격하는 일 이외의 행동은 하지 않게 된다. 주목할 점은 모트가 다른 사람들이 욕하는 것을 많이 들으면 들을 수록 저주의 연도의 효과 역시 향상된다는 점이다. 저주의 연도는 메이지를 상대할 때 특히 효과가 크다.{#morte_s666_1}'
...
label morte_s667: # from 663.1 665.1 666.0
    nr '"난 로타의 응접실에서 대장이 날 빼내 주기를 기다렸어, 그런데 대장이 죽도록 시간을 끄는 덕분에 그 동안 친구들을 사귈 수가 있었지. 그리고 그들은 도움이 필요하면 자기들을 부르라고 했어.{#morte_s667_1}'
...
label morte_s668: # from 667.0
    nr '"내가 휘파람을 불면 그들이 나타나. 꽤 쓸만한 친구들이야, 그리고 뱀처럼 따끔하게 물지."  주: 이제 모트는 "해골 폭도"라고 불리는 특수 능력을 가지게 되었다. 이 능력을 사용하면 화면 밖에서 해골들이 몰려와 하나의 적을 여러 차례 물어뜯는다. 해골들의 위력과 그 대미지는 모트의 레벨에 비례하며, 이 능력은 하루에 일정 회수밖에 사용할 수 없다.{#morte_s668_1}'
...
label morte_s670: # from 669.3
    nr '"내가 보기에 모든 건 대장에게 달렸어. 지금은 대장에게 해줄 쓸모 있는 얘기가 없어."{#morte_s670_1}'
...
label morte_s671: # from 669.0
    nr '"이 „파로드“란 작자가 있는 곳부터 찾아야 할 것 같아. 만약 그가 대장에 대한 정보를 가지고 있지 않다면 그러한 지시 사항이 대장 등에 적혀 있을 이유가 없잖아. 아마 이 곳 토박이들 중에는 아는 사람이 틀림없이 있을 거야."{#morte_s671_1}'
...
label morte_s672: # from 669.1
    nr '"이 „청동 구체“란 걸 빨리 찾아서 늙은 지팡이에게 가져가자고."{#morte_s672_1}'
...
label morte_s673: # from 669.2
    nr '"대장 시체가 발견된 곳으로 가자고. 대장이 어떻게 죽었는지를 알아낼 수 있을지도 모르니까."{#morte_s673_1}'
...
label morte_s674: # from 669.4
    nr '"가서 대장에 대해 더 아는 - 대장이 왜 이렇게 됐는지 아는 자를 찾자고. 시길의 어딘가에 대장에 대해 대장보다 더 이는 사람이 분명히 있을 거야."{#morte_s674_1}'
...
label morte_s675: # from 669.5
    nr '"그 이 나이트 해그 래벌에 대한 정보를 더 알아내야 할 것 같아, 대장 - 그리고 솔직히 말해서 그건 별로 내키는 일이 아니야. 하지만 시 공회당에 있는 학자들과 감각석이 우리에게 도움을 줄 수 있을지도 몰라."{#morte_s675_1}'
...
label morte_s676: # from 675.0
    nr '"미안, 대장 - 나는 지금 대장의 상식 수준이 물질계에서 방금 온 사람과 차이가 없다는 걸 계속 까먹고 어. 시 공회당은 사무구에 있는 센세이트의 본거지야. 그 곳에는 체험을 기록한 감각석들과, 우리들에게 래벌에 대한 정보를 제공할 수 있을지도 모를 많은 수의 학자, 연사, 그리고 강사들이 있어."{#morte_s676_1}'
...
label morte_s677: # from 669.6
    nr '"래벌은 미로에 갇혔어. 하지만 대장이 그래도 가기를 원한다면, 그 곳으로 갈 수 전이문과 열쇠는 분명히 존재하고 있을 거야."{#morte_s677_1}'
...
label morte_s678: # from 677.0
    nr '"모르겠어. „래벌의 일부?“ 그건 그녀의 말라서 떨어진 사마귀에서 그녀의 침을 거쳐 그녀의 작품에 이르기까지 그 어떤 것에도 해당이 될 수 있는 말이야. 너무 애매해. 하지만 아마 사무구에는 그 미친 마녀의 일부를 어떻게 얻을 수 있는지 아는 사람이 분명히 있기는 있을 거야. 만약 그것이 여의치 못하면, 시 공회당에 있는 감각석을 체크해 볼 수밖에. 그것들 중 하나에 우리에게 유용한 체험이 담겨 있을지도 모르잖아."{#morte_s678_1}'
...
label morte_s679: # from 677.1 678.0
    nr '"모르겠어, 대장. 시길에는 전이문들이 무수히 많아. 우선 시 공회당에 가보자고. 그 곳의 감각석들 중 하나에 우리에게 유용한 체험이 담겨 있을지도 모르니까. 그것도 실패로 돌아가면 이렇게 뜬 구름 잡듯이 돌아다니는 건 그만두고 차리리 누구에게 전이문을 만들어 달라고 하자고."{#morte_s679_1}'
...
label morte_s680: # from 669.7
    nr '"우리가 필요한 것만 찾아서 당장 줄행랑치자고, 대장. 이 곳은 나처럼 피부도 없는 사람도 부시시 떨게 만든다고."{#morte_s680_1}'
...
label morte_s681: # from 669.8
    nr '"몰라, 대장. 이 게임의 주인공은 대장이라고 - 난 그냥 따라다닐 뿐이야."{#morte_s681_1}'
...
label morte_s682: # from 651.2
    nr '"아니… 여기 왔을 때 대장은 깨끗하게 털린 상태였어. 이미 말했듯이 대장 몸에는 충분하고도 남을 정도의 일지가 적혀 있다고."{#morte_s682_1}'
...
label morte_s683: # from 682.0
    nr '"아니. 그래도 그가 어디 있는지 아는 사람은 분명히 있을 거야. 이 근처에 사는 사람들에게 물어보자고."{#morte_s683_1}'
...
label morte_s684: # from 329.6 729.6
    nr '"그래, 미미르는 떠다니는 백과사전이야. 정보를 보관했다가 필요할 때 꺼낼 수가 있지."{#morte_s684_1}'
...
label morte_s685: # from 684.0
    nr '"그래서? 그런 종류도 있겠지만, *나는* 달라. 그리고 다원 우주에는 더 이상한 일들도 얼마든지 있다고, 대장."{#morte_s685_1}'
...
label morte_s686: # from 685.0
    nr '"왜 심문하는 거야? 그리고 대장이 미미르에 대해 대체 뭘 알아?"{#morte_s686_1}'
...
label morte_s687: # from 686.0 686.1
    nr '"그래, 난 미미르가 아냐, 하지만 난 많은 걸 알아, 그러니까 그렇게 불러서 나쁠 것 없잖아."{#morte_s687_1}'
...
label morte_s688: # from 687.0
    nr '"나는 많은 것을 아는 떠다니는 해골이야."{#morte_s688_1}'
...
label morte_s689: # from 688.1
    nr '"대장이 베이터의 냄새에 대해 뭘 알아?!"{#morte_s689_1}'
...
label morte_s690: # from 688.0
    nr '"대장이 베이터의 냄새에 대해 뭘 알겠어? 저 타나리와 나에 대해서 얘기를 하지 않았다면…?! 이봐, 그녀는 뭘 알고 있는 거지?!"{#morte_s690_1}'
...
label morte_s691: # from 689.0 690.0
    nr '"그래, 하지만… 그래. 그래 난 냄새가 좀 난다고. 냄새나서 미안하다고."{#morte_s691_1}'
...
label morte_s692: # from 691.0
    nr '"나는 지옥에 잠시 있었어. 오래 전 얘기지. 그런데도 악취는 한 번 배면 떨어지질 않아."{#morte_s692_1}'
...
label morte_s693: # from 329.7 692.0 729.7
    nr '"베이터의 첫 번째 층인 아버누스에는 해골들의 기둥이란 기둥이 있어, 하지만 보다 정확히 말하자면 머리들의 기둥이지."{#morte_s693_1}'
...
label morte_s694: # from 693.0
    nr '"사람들 얘기로 그 곳은 살아 있을 때 자신들이 지닌 지식을 악용하여 진실을 왜곡한 사람들 - 주로 학자나 현자들의 머리로 만들어졌다고 해… 그것도 다른 사람들을 죽게 하거나 큰 해를 입힐 정도로 중대한 거짓말을 한. 난 죽은 후 그것의 일부가 되었어. 웃기지?"{#morte_s694_1}'
...
label morte_s695: # from 694.0
    nr '"어…" 모트는 잠시 침묵한다. "그래, 대장 말이 옳아. 하나도 웃기지 않아. 아마 난 살았을 때 많은 것들을 알고 있었던 모양이야, 그리고 알고 있으면서도 늘 진실을 말하지는 않았던 모양이야. 그리고 내가 진실을 한두 번 왜곡했을 때, 그로 인해 다른 사람이 제 명을 다하지 못하고 죽었던 것 같아."{#morte_s695_1}'
...
label morte_s696: # from 695.1
    nr '모트는 잠시 당신을 쳐다본다. "그래. 어떻게 내가 아는지는 나도 몰라, 대장, 하지만 그렇게 생각해. 내 생각에 나는 바로 대장 때문에 그 곳에 가게 된 것 같아. 내장을 속인 일이 결정타가 된 것 같아. 나도 정확히 어떤 일이 일어났었는지는 기억을 할 수가 없어. 나는 내가 인간이었을 때의 기억도 없고, 기둥에서 깨어나기 전에 어떤 삶을 살았는지도 기억이 나지 않아.{#morte_s696_1}'
...
label morte_s697: # from 695.0
    nr '"어떻게 내가 아는지는 나도 몰라, 하지만 대장이었다고 생각해. 적어도 한 번은. 나도 정확히 어떤 일이 일어났었는지는 기억을 할 수가 없어. 나는 내가 인간이었을 때의 기억도 없고, 기둥에서 깨어나기 전에 어떤 삶을 살았는지도 기억이 나지 않아.{#morte_s697_1}'
...
label morte_s698: # from 696.0 697.0
    nr '"대장도 잘 알다시피 죽으면 기억을 잃는 것이 세상 이치인 모양이야… 전에 나는 사회의 신뢰할 수 있는 구성원은 아니었던 것 같아… 하지만 정말로 그런 사람이 어디 있어?" 모트는 다시 한숨을 쉰다. "하지만 어쩔 수가 없어. 늘 정직한 것만큼 괴로운 것도 또 없다고."{#morte_s698_1}'
...
label morte_s699: # from 698.0 698.1
    nr '"그래. *이번에도* 대장 말이 옳아." 모트는 이빨을 찰칵거리는데, 그것은 왠지 사람이 손가락을 두드리는 소리처럼 들린다. "생전에 한 거짓말과 악행에 대한 대가는 언젠가는 치르게 되어 있지, 그리고 내가 죽었을 때, 이제는 내가 저승의 뱃사공에게 돈을 낼 차례가 되었어."{#morte_s699_1}'
...
label morte_s700: # from 699.0
    nr '"대장이 날 도왔어. 대장이 해골들의 기둥 앞에 나타났을 때, 나는 기를 쓰고 표면으로 나왔지, 그리고 내 노하우와 매력을 총동원해 대장의 이목을 끌었어 - 대장은 *내*가 가장 많은 것을 아는 머리라는 걸 알고 있엇어. 그리고 난 대장과 거래를 했지"{#morte_s700_1}'
...
label morte_s701: # from 700.0
    nr '모트가 얘기를 하자 당신의 시야가 시뻘겋게 변한다, 그리고 온갖 끔찍스런 목소리들이 당신 귀에 들려 온다. 그들은 모두 당신에게 구해 달라고 애원하면서 비명을 지르고 있다, 그리고 모트의 목소리는 거기에 파묻혀 거의 들리지 않는다. 그의 목소리는 절박감과 공포로 가득 차 있다… 그리고 그는 가련할 정도로 스스로를 잃고 어찌할 줄을 모르고 있다.{#morte_s701_1}'
...
label morte_s702: # from 701.0
    nr '울부짖는 목소리들이 침묵한다, 그리고 업화의 불빛을 받아 벌겋게 빛나고 있는 작은 해골이 당신에게로 시선을 돌린다. 그의 안면은 피와 점액으로 얼룩져 있으며, 마치 추위에 또는 듯 이빨을 딱딱거리고 있다. "난… 난 당-당신을 도울 수 있어. 난 당-당신이 찾는 걸 알고 있어… 이 머리들… 그들의 모든 지식… 제발, 애원할게, 내가 당신을 돕게 해줘. *뭐든지* 다 말하겠어."{#morte_s702_1}'
...
label morte_s703: # from 702.0
    nr '"맹세해, 맹세해. 그러니.. 제발 날 여기서 구해줘… 나…" 당신은 모트가 자존심도 내팽개치고 보기 역겨울 정도로 애걸하는 것을 지켜본다. "애원할게. 내가 당신을 돕게 해줘. 제발…"{#morte_s703_1}'
...
label morte_s704: # from 703.0
    nr '당신이 움직임에 따라 시야 역시 움직인다, 그리고 울부짖음과 비명의 불협화음이 재개된다. 마치 악몽과도 같은 울부짖음, 도발, 욕설, 야유가 쇄도한다… 당신은 손을 기둥의 진창 속에 넣는다, 그리고 머리들이 마구 물어뜯는 것을 견디면서 작은 해골을 움켜 쥔다, 그리고 그것을 마치 오래된 상처딱지를 벗기듯 기둥에서 꺼낸다…{#morte_s704_1}'
...
label morte_s705: # from 704.0
    nr '당신은 자신의 흉터투성이 손 안에 있는 피로 범벅이 된 해골을 내려다본다. 그의 눈은 기둥에서 나온 점액으로 덮여 있으며, 그는 이빨을 한 번, 두 번 딱딱거린다. 그것은 무력한 간난아기가 우는 소리를 연상시키며, 과거의 당신 눈으로 볼 때 너무 한심하다.{#morte_s705_1}'
...
label morte_s706: # from 701.1 702.1 703.1 704.1 705.0 705.1
    nr '당신의 시야가 소용돌이친다, 그리고 과거의 안개는 바람에 날리듯 사라진다. 모트는 아직도 수다를 떨고 있다. "우리는 상호 협의가 제대로 이루어질 수 있을지 여부에 대해 한동안 얘기를 했지, 그리고 내 생각에 우리는 서로에게 깊은 인상을 받았던 것 같아. 그래서 대장은 날 기둥에서 빼냈고, 그 이후로는 늘 함께 있었어."{#morte_s706_1}'
...
label morte_s707: # from 706.0
    nr '"나는 일단 기둥 밖으로 나가면 기둥에 축적된 지식을 잃게 된다는 사실을 알지 못했어… 솔직히 나가 본 적이 없는데 어떻게 알겠어… 하지만 대장은 이해해 주었지 "{#morte_s707_1}'
...
label morte_s708: # from 707.0
    nr '당신의 시야가 다시 소용돌이치자 머리가 어지러워지고 속이 울렁거린다. 당신 귀에 뼈가 부서지는 것 같은 소리와 모트의 울부짖음이 들려 온다 - 고통에 신음하며 제발 자길 죽이지 말아 달라고 애걸하는 모트의 울부짖음이… 그리고 당신은 계속해서 손을 내밀고 또 내민다…{#morte_s708_1}'
...
label morte_s709: # from 708.0
    nr '뼈가 금속 성의 물질 - 벽이나 바닥과 부딪치는 소리와 이빨이 부러져 나가는 소리가 들린다. 모트가 두들겨 맞은 개새끼처럼 훌쩍이며 애걸하는 소리가-{#morte_s709_1}'
...
label morte_s710: # from 709.0
    nr '당신의 시야는 다시 소용돌이치고 모트의 울음소리는 그의 수다떠는 소리에 묻혀 사라진다. "대장은 내게 아직도 쓸모가 있다는 걸 깨달았고, 그래서 난 함께 가기로 했지. 그 이후로는 늘 함께 있었어."{#morte_s710_1}'
...
label morte_s711: # from 710.0
    nr '모트는 잠시 생각한다. "얼마나 오래됐는지는 정확히 몰라, 대장. 아마 수백 년은 되었겠지.나는 매번 내 능력껏 대장을 도왔어, 하지만…" 모트는 한숨을 쉰다. "하지만 쉽지는 않았어. 그리고 대장이 기둥에서 뭘 원했는지는 나도 몰라, 대장이 날 기둥에서 꺼내자마자 잊어버렸어."{#morte_s711_1}'
...
label morte_s712: # from 711.0
    nr '모트는 갑자기 변명을 늘어놓기 시작한다. "왜냐하면 난 대장이 어떤 사람이 될지 몰랐기 때문이야! 대장의 화신들 중 일부는 완전히 발광한 자들이었다고! 언젠가는 깨어나더니 내가 대장 해골이라는 생각에 사로잡혀 날 부셔서 먹겠다고 날 쫓아서 온 시길을 돌아다니기도 했지… 다행히도 그 때 대장이 거리에서 마차에 치어서 죽는 바람에 무사할 수 있었지. 그리고 „질서와 선“을 존중하는 또 다른 화신은 기둥이 내가 있어야 할 곳이라고 하면서 날 거기 다시 처박으려고 했어." 모트는 억지로 웃는다. "그게 이유야. 게다가 그걸 모른다고 해서 대장이 해를 입은 것도 아니잖아…"{#morte_s712_1}'
...
label morte_s713: # from 712.0
    nr '"그래, 대장, 내가 그럴 거라고 말했잖아. 모트는 늘 약속을 지킨다고." 그는 잠시 멈춘다. "대부분의 경우엔. 헤-헤. 아버리어에 어떤 계집이…"{#morte_s713_1}'
...
label morte_s714: # from 713.0
    nr '갑자기 당신은 모트의 어조가 변했다는 것을 깨닫는다. 당신은 그가 뭔가를 농담으로 적당히 감추려고 한다는 것을 한다. 당신과 함께 행동하게 된 이유에 대한 뭔가를.{#morte_s714_1}'
...
label morte_s715: # from 329.8 714.0 729.8
    nr '"대장, 그건 내가 약속을 했기 때문이라고 했잖아. 알겠어?" 그는 짜증스러워 하는 것 같다. "그 이외에 다른 어떤 이유가 있겠어?"{#morte_s715_1}'
...
label morte_s716: # from 715.0
    nr '"물론 아니야, 대장, 하지만 난-" 그리고 그의 목소리는 당신 안에서 뭔가를 갑자기 상기시킨다, 그리고 당신은 *왜* 그가 지금까지 당신 곁에 있었는지를 깨닫는다.{#morte_s716_1}'
...
label morte_s717: # from 716.0
    nr '"이봐, 대장. 내가 *죄책감*을 느껴? 나는 모트라고."{#morte_s717_1}'
...
label morte_s718: # from 717.0
    nr '모트는 당신을 바라보며 잠시 침묵한다. "아마 그럴지도. 정말 웃긴게 뭔지 알아? 처음에는 나는 그걸 느끼지 못했어 - 하지만 그건 사람 피를 서서히 말린다고, 알아?"{#morte_s718_1}'
...
label morte_s719: # from 718.0
    nr '"처음에 나는 내가 대장한테 „묶여“ 있다고 생각했었어… 그리고 대장의 마법이 날 일종의 마법사의 종복으로 만들었다고. 하지만 이백 년 정도가 지나고 나서 나는 우리의 관계가 더 깊은 것이라는 걸 깨달았어. 나는 왠지 대장에게 끌렸어. 아마 대장의 고통 때문일지도 몰라. 모르겠어. 아마 난… 모르겠어… 내가 한 일에 대해 책임감을 느꼈어. 만약 대장이 이렇게 된 게 다 내 탓이었다면?"{#morte_s719_1}'
...
label morte_s720: # from 719.0
    nr '"나는 내가 - 생전의 내가 했던 거짓말과 사기가 초래한 결과를 본 적이 없어, 그럼에도 난 내가 기둥 속에서 대장을 보았을 대, 즉석에서 내가 오래 전에 한 번… 배신한 사람이 바로 대장이라는 걸 즉각 깨달았어." 모트는 한숨을 쉰다. "그게 내가 아는 전부야."{#morte_s720_1}'
...
label morte_s721: # from 720.0
    nr '"아니, 내게 감사할 필요 없어…" 모트는 한숨을 쉰다, 그리고 놀랍게도 그의 목소리는 전보다 훨씬 강하고 자신에 넘치는 것 같다. 그리고 그의 해골에 나 있던 금과 부서진 부분들도 깨끗이 나았다. "정말 감사해야 할 건 나야. 날 지금껏 누르고 있던 차원 하나가 사라진 느낌이야… 비유해서 말하자면."{#morte_s721_1}'
...
label morte_s722: # from 329.10 729.10
    nr '"그녀는 나이트 해그야 - 그리고 그녀는 대장을 불사신으로 만들 정도로 미쳤다고, 날 선택할 수도 있었는데." 모트는 눈을 부라린다. "하지만 레이디 오브 페인에게 싸움을 걸 정도로 돈 자는 별로 찾고 싶지가 않은 걸."{#morte_s722_1}'
...
label morte_s723: # from 329.9 729.9
    nr '"그건 엄청난 규모의 참혹한 전쟁이야. 모든 곳에서 벌어지고는 있으나 늘 눈에 보이는 건 아니야."{#morte_s723_1}'
...
label morte_s724: # from 723.0
    nr '"대장, 그건 두 악랄한 종족들 - 타나리와 바테주 사이의 전쟁이야. 옛날옛적에는 둘이 서로를 모르고 지냈지. 바테주는 사악했지만, „질서 정연“한 악이었고, 반대로 타나리는 사악한 건 마찬가지이지만 느슨했어, 즉 보다 충동적이고 혼돈스러웠지. 바테주는 정치가, 타나리는 도살자였어."{#morte_s724_1}'
...
label morte_s725: # from 724.0
    nr '"그러다가 어느 날 두 종족이 만난 거지. 그들은 서로를 쳐다보자마자 상대방이 악에 접근하는 방식이 마음에 둘지 않았어. 그리고 그 이래로 그들은 계속 싸우고 있어. 그건 악몽이지, 하지만 두 종족들을 바쁘게 만들어 그들이 다원 우주에 입히는 피해를 최소화하지."{#morte_s725_1}'
...
label morte_s726: # from 329.11 729.11
    nr '"몰라, 대장. 죽었을 때 잊어버렸어. 스스로를 탓하진 않아 - 적어도 죽은 뒤에 날 기다리고 있는 운명이 있었으니까, 설령 그것이 떠다니는 해골로서의 삶일지라도. 내 말은 그것보다 훨씬 심한 꼴을 당했을 수도 있었다는 거야."{#morte_s726_1}'
...
label morte_s727: # from 726.0
    nr '"어… 몰라. 그냥 사라졌어." 모트는 당신을 노려본다. "하지만 별로 그립지는 않아. 난 지금의 내가 마음에 드니까. 그러니까 대장 편견으로 날 판단하거나 헐뜯지는 말라고."{#morte_s727_1}'
...
label morte_s728: # from 727.1
    nr '모트는 당신을 노려본다. "대장이 날 따라다니도록 운명지워진 살아 있는 저주가 아니라는 걸 나로서는 확신을 할 수가 없군."{#morte_s728_1}'
...
label morte_s729: # - # IF WEIGHT #7 /* Triggers after states #: 742 737 733 even though they appear after this state */ ~  Global("AR0200_Visited","GLOBAL",1) InParty("Morte") !GlobalGT("Fortress_Morte","GLOBAL",2)
    nr '"뭘 그렇게 골똘하게 생각하는 거야, ?"~ [MRT515]{#morte_s729_1}'
...
# s730 # say66816
label morte_s730: # -
    nr '"이봐, 대장, 저 두 사람 정말 대단하군. 나도 그들로부터 한두 가지 정도는 배울 수 있겠는데…"~ [MRT387]{#morte_s730_1}'
...
# s731 # say67510
label morte_s731: # -
    nr '"나는 그냥 무드를 깰 생각이 없다고 불쑥 말하고 싶었을 뿐이야, 대장. 난 그냥 여기 떠서 구경을 할 테니까 신경 쓰지 말라고."{#morte_s731_1}'
...
# s732 # say67600
label morte_s732: # -
    nr '"내가 다버스를 불러다가 두 사람을 분리시키기 전에 어서 떨어지라고!" 모트가 투덜거린다. "아니면 적어도 내가 끼어들 여지를 달라고."{#morte_s732_1}'
...
label morte_s733: # - # IF WEIGHT #1 ~  Global("Fortress_Morte","GLOBAL",3) Global("Absorb","GLOBAL",0)
    nr '당신이 손을 내밀자 갑자기 모트가 입을 연다. "워, 워, 워! 기다려, 대장! 내가 대장에게 말해야 할 게 몇 가지 있어."~ [MRT242]{#morte_s733_1}'
...
label morte_s734: # from 733.0
    nr '"그래 - 나처럼 죽은지 오래되면, 죽음을 위장하는 데 익숙해지게 된다고. 나는 대장과 그 녀석이 하는 대화를 처음부터 다 들었어. 그 힘은 다른 사람에게 쓰라고 - 나는 필요없어.{#morte_s734_1}'
...
label morte_s735: # from 734.0
    nr '"그래, 대장. 대장이 죽을 건 아니잖아. 내 말은 대장이 실패했을 경우 대장을 위해 기억해줄 사람이 필요하다는 거야. 게다가 대장도 내가 전투에서 얼마나 쓸모가 없는지는 잘 알잖아 - 마법사들을 도발할 때만 빼놓고…"{#morte_s735_1}'
...
label morte_s736: # from 735.0
    nr '당신은 다시 힘을 가지고 손을 내민다…{#morte_s736_1}'
...
label morte_s737: # - # IF WEIGHT #2 ~  Global("Fortress_Morte","GLOBAL",3) GlobalGT("Absorb","GLOBAL",0)
    nr '당신이 힘을 가지고 손을 내밀자. 모트가 갑자기 공중으로 떠오른다. 에… 기다려, 대장. 날 부활시킬 필요는 없어. 난 그냥 누워서 두 사람 얘기를 듣고 있었을 뿐이라고."{#morte_s737_1}'
...
label morte_s738: # from 737.0
    nr '"그래, 내 말은 난 이미 죽었다는 거야… 어, 대장, *목소리*가 어떻게 된 거야?"{#morte_s738_1}'
...
label morte_s739: # from 738.0
    nr '"뭐… 날 돌려보내? 대장은 어떡하고? 이봐, 대장, 나는 *겁쟁이*일지는 모르지만, 그래도 대장을 여기 두고 떠날 순 없어."{#morte_s739_1}'
...
label morte_s740: # from 739.0
    nr '"그래도 난 대장과 함께 갈 수 있어, 대장이 원한다면 - 내 말은 우린 이보다 더 지독 -{#morte_s740_1}'
...
label morte_s741: # from 740.0
    nr '모트는 당신을 쳐다본다, 그리고 한숨을 쉰다. "신파조로 나가긴 싫지만, 그 동안 즐거웠어, 대장."~ [MRT109]{#morte_s741_1}'
...
label morte_s742: # - # IF WEIGHT #3 ~  Global("Fortress_Morte","GLOBAL",4)
    nr '모트는 당신을 쳐다본다, 그리고 한숨을 쉰다. "신파조로 나가긴 싫지만, 그 동안 즐거웠어, 대장."~ [MRT109]{#morte_s742_1}'
