...
class MorteLogicTest(LogicTest):
    ...
    def test_j20538_s209_r20612_action(self):
        note_id = '20538'

        self._pickup_journal_note_action(
            note_id,
            self.logic.j20538_s209_r20612_action
        )


    def test_r20612_action(self):
        self.state_manager.world_manager.set_know_marta_work(4)
        self._integer_equals_action(
            self.state_manager.world_manager.get_know_marta_work,
            3,
    ...
    def test_j24933_s243_r24932_action(self):
        note_id = '24933'

        self._pickup_journal_note_action(
            note_id,
            self.logic.j24933_s243_r24932_action
        )
    ...
    def test_j67862_s462_r41921_action(self):
        note_id = '67862'

        self._pickup_journal_note_action(
            note_id,
            self.logic.j67862_s462_r41921_action
        )


    def test_r41921_action(self):
        self._false_then_true_action(
            self.state_manager.world_manager.get_jumble_reekwind,
            self.logic.r41921_action
        )


    def test_j39490_s467_r43910_action(self):
        note_id = '39490'

        self._pickup_journal_note_action(
            note_id,
            self.logic.j39490_s467_r43910_action
        )
    ...
    def test_j39490_s470_r43918_action(self):
        note_id = '39490'

        self._pickup_journal_note_action(
            note_id,
            self.logic.j39490_s470_r43918_action
        )
    ...
    def test_r65621_action(self):
        self.state_manager.world_manager.set_morte_talent(False)
        note_id = '65625'

        self.assertFalse(self.state_manager.world_manager.get_morte_talent())
        self.assertFalse(self.state_manager.journal_manager.found_journal_note(note_id))

        self.logic.r65621_action()

        self.assertTrue(self.state_manager.world_manager.get_morte_talent())
        self.assertTrue(self.state_manager.journal_manager.found_journal_note(note_id))
    ...
    def test_j65825_s720_r65821_action(self):
        note_id = '65825'

        self._pickup_journal_note_action(
            note_id,
            self.logic.j65825_s720_r65821_action
        )
    ...
    def test_r3971_condition(self):
        self._boolean_straight_condition(
            lambda x: self.state_manager.world_manager.set_has_prybar(x),
