...
label soego_s0: # - # IF WEIGHT #8 /* Triggers after states #: 59 58 12 63 108 79 82 95 even though they appear after this state */ ~  CreatureInArea("AR0201") Global("Appearance","GLOBAL",1) Global("Gate_Open","GLOBAL",0) Global("Soego","GLOBAL",0)
    nr '당신 시야에 퇴색된 흑색 법복을 입은 피곤한 듯한 사내가 들어온다. 그의 가는 얼굴은 극도로 창백하며, 그는 거의 잠을 자지 못한 것처럼 보인다. 그의 어깨는 축 늘어졌으며, 그의 충혈된 눈 아래에는 살이 처져 있다. 그는 당신의 존재를 알아차리지 못하고 있는 듯하다. 아마 그는 당신을 언데드 노동자들 중 하나로 착각한 모양이다.{#soego_s0_1}'
...
label soego_s1: # from 0.0 0.1 0.2 0.3
    nr '당신이 그에게 인사하자 그는 고개를 재빨리 쳐든다. "뭐라고… 했소? 방금 전에 당신이 내게 말을 했소?„{#soego_s1_1}'
...
label soego_s2: # from 1.0 1.1 3.0 3.3 4.0 4.1
    nr '"신들이여!" 더스트맨은 팔짝 뛴 다음, 당신을 골똘히 바라본다. 당신은 그의 눈이 충혈된 것이라기보다는 약간의 붉은 색조를 띠고 있는 것이라는 사실을 깨닫는다. "이보시오, 당신 귀에는 거슬리겠지만 이 얘긴 꼭 해야겠소. 당신은 정말 좀비처럼 생겼소." 그는 가볍게 인사를 한다. "나는 소에고요." 그는 당신 흉터들을 쳐다보면서 말한다. "그런 모습을 하고 이 곳에는 무슨 용건이오?"{#soego_s2_1}'
...
label soego_s3: # from 1.2
    nr '더스트맨은 잠시 당신을 살펴본 후, 고개를 젓는다. "또 허깨비를 본 모양이야…" 그는 한숨을 쉬고 두 눈을 비빈다. "이 열병은 갈수록 심해지는 것 같군…"{#soego_s3_1}'
...
label soego_s4: # from 1.3
    nr '더스트맨은 당신을 조심스럽게 바라본 다음, 몸을 구부린다. 그가 입을 열자 더럽고 날카로운 이빨들이 보인다. 그리고 그는 마치 쥐처럼 당신 냄새를 맡기 시작한다.{#soego_s4_1}'
...
label soego_s5: # from 1.4
    nr '당신이 떠나려고 돌아서자, 더스트맨은 약간의 쉿 소리를 낸 후 몸을 구부려 당신 냄새를 맡는다. "신들이여!" 더스트맨은 한 발짝 물러선 후 눈을 크게 뜬다. 당신은 그의 눈이 충혈된 것이라기보다는 약간의 붉은 색조를 띠고 있는 것이라는 사실을 깨닫는다. "이보시오, 당신 귀에는 거슬리겠지만 이 얘긴 꼭 해야겠소. 당신은 정말 좀비처럼 생겼소." 그는 가볍게 인사를 한다. "나는 소에고요. 그런 모습을 하고 이 곳에는 무슨 용건이오?"{#soego_s5_1}'
...
label soego_s6: # from 2.0 5.0 15.0 41.1 43.0 50.1 115.1
    nr '"아, 미안하지만 그건 내가 상관할 바요." 소에고의 눈은 붉은 색으로 번뜩이고, 무슨 기대라도 하는 듯 입의 한쪽 구석을 씰룩거린다. "아마…" 그는 날카롭고 더러운 이빨을 드러내며 조소한다. "경비병을 부른 것이 좋을 것 같소. 그래, 그게 좋겠군."{#soego_s6_1}'
...
label soego_s7: # from 2.1 5.1 13.3 15.1 42.1 57.0
    nr '"정말로?" 더스트맨은 당신을 세심히 조사한다. "당신은 *실제로* 준비 과정을 거친 것 같소. 당신의 어떻게 그런 고통을 견뎠는지 모르겠소… 당신은 고통을 받고 있소? 그런 것처럼 보이오."{#soego_s7_1}'
...
label soego_s8: # from 2.2 5.2 6.0 13.0 15.2 16.0 17.0 26.0 40.0 41.0 50.0 61.0 62.0
    nr '소에고는 입의 한쪽 구석을 씰룩거리며 고개를 끄덕인다. "물론이오. 이 건물은 방문자들에게는 헷갈릴 수가 있소. 별 큰 문제는 아니오, 하지만 방문자는 종이 아홉 번 울린 후에는 시체안치소에서 머무를 수가 없소. 당신을 위해 내가 정문을 열어 주리다."{#soego_s8_1}'
...
label soego_s9: # from 8.1 56.1 60.1
    nr '소에게는 벨트에 손을 뻗쳐 잠시 더듬더니 쉿 소리를 낸다. "열쇠!" 그의 눈은 밝은 빨간색으로 빛나고, 그는 분노하며 입술을 뒤로 만다. 그의 표정은 마치 동물과도 같다. "누가 내 열쇠를 훔쳤어!" 그는 당신을 향해 으르렁거린다. "당신이지! 당신이 이런 짓을 했지!"{#soego_s9_1}'
...
# s10 # say1486
label soego_s10: # -
    nr '소에고는 벨트에서 큰 열쇠를 빼낸 후 정문으로 걸어간다. 당신은 그의 기묘한 걸음걸이를 주목하지 않을 수가 없다… 그는 마치 균형을 잡으려는 듯 몸을 앞으로 구부라며 걷고 있다.{#soego_s10_1}'
...
label soego_s11: # from 10.1
    nr '일단 정문에 도달하자 그는 열쇠를 자물쇠에 넣고 돌린다. 잠시 후 자물쇠로부터 삐걱거리는 소리가 난다… 그 소리는 대리석 바닥에 반사되어 메인 홀 전체에 울려 퍼진다.{#soego_s11_1}'
...
label soego_s12: # from 11.0 # IF WEIGHT #5 /* Triggers after states #: 63 108 79 82 95 even though they appear after this state */ ~  CreatureInArea("AR0201") Global("Gate_Open","GLOBAL",1) Global("Gate_Cut_Scene","AR0201",1)
    nr '"좋소. 이제 정문은 열렸소, 하지만 당신은 다시 들어올 수 없소."{#soego_s12_1}'
...
label soego_s13: # from 2.3 5.3 6.1 15.3 16.1 17.1 26.1 61.1
    nr '"나가?" 소에고는 눈살을 찌푸린다. "당신은 어떻게 들어왔소?"{#soego_s13_1}'
...
label soego_s14: # from 13.1
    nr '고에고는 혀를 찬다. "정말 흥미롭군." 그는 다시 당신을 살펴본다. "당신은 계약자들 중 하나가 아니오?"{#soego_s14_1}'
...
label soego_s15: # from 4.4
    nr '당신이 떠나려고 돌아서자, 더스트맨은 냄새를 맡는 것를 멈추고 약간의 쉿 소리를 낸다. "신들이여!" 더스트맨은 한 발짝 물러선 후 눈을 크게 뜬다. 당신은 그의 눈이 충혈된 것이라기보다는 약간의 붉은 색조를 띠고 있는 것이라는 사실을 깨닫는다. "이보시오, 당신 귀에는 거슬리겠지만 이 얘긴 꼭 해야겠소. 당신은 정말 좀비처럼 생겼소." 그는 가볍게 인사를 한다. "나는 소에고요. 그런 모습을 하고 이 곳에는 무슨 용건이오?"{#soego_s15_1}'
...
label soego_s16: # from 2.4 5.4 15.4
    nr '"알겠소…" 소에고의 눈은 붉은 색으로 번뜩이고, 무슨 기대라도 하는 듯 입의 한쪽 구석을 씰룩거린다. "아마…" 그는 날카롭고 더러운 이빨을 드러내며 조소한다. "경비병을 부르는 것이 좋을 것 같소. 그래, 그게 좋겠군."{#soego_s16_1}'
...
label soego_s17: # from 2.5 5.5 7.1 13.4 14.1 15.5 23.2 24.2 25.2 26.9 27.4 28.2 29.3 31.3 32.2 33.4 34.4 35.3 36.3 37.2 114.3 115.4
    nr '당신이 떠나려고 돌아서자, 그는 화난 듯 쉿 소리를 낸다. 그러다 갑자기 그는 냉정을 되찾고 손을 들어 올린다. "아니, 미안하지만 당신은 여기를 떠날 수가 없소. 틀림없이 뭔가 잘못되었소. 이 건을 명확하게 해결하는 것이 좋을 것 같소." 그의 입술 한쪽이 약간 씰룩거리며 그의 두 눈이 번뜩인다. "…아마 경비병들이 도울 수 있을 거요. 그래… 그들을 불러야겠소."{#soego_s17_1}'
...
label soego_s18: # from 6.4 9.0 9.1 9.4 16.4 17.4 40.4 40.5 41.6 50.6 53.6 61.4
    nr '소에고는 한 걸음 물러선 후, 손뼉을 세게 세 번 친다. 그에 응답하듯 시체안치소 안에서 거대한 철제 종소리가 울려 퍼지기 시작한다.{#soego_s18_1}'
...
label soego_s19: # from 3.1 4.2 6.2 9.2 16.2 17.2 40.2 51.0 61.2 114.2 115.3
    nr '그가 입도 뻥끗하기 전에 당신은 양손으로 그의 관자놀이를 꽉 조인다, 그리고 그의 목을 왼쪽으로 세게 비튼다.{#soego_s19_1}'
...
label soego_s20: # from 19.0
    nr '그의 목이 부러지면서 *우지직* 소리가 난다… 하지만 그는 힘없이 늘어지는 대신 비명을 지르며 당신 손아귀에서 벗어난다!{#soego_s20_1}'
...
label soego_s21: # from 20.1
    nr '더스트맨도 당신만큼이나 충격을 받은 모양이다. 그는 정신이 나간 듯한 눈을 하고 있으며, 그의 목구멍에서는 꼴꼴 소리가 나고 있다… 그의 목이 부자연스러운 각도로 휜 것을 볼 때 당신이 그의 목을 부러트린 건 틀림없다, 하지만 그는 여전히 살아 있다! 당신이 놀란 채로 바라보는 동안 그는 힘없이 손뼉을 세 번 친다. 그에 응답하듯 시체안치소 안에서 거대한 철제 종소리가 울려 퍼지기 시작한다.{#soego_s21_1}'
...
label soego_s22: # from 3.2 4.3 6.3 9.3 16.3 17.3 40.3 61.3 114.1 115.2
    nr '*무언가가* 그에게 위험을 알린 듯하다. 당신이 미처 돌격하기도 전에 그는 한 걸음 물러선다. 그는 이빨을 드러내고 있으며 눈은 빨갛게 빛나고 있다. 그는 쉿 소리를 내며 손뼉을 세게 세 번 친다. 그에 응답하듯 시체안치소 안에서 거대한 철제 종소리가 울려 퍼지기 시작한다.{#soego_s22_1}'
...
label soego_s23: # from 14.0
    nr '"더스트맨이 사후에 계약자의 사체를 사용하는 것을 허용하는 계약서에 서명한 사람들이 있소. 당신은 기이한 사고에 말려들어 그렇게 되었을 가능성이 높소. 당신은 우리가 소유하고 있는 보통 좀비들보다 훨씬 똑똑한 것 같소."{#soego_s23_1}'
...
label soego_s24: # from 23.0
    nr '"그렇소. 많은 사람들은 소액의 돈을 받고 진정한 죽음에 도달하면 필요없게 될 육체를 기꺼이 팔고 있소."{#soego_s24_1}'
...
label soego_s25: # from 24.0 24.1
    nr '"좀비들은 시체안치소에서 허드렛일을 하오. 그들은 시체를 나르고, 바닥을 청소하며, 매장을 위해 시체를 준비하는 등 상대적으로 간단한 일들을 담당하오. 불행히도 그들은 조금이라도 복잡한 지시는 이해하고 실행할 수가 없소."{#soego_s25_1}'
...
label soego_s26: # from 12.0 23.1 25.1 27.2 28.0 29.1 31.1 32.0 33.2 34.2 35.1 36.1 37.0 58.0
    nr '소에고는 고개를 끄덕인다. "질문을 해도 좋소."{#soego_s26_1}'
...
label soego_s28: # from 27.0 27.1
    nr '"뭐라고? 누가 왜 그런…?" 그의 목소리는 듣기 어려울 정도로 낮아진다, 그리고 그가 입술을 뒤로 말자 마치 톱니와도 같은 이빨들이 드러난다. "*아나키스트.*" 그의 눈을 붉게 번뜩인다. "아나키스트가 *이 곳에* 침투하나니." 그는 갑자기 당신이 여기 있다는 사실을 기억한 듯 냉정을 되찾는다. "내게 이 사실을 알려 주어 고맙소. 경비병들에게 이 사태에 대해 조치를 취하도록 알리겠소."{#soego_s28_1}'
...
label soego_s29: # from 26.5
    nr '당신은 얘기를 하려다가 갑자기 멈춘다. 소에고를 바라보고 있자니 이상한 느낌이 온다…이유는 알 수 없으나 그에게 아무 말도 해서는 안된다는 생각이 든다.{#soego_s29_1}'
...
label soego_s30: # from 26.4 29.0
    nr '그는 잠시 입을 다물고 당신을 관찰한다. 그의 눈은 붉은 색으로 번뜩이고 있으며, 그는 작은 쉿 소리를 내고 있다. "당신은 여기 너무 오래 머무른 것 같소." 갑작스럽게 그는 한 걸음 물러선 후, 손뼉을 세게 세 번 친다. 그에 응답하듯 시체안치소 안에서 거대한 철제 종소리가 울려 퍼지기 시작한다.{#soego_s30_1}'
...
label soego_s31: # from 26.3
    nr '소에고는 힘없이 웃는다, 그리고 그의 입 한쪽 구석은 약하게 씰룩거린다. "나는 최근 몸이 좋지 않소… 가벼운 열병에 걸렸소, 그뿐이오. 그 때문에 때때로 잠을 잘 수가 없소."{#soego_s31_1}'
...
label soego_s32: # from 31.0
    nr '소에고는 고개를 젓는다. "괜찮소. 걱정을 해주어 고맙소… 난 견딜 수 있소." 그는 얼굴을 약간 찌푸린다. "그 밖에 내게 원하는 건 있소?"{#soego_s32_1}'
...
label soego_s33: # from 26.6
    nr '"파로드? 물론 나는 그를 아오." 그는 눈살을 찌푸린다, 그리고 그의 눈은 붉게 빛난다. "악귀같은 자요. 죽은 자를 존중할 주 모르는 위인이오, 산 자에 대해서는 말할 필요도 없고. 그는 수집자로 하이에나와 마찬가지요."{#soego_s33_1}'
...
label soego_s34: # from 33.0 36.0
    nr '"수집자는 시체를 모아 시체안치소로 가져옴으로서 생계를 유지하오. 우리는 그러한 사체들이 제대로 매장되도록 만전을 기하오."{#soego_s34_1}'
...
label soego_s36: # from 33.1 34.1 35.0
    nr '"나는 그가 시체안치소 밖의 빈민굴인 벌통에 산다는 걸 아나, 정확히 어디에 사는지는 모르오. 수집자들 중에 아는 사람들이 있을지도 모르오, 하지만 그들이 당신에게 털어놓을지 모르겠소."{#soego_s36_1}'
...
label soego_s37: # from 26.7
    nr '"일지?" 소에고는 혼란스러운 듯하다. "아니, 본 적이 없소."{#soego_s37_1}'
...
label soego_s38: # - # IF WEIGHT #9 /* Triggers after states #: 59 58 63 108 79 82 95 even though they appear after this state */ ~  CreatureInArea("AR0201") !Global("Appearance","GLOBAL",1) Global("Gate_Open","GLOBAL",0) Global("Soego","GLOBAL",0)
    nr '당신 시야에 흑색 법복을 입은 피곤한 듯한 사내가 들어온다. 그의 가는 얼굴은 극도로 창백하며, 그는 거의 잠을 자지 못한 것처럼 보인다. 그의 어깨는 축 늘어졌으며, 그의 충혈된 눈 아래에는 살이 처져 있다. 그는 얼마나 생각에 몰두하고 있는지 당신의 존재를 알아차리지 못하고 있는 듯하다.{#soego_s38_1}'
...
label soego_s39: # from 38.0
    nr '"안녕하시오…" 사내는 당신을 향해 몸을 돌린 후 가볍게 인사한다. 당신은 그의 눈이 충혈된 것이라기보다는 약간의 붉은 색조를 띠고 있는 것이라는 사실을 갑자기 깨닫는다. "나는 소에고요. 내가 어떻게…" 그는 갑자기 당신의 흉터를 눈치챈 것 같다, 그리고 입 한쪽 구석을 씰룩거린다. "미안하오, 하지만 당신은 길을 잃었소?"{#soego_s39_1}'
...
label soego_s40: # from 39.0
    nr '"그럼…" 소에고의 입은 무슨 기대라도 하듯 다시 씰룩거린다. "그럼 당신을 밖으로 안내할 경비병을 부르도록 하겠소. 잠깐만 서 계시오." 그는 곧 경비병들을 부를 것 같다.{#soego_s40_1}'
...
label soego_s41: # from 39.1 39.2 39.3
    nr '"나는 당신을 들여보낸 기억이 없소." 소에고는 의심스러운 눈으로 당신을 바라본다. 그리고 그의 눈은 횃불의 빛을 받아 붉게 빛난다. "당신이 여기서 뭘 하고 있는지 물어도 괜찮겠소?"{#soego_s41_1}'
...
label soego_s42: # from 41.2 50.2 115.0
    nr '그는 놀란 듯하다. "당신은… 위층의 철판 위에서 일어났단 말이오?"{#soego_s42_1}'
...
label soego_s43: # from 41.3 50.3
    nr '소에고는 고개를 끄덕인다. "당신은 누구를 만나러 왔소? 내가 기꺼이 안내해 드리리다."{#soego_s43_1}'
...
label soego_s44: # from 43.1
    nr '"달? 서기인 달이라면 위층의 접수실에 있소." 소에고의 입 한쪽 구석이 잠시 씰룩거린다. "그는 상당히 바쁘며, 그의 건강 역시 악화되고 있소. 중요한 용건이 아니라면 그를 방해하지 않는 것이 좋을 거요."{#soego_s44_1}'
...
label soego_s45: # from 44.1
    nr '"그렇소. 접수실은 이 도시의 시체가 이 곳으로 온 후 가는 장소요. 거기서 시체들은 장부에 기록되고 매장을 위한 준비를 받게 되오."{#soego_s45_1}'
...
label soego_s46: # from 44.0 45.0
    nr '"달에게 특별히 잘못된 곳은 없소. 달은…" 소에고는 이빨을 딸깍거린다. "…늙었을 뿐이오. 죽은 자들을 기록하는 그의 오랜 헌신도 이제 종점에 도착하려 하고 있소. 그가 걸린 소모성의 질병 때문에 그는 조만간 사망할 거요."{#soego_s46_1}'
...
label soego_s47: # from 43.2 53.2
    nr '"데이오나라? 북서쪽의 기념 홀에 그런 이름을 가진 여인이 안장되었소. 달신이 찾는 여자가 그녀요?"{#soego_s47_1}'
...
label soego_s48: # from 47.0
    nr '"모르겠소, 하지만 그녀는 이 곳에 상당히 오래 전부터 있었소. 그녀의 아버지라면 그녀에게 어떤 일이 일어났었는지 알지 모르오… 그는 상부 구역에 있는 사무실로부터 이 곳을 자주 방문하오. 그녀가 이 곳의 기념 홀에 안장된 것은 그의 희망에 의한 것이었소."{#soego_s48_1}'
...
label soego_s49: # from 43.3 43.4 53.3 53.4
    nr '"아단…" 소에고는 눈을 가늘게 뜬다, 그러자 당신이 아까 본 그의 눈의 붉은 색조는 한층 더 강조된다. "산 자든 죽은 자든 간에 그런 이름을 가진 사람은 시체안치소에는 없소."{#soego_s49_1}'
...
label soego_s50: # from 40.1 42.0 43.5 49.0 53.1 57.1
    nr '소에고의 입 한 구석은 다시 씰룩거리고, 그의 눈은 번뜩인다. "그럼 당신이 여기 온 용건은 무엇이오?"{#soego_s50_1}'
...
label soego_s51: # from 41.5 50.5 53.5
    nr '당신이 몸을 구부리자 소에고는 눈살을 찌푸린다, 그리고 당신은 그가 무슨 시험이라도 하듯 공기 냄새를 맡고 있다는 것을 알아챈다. 그는 마치 당장이라도 경비병들을 부를 것처럼 눈을 가늘게 뜬다.{#soego_s51_1}'
...
label soego_s52: # from 51.1
    nr '당신이 돌격하자 그는 한 걸음 물러선다. 그는 이빨을 드러내고 있으며 눈은 빨갛게 빛나고 있다. 그는 쉿 소리를 내며 손뼉을 세게 세 번 친다. 그에 응답하듯 시체안치소 안에서 거대한 철제 종소리가 울려 퍼지기 시작한다.{#soego_s52_1}'
...
label soego_s53: # from 41.4 50.4
    nr '"누구의 장례식이라고 했소? 아마 당신이 참석하려는 장례식은 시체안치소의 다른 곳에서 거행되고 있을지도 모르오."{#soego_s53_1}'
...
label soego_s54: # from 7.0 25.0
    nr '"글쎄…" 소에고는 당신을 흘긋 본다. 그는 혼란스러운 듯하다. "분명히 착오가 있었던 모양이오. 당신은 이 곳에 데려온 건 당신의 육친, 다른 더스트맨, 또는…" 소에고는 불쾌한 생각이 갑자기 든 것처럼 쉿 소리를 낸다. "또는 수집자들 중 하나일 것이오."{#soego_s54_1}'
...
label soego_s55: # from 54.0
    nr '"그렇소, 수집자들… 죽은 자의 유해를 우리에게 가져오는 하이에나 같은 자들의 무리요. 그들은 당신이 죽었다고 생각했을지도 모르오…" 그는 쉿 소리를 낸 후 눈을 번뜩인다. "…그리고 그들은 돈에 눈이 먼 자들이라 당신을 데려오기 전에 확인하려고 하지도 않았을 거요." 소에고는 당신을 살펴본다. "당신이 깨어난 것은 불행한 일이오… 아니면 진정한 죽음에 때가 되기도 전에 도달했을 텐데."{#soego_s55_1}'
...
label soego_s56: # from 55.0 59.1
    nr '소에고는 고개를 끄덕인다, 그리고 그의 입 한쪽 구석은 씰룩거린다. "물론이오. 당신을 위해 정문을 열어 주리다."{#soego_s56_1}'
...
label soego_s58: # - # IF WEIGHT #6 /* Triggers after states #: 63 108 79 82 95 even though they appear after this state */ ~  CreatureInArea("AR0201") Global("Gate_Open","GLOBAL",1)
    nr '당신이 다가가자 그는 공기 냄새를 맡은 후 당신을 올려다 본다. 당신을 보자 그는 눈살을 찌푸린다. "난 당신을 위해 정문을 열어 주었소. 왜 아직도 여기 있는 거요?"{#soego_s58_1}'
...
label soego_s59: # - # IF WEIGHT #7 /* Triggers after states #: 63 108 79 82 95 even though they appear after this state */ ~  CreatureInArea("AR0201") Global("Soego","GLOBAL",1) Global("Gate_Open","GLOBAL",0)
    nr '당신이 다가가자 그는 공기 냄새를 맡은 후 당신을 올려다 본다. 당신을 보자 그는 가볍게 인사한다. "찾던 것을 찾았소?"{#soego_s59_1}'
...
label soego_s60: # from 59.0
    nr '소에고는 고개를 끄덕인다, 그리고 그의 입 한쪽 구석은 씰룩거린다. "물론이오. 당신을 위해 정문을 열어 주리다."{#soego_s60_1}'
...
label soego_s61: # from 13.2
    nr '"이건 정말 이상하군." 소에고의 눈은 붉은 색으로 번뜩이고, 무슨 기대라도 하는 듯 입의 한쪽 구석을 씰룩거린다. "아마…" 그는 날카롭고 더러운 이빨을 드러내며 조소한다. "경비병을 부르는 것이 좋을 것 같소. 그래, 그게 좋겠군."{#soego_s61_1}'
...
label soego_s62: # from 44.2 45.1 46.0 47.1 48.0
    nr '소에고는 고개를 끄덕인다… 그리고 그의 입 한쪽 구석은 다시 씰룩거린다. 그는 자신의 그런 습관을 모르는 듯하다. "고인에게 애도의 뜻을 표하고 나면 돌아오시오, 그러면 당신을 위해 정문을 열어 주겠소. 종이 아홉 번 울린 후니 서둘러 용무를 끝내시오."{#soego_s62_1}'
...
label soego_s63: # - # IF WEIGHT #4 /* Triggers after states #: 108 79 82 95 even though they appear after this state */ ~  CreatureInArea("AR1500") !Global("CR_Vic","GLOBAL",1)
    nr '"아, 또 다른 산 자로군. 지하 묘지의 이토록 깊숙한 곳까지 내려오는 자는 대부분 굴들에게 죽임을 당하는데 당신은 운이 좋소."{#soego_s63_1}'
...
label soego_s64: # from 63.1 77.0 78.0
    nr '"나는 더스트맨의 당원인 소에고요. 나는 이 곳에 선교사로서 왔소." 그는 고개를 반쯤 숙여 인사한다.{#soego_s64_1}'
...
label soego_s65: # from 64.0 72.2 73.2 74.0 101.3 104.1
    nr '"그렇소, 나는 자아를 지닌 언데드들이 이 곳에 있다는 소문을 듣고 이 지하 묘지로 왔소. 나는 그들을 구원하고자 하오."{#soego_s65_1}'
...
label soego_s66: # from 64.1 72.3 73.3 74.1 101.4 104.2 109.2
    nr '"나밖에 없소. 나는 자아를 지닌 언데드들이 이 곳에 있다는 소문을 듣고 이 지하 묘지로 왔소. 나는 그들을 구원하고자 하오."{#soego_s66_1}'
...
label soego_s67: # from 65.0 66.0
    nr '"그렇소, 열정은 그들을 거짓된 현생에 묶어두고 있소. 내가 그들이 이러한 열정을 포기하고 거짓된 현생을 떠나 진정한 죽음에 도달하도록 가르칠 수 있다면 좋겠소."{#soego_s67_1}'
...
label soego_s68: # from 67.0 69.0 70.0
    nr '"이 죽은 자들은… 진정한 죽음으로부터 너무나도 가까운 곳에 있소… 그럼에도 그들은 아직도 현생에 매달리고 있소. 이 그릇된 삶은 이 차원에 묶어두려는 허위로 가득한 환상에 불과하오."{#soego_s68_1}'
...
label soego_s69: # from 67.1 68.0 70.1
    nr '"진정한 죽음은 일체의 열정이 없는 상태로, 이 존재의 그림자의 피안에 존재하는 진정한 삶이오. 그 곳은 죽은 자들이 스스로를 해방시키기 위해 도달해야만 하는 곳이오."{#soego_s69_1}'
...
label soego_s70: # from 67.2 68.1 69.1
    nr '"나는 그들이 열정을 버리고 이 존재의 차원을 초월하기를 바라오. 그것만이 그들을 구원할 수 있소."{#soego_s70_1}'
...
label soego_s71: # from 63.4 64.4 65.3 66.3 67.5 68.4 69.4 70.4 72.6 73.6 74.4 77.2 78.2 79.5 80.1 81.0 101.5 104.3 109.5 110.3 112.1
    nr '"가기 전에 잠시 내 말에 귀를 기울이시오. 이 지하 묘지 안에서는 언데드를 결코 공격하지 마시오. 당신이 평화적으로 나오는 한 그들은 당신을 해치지 않을 것이오. 만약 당신이 적대적으로 나온다면 그들도 자신들을 방어할 것이오… 그리고 그들의 수는 매우 많소. 마지막으로 만약 휴식할 곳이 필요하다면 이 곳으로 돌아와도 좋소."{#soego_s71_1}'
...
label soego_s72: # from 63.0
    nr '"당신은 기억력이 좋은 것 같소. 나는 더 이상 시체안치소에서 근무하지 않소… 대신 나는 이 지역에 선교사로 파견되었소."{#soego_s72_1}'
...
label soego_s73: # from 72.0 72.1 109.0 109.1
    nr '"당신이 내게 입힌 상처는 치명상이 아니었소. 나는 금새 회복했고… 시체안치소에서 떨어져 있고 싶다는 생각이 들었소."{#soego_s73_1}'
...
label soego_s74: # from 73.1 101.2 104.0
    nr '"아니… 그래야만 하오? 나는 아직 내가 이 세상을 떠날 때가 되지 않았다는 사실에 다소 실망했소. 그렇지만 당신은 시체안치소로는 돌아가지 않는 것이 좋을 거요, 내 동료 당원들은 당신을 별로 반기지 않을 테니까.{#soego_s74_1}'
...
label soego_s77: # from 63.2 64.2 65.1 66.1 67.3 68.2 69.2 70.2 72.4 73.4 74.2 78.1 109.3
    nr '"당신은 죽은 자의 왕국의 지하 묘지에 있소. 위병들이 당신을 이 곳으로 데려왔소."{#soego_s77_1}'
...
label soego_s78: # from 63.3 64.3 65.2 66.2 67.4 68.3 69.3 70.3 72.5 73.5 74.3 77.1 109.4
    nr '"모르겠소. 이 곳의 „시민들“에게 물어보시오."{#soego_s78_1}'
...
label soego_s79: # - # IF WEIGHT #2 /* Triggers after states #: 82 95 even though they appear after this state */ ~  CreatureInArea("AR1500") Global("CR_Vic","GLOBAL",1)
    nr '"아, 우리의 대의에 협조할 사람이 오셨군! 여럿이-모여-하나의 첩자인 나는 당신이 온다는 소식을 이미 들어 알고 있었소. 당신은 우리를 위해 침묵의 왕의 알현실로 들어갈 방법을 찾아내 그를 죽여야만 하오. 이 일을 해내면 여럿이-모여-하나가 당신에게 상을 내릴 거요."{#soego_s79_1}'
...
label soego_s80: # from 79.4 110.2 112.0
    nr '"모르겠소… 내가 이 곳에 온지도 꽤 되었지만 아직도 그의 알현실로 들어갈 방법은 찾아내지 못했소. 당신은 나처럼 편견과 증오의 대상이 아니니 아마 해낼 수 있을지도 모르오."{#soego_s80_1}'
...
label soego_s81: # from 80.0
    nr '"내 당파의 사상을 모든 사람들이 다 좋아하는 건 아니오. 특히 이 곳의 우두머리들은 내 사상을 달갑게 여기지 않소."{#soego_s81_1}'
...
label soego_s83: # from 82.7 88.0 89.1 90.0 91.1 92.0 94.1 94.3 111.0
    nr '"내가 대답할 수 있는 거라면 대답하리다."{#soego_s83_1}'
...
label soego_s84: # from 71.0 71.1 82.5 82.6
    nr '"물론이오. 이 방에서는 안전하게 휴식을 취할 수가 있소."{#soego_s84_1}'
...
label soego_s88: # from 83.0 91.0
    nr '"고집불통이오, 하지만 그의 경건함과 책무에 대한 헌신은 존경할만 하오. 그는 이 곳에서의 내 최대의 라이벌이오, 그리고 그는 이 문명을 오랜 세월 동안 유지시켜 왔소. 그의 열정은 그의 경건함과 책무에 대한 헌신으로부터 나온다오… 존경할만하기는 하나 그 대상이 잘못되었소."{#soego_s88_1}'
...
label soego_s89: # from 83.1
    nr '"아키스트는 야수만도 못한 자요. 오직 침묵의 왕의 권위만이 그녀가 날뛰는 것을 막고 있쏘. 만약 그가 사라진다면 굴들이 이 지하 묘지 전체를 유린할 것이오."{#soego_s89_1}'
...
label soego_s90: # from 83.2
    nr '"썩은 메리는 느리기는 하지만 마음씨가 고운 사람이오. 나는 그녀가 하는 말을 거의 이해하지 못하오, 하지만 그녀나 그녀의 좀비들은 폭력적이지 않소."{#soego_s90_1}'
...
label soego_s91: # from 83.3 89.0
    nr '"나는 침묵의 왕을 본 적이 없소. 그에 대해 당신에게 얘기해줄 수 있었으면 좋겠으나 나 자신도 그를 본 적이 없소. 그의 알현실은 진홍색 문 뒤에 있으리라고 생각되나, 나는 그 곳에 들어갈 허가를 받지 못했소… 스켈레톤 사제인 하그림이 그걸 허락하지 않소."{#soego_s91_1}'
...
label soego_s92: # from 83.4
    nr '"내 생각에 그들은 이 곳에서 여러 세기 동안 있었던 것 같소, 그들의 왕국에서 죽어간 자들을 보살피며 말이오. 책무에 대한 그러한 헌신은 더 이상 필요하지 않소… 아니, 그건 오히려 범죄적인 행위요."{#soego_s92_1}'
...
label soego_s93: # from 83.5
    nr '"내 생각에 그들은 이 곳에서 여러 세기 동안 있었던 것 같소, 그들의 왕국에서 죽어간 자들을 보살피며 말이오. 책무에 대한 그러한 헌신은 더 이상 필요하지 않소… 아니, 그건 오히려 범죄적인 행위요."{#soego_s93_1}'
...
label soego_s94: # from 82.0 82.1
    nr '"뭐라고? 그게 사실이오? 아, 그 정보를 가져가면 여럿이-모여-하나가 그대에게 상을 내릴 것이오…"{#soego_s94_1}'
...
# s96 # say22003
label soego_s96: # -
    nr '"에… 그 문은 내 개인 방으로 통하는 문이오. 그 방에는 들어가지 마시오."{#soego_s96_1}'
...
label soego_s97: # from 82.4
    nr '"오! 당장 가서 그와 얘기하겠소!"{#soego_s97_1}'
...
# s99 # say22009
label soego_s99: # -
    nr '"불행히도 아니오. 하지만 그렇게 될 가능성은 있소."{#soego_s99_1}'
...
label soego_s100: # from 82.3
    nr '소에고는 잠시 멈춘다. "알겠소." 그는 갑자기 놀라운 변신을 시작한다…{#soego_s100_1}'
...
label soego_s101: # from 73.0
    nr '"어… 당신은 기억력이 나쁜 모양이오. 물론 나는 목을 다쳤소. 하지만 삐었을 뿐 부러진 건 아니오."{#soego_s101_1}'
...
# s102 # say22023
label soego_s102: # -
    nr '그는 초자연적인 속도로 당신 손아귀로부터 벗어난다. 그는 침을 뱉으며 냉소한다 "감히 크래니움 랫 정신 집합체의 대리인을 공격하다니 어리석군!" 그는 갑자기 놀라운 변신을 시작한다…{#soego_s102_1}'
...
label soego_s103: # from 101.1
    nr '"말도 안 되는 질문이오! 당신은 시체안치소의 철판 위에서 깨어났소… 그건 당신 스스로 내게 해준 얘기요. 내 상처도 수집자가 당신을 시체라고 착각하게 만든 상처들보다는 심하지 않았을 것이오, 아니 그렇소?"{#soego_s103_1}'
...
label soego_s104: # from 103.0 103.2 105.0 105.1 106.1 107.0
    nr '그는 어깨를 으쓱한다. "좋소."{#soego_s104_1}'
...
label soego_s105: # from 103.1
    nr '그는 미소짓는다. "모든 사람에게는 제각기 특이한 점이 있기 마련이오. 설마 그걸 부정하겠소?"{#soego_s105_1}'
...
label soego_s106: # from 101.0
    nr '"내가 무엇이냐고? 그건 대체 어떤 종류의 질문이오?"{#soego_s106_1}'
...
label soego_s107: # from 106.0
    nr '소에고는 당신을 노려본다. "나는 당신이 *무슨* 말을 하는지 모르겠소."{#soego_s107_1}'
...
label soego_s108: # - # IF WEIGHT #3 ~  Global("Dustman_Initiation","GLOBAL",5) GlobalLT("Soego","GLOBAL",3) !Global("CR_Vic","GLOBAL",1)
    nr '"아, 또 다른 산 자로군. 지하 묘지의 이토록 깊숙한 곳까지 내려오는 자는 대부분 굴들에게 죽임을 당하는데 당신은 운이 좋소."{#soego_s108_1}'
...
label soego_s109: # from 82.2 108.0 108.1
    nr '"그렇소, 내가 그 사람이오. 나는 더스트맨의 선교사로서 이 곳에 왔소."{#soego_s109_1}'
...
label soego_s111: # from 94.0
    nr '"그렇소, 크래니움 랫의 정신 집합체요. 눈물을 흘리는 돌의 서쪽에 있는 지하 묘지로 가시오. 그 곳에 가면 길을 찾을 수 있을 것이오."{#soego_s111_1}'
...
label soego_s112: # from 79.2 79.3 110.0 110.1
    nr '그는 손을 저어 당신 말을 가로막는다. "아무 것도 아니었소. 나는 이미 수인화의 축복을 받았기 때문에 그런 상처는 금방 나았소."{#soego_s112_1}'
...
label soego_s113: # from 38.1
    nr '"안녕하시오…" 사내는 당신을 향해 몸을 돌린 후 가볍게 인사한다. 당신은 그의 눈이 충혈된 것이라기보다는 약간의 붉은 색조를 띠고 있는 것이라는 사실을 갑자기 깨닫는다. "나는 소에고요. 내가 어떻게 도와드리면 되겠소?"{#soego_s113_1}'
...
label soego_s114: # from 113.0 113.1
    nr '당신이 말을 반쯤 끝냈을 때, 소에고가 갑자기 입을 연다, 그러자 더럽고 날카로운 이빨들이 드러난다. 그는 당신에게 다가와 킁킁거리며 냄새를 맡는다.{#soego_s114_1}'
...
label soego_s115: # from 114.0
    nr '"당신 옷… 이 법복… 냄새가 다르오. 그건 당신 것이 아니오." 소에고는 입가에 기묘한 미소를 띄운다, 그리고 그의 눈은 야수와 같은 눈빛으로 번득인다. "당신은 대체 누구요."{#soego_s115_1}'
