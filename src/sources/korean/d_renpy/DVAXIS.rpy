...
label vaxis_s0: # - # IF ~  Global("Vaxis","GLOBAL",0)
    nr '비틀거리는 시체는 계속 당신을 공허한 눈으로 바라본다. 그의 이마에는 "821" 이라고 새겨져 있으며, 그의 입은 꿰매져 있다. 그의 몸으로부터는 포름알데히드 냄새가 약간 난다.{#vaxis_s0_1}'
...
label vaxis_s1: # from 0.3 # IF ~  False()
    nr '이상하게도 당신 능력은 이 좀비에게는 통용되지 않는다.{#vaxis_s1_1}'
...
label vaxis_s2: # from 1.0
    nr '당신이 좀비의 눈을 찌르자 그는 작은 비명을 지르며 재빨리 손으로 얼굴을 가린다. 그는 작은 소리로 중얼거리기 시작하는데, 그것은 당신이 듣기에는 무슨 욕설 같다.{#vaxis_s2_1}'
...
label vaxis_s3: # from 2.2 5.2
    nr '당신이 돌아서서 떠나려 하자, „좀비“가 뭐라고 중얼거린다… 그는 무슨 얘기를 하려는 것 같으나 그의 입술이 꿰매진 탓에 알아듣기 힘들다. "너 누구? 뭘 원해?"{#vaxis_s3_1}'
...
label vaxis_s4: # from 3.5 6.5 7.8 8.5 10.4 11.4 12.2 13.5 14.4 15.2 16.4 17.2 18.1 19.3 20.1 25.6 27.6 31.6 32.5 34.2 35.6 59.1 74.1 75.3 76.1
    nr '당신이 돌아서서 떠나려 하자, 좀비가 조용히 으르렁거린다. "너 나에 대해 아무 말 하지마. 너 조용히 해. 더스티에게 아무 말도 마." 그는 손가락을 입술에 갖다 댄다. "쉿." 다음에 그는 손가락으로 목을 베는 시늉을 한다. "아니면 잘 때 내가 너 죽인다. 알았어?"{#vaxis_s4_1}'
...
label vaxis_s5: # from 0.0 0.1 0.2 0.4
    nr '당신이 좀비에게 인사를 하자 그는 깜짝 놀라서 눈을 깜박인다. "에? 뭐?"{#vaxis_s5_1}'
...
label vaxis_s6: # from 2.0 2.1 5.0 5.1
    nr '„좀비“는 꿰맨 입술을 가지고 말을 하려고 노력하고 있다. 그는 반은 화나고, 반은 두려워하는 기묘한 표정을 하고 있다. "너 누구? 뭘 원해?"{#vaxis_s6_1}'
...
label vaxis_s7: # from 3.0 3.1 3.2 3.4 6.0 6.1 6.2 6.4
    nr '좀비는 당신 말을 듣지 못한 것 같다. 그는 당신을 잠시 위아래로 살펴보더니 눈살을 찌푸린다. "여기서 뭘 하는 거야?" 그는 의심스럽다는 듯 눈을 좁게 뜬다, "더스티 염탐하는 거야?"{#vaxis_s7_1}'
...
label vaxis_s8: # from 7.2
    nr '그는 당신을 더 골똘히 살핀다, "당신 스파이? 당신 세포의 일원?"{#vaxis_s8_1}'
...
label vaxis_s9: # from 7.3
    nr '그는 당신을 더 골똘히 살핀다, "당신 스파이? 당신 세포의 일원?"{#vaxis_s9_1}'
...
label vaxis_s10: # from 8.0 8.1
    nr '그는 눈살을 찌푸린 후 쉿 소리를 낸다. "너 스파이 아냐!" 그는 저리 가라는 몸짓을 한다. "꺼져!"{#vaxis_s10_1}'
...
label vaxis_s11: # externs morte_s86
    nr '이 말에는 좀비도 고개를 끄덕인다. 당신이 생각하기에 그는 자신의 좀비 변장을 자랑스럽게 생각하고 있는 것 같다.{#vaxis_s11_1}'
...
label vaxis_s12: # from 7.0 11.0
    nr '좀비는 관심이 있는 듯하다. "당신 문제 있어? 무슨 짓 했어?"{#vaxis_s12_1}'
...
label vaxis_s13: # from 12.0
    nr '좀비는 마치 미치광이라도 보는 듯한 눈으로 당신을 본다. "너 미쳤어?"{#vaxis_s13_1}'
...
label vaxis_s14: # from 13.0 13.3 15.0
    nr '그는 당신을 쳐다본 후, 쉿 소리를 내며 저리 가라는 몸짓을 한다. "너 미쳤어! 꺼져!"{#vaxis_s14_1}'
...
label vaxis_s15: # externs morte_s88
    nr '가짜 좀비는 당신들 둘을 의심스러운 눈초리로 쳐다본다.{#vaxis_s15_1}'
...
label vaxis_s16: # from 13.1
    nr '그는 당신을 쳐다본 후, 쉿 소리를 내며 저리 가라는 몸짓을 한다. "너 미쳤어! 바보! 꺼져!"{#vaxis_s16_1}'
...
label vaxis_s17: # from 7.5 10.1 14.1 16.1 25.3 27.3
    nr '그는 잠시 겁에 질린 듯하다, 그러나 당신을 살펴본 후 그는 조소하는 얼굴로 당신을 바라본다. "너 나한테 비밀 말하면 나도 *너*한테 비밀 말해. 난 날 도울 친구 있고, 넌 없어." 넌 여기 있으면 안돼. 더스티는 널 죽여. 난 탈출해."{#vaxis_s17_1}'
...
label vaxis_s18: # from 17.0
    nr '좀비는 눈을 좁게 뜨고 당신에게 야유한다. "네가 날 죽이겠다고? 난 날 도울 친구 있고, 넌 없어. 너 나 건드리면 내 친구 너 죽여"{#vaxis_s18_1}'
...
label vaxis_s19: # from 7.6 10.2 14.2 16.2 25.4 27.4
    nr '그는 잠시 겁에 질린 듯하다, 그러나 당신 체격을 살펴본 후 그는 조소하는 얼굴로 당신을 바라본다. "네가 날 죽이겠다고? 난 날 도울 친구 있고, 넌 없어. 너 나 건드리면 내 친구 너 죽여"{#vaxis_s19_1}'
...
label vaxis_s20: # from 19.2
    nr '좀비는 눈을 좁게 뜨고 당신에게 야유한다. "너 나한테 비밀 말하면 나도 *너*한테 비밀 말해. 난 날 도울 친구 있고, 넌 없어." 넌 여기 있으면 안돼. 더스티는 널 죽여. 난 탈출해."{#vaxis_s20_1}'
...
label vaxis_s21: # from 7.4 10.0 14.0 16.0 19.1 25.2 27.2
    nr '당신 눈 안의 그 무언가가 그의 자신감을 무너트린 것 같다. "아니, 아냐! 경비 부르지 마!" 그는 겁에 질린 듯 하다. "난 더스티 염탐하고 내가 본 것 말할 뿐이야. 그거 뿐이야."{#vaxis_s21_1}'
...
label vaxis_s22: # from 7.7 10.3 14.3 16.3 17.1 25.5 27.5
    nr '"아니, 아냐! 나 해치지 마!" 좀비를 압도하는 당신의 근육이 그의 결정에 영향을 미친 것 같다. "나 해치지 마. 난 더스티 염탐하고 내가 본 것 말할 뿐이야. 그거 뿐이야."{#vaxis_s22_1}'
...
label vaxis_s23: # from 21.0 22.0
    nr '좀비는 겁에 질린 듯 입을 다문다. 그는 더 이상 말을 하려고 하지 않는다.{#vaxis_s23_1}'
...
label vaxis_s24: # from 3.3 6.3 8.2
    nr '"날 찾았어? 왜?" 그는 눈을 가늘게 뜨고 당신을 본다. "나한테 전할 메시지 있어?"{#vaxis_s24_1}'
...
label vaxis_s25: # from 24.2
    nr '화난 듯 쉿 소리를 낸다. "그럼 뭘 원해, 얼간아!"{#vaxis_s25_1}'
...
label vaxis_s27: # from 24.1 26.3 26.4
    nr '그는 화가 난 듯 눈을 좁게 뜬다. "너 심부름꾼 아냐. 너 누구야?"{#vaxis_s27_1}'
...
label vaxis_s28: # from 8.3 8.4 11.1 11.2 11.3 26.0 30.0 43.5
    nr '"난 더스티 염탐하고 내가 본 것 말할 뿐이야. 그거 뿐이야."{#vaxis_s28_1}'
...
label vaxis_s29: # from 21.1 22.1 23.4 28.0 70.1 71.2
    nr '"아무 것도 없어. 그들 아무 일도 안해. 아무 것도 찾을 수 없어. 시체, 시체, 시체 뿐이야. 더스티는 아무 일도 안해." 그는 자신감에 차서 눈을 가늘게 뜬다. "그래도 난 감시해."{#vaxis_s29_1}'
...
label vaxis_s30: # from 26.1 26.2
    nr '그는 이해를 하려고 노력하는 듯 눈을 가늘게 뜬다. "무슨 명령?"{#vaxis_s30_1}'
...
label vaxis_s31: # from 7.1 12.1 13.4 15.1 25.0 27.0 50.0
    nr '그는 잠시 아무 말도 하지 않는다. 그리고 이해했다는 듯 가볍게 고개를 끄덕인다. "왜 내가 너 도와야 하지?"{#vaxis_s31_1}'
...
label vaxis_s32: # from 31.0
    nr '좀비는 조소한다. "모두 뭘 원해, 하지만 아무도 주지 않아. 당신 내게 뭘 주면, 나도 도울지 몰라."{#vaxis_s32_1}'
...
label vaxis_s33: # from 31.2 31.5 32.1 32.4 34.1 35.2 35.5 75.0
    nr '그는 자신이 당신을 처치할 수 있을지 알아보기라도 하듯 당신을 위아래로 살피고 당신 흉터들을 쳐다본 후, 그러지 않기로 결정한다, "흠… 전이문으로 탈출할 수 있어."{#vaxis_s33_1}'
...
label vaxis_s34: # from 31.3 32.2 35.3
    nr '그는 잠시 겁에 질린 듯하다, 그러나 당신을 살펴본 후 그는 조소하는 얼굴로 당신을 바라본다. "너 나한테 비밀 말하면 나도 *너*한테 비밀 말해. 난 날 도울 친구 있고, 넌 없어." 넌 여기 있으면 안돼. 더스티는 널 죽여. 난 탈출해."{#vaxis_s34_1}'
...
label vaxis_s35: # from 30.3 31.1 32.0
    nr '"어 날 위해 열쇠 가져다 줘. 난 쇠로 만든 처리실 열쇠 원해 ."{#vaxis_s35_1}'
...
label vaxis_s36: # from 35.1 58.2
    nr '"더스티 계집이 가지고 있어." 그는 자신의 눈을 가리킨다. "그녀의 눈은 노란색이야…" 다음에 그는 손으로 한 쌍의 가위를 연상시키는 손짓을 한다. "손가락에 칼이 달렸어."{#vaxis_s36_1}'
...
label vaxis_s37: # from 36.3
    nr '좀비는 눈을 깜박인다. 그는 당신 말을 이해하지 못한 듯하다.{#vaxis_s37_1}'
...
label vaxis_s38: # from 36.1 36.2 37.0 37.1
    nr '좀비는 눈을 가늘게 뜨고 당신을 바라본다. "잡혀도 내 얘기 하지 마. 아니면 내가 너 잘 때 죽인다."{#vaxis_s38_1}'
...
label vaxis_s39: # from 43.12
    nr '"나 변장 잘해. 내겐 상처도 있어. 난 향료도 많이 발랐어. 난 좋은 좀비야." 좀비는 꿰맨 입으로 킬킬거리더니 자신의 머리를 가볍게 두드린다. "더스티들은 바보야."{#vaxis_s39_1}'
...
# s40 # say4514
label vaxis_s40: # -
    nr '"난 여기서 기다릴께. 열쇠 가져와." 좀비는 당신에게 역겨운 미소를 짓는다. "그럼 내가 너 도울께."{#vaxis_s40_1}'
...
# s41 # say4517
label vaxis_s41: # -
    nr '좀비는 눈을 크게 뜬다, 그리고 손을 내밀고 손가락을 튕겨 탁 소리를 낸다. "내게 그걸 줘."{#vaxis_s41_1}'
...
label vaxis_s42: # from 35.0 36.0 58.0 58.1
    nr '좀비는 눈을 크게 뜬다, 그리고 당신 손으로부터 열쇠를 채 간다. 그는 계속 고개를 끄덕이며 그것을 돌려본다: "좋아… 좋아."{#vaxis_s42_1}'
...
label vaxis_s44: # from 43.6
    nr '"훠로드?" 좀비는 생각에 잠긴 듯 잠시 눈살을 찌푸린다. "난… 그가 벌통 어딘가에 산다고 들었어." 그는 고개를 젓는다. "정확히 어딘지는 몰라." 그는 다시 눈살을 찌푸린다. "더스티들은 화났어, 그들 훠로드 싫어해."{#vaxis_s44_1}'
...
label vaxis_s46: # from 44.1 45.0
    nr '"그는 수집자야. 시체안치소에 시체를 가져와 더스트맨에게 팔아. 시체를 많이 많이 가져와. 더스티들은 그거 어디서 시체 가져오는지 몰라. 그가 사람들을 죽인다고 생각하는 거 같아."{#vaxis_s46_1}'
...
label vaxis_s47: # from 43.7
    nr '"몰라. 어떤 자식이 널 털었어?"{#vaxis_s47_1}'
...
label vaxis_s48: # from 46.0 47.0
    nr '좀비는 말을 하려다 멈추고, 다시 말을 하려다 어깨를 으쓱한다. 아무래도 그보다 더 명료하게 설명을 할 수가 없는 것 같다.{#vaxis_s48_1}'
...
label vaxis_s49: # from 30.1 42.0 43.0 43.1
    nr '좀비는 툴툴거린다. "전이문으로 탈출할 수 있어." 그는 손을 흔든다. "푹."{#vaxis_s49_1}'
...
label vaxis_s50: # from 33.0 49.0
    nr '"전이문들…" 좀비는 손으로 주변을 가리킨다. "전이문은 모든 곳에 있어."{#vaxis_s50_1}'
...
label vaxis_s51: # from 50.1 50.2 50.3 72.0
    nr '좀비는 고개를 끄덕인다. "나가고 싶으면 1층 북서쪽 방에 있는 아치로 가… 넌 손가락뼈 필요해, 갈고리 모양의." 그는 자신의 집게손가락을 치켜들어 갈고리 모양으로 구부린다. "열쇠를 찾으면 아치를 통해, 비밀 묘지로 간 다음 가기서부터 탈출을 할 수 있어. 비밀 탈출 루트." 그는 열심히 고개를 끄덕인다. "넌 거기서 쉴 수 있어."{#vaxis_s51_1}'
...
label vaxis_s52: # from 43.2
    nr '"잘 듣고 기억하라고!" 좀비는 화난 듯하다. "아치, 1층, 북서쪽…" 그는 자신의 집게손가락을 치켜들어 구부린다. "넌 굽은 손가락뼈 필요해. 너는 비밀 묘지로 가게 돼. 탈출 루트. 거기선 쉴 수가 있어."{#vaxis_s52_1}'
...
label vaxis_s53: # from 43.8
    nr '"서기." 어깨를 으쓱한다. "늙은이."{#vaxis_s53_1}'
...
label vaxis_s54: # from 43.9
    nr '"허?" 눈살을 찌푸린다. "그녀 누구?"{#vaxis_s54_1}'
...
label vaxis_s55: # from 43.10
    nr '"가이드. 시체안치소 장문에 있어. 그로부터 뭘 원해?"{#vaxis_s55_1}'
...
label vaxis_s56: # from 55.0
    nr '"이상하게 행동해. 더스티도 아니고 아나키스트도 아냐. 눈이 변했어…" 어깨를 으쓱한다. "쥐같다고. 이상해."{#vaxis_s56_1}'
...
label vaxis_s57: # - # IF ~  GlobalGT("Vaxis","GLOBAL",0)
    nr '가짜 좀비가 보인다. 당신은 그의 변장에 감탄하지 않을 수 없다… 그의 숨소리는 얼마나 미약한지 거의 눈치채지 못할 정도이다.{#vaxis_s57_1}'
...
label vaxis_s58: # from 57.0 57.1 57.3
    nr '좀비는 주위에 누가 없는 지 살핀 후 당신을 향해 몸을 돌린다. "뭐야?"{#vaxis_s58_1}'
...
label vaxis_s59: # from 57.2
    nr '좀비는 주위에 누가 없는 지 살핀 후, 쉿 소리를 내며 당신에게 딴 데로 가라는 몸짓을 한다 . "꺼져! 꺼지라고!"{#vaxis_s59_1}'
...
label vaxis_s60: # from 43.11
    nr '"나 변장 잘해. 내겐 상처도 있어. 난 향료도 많이 발랐어. 난 좋은 좀비야." 좀비는 꿰맨 입으로 킬킬거리더니 자신의 머리를 가볍게 두드린다. "더스티들은 바보야."{#vaxis_s60_1}'
...
label vaxis_s61: # from 60.0
    nr '좀비는 비꼬아서 한 말이란 눈치채지 못한 모양이다. "바보 같은 더스티들. 난 좋은 좀비야."{#vaxis_s61_1}'
...
label vaxis_s62: # from 60.1 61.0
    nr '그는 당신 흉터들을 바라본다. "나도 같은 질문을 하고 싶은데. 난 별로 아프지 않아." 그는 자기 가슴을 두드린다. "나 튼튼해."{#vaxis_s62_1}'
...
label vaxis_s63: # from 43.3 43.4 60.2 61.1 62.0 64.1 64.2
    nr '그는 몇 초 동안 당신을 위아래로 살핀다, 그리고 스스로에게 뭐라고 중얼거린 다음 고개를 끄덕인다. "어. 향료 한 단지가 필요해." 그는 당신 가슴에 난 흉터들을 가리킨다. "그리고 바늘과 실도 좀 필요해."{#vaxis_s63_1}'
...
label vaxis_s64: # from 61.2 61.3 62.1 62.2
    nr '그는 기묘한 표정으로 당신을 위아래로 살핀다. "넌 좋은 좀비가 되겠어. 난 너 좀비로 만들어 줄 수 있어. 좋은 변장."{#vaxis_s64_1}'
...
label vaxis_s65: # from 63.0
    nr '좀비는 당신으로부터 아이템들을 받은 후 작업을 개시한다…{#vaxis_s65_1}'
...
label vaxis_s66: # from 65.0 65.2 65.3
    nr '좀비는 당신 몸에 향료를 잔뜩 바른 후 당신의 흉터 여러 곳을 꿰맨다. 그는 발로부터 시작하여 위쪽으로 올라가며 당신 흉터들을 꿰맨 다음, 당신 입술을 꿰매어 변장을 완성시킨다.{#vaxis_s66_1}'
...
label vaxis_s67: # from 66.0 66.2
    nr '좀비는 손을 치켜 올린다. "조심해! 말을 하면 꿰맨 곳이 터져 변장을 망쳐! 좀비는 말 안 해. 할 말이 있으면 천천히 조심스럽게 해."  주: 아무도 좀비가 말하리라고는 생각하지 않는다. 만약 좀비로 변장한 채 다른 사람에게 말을 걸면 변장이 탄로날 위험이 있다.{#vaxis_s67_1}'
...
label vaxis_s68: # from 67.0
    nr '좀비는 눈살을 찌푸린다. "변장은 오래 가지 않아… 향료는 말라 버리고 꿰맨 실들도 떨어져 나가." 그는 어깨를 으쓱한다. "아마 시체안치소 밖까지 유지되지는 못할 거야. 그리고 달리지 마! 달리면 변장을 다 망쳐."  주: 무기를 장비하거나 달리면 변장은 즉시 무효화된다. 새로운 무기를 발견하더라도 변장을 해제하고 싶을 때까지 장비를 미루는 것이 좋다. 만약 뛰어서 이동하는 것이 기본 설정으로 되어 있다면, 백시즈에게 변장을 부탁하기 전에 설정을 변경해야 한다.{#vaxis_s68_1}'
...
# s69 # say4641
label vaxis_s69: # -
    nr '„좀비“는 눈살을 찌푸린다. "넌 낯이 익어. 내가 전에 너 본 적 있어?"{#vaxis_s69_1}'
...
label vaxis_s70: # from 23.0 23.2 71.0 71.1
    nr '놀랍게도 좀비는 당신으로부터 고개를 돌린다… 그는 두려운 듯한 눈빛으로 주변을 살피기 시작한다.{#vaxis_s70_1}'
...
label vaxis_s71: # externs morte_s90
    nr '좀비는 당신들 둘을 두려운 눈빛으로 바라보고 있다. 그는 아직도 조용하다… 그의 표정으로 미루어 볼 때 모트의 추측이 맞는 것 같다.{#vaxis_s71_1}'
...
label vaxis_s72: # from 30.2
    nr '좀비는 실망한 듯하다, 그러나 그는 어깨를 으쓱한 다음 자신의 얼룩진 튜닉에 손을 집어 넣고 뒤적거리기 시작한다. "조용했어. 더스티들은 조용했어. 지난번 보고 이후 새로운 건 아무 것도 없어." 잠시 후 그는 툴툴거리면서 당신에게 몇 개의 아이템을 넘겨 준다. "여기 있어." 냄새를 미루어 볼 때 그것들은 수색을 받더라도 발견되지 않을 곳에 감추러 두었던 것 같다. "난 조금 있다가 떠날 거야."{#vaxis_s72_1}'
...
# s73 # say4658
label vaxis_s73: # -
    nr '좀비는 툴툴거린다. "전이문은 아치야, 1층 북쪽 방에 있는. 열려면 스켈레톤 손가락뼈가 필요해." 그는 고개를 끄덕인다. "잘 해봐."{#vaxis_s73_1}'
...
label vaxis_s74: # from 34.0
    nr '좀비는 눈을 좁게 뜨고 당신에게 야유한다. "네가 날 죽이겠다고? 난 날 도울 친구 있고, 넌 없어. 너 나 건드리면 내 친구 너 죽여"{#vaxis_s74_1}'
...
label vaxis_s75: # from 31.4 32.3 35.4
    nr '그는 잠시 겁에 질린 듯하다, 그러나 당신 체격을 살펴본 후 그는 조소하는 얼굴로 당신을 바라본다. "네가 날 죽이겠다고? 난 날 도울 친구 있고, 넌 없어. 너 나 건드리면 내 친구 너 죽여"{#vaxis_s75_1}'
...
label vaxis_s76: # from 75.1
    nr '좀비는 눈을 좁게 뜨고 당신에게 야유한다. "너 나한테 비밀 말하면 나도 *너*한테 비밀 말해. 난 날 도울 친구 있고, 넌 없어." 넌 여기 있으면 안돼. 더스티는 널 죽여. 난 탈출해."{#vaxis_s76_1}'
...
label vaxis_s77: # from 51.0
    nr '그는 어깨를 으쓱한다. "어딘가 있을 거야… 위층의 저장실에 가봐. 아마 거기 있을지도."{#vaxis_s77_1}'
