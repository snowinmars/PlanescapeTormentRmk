...
label zf114_s0: # - # IF ~  True()
    nr '당신이 다가가자 이 여자 시체는 걸음을 멈춘다. 그녀의 이마에는 "114"란 번호가 새겨져 있다. 그녀의 입은 실로 꿰매어져 닫혀 있다. 그러나 실은 천천히 풀리기 시작하고 시작하고 있으며, 그녀의 입술 사이로부터는 작은 신음 소리가 새어 나오고 있다.{#zf114_s0_}'
...
label zf114_s2: # from 0.3
    nr '시체는 아무런 응답을 하지 않는다. 당신의 질문에 대답할 수 있을 정도의 정신은 이미 그것에게는 남아있지 않는 듯하다.{#zf114_s2_}'
...
label zf114_s3: # - # IF ~  False()
    nr '시체는 아무런 응답을 하지 않는다. 당신의 질문에 대답할 수 있을 정도의 정신은 이미 그것에게는 남아있지 않는 듯하다.{#zf114_s3_}'
