...
label zf1148_s0: # - # IF ~  True()
    nr '이 여자 시체의 피부는 복잡한 패턴의 문신들로 뒤덮여 있다. 그녀의 이마의 피부는 그 아래에 있는 두개골에 "1148"이라는 번호를 새기기 위해 벗겨져 있다. 그녀의 입은 굵고 거친 실로 꿰매져 있다.{#zf1148_s0_1}'
...
label zf1148_s1: # from 0.0 0.1 0.2
    nr '시체는 계속 당신을 쳐다본다.{#zf1148_s1_1}'
...
label zf1148_s2: # from 0.3
    nr '시체는 아무런 응답을 하지 않는다. 당신의 질문에 대답할 수 있을 정도의 정신은 이미 그것에게는 남아있지 않는 듯하다.{#zf1148_s2_1}'
...
label zf1148_s3: # - # IF ~  False()
    nr '시체는 아무런 응답을 하지 않는다. 당신의 질문에 대답할 수 있을 정도의 정신은 이미 그것에게는 남아있지 않는 듯하다.{#zf1148_s3_1}'
