...
label zf679_s0: # - # IF ~  True()
    nr '이것은 고령의 노파의 좀비인 것 같다. 향료의 냄새, 꿰맨 입술, 그리고 오른쪽 볼에 새긴 "679"란 번호만 제외한다면 그녀의 죽기 전 모습도 지금과 별로 다르지 않았을 것 같다.{#zf679_s0_1}'
...
label zf679_s2: # from 0.3
    nr '시체는 아무런 응답을 하지 않는다. 당신의 질문에 대답할 수 있을 정도의 정신은 이미 그것에게는 남아있지 않는 듯하다.{#zf679_s2_1}'
...
label zf679_s3: # - # IF ~  False()
    nr '시체는 아무런 응답을 하지 않는다. 당신의 질문에 대답할 수 있을 정도의 정신은 이미 그것에게는 남아있지 않는 듯하다.{#zf679_s3_1}'
