...
label zf916_s0: # - # IF ~  True()
    nr '이 여자 시체는 계속 당신을 공허한 눈으로 바라본다. 그녀의 이마에는 "916" 이라고 새겨져 있으며, 그녀의 입은 꿰매져 있다. 그녀의 몸으로부터는 포름알데히드 냄새가 약간 난다.{#zf916_s0_}'
...
label zf916_s2: # from 0.3
    nr '시체는 아무런 응답을 하지 않는다. 당신의 질문에 대답할 수 있을 정도의 정신은 이미 그것에게는 남아있지 않는 듯하다.{#zf916_s2_}'
...
label zf916_s3: # - # IF ~  False()
    nr '시체는 아무런 응답을 하지 않는다. 당신의 질문에 대답할 수 있을 정도의 정신은 이미 그것에게는 남아있지 않는 듯하다.{#zf916_s3_}'
