...
label zm1445_s0: # - # IF ~  True()
    nr '이 시체는 심하게 손상되어 있다. 귀, 콧등, 그리고 심지어는 손가락 몇 개까지 썩어서 없어졌다… 죽기 전에 끔찍한 병을 앓았던 것 같다. 이마에는 "1445"이란 번호가 새겨져 있으며 입은 꿰매져 있다.{#zm1445_s0_1}'
...
label zm1445_s1: # from 0.0 0.1 0.2
    nr '시체는 계속 당신을 쳐다본다.{#zm1445_s1_1}'
...
label zm1445_s2: # from 0.3
    nr '시체는 아무런 응답을 하지 않는다. 당신의 질문에 대답할 수 있을 정도의 정신은 이미 그것에게는 남아있지 않는 듯하다.{#zm1445_s2_1}'
