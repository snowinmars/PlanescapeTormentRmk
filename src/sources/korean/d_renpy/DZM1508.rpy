...
label zm1508_s0: # - # IF ~  True()
    nr '이 우락부락하게 생긴 시체의 이마는 생전에 박치기가 주된 공격수단이었던 듯 흉터투성이다. 이마에는 "1508"이란 번호가 붉은 실로 꿰매져 있으며 입은 거친 검은색 실로 꿰매져 있다. 그로부터는 향료 냄새가 희미하게 난다.{#zm1508_s0_1}'
...
label zm1508_s1: # from 0.0 0.1 0.2
    nr '시체는 계속 당신을 쳐다본다.{#zm1508_s1_1}'
...
label zm1508_s2: # from 0.3
    nr '시체는 아무런 응답을 하지 않는다. 당신의 질문에 대답할 수 있을 정도의 정신은 이미 그것에게는 남아있지 않는 듯하다.{#zm1508_s2_1}'
