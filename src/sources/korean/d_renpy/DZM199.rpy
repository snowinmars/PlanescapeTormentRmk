...
label zm199_s0: # - # IF ~  True()
    nr '이 걸어다니는 시체로부터는 탄 고기와 섬유의 냄새가 난다. 시체의 측면 전체에 걸쳐 비교적 새로운 화상이 나 있다. 아마 불 너무 가까이 서 있었던 탓에 타버린 것 같다. 이마에는 "199"란 번호가 새겨져 있으며, 입술은 꿰매어져 있다.{#zm199_s0_}'
...
label zm199_s2: # from 0.3
    nr '시체는 아무런 응답을 하지 않는다. 당신의 질문에 대답할 수 있을 정도의 정신은 이미 그것에게는 남아있지 않는 듯하다.{#zm199_s2_}'
