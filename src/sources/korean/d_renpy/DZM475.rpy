...
label zm475_s0: # - # IF ~  True()
    nr '이 시체의 머리는 여러 개의 얇은 철판을 볼트로 해골에 직접 덧대 놓은 기형적인 모습을 하고 있다. 왼쪽 눈을 덮고 있는 녹슨 철판에는 "475"라는 숫자가 새겨져 있다. 볼트로 굳게 닫아 놓은 입에서는 방부제의 악취가 나고 있다.{#zm475_s0_}'
...
label zm475_s2: # from 0.3
    nr '시체는 아무런 응답을 하지 않는다. 당신의 질문에 대답할 수 있을 정도의 정신은 이미 그것에게는 남아있지 않는 듯하다.{#zm475_s2_}'
