...
label zm613_s0: # - # IF ~  True()
    nr '이 터벅터벅 걷는 좀비의 이마에는 "613"이라는 번호가 깊숙이 새겨져 있다, 하지만 "1"과 "3"사이에는 2.5 cm 정도 길이의 가죽질의 피부조각이 있다. 자세히 보니 거기에 새겨진 "2"라는 숫자가 간신히 보인다.{#zm613_s0_1}'
...
label zm613_s2: # from 0.3
    nr '시체는 아무런 응답을 하지 않는다. 당신의 질문에 대답할 수 있을 정도의 정신은 이미 그것에게는 남아있지 않는 듯하다.{#zm613_s2_1}'
