...
label zm79_s0: # - # IF ~  True()
    nr '이 시체의 살이 많이 붙어 있는 대가리는 과거 어느 시점에서 잘려 나가 실로 급하게 꿰매서 붙여 놓은 것이 틀림없다. 여러 종류의 꿰맨 자국들이 있고, 또 실이 풀어진 정도가 각기 다른 것으로 미루어 볼 때, 이 시체의 머리는 작업 중에 여러 번 떨어져 나갔고, 그 때마다 꿰매어 봉합했던 것 같다. 시체의 관자놀이에는 "79"란 번호가 새겨져 있으며, 그것은 이빨 달린 원에 의해 둘러싸여 있다. 원은 시체의 이마에 낙인으로 찍힌 것 같다.{#zm79_s0_}'
...
label zm79_s2: # from 0.3 3.0 3.1
    nr '시체는 아무런 응답을 하지 않는다. 당신의 질문에 대답할 수 있을 정도의 정신은 이미 그것에게는 남아있지 않는 듯하다.{#zm79_s2_}'
...
label zm79_s3: # from 0.1
    nr '이빨 달린 원은 시체의 이마에 오래 전, 그것도 아마 그가 죽기 전에 찍혀진 것 같다. 그것은 종교적인 상징이거나 어떤 통과 의례의 징표인지도 모른다. 당신은 안쪽의 이빨들 사이의 움푹 들어간 곳들 중 한 곳에는 무슨 특별한 의미가 있는 것처럼 작은 삼각형이 있다는 사실을 발견한다.{#zm79_s3_}'
