...
label zm965_s0: # - # IF ~  NearbyDialog("Dmorte")
    nr '이 시체는 삼각형을 그리며 움직이고 있다. 시체는 삼각형의 한 모퉁이에 도달하면 일단 잠시 멈춘다, 그리고 방향을 바꾸어 다음 모퉁이로 향한다. 그것의 해골 옆머리에는 "965"라는 문신이 새겨져 있다. 당신이 다가가자 시체는 걸음을 멈추고 당신을 쳐다본다.{#zm965_s0_}'
...
label zm965_s1: # externs morte_s481 morte_s480 # IF ~  !NearbyDialog("Dmorte")
    nr '이 시체는 삼각형을 그리며 움직이고 있다. 시체는 삼각형의 한 모퉁이에 도달하면 일단 잠시 멈춘다, 그리고 방향을 바꾸어 다음 모퉁이로 향한다. 그것의 해골 옆머리에는 "965"라는 문신이 새겨져 있다. 당신이 다가가자 시체는 걸음을 멈추고 당신을 쳐다본다.{#zm965_s1_}'
...
label zm965_s3: # from 1.3
    nr '시체는 움직이지 않는다. 당신의 질문에 대답할 정도의 정신은 이제 그것에게는 남아있지 않은 것 같다.{#zm965_s3_}'
