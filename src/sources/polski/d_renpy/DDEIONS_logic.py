class DeionarraLogic:
    ...
    def j26087_s29_r810_action(self):
        ...
        #$% .register('26087', 'Spotkałem ducha kobiety o imieniu Deionarra, która przepowiedziała mi spotkanie z trzema wrogami, lecz "nie bardziej niebezpiecznymi niż ja w pełni chwały". Są to cienie zła, dobra i neutralności, obdarzone życiem i pozmieniane przez prawa sfer. Powiedziała mi także, że pójdę do więzienia zbudowanego z "żalu i cierpienia" gdzie "cienie zatraciły się w szaleństwie". Tam zostanę poproszony o straszliwe poświęcenie... aby wszystko się zakończyło, muszę "zniszczyć to co utrzymuje mnie przy życiu i przestać być nieśmiertelnym."') %$#
    ...
    def j68117_s68_r63415_action(self):
        ...
        #$% .register('68117', 'Deionarra ostrzegła mnie, że w pobliżu wejścia do Fortecy znajduje się wielki przedsionek, gdzie zamieszkują cienie. Powiedziała, że w komnacie tej znajduje się wiele ogromnych zegarów, które, wedle moich słów z poprzedniego żywota, pozwolą mi w jakiś sposób na wydostanie się z przedsionka. Muszę sobie to zakonotować, a kiedy trafię na tego zegary, skrupulatnie je sprawdzić.') %$#
    ...
    def r66914_action(self):
        ...
        #$%.register('66917', 'Nie wiem, czy powinienem czuć lęk, czy też dumę... W rozmowie z duchem Deionarry w krypcie Kostnicy dowiedziałem się, że moje ciągłe zgony dały mi coś w rodzaju władzy nad życiem i śmiercią. Potrafię mianowicie dostrzec w zwłokach dogasające ogniki życia i rozbudzić je z powrotem. Z jakiegoś powodu ze zdolności takich mogę skorzystać jedynie w odniesieniu do istot, które towarzyszą mi w mojej włóczędze, a przy tym jedynie wówczas, gdy umierają w mojej obecności... Ciekawe czemu? Czyżby fakt odbywania wspólnych podróży miałby w jakiś sposób wiązać mnie duchowo z moimi kompanami? %$#')
