...
label s42_s0: # - # IF ~  True()
    nr 'Szkielet odwraca się do ciebie. Na czole wyryto mu liczbę "42", a wiele kości, zwłaszcza przy żuchwie i stawach, związano skórzanymi paskami. Jego ubranie stanowi czarny kaftan.{#s42_s0_}'
...
label s42_s1: # from 0.0 0.1 0.2 0.3 0.9 3.0 3.3
    nr 'Na dźwięk twojego głosu szkielet nagle się prostuje. Składa ręce na klatce piersiowej, a jego palce wpijają się w żebra.{#s42_s1_}'
...
label s42_s2: # from 0.4
    nr 'Szkielet nic nie odpowiada. Wygląda na to, że jest już martwy zbyt długo, żeby odpowiadać na twoje pytania.{#s42_s2_}'
...
label s42_s3: # from 0.5 10.2
    nr 'To zadziwiające, że ta kupa kości jeszcze się nie rozpadła. Pożółkły szkielet pokryto gipsem i kilkoma warstwami cuchnącego kleju… A nieliczne wystające kawałki kości pokryte są setkami małych pęknięć. Choć ktoś powiązał to wszystko za pomocą skórzanych pasków i żelaznych nitów, to skóra jest już przetarta, a nity wyglądają, jakby miały za chwilę powypadać.{#s42_s3_}'
...
label s42_s4: # from 1.0 12.0
    nr 'W odpowiedzi szkielet opuszcza ręce. Skórzane pasy obwiązujące jego klatkę pękają, a klatka piersiowa otwiera się jak podwójne wrota.{#s42_s4_}'
...
label s42_s5: # from 4.0 9.0
    nr 'Ku twojemu zdumieniu, kiedy sięgasz do wnętrz klatki piersiowej, twoja ręka znika… Masz dziwne wrażenie, że ona jest w jakimś *innym* miejscu. W końcu natrafiasz na jakiś niewidzialny przedmiot wielkości pięści, który przymocowano do kręgosłupa szkieletu.{#s42_s5_}'
...
label s42_s6: # from 0.7 0.8 3.2
    nr 'Nity z łatwością wysuwają się ze stawów. Szkielet pada na ziemię, choć niektóre kości ciągle jeszcze drżą.{#s42_s6_}'
...
label s42_s7: # from 5.0
    nr 'Kiedy wyciągasz tajemniczy przedmiot, szkielet nagle się rozpada, a żelazne nity spadają z brzdękiem na ziemię. Wygląda na to, że tylko ten przedmiot trzymał kości w kupie.{#s42_s7_}'
...
label s42_s8: # from 7.0 7.1
    nr 'Przedmiot przypomina niepozorną bryłę żelaza. Zastanawiasz się, dlaczego ktoś miałby ukrywać coś takiego wewnątrz klatki piersiowej szkieletu.{#s42_s8_}'
...
label s42_s9: # from 1.1 12.1
    nr 'W odpowiedzi szkielet opuszcza ręce. Skórzane pasy obwiązujące jego klatkę pękają, a klatka piersiowa otwiera się jak podwójne wrota. Nie wiedząc czemu, nagle nachodzi cię chęć sięgnięcia do wewnątrz.{#s42_s9_}'
...
label s42_s10: # from 1.2 12.2
    nr 'Ręce szkieletu opadają na boki.{#s42_s10_}'
...
# s11 # say6606
label s42_s11: # -
    nr 'Przedmiot przypomina niepozorną bryłę żelaza. Twoje wcześniejsze wcielenie musiało mieć jakiś powód, żeby ją tam ukryć.{#s42_s11_}'
...
label s42_s12: # from 10.0
    nr 'Szkielet znowu krzyżuje ręce na piersi.{#s42_s12_}'
...
label s42_s13: # from 10.1
    nr 'Szkielet znowu krzyżuje ręce na piersi.{#s42_s13_}'
...
label s42_s14: # from 8.0 11.0
    nr 'Kiedy ujmujesz bryłę obiema rękami, żeby się jej lepiej przyjrzeć, nagle do twoich uszu dochodzi *ssssssssss* i metal znika. W dłoniach zostaje ci sztylet, trochę monet zawiniętych w brudną szmatkę i dwie krwawe łzy - wygląda na to, że te rzeczy znajdowały się *wewnątrz* bryły.{#s42_s14_}'
