class SoegoLogic:
    ...
    def j63982_s1_r1438_action(self):
        ...
        #$% .register('63982', 'U frontowej bramy Kostnicy spotkałem Grabarza o imieniu Soe. Wyglądał na nieco zmęczonego, jak gdyby nie zaznał snu od długich tygodni. Sądząc z jego oczu i nienaturalnej bladości ciała, musi cierpieć na jakąś chorobę.') %$#
    ...
    def j21805_s71_r21800_action(self):
        ...
        #$% .register('21805', 'Soe powiedział, abym nie atakował żadnych mieszkańców Ziem Umarłych, gdyż nie skrzywdzą mnie tak długo, dopóki sam będę zachowywał się pokojowo.') %$#
    ...
    def r21852_action(self):
        ...
        #$%.register('21856', 'Znalazłem Soego. Został zarażony likantropią, która przywiodła go do katakumb. Jego umysł nie należał już do niego, a jego poglądy Grabarza zniknęły. %$#')
    ...
    def r21853_action(self):
        ...
        #$%.register('21857', 'Soe powiedział mi, że nie wie jak się dostać do sali tronowej Milczącego Króla. Będę to jednak musiał uczynić, jeśli zamierzam zabić władcę. %$#')
    ...
    def r21915_action(self):
        ...
        #$%.register('21926', 'Pokazałem Soemu, że znam treść jego dziennika, a on zmienił się szczurołaka i zaatakował mnie. %$#')
    ...
    def j25254_s94_r25248_action(self):
        ...
        #$% .register('25254', 'Powiedziałem Soemu, że Milczący Król nie jest już niczym więcej aniżeli pomarszczonymi zwłokami. Stwierdził, że powinienem powiadomić o tym Wielojedność, i że zostanę za to nagrodzony. Wielojedność to zbiorowa świadomość czaszkoszczurów w Labiryntach Myśli, na południe od katakumb Łkających Kamieni.') %$#
    ...
    def j21996_s94_r21994_action(self):
        ...
        #$% .register('21996', 'Powiedziałem Soemu, że Milczący Król nie jest już niczym więcej aniżeli pomarszczonymi zwłokami. Będę musiał osobiście poinformować o tym Wielojedność gdy tylko nadarzy się okazja.') %$#
    ...
    def r22051_action(self):
        ...
        #$%.register('22052', 'Znalazłem Soego. Odkrył grupę nieumarłych strażników, którzy pilnują katakumb. Próbuje ich przekonać by przyjęli Prawdziwą Śmierć. %$#')
