class VaxisLogic:
    ...
    def j64513_s2_r464_action(self):
        ...
        #$% .register('64513', 'Jeden z zombie na pierwszym piętrze Kostnicy był facetem w przebraniu. Nie jest w stanie zrozumieć, kto i w jakim celu miałby przebierać za zombie!') %$#
    ...
    def r4469_action(self):
        ...
        #$%.register('64517', 'Powiedziałem szpiegowi w przebraniu zombie, że przybyłem tutaj, aby go "zluzować", a wówczas on przekazał mi wszystko, co posiadał, głównie mnóstwo bandaży i przedmiotów leczniczych, które zapewne były dla niego nieodzowne dla podtrzymywania charakteryzacji. %$#')
    ...
    def j64519_s36_r64520_action(self):
        ...
        #$% .register('64519', 'W zamian za pomoc, zgodziłem się wydostać dla fałszywego zombie klucz do balsamowni, znajdujący się w posiadaniu kobiety, którą wcześniej spotkałem w sąsiedniej komnacie, zdaje się, że miała na imię Ei-Vene. Zachodzę tylko w głowę, jak ktoś o dłoniach z ostrzy może posługiwać się kluczem, nie mówiąc już o balsamie.') %$#


    def j64518_s36_r4503_action(self):
        self.state_manager.journal_manager.update_journal('64518')
        #$% .register('64518', 'W zamian za pomoc, zgodziłem się wydostać dla fałszywego zombie klucz do balsamowni, znajdujący się w posiadaniu Grabarki o żółtych oczach i ostrzach zamiast dłoni.') %$#
    ...
    def r4521_action(self):
        ...
        #$%.register('64521', 'Zdobyłem dla Vaxisa "drogocenny" klucz do balsamowni. Był on dla niego nieodzowny do zdobycia nowych środków dla utrzymania swojej charakteryzacji. Przynajmniej tak można sądzić z zapachu płynu do balsamowania, jaki roztaczał wokół siebie fałszywy zombie. %$#')
    ...
    def j64522_s44_r4539_action(self):
        ...
        #$% .register('64522', 'Wygląda na to, że Grabarze i Farod nie przepadają za sobą... Vaxis powiedział mi, że Farod przekazuje do Kostnicy masy zwłok, a Grabarze podejrzewają, że Farod zwiększa sobie obroty, dokonując masowych mordów.') %$#
    ...
    def r64527_action(self):
        ...
        #$%.register('64528', 'Vaxis zdradził mi, że w północno-zachodniej komnacie na parterze Kostnicy znajduje się sekretny portal. Wystarczy udać się tam i unieść w górę skrzywioną kostkę z palca kościotrupa, a portal otworzy się i przeniesie mnie do sekretnej krypty, gdzie, wedle słów, Vaxisa, można "zażyć odpoczynku". Niemniej jednak Vaxis nie wie, gdzie można znaleźć krzywą kostkę z palca. Zasugerował jedynie, abym poszukał jej na górnym poziomie Kostnicy. %$#')
    ...
    def r4568_action(self):
        ...
        #$%.register('64529', 'Vaxis zdradził mi, że w północno-zachodniej komnacie na parterze Kostnicy znajduje się sekretny portal. Wystarczy udać się tam i unieść w górę skrzywioną kostkę z palca kościotrupa, a portal otworzy się i przeniesie mnie do sekretnej krypty, gdzie, wedle słów, Vaxisa, można "zażyć odpoczynku". %$#')
    ...
    def r4580_action(self):
        ...
        #$%.register('64530', 'Vaxis powiedział coś o dziwnym zachowaniu Soego. Fałszywy zombie wyraził się, że Grabarz ten lubi "szczury", albo przynajmniej tak to zrozumiałem. Nie wiem co myśleć o osobniku, który nawet w oczach Vaxisa jest dziwny. To wszystko... bardzo dziwne. %$#')
    ...
    def j64531_s67_r4638_action(self):
        ...
        #$% .register('64531', 'W zamian za garść igieł i nici oraz pewną ilość płynu balsamującego, Vaxis przebrał mnie za zombie. Ostrzegł mnie wszakże, żebym unikał biegania, bo w ten sposób moje przebranie szybko straci na wiarygodności. Nie powinienem też wdawać się w rozmowy z napotkanymi istotami, bo jak Vaxis stwierdził: "zombie głosu nie mają."') %$#
