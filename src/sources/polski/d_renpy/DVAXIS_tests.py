...
class VaxisLogicTest(LogicTest):
    ...
    def test_r480_action(self):
        ...
        self.state_manager.world_manager.set_vaxis_value(vaxis_value_before)
        note_id = '64513'

        self.assertEqual(self.state_manager.world_manager.get_vaxis_value(), vaxis_value_before)
        self.assertFalse(self.state_manager.journal_manager.found_journal_note(note_id))

        self.logic.r480_action()

        self.assertEqual(self.state_manager.world_manager.get_vaxis_value(), vaxis_value_after)
        self.assertTrue(self.state_manager.journal_manager.found_journal_note(note_id))

        self.logic.r480_action()

        self.assertEqual(self.state_manager.world_manager.get_vaxis_value(), vaxis_value_after_once)
        self.assertTrue(self.state_manager.journal_manager.found_journal_note(note_id))
