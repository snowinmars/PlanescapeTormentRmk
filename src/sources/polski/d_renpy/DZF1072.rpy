...
label zf1072_s0: # - # IF ~  True()
    ...
    menu:
        ...
        '"Ta to chyba widywała już lepsze czasy…"{#zf1072_s0_r35132}' if zf1072Logic.r35132_condition():
            # a1 # r35132
            jump zf1072_s1

        '"Przecież wiem, że nie jesteś zombie. Nikogo nie oszukasz."{#zf1072_s0_r35133}' if zf1072Logic.r35133_condition():
            # a2 # r35133
            jump zf1072_s1

        'Posłuż się swoją umiejętnością Gadaj-Kości-Opowieści.{#zf1072_s0_r35134}' if zf1072Logic.r35134_condition():
            # a3 # r35134
            jump zf1072_s2

        '"Miło było z tobą pogadać. Żegnaj."{#zf1072_s0_r35139}' if zf1072Logic.r35139_condition():
            # a4 # r35139
            jump morte_s346  # EXTERN

        'Zostaw truposza w spokoju.{#zf1072_s0_r35140}' if zf1072Logic.r35140_condition():
            # a5 # r35140
            jump morte_s346  # EXTERN

        '"Miło było z tobą pogadać. Żegnaj."{#zf1072_s0_r35141}' if zf1072Logic.r35141_condition():
            # a6 # r35141
            jump zf1072_dispose

        'Zostaw truposza w spokoju.{#zf1072_s0_r35142}' if zf1072Logic.r35142_condition():
            # a7 # r35142
            jump zf1072_dispose

        '"Miło było z tobą pogadać. Żegnaj."{#zf1072_s0_r35143}' if zf1072Logic.r35143_condition():
            # a8 # r35143
            jump zf1072_dispose

        'Zostaw truposza w spokoju.{#zf1072_s0_r35144}' if zf1072Logic.r35144_condition():
            # a9 # r35144
            jump zf1072_dispose
...
label zf1072_s1: # from 0.0 0.1 0.2
    ...
    menu:
        ...
        '"A zatem żegnaj."{#zf1072_s1_r35130}' if zf1072Logic.r35130_condition():
            # a11 # r35130
            jump zf1072_dispose

        '"A zatem żegnaj."{#zf1072_s1_r35131}' if zf1072Logic.r35131_condition():
            # a12 # r35131
            jump zf1072_dispose
...
label zf1072_s2: # from 0.3
    ...
    menu:
        ...
        '"A zatem żegnaj."{#zf1072_s2_r35137}' if zf1072Logic.r35137_condition():
            # a14 # r35137
            jump zf1072_dispose

        '"A zatem żegnaj."{#zf1072_s2_r35138}' if zf1072Logic.r35138_condition():
            # a15 # r35138
            jump zf1072_dispose
