...
label zf444_s0: # - # IF ~  True()
    ...
    menu:
        ...
        '"Więc jak… masz jakieś plany na później?"{#zf444_s0_r35228}' if zf444Logic.r35228_condition():
            # a1 # r35228
            jump zf444_s1

        '"Przecież wiem, że nie jesteś zombie. Nikogo nie oszukasz."{#zf444_s0_r35229}' if zf444Logic.r35229_condition():
            # a2 # r35229
            jump zf444_s1

        'Posłuż się swoją umiejętnością Gadaj-Kości-Opowieści.{#zf444_s0_r35230}' if zf444Logic.r35230_condition():
            # a3 # r35230
            jump zf444_s2

        '"Miło było z tobą pogadać. Żegnaj."{#zf444_s0_r35235}' if zf444Logic.r35235_condition():
            # a4 # r35235
            jump morte_s358  # EXTERN

        'Zostaw truposza w spokoju.{#zf444_s0_r35236}' if zf444Logic.r35236_condition():
            # a5 # r35236
            jump morte_s358  # EXTERN

        '"Miło było z tobą pogadać. Żegnaj."{#zf444_s0_r35237}' if zf444Logic.r35237_condition():
            # a6 # r35237
            jump zf444_dispose

        'Zostaw truposza w spokoju.{#zf444_s0_r35238}' if zf444Logic.r35238_condition():
            # a7 # r35238
            jump zf444_dispose

        '"Miło było z tobą pogadać. Żegnaj."{#zf444_s0_r35239}' if zf444Logic.r35239_condition():
            # a8 # r35239
            jump zf444_dispose

        'Zostaw truposza w spokoju.{#zf444_s0_r35240}' if zf444Logic.r35240_condition():
            # a9 # r35240
            jump zf444_dispose
...
label zf444_s1: # from 0.0 0.1 0.2
    ...
    menu:
        ...
        '"A zatem żegnaj."{#zf444_s1_r35226}' if zf444Logic.r35226_condition():
            # a11 # r35226
            jump zf444_dispose

        '"A zatem żegnaj."{#zf444_s1_r35227}' if zf444Logic.r35227_condition():
            # a12 # r35227
            jump zf444_dispose
...
label zf444_s2: # from 0.3
    ...
    menu:
        ...
        '"A zatem żegnaj."{#zf444_s2_r35233}' if zf444Logic.r35233_condition():
            # a14 # r35233
            jump zf444_dispose

        '"A zatem żegnaj."{#zf444_s2_r35234}' if zf444Logic.r35234_condition():
            # a15 # r35234
            jump zf444_dispose
