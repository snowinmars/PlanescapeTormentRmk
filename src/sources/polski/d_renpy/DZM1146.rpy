...
label zm1146_s0: # - # IF ~  Global("Crispy","GLOBAL",0)
    nr 'Na czole tego chodzącego trupa wyryto numer "1146", zaś usta zszyto mu grubymi, czarnymi nićmi. Całe jego ciało pokrywają blizny - gorsze nawet od twoich własnych - jak gdyby jego posiadacz spłonął żywcem. Trup nie ma nosa, uszu i kilku palców, przypuszczalnie zwęglonych w jakiejś pożodze bardzo dawno temu. Gdy blokujesz jego drogę, aby zwrócić na siebie uwagę, trup zatrzymuje się i patrzy na ciebie nic nie widzącym wzrokiem.{#zm1146_s0_}'
...
label zm1146_s1: # from 0.0 0.1 0.2
    nr 'Trup wciąż się w ciebie wpatruje.{#zm1146_s1_}'
...
label zm1146_s3: # from 2.0
    nr 'Duch otwiera jedno oko. Całkowita biel jego oczu kontrastuje z szarym, pomarszczonym ciałem, które je otacza. Powoli odwraca głowę, aby lepiej ci się przyjrzeć; nabrzmiała i pocięta skóra jego twarzy i karku ściśle owija kości czaszki. W końcu słychać charkot wydobywający się ze zniszczonego gardła: "Nie. Nie… ja nie, ty… szpicuj się, pomyleńcu."{#zm1146_s3_}'
...
label zm1146_s5: # from 4.0
    nr 'Okropny kaszel wreszcie ustępuje. "Nie, trepie… ty… nie możesz. Chyba że… że zatańczysz w Baator i wybawisz mnie, ja jestem w ślepakach. Czas mojej… mojej pokuty." Duch zamyka oko i kładzie głowę na podłodze.{#zm1146_s5_}'
...
label zm1146_s6: # from 3.2 17.0
    nr 'Duch wydaje się z siebie wilgotny, warczący odgłos, a poczerniałe wargi odsłaniają zakrzywione, żółte zęby. "Tylko… tylko poczekaj aż… wyrwę się z tej otchłani… Po ciebie przyjdę najpierw, trepie…"{#zm1146_s6_}'
...
label zm1146_s7: # from 6.0
    nr 'Duch wydaje słaby, gardłowy warkot i spluwa w twoim kierunku - nieczystości lądują kilka centymetrów od twoich stóp. Całkiem wyczerpany, truposz opada z powrotem na podłogę i wydaje się, że raz jeszcze życie z niego uchodzi.{#zm1146_s7_}'
...
label zm1146_s8: # from 6.1
    nr 'Twój szybki kopniak ląduje na nerce truposza, ale nic to nie daje; nie wygląda na to, aby duch odniósł jakiekolwiek obrażenia. Stoisz tak z niejakim poczuciem niezadowolenia.{#zm1146_s8_}'
...
label zm1146_s9: # from 2.1 3.1 4.1 5.0 10.0 11.0 12.1 13.1 14.1 15.0 16.0 17.1 18.1 19.0 20.0
    nr '"Czego… czego to *mógłbyś* w ogóle ode mnie chcieć, trepie?" Duch wciąż wije się, poklepując się jak gdyby usiłując ugasić rozmaite małe ogniska na swym ciele.{#zm1146_s9_}'
...
label zm1146_s10: # from 9.0
    nr '"Nie twoja brocha… zostaw mnie… w spokoju…"{#zm1146_s10_}'
...
label zm1146_s11: # from 9.1
    nr '"Co? Na litość mocy, kogo to… interesuje? Z Sigil, ty… ty szpicu."{#zm1146_s11_}'
...
label zm1146_s14: # from 9.4
    nr '"Zasłużyć? NA TO? Nijak! Ja… *hep* … nic nie zrobiłem. Starałem się tylko jakoś żyć… przetrwać jak każdy… i wtedy „buum“. Ten cholerny mag podpalił Ul!"{#zm1146_s14_}'
...
label zm1146_s15: # from 9.5
    nr '"Nic. Nic. Przecież *ci* mówię, trepie. Po prostu… zostaw mnie moim oparzeniom…"{#zm1146_s15_}'
...
label zm1146_s16: # from 9.6
    nr '"Kogo? Co? Nie! Co… co każe ci myśleć, że powiedziałbym ci, gdybym… ty… ty skurlony trepie? Hmpf…"{#zm1146_s16_}'
...
label zm1146_s17: # from 13.0
    nr '"Zemsta, pomyleńcu! Dorwę… dorwę ich wszystkich, wszystkich tych, którzy mnie wkurzyli. A szczególnie tego czarodzieja! Rozerwę na strzępy te jego drobinki i wepchnę mu je do gardła. A potem wrzucę go do tej cuchnącej dziury, te jego drobinki i wszystko inne też! Jego i paru innych też… co by się wyrównało! He he he…"{#zm1146_s17_}'
