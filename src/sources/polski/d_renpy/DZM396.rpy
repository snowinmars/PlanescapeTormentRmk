...
label zm396_s0: # - # IF ~  HasItem("Bandage","ZM396")
    ...
    menu:
        ...
        '"Czy mogę pożyczyć te bandaże?"{#zm396_s0_r34935}' if zm396Logic.r34935_condition():
            # a1 # r34935
            jump zm396_s1

        'Spróbuj wziąć bandaże od zombiaka.{#zm396_s0_r34936}':
            # a2 # r34936
            $ zm396Logic.r34936_action()
            jump zm396_s3

        '"Przecież wiem, że nie jesteś zombie. Nikogo nie oszukasz."{#zm396_s0_r34937}' if zm396Logic.r34937_condition():
            # a3 # r34937
            jump zm396_s1

        'Posłuż się swoją umiejętnością Gadaj-Kości-Opowieści.{#zm396_s0_r34940}' if zm396Logic.r34940_condition():
            # a4 # r34940
            jump zm396_s2

        '"Miło było z tobą pogadać. Żegnaj."{#zm396_s0_r34941}':
            # a5 # r34941
            jump zm396_dispose

        'Zostaw truposza w spokoju.{#zm396_s0_r45106}':
            # a6 # r45106
            jump zm396_dispose
...
label zm396_s1: # from 0.0 0.1 0.3 4.0 4.1 4.2
    ...
    menu:
        ...
        'Zostaw truposza w spokoju.{#zm396_s1_r45107}':
            # a8 # r45107
            jump zm396_dispose
...
label zm396_s3: # from 0.2 1.0
    ...
    menu:
        ...
        'Zostaw truposza w spokoju.{#zm396_s3_r45110}':
            # a11 # r45110
            jump zm396_dispose
...
label zm396_s4: # from 3.0 # IF ~  !HasItem("Bandage","ZM396")
    ...
    menu:
        ...
        '"Przepraszam, że wziąłem od ciebie te bandaże. Po prostu mnie się bardziej przydadzą niż tym zwłokom."{#zm396_s4_r45113}' if zm396Logic.r45113_condition():
            # a13 # r45113
            jump zm396_s1

        '"Przecież wiem, że nie jesteś zombie. Nikogo nie oszukasz."{#zm396_s4_r45114}' if zm396Logic.r45114_condition():
            # a14 # r45114
            jump zm396_s1

        'Posłuż się swoją umiejętnością Gadaj-Kości-Opowieści.{#zm396_s4_r45115}' if zm396Logic.r45115_condition():
            # a15 # r45115
            jump zm396_s2

        '"Miło było z tobą pogadać. Żegnaj."{#zm396_s4_r45116}':
            # a16 # r45116
            jump zm396_dispose

        'Zostaw truposza w spokoju.{#zm396_s4_r45117}':
            # a17 # r45117
            jump zm396_dispose
