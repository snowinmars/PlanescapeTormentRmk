...
label zm79_s0: # - # IF ~  True()
    ...
    menu:
        ...
        'Przyjrzyj się dobrze kręgowi kłów.{#zm79_s0_r34946}' if zm79Logic.r34946_condition():
            # a1 # r34946
            $ zm79Logic.r34946_action()
            jump zm79_s3

        '"Przecież wiem, że nie jesteś zombie. Nikogo nie oszukasz."{#zm79_s0_r34947}' if zm79Logic.r34947_condition():
            # a2 # r34947
            jump zm79_s1

        'Posłuż się swoją umiejętnością Gadaj-Kości-Opowieści.{#zm79_s0_r34948}' if zm79Logic.r34948_condition():
            # a3 # r34948
            jump zm79_s2

        '"Miło było z tobą pogadać. Żegnaj."{#zm79_s0_r34951}':
            # a4 # r34951
            jump zm79_dispose

        'Zostaw truposza w spokoju.{#zm79_s0_r34952}':
            # a5 # r34952
            jump zm79_dispose
...
label zm79_s3: # from 0.1
    ...
    menu:
        ...
        '"Hmmm… Zastanawiam się, czy ta przerwa pomiędzy kłami pasuje do wyżłobień na tym miedzianym kolczyku, który mam…"{#zm79_s3_r64280}' if zm79Logic.r64280_condition():
            # a9 # r64280
