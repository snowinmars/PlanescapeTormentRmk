...
label zm985_s0: # - # IF ~  Global("Topple_985","GLOBAL",0)
    nr 'Ten trup - numer "985" - nagle zamarł; sądząc po stanie jego lewej nogi, wydaje się, że jakiś proces gnicia albo coś w tym rodzaju przegryzło mu się przez kolano. Truposz chwieje się w przód i w tył, usiłując zachować równowagę.{#zm985_s0_1}'
...
label zm985_s1: # from 0.4 5.0 5.1 5.2
    nr 'Trup patrzy przed siebie w zapomnieniu. Nie daje żadnych oznak, że cię usłyszał.{#zm985_s1_1}'
...
label zm985_s2: # from 0.5 5.3
    nr 'Truposz nie rusza się. Wygląda na to, że jest w zbyt daleko posuniętym stadium rozkładu, aby odpowiedzieć na twoje pytania.{#zm985_s2_1}'
...
label zm985_s3: # from 0.1 6.0
    nr 'Słychać *trzask* z lewej nogi truposza i cały pada na ziemię niczym martwe drzewo. Jego tors uderza w kamienną posadzkę i roztrzaskuje się niczym zgniły arbuz, a z dziury z głośnym gulgotem wylewa się posoka i cuchnąca maź. Ku twemu zdziwieniu nie wydaje się, aby ktokolwiek zauważył upadek truposza… a co dziwniejsze, lewa noga wciąż tkwi w tym samym miejscu, gdzie była przed upadkiem całego ciała, jak gdyby stała na baczność. Po chwili, noga przewraca się z wilgotnym stuknięciem.{#zm985_s3_1}'
...
label zm985_s4: # from 0.2
    nr 'Wyciągasz rękę w kierunku lewego ramienia truposza, aby pomóc mu złapać równowagę. Jednakże, gdy chwytasz jego ramię, truposz nagle przechyla się w prawo, i wszystko kończy się na tym, że zamiast pomagać mu złapać równowagę, popychasz go.{#zm985_s4_1}'
...
label zm985_s5: # - # IF ~  GlobalGT("Topple_985","GLOBAL",0)
    nr 'Wygląda na to, że ktoś zamienił lewą rękę i lewą nogę truposza na jakieś kończyny wymienne wzięte od innych truposzy. Lewa noga jest krótsza niż ta stara, ale teraz truposz jest przynajmniej w stanie stać.{#zm985_s5_1}'
...
label zm985_s6: # from 0.3
    nr 'Wyciągasz rękę w kierunku lewego ramienia truposza, aby pomóc mu złapać równowagę. Jednakże, gdy chwytasz jego ramię, truposz nagle przechyla się w prawo, i wszystko kończy się na tym, że zamiast pomagać mu złapać równowagę, popychasz go.{#zm985_s6_1}'
...
label zm985_s7: # from 3.0
    nr 'Gdy tak patrzysz na przegniłe szczątki truposza, zauważasz, iż jego lewa ręka chyba wyszła z upadku bez szwanku - urwała się od korpusu w trakcie upadku i wygląda na to, że nie została tknięta przez żaden proces gnicia, który zaatakował resztę ciała.{#zm985_s7_1}'
