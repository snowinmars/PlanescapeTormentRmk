...
label deionarra_s0: # from 5.2 9.5 10.8 11.3 12.3 13.4 14.2 25.3 27.4 28.4 30.2 31.3 32.2 41.4 41.5 42.3 42.4 43.4 44.4
    ...
    # nr 'Дейонарра улыбается, но в улыбке нет ничего, кроме печали. Закрыв глаза, она исчезает с беззвучным вздохом.~ [DEN008B]{#deionarra_s0_2}'
...
label deionarra_s52: # from 51.0
    ...
    # nr 'Твое заключение здесь. Но он{#deionarra_s52_2}'
    # deionarra '«Не преграда для таких как я».{#deionarra_s52_3}'
    # nr 'Она закрывает глаза.{#deionarra_s52_4}'
    # deionarra '«Мои глаза видят многое, и залы этой Крепости очень знакомы мне».{#deionarra_s52_5}'
