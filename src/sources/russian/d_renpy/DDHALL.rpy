...
label dhall_s8: # from 22.0
    ...
    menu:
        ...
        'dhall_s8_r6038{#dhall_s8_r6038}': # '«Я выслушал достаточно. Прощай, Дхолл».{#dhall_s8_r6038}'
            # a26 # r6038
            jump dhall_s11
...
label dhall_s9: # from 2.5 3.2 4.0 6.0 6.1 8.2 10.5 12.1 13.0 14.4 15.2 16.3 17.3 18.2 19.2 20.2 21.1 22.2 23.2 24.1 25.2 26.2 27.0 28.1 29.2 30.0 31.1 32.6 33.3 34.2 35.2 36.2 37.1 38.2 39.0 40.0 41.3 42.4 43.3 45.0 47.4 48.2 49.2 51.2 52.2 53.1
    ...
    menu:
        ...
        'dhall_s9_r41663{#dhall_s9_r41663}': # '«Ничего… прощай, Дхолл».{#dhall_s9_r41663}'
            # a34 # r41663
            jump dhall_s11
...
label dhall_s10: # from 9.1
    ...
    menu:
        ...
        'dhall_s10_r866{#dhall_s10_r866}': # '«Прощай, Дхолл».{#dhall_s10_r866}'
            # a41 # r866
            jump dhall_s11
...
label dhall_s11: # from 2.6 2.7 4.1 8.3 9.7 10.6 12.2 14.5 15.3 16.4 19.3 20.3 21.2 22.3 23.3 24.2 25.3 26.3 27.1 28.2 29.4 30.1 31.3 32.7 33.4 34.3 35.3 36.3 37.2 38.3 41.4 42.5 43.4 47.5 48.3 49.3 51.3 52.3 53.2
    ...
    menu:
        'dhall_s11_r41564{#dhall_s11_r41564}': # '«Тогда, возможно, мы еще встретимся, Дхолл».{#dhall_s11_r41564}'
            # a42 # r41564
            jump dhall_dispose
...
label dhall_s13: # from 9.3
    ...
    # nr 'Самый очевидный выход, но они не выпустят никого, кроме тленных…{#dhall_s13_2}'
    # dhall '«Дхолл заходится в кашле, затем продолжает. — У одного из проводников у главных ворот есть ключ к ним, но он вряд ли откроет их для тебя, разве что ты будешь весьма убедительным».{#dhall_s13_3}'
    ...
    menu:
        ...
        'dhall_s13_r877{#dhall_s13_r877}': # '«Тогда прощай, Дхолл».{#dhall_s13_r877}'
            # a47 # r877
            jump dhall_dispose
...
label dhall_s14: # from 10.3
    ...
    menu:
        ...
        'dhall_s14_r5752{#dhall_s14_r5752}': # '«Прощай, Дхолл».{#dhall_s14_r5752}'
            # a53 # r5752
            jump dhall_s11
...
label dhall_s15: # from 9.2 10.4 32.5
    ...
    menu:
        ...
        'dhall_s15_r889{#dhall_s15_r889}': # '«Прощай, Дхолл».{#dhall_s15_r889}'
            # a57 # r889
            jump dhall_s11
...
label dhall_s16: # from 15.0
    ...
    menu:
        ...
        'dhall_s16_r5753{#dhall_s16_r5753}': # '«Прощай, Дхолл».{#dhall_s16_r5753}'
            # a62 # r5753
            jump dhall_s11
...
label dhall_s17: # from 16.0
    ...
    menu:
        ...
        'dhall_s17_r6031{#dhall_s17_r6031}': # '«Тогда пойду и разыщу этого Фарода. Прощай, Дхолл».{#dhall_s17_r6031}'
            # a67 # r6031
            jump dhall_s19
...
label dhall_s18: # from 17.0 29.1 31.0 35.1 36.1
    ...
    menu:
        ...
        'dhall_s18_r5755{#dhall_s18_r5755}': # '«У меня такое чувство, что наши пути еще пересекутся. Прощай, Дхолл».{#dhall_s18_r5755}'
            # a71 # r5755
            jump dhall_s19
...
label dhall_s19: # from 17.4 18.0 18.3 29.3 31.2
    ...
    menu:
        ...
        'dhall_s19_r5756{#dhall_s19_r5756}': # '«Я не могу больше с тобой говорить. Прощай, Дхолл».{#dhall_s19_r5756}'
            # a75 # r5756
            jump dhall_s11
...
label dhall_s21: # from 9.4
    ...
    menu:
        ...
        'dhall_s21_r923{#dhall_s21_r923}': # '«Прощай, Дхолл».{#dhall_s21_r923}'
            # a82 # r923
            jump dhall_s11
...
label dhall_s22: # from 47.0
    ...
    menu:
        ...
        'dhall_s22_r920{#dhall_s22_r920}': # '«Думаю, я услышал достаточно. Прощай, Дхолл».{#dhall_s22_r920}'
            # a86 # r920
            jump dhall_s11
...
label dhall_s23: # from 8.0
    ...
    menu:
        ...
        'dhall_s23_r6039{#dhall_s23_r6039}': # '«Я выслушал достаточно. Прощай, Дхолл».{#dhall_s23_r6039}'
            # a90 # r6039
            jump dhall_s11
...
label dhall_s24: # from 25.0
    ...
    menu:
        ...
        'dhall_s24_r6042{#dhall_s24_r6042}': # '«Кажется, я обязан тебе. Прощай, Дхолл».{#dhall_s24_r6042}'
            # a93 # r6042
            jump dhall_s11
...
label dhall_s25: # from 9.5 23.0
    ...
    menu:
        ...
        'dhall_s25_r6040{#dhall_s25_r6040}': # '«Отлично. Прощай, Дхолл».{#dhall_s25_r6040}'
            # a97 # r6040
            jump dhall_s11
...
label dhall_s26: # from 9.6
    ...
    menu:
        ...
        'dhall_s26_r960{#dhall_s26_r960}': # '«Прощай, Дхолл».{#dhall_s26_r960}'
            # a101 # r960
            jump dhall_s11
...
label dhall_s27: # from 26.1
    ...
    menu:
        ...
        'dhall_s27_r1304{#dhall_s27_r1304}': # '«Пусть будет так. Прощай, Дхолл».{#dhall_s27_r1304}'
            # a103 # r1304
            jump dhall_s11
...
label dhall_s28: # from 2.2 42.1
    ...
    menu:
        'dhall_s28_r981{#dhall_s28_r981}': # '«Она разговаривала со мной, Дхолл. Ее душа находится здесь».{#dhall_s28_r981}'
            # a104 # r981
            jump dhall_s30
        ...
        'dhall_s28_r873{#dhall_s28_r873}': # '«Не уверен, что она достигла Истинной Смерти. Прощай, Дхолл».{#dhall_s28_r873}'
            # a106 # r873
            jump dhall_s11
...
label dhall_s29: # from 36.0
    ...
    menu:
        ...
        'dhall_s29_r6026{#dhall_s29_r6026}' if dhallLogic.r6026_condition(): # '«Возможно, мне стоит поговорить с Фародом. Прощай, Дхолл».{#dhall_s29_r6026}'
            # a110 # r6026
            jump dhall_s19

        'dhall_s29_r874{#dhall_s29_r874}' if dhallLogic.r874_condition(): # '«Понятно. Прощай, Дхолл».{#dhall_s29_r874}'
            # a111 # r874
            jump dhall_s11
...
label dhall_s30: # from 28.0
    ...
    menu:
        ...
        'dhall_s30_r947{#dhall_s30_r947}': # '«Возможно, мы поговорим об этом позже. Прощай, Дхолл».{#dhall_s30_r947}'
            # a113 # r947
            jump dhall_s11
...
label dhall_s31: # from 29.0
    ...
    menu:
        ...
        'dhall_s31_r6027{#dhall_s31_r6027}' if dhallLogic.r6027_condition(): # '«В таком случае, я должен разыскать его. Прощай, Дхолл».{#dhall_s31_r6027}'
            # a116 # r6027
            jump dhall_s19

        'dhall_s31_r6066{#dhall_s31_r6066}' if dhallLogic.r6066_condition(): # '«Понятно. Прощай, Дхолл».{#dhall_s31_r6066}'
            # a117 # r6066
            jump dhall_s11
...
label dhall_s32: # from 8.1 10.0 14.3 15.1 16.2 17.2 18.1 19.1 20.1 22.1 23.1 24.0 25.1 33.2 34.1 37.0 38.1 41.2 47.3 48.1 49.1 51.1 52.1 53.0
    ...
    menu:
        ...
        'dhall_s32_r6062{#dhall_s32_r6062}': # '«Прощай, Дхолл».{#dhall_s32_r6062}'
            # a125 # r6062
            jump dhall_s11
...
label dhall_s33: # from 10.2 14.2 32.0 41.0 47.2 49.0
    ...
    # nr 'Всего лишь тени, жалкое подобие от того, что было однажды жизнью. Эта 'жизнь'{#dhall_s33_2}'
    # dhall '«То, куда мы попадаем *после* того, как умираем. А здесь мы… в западне. В клетке. До тех пор, пока не достигнем Истинной Смерти».{#dhall_s33_3}'
    ...
    menu:
        ...
        'dhall_s33_r5738{#dhall_s33_r5738}': # '«Прощай, Дхолл».{#dhall_s33_r5738}'
            # a130 # r5738
            jump dhall_s11
...
label dhall_s34: # from 14.1 32.4
    ...
    menu:
        ...
        'dhall_s34_r5747{#dhall_s34_r5747}': # '«Прощай, Дхолл».{#dhall_s34_r5747}'
            # a134 # r5747
            jump dhall_s11
...
label dhall_s35: # from 16.1 17.1 20.0
    ...
    menu:
        ...
        'dhall_s35_r6028{#dhall_s35_r6028}': # '«Звучит ободряюще. Прощай, Дхолл».{#dhall_s35_r6028}'
            # a138 # r6028
            jump dhall_s11
...
label dhall_s36: # from 35.0
    ...
    menu:
        ...
        'dhall_s36_r6029{#dhall_s36_r6029}': # '«Прощай, Дхолл».{#dhall_s36_r6029}'
            # a142 # r6029
            jump dhall_s11
...
label dhall_s37: # from 32.3
    ...
    menu:
        ...
        'dhall_s37_r5758{#dhall_s37_r5758}': # '«Прощай, Дхолл».{#dhall_s37_r5758}'
            # a145 # r5758
            jump dhall_s11
...
label dhall_s38: # from 10.1 14.0
    ...
    # nr 'Имя не хуже других…{#dhall_s38_2}'
    # dhall '«Дхолл переводит дыхание. — Ведь что-то держит тебя здесь, не так ли? Какое-то незаконченное дело, какая-то страсть, которая должна быть подавлена, прежде чем ты сможешь достигнуть Истинной Смерти?»{#dhall_s38_3}'
    ...
    menu:
        ...
        'dhall_s38_r5750{#dhall_s38_r5750}': # '«Прощай, Дхолл».{#dhall_s38_r5750}'
            # a149 # r5750
            jump dhall_s11
...
label dhall_s39: # -
    ...
    menu:
        ...
        'dhall_s39_r977{#dhall_s39_r977}': # '«Прощай, Дхолл».{#dhall_s39_r977}'
            # a151 # r977
            jump dhall_dispose
...
label dhall_s40: # - # IF ~  Global("Dhall","GLOBAL",1)
    ...
    menu:
        'dhall_s40_r979{#dhall_s40_r979}': # '«У меня к тебе другие вопросы, Дхолл».{#dhall_s40_r979}'
            # a152 # r979
            jump dhall_s9
...
label dhall_s41: # from 26.0 52.0
    ...
    menu:
        ...
        'dhall_s41_r5741{#dhall_s41_r5741}': # '«Прощай, Дхолл».{#dhall_s41_r5741}'
            # a158 # r5741
            jump dhall_s11
...
label dhall_s45: # from 44.0
    ...
    menu:
        'dhall_s45_r5731{#dhall_s45_r5731}': # '«Возможно, ты ответишь на некоторые из моих вопросов, Дхолл…»{#dhall_s45_r5731}'
            # a171 # r5731
...
label dhall_s48: # from 32.1 33.0 38.0 41.1 47.1
    ...
    menu:
        ...
        'dhall_s48_r6046{#dhall_s48_r6046}': # '«Я должен идти. Прощай, Дхолл».{#dhall_s48_r6046}'
            # a183 # r6046
            jump dhall_s11
...
label dhall_s49: # from 48.0
    ...
    menu:
        ...
        'dhall_s49_r6050{#dhall_s49_r6050}': # '«Я должен идти. Прощай, Дхолл».{#dhall_s49_r6050}'
            # a187 # r6050
            jump dhall_s11
...
label dhall_s51: # from 50.0 50.1 50.2
    ...
    menu:
        ...
        'dhall_s51_r6057{#dhall_s51_r6057}': # '«Прощай, Дхолл».{#dhall_s51_r6057}'
            # a194 # r6057
            jump dhall_s11
...
label dhall_s52: # from 51.0
    ...
    menu:
        ...
        'dhall_s52_r6061{#dhall_s52_r6061}': # '«Прощай, Дхолл».{#dhall_s52_r6061}'
            # a198 # r6061
            jump dhall_s11
...
label dhall_s53: # from 34.0
    ...
    menu:
        ...
        'dhall_s53_r5745{#dhall_s53_r5745}': # '«Прощай, Дхолл».{#dhall_s53_r5745}'
            # a201 # r5745
            jump dhall_s11
