...
label dust_s45: # from 19.5
    'dust_s45{#dust_s45}'
    # nr 'Ты наклоняешься, чтобы{#dust_s45_1}'
    # dust '«Шепнуть»{#dust_s45_2}'
    # nr 'Ему что-то на ухо, тленный тоже наклоняется. Как только он оказывается на расстоянии вытянутой руки, ты хватаешь его за виски и резко сворачиваешь голову влево.{#dust_s45_3}'
