...
label dustfem_s0: # - # IF ~  Global("Appearance","GLOBAL",1)
    nr 'Тленная не обращает на тебя внимания. Должно быть, она спутала тебя с одним из мертвых рабочих.{#dustfem_s0_}'
...
label dustfem_s1: # from 0.0 0.1 0.2 0.3
    nr 'Тленная подпрыгивает от неожиданности. Затем она поворачивает к тебе голову. Она выглядит потрясенной: должно быть, маскировка у тебя весьма неплохая.{#dustfem_s1_}'
...
label dustfem_s2: # from 1.1 1.2 4.3 5.2 5.3 6.4 19.6 20.4 47.2 47.3 51.4
    nr 'Тленная отступает на шаг, затем быстро хлопает в ладони три раза. В ответ во всем Морге раздается звон огромного железного колокола.{#dustfem_s2_}'
...
label dustfem_s3: # externs morte_s84
    nr 'Эта бледная женщина одета в длинную темную мантию. От нее слегка отдает плесенью. Ее лицо ничего не выражает; кажется, она поглощена своими обязанностями.{#dustfem_s3_}'
...
label dustfem_s4: # from 3.0 3.1 3.2 3.3 40.2 40.3
    nr 'Тленная медленно поднимает свою голову и оборачивается к тебе.{#dustfem_s4_}'
...
label dustfem_s5: # from 4.0 16.2 51.1
    dustfem '«Я позову стражу, они тебя живо выведут. Погоди минутку».{#dustfem_s5_}'
...
label dustfem_s6: # from 4.1 4.2 51.2 51.3
    dustfem '«Если ты не потерялся, то что же ты здесь делаешь?»{#dustfem_s6_}'
...
label dustfem_s7: # from 6.0 9.0 20.0
    dustfem '«Боюсь, что меня касается. Может, стражники развяжут твой язык».{#dustfem_s7_}'
    nr 'Тленная делает шаг назад, кажется, она собирается позвать стражников.{#dustfem_s7_}'
...
label dustfem_s8: # from 6.1 16.0 20.1
    dustfem '«Любишь пошутить? Тогда может поделишься своими шутками со стражниками».{#dustfem_s8_}'
    nr 'Тленная отступает на шаг; кажется, она собирается позвать стражников.{#dustfem_s8_}'
...
label dustfem_s9: # from 6.2 20.2
    dustfem '«Кого ты хочешь увидеть?»{#dustfem_s9_}'
...
label dustfem_s10: # from 9.1
    dustfem '«Дхолла можно найти в приемной комнате на этом этаже. Должна предупредить… Дхолл очень занят, а здоровье у него подкошено. Если у тебя к нему несрочное дело, то лучше не беспокоить его».{#dustfem_s10_}'
...
label dustfem_s11: # from 9.2
    dustfem '«Дхолл скорее всего в приемной комнате на втором этаже. Он очень занят, а здоровье у него подкошено. Если у тебя к нему несрочное дело, то лучше не беспокоить его».{#dustfem_s11_}'
...
label dustfem_s12: # from 9.4 19.1
    dustfem '«Дейонаррой? На первом этаже в мемориальном зале похоронена женщина. Может быть, это она?»{#dustfem_s12_}'
...
label dustfem_s13: # from 9.3
    dustfem '«Дейонаррой? В северо-западном мемориальном зале похоронена женщина. Может быть, это она?»{#dustfem_s13_}'
...
label dustfem_s14: # from 9.6
    dustfem '«Скорее всего, Соэго находится у главных ворот на первом этаже. Он работает проводником в часы антипика».{#dustfem_s14_}'
...
label dustfem_s15: # from 9.5
    dustfem '«Скорее всего, Соэго находится у главных ворот. Он работает проводником в часы антипика».{#dustfem_s15_}'
...
label dustfem_s16: # from 6.3 20.3
    dustfem '«Кто был погребен? Возможно, служба проводится в другом конце Морга».{#dustfem_s16_}'
...
label dustfem_s17: # from 16.1
    dustfem '«По всему периметру Морга расположены погребальные залы. Они расположены вдоль стены на первом и втором этажах. Тебе известно имя усопшего?»{#dustfem_s17_}'
...
label dustfem_s18: # from 17.0
    dustfem '«Тогда тебе стоит поговорить с одним из проводников у главных ворот. Они тебе помогут».{#dustfem_s18_}'
...
label dustfem_s20: # from 9.9 19.0
    dustfem '«Понятно. И что же ты здесь делаешь?»{#dustfem_s20_}'
...
label dustfem_s21: # from 9.7 9.8 19.2 19.3
    dustfem '«Это имя мне незнакомо. Справься у одного из проводников у главных ворот… они смогут сориентировать тебя лучше, чем я».{#dustfem_s21_}'
...
label dustfem_s22: # - # IF ~  Global("Appearance","GLOBAL",2)
    nr 'Эта бледная женщина одета в длинную темную мантию. От нее слегка отдает плесенью. Ее лицо ничего не выражает; кажется, она поглощена своими обязанностями.{#dustfem_s22_}'
...
label dustfem_s23: # from 22.0
    nr 'Она медленно оборачивается, ее взгляд мельком скользит по твоей одежде.{#dustfem_s23_}'
...
label dustfem_s24: # from 23.0
    dustfem '«У меня такой же вопрос. Твое лицо мне незнакомо. Как тебя зовут?»{#dustfem_s24_}'
...
label dustfem_s25: # from 23.1
    dustfem '«Это Морг…»{#dustfem_s25_}'
    nr 'Тленная какое-то время смотрит на тебя, как бы оценивая только что тобою сказанное.{#dustfem_s25_}'
    dustfem '«Как, ты сказал, тебя зовут?»{#dustfem_s25_}'
...
label dustfem_s26: # from 23.2 27.0 28.2 30.3 31.3 34.2 36.1 39.0 50.0
    nr 'Тленная терпеливо ждет твоего продолжения.{#dustfem_s26_}'
...
label dustfem_s27: # from 26.0
    dustfem '«Ты можешь просто выйти через главные ворота. Они на первом этаже».{#dustfem_s27_}'
...
label dustfem_s28: # from 26.1
    dustfem '«Это имя…»{#dustfem_s28_}'
    nr 'Тленная на секунду умолкает.{#dustfem_s28_}'
    dustfem '«Это имя *звучит* знакомо… Кажется, я припоминаю сборщика с таким именем. Писец Дхолл может знать о нем больше».{#dustfem_s28_}'
...
label dustfem_s29: # from 28.0
    dustfem '«Сборщики… они собирают тех, кто умер на улицах Сигила, и доставляют их в Морг…»{#dustfem_s29_}'
    nr 'Тленная умолкает, хмуря брови.{#dustfem_s29_}'
    dustfem '«Ты нездешний. Кто ты?»{#dustfem_s29_}'
...
label dustfem_s30: # from 28.1
    dustfem '«Дхолл — один из самых уважаемых членов нашей фракции. Наверное, никто не размышлял о сущности Истинной Смерти и не заслужил ее больше, чем он. У него много знаний, которыми он может поделиться. Если ты незнаком с ним, то я советую тебе как можно раньше воспользоваться этой возможностью. Ему осталось не так долго жить в тени этого существования».{#dustfem_s30_}'
...
label dustfem_s31: # from 30.0 32.0 33.0
    nr 'Кивок.{#dustfem_s31_}'
    dustfem '«Дхолл болен. Он стар, даже по меркам гитцераев. Несомненно, смерть последует за болезнью, которую он подхватил. Ему повезло».{#dustfem_s31_}'
...
label dustfem_s32: # from 30.1
    dustfem '«Дхолл находится в приемной комнате в северо-западной части этого этажа. Должна предупредить… Дхолл очень занят… то время, которое он не занят своими обязанностями, отбирает у него болезнь».{#dustfem_s32_}'
...
label dustfem_s33: # from 30.2
    dustfem '«Дхолл скорее всего в приемной комнате на втором этаже. Лучше не отвлекай его слишком сильно — он очень занят… то время, которое он не занят своими обязанностями, отбирает у него болезнь».{#dustfem_s33_}'
...
label dustfem_s35: # from 31.1 34.0
    dustfem '«Гитцерай»{#dustfem_s35_}'
    nr 'Это…{#dustfem_s35_}'
    dustfem '«Тленная умолкает, пристально глядя на тебя. — Ты ведь нездешний. Кто ты?»{#dustfem_s35_}'
...
label dustfem_s36: # from 31.2 34.1
    dustfem '«Ему повезло в том, что он достигнет Истинной Смерти. Он больше не будет странствовать в тени этого существования».{#dustfem_s36_}'
...
label dustfem_s37: # from 36.0
    nr 'Тленная кивает.{#dustfem_s37_}'
    dustfem '«Да».{#dustfem_s37_}'
    nr 'Она хмурится, затем пристально смотрит на тебя.{#dustfem_s37_}'
    dustfem '«Ты нездешний. Кто ты?»{#dustfem_s37_}'
...
# s38 # say1212
label dustfem_s38: # -
    dustfem '«Ты не из наших. Кто ты? Что ты здесь делаешь? Ты из анархистов? Или шпион другой фракции?»{#dustfem_s38_}'
    nr 'Тленная отступает на шаг.{#dustfem_s38_}'
    dustfem '«Стража! Стража!»{#dustfem_s38_}'
...
label dustfem_s39: # from 26.2
    dustfem '«Дневник? Не встречала такого».{#dustfem_s39_}'
...
# s40 # say1214
label dustfem_s40: # -
    nr 'Эта бледная женщина одета в длинную темную мантию. От нее слегка отдает плесенью. Ее лицо ничего не выражает; кажется, она поглощена своими обязанностями.{#dustfem_s40_}'
...
label dustfem_s41: # from 1.0 5.1 7.1 8.1 47.1
    nr 'Тленная не успевает и слова вымолвить, как твои руки хватают ее голову за виски и резко сворачивают ее влево.{#dustfem_s41_}'
...
label dustfem_s42: # from 41.0 45.0
    nr 'В шее раздается характерный хруст, и тело тленной безвольно падает в твои объятия.{#dustfem_s42_}'
...
label dustfem_s43: # from 42.0
    nr 'К своему удивлению, это действие происходит практически инстинктивно, будто ты проделывал это уже много раз… с этой мыслью всплывает воспоминание, но оно недостаточно сильно для того, чтобы за него зацепиться.{#dustfem_s43_}'
...
label dustfem_s44: # from 5.0 7.0 8.0 19.4 47.0
    nr 'Ты недостаточно быстр, и тленная уворачивается от твоего выпада. Отступив на шаг, она быстро хлопает в ладони три раза. В ответ во всем Морге раздается звон огромного железного колокола.{#dustfem_s44_}'
...
label dustfem_s45: # from 19.5
    nr 'Ты наклоняешься, чтобы{#dustfem_s45_}'
    dustfem '«Шепнуть»{#dustfem_s45_}'
    nr 'Ей что-то на ухо, тленная тоже наклоняется. Как только она оказывается на расстоянии вытянутой руки, ты хватаешь ее за виски и резко сворачиваешь голову влево.{#dustfem_s45_}'
...
label dustfem_s46: # from 24.3 25.3 29.3 35.3 37.3 49.3 50.1
    nr 'Тленная явно что-то подозревает. Похоже, она хочет что-то сказать, затем едва заметно качает головой и возвращается к своим обязанностям.{#dustfem_s46_}'
...
label dustfem_s47: # from 24.2 25.2 29.1 29.2 35.1 35.2 37.1 37.2 49.1 49.2
    nr 'Тленная внимательно тебя осматривает.{#dustfem_s47_}'
...
label dustfem_s48: # from 10.0 11.0 12.0 13.0 14.0 15.0 26.3 27.1 28.3 30.4 31.4 32.1 33.1 34.3 36.2 39.1
    nr 'Тленная кивает и возвращается к своим делам.{#dustfem_s48_}'
...
label dustfem_s49: # from 24.0 24.1 25.0 25.1
    nr 'Тленная хмурится.{#dustfem_s49_}'
    dustfem '«Это имя мне незнакомо».{#dustfem_s49_}'
...
label dustfem_s50: # from 29.0 35.0 37.0 49.0
    nr 'Тленная продолжает хмуриться, но затем слегка кивает.{#dustfem_s50_}'
    dustfem '«Ну хорошо. Что я могу сделать для тебя, посвященный?»{#dustfem_s50_}'
...
label dustfem_s51: # - # IF ~  Global("Appearance","GLOBAL",0)
    nr 'Тленная бросает на тебя каменный взгляд.{#dustfem_s51_}'
    dustfem '«Ты потерялся?»{#dustfem_s51_}'
...
label dustfem_s52: # from 51.0
    nr 'Тленная какое-то время пристально на тебя смотрит, затем кивает.{#dustfem_s52_}'
