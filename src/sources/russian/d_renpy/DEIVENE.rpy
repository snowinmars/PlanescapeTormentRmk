...
label eivene_s5: # from 4.0
    ...
    eivene '«Ты».{#eivene_s5_1}'
    nr 'Она соединяет когти вместе, затем делает странное движение рукой.{#eivene_s5_1}'
    eivene '«Найди НИТКУ и БАЛЬЗАМ, принеси СЮДА, к Эи-Вейн. Пшел»{#eivene_s5_1}'
    nr 'Пшел{#eivene_s5_1}'
    eivene '«Пшел».{#eivene_s5_1}'
...
label eivene_s10: # from 9.4 12.1
    ...
    eivene '«Зомфи? Ты не зомфи!»{#eivene_s10_1}'
    nr 'Она отступает на шаг, и ты не успеваешь среагировать, как она трижды хлопает в ладони. В ответ повсюду Морге раздается звон огромного колокола.{#eivene_s10_1}'
...
label eivene_s11: # from 9.0 9.2
    ...
    eivene '«Хм-м. Кто это так тебя изрисовал? Никакого уважения к зомфи. Зомфи — не картина».{#eivene_s11_1}'
    nr 'Она принюхивается, затем похлопывает по твоим шрамам.{#eivene_s11_1}'
    eivene '«Этот в плохой форме, много шрамов, не законсервирован».{#eivene_s11_1}'
...
label eivene_s14: # from 13.0
    ...
    eivene '«Готово. Пшел-пшел».{#eivene_s14_1}'
...
label eivene_s17: # from 6.0 15.1 25.0 27.0
    ...
    eivene '«Тупые зомфи».{#eivene_s17_1}'
    nr 'Она нетерпеливо щелкает когтистыми пальцами, а затем делает движение рукой, как будто что-то зашивает.{#eivene_s17_1}'
    eivene '«Найди нитку и бальзам, принеси сюда, к Эи-Вейн. Пшел-пшел-пшел».{#eivene_s17_1}'
...
label eivene_s18: # from 14.0 17.1 22.0
    ...
    eivene '«Принеси потом обратно. Пшел-пшел».{#eivene_s18_1}'
...
label eivene_s22: # from 15.2 25.1 27.1
    ...
    eivene '«Тупые зомфи».{#eivene_s22_1}'
    nr 'Она нетерпеливо щелкает когтистыми пальцами, а затем делает движение рукой, как будто что-то зашивает.{#eivene_s22_1}'
    eivene '«Ты готов. Все зашито. Пшел-пшел-пшел».{#eivene_s22_1}'
...
label eivene_s24: # from 14.1 17.2 22.1
    ...
    eivene '«Ключа нет».{#eivene_s24_1}'
    nr 'Она делает отгоняющее движение.{#eivene_s24_1}'
    eivene '«Пшел-пшел-пшел».{#eivene_s24_1}'
