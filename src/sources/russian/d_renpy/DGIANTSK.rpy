...
label giantsk_s14: # from 13.0
    ...
    # nr 'Ты быстро оглядываешь останки скелета и, как и в прошлый раз, обнаруживаешь часть нагрудника скелета… как и в первый раз, на нем высечен фрагмент разрушенного заклинания. Эта вещь может пригодиться.{#giantsk_s14_1}'
