...
label vaxis_s0: # - # IF ~  Global("Vaxis","GLOBAL",0)
    ...
    vaxis '«821»{#vaxis_s0_1}'
    nr ', а его губы крепко зашиты. От тела исходит легкий запах формальдегида.{#vaxis_s0_1}'
...
label vaxis_s3: # from 2.2 5.2
    ...
    vaxis '«Зомби»{#vaxis_s3_1}'
    nr 'Начинает что-то бормотать… кажется, он пытается что-то сказать, но с зашитым ртом это сделать трудно.{#vaxis_s3_1}'
    vaxis '«Фто ТЫ? Фто тее нао?»{#vaxis_s3_1}'
...
label vaxis_s4: # from 3.5 6.5 7.8 8.5 10.4 11.4 12.2 13.5 14.4 15.2 16.4 17.2 18.1 19.3 20.1 25.6 27.6 31.6 32.5 34.2 35.6 59.1 74.1 75.3 76.1
    ...
    vaxis '«Никоу ничео не говои пво МЕЯ. Моучи. Не говои НИФЕО твуфявым».{#vaxis_s4_1}'
    nr 'Он прикладывает палец к губам.{#vaxis_s4_1}'
    vaxis '«Фффф».{#vaxis_s4_1}'
    nr 'После этого он проводит пальцем по горлу.{#vaxis_s4_1}'
    vaxis '«Или ты уфнефь нафегда. ПОЯЛ мея?»{#vaxis_s4_1}'
...
label vaxis_s6: # from 2.0 2.1 5.0 5.1
    ...
    nr 'Пытается что-то сказать сквозь зашитые губы. На его лице странная смесь испуга и злобы.{#vaxis_s6_1}'
    vaxis '«Фто ТЫ? Фего тее нао?»{#vaxis_s6_1}'
...
label vaxis_s7: # from 3.0 3.1 3.2 3.4 6.0 6.1 6.2 6.4
    ...
    vaxis '«Фто ты фдефь делаефь?»{#vaxis_s7_1}'
    nr 'Его глаза недоверчиво сужаются.{#vaxis_s7_1}'
    vaxis '«Фпионифь за Мертфяками?»{#vaxis_s7_1}'
...
label vaxis_s8: # from 7.2
    ...
    vaxis '«Ты фпион? Ты иф яфейки?»{#vaxis_s8_1}'
...
label vaxis_s9: # from 7.3
    ...
    vaxis '«Ты фпион? Ты иф яфейки?»{#vaxis_s9_1}'
...
label vaxis_s10: # from 8.0 8.1
    ...
    vaxis '«Ты не фпион!»{#vaxis_s10_1}'
    nr 'Он гонит тебя прочь.{#vaxis_s10_1}'
    vaxis '«Профь! Профь!»{#vaxis_s10_1}'
...
label vaxis_s12: # from 7.0 11.0
    ...
    vaxis '«Пвоулемы? Фево ты натвовил?»{#vaxis_s12_1}'
...
label vaxis_s14: # from 13.0 13.3 15.0
    ...
    vaxis '«Ты фпятил! Профь от мея!»{#vaxis_s14_1}'
...
label vaxis_s16: # from 13.1
    ...
    vaxis '«Пуфтогоовый! Приурок! Профь от мея, пей! Профь!»{#vaxis_s16_1}'
...
label vaxis_s17: # from 7.5 10.1 14.1 16.1 25.3 27.3
    ...
    vaxis '«Ты подеиффя фо мной фвоим фекветом, я подеюфь фвоим ф *тоой*. Фдефь у мея пряфуффа друфья, у тея фдефь *никоо*. Тее фдефь не мефто. Твуфьявые тея уют. Я фбегу».{#vaxis_s17_1}'
...
label vaxis_s18: # from 17.0
    ...
    vaxis '«Ты ПЫТАЕФФЯ фапифать мея ф кьигу мертфых? У мея фдефь пвяфуффа двуфья, у тея фдефь *никоо*. Твониф мея — они тея пвиконфят».{#vaxis_s18_1}'
...
label vaxis_s19: # from 7.6 10.2 14.2 16.2 25.4 27.4
    ...
    vaxis '«ТЫ пытаеффя фапифать МЕЯ ф кьигу мертфых? У мея фдефь пвячуффа двуфья, у тея фдефь *никоо*. Твонеф мея — они тея пвиконфят».{#vaxis_s19_1}'
...
label vaxis_s20: # from 19.2
    ...
    vaxis '«Ты подеилфя фо мной фвоим фекретом, я подеюфь фоим ф *тоой*. Фдефь у мея прячуффа друфья, у тея фдефь *никоо*. Твуфьявые тея уют. Я фбегу».{#vaxis_s20_1}'
...
label vaxis_s21: # from 7.4 10.0 14.0 16.0 19.1 25.2 27.2
    ...
    vaxis '«Не-не-не! Не наа фвать фтражу!»{#vaxis_s21_1}'
    nr 'Он явно напуган.{#vaxis_s21_1}'
    vaxis '«Я-я-я фпионю фа твуфявыми, говою, фео увиву. Ни-нифео больфе».{#vaxis_s21_1}'
...
label vaxis_s22: # from 7.7 10.3 14.3 16.3 17.1 25.5 27.5
    ...
    nr 'Факт того, что ты явно превосходишь зомби в грубой силе, очевидно, повлиял на его решение, и от его самонадеянности не осталось и следа.{#vaxis_s22_1}'
    vaxis '«Я-я-я фпионю за твуфьявыми, говою, фео увиву. Ни-нифео больфе».{#vaxis_s22_1}'
...
label vaxis_s24: # from 3.3 6.3 8.2
    ...
    nr 'Он искоса смотрит на тебя.{#vaxis_s24_1}'
    vaxis '«У тея соофение двя мея?»{#vaxis_s24_1}'
...
label vaxis_s25: # from 24.2
    ...
    vaxis '«Тада фео тее *надо*, пей?!»{#vaxis_s25_1}'
...
label vaxis_s27: # from 24.1 26.3 26.4
    ...
    vaxis '«Ты не фьяфной. Фто ты?»{#vaxis_s27_1}'
...
label vaxis_s29: # from 21.1 22.1 23.4 28.0 70.1 71.2
    ...
    nr 'Его глаза деловито сужаются.{#vaxis_s29_1}'
    vaxis '«Буу дальфе фледить».{#vaxis_s29_1}'
...
label vaxis_s30: # from 26.1 26.2
    ...
    vaxis '«Какие вафповявения?»{#vaxis_s30_1}'
...
label vaxis_s31: # from 7.1 12.1 13.4 15.1 25.0 27.0 50.0
    ...
    vaxis '«Пофеу я доувен помоать тее?»{#vaxis_s31_1}'
...
label vaxis_s32: # from 31.0
    ...
    vaxis '«Фем *нао* фео-то, но нифто нифео *не дает*. *Дай* мне фео-нить, и, *мовет*, я помоу».{#vaxis_s32_1}'
...
label vaxis_s33: # from 31.2 31.5 32.1 32.4 34.1 35.2 35.5 75.0
    ...
    vaxis '«Хм-м. Ты мовефь убевать фееф поуталы».{#vaxis_s33_1}'
...
label vaxis_s34: # from 31.3 32.2 35.3
    ...
    vaxis '«Ты подеиффя фо мной фвоим фекветом, я подеюфь фвоим ф *тоой*. Фдефь у мея пряфуффа друфья, у тея фдефь *никоо*. Тее фдефь не мефто. Твуфьявые тея уют. Я фбегу».{#vaxis_s34_1}'
...
label vaxis_s36: # from 35.1 58.2
    ...
    nr 'Он показывает на свои глаза.{#vaxis_s36_1}'
    vaxis '«У нее воутые глафифи…»{#vaxis_s36_1}'
    nr 'Затем он делает движение руками, похожее на стрижку ножницами.{#vaxis_s36_1}'
    vaxis '«Лефвия на пайфах».{#vaxis_s36_1}'
...
label vaxis_s38: # from 36.1 36.2 37.0 37.1
    ...
    vaxis '«Ефи тея поимают, не говои никоу обо мне, или я добеусь до тея, когда ты буешь фпать».{#vaxis_s38_1}'
...
label vaxis_s39: # from 43.12
    ...
    nr 'Зомби хихикает через зашитые губы, потом стучит себя по голове.{#vaxis_s39_1}'
    vaxis '«Твуфяки тууупые».{#vaxis_s39_1}'
...
label vaxis_s40: # -
    ...
    nr 'Зомби улыбается мертвецким оскалом.{#vaxis_s40_1}'
    vaxis '«Потом я помоу тее».{#vaxis_s40_1}'
...
label vaxis_s42: # from 35.0 36.0 58.0 58.1
    ...
    vaxis '«Хорофо… хорофо».{#vaxis_s42_1}'
...
label vaxis_s44: # from 43.6
    ...
    nr 'Нахмурившись, зомби напряженно думает.{#vaxis_s44_1}'
    vaxis '«Я… фвыфал, фто он фиет де-то ф Уле».{#vaxis_s44_1}'
    nr 'Он качает головой.{#vaxis_s44_1}'
    vaxis '«Нефнаю где».{#vaxis_s44_1}'
    nr 'Он снова хмурится.{#vaxis_s44_1}'
    vaxis '«Твуфявые фодят ф ума, они не ЛЮЯТ Фа-ода».{#vaxis_s44_1}'
...
label vaxis_s49: # from 30.1 42.0 43.0 43.1
    ...
    vaxis '«Ты мовешь убевафь феев поуталы».{#vaxis_s49_1}'
    nr 'Он взмахивает руками.{#vaxis_s49_1}'
    vaxis '«Пуф».{#vaxis_s49_1}'
...
label vaxis_s50: # from 33.0 49.0
    ...
    nr 'Зомби окидывает широким жестом пространство вокруг себя.{#vaxis_s50_1}'
    vaxis '«Поуталы вефде».{#vaxis_s50_1}'
...
label vaxis_s51: # from 50.1 50.2 50.3 72.0
    ...
    vaxis '«Тее надо выити, пойти ф арку на певом этаже, февео-фападный фал… Тее нувна кофть паица, фогнутоо в кьюк…»{#vaxis_s51_1}'
    nr 'Он поднимает указательный палец и сгибает его в крюк.{#vaxis_s51_1}'
    vaxis '«Ефли у тея кьюч, иди в авку и пуыгай ф тайную гуобицу. И ты выбралфя отфюда. Тайный выфод».{#vaxis_s51_1}'
    nr 'Он энергично кивает.{#vaxis_s51_1}'
    vaxis '«Там ты мовефь ОДОФНУТЬ».{#vaxis_s51_1}'
...
label vaxis_s52: # from 43.2
    ...
    nr 'В голосе зомби слышна раздраженность.{#vaxis_s52_1}'
    vaxis '«Арка, пеувый этаж, феверо-фападная коуната…»{#vaxis_s52_1}'
    nr 'Он поднимает указательный палец и сгибает его.{#vaxis_s52_1}'
    vaxis '«Тее нувна кофть паица, фогнутая. Ты попаефь ф тайную гуобицу. Тайный выфод. Там ты мовефь ОДОФНУТЬ».{#vaxis_s52_1}'
...
label vaxis_s53: # from 43.8
    ...
    nr 'Пожимает плечами.{#vaxis_s53_1}'
    vaxis '«Фтарый. Вовтый».{#vaxis_s53_1}'
...
label vaxis_s54: # from 43.9
    vaxis '«Э?»{#vaxis_s54_1}'
    nr 'Хмурится.{#vaxis_s54_1}'
    vaxis '«Фто она?»{#vaxis_s54_1}'
...
label vaxis_s56: # from 55.0
    ...
    nr 'Пожимает плечами.{#vaxis_s56_1}'
    vaxis '«Как у квыфы. Фтванно».{#vaxis_s56_1}'
...
label vaxis_s60: # from 43.11
    ...
    nr 'Зомби хихикает через зашитые губы, потом стучит себя по голове.{#vaxis_s60_1}'
    vaxis '«Твуфяки тууупые».{#vaxis_s60_1}'
...
label vaxis_s61: # from 60.0
    ...
    vaxis '«Тупие твуфявые. Ив мея ХОВОФЫЙ фомби».{#vaxis_s61_1}'
...
label vaxis_s62: # from 60.1 61.0
    ...
    vaxis '«А как ты думаефь? По мие, нет, не офень».{#vaxis_s62_1}'
    nr 'Бьет себя по груди.{#vaxis_s62_1}'
    vaxis '«Я КИЕПКИЙ».{#vaxis_s62_1}'
...
label vaxis_s63: # from 43.3 43.4 60.2 61.1 62.0 64.1 64.2
    ...
    vaxis '«Уху. Мие нуна банка баифама».{#vaxis_s63_1}'
    nr 'Показывает на шрамы на твоей груди.{#vaxis_s63_1}'
    vaxis '«И игоука ф ниткой».{#vaxis_s63_1}'
...
label vaxis_s64: # from 61.2 61.3 62.1 62.2
    ...
    vaxis '«Ты будефь ХОВОФЫМ фомби. Мовно фделать из тея фомби? ХОВОФАЯ мафкиофка».{#vaxis_s64_1}'
...
label vaxis_s67: # from 66.0 66.2
    ...
    vaxis '«Офтововно! Вафгоов вафофет фвы, науфив мафкивку. Фомби не говоят. Поняу? Говои медвенно, офтовоно».{#vaxis_s67_1}'
...
label vaxis_s68: # from 67.0
    ...
    vaxis '«Мафкирофка не деужится доуго… бальфам выфыхает, фвы рвутфя».{#vaxis_s68_1}'
    nr 'Он жмет плечами.{#vaxis_s68_1}'
    vaxis '«Фнаружи Морга от нее нифего не офтанетфя. Не бегай! Ефли ты побежифь, то науфифь вфю мафкирофку».{#vaxis_s68_1}'
...
label vaxis_s69: # -
    ...
    nr 'Хмурится.{#vaxis_s69_1}'
    vaxis '«Фде-то я тея виел. Мы не виелифь раньфе?»{#vaxis_s69_1}'
...
label vaxis_s72: # from 30.2
    ...
    vaxis '«Вфе тихо, твувявыя не февелятся, нифего новоо с пофледнего отфета».{#vaxis_s72_1}'
    nr 'Спустя несколько секунд он протягивает тебе какие-то предметы, затем ворчит:{#vaxis_s72_1}'
    vaxis '«Вот»{#vaxis_s72_1}'
    nr 'Судя по запаху, они прятались очень глубоко, чтобы их невозможно было найти в случае обыска.{#vaxis_s72_1}'
    vaxis '«Я фкоро уйду».{#vaxis_s72_1}'
...
label vaxis_s73: # -
    ...
    vaxis '«Поутал в арке»{#vaxis_s73_1}'
    nr 'Пеувый этав, феверо-фападная коумата, нувен кофтяной паиец дья откуывания,{#vaxis_s73_1}'
    vaxis '«Он кивает. — Удафи».{#vaxis_s73_1}'
...
label vaxis_s74: # from 34.0
    ...
    vaxis '«Ты ПЫТАЕФФЯ фапифать мея ф кьигу мертфых? У мея фдефь пвяфуффа двуфья, у тея фдефь *никоо*. Твониф мея — они тея пвиконфят».{#vaxis_s74_1}'
...
label vaxis_s75: # from 31.4 32.3 35.4
    ...
    vaxis '«ТЫ пытаеффя фапифать МЕЯ ф кьигу мертфых? У мея фдефь пвячуффа двуфья, у тея фдефь *никоо*. Твонеф мея — они тея пвиконфят».{#vaxis_s75_1}'
...
label vaxis_s76: # from 75.1
    ...
    vaxis '«Ты подеилфя фо мной фвоим фекретом, я подеюфь фоим ф *тоой*. Фдефь у мея прячуффа друфья, у тея фдефь *никоо*. Твуфьявые тея уют. Я фбегу».{#vaxis_s76_1}'
...
label vaxis_s77: # from 51.0
    ...
    vaxis '«Доувен быть де-то фдефь… Ифи на фкладах навеуху. Мовет быть, там».{#vaxis_s77_1}'
