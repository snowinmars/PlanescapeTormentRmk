...
label zf114_s0: # - # IF ~  True()
    'zf114_s0{#zf114_s0}'
    # nr 'Труп женщины перестает ковылять, как только ты подходишь. Ты замечаешь номер{#zf114_s0_1}'
    # zf114 '«114»{#zf114_s0_2}'
    # nr ', вырезанный у нее на лбу. Ее рот зашит, однако нитки начинают рваться и из ее губ слышится слабый стон.{#zf114_s0_3}'
