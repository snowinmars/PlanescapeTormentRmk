...
label zf114_s0: # - # IF ~  True()
    nr 'Труп женщины перестает ковылять, как только ты подходишь. Ты замечаешь номер{#zf114_s0_}'
    zf114 '«114»{#zf114_s0_}'
    nr ', вырезанный у нее на лбу. Ее рот зашит, однако нитки начинают рваться и из ее губ слышится слабый стон.{#zf114_s0_}'
...
label zf114_s1: # from 0.0 0.1 0.2
    nr 'Труп продолжает пялиться на тебя.{#zf114_s1_}'
...
label zf114_s2: # from 0.3
    nr 'Этот труп не реагирует. Кажется, он слишком далек от того, чтобы отвечать на твои вопросы.{#zf114_s2_}'
...
label zf114_s3: # - # IF ~  False()
    nr 'Этот труп не реагирует. Кажется, он слишком далек от того, чтобы отвечать на твои вопросы.{#zf114_s3_}'
