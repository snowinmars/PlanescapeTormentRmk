...
label zf1148_s0: # - # IF ~  True()
    nr 'Кожа этого женского трупа покрыто замысловатыми узорами татуировок. Кожа на лбу отвалилась, так что номер{#zf1148_s0_}'
    zf1148 '«1148»{#zf1148_s0_}'
    nr 'Вырезан прямо на черепе. Ее рот зашит крепкими грубыми стежками.{#zf1148_s0_}'
...
label zf1148_s1: # from 0.0 0.1 0.2
    nr 'Труп продолжает пялиться на тебя.{#zf1148_s1_}'
...
label zf1148_s2: # from 0.3
    nr 'Труп не реагирует. Кажется, он слишком далек от того, чтобы отвечать на твои вопросы.{#zf1148_s2_}'
...
label zf1148_s3: # - # IF ~  False()
    nr 'Труп не реагирует. Кажется, он слишком далек от того, чтобы отвечать на твои вопросы.{#zf1148_s3_}'
