...
label zf1148_s0: # - # IF ~  True()
    'zf1148_s0{#zf1148_s0}'
    # nr 'Кожа этого женского трупа покрыто замысловатыми узорами татуировок. Кожа на лбу отвалилась, так что номер{#zf1148_s0_1}'
    # zf1148 '«1148»{#zf1148_s0_2}'
    # nr 'Вырезан прямо на черепе. Ее рот зашит крепкими грубыми стежками.{#zf1148_s0_3}'
