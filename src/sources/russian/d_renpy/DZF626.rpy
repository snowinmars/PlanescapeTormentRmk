...
label zf626_s0: # - # IF ~  True()
    'zf626_s0{#zf626_s0}'
    # nr 'Левая сторона лица этой женщины выглядит так, словно ее разбили дубиной; плоть, вся во вмятинах и синяках, едва держится на проломленном черепе. Номер{#zf626_s0_1}'
    # zf626 '«626»{#zf626_s0_2}'
    # nr 'Вышит на правой щеке, прямо под глазом.{#zf626_s0_3}'
