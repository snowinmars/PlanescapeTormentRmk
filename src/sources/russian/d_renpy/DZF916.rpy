...
label zf916_s0: # - # IF ~  True()
    nr 'Труп женщины смотрит на тебя пустым взглядом. На ее лбу вырезан номер{#zf916_s0_}'
    zf916 '«916»{#zf916_s0_}'
    nr '; ее губы крепко зашиты. От тела исходит легкий запах формальдегида.{#zf916_s0_}'
...
label zf916_s1: # from 0.0 0.1 0.2
    nr 'Труп продолжает пялиться на тебя.{#zf916_s1_}'
...
label zf916_s2: # from 0.3
    nr 'Труп не реагирует. Кажется, он слишком далек от того, чтобы отвечать на твои вопросы.{#zf916_s2_}'
...
label zf916_s3: # - # IF ~  False()
    nr 'Труп не реагирует. Кажется, он слишком далек от того, чтобы отвечать на твои вопросы.{#zf916_s3_}'
