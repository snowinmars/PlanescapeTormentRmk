...
label zm613_s0: # - # IF ~  True()
    nr 'На лбу этого мертвого работяги при помощи глубоких порезов нанесены цифры{#zm613_s0_1}'
    zm613 '«613»{#zm613_s0_1}'
    nr ', но на коже между{#zm613_s0_1}'
    zm613 '«1»{#zm613_s0_1}'
    nr 'И{#zm613_s0_1}'
    zm613 '«3»{#zm613_s0_1}'
    nr 'Виден большой пробел шириной с палец. Приглядевшись, ты с трудом различаешь вырезанную{#zm613_s0_1}'
    zm613 '«2».{#zm613_s0_1}'
