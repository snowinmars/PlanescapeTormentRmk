...
label zm613_s0: # - # IF ~  True()
    nr 'На лбу этого мертвого работяги при помощи глубоких порезов нанесены цифры{#zm613_s0_}'
    zm613 '«613»{#zm613_s0_}'
    nr ', но на коже между{#zm613_s0_}'
    zm613 '«1»{#zm613_s0_}'
    nr 'И{#zm613_s0_}'
    zm613 '«3»{#zm613_s0_}'
    nr 'Виден большой пробел шириной с палец. Приглядевшись, ты с трудом различаешь вырезанную{#zm613_s0_}'
    zm613 '«2».{#zm613_s0_}'
...
label zm613_s1: # from 0.0 0.1 0.2
    nr 'Труп продолжает пялиться на тебя.{#zm613_s1_}'
...
label zm613_s2: # from 0.3
    nr 'Труп не реагирует. Кажется, он слишком далек от того, чтобы отвечать на твои вопросы.{#zm613_s2_}'
